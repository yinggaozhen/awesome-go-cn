...
* [portmidi](https://github.com/rakyll/portmidi) **star:206** Go bindings for PortMidi.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) **star:5946** Golang implementation of JSON Web Tokens (JWT).   ![star > 5000][Gold]   ![There was an update last week][Green]
* [casbin](https://github.com/hsluoyz/casbin) **star:4919** Authorization library that supports access control models like ACL, RBAC, ABAC.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [oauth2](https://github.com/golang/oauth2) **star:2378** Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support.   ![star > 1000][Silver]
* [goth](https://github.com/markbates/goth) **star:2260** provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.   ![star > 1000][Silver]
* [authboss](https://github.com/volatiletech/authboss) **star:1928** Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time.   ![star > 1000][Silver]
* [osin](https://github.com/openshift/osin) **star:1540** Golang OAuth2 server library.   ![star > 1000][Silver]
...
* [go-jose](https://github.com/square/go-jose) **star:1122** Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.   ![star > 1000][Silver]
...
* [loginsrv](https://github.com/tarent/loginsrv) **star:809** JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam.   ![star > 100][Bronze]
* [scs](https://github.com/alexedwards/scs) **star:525** Session Manager for HTTP servers.   ![star > 100][Bronze]
* [permissions2](https://github.com/xyproto/permissions2) **star:353** Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [cobra](https://github.com/spf13/cobra) **star:13247** Commander for modern Go CLI interactions.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [urfave/cli](https://github.com/urfave/cli) **star:11329** Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [go-flags](https://github.com/jessevdk/go-flags) **star:1505** go command line option parser.   ![star > 1000][Silver]
* [readline](https://github.com/chzyer/readline) **star:1367** Pure golang implementation that provides most features in GNU-Readline under MIT license.   ![star > 1000][Silver]
...
* [mitchellh/cli](https://github.com/mitchellh/cli) **star:997** Go library for implementing command-line interfaces.   ![star > 100][Bronze]
...
* [complete](https://github.com/posener/complete) **star:612** Write bash completions in Go + Go command bash completion.   ![star > 100][Bronze]
...
* [flaggy](https://github.com/integrii/flaggy) **star:449** A robust and idiomatic flags package with excellent subcommand support.   ![star > 100][Bronze]
...
* [termui](https://github.com/gizak/termui) **star:8897** Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).   ![star > 5000][Gold]   ![There was an update last week][Green]
* [gommon/color](https://github.com/labstack/gommon/tree/master/color)  Style terminal text.
* [gocui](https://github.com/jroimartin/gocui) **star:5344** Minimalist Go library aimed at creating Console User Interfaces.   ![star > 5000][Gold]
* [termbox-go](https://github.com/nsf/termbox-go) **star:3476** Termbox is a library for creating cross-platform text-based interfaces.   ![star > 1000][Silver]
* [color](https://github.com/fatih/color) **star:3011** Versatile package for colored terminal output.   ![star > 1000][Silver]
* [go-prompt](https://github.com/c-bata/go-prompt) **star:2325** Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).   ![star > 1000][Silver]   ![There was an update last week][Green]
* [uiprogress](https://github.com/gosuri/uiprogress) **star:1535** Flexible library to render progress bars in terminal applications.   ![star > 1000][Silver]
* [asciigraph](https://github.com/guptarohit/asciigraph) **star:1139** Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.   ![star > 1000][Silver]
...
* [mpb](https://github.com/vbauerster/mpb) **star:687** Multi progress bar for terminal applications.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [aurora](https://github.com/logrusorgru/aurora) **star:630** ANSI terminal colors that supports fmt.Printf/Sprintf.   ![star > 100][Bronze]
* [progressbar](https://github.com/schollz/progressbar) **star:568** Basic thread-safe progress bar that works in every OS.   ![star > 100][Bronze]
...
* [tabby](https://github.com/cheynewallace/tabby) **star:247** A tiny library for super simple Golang tables.   ![star > 100][Bronze]
...
* [viper](https://github.com/spf13/viper) **star:9270** Go configuration with fangs.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [ini](https://github.com/go-ini/ini) **star:1589** Go package to read and write INI files.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [env](https://github.com/caarlos0/env) **star:858** Parse environment variables to Go structs (with defaults).   ![star > 100][Bronze]
...
* [drone](https://github.com/drone/drone) **star:18971** Drone is a Continuous Integration platform built on Docker, written in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [gods](https://github.com/emirpasic/gods) **star:6341** Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.   ![star > 5000][Gold]
* [go-datastructures](https://github.com/Workiva/go-datastructures) **star:5125** Collection of useful, performant, and thread-safe data structures.   ![star > 5000][Gold]
* [golang-set](https://github.com/deckarep/golang-set) **star:1163** Thread-Safe and Non-Thread-Safe high-performance sets for Go.   ![star > 1000][Silver]
* [boomfilters](https://github.com/tylertreat/BoomFilters) **star:1135** Probabilistic data structures for processing continuous, unbounded streams.   ![star > 1000][Silver]
* [gota](https://github.com/kniren/gota) **star:877** Implementation of dataframes, series, and data wrangling methods for Go.   ![star > 100][Bronze]
...
* [conjungo](https://github.com/InVisionApp/conjungo) **star:77** A small, powerful and flexible merge library.
...
* [prometheus](https://github.com/prometheus/prometheus) **star:25471** Monitoring system and time series database.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [tidb](https://github.com/pingcap/tidb) **star:20000** TiDB is a distributed SQL database. Inspired by the design of Google F1.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [influxdb](https://github.com/influxdb/influxdb) **star:17070** Scalable datastore for metrics, events, and real-time analytics.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [cockroach](https://github.com/cockroachdb/cockroach) **star:16750** Scalable, Geo-Replicated, Transactional Datastore.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [dgraph](https://github.com/dgraph-io/dgraph) **star:10278** Scalable, Distributed, Low Latency, High Throughput Graph Database.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [bolt](https://github.com/boltdb/bolt) **star:9961** Low-level key/value database for Go.   ![star > 5000][Gold]   ![It hasn't been updated in the last year][Yellow]
* [groupcache](https://github.com/golang/groupcache) **star:7647** Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.   ![star > 5000][Gold]
* [badger](https://github.com/dgraph-io/badger) **star:6257** Fast key-value store in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [rqlite](https://github.com/rqlite/rqlite) **star:4688** The lightweight, distributed, relational database built on SQLite.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [goleveldb](https://github.com/syndtr/goleveldb) **star:3164** Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [go-cache](https://github.com/pmylund/go-cache) **star:2892** In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications.   ![star > 1000][Silver]
* [BigCache](https://github.com/allegro/bigcache) **star:2447** Efficient key/value cache for gigabytes of data.   ![star > 1000][Silver]
...
* [cache2go](https://github.com/muesli/cache2go) **star:1037** In-memory key:value cache which supports automatic invalidation based on timeouts.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) **star:993** fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [nutsdb](https://github.com/xujiajun/nutsdb) **star:887** Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set.   ![star > 100][Bronze]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
...
* [diskv](https://github.com/peterbourgon/diskv) **star:749** Home-grown disk-backed key-value store.   ![star > 100][Bronze]
...
* [migrate](https://github.com/golang-migrate/migrate) **star:2593** Database migrations. CLI and Golang library.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [vitess](https://github.com/youtube/vitess) **star:8431** vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [pgweb](https://github.com/sosedoff/pgweb) **star:5977** Web-based PostgreSQL database browser.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [kingshard](https://github.com/flike/kingshard) **star:4597** kingshard is a high performance proxy for MySQL powered by Golang.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [orchestrator](https://github.com/github/orchestrator) **star:3019** MySQL replication topology manager & visualizer.   ![star > 1000][Silver]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) **star:2388** Sync your MySQL data into Elasticsearch automatically.   ![star > 1000][Silver]
* [pREST](https://github.com/nuveo/prest) **star:2082** Serve a RESTful API from any PostgreSQL database.   ![star > 1000][Silver]
* [go-mysql](https://github.com/siddontang/go-mysql) **star:1880** Go toolset to handle MySQL protocol and replication.   ![star > 1000][Silver]
...
* [Squirrel](https://github.com/Masterminds/squirrel) **star:2302** Go library that helps you build SQL queries.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [xo](https://github.com/knq/xo) **star:2178** Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.   ![star > 1000][Silver]
* [gendry](https://github.com/didi/gendry) **star:756** Non-invasive SQL builder and powerful data binder.   ![star > 100][Bronze]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
...
* Relational Databases
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) **star:8083** MySQL driver for Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [pq](https://github.com/lib/pq) **star:5175** Pure Go Postgres driver for database/sql.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) **star:3424** SQLite3 driver for go that uses database/sql.   ![star > 1000][Silver]
    * [pgx](https://github.com/jackc/pgx) **star:1910** PostgreSQL driver supporting features beyond those exposed by database/sql.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [go-mssqldb](https://github.com/denisenkom/go-mssqldb) **star:1018** Microsoft MSSQL driver for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [go-oci8](https://github.com/mattn/go-oci8) **star:404** Oracle driver for go that uses database/sql.   ![star > 100][Bronze]
    * [goracle](https://github.com/go-goracle/goracle) **star:236** Oracle driver for Go, using the ODPI-C driver.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* NoSQL Databases
    * [redis](https://github.com/go-redis/redis) **star:6475** Redis client for Golang.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [redigo](https://github.com/gomodule/redigo) **star:6257** Redigo is a Go client for the Redis database.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) **star:3076** Official MongoDB driver for the Go language.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) **star:5823** Modern text indexing library for go.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [riot](https://github.com/go-ego/riot) **star:4688** Go Open Source, Distributed, Simple and efficient Search Engine.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
    * [elastic](https://github.com/olivere/elastic) **star:4123** Elasticsearch client for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) **star:1561** Official Elasticsearch client for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [now](https://github.com/jinzhu/now) **star:2175** Now is a time toolkit for golang.   ![star > 1000][Silver]
* [dateparse](https://github.com/araddon/dateparse) **star:891** Parse date's without knowing format in advance.   ![star > 100][Bronze]
* [carbon](https://github.com/uniplaces/carbon) **star:333** Simple Time extension with a lot of util methods, ported from PHP Carbon library.   ![star > 100][Bronze]
...
* [go-kit](https://github.com/go-kit/kit) **star:14385** Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.   ![star > 5000][Gold]
* [grpc-go](https://github.com/grpc/grpc-go) **star:9054** The Go language implementation of gRPC. HTTP/2 based RPC.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [jaeger](https://github.com/jaegertracing/jaeger) **star:8620** A distributed tracing system.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [micro](https://github.com/micro/micro) **star:6561** Pluggable microservice toolkit and distributed systems platform.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [NATS](https://github.com/nats-io/gnatsd) **star:6320** Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [rpcx](https://github.com/smallnest/rpcx) **star:3774** Distributed pluggable RPC service framework like alibaba Dubbo.   ![star > 1000][Silver]
* [tendermint](https://github.com/tendermint/tendermint) **star:3124** High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [raft](https://github.com/coreos/etcd/tree/master/raft)  Go implementation of the Raft consensus protocol, by CoreOS.
* [raft](https://github.com/hashicorp/raft) **star:2837** Golang implementation of the Raft consensus protocol, by HashiCorp.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [torrent](https://github.com/anacrolix/torrent) **star:2834** BitTorrent client package.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [glow](https://github.com/chrislusf/glow) **star:2520** Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go.   ![star > 1000][Silver]
* [dragonboat](https://github.com/lni/dragonboat) **star:2517** A feature complete and high performance multi-group Raft library in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [gleam](https://github.com/chrislusf/gleam) **star:2081** Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.   ![star > 1000][Silver]
* [emitter-io](https://github.com/emitter-io/emitter) **star:1925** High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.   ![star > 1000][Silver]
* [KrakenD](https://github.com/devopsfaith/krakend) **star:1736** Ultra performant API Gateway framework with middlewares.   ![star > 1000][Silver]
* [hprose](https://github.com/hprose/hprose-golang) **star:1001** Very newbility RPC Library, support 25+ languages now.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
...
* [go-health](https://github.com/InVisionApp/go-health) **star:476** Library for enabling asynchronous dependency health checks in your service.   ![star > 100][Bronze]
...
* [MailHog](https://github.com/mailhog/MailHog) **star:5150** Email and SMTP testing with web and API interface.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [SendGrid](https://github.com/sendgrid/sendgrid-go) **star:518** SendGrid's Go library for sending email.   ![star > 100][Bronze]
...
* [otto](https://github.com/robertkrimen/otto) **star:4719** JavaScript interpreter written in Go.   ![star > 1000][Silver]
* [gopher-lua](https://github.com/yuin/gopher-lua) **star:2950** Lua 5.1 VM and compiler written in Go.   ![star > 1000][Silver]
* [go-lua](https://github.com/Shopify/go-lua) **star:1665** Port of the Lua 5.2 VM to pure Go.   ![star > 1000][Silver]
...
* [gval](https://github.com/PaesslerAG/gval) **star:135** A highly customizable expression language written in Go.   ![star > 100][Bronze]
...
* [errors](https://github.com/pkg/errors) **star:4864** Package that provides simple error handling primitives.   ![star > 1000][Silver]
* [go-multierror](https://github.com/hashicorp/go-multierror) **star:725** Go (golang) package for representing a list of errors as a single error.   ![star > 100][Bronze]
...
* [errlog](https://github.com/snwfdhmp/errlog) **star:151** Hackable package that determines responsible source code for an error (and some other fast-debugging features). Pluggable to any logger in-place.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [afero](https://github.com/spf13/afero) **star:2222** FileSystem Abstraction System for Go.   ![star > 1000][Silver]
* [pdfcpu](https://github.com/hhrutter/pdfcpu) **star:943** PDF processor.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [decimal](https://github.com/shopspring/decimal) **star:1591** Arbitrary-precision fixed-point decimal numbers.   ![star > 1000][Silver]
...
* [Leaf](https://github.com/name5566/leaf) **star:3048** Lightweight game server framework.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
* [Pixel](https://github.com/faiface/pixel) **star:2428** Hand-crafted 2D game library in Go.   ![star > 1000][Silver]
...
* [go-sdl2](https://github.com/veandco/go-sdl2) **star:1154** Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [nano](https://github.com/lonng/nano) **star:987** Lightweight, facility, high performance golang based game server framework.   ![star > 100][Bronze]   ![Contains Chinese documents][CN]
* [g3n](https://github.com/g3n/engine) **star:744** Go 3D Game Engine.   ![star > 100][Bronze]
* [Oak](https://github.com/oakmound/oak) **star:627** Pure Go game engine.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [raylib-go](https://github.com/gen2brain/raylib-go) **star:381** Go bindings for [raylib](http://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [jennifer](https://github.com/dave/jennifer) **star:1266** Generate arbitrary Go code without templates.   ![star > 1000][Silver]
...
* [Tile38](https://github.com/tidwall/tile38) **star:6316** Geolocation DB with spatial index and realtime geofencing.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [gopherjs](https://github.com/gopherjs/gopherjs) **star:8531** Compiler from Go to JavaScript.   ![star > 5000][Gold]
...
* [goworker](https://github.com/benmanns/goworker) **star:2245** goworker is a Go-based background worker.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [ants](https://github.com/panjf2000/ants) **star:1867** A high-performance goroutine pool for golang.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [tunny](https://github.com/Jeffail/tunny) **star:1341** Goroutine pool for golang.   ![star > 1000][Silver]
* [grpool](https://github.com/ivpusic/grpool) **star:497** Lightweight Goroutine pool.   ![star > 100][Bronze]
...
* [ui](https://github.com/andlabs/ui) **star:6935** Platform-native GUI library for Go. Cross platform.   ![star > 5000][Gold]
* [Wails](https://wails.app)  Mac, Windows, Linux desktop apps with HTML UI using built-in OS HTML renderer.
* [fyne](https://github.com/fyne-io/fyne) **star:6254** Cross platform native GUIs designed for Go, rendered using EFL. Supports: Linux, macOS, Windows.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [qt](https://github.com/therecipe/qt) **star:6022** Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).   ![star > 5000][Gold]
* [webview](https://github.com/zserge/webview) **star:4636** Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).   ![star > 1000][Silver]   ![There was an update last week][Green]
* [walk](https://github.com/lxn/walk) **star:3683** Windows application library kit for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [app](https://github.com/murlokswarm/app) **star:2948** Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [gotk3](https://github.com/gotk3/gotk3) **star:766** Go bindings for GTK3.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [systray](https://github.com/getlantern/systray) **star:781** Cross platform Go library to place an icon and menu in the notification area.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [imaging](https://github.com/disintegration/imaging) **star:2513** Simple Go image processing package.   ![star > 1000][Silver]
* [bild](https://github.com/anthonynsimon/bild) **star:2473** Collection of image processing algorithms in pure Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [ln](https://github.com/fogleman/ln) **star:2458** 3D line art rendering in Go.   ![star > 1000][Silver]
* [gocv](https://github.com/hybridgroup/gocv) **star:2438** Go package for computer vision using OpenCV 3.3+.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [resize](https://github.com/nfnt/resize) **star:2124** Image resizing for Go with common interpolation methods.   ![star > 1000][Silver]   ![It hasn't been updated in the last year][Yellow]
* [gg](https://github.com/fogleman/gg) **star:1904** 2D rendering in pure Go.   ![star > 1000][Silver]
* [pt](https://github.com/fogleman/pt) **star:1768** Path tracing engine written in Go.   ![star > 1000][Silver]
* [svgo](https://github.com/ajstarks/svgo) **star:1329** Go Language Library for SVG generation.   ![star > 1000][Silver]
...
* [darkroom](https://github.com/gojek/darkroom) **star:21** An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency.   ![There was an update last week][Green]
...
* [mainflux](https://github.com/Mainflux/mainflux) **star:586** Industrial IoT Messaging and Device Management Server.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [GJSON](https://github.com/tidwall/gjson) **star:4861** Get a JSON value with one line of code.   ![star > 1000][Silver]
...
* [logrus](https://github.com/Sirupsen/logrus) **star:11878** Structured logger for Go.   ![star > 5000][Gold]
* [zap](https://github.com/uber-go/zap) **star:7395** Fast, structured, leveled logging in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [spew](https://github.com/davecgh/go-spew) **star:3294** Implements a deep pretty printer for Go data structures to aid in debugging.   ![star > 1000][Silver]
* [glog](https://github.com/golang/glog) **star:2301** Leveled execution logs for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [zerolog](https://github.com/rs/zerolog) **star:2199** Zero-allocation JSON logger.   ![star > 1000][Silver]
* [tail](https://github.com/hpcloud/tail) **star:1536** Go package striving to emulate the features of the BSD tail program.   ![star > 1000][Silver]
...
* [seelog](https://github.com/cihub/seelog) **star:1349** Logging functionality with flexible dispatching, filtering, and formatting.   ![star > 1000][Silver]
* [log15](https://github.com/inconshreveable/log15) **star:885** Simple, powerful logging for Go.   ![star > 100][Bronze]
* [log](https://github.com/apex/log) **star:731** Structured logging package for Go.   ![star > 100][Bronze]
...
* [GoLearn](https://github.com/sjwhitworth/golearn) **star:6645** General Machine Learning library for Go.   ![star > 5000][Gold]   ![Contains Chinese documents][CN]
* [gorgonia](https://github.com/chewxy/gorgonia) **star:2684** graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [gobrain](https://github.com/goml/gobrain) **star:384** Neural Networks written in go.   ![star > 100][Bronze]
...
* [sarama](https://github.com/Shopify/sarama) **star:4599** Go library for Apache Kafka.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) **star:3670** Real-time messaging (Websockets or SockJS) server in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [machinery](https://github.com/RichardKnop/machinery) **star:3356** Asynchronous task queue/job queue based on distributed message passing.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [go-socket.io](https://github.com/googollee/go-socket.io) **star:2877** socket.io library for golang, a realtime application framework.   ![star > 1000][Silver]
* [NATS Go Client](https://github.com/nats-io/nats) **star:2393** Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [APNs2](https://github.com/sideshow/apns2) **star:2039** HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps.   ![star > 1000][Silver]
* [Benthos](https://github.com/Jeffail/benthos) **star:2000** A message streaming bridge between a range of protocols.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [melody](https://github.com/olahol/melody) **star:1554** Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.   ![star > 1000][Silver]
* [mangos](https://github.com/go-mangos/mangos) **star:1535** Pure go implementation of the Nanomsg ("Scalable Protocols") with transport interoperability.   ![star > 1000][Silver]
* [Mercure](https://github.com/dunglas/mercure) **star:1496** Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [Beaver](https://github.com/Clivern/Beaver) **star:722** A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [EventBus](https://github.com/asaskevich/EventBus) **star:557** The lightweight event bus with async compatibility.   ![star > 100][Bronze]
...
* [unioffice](https://github.com/unidoc/unioffice) **star:1696** Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.   ![star > 1000][Silver]

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) **star:4432** Golang library for reading and writing Microsoft Excel™ (XLSX) files.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [xlsx](https://github.com/tealeg/xlsx) **star:3355** Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [dig](https://github.com/uber-go/dig) **star:903** A reflection based dependency injection toolkit for Go.   ![star > 100][Bronze]
* [fx](https://github.com/uber-go/fx) **star:745** A dependency injection based application framework for Go (built on top of dig).   ![star > 100][Bronze]
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) **star:9009** Set of common historical and emerging project layout patterns in the Go ecosystem.   ![star > 5000][Gold]
...
* [gopsutil](https://github.com/shirou/gopsutil) **star:3908** Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).   ![star > 1000][Silver]   ![There was an update last week][Green]
* [archiver](https://github.com/mholt/archiver) **star:2483** Library and command for making and extracting .zip and .tar.gz archives.   ![star > 1000][Silver]
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) **star:626** Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.   ![star > 100][Bronze]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
...
* [gofakeit](https://github.com/brianvoe/gofakeit) **star:413** Random data generator written in go.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [gojieba](https://github.com/yanyiwu/gojieba) **star:817** This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.   ![star > 100][Bronze]   ![Contains Chinese documents][CN]
* [go-pinyin](https://github.com/mozillazg/go-pinyin) **star:521** CN Hanzi to Hanyu Pinyin converter.   ![star > 100][Bronze]
* [kagome](https://github.com/ikawaha/kagome) **star:414** JP morphological analyzer written in pure Go.   ![star > 100][Bronze]
...
* [kcptun](https://github.com/xtaci/kcptun) **star:10642** Extremely simple & fast udp tunnel based on KCP protocol.   ![star > 5000][Gold]
* [fasthttp](https://github.com/valyala/fasthttp) **star:9300** Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [dns](https://github.com/miekg/dns) **star:3788** Go library for working with DNS.   ![star > 1000][Silver]
...
* [quic-go](https://github.com/lucas-clemente/quic-go) **star:2883** An implementation of the QUIC protocol in pure Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [gopacket](https://github.com/google/gopacket) **star:2865** Go library for packet processing with libpcap bindings.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [kcp-go](https://github.com/xtaci/kcp-go) **star:2238** KCP - Fast and Reliable ARQ Protocol.   ![star > 1000][Silver]
* [webrtc](https://github.com/pions/webrtc) **star:2204** A pure Go implementation of the WebRTC API.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [fortio](https://github.com/fortio/fortio) **star:869** Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.   ![star > 100][Bronze]
* [water](https://github.com/songgao/water) **star:837** Simple TUN/TAP library.   ![star > 100][Bronze]
...
* [mdns](https://github.com/hashicorp/mdns) **star:548** Simple mDNS (Multicast DNS) client/server library in Golang.   ![star > 100][Bronze]
* [grab](https://github.com/cavaliercoder/grab) **star:545** Go package for managing file downloads.   ![star > 100][Bronze]
* [ftp](https://github.com/jlaffaye/ftp) **star:523** Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959).   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [peerdiscovery](https://github.com/schollz/peerdiscovery) **star:362** Pure Go library for cross-platform local peer discovery using UDP multicast.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [gmqtt](https://github.com/DrmagicE/gmqtt) **star:85** Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.   ![Contains Chinese documents][CN]
...
* [grequests](https://github.com/levigross/grequests) **star:1411** A Go "clone" of the great and famous Requests library.   ![star > 1000][Silver]
...
* [sling](https://github.com/dghubble/sling) **star:997** Sling is a Go HTTP client library for creating and sending API requests.   ![star > 100][Bronze]
...
* [glfw](https://github.com/go-gl/glfw) **star:730** Go bindings for GLFW 3.   ![star > 100][Bronze]
...
* [GORM](https://github.com/jinzhu/gorm) **star:14595** The fantastic ORM library for Golang, aims to be developer friendly.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Xorm](https://github.com/go-xorm/xorm) **star:5179** Simple and powerful ORM for Go.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [gorp](https://github.com/go-gorp/gorp) **star:3074** Go Relational Persistence, ORM-ish library for Go.   ![star > 1000][Silver]
* [go-pg](https://github.com/go-pg/pg) **star:2966** PostgreSQL ORM with focus on PostgreSQL specific features and performance.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) **star:2262** ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [dep](https://github.com/golang/dep) **star:12556** Go dependency tool.   ![star > 5000][Gold]
...
* [graphql-go](https://github.com/graphql-go/graphql) **star:5203** Implementation of GraphQL for Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [graphql](https://github.com/neelance/graphql-go) **star:2759** GraphQL server with a focus on ease of use.   ![star > 1000][Silver]
...
* [packr](https://github.com/gobuffalo/packr) **star:2099** The simple and easy way to embed static files into Go binaries.   ![star > 1000][Silver]
* [statik](https://github.com/rakyll/statik) **star:2091** Embeds static files into a Go executable.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [gonum](https://github.com/gonum/gonum) **star:2941** Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [lego](https://github.com/xenolf/lego) **star:3472** Pure Go ACME client library and CLI tool (for use with Let's Encrypt).   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [memguard](https://github.com/awnumar/memguard) **star:1461** A pure Go library for handling sensitive values in memory.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [secure](https://github.com/unrolled/secure) **star:1201** HTTP middleware for Go that facilitates some quick security wins.   ![star > 1000][Silver]
...
* [jsoniter](https://github.com/json-iterator/go) **star:5514** High-performance 100% compatible drop-in replacement of "encoding/json".   ![star > 5000][Gold]   ![There was an update last week][Green]
* [goprotobuf](https://github.com/golang/protobuf) **star:5062** Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) **star:2942** Protocol Buffers for Go with Gadgets.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [mapstructure](https://github.com/mitchellh/mapstructure) **star:2405** Go library for decoding generic map values into native Go structures.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [go-codec](https://github.com/ugorji/go) **star:1230** High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support.   ![star > 1000][Silver]
...
* [etcd](https://github.com/coreos/etcd) **star:26384** Highly-available key value store for shared configuration and service discovery.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Caddy](https://github.com/mholt/caddy) **star:23116** Caddy is an alternative, HTTP/2 web server that's easy to configure and use.   ![star > 5000][Gold]
* [consul](https://www.consul.io/)  Consul is a tool for service discovery, monitoring and configuration.
* [minio](https://github.com/minio/minio) **star:17306** Minio is a distributed object storage server.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [yakvs](https://git.sci4me.com/sci4me/yakvs)  Small, networked, in-memory key-value store.
* [RoadRunner](https://github.com/spiral/roadrunner) **star:3262** High-performance PHP application server, load-balancer and process manager.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [flipt](https://github.com/markphelps/flipt) **star:986** A self contained feature flag solution written in Go and Vue.js   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [Fider](https://github.com/getfider/fider) **star:793** Fider is an open platform to collect and organize customer feedback.   ![star > 100][Bronze]
* [jackal](https://github.com/ortuman/jackal) **star:714** An XMPP server written in Go.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [discovery](https://github.com/Bilibili/discovery) **star:671** A registry for resilient mid-tier load balancing and failover.   ![star > 100][Bronze]
...
* [quicktemplate](https://github.com/valyala/quicktemplate) **star:1399** Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.   ![star > 1000][Silver]
...
* [Razor](https://github.com/sipin/gorazor) **star:697** Razor view engine for Golang.   ![star > 100][Bronze]
...
* Testing Frameworks
    ...
    * [Testify](https://github.com/stretchr/testify) **star:8103** Sacred extension to the standard go testing package.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [go-cmp](https://github.com/google/go-cmp) **star:1143** Package for comparing Go values in tests.   ![star > 1000][Silver]   ![There was an update last week][Green]
    ...
    * [godog](https://github.com/DATA-DOG/godog) **star:749** Cucumber or Behat like BDD framework for Go.   ![star > 100][Bronze]
...
* Mock
    * [gomock](https://github.com/golang/mock) **star:2828** Mocking framework for the Go programming language.   ![star > 1000][Silver]
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) **star:1732** Mock SQL driver for testing database interactions.   ![star > 1000][Silver]
    ...
    * [go-txdb](https://github.com/DATA-DOG/go-txdb) **star:160** Single transaction based database driver mainly for testing purposes.   ![star > 100][Bronze]
...
* Fuzzing and delta-debugging/reducing/shrinking.
    * [go-fuzz](https://github.com/dvyukov/go-fuzz) **star:2875** Randomized testing system.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* Selenium and browser control tools.
    * [chromedp](https://github.com/knq/chromedp) **star:3569** a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.   ![star > 1000][Silver]
    * [selenoid](https://github.com/aerokube/selenoid) **star:1223** alternative Selenium hub server that launches browsers within containers.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* Fail injection
    * [failpoint](https://github.com/pingcap/failpoint) **star:384** An implementation of [failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail) for Golang.   ![star > 100][Bronze]
...
* Specific Formats
    * [colly](https://github.com/asciimoo/colly) **star:8332** Fast and Elegant Scraping Framework for Gophers.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [GoQuery](https://github.com/PuerkitoBio/goquery) **star:7543** GoQuery brings a syntax and a set of features similar to jQuery to the Go language.   ![star > 5000][Gold]
    * [blackfriday](https://github.com/russross/blackfriday) **star:3881** Markdown processor in Go.   ![star > 1000][Silver]
    * [toml](https://github.com/BurntSushi/toml) **star:2769** TOML configuration format (encoder/decoder with reflection).   ![star > 1000][Silver]
    * [sh](https://github.com/mvdan/sh) **star:1985** Shell parser and formatter.   ![star > 1000][Silver]
    * [go-humanize](https://github.com/dustin/go-humanize) **star:1895** Formatters for time, numbers, and memory size to human readable format.   ![star > 1000][Silver]
    * [bluemonday](https://github.com/microcosm-cc/bluemonday) **star:1243** HTML Sanitizer.   ![star > 1000][Silver]
    * [inject](https://github.com/facebookgo/inject) **star:1140** Package inject provides a reflect based injector.   ![star > 1000][Silver]
    * [gofeed](https://github.com/mmcdole/gofeed) **star:1095** Parse RSS and Atom feeds in Go.   ![star > 1000][Silver]
    ...
    * [gographviz](https://github.com/awalterschulze/gographviz) **star:297** Parses the Graphviz DOT language.   ![star > 100][Bronze]
    ...
    * [go-nmea](https://github.com/adrianmo/go-nmea) **star:95** NMEA parser library for the Go language.   ![There was an update last week][Green]
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) **star:5012** The official AWS SDK for the Go programming language.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [github](https://github.com/google/go-github) **star:4750** Go library for accessing the GitHub REST API v3.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [slack](https://github.com/nlopes/slack) **star:2408** Slack API in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [google](https://github.com/google/google-api-go-client) **star:1914** Auto-generated Google APIs for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) **star:1771** Google Cloud APIs Go Client Library.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [anaconda](https://github.com/ChimeraCoder/anaconda) **star:985** Go client library for the Twitter 1.1 API.   ![star > 100][Bronze]
* [discordgo](https://github.com/bwmarrin/discordgo) **star:968** Go bindings for the Discord Chat API.   ![star > 100][Bronze]
...
* [go-jira](https://github.com/andygrunwald/go-jira) **star:573** Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)   ![star > 100][Bronze]
* [githubql](https://github.com/shurcooL/githubql) **star:501** Go library for accessing the GitHub GraphQL API v4.   ![star > 100][Bronze]
* [webhooks](https://github.com/go-playground/webhooks) **star:350** Webhook receiver for GitHub and Bitbucket.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [fzf](https://github.com/junegunn/fzf) **star:23079** Command-line fuzzy finder written in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [hub](https://github.com/github/hub) **star:16906** wrap git commands with additional functionality to interact with github from the terminal.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [delve](https://github.com/derekparker/delve) **star:11984** Go debugger.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [ctop](https://github.com/bcicen/ctop) **star:8808** [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics.   ![star > 5000][Gold]
* [wuzz](https://github.com/asciimoo/wuzz) **star:8255** Interactive cli tool for HTTP inspection.   ![star > 5000][Gold]
* [sqlx](https://github.com/jmoiron/sqlx) **star:6763** provides a set of extensions on top of the excellent built-in database/sql package.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [peco](https://github.com/peco/peco) **star:5446** Simplistic interactive filtering tool.   ![star > 5000][Gold]
* [usql](https://github.com/knq/usql) **star:4669** usql is a universal command-line interface for SQL databases.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [goreleaser](https://github.com/goreleaser/goreleaser) **star:4486** Deliver Go binaries as fast and easily as possible.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [go-torch](https://github.com/uber/go-torch) **star:3637** Stochastic flame graph profiler for Go programs.   ![star > 1000][Silver]
...
* [hystrix-go](https://github.com/afex/hystrix-go) **star:2002** Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker.   ![star > 1000][Silver]
* [resty](https://github.com/go-resty/resty) **star:1951** Simple HTTP and REST client for Go inspired by Ruby rest-client.   ![star > 1000][Silver]
* [Task](https://github.com/go-task/task) **star:1930** simple "Make" alternative.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [minify](https://github.com/tdewolff/minify) **star:1855** Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.   ![star > 1000][Silver]
...
* [go-funk](https://github.com/thoas/go-funk) **star:1174** Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [profile](https://github.com/pkg/profile) **star:1003** Simple profiling support package for Go.   ![star > 1000][Silver]
* [filetype](https://github.com/h2non/filetype) **star:945** Small package to infer the file type checking the magic numbers signature.   ![star > 100][Bronze]
...
* [jump](https://github.com/gsamokovarov/jump) **star:656** Jump helps you navigate faster by learning your habits.   ![star > 100][Bronze]
...
* [retry](https://github.com/kamilsk/retry) **star:158** The most advanced functional mechanism to perform actions repetitively until successful.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [chyle](https://github.com/antham/chyle) **star:106** Changelog generator using a git repository with multiple configuration possibilities.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [govalidator](https://github.com/asaskevich/govalidator) **star:3540** Validators and sanitizers for strings, numerics, slices and structs.   ![star > 1000][Silver]
* [validator](https://github.com/go-playground/validator) **star:3492** Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.   ![star > 1000][Silver]
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) **star:1034** Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [go-git](https://github.com/src-d/go-git) **star:4197** highly extensible Git implementation in pure Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [git2go](https://github.com/libgit2/git2go) **star:1356** Go bindings for libgit2.   ![star > 1000][Silver]
* [hercules](https://github.com/src-d/hercules) **star:524** gaining advanced insights from Git repository history.   ![star > 100][Bronze]
...
* [goav](https://github.com/giorgisio/goav) **star:778** Comphrensive Go bindings for FFmpeg.   ![star > 100][Bronze]
* [gmf](https://github.com/3d0c/gmf) **star:523** Go bindings for FFmpeg av\* libraries.   ![star > 100][Bronze]
...
* [Gin](https://github.com/gin-gonic/gin) **star:29818** Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Beego](https://github.com/astaxie/beego) **star:21408** beego is an open-source, high-performance web framework for the Go programming language.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [Buffalo](http://gobuffalo.io)  Bringing the productivity of Rails to Go!
* [Echo](https://github.com/labstack/echo) **star:14636** High performance, minimalist Go web framework.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Revel](https://github.com/revel/revel) **star:11240** High-productivity web framework for the Go language.   ![star > 5000][Gold]
...
* [Gizmo](https://github.com/NYTimes/gizmo) **star:2842** Microservice toolkit used by the New York Times.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [Macaron](https://github.com/go-macaron/macaron) **star:2815** Macaron is a high productive and modular design web framework in Go.   ![star > 1000][Silver]
...
* [CORS](https://github.com/rs/cors) **star:1217** Easily add CORS capabilities to your API.   ![star > 1000][Silver]
...
* [httprouter](https://github.com/julienschmidt/httprouter) **star:9691** High performance router. Use this and the standard http handlers to form a very high performance web framework.   ![star > 5000][Gold]
* [mux](https://github.com/gorilla/mux) **star:9637** Powerful URL router and dispatcher for golang.   ![star > 5000][Gold]
* [chi](https://github.com/go-chi/chi) **star:6016** Small, fast and expressive HTTP router built on net/context.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [fasthttprouter](https://github.com/buaazp/fasthttprouter) **star:746** High performance router forked from `httprouter`. The first router fit for `fasthttp`.   ![star > 100][Bronze]
...
* [GoLint](https://github.com/golang/lint) **star:3145** Golint is a linter for Go source code.   ![star > 1000][Silver]
...
* [vim-go](https://github.com/fatih/vim-go) **star:10812** Go development plugin for Vim.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) **star:5105** Extension for Visual Studio Code (VS Code) which provides support for the Go language.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [GoSublime](https://github.com/DisposaBoy/GoSublime) **star:3233** Golang plugin collection for the text editor SublimeText 3 providing code completion and other IDE-like features.   ![star > 1000][Silver]
...
* [go-mode](https://github.com/dominikh/go-mode.el) **star:951** Go mode for GNU/Emacs.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [gotests](https://github.com/cweill/gotests) **star:2183** Generate Go tests from your source code.   ![star > 1000][Silver]
* [genny](https://github.com/cheekybits/genny) **star:961** Elegant generics for Go.   ![star > 100][Bronze]
...
* [go-swagger](https://github.com/go-swagger/go-swagger) **star:3971** Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [richgo](https://github.com/kyoh86/richgo) **star:388** Enrich `go test` outputs with text decorations.   ![star > 100][Bronze]
* [depth](https://github.com/KyleBanks/depth) **star:376** Visualize dependency trees of any package by analyzing imports.   ![star > 100][Bronze]
...
* [kubernetes](https://github.com/kubernetes/kubernetes) **star:56079** Container Cluster Manager from Google.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Moby](https://github.com/moby/moby) **star:54379** Collaborative project for the container ecosystem to assemble container-based systems.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [traefik](https://github.com/containous/traefik) **star:23652** Reverse proxy and load balancer with support for multiple backends.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [gitea-github-migrator](https://git.jonasfranz.software/JonasFranzDEV/gitea-github-migrator)  Migrate all your GitHub repositories, issues, milestones and labels to your Gitea instance.
* [Gitea](https://github.com/go-gitea/gitea) **star:15188** Fork of Gogs, entirely community driven.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [Vegeta](https://github.com/tsenart/vegeta) **star:12132** HTTP load testing tool and library. It's over 9000!   ![star > 5000][Gold]
...
* [Hey](https://github.com/rakyll/hey) **star:6276** Hey is a tiny program that sends some load to a web application.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [GVM](https://github.com/moovweb/gvm) **star:4468** GVM provides an interface to manage Go versions.   ![star > 1000][Silver]
* [Wide](https://wide.b3log.org/login)  Web-based IDE for Teams using Golang.
* [webhook](https://github.com/adnanh/webhook) **star:4076** Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.   ![star > 1000][Silver]
...
* [bombardier](https://github.com/codesenberg/bombardier) **star:1738** Fast cross-platform HTTP benchmarking tool.   ![star > 1000][Silver]
...
* [StatusOK](https://github.com/sanathp/statusok) **star:1162** Monitor your Website and REST APIs.Get Notified through Slack, E-mail when your server is down or response time is more than expected.   ![star > 1000][Silver]
* [s3gof3r](https://github.com/rlmcpherson/s3gof3r) **star:995** Small utility/library optimized for high speed transfer of large objects into and out of Amazon S3.   ![star > 100][Bronze]
* [script](https://github.com/bitfield/script) **star:915** Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.   ![star > 100][Bronze]
...
* [Pomerium](https://github.com/pomerium/pomerium) **star:496** Pomerium is an identity-aware access proxy.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) **star:8224** Fast, Simple and Scalable Distributed File System with O(1) disk seek.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [restic](https://github.com/restic/restic) **star:7426** De-duplicating backup program.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [LiteIDE](https://github.com/visualfc/liteide) **star:5484** LiteIDE is a simple, open source, cross-platform Go IDE.   ![star > 5000][Gold]   ![Contains Chinese documents][CN]
* [drive](https://github.com/odeke-em/drive) **star:4957** Google Drive client for the commandline.   ![star > 1000][Silver]
* [nes](https://github.com/fogleman/nes) **star:4124** Nintendo Entertainment System (NES) emulator written in Go.   ![star > 1000][Silver]
* [toxiproxy](https://github.com/shopify/toxiproxy) **star:3932** Proxy to simulate network and system conditions for automated tests.   ![star > 1000][Silver]
* [tsuru](https://tsuru.io/)  Extensible and open source Platform as a Service software.
* [Pipe](https://github.com/b3log/pipe) **star:2915** A small and beautiful blogging platform.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [Duplicacy](https://github.com/gilbertchen/duplicacy) **star:2687** A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.   ![star > 1000][Silver]
* [myLG](https://github.com/mehrdadrad/mylg) **star:2195** Command Line Network Diagnostic tool written in Go.   ![star > 1000][Silver]
...
* [gfile](https://github.com/Antonito/gfile) **star:498** Securely transfer files between two computers, without any third party, over WebRTC.   ![star > 100][Bronze]
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) **star:4440** Learn Go with test-driven development.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
