...
* [PortAudio](https://github.com/gordonklaus/portaudio) **star:302** Go bindings for the PortAudio audio I/O library.   ![star > 100][Bronze]
* [music-theory](https://github.com/go-music-theory/music-theory) **star:255** Music theory models in Go.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) **star:5992** Golang implementation of JSON Web Tokens (JWT).   ![star > 5000][Gold]
* [casbin](https://github.com/hsluoyz/casbin) **star:4953** Authorization library that supports access control models like ACL, RBAC, ABAC.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [oauth2](https://github.com/golang/oauth2) **star:2384** Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support.   ![star > 1000][Silver]
* [goth](https://github.com/markbates/goth) **star:2269** provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.   ![star > 1000][Silver]
* [authboss](https://github.com/volatiletech/authboss) **star:1934** Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time.   ![star > 1000][Silver]
* [osin](https://github.com/openshift/osin) **star:1544** Golang OAuth2 server library.   ![star > 1000][Silver]
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) **star:1281** Standalone, specification-compliant,  OAuth2 server written in Golang.   ![star > 1000][Silver]
* [go-jose](https://github.com/square/go-jose) **star:1125** Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.   ![star > 1000][Silver]
...
* [loginsrv](https://github.com/tarent/loginsrv) **star:815** JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam.   ![star > 100][Bronze]
...
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) **star:1627** Simple and clean Telegram bot client.   ![star > 1000][Silver]
...
* [slacker](https://github.com/shomali11/slacker) **star:309** Easy to use framework to create Slack bots.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [Kelp](https://github.com/stellar/kelp) **star:162** official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [cobra](https://github.com/spf13/cobra) **star:13317** Commander for modern Go CLI interactions.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [urfave/cli](https://github.com/urfave/cli) **star:11375** Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [go-flags](https://github.com/jessevdk/go-flags) **star:1508** go command line option parser.   ![star > 1000][Silver]
...
* [pflag](https://github.com/spf13/pflag) **star:749** Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.   ![star > 100][Bronze]
* [go-arg](https://github.com/alexflint/go-arg) **star:659** Struct-based argument parsing in Go.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [complete](https://github.com/posener/complete) **star:617** Write bash completions in Go + Go command bash completion.   ![star > 100][Bronze]
* [liner](https://github.com/peterh/liner) **star:586** Go readline-like library for command-line interfaces.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [cli](https://github.com/mkideal/cli) **star:478** Feature-rich and easy to use command-line package based on golang struct tags.   ![star > 100][Bronze]
...
* [ops](https://github.com/nanovms/ops) **star:263** Unikernel Builder/Orchestrator.   ![star > 100][Bronze]
...
* [cmdr](https://github.com/hedzr/cmdr) **star:14** A POSIX/GNU style, getopt-like command-line UI Go library.   ![There was an update last week][Green]
...
* [termui](https://github.com/gizak/termui) **star:8924** Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).   ![star > 5000][Gold]
* [gommon/color](https://github.com/labstack/gommon/tree/master/color)  Style terminal text.
* [gocui](https://github.com/jroimartin/gocui) **star:5376** Minimalist Go library aimed at creating Console User Interfaces.   ![star > 5000][Gold]
* [termbox-go](https://github.com/nsf/termbox-go) **star:3485** Termbox is a library for creating cross-platform text-based interfaces.   ![star > 1000][Silver]
* [color](https://github.com/fatih/color) **star:3018** Versatile package for colored terminal output.   ![star > 1000][Silver]   ![Archived][Archived]
* [go-prompt](https://github.com/c-bata/go-prompt) **star:2335** Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).   ![star > 1000][Silver]
* [uiprogress](https://github.com/gosuri/uiprogress) **star:1540** Flexible library to render progress bars in terminal applications.   ![star > 1000][Silver]
* [asciigraph](https://github.com/guptarohit/asciigraph) **star:1144** Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.   ![star > 1000][Silver]
...
* [progressbar](https://github.com/schollz/progressbar) **star:572** Basic thread-safe progress bar that works in every OS.   ![star > 100][Bronze]
...
* [go-colorable](https://github.com/mattn/go-colorable) **star:375** Colorable writer for windows.   ![star > 100][Bronze]
...
* [gookit/color](https://github.com/gookit/color) **star:202** Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows.   ![star > 100][Bronze]   ![Contains Chinese documents][CN]
...
* [simpletable](https://github.com/alexeyco/simpletable) **star:165** Simple tables in terminal with Go.   ![star > 100][Bronze]
...
* [viper](https://github.com/spf13/viper) **star:9322** Go configuration with fangs.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) **star:2407** Go library for managing configuration data from environment variables.   ![star > 1000][Silver]
* [godotenv](https://github.com/joho/godotenv) **star:2124** Go port of Ruby's dotenv library (Loads environment variables from `.env`).   ![star > 1000][Silver]
* [ini](https://github.com/go-ini/ini) **star:1595** Go package to read and write INI files.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [env](https://github.com/caarlos0/env) **star:870** Parse environment variables to Go structs (with defaults).   ![star > 100][Bronze]
...
* [gookit/config](https://github.com/gookit/config) **star:84** application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge.   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
...
* [xdg](https://github.com/OpenPeeDeeP/xdg) **star:36** Cross platform package that follows the [XDG Standard](https://standards.freedesktop.org/basedir-spec/basedir-spec-latest.html).
...
* [drone](https://github.com/drone/drone) **star:19032** Drone is a Continuous Integration platform built on Docker, written in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [gods](https://github.com/emirpasic/gods) **star:6401** Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.   ![star > 5000][Gold]
...
* [golang-set](https://github.com/deckarep/golang-set) **star:1171** Thread-Safe and Non-Thread-Safe high-performance sets for Go.   ![star > 1000][Silver]
...
* [willf/bloom](https://github.com/willf/bloom) **star:668** Go package implementing Bloom filters.   ![star > 100][Bronze]
* [roaring](https://github.com/RoaringBitmap/roaring) **star:662** Go package implementing compressed bitsets.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) **star:514** Cuckoo filter: a good alternative to a counting bloom filter implemented in Go.   ![star > 100][Bronze]
* [bitset](https://github.com/willf/bitset) **star:481** Go package implementing bitsets.   ![star > 100][Bronze]
...
* [ttlcache](https://github.com/diegobernardes/ttlcache) **star:97** In-memory LRU string-interface{} map with expiration for golang.
...
* [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) **star:26** Concurrent FIFO queue.
...
* [prometheus](https://github.com/prometheus/prometheus) **star:25563** Monitoring system and time series database.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [tidb](https://github.com/pingcap/tidb) **star:20065** TiDB is a distributed SQL database. Inspired by the design of Google F1.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [influxdb](https://github.com/influxdb/influxdb) **star:17113** Scalable datastore for metrics, events, and real-time analytics.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [cockroach](https://github.com/cockroachdb/cockroach) **star:16774** Scalable, Geo-Replicated, Transactional Datastore.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [dgraph](https://github.com/dgraph-io/dgraph) **star:10407** Scalable, Distributed, Low Latency, High Throughput Graph Database.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [bolt](https://github.com/boltdb/bolt) **star:9983** Low-level key/value database for Go.   ![star > 5000][Gold]   ![It hasn't been updated in the last year][Yellow]   ![Archived][Archived]
* [groupcache](https://github.com/golang/groupcache) **star:7659** Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.   ![star > 5000][Gold]
* [badger](https://github.com/dgraph-io/badger) **star:6276** Fast key-value store in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [rqlite](https://github.com/rqlite/rqlite) **star:4696** The lightweight, distributed, relational database built on SQLite.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [goleveldb](https://github.com/syndtr/goleveldb) **star:3167** Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [ledisdb](https://github.com/siddontang/ledisdb) **star:3077** Ledisdb is a high performance NoSQL like Redis based on LevelDB.   ![star > 1000][Silver]
* [go-cache](https://github.com/pmylund/go-cache) **star:2901** In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications.   ![star > 1000][Silver]
* [BigCache](https://github.com/allegro/bigcache) **star:2456** Efficient key/value cache for gigabytes of data.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [buntdb](https://github.com/tidwall/buntdb) **star:2438** Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.   ![star > 1000][Silver]
* [tiedot](https://github.com/HouzuoGuo/tiedot) **star:2365** Your NoSQL database powered by Golang.   ![star > 1000][Silver]
* [cache2go](https://github.com/muesli/cache2go) **star:1049** In-memory key:value cache which supports automatic invalidation based on timeouts.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) **star:1009** fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [GCache](https://github.com/bluele/gcache) **star:898** Cache library with support for expirable Cache, LFU, LRU and ARC.   ![star > 100][Bronze]
...
* [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) **star:876** CovenantSQL is a SQL database on blockchain.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [diskv](https://github.com/peterbourgon/diskv) **star:752** Home-grown disk-backed key-value store.   ![star > 100][Bronze]
...
* [fastcache](https://github.com/VictoriaMetrics/fastcache) **star:487** fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.   ![star > 100][Bronze]
...
* [Vasto](https://github.com/chrislusf/vasto) **star:148** A distributed high-performance key-value store. On Disk. Eventual consistent. HA. Able to grow or shrink without service interruption.   ![star > 100][Bronze]
...
* [migrate](https://github.com/golang-migrate/migrate) **star:2669** Database migrations. CLI and Golang library.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [sql-migrate](https://github.com/rubenv/sql-migrate) **star:1410** Database migration tool. Allows embedding migrations into the application using go-bindata.   ![star > 1000][Silver]
* [gormigrate](https://github.com/go-gormigrate/gormigrate) **star:333** Database schema migration helper for Gorm ORM.   ![star > 100][Bronze]
...
* [vitess](https://github.com/youtube/vitess) **star:8449** vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [pgweb](https://github.com/sosedoff/pgweb) **star:5987** Web-based PostgreSQL database browser.   ![star > 5000][Gold]
* [kingshard](https://github.com/flike/kingshard) **star:4607** kingshard is a high performance proxy for MySQL powered by Golang.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
* [orchestrator](https://github.com/github/orchestrator) **star:3029** MySQL replication topology manager & visualizer.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) **star:2400** Sync your MySQL data into Elasticsearch automatically.   ![star > 1000][Silver]
* [pREST](https://github.com/nuveo/prest) **star:2085** Serve a RESTful API from any PostgreSQL database.   ![star > 1000][Silver]
* [go-mysql](https://github.com/siddontang/go-mysql) **star:1889** Go toolset to handle MySQL protocol and replication.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) **star:138** Collects small insterts and sends big requests to ClickHouse servers.   ![star > 100][Bronze]
...
* [Squirrel](https://github.com/Masterminds/squirrel) **star:2317** Go library that helps you build SQL queries.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [xo](https://github.com/knq/xo) **star:2184** Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.   ![star > 1000][Silver]
* [gendry](https://github.com/didi/gendry) **star:759** Non-invasive SQL builder and powerful data binder.   ![star > 100][Bronze]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [goqu](https://github.com/doug-martin/goqu) **star:637** Idiomatic SQL builder and query library.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [Dotsql](https://github.com/gchaincl/dotsql) **star:438** Go library that helps you keep sql files in one place and use them with ease.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* Relational Databases
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) **star:8110** MySQL driver for Go.   ![star > 5000][Gold]
    * [pq](https://github.com/lib/pq) **star:5188** Pure Go Postgres driver for database/sql.   ![star > 5000][Gold]
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) **star:3427** SQLite3 driver for go that uses database/sql.   ![star > 1000][Silver]
    * [pgx](https://github.com/jackc/pgx) **star:1954** PostgreSQL driver supporting features beyond those exposed by database/sql.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* NoSQL Databases
    * [redis](https://github.com/go-redis/redis) **star:6505** Redis client for Golang.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [redigo](https://github.com/gomodule/redigo) **star:6281** Redigo is a Go client for the Redis database.   ![star > 5000][Gold]
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) **star:3106** Official MongoDB driver for the Go language.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [mgo](https://github.com/globalsign/mgo) **star:1639** (unmaintained) MongoDB driver for the Go language that implements a rich and well tested selection of features under a very simple API following standard Go idioms.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [gorethink](https://github.com/dancannon/gorethink) **star:1459** Go language driver for RethinkDB.   ![star > 1000][Silver]
    ...
    * [redeo](https://github.com/bsm/redeo) **star:259** Redis-protocol compatible TCP servers/services.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) **star:5835** Modern text indexing library for go.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [riot](https://github.com/go-ego/riot) **star:4700** Go Open Source, Distributed, Simple and efficient Search Engine.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
    * [elastic](https://github.com/olivere/elastic) **star:4143** Elasticsearch client for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) **star:1580** Official Elasticsearch client for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [elastigo](https://github.com/mattbaird/elastigo) **star:951** Elasticsearch client library.   ![star > 100][Bronze]
    * [elasticsql](https://github.com/cch123/elasticsql) **star:395** Convert sql to elasticsearch dsl in Go.   ![star > 100][Bronze]
...
* Multiple Backends.
    * [cayley](https://github.com/google/cayley) **star:12689** Graph database with support for multiple backends.   ![star > 5000][Gold]
    * [cachego](https://github.com/fabiorphp/cachego) **star:110** Golang Cache component for multiple drivers.   ![star > 100][Bronze]
    * [gokv](https://github.com/philippgille/gokv) **star:84** Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
...
* [now](https://github.com/jinzhu/now) **star:2187** Now is a time toolkit for golang.   ![star > 1000][Silver]
* [dateparse](https://github.com/araddon/dateparse) **star:895** Parse date's without knowing format in advance.   ![star > 100][Bronze]
* [carbon](https://github.com/uniplaces/carbon) **star:337** Simple Time extension with a lot of util methods, ported from PHP Carbon library.   ![star > 100][Bronze]
...
* [go-kit](https://github.com/go-kit/kit) **star:14438** Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [grpc-go](https://github.com/grpc/grpc-go) **star:9097** The Go language implementation of gRPC. HTTP/2 based RPC.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [jaeger](https://github.com/jaegertracing/jaeger) **star:8664** A distributed tracing system.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [micro](https://github.com/micro/micro) **star:6592** Pluggable microservice toolkit and distributed systems platform.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [NATS](https://github.com/nats-io/gnatsd) **star:6342** Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [rpcx](https://github.com/smallnest/rpcx) **star:3795** Distributed pluggable RPC service framework like alibaba Dubbo.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [tendermint](https://github.com/tendermint/tendermint) **star:3133** High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [raft](https://github.com/coreos/etcd/tree/master/raft)  Go implementation of the Raft consensus protocol, by CoreOS.
* [raft](https://github.com/hashicorp/raft) **star:2842** Golang implementation of the Raft consensus protocol, by HashiCorp.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [torrent](https://github.com/anacrolix/torrent) **star:2842** BitTorrent client package.   ![star > 1000][Silver]
* [dragonboat](https://github.com/lni/dragonboat) **star:2534** A feature complete and high performance multi-group Raft library in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [glow](https://github.com/chrislusf/glow) **star:2526** Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go.   ![star > 1000][Silver]
* [gleam](https://github.com/chrislusf/gleam) **star:2095** Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.   ![star > 1000][Silver]
* [emitter-io](https://github.com/emitter-io/emitter) **star:1933** High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [KrakenD](https://github.com/devopsfaith/krakend) **star:1750** Ultra performant API Gateway framework with middlewares.   ![star > 1000][Silver]
* [hprose](https://github.com/hprose/hprose-golang) **star:1005** Very newbility RPC Library, support 25+ languages now.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
...
* [consistent](https://github.com/buraksezer/consistent) **star:190** Consistent hashing with bounded loads.   ![star > 100][Bronze]
...
* [MailHog](https://github.com/mailhog/MailHog) **star:5165** Email and SMTP testing with web and API interface.   ![star > 5000][Gold]
* [chasquid](https://blitiri.com.ar/p/chasquid)  SMTP server written in Go.
* [hermes](https://github.com/matcornic/hermes) **star:1617** Golang package that generates clean, responsive HTML e-mails.   ![star > 1000][Silver]
* [email](https://github.com/jordan-wright/email) **star:1093** A robust and flexible email library for Go.   ![star > 1000][Silver]
* [go-imap](https://github.com/emersion/go-imap) **star:733** IMAP library for clients and servers.   ![star > 100][Bronze]
...
* [go-message](https://github.com/emersion/go-message) **star:112** Streaming library for the Internet Message Format and mail messages.   ![star > 100][Bronze]
...
* [otto](https://github.com/robertkrimen/otto) **star:4724** JavaScript interpreter written in Go.   ![star > 1000][Silver]
* [gopher-lua](https://github.com/yuin/gopher-lua) **star:2961** Lua 5.1 VM and compiler written in Go.   ![star > 1000][Silver]
* [go-lua](https://github.com/Shopify/go-lua) **star:1670** Port of the Lua 5.2 VM to pure Go.   ![star > 1000][Silver]
* [tengo](https://github.com/d5/tengo) **star:1299** Bytecode compiled script language for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [expr](https://github.com/antonmedv/expr) **star:699** an engine that can evaluate expressions.   ![star > 100][Bronze]
* [go-php](https://github.com/deuill/go-php) **star:680** PHP bindings for Go.   ![star > 100][Bronze]
...
* [agora](https://github.com/PuerkitoBio/agora) **star:321** Dynamically typed, embeddable programming language in Go.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]   ![Archived][Archived]
* [gval](https://github.com/PaesslerAG/gval) **star:136** A highly customizable expression language written in Go.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [errors](https://github.com/pkg/errors) **star:4887** Package that provides simple error handling primitives.   ![star > 1000][Silver]
* [go-multierror](https://github.com/hashicorp/go-multierror) **star:729** Go (golang) package for representing a list of errors as a single error.   ![star > 100][Bronze]
...
* [afero](https://github.com/spf13/afero) **star:2233** FileSystem Abstraction System for Go.   ![star > 1000][Silver]
* [pdfcpu](https://github.com/hhrutter/pdfcpu) **star:947** PDF processor.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [decimal](https://github.com/shopspring/decimal) **star:1598** Arbitrary-precision fixed-point decimal numbers.   ![star > 1000][Silver]
...
* [nosurf](https://github.com/justinas/nosurf) **star:972** CSRF protection middleware for Go.   ![star > 100][Bronze]
...
* [gorilla/csrf](https://github.com/gorilla/csrf) **star:435** CSRF protection for Go web applications & services.   ![star > 100][Bronze]
...
* [Leaf](https://github.com/name5566/leaf) **star:3061** Lightweight game server framework.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
* [Pixel](https://github.com/faiface/pixel) **star:2435** Hand-crafted 2D game library in Go.   ![star > 1000][Silver]
* [Ebiten](https://github.com/hajimehoshi/ebiten) **star:1852** dead simple 2D game library in Go.   ![star > 1000][Silver]
* [goworld](https://github.com/xiaonanln/goworld) **star:1194** Scalable game server engine, featuring space-entity framework and hot-swapping.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
* [go-sdl2](https://github.com/veandco/go-sdl2) **star:1159** Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [nano](https://github.com/lonng/nano) **star:996** Lightweight, facility, high performance golang based game server framework.   ![star > 100][Bronze]   ![Contains Chinese documents][CN]
* [g3n](https://github.com/g3n/engine) **star:751** Go 3D Game Engine.   ![star > 100][Bronze]
...
* [GarageEngine](https://github.com/vova616/GarageEngine) **star:313** 2d game engine written in Go working on OpenGL.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [jennifer](https://github.com/dave/jennifer) **star:1273** Generate arbitrary Go code without templates.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [gen](https://github.com/clipperhouse/gen) **star:1036** Code generation tool for ‘generics’-like functionality.   ![star > 1000][Silver]   ![It hasn't been updated in the last year][Yellow]
* [goderive](https://github.com/awalterschulze/goderive) **star:744** Derives functions from input types.   ![star > 100][Bronze]
...
* [gotype](https://github.com/wzshiming/gotype) **star:22** Golang source code parsing, usage like reflect package.   ![Contains Chinese documents][CN]
...
* [Tile38](https://github.com/tidwall/tile38) **star:6331** Geolocation DB with spatial index and realtime geofencing.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [gopherjs](https://github.com/gopherjs/gopherjs) **star:8541** Compiler from Go to JavaScript.   ![star > 5000][Gold]
...
* [goworker](https://github.com/benmanns/goworker) **star:2251** goworker is a Go-based background worker.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [ants](https://github.com/panjf2000/ants) **star:1886** A high-performance goroutine pool for golang.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
* [tunny](https://github.com/Jeffail/tunny) **star:1345** Goroutine pool for golang.   ![star > 1000][Silver]
* [grpool](https://github.com/ivpusic/grpool) **star:500** Lightweight Goroutine pool.   ![star > 100][Bronze]
...
* [ui](https://github.com/andlabs/ui) **star:6949** Platform-native GUI library for Go. Cross platform.   ![star > 5000][Gold]
* [Wails](https://wails.app)  Mac, Windows, Linux desktop apps with HTML UI using built-in OS HTML renderer.
* [fyne](https://github.com/fyne-io/fyne) **star:6280** Cross platform native GUIs designed for Go, rendered using EFL. Supports: Linux, macOS, Windows.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [qt](https://github.com/therecipe/qt) **star:6056** Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).   ![star > 5000][Gold]   ![There was an update last week][Green]
* [webview](https://github.com/zserge/webview) **star:4654** Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).   ![star > 1000][Silver]
* [walk](https://github.com/lxn/walk) **star:3692** Windows application library kit for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [app](https://github.com/murlokswarm/app) **star:2953** Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.   ![star > 1000][Silver]
* [go-astilectron](https://github.com/asticode/go-astilectron) **star:2663** Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron).   ![star > 1000][Silver]
...
* [gotk3](https://github.com/gotk3/gotk3) **star:771** Go bindings for GTK3.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [gowd](https://github.com/dtylman/gowd) **star:209** Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform.   ![star > 100][Bronze]

*Interaction*

* [robotgo](https://github.com/go-vgo/robotgo) **star:4427** Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.   ![star > 1000][Silver]
* [systray](https://github.com/getlantern/systray) **star:785** Cross platform Go library to place an icon and menu in the notification area.   ![star > 100][Bronze]
...
* [bild](https://github.com/anthonynsimon/bild) **star:2539** Collection of image processing algorithms in pure Go.   ![star > 1000][Silver]
* [imaging](https://github.com/disintegration/imaging) **star:2522** Simple Go image processing package.   ![star > 1000][Silver]
* [ln](https://github.com/fogleman/ln) **star:2460** 3D line art rendering in Go.   ![star > 1000][Silver]
* [gocv](https://github.com/hybridgroup/gocv) **star:2449** Go package for computer vision using OpenCV 3.3+.   ![star > 1000][Silver]
...
* [gg](https://github.com/fogleman/gg) **star:1913** 2D rendering in pure Go.   ![star > 1000][Silver]
* [pt](https://github.com/fogleman/pt) **star:1772** Path tracing engine written in Go.   ![star > 1000][Silver]
* [svgo](https://github.com/ajstarks/svgo) **star:1332** Go Language Library for SVG generation.   ![star > 1000][Silver]
* [smartcrop](https://github.com/muesli/smartcrop) **star:1259** Finds good crops for arbitrary images and crop sizes.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [picfit](https://github.com/thoas/picfit) **star:1067** An image resizing server written in Go.   ![star > 1000][Silver]
...
* [imagick](https://github.com/gographics/imagick) **star:975** Go binding to ImageMagick's MagickWand C API.   ![star > 100][Bronze]
* [bimg](https://github.com/h2non/bimg) **star:794** Small package for fast and efficient image processing using libvips.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [stegify](https://github.com/DimitarPetrov/stegify) **star:503** Go tool for LSB steganography, capable of hiding any file within an image.   ![star > 100][Bronze]
...
* [flogo](https://github.com/tibcosoftware/flogo) **star:1126** Project Flogo is an Open Source Framework for IoT Edge Apps & Integration.   ![star > 1000][Silver]
* [gatt](https://github.com/paypal/gatt) **star:816** Gatt is a Go package for building Bluetooth Low Energy peripherals.   ![star > 100][Bronze]
* [gobot](https://github.com/hybridgroup/gobot/)  Gobot is a framework for robotics, physical computing, and the Internet of Things.
* [mainflux](https://github.com/Mainflux/mainflux) **star:590** Industrial IoT Messaging and Device Management Server.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [gron](https://github.com/roylee0704/gron) **star:632** Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly.   ![star > 100][Bronze]
* [JobRunner](https://github.com/bamzi/jobrunner) **star:569** Smart and featureful cron job scheduler with job queuing and live monitoring built in.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [GJSON](https://github.com/tidwall/gjson) **star:4896** Get a JSON value with one line of code.   ![star > 1000][Silver]
...
* [logrus](https://github.com/Sirupsen/logrus) **star:11937** Structured logger for Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [zap](https://github.com/uber-go/zap) **star:7443** Fast, structured, leveled logging in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [spew](https://github.com/davecgh/go-spew) **star:3308** Implements a deep pretty printer for Go data structures to aid in debugging.   ![star > 1000][Silver]
...
* [zerolog](https://github.com/rs/zerolog) **star:2214** Zero-allocation JSON logger.   ![star > 1000][Silver]
* [tail](https://github.com/hpcloud/tail) **star:1539** Go package striving to emulate the features of the BSD tail program.   ![star > 1000][Silver]
* [lumberjack](https://github.com/natefinch/lumberjack) **star:1440** Simple rolling logger, implements io.WriteCloser.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [seelog](https://github.com/cihub/seelog) **star:1359** Logging functionality with flexible dispatching, filtering, and formatting.   ![star > 1000][Silver]
...
* [gologger](https://github.com/sadlil/gologger) **star:39** Simple easy to use log lib for go, logs in Colored Console, Simple Console, File or Elasticsearch.   ![It hasn't been updated in the last year][Yellow]   ![Archived][Archived]
...
* [GoLearn](https://github.com/sjwhitworth/golearn) **star:6652** General Machine Learning library for Go.   ![star > 5000][Gold]   ![Contains Chinese documents][CN]
* [gorgonia](https://github.com/chewxy/gorgonia) **star:2691** graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [tfgo](https://github.com/galeone/tfgo) **star:1185** Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python.   ![star > 1000][Silver]
* [goml](https://github.com/cdipaolo/goml) **star:1012** On-line Machine Learning in Go.   ![star > 1000][Silver]
* [gosseract](https://github.com/otiai10/gosseract) **star:872** Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [eaopt](https://github.com/MaxHalford/eaopt) **star:621** An evolutionary optimization library.   ![star > 100][Bronze]
* [gorse](https://github.com/zhenghaoz/gorse) **star:535** A High Performance Recommender System Package based on Collaborative Filtering for Go.   ![star > 100][Bronze]   ![Contains Chinese documents][CN]
...
* [goscore](https://github.com/asafschers/goscore) **star:36** Go Scoring API for PMML.
...
* [sarama](https://github.com/Shopify/sarama) **star:4617** Go library for Apache Kafka.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [gorush](https://github.com/appleboy/gorush) **star:3711** Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).   ![star > 1000][Silver]
...
* [machinery](https://github.com/RichardKnop/machinery) **star:3371** Asynchronous task queue/job queue based on distributed message passing.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [go-socket.io](https://github.com/googollee/go-socket.io) **star:2883** socket.io library for golang, a realtime application framework.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [Benthos](https://github.com/Jeffail/benthos) **star:2011** A message streaming bridge between a range of protocols.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [Mercure](https://github.com/dunglas/mercure) **star:1506** Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).   ![star > 1000][Silver]   ![There was an update last week][Green]
* [go-nsq](https://github.com/nsqio/go-nsq) **star:1455** the official Go package for NSQ.   ![star > 1000][Silver]
...
* [Gollum](https://github.com/trivago/gollum) **star:768** A n:m multiplexer that gathers messages from different sources and broadcasts them to a set of destinations.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [Beaver](https://github.com/Clivern/Beaver) **star:725** A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps.   ![star > 100][Bronze]
...
* [pubsub](https://github.com/tuxychandru/pubsub) **star:279** Simple pubsub package for go.   ![star > 100][Bronze]
...
* [unioffice](https://github.com/unidoc/unioffice) **star:1714** Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.   ![star > 1000][Silver]   ![There was an update last week][Green]

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) **star:4460** Golang library for reading and writing Microsoft Excel™ (XLSX) files.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [xlsx](https://github.com/tealeg/xlsx) **star:3411** Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [xlsx](https://github.com/plandem/xlsx) **star:72** Fast and safe way to read/update your existing Microsoft Excel files in Go programs.
...
* [dig](https://github.com/uber-go/dig) **star:909** A reflection based dependency injection toolkit for Go.   ![star > 100][Bronze]
* [fx](https://github.com/uber-go/fx) **star:751** A dependency injection based application framework for Go (built on top of dig).   ![star > 100][Bronze]
...
* [linker](https://github.com/logrange/linker) **star:7** A reflection based dependency injection and inversion of control library with components lifecycle support.

### Project Layout

*Unofficial set of patterns for structuring projects.*

* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) **star:9127** Set of common historical and emerging project layout patterns in the Go ecosystem.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [gopsutil](https://github.com/shirou/gopsutil) **star:3930** Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).   ![star > 1000][Silver]   ![There was an update last week][Green]
* [archiver](https://github.com/mholt/archiver) **star:2487** Library and command for making and extracting .zip and .tar.gz archives.   ![star > 1000][Silver]
...
* [go-resiliency](https://github.com/eapache/go-resiliency) **star:856** Resiliency patterns for golang.   ![star > 100][Bronze]
* [go-openapi](https://github.com/go-openapi)  Collection of packages to parse and utilize open-api schemas.
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) **star:670** Generic object pool for Golang.   ![star > 100][Bronze]   ![Contains Chinese documents][CN]
...
* [gofakeit](https://github.com/brianvoe/gofakeit) **star:418** Random data generator written in go.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [llvm](https://github.com/llir/llvm) **star:411** Library for interacting with LLVM IR in pure Go.   ![star > 100][Bronze]
...
* [banner](https://github.com/dimiro1/banner) **star:232** Add beautiful banners into your Go applications.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [ghorg](https://github.com/gabrie30/ghorg) **star:29** Clone all repos from a GitHub org into a single directory.   ![There was an update last week][Green]
...
* [gse](https://github.com/go-ego/gse) **star:1071** Go efficient text segmentation; support english, chinese, japanese and other.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
...
* [kcptun](https://github.com/xtaci/kcptun) **star:10669** Extremely simple & fast udp tunnel based on KCP protocol.   ![star > 5000][Gold]
* [fasthttp](https://github.com/valyala/fasthttp) **star:9369** Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [dns](https://github.com/miekg/dns) **star:3802** Go library for working with DNS.   ![star > 1000][Silver]
* [HTTPLab](https://github.com/gchaincl/httplab) **star:3406** HTTPLabs let you inspect HTTP requests and forge responses.   ![star > 1000][Silver]
* [quic-go](https://github.com/lucas-clemente/quic-go) **star:2916** An implementation of the QUIC protocol in pure Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [gopacket](https://github.com/google/gopacket) **star:2880** Go library for packet processing with libpcap bindings.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [webrtc](https://github.com/pions/webrtc) **star:2259** A pure Go implementation of the WebRTC API.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [kcp-go](https://github.com/xtaci/kcp-go) **star:2244** KCP - Fast and Reliable ARQ Protocol.   ![star > 1000][Silver]
* [gobgp](https://github.com/osrg/gobgp) **star:1690** BGP implemented in the Go Programming Language.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [ssh](https://github.com/gliderlabs/ssh) **star:1111** Higher-level API for building SSH servers (wraps crypto/ssh).   ![star > 1000][Silver]
* [fortio](https://github.com/fortio/fortio) **star:875** Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.   ![star > 100][Bronze]
* [water](https://github.com/songgao/water) **star:841** Simple TUN/TAP library.   ![star > 100][Bronze]
* [sftp](https://github.com/pkg/sftp) **star:738** Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt.   ![star > 100][Bronze]
* [go-getter](https://github.com/hashicorp/go-getter) **star:725** Go library for downloading files or directories from various sources using a URL.   ![star > 100][Bronze]
* [NFF-Go](https://github.com/intel-go/nff-go) **star:664** Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF).   ![star > 100][Bronze]
...
* [gosnmp](https://github.com/soniah/gosnmp) **star:436** Native Go library for performing SNMP actions.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [gotcp](https://github.com/gansidui/gotcp) **star:417** Go package for quickly writing tcp applications.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [stun](https://github.com/go-rtc/stun) **star:277** Go implementation of RFC 5389 STUN protocol.   ![star > 100][Bronze]
...
* [gNxI](https://github.com/google/gnxi) **star:99** A collection of tools for Network Management that use the gNMI and gNOI protocols.
* [gmqtt](https://github.com/DrmagicE/gmqtt) **star:89** Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.   ![Contains Chinese documents][CN]
...
* [grequests](https://github.com/levigross/grequests) **star:1414** A Go "clone" of the great and famous Requests library.   ![star > 1000][Silver]
* [heimdall](https://github.com/gojektech/heimdall) **star:1076** An enchanced http client with retry and hystrix capabilities.   ![star > 1000][Silver]
* [sling](https://github.com/dghubble/sling) **star:1004** Sling is a Go HTTP client library for creating and sending API requests.   ![star > 1000][Silver]
* [gentleman](https://github.com/h2non/gentleman) **star:678** Full-featured plugin-driven HTTP client library.   ![star > 100][Bronze]
* [pester](https://github.com/sethgrid/pester) **star:331** Go HTTP client calls with retries, backoff, and concurrency.   ![star > 100][Bronze]
...
* [GORM](https://github.com/jinzhu/gorm) **star:14661** The fantastic ORM library for Golang, aims to be developer friendly.   ![star > 5000][Gold]
* [Xorm](https://github.com/go-xorm/xorm) **star:5204** Simple and powerful ORM for Go.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [gorp](https://github.com/go-gorp/gorp) **star:3077** Go Relational Persistence, ORM-ish library for Go.   ![star > 1000][Silver]
* [go-pg](https://github.com/go-pg/pg) **star:2997** PostgreSQL ORM with focus on PostgreSQL specific features and performance.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) **star:2273** ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.   ![star > 1000][Silver]
...
* [pop/soda](https://github.com/gobuffalo/pop) **star:677** Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.   ![star > 100][Bronze]
...
* [dep](https://github.com/golang/dep) **star:12560** Go dependency tool.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [vgo](https://go.googlesource.com/vgo/)  Versioned Go.

*Unofficial libraries for package and dependency management.*

* [glide](https://github.com/Masterminds/glide) **star:7781** Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip.   ![star > 5000][Gold]
...
* [govendor](https://github.com/kardianos/govendor) **star:4738** Go Package Manager. Go vendor tool that works with the standard vendor file.   ![star > 1000][Silver]
* [gopm](https://github.com/gpmgo/gopm) **star:2361** Go Package Manager.   ![star > 1000][Silver]   ![Archived][Archived]
...
* [graphql-go](https://github.com/graphql-go/graphql) **star:5223** Implementation of GraphQL for Go.   ![star > 5000][Gold]
* [graphql](https://github.com/neelance/graphql-go) **star:2783** GraphQL server with a focus on ease of use.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [packr](https://github.com/gobuffalo/packr) **star:2118** The simple and easy way to embed static files into Go binaries.   ![star > 1000][Silver]
* [statik](https://github.com/rakyll/statik) **star:2107** Embeds static files into a Go executable.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [go.rice](https://github.com/GeertJohan/go.rice) **star:1647** go.rice is a Go package that makes working with resources such as html,js,css,images and templates very easy.   ![star > 1000][Silver]
* [vfsgen](https://github.com/shurcooL/vfsgen) **star:655** Generates a vfsdata.go file that statically implements the given virtual filesystem.   ![star > 100][Bronze]
...
* [gonum](https://github.com/gonum/gonum) **star:2958** Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [gonum/plot](https://github.com/gonum/plot) **star:1215** gonum/plot provides an API for building and drawing plots in Go.   ![star > 1000][Silver]
* [go-dsp](https://github.com/mjibson/go-dsp) **star:627** Digital Signal Processing for Go.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [orb](https://github.com/paulmach/orb) **star:199** 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.   ![star > 100][Bronze]
...
* [lego](https://github.com/xenolf/lego) **star:3482** Pure Go ACME client library and CLI tool (for use with Let's Encrypt).   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [memguard](https://github.com/awnumar/memguard) **star:1508** A pure Go library for handling sensitive values in memory.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [secure](https://github.com/unrolled/secure) **star:1208** HTTP middleware for Go that facilitates some quick security wins.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [jsoniter](https://github.com/json-iterator/go) **star:5541** High-performance 100% compatible drop-in replacement of "encoding/json".   ![star > 5000][Gold]
* [goprotobuf](https://github.com/golang/protobuf) **star:5090** Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) **star:2955** Protocol Buffers for Go with Gadgets.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [mapstructure](https://github.com/mitchellh/mapstructure) **star:2430** Go library for decoding generic map values into native Go structures.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [etcd](https://github.com/coreos/etcd) **star:26510** Highly-available key value store for shared configuration and service discovery.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Caddy](https://github.com/mholt/caddy) **star:23170** Caddy is an alternative, HTTP/2 web server that's easy to configure and use.   ![star > 5000][Gold]
* [consul](https://www.consul.io/)  Consul is a tool for service discovery, monitoring and configuration.
* [minio](https://github.com/minio/minio) **star:17497** Minio is a distributed object storage server.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [yakvs](https://git.sci4me.com/sci4me/yakvs)  Small, networked, in-memory key-value store.
* [RoadRunner](https://github.com/spiral/roadrunner) **star:3289** High-performance PHP application server, load-balancer and process manager.   ![star > 1000][Silver]
...
* [flipt](https://github.com/markphelps/flipt) **star:990** A self contained feature flag solution written in Go and Vue.js   ![star > 100][Bronze]   ![There was an update last week][Green]
* [Flagr](https://github.com/checkr/flagr) **star:825** Flagr is an open-source feature flagging and A/B testing service.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [jackal](https://github.com/ortuman/jackal) **star:717** An XMPP server written in Go.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [discovery](https://github.com/Bilibili/discovery) **star:674** A registry for resilient mid-tier load balancing and failover.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [gofpdf](https://github.com/jung-kurt/gofpdf) **star:3076** PDF document generator with high level support for text, drawing and images.   ![star > 1000][Silver]
* [pongo2](https://github.com/flosch/pongo2) **star:1488** Django-like template-engine for Go.   ![star > 1000][Silver]
* [quicktemplate](https://github.com/valyala/quicktemplate) **star:1407** Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.   ![star > 1000][Silver]
* [hero](https://github.com/shiyanhui/hero) **star:1204** Hero is a handy, fast and powerful go template engine.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
...
* [ace](https://github.com/yosssi/ace) **star:762** Ace is an HTML template engine for Go, inspired by Slim and Jade. Ace is a refinement of Gold.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [raymond](https://github.com/aymerick/raymond) **star:340** Complete handlebars implementation in Go.   ![star > 100][Bronze]
...
* Testing Frameworks
    ...
    * [Testify](https://github.com/stretchr/testify) **star:8146** Sacred extension to the standard go testing package.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [go-cmp](https://github.com/google/go-cmp) **star:1157** Package for comparing Go values in tests.   ![star > 1000][Silver]   ![There was an update last week][Green]
    ...
    * [godog](https://github.com/DATA-DOG/godog) **star:756** Cucumber or Behat like BDD framework for Go.   ![star > 100][Bronze]
    ...
    * [testfixtures](https://github.com/go-testfixtures/testfixtures) **star:327** A helper for Rails' like test fixtures to test database applications.   ![star > 100][Bronze]
    * [go-mutesting](https://github.com/zimmski/go-mutesting) **star:291** Mutation testing for Go source code.   ![star > 100][Bronze]
    * [gofight](https://github.com/appleboy/gofight) **star:256** API Handler Testing for Golang Router framework.   ![star > 100][Bronze]
    ...
    * [gotest.tools](https://github.com/gotestyourself/gotest.tools) **star:120** A collection of packages to augment the go testing package and support common patterns.   ![star > 100][Bronze]
    ...
    * [endly](https://github.com/viant/endly) **star:93** Declarative end to end functional testing.
...
* Mock
    * [gomock](https://github.com/golang/mock) **star:2850** Mocking framework for the Go programming language.   ![star > 1000][Silver]
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) **star:1743** Mock SQL driver for testing database interactions.   ![star > 1000][Silver]
    * [hoverfly](https://github.com/SpectoLabs/hoverfly) **star:1438** HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI.   ![star > 1000][Silver]
    * [gock](https://github.com/h2non/gock) **star:818** Versatile HTTP mocking made easy.   ![star > 100][Bronze]
    ...
    * [go-txdb](https://github.com/DATA-DOG/go-txdb) **star:163** Single transaction based database driver mainly for testing purposes.   ![star > 100][Bronze]
...
* Fuzzing and delta-debugging/reducing/shrinking.
    * [go-fuzz](https://github.com/dvyukov/go-fuzz) **star:2886** Randomized testing system.   ![star > 1000][Silver]
...
* Selenium and browser control tools.
    * [chromedp](https://github.com/knq/chromedp) **star:3585** a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.   ![star > 1000][Silver]
...
* Fail injection
    * [failpoint](https://github.com/pingcap/failpoint) **star:388** An implementation of [failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail) for Golang.   ![star > 100][Bronze]
...
* Specific Formats
    * [colly](https://github.com/asciimoo/colly) **star:8411** Fast and Elegant Scraping Framework for Gophers.   ![star > 5000][Gold]
    * [GoQuery](https://github.com/PuerkitoBio/goquery) **star:7584** GoQuery brings a syntax and a set of features similar to jQuery to the Go language.   ![star > 5000][Gold]
    * [blackfriday](https://github.com/russross/blackfriday) **star:3893** Markdown processor in Go.   ![star > 1000][Silver]
    * [toml](https://github.com/BurntSushi/toml) **star:2786** TOML configuration format (encoder/decoder with reflection).   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [sh](https://github.com/mvdan/sh) **star:1996** Shell parser and formatter.   ![star > 1000][Silver]
    * [go-humanize](https://github.com/dustin/go-humanize) **star:1900** Formatters for time, numbers, and memory size to human readable format.   ![star > 1000][Silver]
    * [bluemonday](https://github.com/microcosm-cc/bluemonday) **star:1251** HTML Sanitizer.   ![star > 1000][Silver]
    * [inject](https://github.com/facebookgo/inject) **star:1139** Package inject provides a reflect based injector.   ![star > 1000][Silver]   ![Archived][Archived]
    ...
    * [gographviz](https://github.com/awalterschulze/gographviz) **star:300** Parses the Graphviz DOT language.   ![star > 100][Bronze]
    ...
    * [htmlquery](https://github.com/antchfx/htmlquery) **star:130** An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression.   ![star > 100][Bronze]
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) **star:5024** The official AWS SDK for the Go programming language.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [github](https://github.com/google/go-github) **star:4763** Go library for accessing the GitHub REST API v3.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [slack](https://github.com/nlopes/slack) **star:2421** Slack API in Go.   ![star > 1000][Silver]
* [google](https://github.com/google/google-api-go-client) **star:1923** Auto-generated Google APIs for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) **star:1785** Google Cloud APIs Go Client Library.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [anaconda](https://github.com/ChimeraCoder/anaconda) **star:988** Go client library for the Twitter 1.1 API.   ![star > 100][Bronze]
* [discordgo](https://github.com/bwmarrin/discordgo) **star:967** Go bindings for the Discord Chat API.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [stripe](https://github.com/stripe/stripe-go) **star:942** Go client for the Stripe API.   ![star > 100][Bronze]
* [facebook](https://github.com/huandu/facebook) **star:771** Go Library that supports the Facebook Graph API.   ![star > 100][Bronze]
* [minio-go](https://github.com/minio/minio-go) **star:719** Minio Go Library for Amazon S3 compatible cloud storage.   ![star > 100][Bronze]
* [go-twitter](https://github.com/dghubble/go-twitter) **star:712** Go client library for the Twitter v1.1 APIs.   ![star > 100][Bronze]
...
* [fzf](https://github.com/junegunn/fzf) **star:23153** Command-line fuzzy finder written in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [hub](https://github.com/github/hub) **star:16965** wrap git commands with additional functionality to interact with github from the terminal.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [delve](https://github.com/derekparker/delve) **star:12033** Go debugger.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [ctop](https://github.com/bcicen/ctop) **star:8825** [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics.   ![star > 5000][Gold]
* [wuzz](https://github.com/asciimoo/wuzz) **star:8257** Interactive cli tool for HTTP inspection.   ![star > 5000][Gold]
* [sqlx](https://github.com/jmoiron/sqlx) **star:6806** provides a set of extensions on top of the excellent built-in database/sql package.   ![star > 5000][Gold]
* [peco](https://github.com/peco/peco) **star:5468** Simplistic interactive filtering tool.   ![star > 5000][Gold]
* [usql](https://github.com/knq/usql) **star:4673** usql is a universal command-line interface for SQL databases.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [goreleaser](https://github.com/goreleaser/goreleaser) **star:4500** Deliver Go binaries as fast and easily as possible.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [go-torch](https://github.com/uber/go-torch) **star:3635** Stochastic flame graph profiler for Go programs.   ![star > 1000][Silver]   ![Archived][Archived]
* [realize](https://github.com/tockins/realize) **star:3163** Go build system with file watchers and live reload. Run, build and watch file changes with custom paths.   ![star > 1000][Silver]
...
* [go-funk](https://github.com/thoas/go-funk) **star:1185** Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).   ![star > 1000][Silver]
* [mc](https://github.com/minio/mc) **star:1116** Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [profile](https://github.com/pkg/profile) **star:1011** Simple profiling support package for Go.   ![star > 1000][Silver]
* [filetype](https://github.com/h2non/filetype) **star:949** Small package to infer the file type checking the magic numbers signature.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [spinner](https://github.com/briandowns/spinner) **star:783** Go package to easily provide a terminal spinner with options.   ![star > 100][Bronze]
...
* [jump](https://github.com/gsamokovarov/jump) **star:660** Jump helps you navigate faster by learning your habits.   ![star > 100][Bronze]
...
* [ergo](https://github.com/cristianoliveira/ergo) **star:310** The management of multiple local services running over different ports made easy.   ![star > 100][Bronze]
* [koazee](https://github.com/wesovilabs/koazee) **star:295** Library inspired in Lazy evaluation and functional programming that takes the hassle out of working with arrays.   ![star > 100][Bronze]
...
* [gohper](https://github.com/cosiner/gohper) **star:248** Various tools/modules help for development.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]   ![Archived][Archived]
...
* [retry](https://github.com/kamilsk/retry) **star:160** The most advanced functional mechanism to perform actions repetitively until successful.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [robustly](https://github.com/VividCortex/robustly) **star:135** Runs functions resiliently, catching and restarting panics.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [ulid](https://github.com/oklog/ulid) **star:1673** Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).   ![star > 1000][Silver]
* [uniq](https://gitlab.com/skilstak/code/go/uniq)  No hassle safe, fast unique identifiers with commands. 
* [uuid](https://github.com/gofrs/uuid) **star:568** Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.   ![star > 100][Bronze]
* [wuid](https://github.com/edwingeng/wuid) **star:287** An extremely fast unique number generator, 10-135 times faster than UUID.   ![star > 100][Bronze]
...
* [govalidator](https://github.com/asaskevich/govalidator) **star:3553** Validators and sanitizers for strings, numerics, slices and structs.   ![star > 1000][Silver]
* [validator](https://github.com/go-playground/validator) **star:3519** Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) **star:1048** Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.   ![star > 1000][Silver]
* [govalidator](https://github.com/thedevsaddam/govalidator) **star:716** Validate Golang request data with simple rules. Highly inspired by Laravel's request validation.   ![star > 100][Bronze]
* [validate](https://github.com/gookit/validate) **star:94** Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features.   ![Contains Chinese documents][CN]
...
* [go-git](https://github.com/src-d/go-git) **star:4276** highly extensible Git implementation in pure Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [git2go](https://github.com/libgit2/git2go) **star:1363** Go bindings for libgit2.   ![star > 1000][Silver]
* [hercules](https://github.com/src-d/hercules) **star:529** gaining advanced insights from Git repository history.   ![star > 100][Bronze]
...
* [goav](https://github.com/giorgisio/goav) **star:787** Comphrensive Go bindings for FFmpeg.   ![star > 100][Bronze]
...
* [Gin](https://github.com/gin-gonic/gin) **star:29978** Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Beego](https://github.com/astaxie/beego) **star:21468** beego is an open-source, high-performance web framework for the Go programming language.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [Buffalo](http://gobuffalo.io)  Bringing the productivity of Rails to Go!
* [Echo](https://github.com/labstack/echo) **star:14686** High performance, minimalist Go web framework.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Revel](https://github.com/revel/revel) **star:11243** High-productivity web framework for the Go language.   ![star > 5000][Gold]
* [Goa](https://github.com/goadesign/goa) **star:3505** Goa provides a holistic approach for developing remote APIs and microservices in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [Gizmo](https://github.com/NYTimes/gizmo) **star:2848** Microservice toolkit used by the New York Times.   ![star > 1000][Silver]
...
* [utron](https://github.com/gernest/utron) **star:2136** Lightweight MVC framework for Go(Golang).   ![star > 1000][Silver]
...
* [Tollbooth](https://github.com/didip/tollbooth) **star:1248** Rate limit HTTP request handler.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [CORS](https://github.com/rs/cors) **star:1222** Easily add CORS capabilities to your API.   ![star > 1000][Silver]
* [Limiter](https://github.com/ulule/limiter) **star:791** Dead simple rate limit middleware for Go.   ![star > 100][Bronze]
* [go-server-timing](https://github.com/mitchellh/go-server-timing) **star:745** Add/parse Server-Timing header.   ![star > 100][Bronze]
...
* [negroni](https://github.com/urfave/negroni) **star:6329** Idiomatic HTTP middleware for Golang.   ![star > 5000][Gold]   ![Contains Chinese documents][CN]
...
* [stats](https://github.com/thoas/stats) **star:537** Go middleware that stores various information about your web application.   ![star > 100][Bronze]
...
* [httprouter](https://github.com/julienschmidt/httprouter) **star:9719** High performance router. Use this and the standard http handlers to form a very high performance web framework.   ![star > 5000][Gold]
* [mux](https://github.com/gorilla/mux) **star:9671** Powerful URL router and dispatcher for golang.   ![star > 5000][Gold]
* [chi](https://github.com/go-chi/chi) **star:6038** Small, fast and expressive HTTP router built on net/context.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [xpath](https://github.com/antchfx/xpath) **star:166** XPath package for Go.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [GoLint](https://github.com/golang/lint) **star:3153** Golint is a linter for Go source code.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [gcvis](https://github.com/davecheney/gcvis) **star:917** Visualise Go program GC trace data in real time.   ![star > 100][Bronze]
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck)  staticcheck is `go vet` on steroids, applying a ton of static analysis checks you might be used to from tools like ReSharper for C#.
* [php-parser](https://github.com/z7zmey/php-parser) **star:636** A Parser for PHP written in Go.   ![star > 100][Bronze]
* [go-critic](https://github.com/go-critic/go-critic) **star:577** source code linter that brings checks that are currently not implemented in other linters.   ![star > 100][Bronze]
...
* [goast-viewer](https://github.com/yuroyoro/goast-viewer) **star:374** Web based Golang AST visualizer.   ![star > 100][Bronze]
...
* [dupl](https://github.com/mibk/dupl) **star:175** Tool for code clone detection.   ![star > 100][Bronze]
...
* [go-outdated](https://github.com/firstrow/go-outdated) **star:45** Console application that displays outdated packages.   ![Archived][Archived]
...
* [vim-go](https://github.com/fatih/vim-go) **star:10841** Go development plugin for Vim.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) **star:5126** Extension for Visual Studio Code (VS Code) which provides support for the Go language.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [gocode](https://github.com/nsf/gocode) **star:4741** Autocompletion daemon for the Go programming language.   ![star > 1000][Silver]
...
* [gotests](https://github.com/cweill/gotests) **star:2198** Generate Go tests from your source code.   ![star > 1000][Silver]
* [genny](https://github.com/cheekybits/genny) **star:968** Elegant generics for Go.   ![star > 100][Bronze]
...
* [go-swagger](https://github.com/go-swagger/go-swagger) **star:3990** Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [OctoLinker](https://github.com/OctoLinker/browser-extension) **star:3793** Navigate through go files efficiently with the OctoLinker browser extension for GitHub.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [kubernetes](https://github.com/kubernetes/kubernetes) **star:56279** Container Cluster Manager from Google.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Moby](https://github.com/moby/moby) **star:54435** Collaborative project for the container ecosystem to assemble container-based systems.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [traefik](https://github.com/containous/traefik) **star:23745** Reverse proxy and load balancer with support for multiple backends.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [gitea-github-migrator](https://git.jonasfranz.software/JonasFranzDEV/gitea-github-migrator)  Migrate all your GitHub repositories, issues, milestones and labels to your Gitea instance.
* [Gitea](https://github.com/go-gitea/gitea) **star:15301** Fork of Gogs, entirely community driven.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [Vegeta](https://github.com/tsenart/vegeta) **star:12194** HTTP load testing tool and library. It's over 9000!   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Packer](https://github.com/mitchellh/packer) **star:9239** Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Hey](https://github.com/rakyll/hey) **star:6314** Hey is a tiny program that sends some load to a web application.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [GVM](https://github.com/moovweb/gvm) **star:4475** GVM provides an interface to manage Go versions.   ![star > 1000][Silver]
* [Wide](https://wide.b3log.org/login)  Web-based IDE for Teams using Golang.
* [webhook](https://github.com/adnanh/webhook) **star:4090** Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.   ![star > 1000][Silver]
* [gaia](https://github.com/gaia-pipeline/gaia) **star:3740** Build powerful pipelines in any programming language.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [gox](https://github.com/mitchellh/gox) **star:3363** Dead simple, no frills Go cross compile tool.   ![star > 1000][Silver]
* [bosun](https://github.com/bosun-monitor/bosun) **star:2852** Time Series Alerting Framework.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [bombardier](https://github.com/codesenberg/bombardier) **star:1747** Fast cross-platform HTTP benchmarking tool.   ![star > 1000][Silver]
...
* [script](https://github.com/bitfield/script) **star:920** Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.   ![star > 100][Bronze]
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) **star:671** Enable your Go applications to self update.   ![star > 100][Bronze]
...
* [Pomerium](https://github.com/pomerium/pomerium) **star:510** Pomerium is an identity-aware access proxy.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [aurora](https://github.com/xuri/aurora) **star:401** Cross-platform web-based Beanstalkd queue server console.   ![star > 100][Bronze]
* [govvv](https://github.com/ahmetalpbalkan/govvv) **star:388** “go build” wrapper to easily add version information into Go binaries.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [Gor](https://github.com/buger/gor) **star:11363** Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.   ![star > 5000][Gold]
* [rkt](https://github.com/coreos/rkt) **star:8744** App Container runtime that integrates with init systems, is compatible with other container formats like Docker, and supports alternative execution engines like KVM.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) **star:8247** Fast, Simple and Scalable Distributed File System with O(1) disk seek.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [restic](https://github.com/restic/restic) **star:7482** De-duplicating backup program.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [confd](https://github.com/kelseyhightower/confd) **star:6414** Manage local application configuration files using templates and data from etcd or consul.   ![star > 5000][Gold]
* [Comcast](https://github.com/tylertreat/Comcast) **star:6177** Simulate bad network connections.   ![star > 5000][Gold]
* [LiteIDE](https://github.com/visualfc/liteide) **star:5496** LiteIDE is a simple, open source, cross-platform Go IDE.   ![star > 5000][Gold]   ![Contains Chinese documents][CN]
* [drive](https://github.com/odeke-em/drive) **star:4964** Google Drive client for the commandline.   ![star > 1000][Silver]
* [nes](https://github.com/fogleman/nes) **star:4125** Nintendo Entertainment System (NES) emulator written in Go.   ![star > 1000][Silver]
* [tsuru](https://tsuru.io/)  Extensible and open source Platform as a Service software.
* [toxiproxy](https://github.com/shopify/toxiproxy) **star:3942** Proxy to simulate network and system conditions for automated tests.   ![star > 1000][Silver]
* [Pipe](https://github.com/b3log/pipe) **star:2961** A small and beautiful blogging platform.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [Duplicacy](https://github.com/gilbertchen/duplicacy) **star:2692** A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.   ![star > 1000][Silver]
* [myLG](https://github.com/mehrdadrad/mylg) **star:2200** Command Line Network Diagnostic tool written in Go.   ![star > 1000][Silver]
* [GoBoy](https://github.com/Humpheh/goboy) **star:2105** Nintendo Game Boy Color emulator written in Go.   ![star > 1000][Silver]
...
* [Documize](https://github.com/documize/community) **star:828** Modern wiki software that integrates data from SaaS tools.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [scc](https://github.com/boyter/scc) **star:771** Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [Leaps](https://github.com/jeffail/leaps) **star:640** Pair programming service using Operational Transforms.   ![star > 100][Bronze]
* [peg](https://github.com/pointlander/peg) **star:610** Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator.   ![star > 100][Bronze]
...
* [GoDNS](https://github.com/timothyye/godns) **star:433** A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [shell2http](https://github.com/msoap/shell2http) **star:414** Executing shell commands via http server (for prototyping or remote control).   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) **star:1003** Go web framework benchmark.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [go-benchmarks](https://github.com/tylertreat/go-benchmarks) **star:122** Few miscellaneous Go microbenchmarks. Compare some language features to alternative approaches.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [GoBooks](https://github.com/dariubs/GoBooks) **star:6801** A curated list of Go books.   ![star > 5000][Gold]
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) **star:1539** Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [gophers](https://github.com/ashleymcnamara/gophers) **star:1855** Gopher artworks by Ashley McNamara.   ![star > 1000][Silver]
* [gophers](https://github.com/egonelbre/gophers) **star:1593** Free gophers.   ![star > 1000][Silver]
...
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) **star:24648** List of other amazingly awesome lists.   ![star > 5000][Gold]
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) **star:14552** Curated list of awesome remote jobs. A lot of them are looking for Go hackers.   ![star > 5000][Gold]
* [golang-graphics](https://github.com/mholt/golang-graphics) **star:141** Collection of Go images, graphics, and art.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]   ![Archived][Archived]
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) **star:31545** Golang ebook intro how to build a web app with golang.   ![star > 5000][Gold]   ![Contains Chinese documents][CN]
* [Building Go Web Applications and Microservices Using Gin](https://semaphoreci.com/community/tutorials/building-go-web-applications-and-microservices-using-gin)  Get familiar with Gin and find out how it can help you reduce boilerplate code and build a request handling pipeline.
* [Caching Slow Database Queries](https://medium.com/@rocketlaunchr.cloud/caching-slow-database-queries-1085d308a0c9)  How to cache slow database queries.
* [Canceling MySQL](https://medium.com/@rocketlaunchr.cloud/canceling-mysql-in-go-827ed8f83b30)  How to cancel MySQL queries.
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) **star:4041** Go's reference card.   ![star > 1000][Silver]
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) **star:4544** Learn Go with test-driven development.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) **star:694** Examples of Golang compared to Node.js for learning.   ![star > 100][Bronze]
