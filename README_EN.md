...
**This project is [awesome-go](https://awesome-go.com/) Chinese version, last sync time : 2019-08-03 23:48:51(Synchronize every day)**
...
* [Oto](https://github.com/hajimehoshi/oto) **star:431** A low-level library to play sound on multiple platforms.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) **star:5948** Golang implementation of JSON Web Tokens (JWT).   ![star > 5000][Gold]
* [casbin](https://github.com/hsluoyz/casbin) **star:4928** Authorization library that supports access control models like ACL, RBAC, ABAC.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [oauth2](https://github.com/golang/oauth2) **star:2380** Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support.   ![star > 1000][Silver]
* [goth](https://github.com/markbates/goth) **star:2262** provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.   ![star > 1000][Silver]
* [authboss](https://github.com/volatiletech/authboss) **star:1931** Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time.   ![star > 1000][Silver]
* [osin](https://github.com/openshift/osin) **star:1542** Golang OAuth2 server library.   ![star > 1000][Silver]
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) **star:1276** Standalone, specification-compliant,  OAuth2 server written in Golang.   ![star > 1000][Silver]
...
* [gologin](https://github.com/dghubble/gologin) **star:1041** chainable handlers for login with OAuth1 and OAuth2 authentication providers.   ![star > 1000][Silver]
* [gorbac](https://github.com/mikespook/gorbac) **star:908** provides a lightweight role-based access control (RBAC) implementation in Golang.   ![star > 100][Bronze]
...
* [scs](https://github.com/alexedwards/scs) **star:526** Session Manager for HTTP servers.   ![star > 100][Bronze]
...
* [jwt-auth](https://github.com/adam-hanna/jwt-auth) **star:152** JWT middleware for Golang http servers with many configuration options.   ![star > 100][Bronze]
...
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) **star:1621** Simple and clean Telegram bot client.   ![star > 1000][Silver]
...
* [slacker](https://github.com/shomali11/slacker) **star:307** Easy to use framework to create Slack bots.   ![star > 100][Bronze]
...
* [Kelp](https://github.com/stellar/kelp) **star:159** official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [cobra](https://github.com/spf13/cobra) **star:13266** Commander for modern Go CLI interactions.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [urfave/cli](https://github.com/urfave/cli) **star:11337** Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).   ![star > 5000][Gold]   ![There was an update last week][Green]
* [kingpin](https://github.com/alecthomas/kingpin) **star:2529** Command line and flag parser supporting sub commands.   ![star > 1000][Silver]
...
* [mitchellh/cli](https://github.com/mitchellh/cli) **star:999** Go library for implementing command-line interfaces.   ![star > 100][Bronze]
...
* [liner](https://github.com/peterh/liner) **star:583** Go readline-like library for command-line interfaces.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [flaggy](https://github.com/integrii/flaggy) **star:451** A robust and idiomatic flags package with excellent subcommand support.   ![star > 100][Bronze]
* [ops](https://github.com/nanovms/ops) **star:262** Unikernel Builder/Orchestrator.   ![star > 100][Bronze]
* [argparse](https://github.com/akamensky/argparse) **star:106** Command line argument parser inspired by Python's argparse module.   ![star > 100][Bronze]
...
* [commandeer](https://github.com/jaffee/commandeer) **star:91** Dev-friendly CLI apps: sets up flags, defaults, and usage based on struct fields and tags.
...
* [termui](https://github.com/gizak/termui) **star:8906** Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).   ![star > 5000][Gold]   ![There was an update last week][Green]
* [gommon/color](https://github.com/labstack/gommon/tree/master/color)  Style terminal text.
* [gocui](https://github.com/jroimartin/gocui) **star:5357** Minimalist Go library aimed at creating Console User Interfaces.   ![star > 5000][Gold]
...
* [go-prompt](https://github.com/c-bata/go-prompt) **star:2327** Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [asciigraph](https://github.com/guptarohit/asciigraph) **star:1140** Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.   ![star > 1000][Silver]
...
* [mpb](https://github.com/vbauerster/mpb) **star:692** Multi progress bar for terminal applications.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [aurora](https://github.com/logrusorgru/aurora) **star:633** ANSI terminal colors that supports fmt.Printf/Sprintf.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [simpletable](https://github.com/alexeyco/simpletable) **star:161** Simple tables in terminal with Go.   ![star > 100][Bronze]
...
* [viper](https://github.com/spf13/viper) **star:9282** Go configuration with fangs.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) **star:2401** Go library for managing configuration data from environment variables.   ![star > 1000][Silver]
* [godotenv](https://github.com/joho/godotenv) **star:2117** Go port of Ruby's dotenv library (Loads environment variables from `.env`).   ![star > 1000][Silver]
...
* [env](https://github.com/caarlos0/env) **star:860** Parse environment variables to Go structs (with defaults).   ![star > 100][Bronze]
...
* [drone](https://github.com/drone/drone) **star:18987** Drone is a Continuous Integration platform built on Docker, written in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [gods](https://github.com/emirpasic/gods) **star:6355** Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.   ![star > 5000][Gold]
* [go-datastructures](https://github.com/Workiva/go-datastructures) **star:5126** Collection of useful, performant, and thread-safe data structures.   ![star > 5000][Gold]
* [golang-set](https://github.com/deckarep/golang-set) **star:1165** Thread-Safe and Non-Thread-Safe high-performance sets for Go.   ![star > 1000][Silver]
* [boomfilters](https://github.com/tylertreat/BoomFilters) **star:1138** Probabilistic data structures for processing continuous, unbounded streams.   ![star > 1000][Silver]
...
* [trie](https://github.com/derekparker/trie) **star:421** Trie implementation in Go.   ![star > 100][Bronze]
...
* [prometheus](https://github.com/prometheus/prometheus) **star:25488** Monitoring system and time series database.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [tidb](https://github.com/pingcap/tidb) **star:20019** TiDB is a distributed SQL database. Inspired by the design of Google F1.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [influxdb](https://github.com/influxdb/influxdb) **star:17083** Scalable datastore for metrics, events, and real-time analytics.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [cockroach](https://github.com/cockroachdb/cockroach) **star:16754** Scalable, Geo-Replicated, Transactional Datastore.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [dgraph](https://github.com/dgraph-io/dgraph) **star:10318** Scalable, Distributed, Low Latency, High Throughput Graph Database.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [bolt](https://github.com/boltdb/bolt) **star:9975** Low-level key/value database for Go.   ![star > 5000][Gold]   ![It hasn't been updated in the last year][Yellow]
* [groupcache](https://github.com/golang/groupcache) **star:7653** Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.   ![star > 5000][Gold]
* [badger](https://github.com/dgraph-io/badger) **star:6264** Fast key-value store in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [rqlite](https://github.com/rqlite/rqlite) **star:4690** The lightweight, distributed, relational database built on SQLite.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [BigCache](https://github.com/allegro/bigcache) **star:2449** Efficient key/value cache for gigabytes of data.   ![star > 1000][Silver]
* [buntdb](https://github.com/tidwall/buntdb) **star:2434** Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.   ![star > 1000][Silver]
* [tiedot](https://github.com/HouzuoGuo/tiedot) **star:2365** Your NoSQL database powered by Golang.   ![star > 1000][Silver]
* [cache2go](https://github.com/muesli/cache2go) **star:1041** In-memory key:value cache which supports automatic invalidation based on timeouts.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) **star:995** fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [nutsdb](https://github.com/xujiajun/nutsdb) **star:890** Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set.   ![star > 100][Bronze]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) **star:873** CovenantSQL is a SQL database on blockchain.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [migrate](https://github.com/golang-migrate/migrate) **star:2601** Database migrations. CLI and Golang library.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [sql-migrate](https://github.com/rubenv/sql-migrate) **star:1405** Database migration tool. Allows embedding migrations into the application using go-bindata.   ![star > 1000][Silver]
* [gormigrate](https://github.com/go-gormigrate/gormigrate) **star:329** Database schema migration helper for Gorm ORM.   ![star > 100][Bronze]
...
* [vitess](https://github.com/youtube/vitess) **star:8441** vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [pgweb](https://github.com/sosedoff/pgweb) **star:5981** Web-based PostgreSQL database browser.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [kingshard](https://github.com/flike/kingshard) **star:4600** kingshard is a high performance proxy for MySQL powered by Golang.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [orchestrator](https://github.com/github/orchestrator) **star:3023** MySQL replication topology manager & visualizer.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) **star:2394** Sync your MySQL data into Elasticsearch automatically.   ![star > 1000][Silver]
...
* [Squirrel](https://github.com/Masterminds/squirrel) **star:2306** Go library that helps you build SQL queries.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [xo](https://github.com/knq/xo) **star:2182** Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.   ![star > 1000][Silver]
* [gendry](https://github.com/didi/gendry) **star:756** Non-invasive SQL builder and powerful data binder.   ![star > 100][Bronze]   ![Contains Chinese documents][CN]
* [goqu](https://github.com/doug-martin/goqu) **star:633** Idiomatic SQL builder and query library.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* Relational Databases
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) **star:8092** MySQL driver for Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [pq](https://github.com/lib/pq) **star:5177** Pure Go Postgres driver for database/sql.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) **star:3423** SQLite3 driver for go that uses database/sql.   ![star > 1000][Silver]
    * [pgx](https://github.com/jackc/pgx) **star:1916** PostgreSQL driver supporting features beyond those exposed by database/sql.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* NoSQL Databases
    * [redis](https://github.com/go-redis/redis) **star:6484** Redis client for Golang.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [redigo](https://github.com/gomodule/redigo) **star:6265** Redigo is a Go client for the Redis database.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) **star:3081** Official MongoDB driver for the Go language.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [mgo](https://github.com/globalsign/mgo) **star:1634** (unmaintained) MongoDB driver for the Go language that implements a rich and well tested selection of features under a very simple API following standard Go idioms.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [gorethink](https://github.com/dancannon/gorethink) **star:1457** Go language driver for RethinkDB.   ![star > 1000][Silver]
...
* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) **star:5824** Modern text indexing library for go.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [riot](https://github.com/go-ego/riot) **star:4693** Go Open Source, Distributed, Simple and efficient Search Engine.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
    * [elastic](https://github.com/olivere/elastic) **star:4124** Elasticsearch client for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) **star:1568** Official Elasticsearch client for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* Multiple Backends.
    * [cayley](https://github.com/google/cayley) **star:12676** Graph database with support for multiple backends.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [now](https://github.com/jinzhu/now) **star:2180** Now is a time toolkit for golang.   ![star > 1000][Silver]
...
* [go-kit](https://github.com/go-kit/kit) **star:14401** Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.   ![star > 5000][Gold]
* [grpc-go](https://github.com/grpc/grpc-go) **star:9068** The Go language implementation of gRPC. HTTP/2 based RPC.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [jaeger](https://github.com/jaegertracing/jaeger) **star:8630** A distributed tracing system.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [micro](https://github.com/micro/micro) **star:6562** Pluggable microservice toolkit and distributed systems platform.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [NATS](https://github.com/nats-io/gnatsd) **star:6326** Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [rpcx](https://github.com/smallnest/rpcx) **star:3787** Distributed pluggable RPC service framework like alibaba Dubbo.   ![star > 1000][Silver]
* [tendermint](https://github.com/tendermint/tendermint) **star:3128** High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [torrent](https://github.com/anacrolix/torrent) **star:2835** BitTorrent client package.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [dragonboat](https://github.com/lni/dragonboat) **star:2522** A feature complete and high performance multi-group Raft library in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
...
* [jsonrpc](https://github.com/ybbus/jsonrpc) **star:101** JSON-RPC 2.0 HTTP client implementation.   ![star > 100][Bronze]
...
* [MailHog](https://github.com/mailhog/MailHog) **star:5152** Email and SMTP testing with web and API interface.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [chasquid](https://blitiri.com.ar/p/chasquid)  SMTP server written in Go.
* [hermes](https://github.com/matcornic/hermes) **star:1615** Golang package that generates clean, responsive HTML e-mails.   ![star > 1000][Silver]
...
* [SendGrid](https://github.com/sendgrid/sendgrid-go) **star:519** SendGrid's Go library for sending email.   ![star > 100][Bronze]
...
* [gopher-lua](https://github.com/yuin/gopher-lua) **star:2952** Lua 5.1 VM and compiler written in Go.   ![star > 1000][Silver]
* [go-lua](https://github.com/Shopify/go-lua) **star:1667** Port of the Lua 5.2 VM to pure Go.   ![star > 1000][Silver]
* [tengo](https://github.com/d5/tengo) **star:1295** Bytecode compiled script language for Go.   ![star > 1000][Silver]
...
* [expr](https://github.com/antonmedv/expr) **star:696** an engine that can evaluate expressions.   ![star > 100][Bronze]
...
* [errors](https://github.com/pkg/errors) **star:4871** Package that provides simple error handling primitives.   ![star > 1000][Silver]
...
* [afero](https://github.com/spf13/afero) **star:2227** FileSystem Abstraction System for Go.   ![star > 1000][Silver]
...
* [decimal](https://github.com/shopspring/decimal) **star:1593** Arbitrary-precision fixed-point decimal numbers.   ![star > 1000][Silver]
...
* [gorilla/csrf](https://github.com/gorilla/csrf) **star:433** CSRF protection for Go web applications & services.   ![star > 100][Bronze]
...
* [Leaf](https://github.com/name5566/leaf) **star:3051** Lightweight game server framework.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
* [Pixel](https://github.com/faiface/pixel) **star:2429** Hand-crafted 2D game library in Go.   ![star > 1000][Silver]
* [Ebiten](https://github.com/hajimehoshi/ebiten) **star:1848** dead simple 2D game library in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [goworld](https://github.com/xiaonanln/goworld) **star:1188** Scalable game server engine, featuring space-entity framework and hot-swapping.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
...
* [engo](https://github.com/EngoEngine/engo) **star:1080** Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm.   ![star > 1000][Silver]
...
* [nano](https://github.com/lonng/nano) **star:990** Lightweight, facility, high performance golang based game server framework.   ![star > 100][Bronze]   ![Contains Chinese documents][CN]
...
* [raylib-go](https://github.com/gen2brain/raylib-go) **star:381** Go bindings for [raylib](http://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.   ![star > 100][Bronze]
...
* [jennifer](https://github.com/dave/jennifer) **star:1268** Generate arbitrary Go code without templates.   ![star > 1000][Silver]
...
* [goderive](https://github.com/awalterschulze/goderive) **star:739** Derives functions from input types.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [Tile38](https://github.com/tidwall/tile38) **star:6319** Geolocation DB with spatial index and realtime geofencing.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [gopherjs](https://github.com/gopherjs/gopherjs) **star:8534** Compiler from Go to JavaScript.   ![star > 5000][Gold]
...
* [c4go](https://github.com/Konstantin8105/c4go) **star:153** Transpile C code to Go code.   ![star > 100][Bronze]
...
* [ants](https://github.com/panjf2000/ants) **star:1873** A high-performance goroutine pool for golang.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
* [tunny](https://github.com/Jeffail/tunny) **star:1343** Goroutine pool for golang.   ![star > 1000][Silver]
...
* [workerpool](https://github.com/gammazero/workerpool) **star:136** Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.   ![star > 100][Bronze]
...
* [ui](https://github.com/andlabs/ui) **star:6937** Platform-native GUI library for Go. Cross platform.   ![star > 5000][Gold]
* [Wails](https://wails.app)  Mac, Windows, Linux desktop apps with HTML UI using built-in OS HTML renderer.
* [fyne](https://github.com/fyne-io/fyne) **star:6261** Cross platform native GUIs designed for Go, rendered using EFL. Supports: Linux, macOS, Windows.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [qt](https://github.com/therecipe/qt) **star:6028** Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).   ![star > 5000][Gold]
* [webview](https://github.com/zserge/webview) **star:4641** Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).   ![star > 1000][Silver]
* [walk](https://github.com/lxn/walk) **star:3687** Windows application library kit for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [app](https://github.com/murlokswarm/app) **star:2949** Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [go-sciter](https://github.com/sciter-sdk/go-sciter) **star:1447** Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [gotk3](https://github.com/gotk3/gotk3) **star:766** Go bindings for GTK3.   ![star > 100][Bronze]
...
* [robotgo](https://github.com/go-vgo/robotgo) **star:4424** Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [imaging](https://github.com/disintegration/imaging) **star:2517** Simple Go image processing package.   ![star > 1000][Silver]
* [bild](https://github.com/anthonynsimon/bild) **star:2505** Collection of image processing algorithms in pure Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [ln](https://github.com/fogleman/ln) **star:2459** 3D line art rendering in Go.   ![star > 1000][Silver]
* [gocv](https://github.com/hybridgroup/gocv) **star:2442** Go package for computer vision using OpenCV 3.3+.   ![star > 1000][Silver]
...
* [svgo](https://github.com/ajstarks/svgo) **star:1330** Go Language Library for SVG generation.   ![star > 1000][Silver]
...
* [bimg](https://github.com/h2non/bimg) **star:790** Small package for fast and efficient image processing using libvips.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [stegify](https://github.com/DimitarPetrov/stegify) **star:490** Go tool for LSB steganography, capable of hiding any file within an image.   ![star > 100][Bronze]
...
* [darkroom](https://github.com/gojek/darkroom) **star:24** An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency.   ![There was an update last week][Green]
...
* [flogo](https://github.com/tibcosoftware/flogo) **star:1118** Project Flogo is an Open Source Framework for IoT Edge Apps & Integration.   ![star > 1000][Silver]
...
* [mainflux](https://github.com/Mainflux/mainflux) **star:587** Industrial IoT Messaging and Device Management Server.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [GJSON](https://github.com/tidwall/gjson) **star:4870** Get a JSON value with one line of code.   ![star > 1000][Silver]
...
* [logrus](https://github.com/Sirupsen/logrus) **star:11889** Structured logger for Go.   ![star > 5000][Gold]
* [zap](https://github.com/uber-go/zap) **star:7411** Fast, structured, leveled logging in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [spew](https://github.com/davecgh/go-spew) **star:3296** Implements a deep pretty printer for Go data structures to aid in debugging.   ![star > 1000][Silver]
* [glog](https://github.com/golang/glog) **star:2302** Leveled execution logs for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [zerolog](https://github.com/rs/zerolog) **star:2206** Zero-allocation JSON logger.   ![star > 1000][Silver]
...
* [lumberjack](https://github.com/natefinch/lumberjack) **star:1437** Simple rolling logger, implements io.WriteCloser.   ![star > 1000][Silver]
* [seelog](https://github.com/cihub/seelog) **star:1353** Logging functionality with flexible dispatching, filtering, and formatting.   ![star > 1000][Silver]
* [log15](https://github.com/inconshreveable/log15) **star:885** Simple, powerful logging for Go.   ![star > 100][Bronze]
...
* [gorgonia](https://github.com/chewxy/gorgonia) **star:2686** graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [tfgo](https://github.com/galeone/tfgo) **star:1181** Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python.   ![star > 1000][Silver]
...
* [sarama](https://github.com/Shopify/sarama) **star:4604** Go library for Apache Kafka.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [gorush](https://github.com/appleboy/gorush) **star:3700** Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).   ![star > 1000][Silver]
* [Centrifugo](https://github.com/centrifugal/centrifugo) **star:3674** Real-time messaging (Websockets or SockJS) server in Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [machinery](https://github.com/RichardKnop/machinery) **star:3362** Asynchronous task queue/job queue based on distributed message passing.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [go-socket.io](https://github.com/googollee/go-socket.io) **star:2877** socket.io library for golang, a realtime application framework.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [NATS Go Client](https://github.com/nats-io/nats) **star:2396** Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [APNs2](https://github.com/sideshow/apns2) **star:2040** HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps.   ![star > 1000][Silver]
* [Benthos](https://github.com/Jeffail/benthos) **star:2002** A message streaming bridge between a range of protocols.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [melody](https://github.com/olahol/melody) **star:1557** Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.   ![star > 1000][Silver]
...
* [EventBus](https://github.com/asaskevich/EventBus) **star:558** The lightweight event bus with async compatibility.   ![star > 100][Bronze]
...
* [unioffice](https://github.com/unidoc/unioffice) **star:1700** Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.   ![star > 1000][Silver]   ![There was an update last week][Green]

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) **star:4437** Golang library for reading and writing Microsoft Excel™ (XLSX) files.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [xlsx](https://github.com/tealeg/xlsx) **star:3359** Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [dig](https://github.com/uber-go/dig) **star:906** A reflection based dependency injection toolkit for Go.   ![star > 100][Bronze]
* [fx](https://github.com/uber-go/fx) **star:746** A dependency injection based application framework for Go (built on top of dig).   ![star > 100][Bronze]
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) **star:9043** Set of common historical and emerging project layout patterns in the Go ecosystem.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [gopsutil](https://github.com/shirou/gopsutil) **star:3911** Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) **star:627** Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.   ![star > 100][Bronze]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
...
* [gofakeit](https://github.com/brianvoe/gofakeit) **star:414** Random data generator written in go.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [gommit](https://github.com/antham/gommit) **star:72** Analyze git commit messages to ensure they follow defined patterns.   ![There was an update last week][Green]
...
* [ghorg](https://github.com/gabrie30/ghorg) **star:25** Clone all repos from a GitHub org into a single directory.   ![There was an update last week][Green]
...
* [prose](https://github.com/jdkato/prose) **star:2042** Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more.   ![star > 1000][Silver]
...
* [go-pinyin](https://github.com/mozillazg/go-pinyin) **star:522** CN Hanzi to Hanyu Pinyin converter.   ![star > 100][Bronze]
...
* [kcptun](https://github.com/xtaci/kcptun) **star:10649** Extremely simple & fast udp tunnel based on KCP protocol.   ![star > 5000][Gold]
* [fasthttp](https://github.com/valyala/fasthttp) **star:9320** Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [dns](https://github.com/miekg/dns) **star:3791** Go library for working with DNS.   ![star > 1000][Silver]
* [HTTPLab](https://github.com/gchaincl/httplab) **star:3398** HTTPLabs let you inspect HTTP requests and forge responses.   ![star > 1000][Silver]
* [quic-go](https://github.com/lucas-clemente/quic-go) **star:2889** An implementation of the QUIC protocol in pure Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [gopacket](https://github.com/google/gopacket) **star:2871** Go library for packet processing with libpcap bindings.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [kcp-go](https://github.com/xtaci/kcp-go) **star:2239** KCP - Fast and Reliable ARQ Protocol.   ![star > 1000][Silver]
* [webrtc](https://github.com/pions/webrtc) **star:2236** A pure Go implementation of the WebRTC API.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [fortio](https://github.com/fortio/fortio) **star:870** Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.   ![star > 100][Bronze]
...
* [mdns](https://github.com/hashicorp/mdns) **star:549** Simple mDNS (Multicast DNS) client/server library in Golang.   ![star > 100][Bronze]
...
* [gosnmp](https://github.com/soniah/gosnmp) **star:433** Native Go library for performing SNMP actions.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [grequests](https://github.com/levigross/grequests) **star:1412** A Go "clone" of the great and famous Requests library.   ![star > 1000][Silver]
...
* [sling](https://github.com/dghubble/sling) **star:999** Sling is a Go HTTP client library for creating and sending API requests.   ![star > 100][Bronze]
...
* [GORM](https://github.com/jinzhu/gorm) **star:14619** The fantastic ORM library for Golang, aims to be developer friendly.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Xorm](https://github.com/go-xorm/xorm) **star:5185** Simple and powerful ORM for Go.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [gorp](https://github.com/go-gorp/gorp) **star:3075** Go Relational Persistence, ORM-ish library for Go.   ![star > 1000][Silver]
* [go-pg](https://github.com/go-pg/pg) **star:2973** PostgreSQL ORM with focus on PostgreSQL specific features and performance.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [upper.io/db](https://github.com/upper/db) **star:1848** Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [pop/soda](https://github.com/gobuffalo/pop) **star:675** Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [dep](https://github.com/golang/dep) **star:12559** Go dependency tool.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [vgo](https://go.googlesource.com/vgo/)  Versioned Go.

*Unofficial libraries for package and dependency management.*

* [glide](https://github.com/Masterminds/glide) **star:7776** Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip.   ![star > 5000][Gold]
...
* [govendor](https://github.com/kardianos/govendor) **star:4734** Go Package Manager. Go vendor tool that works with the standard vendor file.   ![star > 1000][Silver]
* [gopm](https://github.com/gpmgo/gopm) **star:2357** Go Package Manager.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [graphql-go](https://github.com/graphql-go/graphql) **star:5206** Implementation of GraphQL for Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [graphql](https://github.com/neelance/graphql-go) **star:2763** GraphQL server with a focus on ease of use.   ![star > 1000][Silver]
...
* [packr](https://github.com/gobuffalo/packr) **star:2107** The simple and easy way to embed static files into Go binaries.   ![star > 1000][Silver]
* [statik](https://github.com/rakyll/statik) **star:2093** Embeds static files into a Go executable.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [go-embed](https://github.com/pyros2097/go-embed) **star:15** Generates go code to embed resource files into your library or executable.   ![There was an update last week][Green]

## Science and Data Analysis

*Libraries for scientific computing and data analyzing.*

* [gonum](https://github.com/gonum/gonum) **star:2944** Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [gosl](https://github.com/cpmech/gosl) **star:1306** Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more.   ![star > 1000][Silver]
...
* [memguard](https://github.com/awnumar/memguard) **star:1474** A pure Go library for handling sensitive values in memory.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [secure](https://github.com/unrolled/secure) **star:1202** HTTP middleware for Go that facilitates some quick security wins.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [jsoniter](https://github.com/json-iterator/go) **star:5522** High-performance 100% compatible drop-in replacement of "encoding/json".   ![star > 5000][Gold]
* [goprotobuf](https://github.com/golang/protobuf) **star:5071** Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) **star:2945** Protocol Buffers for Go with Gadgets.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [mapstructure](https://github.com/mitchellh/mapstructure) **star:2414** Go library for decoding generic map values into native Go structures.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [go-codec](https://github.com/ugorji/go) **star:1232** High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support.   ![star > 1000][Silver]
...
* [etcd](https://github.com/coreos/etcd) **star:26414** Highly-available key value store for shared configuration and service discovery.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Caddy](https://github.com/mholt/caddy) **star:23125** Caddy is an alternative, HTTP/2 web server that's easy to configure and use.   ![star > 5000][Gold]
* [consul](https://www.consul.io/)  Consul is a tool for service discovery, monitoring and configuration.
* [minio](https://github.com/minio/minio) **star:17416** Minio is a distributed object storage server.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [yakvs](https://git.sci4me.com/sci4me/yakvs)  Small, networked, in-memory key-value store.
* [RoadRunner](https://github.com/spiral/roadrunner) **star:3265** High-performance PHP application server, load-balancer and process manager.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [flipt](https://github.com/markphelps/flipt) **star:987** A self contained feature flag solution written in Go and Vue.js   ![star > 100][Bronze]   ![There was an update last week][Green]
* [Flagr](https://github.com/checkr/flagr) **star:822** Flagr is an open-source feature flagging and A/B testing service.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [Fider](https://github.com/getfider/fider) **star:794** Fider is an open platform to collect and organize customer feedback.   ![star > 100][Bronze]
* [jackal](https://github.com/ortuman/jackal) **star:714** An XMPP server written in Go.   ![star > 100][Bronze]
...
* [pongo2](https://github.com/flosch/pongo2) **star:1484** Django-like template-engine for Go.   ![star > 1000][Silver]
* [quicktemplate](https://github.com/valyala/quicktemplate) **star:1401** Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.   ![star > 1000][Silver]
* [hero](https://github.com/shiyanhui/hero) **star:1201** Hero is a handy, fast and powerful go template engine.   ![star > 1000][Silver]   ![Contains Chinese documents][CN]
...
* [Razor](https://github.com/sipin/gorazor) **star:698** Razor view engine for Golang.   ![star > 100][Bronze]
...
* Testing Frameworks
    ...
    * [Testify](https://github.com/stretchr/testify) **star:8116** Sacred extension to the standard go testing package.   ![star > 5000][Gold]   ![There was an update last week][Green]
    ...
    * [httpexpect](https://github.com/gavv/httpexpect) **star:1139** Concise, declarative, and easy to use end-to-end HTTP and REST API testing.   ![star > 1000][Silver]
...
* Mock
    * [gomock](https://github.com/golang/mock) **star:2830** Mocking framework for the Go programming language.   ![star > 1000][Silver]
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) **star:1733** Mock SQL driver for testing database interactions.   ![star > 1000][Silver]
...
* Fuzzing and delta-debugging/reducing/shrinking.
    * [go-fuzz](https://github.com/dvyukov/go-fuzz) **star:2878** Randomized testing system.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* Selenium and browser control tools.
    * [chromedp](https://github.com/knq/chromedp) **star:3572** a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.   ![star > 1000][Silver]
    * [selenoid](https://github.com/aerokube/selenoid) **star:1225** alternative Selenium hub server that launches browsers within containers.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* Specific Formats
    * [colly](https://github.com/asciimoo/colly) **star:8344** Fast and Elegant Scraping Framework for Gophers.   ![star > 5000][Gold]   ![There was an update last week][Green]
    * [GoQuery](https://github.com/PuerkitoBio/goquery) **star:7549** GoQuery brings a syntax and a set of features similar to jQuery to the Go language.   ![star > 5000][Gold]
    * [blackfriday](https://github.com/russross/blackfriday) **star:3886** Markdown processor in Go.   ![star > 1000][Silver]
    * [toml](https://github.com/BurntSushi/toml) **star:2772** TOML configuration format (encoder/decoder with reflection).   ![star > 1000][Silver]
    * [sh](https://github.com/mvdan/sh) **star:1986** Shell parser and formatter.   ![star > 1000][Silver]
    ...
    * [gofeed](https://github.com/mmcdole/gofeed) **star:1096** Parse RSS and Atom feeds in Go.   ![star > 1000][Silver]
    * [go-toml](https://github.com/pelletier/go-toml) **star:607** Go library for the TOML format with query support and handy cli tools.   ![star > 100][Bronze]
    ...
    * [go-nmea](https://github.com/adrianmo/go-nmea) **star:96** NMEA parser library for the Go language.   ![There was an update last week][Green]
...
* Utility
    * [xurls](https://github.com/mvdan/xurls) **star:460** Extract urls from text.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) **star:5013** The official AWS SDK for the Go programming language.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [github](https://github.com/google/go-github) **star:4754** Go library for accessing the GitHub REST API v3.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [slack](https://github.com/nlopes/slack) **star:2410** Slack API in Go.   ![star > 1000][Silver]
* [google](https://github.com/google/google-api-go-client) **star:1916** Auto-generated Google APIs for Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) **star:1774** Google Cloud APIs Go Client Library.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [anaconda](https://github.com/ChimeraCoder/anaconda) **star:986** Go client library for the Twitter 1.1 API.   ![star > 100][Bronze]
* [discordgo](https://github.com/bwmarrin/discordgo) **star:968** Go bindings for the Discord Chat API.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [fzf](https://github.com/junegunn/fzf) **star:23108** Command-line fuzzy finder written in Go.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [hub](https://github.com/github/hub) **star:16915** wrap git commands with additional functionality to interact with github from the terminal.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [delve](https://github.com/derekparker/delve) **star:11995** Go debugger.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [ctop](https://github.com/bcicen/ctop) **star:8815** [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics.   ![star > 5000][Gold]
* [wuzz](https://github.com/asciimoo/wuzz) **star:8256** Interactive cli tool for HTTP inspection.   ![star > 5000][Gold]
* [sqlx](https://github.com/jmoiron/sqlx) **star:6778** provides a set of extensions on top of the excellent built-in database/sql package.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [peco](https://github.com/peco/peco) **star:5450** Simplistic interactive filtering tool.   ![star > 5000][Gold]
...
* [goreleaser](https://github.com/goreleaser/goreleaser) **star:4489** Deliver Go binaries as fast and easily as possible.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [realize](https://github.com/tockins/realize) **star:3158** Go build system with file watchers and live reload. Run, build and watch file changes with custom paths.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [panicparse](https://github.com/maruel/panicparse) **star:2142** Groups similar goroutines and colorizes stack dump.   ![star > 1000][Silver]
* [hystrix-go](https://github.com/afex/hystrix-go) **star:2008** Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker.   ![star > 1000][Silver]
* [resty](https://github.com/go-resty/resty) **star:1956** Simple HTTP and REST client for Go inspired by Ruby rest-client.   ![star > 1000][Silver]
...
* [minify](https://github.com/tdewolff/minify) **star:1857** Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.   ![star > 1000][Silver]
...
* [go-funk](https://github.com/thoas/go-funk) **star:1176** Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).   ![star > 1000][Silver]   ![There was an update last week][Green]
* [mc](https://github.com/minio/mc) **star:1109** Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [profile](https://github.com/pkg/profile) **star:1006** Simple profiling support package for Go.   ![star > 1000][Silver]
...
* [boilr](https://github.com/tmrts/boilr) **star:938** Blazingly fast CLI tool for creating projects from boilerplate templates.   ![star > 100][Bronze]   ![It hasn't been updated in the last year][Yellow]
...
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) **star:789** Circuit Breakers in Go.   ![star > 100][Bronze]
* [spinner](https://github.com/briandowns/spinner) **star:780** Go package to easily provide a terminal spinner with options.   ![star > 100][Bronze]
* [git-time-metric](https://github.com/git-time-metric/gtm) **star:715** Simple, seamless, lightweight time tracking for Git.   ![star > 100][Bronze]   ![There was an update last week][Green]
* [jump](https://github.com/gsamokovarov/jump) **star:657** Jump helps you navigate faster by learning your habits.   ![star > 100][Bronze]
...
* [gotenv](https://github.com/subosito/gotenv) **star:140** Load environment variables from `.env` or any `io.Reader` in Go.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) **star:110** Package for MIME type detection based on magic numbers.   ![star > 100][Bronze]
...
* [uuid](https://github.com/gofrs/uuid) **star:565** Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.   ![star > 100][Bronze]
...
* [govalidator](https://github.com/asaskevich/govalidator) **star:3543** Validators and sanitizers for strings, numerics, slices and structs.   ![star > 1000][Silver]
* [validator](https://github.com/go-playground/validator) **star:3501** Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [go-git](https://github.com/src-d/go-git) **star:4241** highly extensible Git implementation in pure Go.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [git2go](https://github.com/libgit2/git2go) **star:1359** Go bindings for libgit2.   ![star > 1000][Silver]
* [hercules](https://github.com/src-d/hercules) **star:525** gaining advanced insights from Git repository history.   ![star > 100][Bronze]
...
* [goav](https://github.com/giorgisio/goav) **star:781** Comphrensive Go bindings for FFmpeg.   ![star > 100][Bronze]
...
* [go-astisub](https://github.com/asticode/go-astisub) **star:166** Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).   ![star > 100][Bronze]
...
* [libvlc-go](https://github.com/adrg/libvlc-go) **star:63** Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player).
...
* [Gin](https://github.com/gin-gonic/gin) **star:29867** Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Beego](https://github.com/astaxie/beego) **star:21423** beego is an open-source, high-performance web framework for the Go programming language.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [Buffalo](http://gobuffalo.io)  Bringing the productivity of Rails to Go!
* [Echo](https://github.com/labstack/echo) **star:14646** High performance, minimalist Go web framework.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Revel](https://github.com/revel/revel) **star:11239** High-productivity web framework for the Go language.   ![star > 5000][Gold]
...
* [Gizmo](https://github.com/NYTimes/gizmo) **star:2843** Microservice toolkit used by the New York Times.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [Tollbooth](https://github.com/didip/tollbooth) **star:1243** Rate limit HTTP request handler.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [negroni](https://github.com/urfave/negroni) **star:6324** Idiomatic HTTP middleware for Golang.   ![star > 5000][Gold]   ![Contains Chinese documents][CN]
...
* [httprouter](https://github.com/julienschmidt/httprouter) **star:9698** High performance router. Use this and the standard http handlers to form a very high performance web framework.   ![star > 5000][Gold]
* [mux](https://github.com/gorilla/mux) **star:9649** Powerful URL router and dispatcher for golang.   ![star > 5000][Gold]
* [chi](https://github.com/go-chi/chi) **star:6020** Small, fast and expressive HTTP router built on net/context.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [fasthttprouter](https://github.com/buaazp/fasthttprouter) **star:747** High performance router forked from `httprouter`. The first router fit for `fasthttp`.   ![star > 100][Bronze]
...
* [php-parser](https://github.com/z7zmey/php-parser) **star:634** A Parser for PHP written in Go.   ![star > 100][Bronze]
...
* [dupl](https://github.com/mibk/dupl) **star:172** Tool for code clone detection.   ![star > 100][Bronze]
...
* [vim-go](https://github.com/fatih/vim-go) **star:10822** Go development plugin for Vim.   ![star > 5000][Gold]   ![There was an update last week][Green]
...
* [GoSublime](https://github.com/DisposaBoy/GoSublime) **star:3234** Golang plugin collection for the text editor SublimeText 3 providing code completion and other IDE-like features.   ![star > 1000][Silver]
* [go-plus](https://github.com/joefitzgerald/go-plus) **star:1480** Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting.   ![star > 1000][Silver]
...
* [gotests](https://github.com/cweill/gotests) **star:2193** Generate Go tests from your source code.   ![star > 1000][Silver]
...
* [go-swagger](https://github.com/go-swagger/go-swagger) **star:3979** Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [OctoLinker](https://github.com/OctoLinker/browser-extension) **star:3773** Navigate through go files efficiently with the OctoLinker browser extension for GitHub.   ![star > 1000][Silver]   ![There was an update last week][Green]
...
* [kubernetes](https://github.com/kubernetes/kubernetes) **star:56134** Container Cluster Manager from Google.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Moby](https://github.com/moby/moby) **star:54402** Collaborative project for the container ecosystem to assemble container-based systems.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [traefik](https://github.com/containous/traefik) **star:23683** Reverse proxy and load balancer with support for multiple backends.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [gitea-github-migrator](https://git.jonasfranz.software/JonasFranzDEV/gitea-github-migrator)  Migrate all your GitHub repositories, issues, milestones and labels to your Gitea instance.
* [Gitea](https://github.com/go-gitea/gitea) **star:15224** Fork of Gogs, entirely community driven.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
* [Vegeta](https://github.com/tsenart/vegeta) **star:12144** HTTP load testing tool and library. It's over 9000!   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Packer](https://github.com/mitchellh/packer) **star:9224** Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Hey](https://github.com/rakyll/hey) **star:6288** Hey is a tiny program that sends some load to a web application.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [GVM](https://github.com/moovweb/gvm) **star:4470** GVM provides an interface to manage Go versions.   ![star > 1000][Silver]
* [Wide](https://wide.b3log.org/login)  Web-based IDE for Teams using Golang.
* [webhook](https://github.com/adnanh/webhook) **star:4080** Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.   ![star > 1000][Silver]
...
* [gox](https://github.com/mitchellh/gox) **star:3354** Dead simple, no frills Go cross compile tool.   ![star > 1000][Silver]
...
* [bombardier](https://github.com/codesenberg/bombardier) **star:1743** Fast cross-platform HTTP benchmarking tool.   ![star > 1000][Silver]
...
* [s3gof3r](https://github.com/rlmcpherson/s3gof3r) **star:996** Small utility/library optimized for high speed transfer of large objects into and out of Amazon S3.   ![star > 100][Bronze]
...
* [Pomerium](https://github.com/pomerium/pomerium) **star:500** Pomerium is an identity-aware access proxy.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [Pewpew](https://github.com/bengadbois/pewpew) **star:203** Flexible HTTP command line stress tester.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [Gor](https://github.com/buger/gor) **star:11344** Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.   ![star > 5000][Gold]
* [rkt](https://github.com/coreos/rkt) **star:8741** App Container runtime that integrates with init systems, is compatible with other container formats like Docker, and supports alternative execution engines like KVM.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) **star:8232** Fast, Simple and Scalable Distributed File System with O(1) disk seek.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [restic](https://github.com/restic/restic) **star:7449** De-duplicating backup program.   ![star > 5000][Gold]   ![There was an update last week][Green]
* [confd](https://github.com/kelseyhightower/confd) **star:6408** Manage local application configuration files using templates and data from etcd or consul.   ![star > 5000][Gold]
* [Comcast](https://github.com/tylertreat/Comcast) **star:6175** Simulate bad network connections.   ![star > 5000][Gold]
* [LiteIDE](https://github.com/visualfc/liteide) **star:5488** LiteIDE is a simple, open source, cross-platform Go IDE.   ![star > 5000][Gold]   ![Contains Chinese documents][CN]
* [drive](https://github.com/odeke-em/drive) **star:4958** Google Drive client for the commandline.   ![star > 1000][Silver]
* [nes](https://github.com/fogleman/nes) **star:4124** Nintendo Entertainment System (NES) emulator written in Go.   ![star > 1000][Silver]
* [toxiproxy](https://github.com/shopify/toxiproxy) **star:3935** Proxy to simulate network and system conditions for automated tests.   ![star > 1000][Silver]
* [tsuru](https://tsuru.io/)  Extensible and open source Platform as a Service software.
* [Pipe](https://github.com/b3log/pipe) **star:2922** A small and beautiful blogging platform.   ![star > 1000][Silver]   ![There was an update last week][Green]
* [Duplicacy](https://github.com/gilbertchen/duplicacy) **star:2689** A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.   ![star > 1000][Silver]
* [myLG](https://github.com/mehrdadrad/mylg) **star:2197** Command Line Network Diagnostic tool written in Go.   ![star > 1000][Silver]
* [GoBoy](https://github.com/Humpheh/goboy) **star:2103** Nintendo Game Boy Color emulator written in Go.   ![star > 1000][Silver]
* [Stack Up](https://github.com/pressly/sup) **star:1991** Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers.   ![star > 1000][Silver]
...
* [shell2http](https://github.com/msoap/shell2http) **star:408** Executing shell commands via http server (for prototyping or remote control).   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) **star:998** Go web framework benchmark.   ![star > 100][Bronze]   ![There was an update last week][Green]
...
* [GoBooks](https://github.com/dariubs/GoBooks) **star:6783** A curated list of Go books.   ![star > 5000][Gold]
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) **star:1526** Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.   ![star > 1000][Silver]
...
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) **star:24618** List of other amazingly awesome lists.   ![star > 5000][Gold]
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) **star:31479** Golang ebook intro how to build a web app with golang.   ![star > 5000][Gold]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) **star:4484** Learn Go with test-driven development.   ![star > 1000][Silver]   ![There was an update last week][Green]   ![Contains Chinese documents][CN]
