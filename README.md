...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-24 17:59:31(每隔1天同步一次)**
...
| [casbin](https://github.com/hsluoyz/casbin)  | 4843 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]   
...
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5864 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]   
...
| [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api)  | 1600 |  简单轻量级的Telegram bot客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [cobra](https://github.com/spf13/cobra)  | 13064 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [kingpin](https://github.com/alecthomas/kingpin)  | 2518 |  支持子命令的命令行和标志解析器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [ops](https://github.com/nanovms/ops)  | 254 |  Unikernel 构建器/协调器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [urfave/cli](https://github.com/urfave/cli)  | 11250 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [aurora](https://github.com/logrusorgru/aurora)  | 619 |  支持fmt.Printf/Sprintf的ANSI终端颜色。 |![star > 100][Bronze]   
...
| [gocui](https://github.com/jroimartin/gocui)  | 5254 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [gommon/color](https://github.com/labstack/gommon/tree/master/color)  | - |  更换终端文本样式。 |
| [gookit/color](https://github.com/gookit/color)  | 197 |  终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [termbox-go](https://github.com/nsf/termbox-go)  | 3455 |  基于文本的跨平台接口库。 |![star > 1000][Silver]   
...
| [termui](https://github.com/gizak/termui)  | 8864 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]   
| [uilive](https://github.com/gosuri/uilive)  | 821 |  用于实时更新终端输出的库。 |![star > 100][Bronze]   
| [uiprogress](https://github.com/gosuri/uiprogress)  | 1528 |  在终端呈现进度条，可灵活配置的。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [env](https://github.com/caarlos0/env)  | 850 |  解析环境变量并赋值到struct中(默认值)。 |![star > 100][Bronze]   
...
| [godotenv](https://github.com/joho/godotenv)  | 2092 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]   
...
| [gookit/config](https://github.com/gookit/config)  | 74 |  程序配置管理(load,get,set)。支持JSON, YAML, TOML, INI, HCL。支持多文件加载，数据覆盖合并。 |
...
| [ini](https://github.com/go-ini/ini)  | 1569 |   读和写INI文件。 |![star > 1000][Silver]   
...
| [viper](https://github.com/spf13/viper)  | 9192 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18869 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algorithms](https://github.com/shady831213/algorithms)  | 235 |  算法和数据结构。来源于CLRS。 |![star > 100][Bronze]   
...
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter)  | 508 |  布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。 |![star > 100][Bronze]   
...
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5102 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]   
...
| [gods](https://github.com/emirpasic/gods)  | 6206 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]   
...
| [willf/bloom](https://github.com/willf/bloom)  | 660 |  实现Bloom过滤器。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6209 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [buntdb](https://github.com/tidwall/buntdb)  | 2427 |  基于内存的K/V，快速，可嵌入的数据库，可自定义索引和空间支持。 |![star > 1000][Silver]   
...
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16700 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10074 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [diskv](https://github.com/peterbourgon/diskv)  | 740 |  支持磁盘备份的可持久化 K/V 存储。 |![star > 100][Bronze]   
| [eliasdb](https://github.com/krotik/eliasdb)  | 532 |  无其他依赖项，支持REST API，短语搜索和sql类似的查询语言的事务图数据库。 |![star > 100][Bronze]   
| [fastcache](https://github.com/VictoriaMetrics/fastcache)  | 479 |  基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。 |![star > 100][Bronze]   
| [GCache](https://github.com/bluele/gcache)  | 883 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]   
| [go-cache](https://github.com/pmylund/go-cache)  | 2856 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]   
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3145 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]   
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7615 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]   
| [influxdb](https://github.com/influxdb/influxdb)  | 16895 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [nutsdb](https://github.com/xujiajun/nutsdb)  | 853 |  Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [piladb](https://github.com/fern4lvarez/piladb)  | 171 |  基于堆栈数据结构的轻量级RESTful数据库引擎。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [prometheus](https://github.com/prometheus/prometheus)  | 25298 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [tidb](https://github.com/pingcap/tidb)  | 19838 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 963 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [migrate](https://github.com/golang-migrate/migrate)  | 2548 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sql-migrate](https://github.com/rubenv/sql-migrate)  | 1390 |  数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [kingshard](https://github.com/flike/kingshard)  | 4569 |  kingshard 是基于 Golang 的MySQL高性能代理。 |![star > 1000][Silver]   
...
| [orchestrator](https://github.com/github/orchestrator)  | 3005 |  MySQL复制拓扑管理器和可视化工具。 |![star > 1000][Silver]   
...
| [vitess](https://github.com/youtube/vitess)  | 8371 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gendry](https://github.com/didi/gendry)  | 745 |  非入侵的SQL构建器和强大的数据绑定器。 |![star > 100][Bronze]   
...
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2270 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]   
...
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 8028 |  MySQL驱动程序。 |![star > 5000][Gold]   
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3407 |  SQLite3驱动程序。 |![star > 1000][Silver]   
...
| [pgx](https://github.com/jackc/pgx)  | 1888 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-rejson](https://github.com/nitishm/go-rejson)  | 88 |  实现了基于 Redigo 客户端的redislabs' ReJSON 模块。可简单地将结构体存储为JSON对象并对其进行操作。 |
...
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 3012 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6220 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   
| [redis](https://github.com/go-redis/redis)  | 6384 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5805 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4075 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [elasticsql](https://github.com/cch123/elasticsql)  | 381 |  将 SQL 转换为 elasticsearch dsl。 |![star > 100][Bronze]   
...
| [riot](https://github.com/go-ego/riot)  | 4665 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   
...
| [cayley](https://github.com/google/cayley)  | 12658 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dht](https://github.com/anacrolix/dht)  | 124 |  BitTorrent Kademlia DHT的实现。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2494 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [glow](https://github.com/chrislusf/glow)  | 2512 |  全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。 |![star > 1000][Silver]   
...
| [go-kit](https://github.com/go-kit/kit)  | 14295 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]   
| [gorpc](https://github.com/valyala/gorpc)  | 548 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8965 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 998 |  支持25+种语言RPC库。 |![star > 100][Bronze]   
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8547 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1721 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   
| [micro](https://github.com/micro/micro)  | 6510 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [NATS](https://github.com/nats-io/gnatsd)  | 6241 |  轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [raft](https://github.com/hashicorp/raft)  | 2815 |  Raft consensus协议的实现。 by HashiCorp。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [rpcx](https://github.com/smallnest/rpcx)  | 3733 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tendermint](https://github.com/tendermint/tendermint)  | 3101 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [MailHog](https://github.com/mailhog/MailHog)  | 5115 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]   
...
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2933 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]   
...
| [errors](https://github.com/pkg/errors)  | 4811 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2199 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [accounting](https://github.com/leekchan/accounting)  | 484 |  货币和货币格式。 |![star > 100][Bronze]   
| [currency](https://github.com/bnkamalesh/currency)  | 8 |  高性能、准确的货币计算软件包。 |
| [decimal](https://github.com/shopspring/decimal)  | 1581 |  任意精度定点的十进制数。 |![star > 1000][Silver]   
...
| [g3n](https://github.com/g3n/engine)  | 735 |   3D游戏引擎。 |![star > 100][Bronze]   
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1159 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Leaf](https://github.com/name5566/leaf)  | 3027 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   
| [nano](https://github.com/lonng/nano)  | 975 |  轻量级、方便、高性能的基于golang的游戏服务器框架。 |![star > 100][Bronze]   
...
| [goderive](https://github.com/awalterschulze/goderive)  | 734 |  从输入类型来派生函数。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [c4go](https://github.com/Konstantin8105/c4go)  | 147 |  将 C 代码转换为 Go 代码。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1815 |  一个高性能的协程池。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [cyclicbarrier](https://github.com/marusama/cyclicbarrier)  | 30 |  基于 Go 的 CyclicBarrier 实现。 |
...
| [grpool](https://github.com/ivpusic/grpool)  | 492 |  轻量级协程池。 |![star > 100][Bronze]   
...
| [fyne](https://github.com/fyne-io/fyne)  | 6186 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gotk3](https://github.com/gotk3/gotk3)  | 757 |  实现了 GTK3 的 Go接口。 |![star > 100][Bronze]   
| [gowd](https://github.com/dtylman/gowd)  | 206 |  跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。 |![star > 100][Bronze]   
| [qt](https://github.com/therecipe/qt)  | 5970 |  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [ui](https://github.com/andlabs/ui)  | 6899 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]   
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3669 |  Windows应用程序库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [webview](https://github.com/zserge/webview)  | 4600 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]   
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4401 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gocv](https://github.com/hybridgroup/gocv)  | 2414 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [picfit](https://github.com/thoas/picfit)  | 1059 |  Go实现的图像调整服务器。 |![star > 1000][Silver]   
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11773 |  Go的结构化日志操作 。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [ozzo-log](https://github.com/go-ozzo/ozzo-log)  | 110 |  支持日志多等级、分类和过滤的高性能日志记录。可以发送过滤后的日志消息到各种目标(如控制台，网络，邮件)。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [tail](https://github.com/hpcloud/tail)  | 1525 |  努力模拟实现BSD的tail的特性的Go包。 |![star > 1000][Silver]   
...
| [zap](https://github.com/uber-go/zap)  | 7334 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]   
| [zerolog](https://github.com/rs/zerolog)  | 2164 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GoLearn](https://github.com/sjwhitworth/golearn)  | 6631 |  通用机器学习库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gorse](https://github.com/zhenghaoz/gorse)  | 523 |  基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。 |![star > 100][Bronze]   
...
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3649 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Commander](https://github.com/jeroenrinzema/commander)  | 21 |  高级事件驱动的消费者/生产者(consumer/producer)，支持各种“方言”，如Apache Kafka。 |
| [dbus](https://github.com/godbus/dbus)  | 354 |  D-Bus的Go bindings。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-socket.io](https://github.com/googollee/go-socket.io)  | 2864 |  go的socket.io库，一个实时应用程序框架。 |![star > 1000][Silver]   
...
| [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster)  | 1833 |  gopush-cluster是一个gopush服务器集群。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
| [gorush](https://github.com/appleboy/gorush)  | 3678 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3340 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mangos](https://github.com/go-mangos/mangos)  | 1532 |  Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。 |![star > 1000][Silver]   
| [melody](https://github.com/olahol/melody)  | 1540 |  处理websocket session的极简框架，包括广播和自动ping/pong处理。 |![star > 1000][Silver]   
...
| [NATS Go Client](https://github.com/nats-io/nats)  | 2378 |  轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sarama](https://github.com/Shopify/sarama)  | 4564 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1669 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4387 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [dig](https://github.com/uber-go/dig)  | 889 |  一个基于反射的Go依赖注入工具包。 |![star > 100][Bronze]   
| [fx](https://github.com/uber-go/fx)  | 660 |  基于依赖注入的Go应用程序框架(构建在dig之上)。 |![star > 100][Bronze]   
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8838 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]   
...
| [base64Captcha](https://github.com/mojocn/base64Captcha)  | 620 |  base64Captcha支持数字，字母，算术，音频和混合模式的验证码。 |![star > 100][Bronze]   
...
| [gopsutil](https://github.com/shirou/gopsutil)  | 3882 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gojieba](https://github.com/yanyiwu/gojieba)  | 811 |  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。 |![star > 100][Bronze]   
...
| [gse](https://github.com/go-ego/gse)  | 1060 |  高效的文本分割;支持英语、汉语、日语等。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [fasthttp](https://github.com/valyala/fasthttp)  | 9214 |  一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [ftp](https://github.com/jlaffaye/ftp)  | 517 |  实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gopacket](https://github.com/google/gopacket)  | 2835 |  Go library for packet processing with libpcap bindings. |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [kcptun](https://github.com/xtaci/kcptun)  | 10618 |  基于KCP协议的非常简单和快速udp隧道。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2862 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [webrtc](https://github.com/pions/webrtc)  | 2160 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sling](https://github.com/dghubble/sling)  | 982 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]   
...
| [GORM](https://github.com/jinzhu/gorm)  | 14464 |  一个出色的 ORM 库。主要目标是对开发人员友好。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2243 |  ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [upper.io/db](https://github.com/upper/db)  | 1836 |  对外提供统一的接口用于访问不同的存储介质，例如PostgreSQL, MySQL, SQLite, MSSQL, QL、MongoDB.。 |![star > 1000][Silver]   
| [Xorm](https://github.com/go-xorm/xorm)  | 5137 |  基于 Go 的简单而强大的ORM。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [govendor](https://github.com/kardianos/govendor)  | 4712 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]   
...
| [graphql](https://github.com/neelance/graphql-go)  | 2743 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   
| [graphql-go](https://github.com/graphql-go/graphql)  | 5156 |  为Go实现GraphQL。 |![star > 5000][Gold]   
...
| [packr](https://github.com/gobuffalo/packr)  | 2073 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [statics](https://github.com/go-playground/statics)  | 53 |  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。 |![最近一年没有更新][Yellow]
| [statik](https://github.com/rakyll/statik)  | 2070 |  将静态文件嵌入到Go可执行文件中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gonum](https://github.com/gonum/gonum)  | 2910 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gonum/plot](https://github.com/gonum/plot)  | 1203 |  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。 |![star > 1000][Silver]   
...
| [memguard](https://github.com/awnumar/memguard)  | 1048 |  一个用于处理内存中敏感值的纯Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [jsoniter](https://github.com/json-iterator/go)  | 5424 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   
...
| [Caddy](https://github.com/mholt/caddy)  | 22977 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [discovery](https://github.com/Bilibili/discovery)  | 665 |  用于弹性中间层负载平衡和故障转移的注册表。 |![star > 100][Bronze]   
| [etcd](https://github.com/coreos/etcd)  | 26195 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Fider](https://github.com/getfider/fider)  | 787 |  Fider是一个收集和组织客户反馈的开放平台。 |![star > 100][Bronze]   
| [Flagr](https://github.com/checkr/flagr)  | 812 |  Flagr是一个开源特性标记和A/B测试服务。 |![star > 100][Bronze]   
...
| [minio](https://github.com/minio/minio)  | 17115 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3212 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]   
...
| [quicktemplate](https://github.com/valyala/quicktemplate)  | 1388 |  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译 |![star > 1000][Silver]   
...
| [godog](https://github.com/DATA-DOG/godog)  | 738 |  类似 Cucumber 或 Behat 的 BDD 框架 |![star > 100][Bronze]   
...
| [Testify](https://github.com/stretchr/testify)  | 7999 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1693 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]   
...
| [gomock](https://github.com/golang/mock)  | 2786 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-fuzz](https://github.com/dvyukov/go-fuzz)  | 2859 |  随机测试系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [chromedp](https://github.com/knq/chromedp)  | 3496 |  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [ggr](https://github.com/aerokube/ggr)  | 208 |  一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs |![star > 100][Bronze]   
| [selenoid](https://github.com/aerokube/selenoid)  | 1204 |  Selenium hub 服务器的替代品，在容器中启动浏览器 |![star > 1000][Silver]   
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3859 |  Markdown 解析器 |![star > 1000][Silver]   
| [bluemonday](https://github.com/microcosm-cc/bluemonday)  | 1223 |  HTML 清理工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [codetree](https://github.com/aerogo/codetree)  | 7 |  解析缩进代码(python、pixy、scarlet等)并返回树结构。 |
| [colly](https://github.com/asciimoo/colly)  | 8244 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   
...
| [go-humanize](https://github.com/dustin/go-humanize)  | 1878 |  格式化程序，用于将时间、数字和内存大小转换为可读格式。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7515 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]   
...
| [toml](https://github.com/BurntSushi/toml)  | 2749 |  TOML配置格式(带反射的编码器/解码器)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
* Utility
...
| [github](https://github.com/google/go-github)  | 4727 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang)  | 1761 |  谷歌云api Go 客户端库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [slack](https://github.com/nlopes/slack)  | 2389 |  Slack API。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [circuit](https://github.com/cep21/circuit)  | 327 |  一个高效和功能齐全的 类似 Hystrix Go 实现断路器模式。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [circuitbreaker](https://github.com/rubyist/circuitbreaker)  | 784 |  接通断路器。 |![star > 100][Bronze]   
...
| [ctop](https://github.com/bcicen/ctop)  | 8751 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]   
...
| [delve](https://github.com/derekparker/delve)  | 11884 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [fzf](https://github.com/junegunn/fzf)  | 22882 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-funk](https://github.com/thoas/go-funk)  | 1151 |  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...) |![star > 1000][Silver]   
...
| [goreleaser](https://github.com/goreleaser/goreleaser)  | 4464 |  尽可能快速的发布 Go 语言二进制文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [hub](https://github.com/github/hub)  | 16830 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [panicparse](https://github.com/maruel/panicparse)  | 2133 |  将类似的协程分组并对调用栈进行着色 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [realize](https://github.com/tockins/realize)  | 3130 |  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。 |![star > 1000][Silver]   
...
| [resty](https://github.com/go-resty/resty)  | 1917 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]   
| [retry](https://github.com/kamilsk/retry)  | 147 |  基于上下文的功能机制，反复执行命令直到成功。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [validator](https://github.com/go-playground/validator)  | 3436 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Beego](https://github.com/astaxie/beego)  | 21307 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14539 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Gin](https://github.com/gin-gonic/gin)  | 29408 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2831 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-json-rest](https://github.com/ant0ine/go-json-rest)  | 3325 |  设置RESTful JSON API的快速简便方法。 |![star > 1000][Silver]   
| [go-rest](https://github.com/ungerik/go-rest)  | 116 |  小型的 REST 框架。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [Goa](https://github.com/goadesign/goa)  | 3487 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Macaron](https://github.com/go-macaron/macaron)  | 2802 |  Macaron 是一个高效的模块化设计的web框架 |![star > 1000][Silver]   
...
| [CORS](https://github.com/rs/cors)  | 1205 |  轻松地向API添加CORS功能。 |![star > 1000][Silver]   
...
| [Limiter](https://github.com/ulule/limiter)  | 781 |  简单的速度限制中间件。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [negroni](https://github.com/urfave/negroni)  | 6304 |  符合语言习惯的 HTTP 中间件库。 |![star > 5000][Gold]   
...
| [chi](https://github.com/go-chi/chi)  | 5969 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9616 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]   
...
| [mux](https://github.com/gorilla/mux)  | 9571 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [xujiajun/gorouter](https://github.com/xujiajun/gorouter)  | 448 |  一个简单和快速的HTTP路由器 Go 。 |![star > 100][Bronze]   
...
| [errcheck](https://github.com/kisielk/errcheck)  | 1318 |  Errcheck是一个用于检查Go程序中未检查错误的程序。 |![star > 1000][Silver]   
...
| [php-parser](https://github.com/z7zmey/php-parser)  | 624 |  用 Go 编写的 PHP 解析器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-mode](https://github.com/dominikh/go-mode.el)  | 946 |  在 GNU/Emacs 支持 GO。 |![star > 100][Bronze]   
| [go-plus](https://github.com/joefitzgerald/go-plus)  | 1482 |  在 Atom 中添加自动完成，格式化，语法检查，高亮和审查。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gocode](https://github.com/nsf/gocode)  | 4727 |  Autocompletion daemon for the Go programming language. |![star > 1000][Silver]   
...
| [vim-go](https://github.com/fatih/vim-go)  | 10763 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [bombardier](https://github.com/codesenberg/bombardier)  | 1718 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]   
...
| [gaia](https://github.com/gaia-pipeline/gaia)  | 3730 |  可用于任何编程语言来构建强大的管道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Gitea](https://github.com/go-gitea/gitea)  | 14931 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55716 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Moby](https://github.com/moby/moby)  | 54244 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Pomerium](https://github.com/pomerium/pomerium)  | 485 |  Pomerium是一个可识别身份的访问代理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [traefik](https://github.com/containous/traefik)  | 23515 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 12038 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Comcast](https://github.com/tylertreat/Comcast)  | 6162 |  模拟坏的网络连接。 |![star > 5000][Gold]   
| [confd](https://github.com/kelseyhightower/confd)  | 6389 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]   
...
| [LiteIDE](https://github.com/visualfc/liteide)  | 5447 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   
...
| [Pipe](https://github.com/b3log/pipe)  | 2817 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [restic](https://github.com/restic/restic)  | 7373 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3907 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
