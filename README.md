...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-26 19:57:20(每隔1天同步一次)**
...
| [Oto](https://github.com/hajimehoshi/oto)  | 427 |  多平台的 low-level 声音播放库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [authboss](https://github.com/volatiletech/authboss)  | 1917 |  web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。 |![star > 1000][Silver]
| [branca](https://github.com/hako/branca)  | 76 |  基于 Go 实现Branca令牌。 |
| [casbin](https://github.com/hsluoyz/casbin)  | 4861 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]
...
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server)  | 1270 |  用 Golang 编写的独立且符合规范的OAuth2服务器。 |![star > 1000][Silver]
| [gologin](https://github.com/dghubble/gologin)  | 1037 |  用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。 |![star > 1000][Silver]
| [gorbac](https://github.com/mikespook/gorbac)  | 903 |  轻量级的基于角色的访问控制(RBAC)实现。 |![star > 100][Bronze]
...
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5888 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [telebot](https://github.com/tucnak/telebot)  | 942 |  用Go编写的Telegram bot框架。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api)  | 1609 |  简单轻量级的Telegram bot客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [cobra](https://github.com/spf13/cobra)  | 13107 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [commandeer](https://github.com/jaffee/commandeer)  | 87 |  开发友好的CLI应用程序。 |   ![最近一个周有更新][Green]
...
| [ops](https://github.com/nanovms/ops)  | 259 |  Unikernel 构建器/协调器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [sflags](https://github.com/octago/sflags)  | 87 |  基于结构的flag生成器，用于flag、urfave/cli、pflag、cobra、kingpin和其他库。 |   ![最近一个周有更新][Green]
...
| [urfave/cli](https://github.com/urfave/cli)  | 11272 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [asciigraph](https://github.com/guptarohit/asciigraph)  | 1131 |  在命令行中构建轻量级ASCII线图╭┈╯，应用程序中没有其他依赖项。 |![star > 1000][Silver]
| [aurora](https://github.com/logrusorgru/aurora)  | 621 |  支持fmt.Printf/Sprintf的ANSI终端颜色。 |![star > 100][Bronze]
...
| [color](https://github.com/fatih/color)  | 3004 |  多功能包装，彩色终端输出。 |![star > 1000][Silver]
...
| [go-prompt](https://github.com/c-bata/go-prompt)  | 2305 |  构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) |![star > 1000][Silver]
| [gocui](https://github.com/jroimartin/gocui)  | 5285 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mpb](https://github.com/vbauerster/mpb)  | 602 |  可在终端显示多进度条。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [progressbar](https://github.com/schollz/progressbar)  | 564 |  基本线程安全的进度条，在每个操作系统工作。 |![star > 100][Bronze]
| [simpletable](https://github.com/alexeyco/simpletable)  | 156 |  可在终端显示简易表格。 |![star > 100][Bronze]
...
| [termbox-go](https://github.com/nsf/termbox-go)  | 3462 |  基于文本的跨平台接口库。 |![star > 1000][Silver]
...
| [termui](https://github.com/gizak/termui)  | 8877 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]
| [uilive](https://github.com/gosuri/uilive)  | 827 |  用于实时更新终端输出的库。 |![star > 100][Bronze]
| [uiprogress](https://github.com/gosuri/uiprogress)  | 1532 |  在终端呈现进度条，可灵活配置的。 |![star > 1000][Silver]
| [uitable](https://github.com/gosuri/uitable)  | 498 |  改善终端应用程序中表格数据的可读性。 |![star > 100][Bronze]
...
| [env](https://github.com/caarlos0/env)  | 855 |  解析环境变量并赋值到struct中(默认值)。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [godotenv](https://github.com/joho/godotenv)  | 2099 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]
...
| [gookit/config](https://github.com/gookit/config)  | 76 |  程序配置管理(load,get,set)。支持JSON, YAML, TOML, INI, HCL。支持多文件加载，数据覆盖合并。 |   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [harvester](https://github.com/beatlabs/harvester)  | 39 |  一个易于使用的静态和动态配置包 |
...
| [ini](https://github.com/go-ini/ini)  | 1578 |   读和写INI文件。 |![star > 1000][Silver]
...
| [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig)  | 2391 |  管理来自环境变量的配置数据。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [viper](https://github.com/spf13/viper)  | 9211 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18898 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]
...
| [goveralls](https://github.com/mattn/goveralls)  | 575 |  Coveralls.io 是一个用 Go 编写，可持续对代码覆盖率进行检测的系统。 |![star > 100][Bronze]
...
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5106 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]
...
| [gods](https://github.com/emirpasic/gods)  | 6229 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]
| [golang-set](https://github.com/deckarep/golang-set)  | 1149 |  线程安全和非线程安全的高性能集。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6222 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [bcache](https://github.com/iwanbk/bcache)  | 27 |  基于内存的最终一致的分布式缓存。 |
| [BigCache](https://github.com/allegro/bigcache)  | 2430 |  高效的键/值缓存为千兆字节的数据。 |![star > 1000][Silver]
| [bolt](https://github.com/boltdb/bolt)  | 9938 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
| [cache2go](https://github.com/muesli/cache2go)  | 1005 |  基于内存的 K/V 缓存，支持超时的自动失效。 |![star > 1000][Silver]
| [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache)  | 29 |  BigCache 支持集群和独立且生命周期存储项。 |   ![最近一年没有更新][Yellow]
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16718 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10090 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache)  | 480 |  基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。 |![star > 100][Bronze]
| [GCache](https://github.com/bluele/gcache)  | 888 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]
| [go-cache](https://github.com/pmylund/go-cache)  | 2864 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3154 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |   ![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7628 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]
| [influxdb](https://github.com/influxdb/influxdb)  | 16977 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [nutsdb](https://github.com/xujiajun/nutsdb)  | 866 |  Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [piladb](https://github.com/fern4lvarez/piladb)  | 171 |  基于堆栈数据结构的轻量级RESTful数据库引擎。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [prometheus](https://github.com/prometheus/prometheus)  | 25363 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 218 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]
| [rqlite](https://github.com/rqlite/rqlite)  | 4674 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tidb](https://github.com/pingcap/tidb)  | 19900 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 974 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [migrate](https://github.com/golang-migrate/migrate)  | 2562 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sql-migrate](https://github.com/rubenv/sql-migrate)  | 1399 |  数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。 |![star > 1000][Silver]
...
| [go-mysql](https://github.com/siddontang/go-mysql)  | 1857 |   Go 工具集，用于处理MySQL协议和复制。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2367 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]
| [kingshard](https://github.com/flike/kingshard)  | 4576 |  kingshard 是基于 Golang 的MySQL高性能代理。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [orchestrator](https://github.com/github/orchestrator)  | 3011 |  MySQL复制拓扑管理器和可视化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pgweb](https://github.com/sosedoff/pgweb)  | 5964 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [prep](https://github.com/hexdigest/prep)  | 24 |  在不更改代码的情况下使用准备好的SQL语句。 |   ![最近一年没有更新][Yellow]
| [pREST](https://github.com/nuveo/prest)  | 2078 |  基于PostgreSQL database的RESTful API服务。 |![star > 1000][Silver]
| [rwdb](https://github.com/andizzle/rwdb)  | 10 |  rwdb为多个数据库服务器的设置提供读取副本功能。 |   ![最近一年没有更新][Yellow]
| [vitess](https://github.com/youtube/vitess)  | 8386 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gendry](https://github.com/didi/gendry)  | 751 |  非入侵的SQL构建器和强大的数据绑定器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [godbal](https://github.com/xujiajun/godbal)  | 50 |  数据库抽象层(dbal)。支持SQL builder，轻松获取结果。 |
| [goqu](https://github.com/doug-martin/goqu)  | 626 |  常用的SQL生成器和查询库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2284 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]
...
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb)  | 1016 |  微软MSSQL驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-oci8](https://github.com/mattn/go-oci8)  | 404 |  Oracle 驱动程序。 |![star > 100][Bronze]
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 8045 |  MySQL驱动程序。 |![star > 5000][Gold]
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3412 |  SQLite3驱动程序。 |![star > 1000][Silver]
...
| [pgx](https://github.com/jackc/pgx)  | 1892 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pq](https://github.com/lib/pq)  | 5144 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gorethink](https://github.com/dancannon/gorethink)  | 1455 |  RethinkDB 驱动。 |![star > 1000][Silver]
...
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 3029 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6226 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [redis](https://github.com/go-redis/redis)  | 6413 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5810 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4090 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [elasticsql](https://github.com/cch123/elasticsql)  | 385 |  将 SQL 转换为 elasticsearch dsl。 |![star > 100][Bronze]
| [elastigo](https://github.com/mattbaird/elastigo)  | 950 |  Elasticsearch 客户端。 |![star > 100][Bronze]
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch)  | 1536 |  官方 Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goes](https://github.com/OwnLocal/goes)  | 24 |  实现了与 Elasticsearch 交互的库。 |   ![最近一年没有更新][Yellow]
| [riot](https://github.com/go-ego/riot)  | 4668 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [cayley](https://github.com/google/cayley)  | 12661 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [now](https://github.com/jinzhu/now)  | 2161 |  now 是时间有关的工具类。 |![star > 1000][Silver]
...
| [consistent](https://github.com/buraksezer/consistent)  | 185 |  Consistent hashing with bounded loads。 |![star > 100][Bronze]
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2500 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [emitter-io](https://github.com/emitter-io/emitter)  | 1906 |  高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。 |![star > 1000][Silver]
| [flowgraph](https://github.com/vectaport/flowgraph)  | 18 |  flow-based programming package。 |
| [gleam](https://github.com/chrislusf/gleam)  | 2071 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]
| [glow](https://github.com/chrislusf/glow)  | 2513 |  全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。 |![star > 1000][Silver]
...
| [go-kit](https://github.com/go-kit/kit)  | 14329 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]
| [gorpc](https://github.com/valyala/gorpc)  | 551 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8989 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 999 |  支持25+种语言RPC库。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8574 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1726 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [micro](https://github.com/micro/micro)  | 6521 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [raft](https://github.com/hashicorp/raft)  | 2821 |  Raft consensus协议的实现。 by HashiCorp。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [rpcx](https://github.com/smallnest/rpcx)  | 3742 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tendermint](https://github.com/tendermint/tendermint)  | 3107 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [torrent](https://github.com/anacrolix/torrent)  | 2822 |  BitTorrent 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [email](https://github.com/jordan-wright/email)  | 1089 |  一个强大和灵活的电子邮件库。 |![star > 1000][Silver]
| [go-dkim](https://github.com/toorop/go-dkim)  | 46 |  DKIM库，用于签署 & 验证电子邮件。 |
| [go-imap](https://github.com/emersion/go-imap)  | 723 |  用于客户端和服务器的IMAP库。 |![star > 100][Bronze]
...
| [hermes](https://github.com/matcornic/hermes)  | 1610 |  可生成干净的、响应式的HTML电子邮件。 |![star > 1000][Silver]
| [MailHog](https://github.com/mailhog/MailHog)  | 5126 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]
...
| [anko](https://github.com/mattn/anko)  | 919 |  用Go编写的解释器。 |![star > 100][Bronze]
| [binder](https://github.com/alexeyco/binder)  | 29 |  Lua接口，基于[gopher-lua](https://github.com/yuin/gopher-lua)。 |   ![最近一年没有更新][Yellow]
| [expr](https://github.com/antonmedv/expr)  | 687 |  一个可以计算表达式的引擎。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gentee](https://github.com/gentee/gentee)  | 25 |  嵌入式脚本编程语言。 |
...
| [go-lua](https://github.com/Shopify/go-lua)  | 1660 |  用 Go 实现的 Lua 5.2 VM接口。 |![star > 1000][Silver]
| [go-php](https://github.com/deuill/go-php)  | 674 |  PHP 的 Go 接口。 |![star > 100][Bronze]
| [go-python](https://github.com/sbinet/go-python)  | 905 |  CPython C-API 的 Go 接口。 |![star > 100][Bronze]
| [golua](https://github.com/aarzilli/golua)  | 441 |  Lua C 的 Go 接口。 |![star > 100][Bronze]
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2943 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]
...
| [tengo](https://github.com/d5/tengo)  | 1287 |  字节码编译的脚本语言。 |![star > 1000][Silver]
...
| [errors](https://github.com/pkg/errors)  | 4831 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]
...
| [tracerr](https://github.com/ztrue/tracerr)  | 494 |  可展示错误的堆栈跟踪信息和源码片段。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2205 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pdfcpu](https://github.com/hhrutter/pdfcpu)  | 937 |  PDF处理器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [nosurf](https://github.com/justinas/nosurf)  | 966 |  CSRF保护中间件。 |![star > 100][Bronze]
...
| [fuego](https://github.com/seborama/fuego)  | 37 |  Functional Experiment in Go。 |   ![最近一个周有更新][Green]
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1834 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [engo](https://github.com/EngoEngine/engo)  | 1076 |  开源 2D 游戏引擎。它遵循 Entity-Component-System 范式。 |![star > 1000][Silver]
| [g3n](https://github.com/g3n/engine)  | 738 |   3D游戏引擎。 |![star > 100][Bronze]
...
| [go-sdl2](https://github.com/veandco/go-sdl2)  | 1150 |  实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1166 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Leaf](https://github.com/name5566/leaf)  | 3036 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [Pitaya](https://github.com/topfreegames/pitaya)  | 296 |  可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity。 |![star > 100][Bronze]
...
| [gen](https://github.com/clipperhouse/gen)  | 1029 |  用于生成泛型等类似方法的功能代码生成工具。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
| [generis](https://github.com/senselogic/GENERIS)  | 18 |  提供泛型、free-form 宏、条件编译和HTML模板的代码生成工具。 |
| [go-enum](https://github.com/abice/go-enum)  | 82 |  从代码注释中生成枚举。 |
...
| [Tile38](https://github.com/tidwall/tile38)  | 6299 |  具有空间索引和实时地理定位功能的地理定位数据库。 |![star > 5000][Gold]
...
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8503 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1834 |  一个高性能的协程池。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [breaker](https://github.com/kamilsk/breaker)  | 32 |  灵活的机制，可以使执行流可中断。 |   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [app](https://github.com/murlokswarm/app)  | 2943 |  用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [fyne](https://github.com/fyne-io/fyne)  | 6201 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [go-astilectron](https://github.com/asticode/go-astilectron)  | 2641 |  使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。 |![star > 1000][Silver]
| [go-gtk](http://mattn.github.io/go-gtk/)  | - |  实现了 GTK 的 Go接口。 |
| [go-sciter](https://github.com/sciter-sdk/go-sciter)  | 1439 |  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。 |![star > 1000][Silver]
| [gotk3](https://github.com/gotk3/gotk3)  | 760 |  实现了 GTK3 的 Go接口。 |![star > 100][Bronze]
...
| [ui](https://github.com/andlabs/ui)  | 6913 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3671 |  Windows应用程序库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [webview](https://github.com/zserge/webview)  | 4616 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4405 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [systray](https://github.com/getlantern/systray)  | 774 |  跨平台 Go 库，可在通知区放置图标和菜单。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bild](https://github.com/anthonynsimon/bild)  | 2029 |  纯Go语言实现的图像处理算法合集。 |![star > 1000][Silver]
| [bimg](https://github.com/h2non/bimg)  | 784 |  使用libvips实现的快速高效的图像处理包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gg](https://github.com/fogleman/gg)  | 1896 |  纯Go语言实现的2D渲染。 |![star > 1000][Silver]
...
| [gocv](https://github.com/hybridgroup/gocv)  | 2422 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [image2ascii](https://github.com/qeesung/image2ascii)  | 288 |  将图像转换为ASCII码。 |![star > 100][Bronze]
| [imagick](https://github.com/gographics/imagick)  | 969 |   ImageMagick下MagickWand的C API的Go binding。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [imaginary](https://github.com/h2non/imaginary)  | 2579 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]
| [imaging](https://github.com/disintegration/imaging)  | 2497 |  简单的Go图像处理包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [picfit](https://github.com/thoas/picfit)  | 1060 |  Go实现的图像调整服务器。 |![star > 1000][Silver]
...
| [stegify](https://github.com/DimitarPetrov/stegify)  | 486 |   Go实现的LSB隐写（LSB steganography），能够隐藏任何文件到一个图像中。 |![star > 100][Bronze]
...
| [flogo](https://github.com/tibcosoftware/flogo)  | 1113 |  Flogo是一个面向物联网边缘应用和集成的开源框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gatt](https://github.com/paypal/gatt)  | 811 |  Gatt是一个用于构建低能耗蓝牙外围设备的Go语言包。 |![star > 100][Bronze]
...
| [mainflux](https://github.com/Mainflux/mainflux)  | 579 |  工业物联网消息和设备管理服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4832 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]
...
| [log15](https://github.com/inconshreveable/log15)  | 880 |  简单、强大的日志操作。 |![star > 100][Bronze]
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11805 |  Go的结构化日志操作 。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [lumberjack](https://github.com/natefinch/lumberjack)  | 1425 |  简单的滚动日志，io.WriteCloser的实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [spew](https://github.com/davecgh/go-spew)  | 3279 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [zap](https://github.com/uber-go/zap)  | 7347 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]
| [zerolog](https://github.com/rs/zerolog)  | 2177 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GoLearn](https://github.com/sjwhitworth/golearn)  | 6635 |  通用机器学习库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [gorgonia](https://github.com/chewxy/gorgonia)  | 2674 |  基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gosseract](https://github.com/otiai10/gosseract)  | 861 |  使用c++的Tesseract库实现的OCR。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Benthos](https://github.com/Jeffail/benthos)  | 1988 |  一系列协议之间的消息流桥接。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Bus](https://github.com/mustafaturan/bus)  | 114 |  内部通信的最小消息总线实现。 |![star > 100][Bronze]
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3655 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [EventBus](https://github.com/asaskevich/EventBus)  | 551 |  具有异步兼容性的轻量级事件总线。 |![star > 100][Bronze]
...
| [go-nsq](https://github.com/nsqio/go-nsq)  | 1451 |  NSQ的官方Go包。 |![star > 1000][Silver]
...
| [gorush](https://github.com/appleboy/gorush)  | 3683 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3343 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Mercure](https://github.com/dunglas/mercure)  | 1477 |  使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sarama](https://github.com/Shopify/sarama)  | 4578 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1679 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4404 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3344 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [xlsx](https://github.com/plandem/xlsx)  | 67 |  在Go程序以快速和安全的方式读取/更新现有的Microsoft Excel文件。 |   ![最近一个周有更新][Green]
...
| [dig](https://github.com/uber-go/dig)  | 893 |  一个基于反射的Go依赖注入工具包。 |![star > 100][Bronze]
| [fx](https://github.com/uber-go/fx)  | 690 |  基于依赖注入的Go应用程序框架(构建在dig之上)。 |![star > 100][Bronze]
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8884 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]
...
| [xstrings](https://github.com/huandu/xstrings)  | 616 |  从其他语言移植的有用字符串函数合集。 |![star > 100][Bronze]
...
| [go-resiliency](https://github.com/eapache/go-resiliency)  | 846 |   Go语言弹性模式(resiliency pattern)。 |![star > 100][Bronze]
...
| [gopsutil](https://github.com/shirou/gopsutil)  | 3890 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gosh](https://github.com/osamingo/gosh)  | 16 |  提供Go统计处理程序，结构和测量方法。 |   ![最近一个周有更新][Green]
| [gosms](https://github.com/haxpax/gosms)  | 1225 |  Go编写的私人的本地短信网关，可以用来发送短信。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
| [gse](https://github.com/go-ego/gse)  | 1064 |  高效的文本分割;支持英语、汉语、日语等。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [prose](https://github.com/jdkato/prose)  | 2038 |  用于支持标记化、词性标记、名称实体提取等文本处理的库。 |![star > 1000][Silver]
...
| [fasthttp](https://github.com/valyala/fasthttp)  | 9228 |  一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [ftp](https://github.com/jlaffaye/ftp)  | 519 |  实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-getter](https://github.com/hashicorp/go-getter)  | 721 |   通过URL来下载文件或目录。 |![star > 100][Bronze]
| [go-stun](https://github.com/ccding/go-stun)  | 331 |  实现了 STUN 客户端(RFC 3489和RFC 5389)。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gobgp](https://github.com/osrg/gobgp)  | 1665 |  基于 Go 的 BGP 实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [golibwireshark](https://github.com/sunwxg/golibwireshark)  | 14 |  用于解码 pcap 文件和分析解剖数据。 |   ![最近一年没有更新][Yellow]
| [gopacket](https://github.com/google/gopacket)  | 2845 |  Go library for packet processing with libpcap bindings. |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gosnmp](https://github.com/soniah/gosnmp)  | 431 |  用于执行 SNMP 操作的原生 Go 库。 |![star > 100][Bronze]
...
| [kcp-go](https://github.com/xtaci/kcp-go)  | 2234 |  快速可靠的ARQ协议。 |![star > 1000][Silver]
| [kcptun](https://github.com/xtaci/kcptun)  | 10625 |  基于KCP协议的非常简单和快速udp隧道。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [NFF-Go](https://github.com/intel-go/nff-go)  | 653 |  用于快速开发云计算和裸机网络功能的框架(原YANFF)。 |![star > 100][Bronze]
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2867 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [raw](https://github.com/mdlayher/raw)  | 303 |  Package raw支持在设备驱动程序级别读取和写入网络接口的数据。 |![star > 100][Bronze]
| [sftp](https://github.com/pkg/sftp)  | 727 |  Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |![star > 100][Bronze]
...
| [stun](https://github.com/go-rtc/stun)  | 269 |  Go实现的RFC 5389 STUN协议。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [tcp_server](https://github.com/firstrow/tcp_server)  | 281 |   Go 图书馆建设tcp服务器更快。 |![star > 100][Bronze]
...
| [water](https://github.com/songgao/water)  | 832 |  简单TUN / TAP图书馆。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [webrtc](https://github.com/pions/webrtc)  | 2166 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [heimdall](https://github.com/gojektech/heimdall)  | 1066 |  具有重试和hystrix功能的增强http客户机。 |![star > 1000][Silver]
...
| [sling](https://github.com/dghubble/sling)  | 986 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gl](https://github.com/go-gl/gl)  | 638 |  OpenGL 的 Go 接口实现(通过glow生成)。 |![star > 100][Bronze]
...
| [GORM](https://github.com/jinzhu/gorm)  | 14515 |  一个出色的 ORM 库。主要目标是对开发人员友好。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [gorp](https://github.com/go-gorp/gorp)  | 3072 |  基于 Go 的关系持久性 ORM-ish 库。 |![star > 1000][Silver]
...
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2249 |  ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]
...
| [Xorm](https://github.com/go-xorm/xorm)  | 5145 |  基于 Go 的简单而强大的ORM。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12530 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]
...
| [glide](https://github.com/Masterminds/glide)  | 7766 |  轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。 |![star > 5000][Gold]
...
| [gopm](https://github.com/gpmgo/gopm)  | 2349 |  包管理器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [govendor](https://github.com/kardianos/govendor)  | 4718 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gojsonq](https://github.com/thedevsaddam/gojsonq)  | 854 |  一个用来查询JSON数据的Go包。 |![star > 100][Bronze]
| [graphql](https://github.com/tmc/graphql)  | 51 |  graphql解析器+工具集 |   ![最近一年没有更新][Yellow]
| [graphql](https://github.com/neelance/graphql-go)  | 2751 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [graphql-go](https://github.com/graphql-go/graphql)  | 5171 |  为Go实现GraphQL。 |![star > 5000][Gold]
...
| [go.rice](https://github.com/GeertJohan/go.rice)  | 1637 |  go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。 |![star > 1000][Silver]
| [packr](https://github.com/gobuffalo/packr)  | 2081 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [statics](https://github.com/go-playground/statics)  | 53 |  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。 |   ![最近一年没有更新][Yellow]
| [statik](https://github.com/rakyll/statik)  | 2080 |  将静态文件嵌入到Go可执行文件中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [chart](https://github.com/vdobler/chart)  | 579 |  简单的图表绘制库。支持多种图形类型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go)  | 73 |  用于机器学习和统计的数据模型(类似于 pandas)。 |   ![最近一个周有更新][Green]
...
| [gonum](https://github.com/gonum/gonum)  | 2917 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [acmetool](https://github.com/hlandau/acme)  | 1693 |  ACME(让我们用自动更新加密)客户端工具。 |![star > 1000][Silver]
| [acra](https://github.com/cossacklabs/acra)  | 448 |  网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。 |![star > 100][Bronze]
...
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1815 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]
...
| [lego](https://github.com/xenolf/lego)  | 3464 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [memguard](https://github.com/awnumar/memguard)  | 1211 |  一个用于处理内存中敏感值的纯Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [secure](https://github.com/unrolled/secure)  | 1197 |  Go 语言 HTTP 中间件，为 Go 提供了一些安全功能 |![star > 1000][Silver]
...
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2908 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 5026 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5471 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mapstructure](https://github.com/mitchellh/mapstructure)  | 2381 |  用于对原生键值对进行解码生成 Go 语言结构体 |![star > 1000][Silver]
...
| [Caddy](https://github.com/mholt/caddy)  | 23007 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [consul](https://www.consul.io/)  | - |  Consul 是一个用于服务发现、监控和配置的工具 |
| [devd](https://github.com/cortesi/devd)  | 2799 |  为开发人员提供本地web服务器。 |![star > 1000][Silver]
| [discovery](https://github.com/Bilibili/discovery)  | 668 |  用于弹性中间层负载平衡和故障转移的注册表。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [etcd](https://github.com/coreos/etcd)  | 26252 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [minio](https://github.com/minio/minio)  | 17158 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3224 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]
...
| [gofpdf](https://github.com/jung-kurt/gofpdf)  | 3056 |  PDF 文档生成器，支持文本，绘图和图片 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pongo2](https://github.com/flosch/pongo2)  | 1484 |  类似 DjanGo 的模板引擎 |![star > 1000][Silver]
...
| [go-cmp](https://github.com/google/go-cmp)  | 1132 |  用于比较测试中的Go值的包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-mutesting](https://github.com/zimmski/go-mutesting)  | 289 |  变异测试的Go源代码。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-testdeep](https://github.com/maxatome/go-testdeep)  | 56 |  极具灵活性的golang深度比较，扩展了go测试包。 |
...
| [godog](https://github.com/DATA-DOG/godog)  | 743 |  类似 Cucumber 或 Behat 的 BDD 框架 |![star > 100][Bronze]
...
| [httpexpect](https://github.com/gavv/httpexpect)  | 1137 |  简洁的、声明式的、易用的端到端HTTP 及 REST API 测试 |![star > 1000][Silver]
...
| [Testify](https://github.com/stretchr/testify)  | 8037 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1713 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]
| [go-txdb](https://github.com/DATA-DOG/go-txdb)  | 158 |  基于单事务的数据库驱动，主要用于测试目的 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gock](https://github.com/h2non/gock)  | 806 |  多功能、易用 HTTP mock |![star > 100][Bronze]
| [gomock](https://github.com/golang/mock)  | 2795 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]
| [govcr](https://github.com/seborama/govcr)  | 82 |  HTTP mock : 离线测试时记录和重放浏览器的动作 |   ![最近一个周有更新][Green]
| [hoverfly](https://github.com/SpectoLabs/hoverfly)  | 1431 |  使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [httpmock](https://github.com/jarcoal/httpmock)  | 574 |  轻松模拟来自外部资源的HTTP响应。 |![star > 100][Bronze]
| [minimock](https://github.com/gojuno/minimock)  | 253 |  Go接口的模拟生成器。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-fuzz](https://github.com/dvyukov/go-fuzz)  | 2862 |  随机测试系统。 |![star > 1000][Silver]
| [gofuzz](https://github.com/google/gofuzz)  | 529 |  用于生成随机值来初始化 Go 语言对象的库 |![star > 100][Bronze]
...
| [chromedp](https://github.com/knq/chromedp)  | 3507 |  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品 |![star > 1000][Silver]
...
| [selenoid](https://github.com/aerokube/selenoid)  | 1214 |  Selenium hub 服务器的替代品，在容器中启动浏览器 |![star > 1000][Silver]
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3865 |  Markdown 解析器 |![star > 1000][Silver]
| [bluemonday](https://github.com/microcosm-cc/bluemonday)  | 1234 |  HTML 清理工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [codetree](https://github.com/aerogo/codetree)  | 7 |  解析缩进代码(python、pixy、scarlet等)并返回树结构。 |
| [colly](https://github.com/asciimoo/colly)  | 8267 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [commonregex](https://github.com/mingrammer/commonregex)  | 550 |  一组用于Go的公共正则表达式。 |![star > 100][Bronze]
| [dataflowkit](https://github.com/slotix/dataflowkit)  | 286 |  Web抓取框架将网站转换为结构化数据。 |![star > 100][Bronze]
...
| [go-humanize](https://github.com/dustin/go-humanize)  | 1884 |  格式化程序，用于将时间、数字和内存大小转换为可读格式。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gofeed](https://github.com/mmcdole/gofeed)  | 1092 |  在Go中解析RSS和Atom feeds。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7520 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]
...
| [mxj](https://github.com/clbanning/mxj)  | 328 |  将XML编码/解码为JSON或map[string]接口{};使用点符号路径和通配符提取值。替换x2j和j2x包。 |![star > 100][Bronze]
| [sdp](https://github.com/gortc/sdp)  | 69 |  SDP:会话描述协议[[RFC 4566](https://tools.ietf.org/html/rfc4566)]。 |   ![最近一个周有更新][Green]
| [sh](https://github.com/mvdan/sh)  | 1967 |  Shell解析器和格式化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [toml](https://github.com/BurntSushi/toml)  | 2756 |  TOML配置格式(带反射的编码器/解码器)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
* Utility
...
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 4996 |  AWS 提供的官方go语言 SDK |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [discordgo](https://github.com/bwmarrin/discordgo)  | 960 |   Discord Chat API的客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ethrpc](https://github.com/onrik/ethrpc)  | 166 |   Ethereum JSON RPC API的客户端。 |![star > 100][Bronze]
...
| [github](https://github.com/google/go-github)  | 4734 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [google](https://github.com/google/google-api-go-client)  | 1909 |  为Go自动生成谷歌api。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [google-analytics](https://github.com/chonthu/go-google-analytics)  | 12 |  简单的包装，方便的谷歌分析报告。 |   ![最近一年没有更新][Yellow]
| [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang)  | 1763 |  谷歌云api Go 客户端库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [slack](https://github.com/nlopes/slack)  | 2393 |  Slack API。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [ctop](https://github.com/bcicen/ctop)  | 8762 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]
...
| [delve](https://github.com/derekparker/delve)  | 11905 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [filetype](https://github.com/h2non/filetype)  | 937 |  通过数字签名来推测文件类型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [fzf](https://github.com/junegunn/fzf)  | 22937 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [git-time-metric](https://github.com/git-time-metric/gtm)  | 712 |  git-time-metric - 。 |![star > 100][Bronze]
...
| [go-funk](https://github.com/thoas/go-funk)  | 1155 |  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...) |![star > 1000][Silver]
...
| [go-torch](https://github.com/uber/go-torch)  | 3631 |  为 Go 语言程序生成火焰图。 |![star > 1000][Silver]
...
| [goreadability](https://github.com/philipjkim/goreadability)  | 31 |  网页摘要提取器使用Facebook开放图形和arc90的可读性。 |
| [goreleaser](https://github.com/goreleaser/goreleaser)  | 4469 |  尽可能快速的发布 Go 语言二进制文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goreporter](https://github.com/wgliang/goreporter)  | 2480 |  进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具 |![star > 1000][Silver]
...
| [hub](https://github.com/github/hub)  | 16848 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mimetype](https://github.com/gabriel-vasile/mimetype)  | 105 |  用于基于神奇数字的MIME类型检测的包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [minify](https://github.com/tdewolff/minify)  | 1850 |  用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [panicparse](https://github.com/maruel/panicparse)  | 2136 |  将类似的协程分组并对调用栈进行着色 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [profile](https://github.com/pkg/profile)  | 995 |  Go的简单分析支持包。 |![star > 100][Bronze]
| [rclient](https://github.com/zpatrick/rclient)  | 27 |  可读、灵活、易于使用的REST api客户端。 |
| [realize](https://github.com/tockins/realize)  | 3135 |  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。 |![star > 1000][Silver]
...
| [resty](https://github.com/go-resty/resty)  | 1932 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]
...
| [sqlx](https://github.com/jmoiron/sqlx)  | 6717 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Task](https://github.com/go-task/task)  | 1908 |  简单的“Go”的选择。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [usql](https://github.com/knq/usql)  | 4661 |  usql 是一个通用的命令行接口，用于操作 sql 数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [ulid](https://github.com/oklog/ulid)  | 1665 |  实现了ULID(普遍唯一的词典分类标识符)。 |![star > 1000][Silver]
...
| [govalidator](https://github.com/asaskevich/govalidator)  | 3525 |  用于字符串，数字，切片和结构的验证器和sanitizers。 |![star > 1000][Silver]
...
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation)  | 1027 |  支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。 |![star > 1000][Silver]
...
| [go-git](https://github.com/src-d/go-git)  | 4171 |  纯Go中高度可扩展的Git实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-astits](https://github.com/asticode/go-astits)  | 256 |  在GO中解析和演示MPEG传输流(.ts)。 |![star > 100][Bronze]
...
| [Beego](https://github.com/astaxie/beego)  | 21346 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14570 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Gin](https://github.com/gin-gonic/gin)  | 29534 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2834 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]
| [go-json-rest](https://github.com/ant0ine/go-json-rest)  | 3328 |  设置RESTful JSON API的快速简便方法。 |![star > 1000][Silver]
| [go-rest](https://github.com/ungerik/go-rest)  | 116 |  小型的 REST 框架。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [Goa](https://github.com/goadesign/goa)  | 3495 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [hiboot](https://github.com/hidevopsio/hiboot)  | 85 |  hiboot是一个高性能的web应用程序框架，支持自动配置和依赖注入。 |   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Macaron](https://github.com/go-macaron/macaron)  | 2803 |  Macaron 是一个高效的模块化设计的web框架 |![star > 1000][Silver]
...
| [Revel](https://github.com/revel/revel)  | 11222 |  用于Go语言的高效web框架。 |![star > 5000][Gold]
...
| [uAdmin](https://github.com/uadmin/uadmin)  | 50 |  受到 Sinatra 启发的 Go 语言 web 框架。 |
...
| [Tollbooth](https://github.com/didip/tollbooth)  | 1238 |  限制速率的 HTTP 请求处理程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [negroni](https://github.com/urfave/negroni)  | 6310 |  符合语言习惯的 HTTP 中间件库。 |![star > 5000][Gold]   ![包含中文文档][CN]
| [render](https://github.com/unrolled/render)  | 1265 |  Go package用于方便地呈现JSON、XML和HTML模板响应。 |![star > 1000][Silver]
...
| [chi](https://github.com/go-chi/chi)  | 5984 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Goji](https://github.com/goji/goji)  | 765 |  枸杞是一种简约的和灵活的与支持'net/context` HTTP请求多路复用器。 |![star > 100][Bronze]
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9642 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]
...
| [mux](https://github.com/gorilla/mux)  | 9588 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-ole](https://github.com/go-ole/go-ole)  | 550 |  为 Go 语言实现的 Win32 OLE。 |![star > 100][Bronze]
...
| [xpath](https://github.com/antchfx/xpath)  | 161 |  Go的XPath包。 |![star > 100][Bronze]
...
| [GoLint](https://github.com/golang/lint)  | 3134 |  Go 源码的 linter。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GoSublime](https://github.com/DisposaBoy/GoSublime)  | 3231 |  包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [vim-go](https://github.com/fatih/vim-go)  | 10771 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5091 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [genny](https://github.com/cheekybits/genny)  | 944 |  优雅的 Go 泛型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gotests](https://github.com/cweill/gotests)  | 2173 |  从源代码生成测试用例。 |![star > 1000][Silver]
...
| [depth](https://github.com/KyleBanks/depth)  | 373 |  通过分析导入，将包依赖关系树可视化输出。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-callvis](https://github.com/TrueFurby/go-callvis)  | 1980 |  使用 dot format 可视化 Go 程序的调用图。 |![star > 1000][Silver]
| [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete)  | 37 |  Bash completion for go and wgo。 |   ![最近一年没有更新][Yellow]
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3928 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [godbg](https://github.com/tylerwince/godbg)  | 156 |  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。 |![star > 100][Bronze]
| [OctoLinker](https://github.com/OctoLinker/browser-extension)  | 3740 |  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [aurora](https://github.com/xuri/aurora)  | 399 |  基于web的跨平台 Beanstalkd 队列服务器控制台。 |![star > 100][Bronze]
...
| [bombardier](https://github.com/codesenberg/bombardier)  | 1722 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]
...
| [fac](https://github.com/mkchoi212/fac)  | 1610 |  修复 git 合并冲突。 |![star > 1000][Silver]
| [gaia](https://github.com/gaia-pipeline/gaia)  | 3732 |  可用于任何编程语言来构建强大的管道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Gitea](https://github.com/go-gitea/gitea)  | 14971 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [gox](https://github.com/mitchellh/gox)  | 3344 |  非常简单，没有多余的跨平台编译工具。 |![star > 1000][Silver]
...
| [Hey](https://github.com/rakyll/hey)  | 6234 |  压力测试工具，可用来代替 ApacheBench (ab)。 |![star > 5000][Gold]
| [kala](https://github.com/ajvb/kala)  | 1354 |  简单、现代和高性能的作业调度程序。 |![star > 1000][Silver]
| [kcli](https://github.com/cswank/kcli)  | 78 |  用于检查kafka主题/分区/消息的命令行工具。 |
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55807 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Moby](https://github.com/moby/moby)  | 54280 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [script](https://github.com/bitfield/script)  | 903 |  让DevOps编写类shell和系统管理任务变得更加容易。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [sg](https://github.com/ChristopherRabotin/sg)  | 5 |  可测试一组HTTP极限(如ab)，可以在每个调用之间使用响应代码和数据，根据之前的响应来确定特定的服务器压力。 |   ![最近一年没有更新][Yellow]
| [skm](https://github.com/TimothyYe/skm)  | 548 |  SKM是一个简单而强大的SSH密钥管理器，它可以帮助您轻松地管理多个SSH密钥! |![star > 100][Bronze]
| [StatusOK](https://github.com/sanathp/statusok)  | 1158 |  监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。 |![star > 1000][Silver]
| [traefik](https://github.com/containous/traefik)  | 23560 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 12069 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [webhook](https://github.com/adnanh/webhook)  | 4060 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]
...
| [Documize](https://github.com/documize/community)  | 816 |  集成了SaaS工具数据的现代wiki软件。 |![star > 100][Bronze]
| [drive](https://github.com/odeke-em/drive)  | 4944 |  基于命令行的谷歌驱动器客户端。 |![star > 1000][Silver]
| [Duplicacy](https://github.com/gilbertchen/duplicacy)  | 2679 |  跨平台网络和云备份工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gfile](https://github.com/Antonito/gfile)  | 495 |  通过WebRTC在两台计算机之间安全地传输文件，不需要任何第三方依赖。 |![star > 100][Bronze]
...
| [GoDNS](https://github.com/timothyye/godns)  | 423 |  一个动态DNS客户端工具，支持DNSPod & HE.net。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [lgo](https://github.com/yunabe/lgo)  | 1796 |  与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。 |![star > 1000][Silver]
| [limetext](http://limetext.org/)  | - |  一个强大而优雅的文本编辑器。 |
| [LiteIDE](https://github.com/visualfc/liteide)  | 5458 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [peg](https://github.com/pointlander/peg)  | 603 |  解析表达式语法，是Packrat解析器生成器的实现。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Pipe](https://github.com/b3log/pipe)  | 2857 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [restic](https://github.com/restic/restic)  | 7383 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Seaweed File System](https://github.com/chrislusf/seaweedfs)  | 8165 |  快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Stack Up](https://github.com/pressly/sup)  | 1987 |  Stack Up 是一个超级简单的部署工具 — 只面向Unix。 |![star > 1000][Silver]
| [syncthing](https://syncthing.net/)  | - |  开放，分散的文件同步工具和协议。 |
| [term-quiz](https://github.com/crazcalm/term-quiz)  | 17 |  测试你的终端。 |
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3917 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark)  | 989 |  web框架基准测试。 |![star > 100][Bronze]
