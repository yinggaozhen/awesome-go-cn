...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [authboss](https://github.com/volatiletech/authboss)  | 1908 |  web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [branca](https://github.com/hako/branca)  | 70 |  基于 Go 实现Branca令牌。 |
| [casbin](https://github.com/hsluoyz/casbin)  | 4803 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [cookiestxt](https://github.com/mengzhuo/cookiestxt)  | 2 |  提供cookie .txt文件格式的解析器。 |![最近一年没有更新][Yellow]
| [go-jose](https://github.com/square/go-jose)  | 1110 |  相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。 |![star > 1000][Silver]   
...
| [goth](https://github.com/markbates/goth)  | 2234 |  提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。 |![star > 1000][Silver]   
...
| [jwt](https://github.com/pascaldekloe/jwt)  | 76 |  轻量级JSON Web令牌库。 |
| [jwt-auth](https://github.com/adam-hanna/jwt-auth)  | 151 |  JWT中间件，可用于Golang http服务器，提供了许多配置选项。 |![star > 100][Bronze]   
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5816 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]   
...
| [oauth2](https://github.com/golang/oauth2)  | 2355 |  goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [osin](https://github.com/openshift/osin)  | 1537 |  OAuth2服务器库。 |![star > 1000][Silver]   
| [paseto](https://github.com/o1egl/paseto)  | 224 |  平台无关的安全令牌(PASETO)。 |![star > 100][Bronze]   
...
| [sjwt](https://github.com/brianvoe/sjwt)  | 29 |  简单的jwt生成器和解析器。 |![最近一个周有更新][Green]
...
| [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api)  | 1585 |  简单轻量级的Telegram bot客户端。 |![star > 1000][Silver]   
...
| [cobra](https://github.com/spf13/cobra)  | 12947 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [docopt.go](https://github.com/docopt/docopt.go)  | 1155 |  会让你满意的命令行参数解析器。 |![star > 1000][Silver]   
...
| [go-flags](https://github.com/jessevdk/go-flags)  | 1495 |   Go 命令行选项解析器。 |![star > 1000][Silver]   
...
| [job](https://github.com/liujianping/job)  | 46 |  工作，把你的短期指令当作长期任务。 |
...
| [ops](https://github.com/nanovms/ops)  | 247 |  Unikernel 构建器/协调器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [pflag](https://github.com/spf13/pflag)  | 737 |  基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。 |![star > 100][Bronze]   
...
| [urfave/cli](https://github.com/urfave/cli)  | 11166 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [asciigraph](https://github.com/guptarohit/asciigraph)  | 1127 |  在命令行中构建轻量级ASCII线图╭┈╯，应用程序中没有其他依赖项。 |![star > 1000][Silver]   
...
| [color](https://github.com/fatih/color)  | 2991 |  多功能包装，彩色终端输出。 |![star > 1000][Silver]   
...
| [go-prompt](https://github.com/c-bata/go-prompt)  | 2283 |  构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) |![star > 1000][Silver]   
| [gocui](https://github.com/jroimartin/gocui)  | 5183 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   
...
| [progressbar](https://github.com/schollz/progressbar)  | 560 |  基本线程安全的进度条，在每个操作系统工作。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [termbox-go](https://github.com/nsf/termbox-go)  | 3451 |  基于文本的跨平台接口库。 |![star > 1000][Silver]   
| [termdash](https://github.com/mum4k/termdash)  | 793 |  此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [termui](https://github.com/gizak/termui)  | 8844 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [uilive](https://github.com/gosuri/uilive)  | 820 |  用于实时更新终端输出的库。 |![star > 100][Bronze]   
...
| [goConfig](https://github.com/crgimenes/goConfig)  | 104 |  将结构体解析为输入，并用来自命令行、环境变量和配置文件的参数填充该结构体的字段。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [godotenv](https://github.com/joho/godotenv)  | 2071 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]   
...
| [ini](https://github.com/go-ini/ini)  | 1552 |   读和写INI文件。 |![star > 1000][Silver]   
...
| [koanf](https://github.com/knadh/koanf)  | 77 |  轻量级可扩展库，用于读取Go应用程序中的配置。内置支持JSON, TOML, YAML, env，命令行。 |
...
| [viper](https://github.com/spf13/viper)  | 9114 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18801 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]   
...
| [goveralls](https://github.com/mattn/goveralls)  | 570 |  Coveralls.io 是一个用 Go 编写，可持续对代码覆盖率进行检测的系统。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algorithms](https://github.com/shady831213/algorithms)  | 231 |  算法和数据结构。来源于CLRS。 |![star > 100][Bronze]   
...
| [boomfilters](https://github.com/tylertreat/BoomFilters)  | 1127 |  用于处理连续的概率数据结构。 |![star > 1000][Silver]   
...
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter)  | 502 |  布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。 |![star > 100][Bronze]   
...
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5086 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]   
...
| [gods](https://github.com/emirpasic/gods)  | 6172 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]   
| [golang-set](https://github.com/deckarep/golang-set)  | 1137 |  线程安全和非线程安全的高性能集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [willf/bloom](https://github.com/willf/bloom)  | 653 |  实现Bloom过滤器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6171 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [bcache](https://github.com/iwanbk/bcache)  | 26 |  基于内存的最终一致的分布式缓存。 |
| [BigCache](https://github.com/allegro/bigcache)  | 2419 |  高效的键/值缓存为千兆字节的数据。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [bolt](https://github.com/boltdb/bolt)  | 9906 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
| [cache2go](https://github.com/muesli/cache2go)  | 988 |  基于内存的 K/V 缓存，支持超时的自动失效。 |![star > 100][Bronze]   
| [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache)  | 29 |  BigCache 支持集群和独立且生命周期存储项。 |![最近一年没有更新][Yellow]
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16639 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [couchcache](https://github.com/codingsince1985/couchcache)  | 40 |  由 Couchbase服务 支持的RESTful缓存微服务。 |
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL)  | 1440 |  区块链领域的一个SQL数据库。 |![star > 1000][Silver]   
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10026 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache)  | 473 |  基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。 |![star > 100][Bronze]   
| [GCache](https://github.com/bluele/gcache)  | 873 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]   
| [go-cache](https://github.com/pmylund/go-cache)  | 2828 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]   
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3124 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]   
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7591 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [influxdb](https://github.com/influxdb/influxdb)  | 16819 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [ledisdb](https://github.com/siddontang/ledisdb)  | 3052 |  Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。 |![star > 1000][Silver]   
| [levigo](https://github.com/jmhodges/levigo)  | 364 |  实现了对LevelDB封装。 |![star > 100][Bronze]   
| [moss](https://github.com/couchbase/moss)  | 714 |  Moss是一个用100% Go编写的简单LSM键值存储引擎。 |![star > 100][Bronze]   
...
| [prometheus](https://github.com/prometheus/prometheus)  | 25151 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 218 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]   
| [rqlite](https://github.com/rqlite/rqlite)  | 4658 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tidb](https://github.com/pingcap/tidb)  | 19728 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 937 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [migrate](https://github.com/golang-migrate/migrate)  | 2510 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk)  | 128 |  收集小的 insterts 并向 ClickHouse 服务器发送大请求。 |![star > 100][Bronze]   
...
| [go-mysql](https://github.com/siddontang/go-mysql)  | 1836 |   Go 工具集，用于处理MySQL协议和复制。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2327 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]   
| [kingshard](https://github.com/flike/kingshard)  | 4559 |  kingshard 是基于 Golang 的MySQL高性能代理。 |![star > 1000][Silver]   
...
| [pgweb](https://github.com/sosedoff/pgweb)  | 5946 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]   
...
| [vitess](https://github.com/youtube/vitess)  | 8335 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gendry](https://github.com/didi/gendry)  | 741 |  非入侵的SQL构建器和强大的数据绑定器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [godbal](https://github.com/xujiajun/godbal)  | 50 |  数据库抽象层(dbal)。支持SQL builder，轻松获取结果。 |
| [goqu](https://github.com/doug-martin/goqu)  | 616 |  常用的SQL生成器和查询库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2214 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]   
...
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb)  | 1010 |  微软MSSQL驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-oci8](https://github.com/mattn/go-oci8)  | 399 |  Oracle 驱动程序。 |![star > 100][Bronze]   
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 7960 |  MySQL驱动程序。 |![star > 5000][Gold]   
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3387 |  SQLite3驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pgx](https://github.com/jackc/pgx)  | 1874 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pq](https://github.com/lib/pq)  | 5116 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6189 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   
| [redis](https://github.com/go-redis/redis)  | 6312 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5766 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4059 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch)  | 1504 |  官方 Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goes](https://github.com/OwnLocal/goes)  | 24 |  实现了与 Elasticsearch 交互的库。 |![最近一年没有更新][Yellow]
| [riot](https://github.com/go-ego/riot)  | 4648 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   
...
| [cayley](https://github.com/google/cayley)  | 12632 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   
...
| [now](https://github.com/jinzhu/now)  | 2150 |  now 是时间有关的工具类。 |![star > 1000][Silver]   
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2476 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [emitter-io](https://github.com/emitter-io/emitter)  | 1890 |  高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。 |![star > 1000][Silver]   
| [flowgraph](https://github.com/vectaport/flowgraph)  | 18 |  flow-based programming package。 |
| [gleam](https://github.com/chrislusf/gleam)  | 2050 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]   
| [glow](https://github.com/chrislusf/glow)  | 2499 |  全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。 |![star > 1000][Silver]   
...
| [go-kit](https://github.com/go-kit/kit)  | 14230 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]   
| [gorpc](https://github.com/valyala/gorpc)  | 547 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8872 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 994 |  支持25+种语言RPC库。 |![star > 100][Bronze]   
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8494 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1697 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   
| [micro](https://github.com/micro/micro)  | 6487 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [NATS](https://github.com/nats-io/gnatsd)  | 6173 |  轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [raft](https://github.com/hashicorp/raft)  | 2807 |  Raft consensus协议的实现。 by HashiCorp。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [rpcx](https://github.com/smallnest/rpcx)  | 3705 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]   
...
| [tendermint](https://github.com/tendermint/tendermint)  | 3088 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [torrent](https://github.com/anacrolix/torrent)  | 2801 |  BitTorrent 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [email](https://github.com/jordan-wright/email)  | 1083 |  一个强大和灵活的电子邮件库。 |![star > 1000][Silver]   
| [go-dkim](https://github.com/toorop/go-dkim)  | 46 |  DKIM库，用于签署 & 验证电子邮件。 |
| [go-imap](https://github.com/emersion/go-imap)  | 716 |  用于客户端和服务器的IMAP库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [anko](https://github.com/mattn/anko)  | 912 |  用Go编写的解释器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [binder](https://github.com/alexeyco/binder)  | 29 |  Lua接口，基于[gopher-lua](https://github.com/yuin/gopher-lua)。 |
| [expr](https://github.com/antonmedv/expr)  | 673 |  一个可以计算表达式的引擎。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [golua](https://github.com/aarzilli/golua)  | 437 |  Lua C 的 Go 接口。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2920 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]   
...
| [otto](https://github.com/robertkrimen/otto)  | 4688 |  用 Go 编写的 JavaScript 解释器。 |![star > 1000][Silver]   
...
| [errors](https://github.com/pkg/errors)  | 4780 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]   
| [errorx](https://github.com/joomcode/errorx)  | 548 |  一个功能丰富的错误包，可进行堆栈跟踪、组装异常信息以及其他。 |![star > 100][Bronze]   
| [go-multierror](https://github.com/hashicorp/go-multierror)  | 712 |  可将一系列的错误作为一个整体来显示。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2192 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pdfcpu](https://github.com/hhrutter/pdfcpu)  | 933 |  PDF处理器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [decimal](https://github.com/shopspring/decimal)  | 1570 |  任意精度定点的十进制数。 |![star > 1000][Silver]   
...
| [go-money](https://github.com/rhymond/go-money)  | 610 |  Fowler 货币模式的实现。 |![star > 100][Bronze]   
| [ofxgo](https://github.com/aclindsa/ofxgo)  | 59 |  查询 OFX 服务器和/或解析响应。 |
| [orderbook](https://github.com/i25959341/orderbook)  | 67 |  限购单匹配引擎。 |
| [techan](https://github.com/sdcoffey/techan)  | 153 |  拥有先进的市场分析和交易策略的技术分析库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1809 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-sdl2](https://github.com/veandco/go-sdl2)  | 1139 |  实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1147 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   
| [Leaf](https://github.com/name5566/leaf)  | 3022 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   
| [nano](https://github.com/lonng/nano)  | 967 |  轻量级、方便、高性能的基于golang的游戏服务器框架。 |![star > 100][Bronze]   
| [Oak](https://github.com/oakmound/oak)  | 622 |  纯 Go 实现的游戏引擎。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Pitaya](https://github.com/topfreegames/pitaya)  | 292 |  可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Pixel](https://github.com/faiface/pixel)  | 2409 |  手工制作的 2D 游戏库。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [geocache](https://github.com/melihmucuk/geocache)  | 108 |  基于内存缓存的的地理位置的应用程序。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [S2 geometry](https://github.com/golang/geo)  | 876 |  S2 geometry 库。 |![star > 100][Bronze]   
| [Tile38](https://github.com/tidwall/tile38)  | 6288 |  具有空间索引和实时地理定位功能的地理定位数据库。 |![star > 5000][Gold]   
...
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8481 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]   
...
| [goworker](https://github.com/benmanns/goworker)  | 2228 |  基于 go 的后台 worker。 |![star > 1000][Silver]   
...
| [tunny](https://github.com/Jeffail/tunny)  | 1317 |  golang 的协程池。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [app](https://github.com/murlokswarm/app)  | 2934 |  用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。 |![star > 1000][Silver]   
| [fyne](https://github.com/fyne-io/fyne)  | 6117 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [go-astilectron](https://github.com/asticode/go-astilectron)  | 2620 |  使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。 |![star > 1000][Silver]   
| [go-gtk](http://mattn.github.io/go-gtk/)  | - |  实现了 GTK 的 Go接口。 |
| [go-sciter](https://github.com/sciter-sdk/go-sciter)  | 1431 |  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gotk3](https://github.com/gotk3/gotk3)  | 753 |  实现了 GTK3 的 Go接口。 |![star > 100][Bronze]   
| [gowd](https://github.com/dtylman/gowd)  | 207 |  跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。 |![star > 100][Bronze]   
| [qt](https://github.com/therecipe/qt)  | 5910 |  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。 |![star > 5000][Gold]   
| [ui](https://github.com/andlabs/ui)  | 6860 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]   
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3657 |  Windows应用程序库。 |![star > 1000][Silver]   
| [webview](https://github.com/zserge/webview)  | 4564 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [systray](https://github.com/getlantern/systray)  | 767 |  跨平台 Go 库，可在通知区放置图标和菜单。 |![star > 100][Bronze]   
...
| [bimg](https://github.com/h2non/bimg)  | 778 |  使用libvips实现的快速高效的图像处理包。 |![star > 100][Bronze]   
...
| [gg](https://github.com/fogleman/gg)  | 1891 |  纯Go语言实现的2D渲染。 |![star > 1000][Silver]   
...
| [gocv](https://github.com/hybridgroup/gocv)  | 2398 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [imagick](https://github.com/gographics/imagick)  | 956 |   ImageMagick下MagickWand的C API的Go binding。 |![star > 100][Bronze]   
| [imaginary](https://github.com/h2non/imaginary)  | 2564 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]   
...
| [resize](https://github.com/nfnt/resize)  | 2114 |  Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
| [svgo](https://github.com/ajstarks/svgo)  | 1320 |   Go实现的SVG生成库。 |![star > 1000][Silver]   
...
| [mainflux](https://github.com/Mainflux/mainflux)  | 571 |  工业物联网消息和设备管理服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4788 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [glog](https://github.com/golang/glog)  | 2283 |  为Go提供了多等级日志记录。 |![star > 1000][Silver]   
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11673 |  Go的结构化日志操作 。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [lumberjack](https://github.com/natefinch/lumberjack)  | 1412 |  简单的滚动日志，io.WriteCloser的实现。 |![star > 1000][Silver]   
...
| [spew](https://github.com/davecgh/go-spew)  | 3250 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]   
| [stdlog](https://github.com/alexcesaro/log)  | 43 |  Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。 |![最近一年没有更新][Yellow]
| [tail](https://github.com/hpcloud/tail)  | 1511 |  努力模拟实现BSD的tail的特性的Go包。 |![star > 1000][Silver]   
...
| [zap](https://github.com/uber-go/zap)  | 7282 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]   
| [zerolog](https://github.com/rs/zerolog)  | 2117 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   
...
| [GoLearn](https://github.com/sjwhitworth/golearn)  | 6623 |  通用机器学习库。 |![star > 5000][Gold]   
...
| [gorgonia](https://github.com/chewxy/gorgonia)  | 2661 |  基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。 |![star > 1000][Silver]   
| [gorse](https://github.com/zhenghaoz/gorse)  | 517 |  基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [goscore](https://github.com/asafschers/goscore)  | 34 |   为预言模型标记语言（PMML）实现的评分API。 |
| [gosseract](https://github.com/otiai10/gosseract)  | 854 |  使用c++的Tesseract库实现的OCR。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [tfgo](https://github.com/galeone/tfgo)  | 1171 |  易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [APNs2](https://github.com/sideshow/apns2)  | 2030 |  HTTP / 2苹果消息推送provider——发送推送消息到iOS, tvOS, Safari和OSX应用。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Beaver](https://github.com/Clivern/Beaver)  | 713 |  一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。 |![star > 100][Bronze]   
| [Benthos](https://github.com/Jeffail/benthos)  | 1925 |  一系列协议之间的消息流桥接。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Bus](https://github.com/mustafaturan/bus)  | 112 |  内部通信的最小消息总线实现。 |![star > 100][Bronze]   
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3635 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   
...
| [EventBus](https://github.com/asaskevich/EventBus)  | 547 |  具有异步兼容性的轻量级事件总线。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-nsq](https://github.com/nsqio/go-nsq)  | 1443 |  NSQ的官方Go包。 |![star > 1000][Silver]   
| [go-socket.io](https://github.com/googollee/go-socket.io)  | 2848 |  go的socket.io库，一个实时应用程序框架。 |![star > 1000][Silver]   
...
| [gorush](https://github.com/appleboy/gorush)  | 3664 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3328 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mangos](https://github.com/go-mangos/mangos)  | 1531 |  Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。 |![star > 1000][Silver]   
| [melody](https://github.com/olahol/melody)  | 1530 |  处理websocket session的极简框架，包括广播和自动ping/pong处理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Mercure](https://github.com/dunglas/mercure)  | 1452 |  使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [messagebus](https://github.com/vardius/message-bus)  | 63 |  messagebus是一个Go的简单异步消息总线，非常适合在执行事件sourcing、CQRS和DDD时用作事件总线。 |
| [NATS Go Client](https://github.com/nats-io/nats)  | 2353 |  轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sarama](https://github.com/Shopify/sarama)  | 4535 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Uniqush-Push](https://github.com/uniqush/uniqush-push)  | 1094 |  Redis支持的统一推送服务, 用于服务端向移动设备的消息通知。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1650 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4355 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3318 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]   
...
| [dig](https://github.com/uber-go/dig)  | 882 |  一个基于反射的Go依赖注入工具包。 |![star > 100][Bronze]   
| [fx](https://github.com/uber-go/fx)  | 649 |  基于依赖注入的Go应用程序框架(构建在dig之上)。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gocontainer](https://github.com/vardius/gocontainer)  | 8 |  简单的依赖注入容器。 |
| [inject](https://github.com/defval/inject)  | 18 |  一个基于反射的依赖注入容器，具有简单的接口。 |
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8689 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]   
...
| [archiver](https://github.com/mholt/archiver)  | 2466 |  用于生成和提取.zip和.tar.gz存档的库和命令。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [base64Captcha](https://github.com/mojocn/base64Captcha)  | 614 |  Base64captch支持数字，数字，字母，算术，音频和数字-字母验证码。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-commons-pool](https://github.com/jolestar/go-commons-pool)  | 660 |  Golang的通用对象池。 |![star > 100][Bronze]   
| [go-openapi](https://github.com/go-openapi)  | - |  用于解析和利用开放api模式的包的集合。 |
| [go-resiliency](https://github.com/eapache/go-resiliency)  | 837 |   Go 的弹性模式。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-unarr](https://github.com/gen2brain/go-unarr)  | 66 |  用于RAR、TAR、ZIP和7z存档的解压缩库。 |
| [gofakeit](https://github.com/brianvoe/gofakeit)  | 406 |  用go编写的随机数据生成器。 |![star > 100][Bronze]   
| [gommit](https://github.com/antham/gommit)  | 65 |  分析git提交消息，确保它们遵循已定义的模式。 |
| [gopsutil](https://github.com/shirou/gopsutil)  | 3855 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-pinyin](https://github.com/mozillazg/go-pinyin)  | 516 |  中文汉字到汉语拼音的转换。 |![star > 100][Bronze]   
...
| [gojieba](https://github.com/yanyiwu/gojieba)  | 804 |  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。 |![star > 100][Bronze]   
...
| [prose](https://github.com/jdkato/prose)  | 2032 |  用于支持标记化、词性标记、名称实体提取等文本处理的库。 |![star > 1000][Silver]   
...
| [cidranger](https://github.com/yl2chen/cidranger)  | 383 |  快速IP到CIDR查找 Go 。 |![star > 100][Bronze]   
| [dhcp6](https://github.com/mdlayher/dhcp6)  | 62 |  包dhcp6实现了一个DHCPv6服务器，如RFC 3315所述。 |
| [dns](https://github.com/miekg/dns)  | 3753 |  使用DNS的库。 |![star > 1000][Silver]   
...
| [fasthttp](https://github.com/valyala/fasthttp)  | 9127 |  软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [fortio](https://github.com/fortio/fortio)  | 849 |  负载测试库和命令行工具，先进的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。Tcp、Http、gRPC。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ftp](https://github.com/jlaffaye/ftp)  | 511 |  包ftp实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户机。 |![star > 100][Bronze]   
...
| [go-getter](https://github.com/hashicorp/go-getter)  | 714 |   Go 图书馆下载文件或目录从各种来源使用一个URL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-stun](https://github.com/ccding/go-stun)  | 329 |  Go实现了STUN客户机(RFC 3489和RFC 5389)。 |![star > 100][Bronze]   
| [gobgp](https://github.com/osrg/gobgp)  | 1655 |  用 Go 编程语言实现的BGP。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [golibwireshark](https://github.com/sunwxg/golibwireshark)  | 14 |  golibwireshark包使用libwireshark库解码pcap文件并分析解剖数据。 |![最近一年没有更新][Yellow]
| [gopacket](https://github.com/google/gopacket)  | 2814 |  使用libpcap绑定访问包处理库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [kcp-go](https://github.com/xtaci/kcp-go)  | 2222 |  快速可靠的ARQ协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [kcptun](https://github.com/xtaci/kcptun)  | 10599 |  非常简单和快速udp隧道基于KCP协议。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2847 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [webrtc](https://github.com/pions/webrtc)  | 2137 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [grequests](https://github.com/levigross/grequests)  | 1396 |  一个 Go “克隆”的伟大和著名的请求库。 |![star > 1000][Silver]   
...
| [sling](https://github.com/dghubble/sling)  | 951 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gl](https://github.com/go-gl/gl)  | 634 |  OpenGL的Go绑定(通过glow生成)。 |![star > 100][Bronze]   
| [glfw](https://github.com/go-gl/glfw)  | 723 |  Go绑定用于glfw3。 |![star > 100][Bronze]   
...
| [pop/soda](https://github.com/gobuffalo/pop)  | 665 |  数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2225 |  ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [upper.io/db](https://github.com/upper/db)  | 1838 |  通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Xorm](https://github.com/go-xorm/xorm)  | 5080 |  简单而强大的ORM for Go。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12484 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]   
...
| [glide](https://github.com/Masterminds/glide)  | 7754 |  轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gopm](https://github.com/gpmgo/gopm)  | 2344 |  包管理器。 |![star > 1000][Silver]   
| [govendor](https://github.com/kardianos/govendor)  | 4696 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]   
...
| [graphql](https://github.com/neelance/graphql-go)  | 2732 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   
| [graphql-go](https://github.com/graphql-go/graphql)  | 5112 |  为Go实现GraphQL。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go.rice](https://github.com/GeertJohan/go.rice)  | 1624 |  go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。 |![star > 1000][Silver]   
| [packr](https://github.com/gobuffalo/packr)  | 2048 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   
| [statics](https://github.com/go-playground/statics)  | 53 |  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。 |![最近一年没有更新][Yellow]
| [statik](https://github.com/rakyll/statik)  | 2057 |  将静态文件嵌入到Go可执行文件中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gonum](https://github.com/gonum/gonum)  | 2883 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gonum/plot](https://github.com/gonum/plot)  | 1197 |  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。 |![star > 1000][Silver]   
...
| [stats](https://github.com/montanaflynn/stats)  | 1332 |  包含Golang标准库中缺少的公共函数的统计软件包。 |![star > 1000][Silver]   
...
| [acra](https://github.com/cossacklabs/acra)  | 442 |  网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。 |![star > 100][Bronze]   
...
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1800 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]   
...
| [lego](https://github.com/xenolf/lego)  | 3439 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [memguard](https://github.com/awnumar/memguard)  | 995 |  一个用于处理内存中敏感值的纯Go库。 |![star > 100][Bronze]   
...
| [go-codec](https://github.com/ugorji/go)  | 1220 |  高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2876 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 4971 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5377 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mapstructure](https://github.com/mitchellh/mapstructure)  | 2360 |  用于对原生键值对进行解码生成 Go 语言结构体 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algernon](https://github.com/xyproto/algernon)  | 1576 |  内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。 |![star > 1000][Silver]   
...
| [jackal](https://github.com/ortuman/jackal)  | 708 |  用Go编写的XMPP服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [minio](https://github.com/minio/minio)  | 17003 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3185 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gofpdf](https://github.com/jung-kurt/gofpdf)  | 3036 |  PDF 文档生成器，支持文本，绘图和图片 |![star > 1000][Silver]   
| [goview](https://github.com/foolin/goview)  | 39 |  Goview是一个轻量级、极简的模板库，基于golang html/template构建Go web应用程序。 |
| [hero](https://github.com/shiyanhui/hero)  | 1195 |  Hero是一个方便、快速和强大的go模板引擎。 |![star > 1000][Silver]   
...
| [quicktemplate](https://github.com/valyala/quicktemplate)  | 1379 |  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译 |![star > 1000][Silver]   
...
| [go-mutesting](https://github.com/zimmski/go-mutesting)  | 278 |  变异测试的Go源代码。 |![star > 100][Bronze]   
| [go-testdeep](https://github.com/maxatome/go-testdeep)  | 55 |  极具灵活性的golang深度比较，扩展了go测试包。 |
| [go-vcr](https://github.com/dnaeon/go-vcr)  | 325 |  记录并回放HTTP交互，以便进行快速、确定和准确的测试。 |![star > 100][Bronze]   
...
| [httpexpect](https://github.com/gavv/httpexpect)  | 1117 |  简洁的、声明式的、易用的端到端HTTP 及 REST API 测试 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Testify](https://github.com/stretchr/testify)  | 7936 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1678 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]   
| [go-txdb](https://github.com/DATA-DOG/go-txdb)  | 157 |  基于单事务的数据库驱动，主要用于测试目的 |![star > 100][Bronze]   
| [gock](https://github.com/h2non/gock)  | 795 |  多功能、易用 HTTP mock |![star > 100][Bronze]   
| [gomock](https://github.com/golang/mock)  | 2713 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [govcr](https://github.com/seborama/govcr)  | 81 |  HTTP mock : 离线测试时记录和重放浏览器的动作 |![最近一个周有更新][Green]
| [hoverfly](https://github.com/SpectoLabs/hoverfly)  | 1424 |  使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [httpmock](https://github.com/jarcoal/httpmock)  | 569 |  轻松模拟来自外部资源的HTTP响应。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-fuzz](https://github.com/dvyukov/go-fuzz)  | 2853 |  随机测试系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gofuzz](https://github.com/google/gofuzz)  | 525 |  用于生成随机值来初始化 Go 语言对象的库 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [failpoint](https://github.com/pingcap/failpoint)  | 374 |  为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。 |![star > 100][Bronze]   
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3841 |  Markdown 解析器 |![star > 1000][Silver]   
| [bluemonday](https://github.com/microcosm-cc/bluemonday)  | 1220 |  HTML 清理工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [codetree](https://github.com/aerogo/codetree)  | 7 |  解析缩进代码(python、pixy、scarlet等)并返回树结构。 |
| [colly](https://github.com/asciimoo/colly)  | 8165 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   
...
| [go-humanize](https://github.com/dustin/go-humanize)  | 1866 |  格式化程序，用于将时间、数字和内存大小转换为可读格式。 |![star > 1000][Silver]   
| [go-nmea](https://github.com/adrianmo/go-nmea)  | 93 |  用于Go语言的NMEA解析器库。 |
...
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7471 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]   
| [goregen](https://github.com/zach-klippenstein/goregen)  | 35 |  根据正则表达式生成随机字符串 |![最近一年没有更新][Yellow]
| [gotext](https://github.com/leonelquinteros/gotext)  | 229 |  GNU gettext 工具 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [sh](https://github.com/mvdan/sh)  | 1937 |  Shell解析器和格式化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 4969 |  AWS 提供的官方go语言 SDK |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [github](https://github.com/google/go-github)  | 4715 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [githubql](https://github.com/shurcooL/githubql)  | 490 |  访问GitHub GraphQL API v4的库。 |![star > 100][Bronze]   
...
| [google](https://github.com/google/google-api-go-client)  | 1904 |  为Go自动生成谷歌api。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [slack](https://github.com/nlopes/slack)  | 2377 |  Slack API。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [stripe](https://github.com/stripe/stripe-go)  | 929 |   Stripe API 的 Go 语言客户端 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [webhooks](https://github.com/go-playground/webhooks)  | 339 |  GitHub 和 Bitbucket 的Webhook接收器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [ctop](https://github.com/bcicen/ctop)  | 8721 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [delve](https://github.com/derekparker/delve)  | 11819 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [filetype](https://github.com/h2non/filetype)  | 930 |  通过数字签名来推测文件类型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [fzf](https://github.com/junegunn/fzf)  | 22702 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [git-time-metric](https://github.com/git-time-metric/gtm)  | 710 |  git-time-metric - 。 |![star > 100][Bronze]   
...
| [go-funk](https://github.com/thoas/go-funk)  | 1129 |  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...) |![star > 1000][Silver]   
...
| [go-torch](https://github.com/uber/go-torch)  | 3624 |  为 Go 语言程序生成火焰图。 |![star > 1000][Silver]   
...
| [goreleaser](https://github.com/goreleaser/goreleaser)  | 4441 |  尽可能快速的发布 Go 语言二进制文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goreporter](https://github.com/wgliang/goreporter)  | 2465 |  进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具 |![star > 1000][Silver]   
...
| [hub](https://github.com/github/hub)  | 16777 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   
...
| [mc](https://github.com/minio/mc)  | 1085 |  Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [minify](https://github.com/tdewolff/minify)  | 1848 |  用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [mole](https://github.com/davrodpin/mole)  | 1297 |  cli应用程序可以轻松创建ssh隧道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [peco](https://github.com/peco/peco)  | 5416 |  简单的交互过滤工具。 |![star > 5000][Gold]   
...
| [profile](https://github.com/pkg/profile)  | 989 |  Go的简单分析支持包。 |![star > 100][Bronze]   
...
| [resty](https://github.com/go-resty/resty)  | 1842 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [retry](https://github.com/kamilsk/retry)  | 142 |  基于上下文的功能机制，反复执行命令直到成功。 |![star > 100][Bronze]   
...
| [spinner](https://github.com/briandowns/spinner)  | 772 |   一个 Go 语言软件包，提供多种选项，方便在终端中创建加载动画。 |![star > 100][Bronze]   
| [sqlx](https://github.com/jmoiron/sqlx)  | 6671 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   
| [sslice](https://github.com/yaa110/sslice)  | 4 |  创建一个总是排序的切片。 |![最近一个周有更新][Green]
| [Storm](https://github.com/asdine/storm)  | 1337 |  一个简单又强大的用于 BoltDB 的工具 |![star > 1000][Silver]   
| [structs](https://github.com/PumpkinSeed/structs)  | 12 |  简单来讲就是 "Make" 的替代品。 |![最近一年没有更新][Yellow]
| [Task](https://github.com/go-task/task)  | 1872 |  简单的“Go”的选择。 |![star > 1000][Silver]   
...
| [wuzz](https://github.com/asciimoo/wuzz)  | 8240 |  用于HTTP检查的交互式cli工具。 |![star > 5000][Gold]   
...
| [uuid](https://github.com/gofrs/uuid)  | 560 |  通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [govalidator](https://github.com/asaskevich/govalidator)  | 3512 |  用于字符串，数字，切片和结构的验证器和sanitizers。 |![star > 1000][Silver]   
...
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation)  | 1020 |  支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [validate](https://github.com/gookit/validate)  | 88 |   Go 封装数据验证和过滤。支持验证映射、结构、请求(表单、JSON、url)。值，上载文件)数据和更多特性。 |
| [validate](https://github.com/gobuffalo/validate)  | 19 |  这个包提供了一个框架，用于为Go应用程序编写验证。 |
| [validator](https://github.com/go-playground/validator)  | 3395 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gmf](https://github.com/3d0c/gmf)  | 518 |   FFmpeg av\* 库的 Go 语言接口。 |![star > 100][Bronze]   
...
| [Air](https://github.com/aofei/air)  | 516 |  一个理想的精细化的Go web框架。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Banjo](https://github.com/nsheremet/banjo)  | 7 |  非常简单和快速的网络框架 Go 。 |![最近一年没有更新][Yellow]
| [Beego](https://github.com/astaxie/beego)  | 21187 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14480 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Gin](https://github.com/gin-gonic/gin)  | 29218 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2822 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-json-rest](https://github.com/ant0ine/go-json-rest)  | 3319 |  设置RESTful JSON API的快速简便方法。 |![star > 1000][Silver]   
| [go-rest](https://github.com/ungerik/go-rest)  | 115 |  小型的 REST 框架。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [Goa](https://github.com/goadesign/goa)  | 3474 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Revel](https://github.com/revel/revel)  | 11206 |  用于Go语言的高效web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [tango](https://github.com/lunny/tango)  | 815 |  微型的、支持插件的 web 框架。 |![star > 100][Bronze]   
...
| [Limiter](https://github.com/ulule/limiter)  | 775 |  简单的速度限制中间件。 |![star > 100][Bronze]   
...
| [negroni](https://github.com/urfave/negroni)  | 6300 |  符合语言习惯的 HTTP 中间件库。 |![star > 5000][Gold]   
| [render](https://github.com/unrolled/render)  | 1263 |  Go package用于方便地呈现JSON、XML和HTML模板响应。 |![star > 1000][Silver]   
...
| [chi](https://github.com/go-chi/chi)  | 5929 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9568 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]   
...
| [mux](https://github.com/gorilla/mux)  | 9507 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]   
...
| [go-ole](https://github.com/go-ole/go-ole)  | 545 |  为 Go 语言实现的 Win32 OLE。 |![star > 100][Bronze]   
...
| [xquery](https://github.com/antchfx/xquery)  | 144 |  XQuery允许您使用XPath表达式从HTML/XML文档中提取数据。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [go-critic](https://github.com/go-critic/go-critic)  | 562 |  源代码检查工具。 |![star > 100][Bronze]   
...
| [GoLint](https://github.com/golang/lint)  | 3123 |  Go 源码的 linter。 |![star > 1000][Silver]   
...
| [GoSublime](https://github.com/DisposaBoy/GoSublime)  | 3224 |  包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。 |![star > 1000][Silver]   
...
| [vim-go](https://github.com/fatih/vim-go)  | 10722 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5062 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-callvis](https://github.com/TrueFurby/go-callvis)  | 1954 |  使用 dot format 可视化 Go 程序的调用图。 |![star > 1000][Silver]   
| [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete)  | 37 |  Bash completion for go and wgo。 |![最近一年没有更新][Yellow]
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3889 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [godbg](https://github.com/tylerwince/godbg)  | 157 |  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。 |![star > 100][Bronze]   
| [OctoLinker](https://github.com/OctoLinker/browser-extension)  | 3713 |  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [richgo](https://github.com/kyoh86/richgo)  | 381 |  用文本装饰丰富 go test 的输出。 |![star > 100][Bronze]   
...
| [aurora](https://github.com/xuri/aurora)  | 395 |  基于web的跨平台 Beanstalkd 队列服务器控制台。 |![star > 100][Bronze]   
...
| [bombardier](https://github.com/codesenberg/bombardier)  | 1697 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]   
...
| [gaia](https://github.com/gaia-pipeline/gaia)  | 3718 |  可用于任何编程语言来构建强大的管道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Gitea](https://github.com/go-gitea/gitea)  | 14832 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [GVM](https://github.com/moovweb/gvm)  | 4438 |  GVM 提供了一个接口来管理 Go 版本。 |![star > 1000][Silver]   
| [Hey](https://github.com/rakyll/hey)  | 6151 |  压力测试工具，可用来代替 ApacheBench (ab)。 |![star > 5000][Gold]   
...
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55343 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Moby](https://github.com/moby/moby)  | 54137 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Packer](https://github.com/mitchellh/packer)  | 9123 |  用于从一个源配置为多个平台创建相同的机器图像。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Pewpew](https://github.com/bengadbois/pewpew)  | 199 |  灵活的 HTTP 命令行压测工具。 |![star > 100][Bronze]   
| [Pomerium](https://github.com/pomerium/pomerium)  | 469 |  Pomerium是一个可识别身份的访问代理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [script](https://github.com/bitfield/script)  | 878 |  让DevOps编写类shell和系统管理任务变得更加容易。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [traefik](https://github.com/containous/traefik)  | 23377 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 11973 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   
| [webhook](https://github.com/adnanh/webhook)  | 4019 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]   
...
| [Comcast](https://github.com/tylertreat/Comcast)  | 6156 |  模拟坏的网络连接。 |![star > 5000][Gold]   
| [confd](https://github.com/kelseyhightower/confd)  | 6354 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]   
| [DDNS](https://github.com/skibish/ddns)  | 97 |  个人 DDNS 客户端。 |
| [Docker](http://www.docker.com/)  | - |  面向开发人员和系统管理员的分布式应用程序的开放平台。 |
| [Documize](https://github.com/documize/community)  | 803 |  集成了SaaS工具数据的现代wiki软件。 |![star > 100][Bronze]   
| [drive](https://github.com/odeke-em/drive)  | 4932 |  基于命令行的谷歌驱动器客户端。 |![star > 1000][Silver]   
...
| [Gor](https://github.com/buger/gor)  | 11253 |  Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。 |![star > 5000][Gold]   
...
| [lgo](https://github.com/yunabe/lgo)  | 1775 |  与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。 |![star > 1000][Silver]   
| [limetext](http://limetext.org/)  | - |  一个强大而优雅的文本编辑器。 |
| [LiteIDE](https://github.com/visualfc/liteide)  | 5434 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Pipe](https://github.com/b3log/pipe)  | 2707 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [restic](https://github.com/restic/restic)  | 7294 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [rkt](https://github.com/coreos/rkt)  | 8722 |  一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [scc](https://github.com/boyter/scc)  | 762 |  一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。 |![star > 100][Bronze]   
| [Seaweed File System](https://github.com/chrislusf/seaweedfs)  | 8099 |  快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks)  | 852 |  Go序列化方法的基准测试。 |![star > 100][Bronze]   
...
| [GoBooks](https://github.com/dariubs/GoBooks)  | 6725 |  一份精选的 Go 书籍清单。 |![star > 5000][Gold]   
...
| [gophers](https://github.com/ashleymcnamara/gophers)  | 1827 |  阿什莉·麦克纳马拉的歌斐艺术品。 |![star > 1000][Silver]   
| [gophers](https://github.com/egonelbre/gophers)  | 1560 |  Free gophers. |![star > 1000][Silver]   
...
| [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job)  | 14448 |  Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness)  | 24543 |  其他 awesome 系列的列表。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang)  | 31158 |  Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。 |![star > 5000][Gold]   
...
| [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet)  | 3998 |   Go's reference card。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers)  | 675 |  引入示例讲述 Golang 与Node.js在学习上的差异。 |![star > 100][Bronze]   
...
| [Learn Go with TDD](https://github.com/quii/learn-go-with-tests)  | 4242 |  学习使用测试驱动开发。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [package main](https://www.youtube.com/packagemain)  | - |  关于 Go 编程的YouTube频道。 |
* [The world’s easiest introduction to WebAssembly with Golang](https://medium.com/@martinolsansky/webassembly-with-golang-is-fun-b243c0e34f02)
        
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [Working with Go](https://github.com/mkaz/working-with-go)  | 1129 |  由一个经验丰富的Go程序员群体编写的一系列Go学习范例。 |![star > 1000][Silver]   
