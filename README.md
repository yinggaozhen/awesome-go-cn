...
* [go-geoindex](https://github.com/hailocab/go-geoindex) - **Star : 309** **最近提交 : 2018-02-21**  基于内存的地理索引。
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) - **Star : 1759** **最近提交 : 2019-06-08**  提供类似 .NET LINQ 的查询方法。
* [goderive](https://github.com/awalterschulze/goderive) - **Star : 717** **最近提交 : 2019-02-24**  从输入类型来派生函数。
* [gotype](https://github.com/wzshiming/gotype) - **Star : 19** **最近提交 : 2019-06-20**  Golang 源码解析，用法类似reflect(反射)。
* [GoWrap](https://github.com/hexdigest/gowrap) - **Star : 258** **最近提交 : 2019-04-23**  使用简单模板为 Go 接口生成装饰器。
* [interfaces](https://github.com/rjeczalik/interfaces) - **Star : 184** **最近提交 : 2019-05-02**  用于生成接口定义的命令行工具。
* [jennifer](https://github.com/dave/jennifer) - **Star : 1248** **最近提交 : 2019-05-04**  不使用模板生成任意 Go 代码。
...
* [geocache](https://github.com/melihmucuk/geocache) - **Star : 106** **最近提交 : 2016-06-22**  基于内存缓存的的地理位置的应用程序。
...
* [S2 geometry](https://github.com/golang/geo) - **Star : 870** **最近提交 : 2019-05-08**  S2 geometry 库。
* [Tile38](https://github.com/tidwall/tile38) - **Star : 6260** **最近提交 : 2019-06-29**  具有空间索引和实时地理定位功能的地理定位数据库。

## Go 编译器

*可将 Go 转换为其他语言的编译工具。*

* [c4go](https://github.com/Konstantin8105/c4go) - **Star : 142** **最近提交 : 2019-06-24**  将 C 代码转换为 Go 代码。
* [f4go](https://github.com/Konstantin8105/f4go) - **Star : 11** **最近提交 : 2018-12-21**  将 FORTRAN 77 转换为 Go代码。
* [gopherjs](https://github.com/gopherjs/gopherjs) - **Star : 8420** **最近提交 : 2019-05-01**  将 Go 编译成 JavaScript。
* [llgo](https://github.com/go-llvm/llgo) - **Star : 986** **最近提交 : 2015-01-05**  基于 llvm 的编译器。
* [tardisgo](https://github.com/tardisgo/tardisgo) - **Star : 391** **最近提交 : 2016-11-20**  Golang 转换为 Haxe，再转换为 CPP/CSharp/Java/JavaScript 的编译器.
...
* [GoSlaves](https://github.com/themester/GoSlaves) - **Star : 74** **最近提交 : 2019-05-31**  简单异步的协程池。
* [goworker](https://github.com/benmanns/goworker) - **Star : 2220** **最近提交 : 2019-02-06**  基于 go 的后台 worker。
* [gpool](https://github.com/Sherifabdlnaby/gpool) - **Star : 58** **最近提交 : 2019-05-09**  manages a resizeable pool of context-aware goroutines to bound concurrency
* [grpool](https://github.com/ivpusic/grpool) - **Star : 487** **最近提交 : 2019-01-28**  轻量级协程池。
* [Hunch](https://github.com/AaronJan/Hunch) - **Star : 8** **最近提交 : 2019-06-27**  Hunch 提供了诸如 All、First、Retry、Waterfall 等功能，这使得异步流控制更加直观。
...
* [pool](https://github.com/go-playground/pool) - **Star : 471** **最近提交 : 2016-08-24**  有限消费者协程或无限协程池，可用于更加简单的处理和取消协程
* [queue](https://github.com/AnikHasibul/queue) - **Star : 1** **最近提交 : 2019-05-18**  提供类似队列组可访问性 sync.WaitGroup 的功能。帮助你节流和限制协程、等待所有协程结束以及更多功能。
* [routine](https://github.com/x-mod/routine) - **Star : 1** **最近提交 : 2019-05-31**  go routine control with context, support: Main, Go, Pool and some useful Executors.
* [semaphore](https://github.com/kamilsk/semaphore) - **Star : 74** **最近提交 : 2019-05-30**  信号量模式实现，可根据通道和上下文进行具备超时功能的锁定/解锁操作。
* [semaphore](https://github.com/marusama/semaphore) - **Star : 69** **最近提交 : 2019-01-10**  基于 CAS 的可快速调整的信号量实现(比基于通道的信号量实现更快)。
* [stl](https://github.com/ssgreg/stl) - **Star : 7** **最近提交 : 2019-04-09**  基于软件事务内存(STM)并发控制机制的软件事务锁。
* [threadpool](https://github.com/shettyh/threadpool) - **Star : 17** **最近提交 : 2019-03-11**  Golang 的 threadpool 实现。
* [tunny](https://github.com/Jeffail/tunny) - **Star : 1293** **最近提交 : 2018-11-09**  golang 的协程池。
* [worker-pool](https://github.com/vardius/worker-pool) - **Star : 43** **最近提交 : 2019-06-07**  一个简单的 Go 异步工作池。
* [workerpool](https://github.com/gammazero/workerpool) - **Star : 118** **最近提交 : 2019-06-09**  限制任务执行并发数，而不是队列中的任务数量的协程池，。
...
* [app](https://github.com/murlokswarm/app) - **Star : 2912** **最近提交 : 2019-06-16**  用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。
* [fyne](https://github.com/fyne-io/fyne) - **Star : 6004** **最近提交 : 2019-07-01**  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。
* [go-astilectron](https://github.com/asticode/go-astilectron) - **Star : 2591** **最近提交 : 2019-06-26**  使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。
* [go-gtk](http://mattn.github.io/go-gtk/) - 实现了 GTK 的 Go接口。
* [go-sciter](https://github.com/sciter-sdk/go-sciter) - **Star : 1415** **最近提交 : 2019-05-23**  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。
* [gotk3](https://github.com/gotk3/gotk3) - **Star : 728** **最近提交 : 2019-06-20**  实现了 GTK3 的 Go接口。
* [gowd](https://github.com/dtylman/gowd) - **Star : 201** **最近提交 : 2019-06-19**  跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。
* [qt](https://github.com/therecipe/qt) - **Star : 5797** **最近提交 : 2019-06-28**  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。
* [ui](https://github.com/andlabs/ui) - **Star : 6821** **最近提交 : 2019-03-28**  跨平台的 Platform-native GUI 库。
* [Wails](https://wails.app) - Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。
* [walk](https://github.com/lxn/walk) - **Star : 3626** **最近提交 : 2019-06-22**  Windows应用程序库。
* [webview](https://github.com/zserge/webview) - **Star : 4508** **最近提交 : 2019-06-28**  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。

*交互*

* [go-appindicator](https://github.com/dawidd6/go-appindicator) - **Star : 1** **最近提交 : 2019-05-21**  实现了 libappindicator3 C库 的 Go接口。
* [gosx-notifier](https://github.com/deckarep/gosx-notifier) - **Star : 492** **最近提交 : 2019-05-02**  OSX 桌面通知库。
* [mac-activity-tracker](https://github.com/prashantgupta24/activity-tracker) - **Star : 1** **最近提交 : 2019-06-17**  用于通知计算机上的任何(可插入的)活动的 OSX 库。
* [mac-sleep-notifier](https://github.com/prashantgupta24/mac-sleep-notifier) - OSX 睡眠/唤醒通知。
* [robotgo](https://github.com/go-vgo/robotgo) - **Star : 4344** **最近提交 : 2019-06-30**  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。
* [systray](https://github.com/getlantern/systray) - **Star : 751** **最近提交 : 2019-06-26**  跨平台 Go 库，可在通知区放置图标和菜单。
* [trayhost](https://github.com/shurcooL/trayhost) - **Star : 158** **最近提交 : 2018-10-21**  跨平台 Go 库，可用于在主机操作系统的任务栏中放置图标。
...
* [gg](https://github.com/fogleman/gg) - **Star : 1867** **最近提交 : 2019-06-12**  纯Go语言实现的2D渲染。
* [gift](https://github.com/disintegration/gift) - **Star : 1203** **最近提交 : 2019-03-23**  图像处理包。
...
* [go-nude](https://github.com/koyachi/go-nude) - **Star : 279** **最近提交 : 2018-11-22**  Go语言实现的裸照检测工具。
...
* [gocv](https://github.com/hybridgroup/gocv) - **Star : 2353** **最近提交 : 2019-06-18**  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。
...
* [imaginary](https://github.com/h2non/imaginary) - **Star : 2541** **最近提交 : 2019-06-29**  用于图像大小调整的快速、简单的HTTP微服务。
* [imaging](https://github.com/disintegration/imaging) - **Star : 2459** **最近提交 : 2019-06-11**  简单的Go图像处理包。
* [img](https://github.com/hawx/img) - **Star : 128** **最近提交 : 2015-05-01**  图像处理工具的集合。
* [ln](https://github.com/fogleman/ln) - **Star : 2439** **最近提交 : 2018-02-24**  Go实现的3D线艺术（3D Line Art）渲染。
...
* [stegify](https://github.com/DimitarPetrov/stegify) - **Star : 480** **最近提交 : 2019-05-15**   Go实现的LSB隐写（LSB steganography），能够隐藏任何文件到一个图像中。
...
* [glog](https://github.com/golang/glog) - **Star : 2260** **最近提交 : 2019-06-01**  为Go提供了水平的执行日志。
...
* [logger](https://github.com/azer/logger) - **Star : 135** **最近提交 : 2019-06-30**  Go的最小化日志库。
...
* [logrus](https://github.com/Sirupsen/logrus) - **Star : 11424** **最近提交 : 2019-06-28**  结构化的日志 Go 。
...
* [lumberjack](https://github.com/natefinch/lumberjack) - **Star : 1379** **最近提交 : 2019-07-01**  简单的滚动日志程序，实现io.WriteCloser。
...
* [seelog](https://github.com/cihub/seelog) - **Star : 1335** **最近提交 : 2019-03-04**  具有灵活调度、过滤和格式化的日志功能。
* [spew](https://github.com/davecgh/go-spew) - **Star : 3231** **最近提交 : 2019-04-21**  为Go数据结构实现一个漂亮的深层打印机，以帮助调试。
* [stdlog](https://github.com/alexcesaro/log) - **Star : 43** **最近提交 : 2015-09-16**  Stdlog是一个面向对象的库，提供水平日志记录。它对cron作业非常有用。
* [tail](https://github.com/hpcloud/tail) - **Star : 1494** **最近提交 : 2019-06-12**  Go软件包努力模拟BSD tail程序的特性。
...
* [zap](https://github.com/uber-go/zap) - **Star : 7171** **最近提交 : 2019-06-26**  快速、结构化、水平登录Go。
* [zerolog](https://github.com/rs/zerolog) - **Star : 2092** **最近提交 : 2019-06-28**  零JSON记录器。

## 机器学习

*机器学习库。*

* [bayesian](https://github.com/jbrukh/bayesian) - **Star : 625** **最近提交 : 2019-03-20**  Golang的朴素贝叶斯分类。
* [CloudForest](https://github.com/ryanbressler/CloudForest) - **Star : 642** **最近提交 : 2018-11-20**  快速、灵活、多线程的决策树集成，用于纯Go中的机器学习。
* [eaopt](https://github.com/MaxHalford/eaopt) - **Star : 615** **最近提交 : 2019-03-25**  一个进化优化库。
* [evoli](https://github.com/khezen/evoli) - **Star : 8** **最近提交 : 2019-05-26**  遗传算法和粒子群优化库。
* [fonet](https://github.com/Fontinalis/fonet) - **Star : 31** **最近提交 : 2018-04-10**  一个用Go编写的深度神经网络库。
* [go-cluster](https://github.com/e-XpertSolutions/go-cluster) - **Star : 21** **最近提交 : 2018-08-06**  Go实现了k模式和k原型聚类算法。
* [go-deep](https://github.com/patrikeh/go-deep) - **Star : 213** **最近提交 : 2018-09-14**  一个功能丰富的神经网络库在 Go 。
* [go-fann](https://github.com/white-pony/go-fann) - **Star : 99** **最近提交 : 2015-02-04**  快速人工神经网络(FANN)库的Go绑定。
* [go-galib](https://github.com/thoj/go-galib) - **Star : 170** **最近提交 : 2015-12-29**  用Go / golang编写的遗传算法库。
* [go-pr](https://github.com/daviddengcn/go-pr) - **Star : 57** **最近提交 : 2013-06-08**  模式识别包在Go lang。
* [gobrain](https://github.com/goml/gobrain) - **Star : 365** **最近提交 : 2019-06-30**  用 Go 编写的神经网络。
* [godist](https://github.com/e-dard/godist) - **Star : 24** **最近提交 : 2015-05-11**  各种概率分布，以及相关的方法。
* [goga](https://github.com/tomcraven/goga) - **Star : 79** **最近提交 : 2017-01-16**  Go的遗传算法库。
* [GoLearn](https://github.com/sjwhitworth/golearn) - **Star : 6593** **最近提交 : 2019-06-20**  通用机器学习库。
* [golinear](https://github.com/danieldk/golinear) - **Star : 39** **最近提交 : 2018-08-29**   Go 的线性绑定。
* [GoMind](https://github.com/surenderthakran/gomind) - **Star : 6** **最近提交 : 2018-07-31**  一个简单的神经网络库在 Go 。
* [goml](https://github.com/cdipaolo/goml) - **Star : 1001** **最近提交 : 2019-04-13**  在线机器学习在 Go 。
* [goRecommend](https://github.com/timkaye11/goRecommend) - **Star : 141** **最近提交 : 2014-07-29**  推荐算法库用Go编写。
* [gorgonia](https://github.com/chewxy/gorgonia) - **Star : 2643** **最近提交 : 2019-06-29**  基于图形的计算库，如Theano for Go，它为构建各种机器学习和神经网络算法提供了基本框架。
* [gorse](https://github.com/zhenghaoz/gorse) - **Star : 508** **最近提交 : 2019-06-14**  基于协同过滤的Go高性能推荐系统包。
* [goscore](https://github.com/asafschers/goscore) - **Star : 34** **最近提交 : 2019-05-04**   Go 为PMML评分API。
* [gosseract](https://github.com/otiai10/gosseract) - **Star : 841** **最近提交 : 2019-05-30**  使用Tesseract c++库为OCR(光学字符识别)打包。
* [libsvm](https://github.com/datastream/libsvm) - **Star : 63** **最近提交 : 2016-05-09**  基于libsvm的golang版本派生工作。
* [mlgo](https://github.com/NullHypothesis/mlgo) - **Star : 5** **最近提交 : 2015-12-08**  这个项目的目的是在 Go 中提供最小化的机器学习算法。
* [neat](https://github.com/jinyeom/neat) - **Star : 55** **最近提交 : 2018-07-05**  即插即用的并行Go框架，用于增强拓扑的神经进化(整洁)。
* [neural-go](https://github.com/schuyler/neural-go) - **Star : 61** **最近提交 : 2014-04-02**  多层感知器网络在Go中实现，通过反向传播进行训练。
* [ocrserver](https://github.com/otiai10/ocrserver) - **Star : 216** **最近提交 : 2019-03-21**  一个简单的OCR API服务器，非常容易被Docker和Heroku部署。
* [onnx-go](https://github.com/owulveryck/onnx-go) - **Star : 137** **最近提交 : 2019-07-01**  Go接口打开神经网络交换(ONNX)。
* [probab](https://github.com/ThePaw/probab) - **Star : 10** **最近提交 : 2015-09-14**  概率分布函数。贝叶斯推理。用纯 Go 写的。
* [regommend](https://github.com/muesli/regommend) - **Star : 243** **最近提交 : 2019-04-24**  推荐&协同过滤引擎。
* [shield](https://github.com/eaigner/shield) - **Star : 124** **最近提交 : 2016-03-16**  贝叶斯文本分类器，具有灵活的令牌器和存储后端。
* [tfgo](https://github.com/galeone/tfgo) - **Star : 1156** **最近提交 : 2019-05-27**  易于使用的Tensorflow绑定:简化了官方Tensorflow Go绑定的使用。在Go中定义计算图形，加载和执行Python中训练的模型。
* [Varis](https://github.com/Xamber/Varis) - **Star : 24** **最近提交 : 2018-08-02**  Golang神经网络。
...
* [Benthos](https://github.com/Jeffail/benthos) - **Star : 1899** **最近提交 : 2019-07-01**  一系列协议之间的消息流桥。
...
* [emitter](https://github.com/olebedev/emitter) - **Star : 307** **最近提交 : 2019-01-10**  使用通配符、谓词、取消可能性和许多其他优点，使用Go way发出事件。
* [event](https://github.com/agoalofalife/event) - **Star : 27** **最近提交 : 2018-02-19**  模式观察者的实现。
...
* [go-nsq](https://github.com/nsqio/go-nsq) - **Star : 1435** **最近提交 : 2019-03-29**  NSQ的官方Go包。
...
* [Gollum](https://github.com/trivago/gollum) - **Star : 761** **最近提交 : 2019-06-07**  n:m多路复用器，它收集来自不同来源的消息并将其广播到一组目的地。
* [golongpoll](https://github.com/jcuga/golongpoll) - **Star : 418** **最近提交 : 2019-02-18**  HTTP longpoll服务器库，使web发布-订阅变得简单。
...
* [gorush](https://github.com/appleboy/gorush) - **Star : 3623** **最近提交 : 2019-06-27**  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。
...
* [machinery](https://github.com/RichardKnop/machinery) - **Star : 3298** **最近提交 : 2019-06-27**  基于分布式消息传递的异步任务队列/作业队列。
* [mangos](https://github.com/go-mangos/mangos) - **Star : 1531** **最近提交 : 2019-06-28**  具有传输互操作性的Nanomsg(“可伸缩协议”)的纯go实现。
* [melody](https://github.com/olahol/melody) - **Star : 1509** **最近提交 : 2019-07-01**  处理websocket会话的极简框架，包括广播和自动乒乓球处理。
...
* [NATS Go Client](https://github.com/nats-io/nats) - **Star : 2336** **最近提交 : 2019-06-08**  轻量级和高性能的发布-订阅和分布式队列消息传递系统——这是Go库。
...
* [sarama](https://github.com/Shopify/sarama) - **Star : 4446** **最近提交 : 2019-06-30**   Go Apache Kafka的库。
* [Uniqush-Push](https://github.com/uniqush/uniqush-push) - **Star : 1092** **最近提交 : 2019-06-14**  Redis支持面向移动设备的服务器端通知的统一推送服务。
* [zmq4](https://github.com/pebbe/zmq4) - **Star : 770** **最近提交 : 2019-06-26**  转接口到ZeroMQ版本4。也可用于[版本3](https://github.com/pebbe/zmq3)和[版本2](https://github.com/pebbe/zmq2)。
...
* [xlsx](https://github.com/tealeg/xlsx) - **Star : 3268** **最近提交 : 2019-06-05**  库，以简化在Go程序中读取Microsoft Excel最新版本使用的XML格式。
...
* [dig](https://github.com/uber-go/dig) - **Star : 859** **最近提交 : 2019-06-17**  一个基于反射的Go依赖注入工具包。
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - **Star : 8394** **最近提交 : 2019-06-10**  Go生态系统中常见的历史和新兴的项目布局模式。
...
* [archiver](https://github.com/mholt/archiver) - **Star : 2396** **最近提交 : 2019-06-28**  用于生成和提取.zip和.tar.gz存档的库和命令。
...
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) - **Star : 649** **最近提交 : 2019-05-26**  Golang的通用对象池。
...
* [gofakeit](https://github.com/brianvoe/gofakeit) - **Star : 403** **最近提交 : 2019-06-25**  用go编写的随机数据生成器。
* [gommit](https://github.com/antham/gommit) - **Star : 65** **最近提交 : 2019-06-19**  分析git提交消息，确保它们遵循已定义的模式。
* [gopsutil](https://github.com/shirou/gopsutil) - **Star : 3791** **最近提交 : 2019-06-30**  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。
...
* [llvm](https://github.com/llir/llvm) - **Star : 403** **最近提交 : 2019-07-01**  用于在纯Go中与LLVM IR交互的库。
...
* [go-pinyin](https://github.com/mozillazg/go-pinyin) - **Star : 512** **最近提交 : 2019-04-06**  中文汉字到汉语拼音的转换。
...
* [gojieba](https://github.com/yanyiwu/gojieba) - **Star : 788** **最近提交 : 2018-10-05**  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。
...
* [nlp](https://github.com/james-bowman/nlp) - **Star : 212** **最近提交 : 2019-04-08**  支持LSA(潜在语义分析)的Go自然语言处理库。
...
* [prose](https://github.com/jdkato/prose) - **Star : 2018** **最近提交 : 2019-02-04**  用于支持标记化、词性标记、名称实体提取等文本处理的库。
...
* [cidranger](https://github.com/yl2chen/cidranger) - **Star : 376** **最近提交 : 2019-01-19**  快速IP到CIDR查找 Go 。
* [dhcp6](https://github.com/mdlayher/dhcp6) - **Star : 60** **最近提交 : 2019-03-12**  包dhcp6实现了一个DHCPv6服务器，如RFC 3315所述。
* [dns](https://github.com/miekg/dns) - **Star : 3712** **最近提交 : 2019-06-28**  使用DNS的库。
...
* [fasthttp](https://github.com/valyala/fasthttp) - **Star : 9015** **最近提交 : 2019-06-30**  软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。
* [fortio](https://github.com/fortio/fortio) - **Star : 828** **最近提交 : 2019-06-18**  负载测试库和命令行工具，先进的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。Tcp、Http、gRPC。
* [ftp](https://github.com/jlaffaye/ftp) - **Star : 500** **最近提交 : 2019-06-24**  包ftp实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户机。
...
* [go-getter](https://github.com/hashicorp/go-getter) - **Star : 686** **最近提交 : 2019-06-30**   Go 图书馆下载文件或目录从各种来源使用一个URL。
* [go-stun](https://github.com/ccding/go-stun) - **Star : 321** **最近提交 : 2018-07-26**  Go实现了STUN客户机(RFC 3489和RFC 5389)。
* [gobgp](https://github.com/osrg/gobgp) - **Star : 1647** **最近提交 : 2019-07-01**  用 Go 编程语言实现的BGP。
...
* [gopacket](https://github.com/google/gopacket) - **Star : 2776** **最近提交 : 2019-06-30**  使用libpcap绑定访问包处理库。
...
* [gotcp](https://github.com/gansidui/gotcp) - **Star : 406** **最近提交 : 2017-04-18**   Go 包快速编写tcp应用程序。
* [grab](https://github.com/cavaliercoder/grab) - **Star : 539** **最近提交 : 2019-04-28**   Go 软件包管理文件下载。
* [graval](https://github.com/koofr/graval) - **Star : 25** **最近提交 : 2018-06-06**  实验FTP服务器框架。
* [HTTPLab](https://github.com/gchaincl/httplab) - **Star : 3369** **最近提交 : 2019-06-05**  HTTPLabs允许您检查HTTP请求并伪造响应。
...
* [kcptun](https://github.com/xtaci/kcptun) - **Star : 10515** **最近提交 : 2019-07-01**  非常简单和快速udp隧道基于KCP协议。
...
* [NFF-Go](https://github.com/intel-go/nff-go) - **Star : 643** **最近提交 : 2019-07-01**  快速开发云计算和裸机网络功能的框架(原YANFF)。
...
* [publicip](https://github.com/polera/publicip) - **Star : 18** **最近提交 : 2016-12-29**  包publicip返回面向公共的IPv4地址(internet出口)。
* [quic-go](https://github.com/lucas-clemente/quic-go) - **Star : 2796** **最近提交 : 2019-07-01**  在纯Go中实现了QUIC协议。
* [raw](https://github.com/mdlayher/raw) - **Star : 298** **最近提交 : 2019-06-25**  Package raw支持在设备驱动程序级别读取和写入网络接口的数据。
* [sftp](https://github.com/pkg/sftp) - **Star : 711** **最近提交 : 2019-06-14**  包sftp实现了SSH文件传输协议，如https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt所述。
* [ssh](https://github.com/gliderlabs/ssh) - **Star : 1087** **最近提交 : 2019-06-20**  用于构建SSH服务器的高级API(封装密码/ SSH)。
...
* [webrtc](https://github.com/pions/webrtc) - **Star : 2032** **最近提交 : 2019-07-01**  WebRTC API的纯Go实现。
* [winrm](https://github.com/masterzen/winrm) - **Star : 207** **最近提交 : 2019-03-08**   Go WinRM客户端远程执行Windows机器上的命令。
...
* [glfw](https://github.com/go-gl/glfw) - **Star : 709** **最近提交 : 2019-04-12**  Go绑定用于glfw3。
...
* [go-pg](https://github.com/go-pg/pg) - **Star : 2871** **最近提交 : 2019-06-30**  关注PostgreSQL的特性和性能。
...
* [GORM](https://github.com/jinzhu/gorm) - **Star : 14113** **最近提交 : 2019-07-01**  Golang出色的ORM库的目标是对开发人员友好。
* [gorp](https://github.com/go-gorp/gorp) - **Star : 3059** **最近提交 : 2019-06-17**  Go的关系持久性，ORM-ish库。
...
* [reform](https://github.com/go-reform/reform) - **Star : 786** **最近提交 : 2019-07-01**  更好的ORM for Go，基于非空接口和代码生成。
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) - **Star : 2200** **最近提交 : 2019-06-30**  ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。
* [upper.io/db](https://github.com/upper/db) - **Star : 1814** **最近提交 : 2019-01-27**  通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。
* [Xorm](https://github.com/go-xorm/xorm) - **Star : 4998** **最近提交 : 2019-06-27**  简单而强大的ORM for Go。
...
* [dep](https://github.com/golang/dep) - **Star : 12382** **最近提交 : 2019-06-24**   Go 的依赖管理工具，需要 Go 1.9+
...
* [glide](https://github.com/Masterminds/glide) - **Star : 7737** **最近提交 : 2019-06-19**  轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。
...
* [govendor](https://github.com/kardianos/govendor) - **Star : 4659** **最近提交 : 2019-06-14**  包管理器。使用 vendor 文件的 Go vendor 工具。
...
* [gojsonq](https://github.com/thedevsaddam/gojsonq) - **Star : 832** **最近提交 : 2019-05-28**  一个用来查询JSON数据的Go包。
* [graphql](https://github.com/tmc/graphql) - **Star : 51** **最近提交 : 2017-06-02**  graphql解析器+工具集
* [graphql](https://github.com/neelance/graphql-go) - **Star : 2694** **最近提交 : 2019-06-25**  关注易用性的GraphQL服务器。
* [graphql-go](https://github.com/graphql-go/graphql) - **Star : 5043** **最近提交 : 2019-06-20**  为Go实现GraphQL。
...
* [rql](https://github.com/a8m/rql) - **Star : 109** **最近提交 : 2019-05-23**  用于REST API的资源查询语言。

## 嵌入的资源

* [esc](https://github.com/mjibson/esc) - **Star : 456** **最近提交 : 2019-04-02**  将文件嵌入到Go程序中并提供http文件系统接口。
* [fileb0x](https://github.com/UnnoTed/fileb0x) - **Star : 416** **最近提交 : 2019-01-08**  一个可定制的工具用来在Go中嵌入文件
* [go-embed](https://github.com/pyros2097/go-embed) - **Star : 14** **最近提交 : 2016-06-02**  生成go代码，将资源文件嵌入到库或可执行文件中。
* [go-resources](https://github.com/omeid/go-resources) - **Star : 155** **最近提交 : 2019-03-24**  嵌入到Go中的普通资源。
* [go.rice](https://github.com/GeertJohan/go.rice) - **Star : 1617** **最近提交 : 2019-05-01**  go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。
* [packr](https://github.com/gobuffalo/packr) - **Star : 2009** **最近提交 : 2019-06-28**  将静态文件嵌入到Go二进制文件中的简单方法。
* [statics](https://github.com/go-playground/statics) - **Star : 53** **最近提交 : 2016-10-05**  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。
* [statik](https://github.com/rakyll/statik) - **Star : 2020** **最近提交 : 2019-03-24**  将静态文件嵌入到Go可执行文件中。
* [templify](https://github.com/wlbr/templify) - **Star : 19** **最近提交 : 2019-05-26**  将外部模板文件嵌入到Go代码中，以创建单个文件二进制文件。
* [vfsgen](https://github.com/shurcooL/vfsgen) - **Star : 632** **最近提交 : 2019-02-14**  生成一个vfsdata。静态实现给定虚拟文件系统的go文件。
...
* [chart](https://github.com/vdobler/chart) - **Star : 573** **最近提交 : 2019-02-18**  简单的图表绘制库。支持多种图形类型。
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) - **Star : 59** **最近提交 : 2019-07-01**  用于机器学习和统计的数据模型(类似于 pandas)。
...
* [gonum](https://github.com/gonum/gonum) - **Star : 2843** **最近提交 : 2019-06-29**  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。
* [gonum/plot](https://github.com/gonum/plot) - **Star : 1180** **最近提交 : 2019-06-15**  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。
...
* [orb](https://github.com/paulmach/orb) - **Star : 184** **最近提交 : 2019-06-26**  2D几何类型，支持剪切、GeoJSON和Mapbox矢量平铺。
...
* [sparse](https://github.com/james-bowman/sparse) - **Star : 65** **最近提交 : 2019-04-23**   Go 稀疏矩阵格式的线性代数支持科学和机器学习应用程序，兼容gonum矩阵库。
* [stats](https://github.com/montanaflynn/stats) - **Star : 1330** **最近提交 : 2019-05-03**  包含Golang标准库中缺少的公共函数的统计软件包。
...
* [acmetool](https://github.com/hlandau/acme) - **Star : 1690** **最近提交 : 2018-08-10**  ACME(让我们用自动更新加密)客户端工具。
* [acra](https://github.com/cossacklabs/acra) - **Star : 441** **最近提交 : 2019-06-25**  网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。
...
* [Cameradar](https://github.com/Ullaakut/cameradar) - **Star : 1772** **最近提交 : 2019-06-29**  工具和库，以远程入侵RTSP流从监控摄像头。
...
* [secure](https://github.com/unrolled/secure) - **Star : 1184** **最近提交 : 2019-06-25**  Go 语言 HTTP 中间件，为 Go 提供了一些安全功能
* [simple-scrypt](https://github.com/elithrar/simple-scrypt) - **Star : 154** **最近提交 : 2019-07-01**  Scrypt 库，具有简单、易懂的 API，同时具有内置的自动校准功能
...
* [colfer](https://github.com/pascaldekloe/colfer) - **Star : 469** **最近提交 : 2019-06-13**  为Colfer二进制格式生成代码。
...
* [gogoprotobuf](https://github.com/gogo/protobuf) - **Star : 2828** **最近提交 : 2019-06-21**  Go 语言的 Protocol Buffer 库。
* [goprotobuf](https://github.com/golang/protobuf) - **Star : 4847** **最近提交 : 2019-06-29**  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.
* [jsoniter](https://github.com/json-iterator/go) - **Star : 5255** **最近提交 : 2019-06-22**  高性能，100% 兼容的“encoding/json” 替代品
* [mapstructure](https://github.com/mitchellh/mapstructure) - **Star : 2315** **最近提交 : 2019-03-26**  用于对原生键值对进行解码生成 Go 语言结构体
...
* [algernon](https://github.com/xyproto/algernon) - **Star : 1572** **最近提交 : 2019-06-03**  内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。
* [Caddy](https://github.com/mholt/caddy) - **Star : 22470** **最近提交 : 2019-06-29**  Caddy是另一种HTTP/2 web服务器，易于配置和使用。
...
* [discovery](https://github.com/Bilibili/discovery) - **Star : 624** **最近提交 : 2019-06-25**  用于弹性中间层负载平衡和故障转移的注册表。
* [etcd](https://github.com/coreos/etcd) - **Star : 25734** **最近提交 : 2019-06-29**  为共享配置和服务发现提供高可用的键值存储。
...
* [flipt](https://github.com/markphelps/flipt) - **Star : 974** **最近提交 : 2019-07-01**  一个用Go和Vue.js编写的自包含特性标志解决方案
* [jackal](https://github.com/ortuman/jackal) - **Star : 704** **最近提交 : 2019-06-17**  用Go编写的XMPP服务器。
* [minio](https://github.com/minio/minio) - **Star : 16807** **最近提交 : 2019-07-01**  Minio是一个分布式对象存储服务器。
...
* [RoadRunner](https://github.com/spiral/roadrunner) - **Star : 3128** **最近提交 : 2019-06-30**  高性能PHP应用服务器，负载平衡器和进程管理器。
...
* [fasttemplate](https://github.com/valyala/fasttemplate) - **Star : 287** **最近提交 : 2019-03-29**  简单快速的模板引擎。进行模板元素替换时，速度是比[text/template](http://golang.org/pkg/text/template/)快10倍。
* [gofpdf](https://github.com/jung-kurt/gofpdf) - **Star : 2996** **最近提交 : 2019-06-24**  PDF 文档生成器，支持文本，绘图和图片
* [goview](https://github.com/foolin/goview) - **Star : 38** **最近提交 : 2019-06-08**  Goview是一个轻量级、极简的模板库，基于golang html/template构建Go web应用程序。
* [hero](https://github.com/shiyanhui/hero) - **Star : 1192** **最近提交 : 2019-06-07**  Hero是一个方便、快速和强大的go模板引擎。
...
* [mustache](https://github.com/hoisie/mustache) - **Star : 964** **最近提交 : 2018-05-26**  Go 语言实现的 Mustache 模板语言
* [pongo2](https://github.com/flosch/pongo2) - **Star : 1478** **最近提交 : 2019-06-19**  类似 DjanGo 的模板引擎
* [quicktemplate](https://github.com/valyala/quicktemplate) - **Star : 1357** **最近提交 : 2019-04-24**  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译
...
* Testing Frameworks
    ...
    * [go-cmp](https://github.com/google/go-cmp) - **Star : 1084** **最近提交 : 2019-06-07**  用于比较测试中的Go值的包。
    ...
    * [godog](https://github.com/DATA-DOG/godog) - **Star : 716** **最近提交 : 2019-05-29**  类似 Cucumber 或 Behat 的 BDD 框架
    ...
    * [gotest.tools](https://github.com/gotestyourself/gotest.tools) - **Star : 112** **最近提交 : 2019-06-27**  一组包，用于增强go测试包并支持公共模式。
    * [Hamcrest](https://github.com/rdrdr/hamcrest) - **Star : 26** **最近提交 : 2011-02-15**  用于声明性 Matcher 对象的连贯框架，当将其应用于输入值时，将产生自描述结果。
    * [httpexpect](https://github.com/gavv/httpexpect) - **Star : 1103** **最近提交 : 2019-06-19**  简洁的、声明式的、易用的端到端HTTP 及 REST API 测试
    ...
    * [testfixtures](https://github.com/go-testfixtures/testfixtures) - **Star : 314** **最近提交 : 2019-05-02**  类似 Rails 的测试工具，用于测试数据库应用
    * [Testify](https://github.com/stretchr/testify) - **Star : 7771** **最近提交 : 2019-06-13**  对标准测试包的扩展。
...
* Mock
    ...
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - **Star : 1623** **最近提交 : 2019-06-21**  Mock SQL ，用于测试数据库交互
    * [go-txdb](https://github.com/DATA-DOG/go-txdb) - **Star : 154** **最近提交 : 2019-06-01**  基于单事务的数据库驱动，主要用于测试目的
    * [gock](https://github.com/h2non/gock) - **Star : 786** **最近提交 : 2019-06-18**  多功能、易用 HTTP mock
    * [gomock](https://github.com/golang/mock) - **Star : 2668** **最近提交 : 2019-06-21**  用于Go编程语言的mock框架。
    ...
    * [httpmock](https://github.com/jarcoal/httpmock) - **Star : 555** **最近提交 : 2019-05-03**  轻松模拟来自外部资源的HTTP响应。
...
* Selenium and browser control tools.
    * [cdp](https://github.com/mafredri/cdp) - **Star : 343** **最近提交 : 2019-06-16**  用于Chrome调试协议的类型安全绑定，可与实现该协议的浏览器或其他调试目标一起使用。
    * [chromedp](https://github.com/knq/chromedp) - **Star : 3384** **最近提交 : 2019-07-01**  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品
    * [ggr](https://github.com/aerokube/ggr) - **Star : 208** **最近提交 : 2019-06-24**  一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs
...
* Specific Formats
    ...
    * [blackfriday](https://github.com/russross/blackfriday) - **Star : 3795** **最近提交 : 2019-06-29**  Markdown 解析器
    ...
    * [colly](https://github.com/asciimoo/colly) - **Star : 8050** **最近提交 : 2019-06-22**  快速和优雅的 Scraping 框架。
    ...
    * [gographviz](https://github.com/awalterschulze/gographviz) - **Star : 284** **最近提交 : 2019-06-21**  解析Graphviz DOT语言。
    ...
    * [GoQuery](https://github.com/PuerkitoBio/goquery) - **Star : 7412** **最近提交 : 2019-04-23**  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能
    ...
    * [htmlquery](https://github.com/antchfx/htmlquery) - **Star : 115** **最近提交 : 2019-02-08**  用于HTML的XPath查询包，允许您通过XPath表达式从HTML文档中提取数据或求值。
    * [inject](https://github.com/facebookgo/inject) - **Star : 1129** **最近提交 : 2019-01-14**  包注入提供了一个基于反射的注入器。
    ...
    * [sh](https://github.com/mvdan/sh) - **Star : 1915** **最近提交 : 2019-07-01**  Shell解析器和格式化工具。
    * [slug](https://github.com/gosimple/slug) - **Star : 365** **最近提交 : 2019-06-12**  URL 友好的 slug 化工具，支持多种语言
    ...
    * [toml](https://github.com/BurntSushi/toml) - **Star : 2707** **最近提交 : 2019-03-27**  TOML配置格式(带反射的编码器/解码器)。
* Utility
    ...
    * [xurls](https://github.com/mvdan/xurls) - **Star : 454** **最近提交 : 2019-05-13**  从文本中提取url。
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - **Star : 4917** **最近提交 : 2019-06-29**  AWS 提供的官方go语言 SDK
...
* [discordgo](https://github.com/bwmarrin/discordgo) - **Star : 930** **最近提交 : 2019-07-01**   Discord Chat API的客户端。
...
* [github](https://github.com/google/go-github) - **Star : 4676** **最近提交 : 2019-07-01**  访问GitHub REST API v3的库。
* [githubql](https://github.com/shurcooL/githubql) - **Star : 479** **最近提交 : 2019-06-25**  访问GitHub GraphQL API v4的库。
...
* [go-sophos](https://github.com/esurdam/go-sophos) - **Star : 5** **最近提交 : 2018-09-10**  为[Sophos UTM REST API](https://www.sophos.com/en-us/medialibrary/pdfs/documentation/utmonaws/sophos-ut-restful-api.pdf?
...
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - **Star : 1722** **最近提交 : 2019-06-29**  谷歌云api Go 客户端库。
...
* [Medium](https://github.com/Medium/medium-sdk-go) - **Star : 116** **最近提交 : 2018-10-27**  Medium的OAuth2 API 客户端。
...
* [paypal](https://github.com/logpacker/PayPal-Go-SDK) - **Star : 296** **最近提交 : 2019-06-29**  PayPal支付API的包装器。
...
* [slack](https://github.com/nlopes/slack) - **Star : 2338** **最近提交 : 2019-06-26**  Slack API。
...
* [chyle](https://github.com/antham/chyle) - **Star : 107** **最近提交 : 2019-07-01**  使用具有多种配置可能性的git存储库生成变更日志。
...
* [ctop](https://github.com/bcicen/ctop) - **Star : 8626** **最近提交 : 2019-06-30**  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。
...
* [Death](https://github.com/vrecan/death) - **Star : 132** **最近提交 : 2018-10-23**  利用信号管理应用程序的关闭。
* [Deepcopier](https://github.com/ulule/deepcopier) - **Star : 201** **最近提交 : 2017-11-07**  结构体拷贝
* [delve](https://github.com/derekparker/delve) - **Star : 11684** **最近提交 : 2019-07-01**  Go 语言调试器
...
* [fzf](https://github.com/junegunn/fzf) - **Star : 22371** **最近提交 : 2019-06-25**  用Go编写的命令行模糊查找器。
...
* [git-time-metric](https://github.com/git-time-metric/gtm) - **Star : 709** **最近提交 : 2019-06-30**  git-time-metric - 。
...
* [go-funk](https://github.com/thoas/go-funk) - **Star : 997** **最近提交 : 2019-05-03**  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)
...
* [go-torch](https://github.com/uber/go-torch) - **Star : 3624** **最近提交 : 2018-11-07**  为 Go 语言程序生成火焰图。
* [go-trigger](https://github.com/sadlil/go-trigger) - **Star : 181** **最近提交 : 2017-03-29**  Go 语言全局事件触发器，通过 id 和触发器，在程序的任何地方注册事件。
...
* [godropbox](https://github.com/dropbox/godropbox) - **Star : 3730** **最近提交 : 2019-05-01**  用于编写 Go 语言服务／应用的库，来自 Dropbox.。
...
* [goreleaser](https://github.com/goreleaser/goreleaser) - **Star : 4331** **最近提交 : 2019-06-30**  尽可能快速的发布 Go 语言二进制文件。
* [goreporter](https://github.com/wgliang/goreporter) - **Star : 2457** **最近提交 : 2018-10-28**  进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具
...
* [hub](https://github.com/github/hub) - **Star : 16548** **最近提交 : 2019-06-29**  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。
* [hystrix-go](https://github.com/afex/hystrix-go) - **Star : 1943** **最近提交 : 2019-06-13**  实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。
...
* [koazee](https://github.com/wesovilabs/koazee) - **Star : 276** **最近提交 : 2019-03-05**  库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。
* [lrserver](https://github.com/jaschaephraim/lrserver) - **Star : 99** **最近提交 : 2017-11-30**  LiveReload 服务器。
* [mc](https://github.com/minio/mc) - **Star : 1064** **最近提交 : 2019-06-29**  Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。
* [mergo](https://github.com/imdario/mergo) - **Star : 821** **最近提交 : 2019-06-15**  用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。
...
* [mole](https://github.com/davrodpin/mole) - **Star : 1290** **最近提交 : 2019-07-01**  cli应用程序可以轻松创建ssh隧道。
...
* [panicparse](https://github.com/maruel/panicparse) - **Star : 2073** **最近提交 : 2019-07-01**  将类似的协程分组并对调用栈进行着色
* [peco](https://github.com/peco/peco) - **Star : 5404** **最近提交 : 2019-06-12**  简单的交互过滤工具。
...
* [profile](https://github.com/pkg/profile) - **Star : 977** **最近提交 : 2019-03-24**  Go的简单分析支持包。
* [rclient](https://github.com/zpatrick/rclient) - **Star : 26** **最近提交 : 2018-08-29**  可读、灵活、易于使用的REST api客户端。
* [realize](https://github.com/tockins/realize) - **Star : 3082** **最近提交 : 2019-05-05**  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。
...
* [resty](https://github.com/go-resty/resty) - **Star : 1811** **最近提交 : 2019-06-19**  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。
...
* [slicer](https://github.com/leaanthony/slicer) - **Star : 3** **最近提交 : 2019-07-01**  使处理切片更容易。
* [spinner](https://github.com/briandowns/spinner) - **Star : 763** **最近提交 : 2019-06-11**   一个 Go 语言软件包，提供多种选项，方便在终端中创建加载动画。
* [sqlx](https://github.com/jmoiron/sqlx) - **Star : 6558** **最近提交 : 2019-06-20**  为内建的数据库/sql 软件包提供一组扩展。
...
* [wuzz](https://github.com/asciimoo/wuzz) - **Star : 8190** **最近提交 : 2018-12-07**  用于HTTP检查的交互式cli工具。
...
* [ulid](https://github.com/oklog/ulid) - **Star : 1652** **最近提交 : 2019-06-03**  实现了ULID(普遍唯一的词典分类标识符)。
...
* [wuid](https://github.com/edwingeng/wuid) - **Star : 266** **最近提交 : 2019-06-01**  一个非常快的唯一数字生成器，比UUID快10-135倍。
...
* [govalidator](https://github.com/asaskevich/govalidator) - **Star : 3472** **最近提交 : 2019-05-10**  用于字符串，数字，切片和结构的验证器和sanitizers。
* [govalidator](https://github.com/thedevsaddam/govalidator) - **Star : 687** **最近提交 : 2019-06-21**  用简单的规则验证Golang请求数据。深受Laravel请求验证的启发。
* [jio](https://github.com/faceair/jio) - **Star : 21** **最近提交 : 2019-05-29**  jio是一个json模式验证器，类似于[joi](https://github.com/hapijs/joi)。
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - **Star : 1006** **最近提交 : 2019-05-24**  支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。
* [validate](https://github.com/gookit/validate) - **Star : 83** **最近提交 : 2019-06-03**   Go 封装数据验证和过滤。支持验证映射、结构、请求(表单、JSON、url)。值，上载文件)数据和更多特性。
* [validate](https://github.com/gobuffalo/validate) - **Star : 19** **最近提交 : 2019-04-03**  这个包提供了一个框架，用于为Go应用程序编写验证。
* [validator](https://github.com/go-playground/validator) - **Star : 3282** **最近提交 : 2019-06-14**   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。
...
* [go-git](https://github.com/src-d/go-git) - **Star : 4098** **最近提交 : 2019-07-01**  纯Go中高度可扩展的Git实现。
...
* [gmf](https://github.com/3d0c/gmf) - **Star : 508** **最近提交 : 2019-05-31**   FFmpeg av\* 库的 Go 语言接口。
...
* [goav](https://github.com/giorgisio/goav) - **Star : 748** **最近提交 : 2019-05-28**  FFmpeg的Comphrensive。
...
* [Beego](https://github.com/astaxie/beego) - **Star : 21008** **最近提交 : 2019-06-28**  beego是一种用于 Go 编程语言的开源高性能web框架。
...
* [Macaron](https://github.com/go-macaron/macaron) - **Star : 2782** **最近提交 : 2019-04-24**  Macaron 是一个高效的模块化设计的web框架
...
* [utron](https://github.com/gernest/utron) - **Star : 2139** **最近提交 : 2018-10-29**  Go(Golang)的轻量级MVC框架。
* [vox](https://github.com/aisk/vox) - **Star : 27** **最近提交 : 2019-06-30**  一个面向人类的golang web框架，深受Koa的启发。
...
* [alice](https://github.com/justinas/alice) - **Star : 1805** **最近提交 : 2018-11-11**  用于连接中间件的库，简单无痛苦。
...
* [negroni](https://github.com/urfave/negroni) - **Star : 6276** **最近提交 : 2019-06-02**  符合语言习惯的 HTTP 中间件库。
* [render](https://github.com/unrolled/render) - **Star : 1259** **最近提交 : 2019-03-25**  Go package用于方便地呈现JSON、XML和HTML模板响应。
* [renderer](https://github.com/thedevsaddam/renderer) - **Star : 166** **最近提交 : 2019-03-11**  简单、轻量级和更快的响应(JSON、JSONP、XML、YAML、HTML、文件)。
...
* [chi](https://github.com/go-chi/chi) - **Star : 5849** **最近提交 : 2019-06-06**  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。
...
* [gocraft/web](https://github.com/gocraft/web) - **Star : 1390** **最近提交 : 2019-06-27**  Mux和中间件包在Go中。
...
* [httprouter](https://github.com/julienschmidt/httprouter) - **Star : 9482** **最近提交 : 2019-05-05**  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。
* [httptreemux](https://github.com/dimfeld/httptreemux) - **Star : 386** **最近提交 : 2018-12-19**  高速，灵活，基于树的 HTTP 路由。受到了 httprouter 的启发。
* [lars](https://github.com/go-playground/lars) - **Star : 375** **最近提交 : 2019-05-16**  是一个轻量级、快速、可扩展、零分配的HTTP路由，用于创建定制化的框架。
* [mux](https://github.com/gorilla/mux) - **Star : 9304** **最近提交 : 2019-06-30**  强大的URL路由器和调度器为golang。
* [ozzo-routing](https://github.com/go-ozzo/ozzo-routing) - **Star : 358** **最近提交 : 2018-11-26**  一个非常快的Go (golang) HTTP路由器，支持正则表达式路由匹配。完全支持构建RESTful api。
...
* [xujiajun/gorouter](https://github.com/xujiajun/gorouter) - **Star : 444** **最近提交 : 2019-07-01**  一个简单和快速的HTTP路由器 Go 。
...
* [xpath](https://github.com/antchfx/xpath) - **Star : 149** **最近提交 : 2019-06-18**  Go的XPath包。
* [xquery](https://github.com/antchfx/xquery) - **Star : 145** **最近提交 : 2018-05-15**  XQuery允许您使用XPath表达式从HTML/XML文档中提取数据。
* [zek](https://github.com/miku/zek) - **Star : 242** **最近提交 : 2019-06-11**  从XML生成Go结构。
...
* [apicompat](https://github.com/bradleyfalzon/apicompat) - **Star : 165** **最近提交 : 2017-02-05**  检查 Go 项目最近的向下不兼容修改。
...
* [gcvis](https://github.com/davecheney/gcvis) - **Star : 912** **最近提交 : 2019-03-13**  实时可视化跟踪 GC 数据。
* [go-checkstyle](https://github.com/qiniu/checkstyle) - **Star : 95** **最近提交 : 2019-03-07**  checkstyle是一个类似于java checkstyle的样式检查工具
* [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) - **Star : 277** **最近提交 : 2018-05-14**  go-cleanarch 的创建是为了验证 Clean 体系结构规则，比如 Go 项目中的依赖关系。
* [go-critic](https://github.com/go-critic/go-critic) - **Star : 551** **最近提交 : 2019-05-26**  源代码检查工具。
* [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) - **Star : 176** **最近提交 : 2019-05-06**  找出项目中过期的依赖项。
* [go-outdated](https://github.com/firstrow/go-outdated) - **Star : 45** **最近提交 : 2019-01-15**  显示过期包的终端应用。
* [goast-viewer](https://github.com/yuroyoro/goast-viewer) - **Star : 367** **最近提交 : 2019-05-31**  基于 Web 的 Golang AST 可视化工具。
...
* [GoLint](https://github.com/golang/lint) - **Star : 3096** **最近提交 : 2019-05-24**  Go 源码的 linter。
...
* [gostatus](https://github.com/shurcooL/gostatus) - **Star : 241** **最近提交 : 2019-02-04**  用于显示包含 Go 包的存储库的状态的命令行工具，。
* [lint](https://github.com/surullabs/lint) - **Star : 62** **最近提交 : 2018-10-28**  将 linters 作为测试的一部分。
* [php-parser](https://github.com/z7zmey/php-parser) - **Star : 614** **最近提交 : 2019-06-13**  用 Go 编写的 PHP 解析器。
* [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck) - 用于大量静态分析检查，您可能已经从 c# 的 ReSharper 等工具中习惯了这些检查。
* [tarp](https://github.com/verygoodsoftwarenotvirus/tarp) - **Star : 14** **最近提交 : 2018-07-23**  在源码中寻找没有直接单元测试的函数和方法。
* [unconvert](https://github.com/mdempsky/unconvert) - **Star : 257** **最近提交 : 2019-03-26**  在源码中删除不必要的类型转换。
* [unused](https://github.com/dominikh/go-tools/tree/master/cmd/unused) - 对未使用的常量、变量、函数和类型的代码进行检查。
* [validate](https://github.com/mccoyst/validate) - **Star : 62** **最近提交 : 2016-03-29**  使用 tags 自动验证结构体字段。

## 编辑器插件

* [Go plugin for JetBrains IDEs](https://plugins.jetbrains.com/plugin/9568-go) - JetBrains IDEs 的 Go 插件。
* [go-language-server](https://github.com/theia-ide/go-language-server) - **Star : 28** **最近提交 : 2019-03-25**  A wrapper to turn the VSCode go extension into a language server supporting the language-server-protocol.
* [go-mode](https://github.com/dominikh/go-mode.el) - **Star : 940** **最近提交 : 2019-04-24**  在 GNU/Emacs 支持 GO。
* [go-plus](https://github.com/joefitzgerald/go-plus) - **Star : 1479** **最近提交 : 2019-06-26**  在 Atom 中添加自动完成，格式化，语法检查，高亮和审查。
* [gocode](https://github.com/nsf/gocode) - **Star : 4713** **最近提交 : 2019-03-02**  Autocompletion daemon for the Go programming language.
* [goprofiling](https://marketplace.visualstudio.com/items?itemName=MaxMedia.go-prof) - 在 VS Code 中支持 Go 的基准分析。
* [GoSublime](https://github.com/DisposaBoy/GoSublime) - **Star : 3215** **最近提交 : 2019-06-26**  包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。
* [gounit-vim](https://github.com/hexdigest/gounit-vim) - **Star : 17** **最近提交 : 2018-10-29**  基于函数或方法的签名生成Go测试的Vim插件。
* [theia-go-extension](https://github.com/theia-ide/theia-go-extension) - **Star : 12** **最近提交 : 2019-03-14**  在 Theia IDE中支持 Go。
* [velour](https://github.com/velour/velour) - **Star : 16** **最近提交 : 2018-10-24**  acme编辑器的IRC客户端。
* [vim-compiler-go](https://github.com/rjohnsondev/vim-compiler-go) - **Star : 80** **最近提交 : 2016-06-29**  在保存时突出显示语法错误的 Vim 插件。
* [vim-go](https://github.com/fatih/vim-go) - **Star : 10658** **最近提交 : 2019-06-30**  Go 开发会用到的 Vim 插件。
* [vscode-go](https://github.com/Microsoft/vscode-go) - **Star : 5006** **最近提交 : 2019-07-01**  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。
* [Watch](https://github.com/eaburns/Watch) - **Star : 166** **最近提交 : 2018-03-25**  Runs a command in an acme win on file changes.

## Go 生成工具

* [generic](https://github.com/usk81/generic) - **Star : 28** **最近提交 : 2019-03-28**  灵活的 Go 数据类型。
* [genny](https://github.com/cheekybits/genny) - **Star : 919** **最近提交 : 2019-06-11**  优雅的 Go 泛型。
* [gocontracts](https://github.com/Parquery/gocontracts) - **Star : 52** **最近提交 : 2019-01-26**  通过同步代码和文档来实现 design-by-contract 设计。
* [gonerics](http://github.com/bouk/gonerics) - Go中的易用的泛型。
* [gotests](https://github.com/cweill/gotests) - **Star : 2122** **最近提交 : 2019-07-01**  从源代码生成测试用例。
* [gounit](https://github.com/hexdigest/gounit) - **Star : 28** **最近提交 : 2018-08-17**  使用您自己的模板生成Go测试用例。
* [hasgo](https://github.com/DylanMeeus/hasgo) - **Star : 11** **最近提交 : 2019-06-17**  可生成用于切片的 Haskell。
* [re2dfa](https://github.com/opennota/re2dfa) - **Star : 169** **最近提交 : 2018-09-11**  将正则表达式转换为有限状态机，并输出 Go 源代码。
...
* [depth](https://github.com/KyleBanks/depth) - **Star : 369** **最近提交 : 2019-03-03**  通过分析导入，将包依赖关系树可视化输出。
* [gb](https://getgb.io/) - 一个基于项目的易用的构建工具。
* [generator-go-lang](https://github.com/axelspringer/generator-go-lang) - **Star : 13** **最近提交 : 2019-06-21**  一个[Yeoman](http://yeoman.io)生成器，用于启动新的 Go 项目。
* [gilbert](https://go-gilbert.github.io) - 一个为 Go 项目而生的构建系统和任务运行器。
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **Star : 1917** **最近提交 : 2019-01-15**  使用 dot format 可视化 Go 程序的调用图。
* [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) - **Star : 37** **最近提交 : 2017-11-17**  Bash completion for go and wgo。
* [go-swagger](https://github.com/go-swagger/go-swagger) - **Star : 3809** **最近提交 : 2019-07-01**  基于 Go 的Swagger 2.0实现。
* [godbg](https://github.com/tylerwince/godbg) - **Star : 157** **最近提交 : 2019-04-20**  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。
* [OctoLinker](https://github.com/OctoLinker/browser-extension) - **Star : 3681** **最近提交 : 2019-06-27**  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。
* [richgo](https://github.com/kyoh86/richgo) - **Star : 374** **最近提交 : 2019-04-11**  用文本装饰丰富 go test 的输出。
* [rts](https://github.com/galeone/rts) - **Star : 184** **最近提交 : 2016-12-07**  从服务器响应生成Go结构。
...
* [Packer](https://github.com/mitchellh/packer) - **Star : 9065** **最近提交 : 2019-07-02**  用于从一个源配置为多个平台创建相同的机器图像。
...
* [rkt](https://github.com/coreos/rkt) - **Star : 8698** **最近提交 : 2019-07-02**  一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。
...
* [GoBooks](https://github.com/dariubs/GoBooks) - **Star : 6668** **最近提交 : 2019-05-30**  一份精选的 Go 书籍清单。
...
* [gophers](https://github.com/egonelbre/gophers) - **Star : 1546** **最近提交 : 2019-03-18**  Free gophers.
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - **Star : 14363** **最近提交 : 2019-06-30**  Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - **Star : 24467** **最近提交 : 2019-06-26**  其他 awesome 系列的列表。
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - **Star : 30904** **最近提交 : 2019-06-24**  Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。
...
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - **Star : 3968** **最近提交 : 2019-02-18**   Go's reference card。
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - **Star : 3840** **最近提交 : 2019-06-26**  学习使用测试驱动开发。
