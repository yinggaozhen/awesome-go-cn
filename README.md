...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-08-09 09:58:58(每隔1天同步一次)**
...
* [Oto](https://github.com/hajimehoshi/oto) **star:435** 多平台的 low-level 声音播放库。   ![star > 100][Bronze]
* [PortAudio](https://github.com/gordonklaus/portaudio) **star:302** 基于 Go 的PortAudio audio I/O库。   ![star > 100][Bronze]
* [music-theory](https://github.com/go-music-theory/music-theory) **star:256** 基于 Go 的音乐理论模型。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) **star:5997** JSON Web令牌(JWT)。   ![star > 5000][Gold]
* [casbin](https://github.com/hsluoyz/casbin) **star:4960** 支持ACL、RBAC、ABAC等访问控制模型的授权库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [oauth2](https://github.com/golang/oauth2) **star:2384** goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。   ![star > 1000][Silver]
* [goth](https://github.com/markbates/goth) **star:2270** 提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。   ![star > 1000][Silver]
* [authboss](https://github.com/volatiletech/authboss) **star:1935** web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。   ![star > 1000][Silver]
* [osin](https://github.com/openshift/osin) **star:1545** OAuth2服务器库。   ![star > 1000][Silver]
...
* [gorbac](https://github.com/mikespook/gorbac) **star:911** 轻量级的基于角色的访问控制(RBAC)实现。   ![star > 100][Bronze]
* [loginsrv](https://github.com/tarent/loginsrv) **star:818** JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。   ![star > 100][Bronze]
...
* [jwt](https://github.com/pascaldekloe/jwt) **star:92** 轻量级JSON Web令牌库。
...
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) **star:1628** 简单轻量级的Telegram bot客户端。   ![star > 1000][Silver]
...
* [slacker](https://github.com/shomali11/slacker) **star:310** 可简单创建Slack机器人的框架。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [cobra](https://github.com/spf13/cobra) **star:13336** 现代Go CLI命令行交互工具。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [urfave/cli](https://github.com/urfave/cli) **star:11381** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [pflag](https://github.com/spf13/pflag) **star:750** 基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。   ![star > 100][Bronze]
...
* [complete](https://github.com/posener/complete) **star:618** 使用 Go 语言编写的 bash 命令补全工具以及 Go 命令补全工具.   ![star > 100][Bronze]
* [liner](https://github.com/peterh/liner) **star:587** 类似readline-like的命令行接口库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [sflags](https://github.com/octago/sflags) **star:90** 基于结构的flag生成器，用于flag、urfave/cli、pflag、cobra、kingpin和其他库。
...
* [go-getoptions](https://github.com/DavidGamba/go-getoptions) **star:8**  Go 选择解析器，借鉴于Perl灵活性的GetOpt::Long。   ![最近一周有更新][Green]
...
* [termui](https://github.com/gizak/termui) **star:8932** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。   ![star > 5000][Gold]
* [gommon/color](https://github.com/labstack/gommon/tree/master/color)  更换终端文本样式。
* [gocui](https://github.com/jroimartin/gocui) **star:5384** 旨在创建控制台用户界面的极简Go库。   ![star > 5000][Gold]
* [termbox-go](https://github.com/nsf/termbox-go) **star:3488** 基于文本的跨平台接口库。   ![star > 1000][Silver]
* [color](https://github.com/fatih/color) **star:3018** 多功能包装，彩色终端输出。   ![star > 1000][Silver]   ![归档项目][Archived]
* [go-prompt](https://github.com/c-bata/go-prompt) **star:2337** 构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit)   ![star > 1000][Silver]
* [uiprogress](https://github.com/gosuri/uiprogress) **star:1543** 在终端呈现进度条，可灵活配置的。   ![star > 1000][Silver]
* [asciigraph](https://github.com/guptarohit/asciigraph) **star:1145** 在命令行中构建轻量级ASCII线图╭┈╯，应用程序中没有其他依赖项。   ![star > 1000][Silver]
* [uilive](https://github.com/gosuri/uilive) **star:832** 用于实时更新终端输出的库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [termdash](https://github.com/mum4k/termdash) **star:809** 此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。   ![star > 100][Bronze]
...
* [progressbar](https://github.com/schollz/progressbar) **star:576** 基本线程安全的进度条，在每个操作系统工作。   ![star > 100][Bronze]
...
* [simpletable](https://github.com/alexeyco/simpletable) **star:166** 可在终端显示简易表格。   ![star > 100][Bronze]
...
* [viper](https://github.com/spf13/viper) **star:9336** 配置管理。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) **star:2409** 管理来自环境变量的配置数据。   ![star > 1000][Silver]
* [godotenv](https://github.com/joho/godotenv) **star:2128** Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。   ![star > 1000][Silver]
* [ini](https://github.com/go-ini/ini) **star:1596**  读和写INI文件。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [env](https://github.com/caarlos0/env) **star:871** 解析环境变量并赋值到struct中(默认值)。   ![star > 100][Bronze]
...
* [drone](https://github.com/drone/drone) **star:19048** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [gods](https://github.com/emirpasic/gods) **star:6402** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。   ![star > 5000][Gold]
* [go-datastructures](https://github.com/Workiva/go-datastructures) **star:5129** 可靠的、高性能的和线程安全的数据结构的集合。   ![star > 5000][Gold]
...
* [gota](https://github.com/kniren/gota) **star:880** 实现了数据帧，序列以及数据噪音。   ![star > 100][Bronze]
* [willf/bloom](https://github.com/willf/bloom) **star:668** 实现Bloom过滤器。   ![star > 100][Bronze]
* [roaring](https://github.com/RoaringBitmap/roaring) **star:663** 实现了压缩 bitsets 的Go包。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [trie](https://github.com/derekparker/trie) **star:423** 在Go中实现Trie。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [ring](https://github.com/TheTannerRyan/ring) **star:88** 高性能、线程安全的bloom过滤器。
...
* [prometheus](https://github.com/prometheus/prometheus) **star:25591** 用于监控系统和时序的数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [tidb](https://github.com/pingcap/tidb) **star:20086** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [influxdb](https://github.com/influxdb/influxdb) **star:17117** 可伸缩的数据存储，用于指标衡量、事件和实时分析。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [cockroach](https://github.com/cockroachdb/cockroach) **star:16783** 可伸缩、区域备份、事务性数据存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [dgraph](https://github.com/dgraph-io/dgraph) **star:10431** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [bolt](https://github.com/boltdb/bolt) **star:9986** K/V 数据库。   ![star > 5000][Gold]   ![最近一年没有更新][Yellow]   ![归档项目][Archived]
* [groupcache](https://github.com/golang/groupcache) **star:7663** Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。   ![star > 5000][Gold]
* [badger](https://github.com/dgraph-io/badger) **star:6283** 快速 K/V 存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [rqlite](https://github.com/rqlite/rqlite) **star:4698** 基于SQLite的轻量级分布式关系数据库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [ledisdb](https://github.com/siddontang/ledisdb) **star:3078** Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。   ![star > 1000][Silver]
* [go-cache](https://github.com/pmylund/go-cache) **star:2906** 基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。   ![star > 1000][Silver]
* [BigCache](https://github.com/allegro/bigcache) **star:2457** 高效的键/值缓存为千兆字节的数据。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [cache2go](https://github.com/muesli/cache2go) **star:1050** 基于内存的 K/V 缓存，支持超时的自动失效。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) **star:1012** 开源，快速，可伸缩的时间序列数据库。支持PromQL。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [fastcache](https://github.com/VictoriaMetrics/fastcache) **star:488** 基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。   ![star > 100][Bronze]
...
* [migrate](https://github.com/golang-migrate/migrate) **star:2723** 基于CLI的数据库迁移库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [sql-migrate](https://github.com/rubenv/sql-migrate) **star:1411** 数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。   ![star > 1000][Silver]
...
* [vitess](https://github.com/youtube/vitess) **star:8453** vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [pgweb](https://github.com/sosedoff/pgweb) **star:5989** 基于web的PostgreSQL数据库浏览器。   ![star > 5000][Gold]
* [kingshard](https://github.com/flike/kingshard) **star:4610** kingshard 是基于 Golang 的MySQL高性能代理。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [orchestrator](https://github.com/github/orchestrator) **star:3031** MySQL复制拓扑管理器和可视化工具。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) **star:2402** 自动将MySQL数据同步到Elasticsearch中。   ![star > 1000][Silver]
* [pREST](https://github.com/nuveo/prest) **star:2089** 基于PostgreSQL database的RESTful API服务。   ![star > 1000][Silver]
* [go-mysql](https://github.com/siddontang/go-mysql) **star:1892**  Go 工具集，用于处理MySQL协议和复制。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [Squirrel](https://github.com/Masterminds/squirrel) **star:2322** 帮助您构建SQL查询的Go库。   ![star > 1000][Silver]
* [xo](https://github.com/knq/xo) **star:2185** 基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。   ![star > 1000][Silver]
...
* Relational Databases
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) **star:8114** MySQL驱动程序。   ![star > 5000][Gold]
    * [pq](https://github.com/lib/pq) **star:5189** 纯 Go 的Postgres驱动。   ![star > 5000][Gold]
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) **star:3428** SQLite3驱动程序。   ![star > 1000][Silver]
    * [pgx](https://github.com/jackc/pgx) **star:1961** PostgreSQL驱动，支持比现有database/sql更多的特性。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [go-mssqldb](https://github.com/denisenkom/go-mssqldb) **star:1023** 微软MSSQL驱动程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* NoSQL Databases
    * [redis](https://github.com/go-redis/redis) **star:6512** 基于 Go 的 Redis 客户端。   ![star > 5000][Gold]   ![最近一周有更新][Green]
    * [redigo](https://github.com/gomodule/redigo) **star:6293** Redigo 是基于 Go 的Redis 客户端。   ![star > 5000][Gold]
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) **star:3112** 官方的 MongoDB 驱动。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [mgo](https://github.com/globalsign/mgo) **star:1643** (已停止维护) MongoDB驱动。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [gorethink](https://github.com/dancannon/gorethink) **star:1460** RethinkDB 驱动。   ![star > 1000][Silver]
...
* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) **star:5846** 基于 Go 的现代文本索引库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
    * [riot](https://github.com/go-ego/riot) **star:4700** 基于 Go 的 开源、分布式、简单高效的搜索引擎。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
    * [elastic](https://github.com/olivere/elastic) **star:4147** Elasticsearch 客户端。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) **star:1581** 官方 Elasticsearch 客户端。   ![star > 1000][Silver]
    * [elastigo](https://github.com/mattbaird/elastigo) **star:951** Elasticsearch 客户端。   ![star > 100][Bronze]
    * [elasticsql](https://github.com/cch123/elasticsql) **star:397** 将 SQL 转换为 elasticsearch dsl。   ![star > 100][Bronze]
...
* [dateparse](https://github.com/araddon/dateparse) **star:896** 可以解析很多格式不固定的日期字符串。   ![star > 100][Bronze]
* [carbon](https://github.com/uniplaces/carbon) **star:339** 简单的时间扩展，包含了许多使用方法，从 PHP Carbon 库移植的。   ![star > 100][Bronze]
...
* [go-kit](https://github.com/go-kit/kit) **star:14449** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [grpc-go](https://github.com/grpc/grpc-go) **star:9109** gRPC的Go语言实现。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [jaeger](https://github.com/jaegertracing/jaeger) **star:8670** 分布式跟踪系统。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [micro](https://github.com/micro/micro) **star:6599** 可插拔的微服务 toolkit 和分布式系统平台。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) **star:6345** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [rpcx](https://github.com/smallnest/rpcx) **star:3801** 分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [tendermint](https://github.com/tendermint/tendermint) **star:3138** 一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [raft](https://github.com/coreos/etcd/tree/master/raft)  Raft consensus协议的实现。 by CoreOS。
* [raft](https://github.com/hashicorp/raft) **star:2843** Raft consensus协议的实现。 by HashiCorp。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [torrent](https://github.com/anacrolix/torrent) **star:2843** BitTorrent 客户端。   ![star > 1000][Silver]
* [dragonboat](https://github.com/lni/dragonboat) **star:2538** 一个功能齐全，高性能的库集。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [glow](https://github.com/chrislusf/glow) **star:2527** 全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。   ![star > 1000][Silver]
* [gleam](https://github.com/chrislusf/gleam) **star:2100** 使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。   ![star > 1000][Silver]
* [emitter-io](https://github.com/emitter-io/emitter) **star:1934** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [KrakenD](https://github.com/devopsfaith/krakend) **star:1752** 具有中间件的高性能API网关框架。   ![star > 1000][Silver]
* [hprose](https://github.com/hprose/hprose-golang) **star:1005** 支持25+种语言RPC库。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [ringpop-go](https://github.com/uber/ringpop-go) **star:574** 可伸缩的，容错、应用分层的的Go应用程序。   ![star > 100][Bronze]
* [gorpc](https://github.com/valyala/gorpc) **star:553** 简单、快速和可伸缩的RPC库。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [go-health](https://github.com/InVisionApp/go-health) **star:478** 用于在服务中启用异步依赖项健康检查的库。   ![star > 100][Bronze]
...
* [jsonrpc](https://github.com/ybbus/jsonrpc) **star:102** JSON-RPC 2.0 HTTP客户端。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [MailHog](https://github.com/mailhog/MailHog) **star:5169** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。   ![star > 5000][Gold]
...
* [email](https://github.com/jordan-wright/email) **star:1093** 一个强大和灵活的电子邮件库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [otto](https://github.com/robertkrimen/otto) **star:4729** 用 Go 编写的 JavaScript 解释器。   ![star > 1000][Silver]
* [gopher-lua](https://github.com/yuin/gopher-lua) **star:2962** 用 Go 实现的 Lua 5.1 虚拟机和编译器。   ![star > 1000][Silver]
* [go-lua](https://github.com/Shopify/go-lua) **star:1670** 用 Go 实现的 Lua 5.2 VM接口。   ![star > 1000][Silver]
* [tengo](https://github.com/d5/tengo) **star:1303** 字节码编译的脚本语言。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [expr](https://github.com/antonmedv/expr) **star:701** 一个可以计算表达式的引擎。   ![star > 100][Bronze]
* [go-php](https://github.com/deuill/go-php) **star:682** PHP 的 Go 接口。   ![star > 100][Bronze]
...
* [errors](https://github.com/pkg/errors) **star:4894** 可让你很简单的进行错误处理。   ![star > 1000][Silver]
...
* [afero](https://github.com/spf13/afero) **star:2234** 文件系统的抽象系统。   ![star > 1000][Silver]
* [pdfcpu](https://github.com/hhrutter/pdfcpu) **star:947** PDF处理器。   ![star > 100][Bronze]
* [notify](https://github.com/rjeczalik/notify) **star:494** 文件系统事件通知库，具有类似于os/signal的简单API，。   ![star > 100][Bronze]
...
* [go-exiftool](https://github.com/barasher/go-exiftool) **star:3** ExifTool 的 Go 实现，这个著名的库用于从文件(图片、PDF、office，…)中提取尽可能多的元数据(EXIF、IPTC，…)。

## 金融

*会计和财务软件包。 (翻译出错了? 试试 [英文版](README_EN.md#financial) 吧~)*

* [decimal](https://github.com/shopspring/decimal) **star:1600** 任意精度定点的十进制数。   ![star > 1000][Silver]
* [go-money](https://github.com/rhymond/go-money) **star:619** Fowler 货币模式的实现。   ![star > 100][Bronze]
...
* [orderbook](https://github.com/i25959341/orderbook) **star:69** 限购单匹配引擎。
...
* [go-underscore](https://github.com/tobyhede/go-underscore) **star:1068** 常用辅助方法集合。   ![star > 1000][Silver]
...
* [Leaf](https://github.com/name5566/leaf) **star:3063** 轻量级游戏服务器框架。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [Pixel](https://github.com/faiface/pixel) **star:2437** 手工制作的 2D 游戏库。   ![star > 1000][Silver]
* [Ebiten](https://github.com/hajimehoshi/ebiten) **star:1851** 很简单的 2D 游戏库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [goworld](https://github.com/xiaonanln/goworld) **star:1195** 可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [termloop](https://github.com/JoelOtter/termloop) **star:1023** 基于终端的 Go 游戏引擎，建立在 Termbox 之上。   ![star > 1000][Silver]
* [nano](https://github.com/lonng/nano) **star:997** 轻量级、方便、高性能的基于golang的游戏服务器框架。   ![star > 100][Bronze]   ![包含中文文档][CN]
* [g3n](https://github.com/g3n/engine) **star:753**  3D游戏引擎。   ![star > 100][Bronze]
...
* [jennifer](https://github.com/dave/jennifer) **star:1275** 不使用模板生成任意 Go 代码。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gen](https://github.com/clipperhouse/gen) **star:1036** 用于生成泛型等类似方法的功能代码生成工具。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [goderive](https://github.com/awalterschulze/goderive) **star:745** 从输入类型来派生函数。   ![star > 100][Bronze]
...
* [Tile38](https://github.com/tidwall/tile38) **star:6332** 具有空间索引和实时地理定位功能的地理定位数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [gopherjs](https://github.com/gopherjs/gopherjs) **star:8543** 将 Go 编译成 JavaScript。   ![star > 5000][Gold]
...
* [goworker](https://github.com/benmanns/goworker) **star:2251** 基于 go 的后台 worker。   ![star > 1000][Silver]
* [ants](https://github.com/panjf2000/ants) **star:1888** 一个高性能的协程池。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [ui](https://github.com/andlabs/ui) **star:6950** 跨平台的 Platform-native GUI 库。   ![star > 5000][Gold]
* [Wails](https://wails.app)  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。
* [fyne](https://github.com/fyne-io/fyne) **star:6282** 为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [qt](https://github.com/therecipe/qt) **star:6059** 实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [webview](https://github.com/zserge/webview) **star:4661** 跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。   ![star > 1000][Silver]
* [walk](https://github.com/lxn/walk) **star:3693** Windows应用程序库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [app](https://github.com/murlokswarm/app) **star:2954** 用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。   ![star > 1000][Silver]
* [go-astilectron](https://github.com/asticode/go-astilectron) **star:2666** 使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [gotk3](https://github.com/gotk3/gotk3) **star:772** 实现了 GTK3 的 Go接口。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [gowd](https://github.com/dtylman/gowd) **star:210** 跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。   ![star > 100][Bronze]

*交互 (翻译出错了? 试试 [英文版](README_EN.md#gui) 吧~)*

* [robotgo](https://github.com/go-vgo/robotgo) **star:4430** 实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [imaginary](https://github.com/h2non/imaginary) **star:2592** 用于图像大小调整的快速、简单的HTTP微服务。   ![star > 1000][Silver]
* [bild](https://github.com/anthonynsimon/bild) **star:2545** 纯Go语言实现的图像处理算法合集。   ![star > 1000][Silver]
* [imaging](https://github.com/disintegration/imaging) **star:2525** 简单的Go图像处理包。   ![star > 1000][Silver]
* [ln](https://github.com/fogleman/ln) **star:2462** Go实现的3D线艺术（3D Line Art）渲染。   ![star > 1000][Silver]
* [gocv](https://github.com/hybridgroup/gocv) **star:2457** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。   ![star > 1000][Silver]
...
* [picfit](https://github.com/thoas/picfit) **star:1068** Go实现的图像调整服务器。   ![star > 1000][Silver]
* [geopattern](https://github.com/pravj/geopattern) **star:1012** 由字符串创建漂亮图案的图片生成器。   ![star > 1000][Silver]
* [imagick](https://github.com/gographics/imagick) **star:976**  ImageMagick下MagickWand的C API的Go binding。   ![star > 100][Bronze]
* [bimg](https://github.com/h2non/bimg) **star:794** 使用libvips实现的快速高效的图像处理包。   ![star > 100][Bronze]
...
* [darkroom](https://github.com/gojek/darkroom) **star:32** An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency.   ![最近一周有更新][Green]
...
* [JobRunner](https://github.com/bamzi/jobrunner) **star:570** 智能和功能丰富的cron作业调度程序（包含任务队列和实时监控）。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [GJSON](https://github.com/tidwall/gjson) **star:4902** 使用一行代码获取JSON的值。   ![star > 1000][Silver]
...
* [logrus](https://github.com/Sirupsen/logrus) **star:11951** Go的结构化日志操作 。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [zap](https://github.com/uber-go/zap) **star:7454** 快速、结构化、多等级的日志记录。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [spew](https://github.com/davecgh/go-spew) **star:3310** 为Go数据结构实现一个漂亮的printer用于帮助调试。   ![star > 1000][Silver]
* [glog](https://github.com/golang/glog) **star:2304** 为Go提供了多等级日志记录。   ![star > 1000][Silver]
* [zerolog](https://github.com/rs/zerolog) **star:2218** Zero-allocation JSON日志记录。   ![star > 1000][Silver]
* [tail](https://github.com/hpcloud/tail) **star:1540** 努力模拟实现BSD的tail的特性的Go包。   ![star > 1000][Silver]
* [lumberjack](https://github.com/natefinch/lumberjack) **star:1444** 简单的滚动日志，io.WriteCloser的实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [seelog](https://github.com/cihub/seelog) **star:1360** 具有灵活调度、过滤和格式化的日志功能。   ![star > 1000][Silver]
* [log15](https://github.com/inconshreveable/log15) **star:912** 简单、强大的日志操作。   ![star > 100][Bronze]
...
* [tfgo](https://github.com/galeone/tfgo) **star:1186** 易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。   ![star > 1000][Silver]
* [goml](https://github.com/cdipaolo/goml) **star:1012** 在线机器学习。   ![star > 1000][Silver]
* [gosseract](https://github.com/otiai10/gosseract) **star:873** 使用c++的Tesseract库实现的OCR。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [sarama](https://github.com/Shopify/sarama) **star:4626**  Apache Kafka的Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gorush](https://github.com/appleboy/gorush) **star:3713** 使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。   ![star > 1000][Silver]
* [Centrifugo](https://github.com/centrifugal/centrifugo) **star:3687** 实时消息(Websockets或SockJS)服务器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [machinery](https://github.com/RichardKnop/machinery) **star:3372** 基于分布式消息传递的异步任务/作业队列。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-socket.io](https://github.com/googollee/go-socket.io) **star:2886** go的socket.io库，一个实时应用程序框架。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [NATS Go Client](https://github.com/nats-io/nats) **star:2398** 轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [APNs2](https://github.com/sideshow/apns2) **star:2043** HTTP / 2苹果消息推送provider——发送推送消息到iOS, tvOS, Safari和OSX应用。   ![star > 1000][Silver]
...
* [melody](https://github.com/olahol/melody) **star:1563** 处理websocket session的极简框架，包括广播和自动ping/pong处理。   ![star > 1000][Silver]
* [mangos](https://github.com/go-mangos/mangos) **star:1534** Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。   ![star > 1000][Silver]
* [Mercure](https://github.com/dunglas/mercure) **star:1507** 使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-nsq](https://github.com/nsqio/go-nsq) **star:1458** NSQ的官方Go包。   ![star > 1000][Silver]
...
* [Gollum](https://github.com/trivago/gollum) **star:768** 一个n:m多路复用器(n:m multiplexer)，收集不同来源的消息并将其广播到一组目的地。   ![star > 100][Bronze]
...
* [dbus](https://github.com/godbus/dbus) **star:358** D-Bus的Go bindings。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [Glue](https://github.com/desertbit/glue) **star:318** 健壮的Go和Javascript Socket库(替代Socket.io)。   ![star > 100][Bronze]
...
* [unioffice](https://github.com/unidoc/unioffice) **star:1717** 用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]

### Microsoft Excel

*用于操作Microsoft Excel的库。 (翻译出错了? 试试 [英文版](README_EN.md#microsoft-excel) 吧~)*

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) **star:4471** 用于读写Microsoft Excel™(XLSX)文件的Go语言库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [xlsx](https://github.com/tealeg/xlsx) **star:3421** 用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [dig](https://github.com/uber-go/dig) **star:911** 一个基于反射的Go依赖注入工具包。   ![star > 100][Bronze]
* [fx](https://github.com/uber-go/fx) **star:752** 基于依赖注入的Go应用程序框架(构建在dig之上)。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) **star:9155** Go生态系统中历史和新兴的项目布局模式集合。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [archiver](https://github.com/mholt/archiver) **star:2488** 用于生成和解压.zip和.tar.gz文档的库和命令。   ![star > 1000][Silver]
* [gosms](https://github.com/haxpax/gosms) **star:1226** Go编写的私人的本地短信网关，可以用来发送短信。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [go-resiliency](https://github.com/eapache/go-resiliency) **star:857**  Go语言弹性模式(resiliency pattern)。   ![star > 100][Bronze]
* [go-openapi](https://github.com/go-openapi)  用于解析和使用开放api模式(open-api schemas)的包的集合。
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) **star:671** Go语言的通用对象池。   ![star > 100][Bronze]   ![包含中文文档][CN]
...
* [shortid](https://github.com/teris-io/shortid) **star:450** 分布式地生成超短、唯一、非顺序、URL友好的id。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [gofakeit](https://github.com/brianvoe/gofakeit) **star:419** 用go编写的随机数据生成器。   ![star > 100][Bronze]
...
* [kcptun](https://github.com/xtaci/kcptun) **star:10673** 基于KCP协议的非常简单和快速udp隧道。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [fasthttp](https://github.com/valyala/fasthttp) **star:9385** 一个快速HTTP实现，比net/http快10倍。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [dns](https://github.com/miekg/dns) **star:3804** 用于 DNS 的库。   ![star > 1000][Silver]
* [HTTPLab](https://github.com/gchaincl/httplab) **star:3408** HTTPLabs 允许你检查 HTTP 请求和伪造响应。   ![star > 1000][Silver]
* [quic-go](https://github.com/lucas-clemente/quic-go) **star:2917** 在纯Go中实现了QUIC协议。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gopacket](https://github.com/google/gopacket) **star:2882** Go library for packet processing with libpcap bindings.   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [webrtc](https://github.com/pions/webrtc) **star:2262** WebRTC API的纯Go实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [kcp-go](https://github.com/xtaci/kcp-go) **star:2245** 快速可靠的ARQ协议。   ![star > 1000][Silver]
* [gobgp](https://github.com/osrg/gobgp) **star:1691** 基于 Go 的 BGP 实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [ssh](https://github.com/gliderlabs/ssh) **star:1113** 用于构建SSH服务器的高级API(封装密码/ SSH)。   ![star > 1000][Silver]
...
* [NFF-Go](https://github.com/intel-go/nff-go) **star:665** 用于快速开发云计算和裸机网络功能的框架(原YANFF)。   ![star > 100][Bronze]
* [mqttPaho](https://eclipse.org/paho/clients/golang/)  Paho Go客户端提供了一个 MQTT 客户端库，用于通过TCP、TLS或WebSockets连接到MQTT代理。
* [mdns](https://github.com/hashicorp/mdns) **star:551** 简单mDNS(Multicast DNS)客户端/服务器库。   ![star > 100][Bronze]
* [grab](https://github.com/cavaliercoder/grab) **star:546**  用于管理文件下载。   ![star > 100][Bronze]
* [ftp](https://github.com/jlaffaye/ftp) **star:525** 实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户端。   ![star > 100][Bronze]
* [lhttp](https://github.com/fanux/lhttp) **star:513** 强大的websocket框架，可以让你更容易的构建IM服务器。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
* [gosnmp](https://github.com/soniah/gosnmp) **star:437** 用于执行 SNMP 操作的原生 Go 库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [peerdiscovery](https://github.com/schollz/peerdiscovery) **star:364** 基于UDP组播的跨平台本地对等点发现库。   ![star > 100][Bronze]
...
* [stun](https://github.com/go-rtc/stun) **star:278** Go实现的RFC 5389 STUN协议。   ![star > 100][Bronze]
* [buffstreams](https://github.com/stabbycutyou/buffstreams) **star:232** 通过TCP传输协议缓冲区数据。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [winrm](https://github.com/masterzen/winrm) **star:212**  Go WinRM客户端远程执行Windows机器上的命令。   ![star > 100][Bronze]
...
* [jazigo](https://github.com/udhos/jazigo) **star:125** Jazigo是一个用Go编写的工具，用于检索多个网络设备的配置。   ![star > 100][Bronze]
...
* [grequests](https://github.com/levigross/grequests) **star:1415** 一个 Go “克隆”的伟大和著名的请求库。   ![star > 1000][Silver]
* [heimdall](https://github.com/gojektech/heimdall) **star:1077** 具有重试和hystrix功能的增强http客户机。   ![star > 1000][Silver]
...
* [glfw](https://github.com/go-gl/glfw) **star:734** GLFW 3 的 Go 接口实现。   ![star > 100][Bronze]
...
* [GORM](https://github.com/jinzhu/gorm) **star:14673** 一个出色的 ORM 库。主要目标是对开发人员友好。   ![star > 5000][Gold]
* [Xorm](https://github.com/go-xorm/xorm) **star:5208** 基于 Go 的简单而强大的ORM。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [gorp](https://github.com/go-gorp/gorp) **star:3078** 基于 Go 的关系持久性 ORM-ish 库。   ![star > 1000][Silver]
* [go-pg](https://github.com/go-pg/pg) **star:3001** 用于 PostgreSQL 的ORM。侧重于 PostgreSQL 的特性和性能。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) **star:2274** ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。   ![star > 1000][Silver]
...
* [pop/soda](https://github.com/gobuffalo/pop) **star:678** 数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。   ![star > 100][Bronze]
* [QBS](https://github.com/coocood/qbs) **star:539** Stands for Query By Struct. A Go ORM.   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
* [go-queryset](https://github.com/jirfag/go-queryset) **star:448** 基于 GORM 100% 类型安全的 ORM。可支持 MySQL, PostgreSQL, Sqlite3, SQL Server。   ![star > 100][Bronze]
...
* [dep](https://github.com/golang/dep) **star:12564**  Go 的依赖管理工具，需要 Go 1.9+   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [vgo](https://go.googlesource.com/vgo/)  Go 命令版本管理

*用于包和依赖项管理的非官方库。 (翻译出错了? 试试 [英文版](README_EN.md#package-management) 吧~)*

* [glide](https://github.com/Masterminds/glide) **star:7784** 轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。   ![star > 5000][Gold]
...
* [govendor](https://github.com/kardianos/govendor) **star:4743** 包管理器。使用 vendor 文件的 Go vendor 工具。   ![star > 1000][Silver]
* [gopm](https://github.com/gpmgo/gopm) **star:2362** 包管理器。   ![star > 1000][Silver]   ![归档项目][Archived]
...
* [graphql-go](https://github.com/graphql-go/graphql) **star:5228** 为Go实现GraphQL。   ![star > 5000][Gold]
* [graphql](https://github.com/neelance/graphql-go) **star:2787** 关注易用性的GraphQL服务器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [packr](https://github.com/gobuffalo/packr) **star:2120** 将静态文件嵌入到Go二进制文件中的简单方法。   ![star > 1000][Silver]
* [statik](https://github.com/rakyll/statik) **star:2111** 将静态文件嵌入到Go可执行文件中。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go.rice](https://github.com/GeertJohan/go.rice) **star:1649** go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。   ![star > 1000][Silver]
* [vfsgen](https://github.com/shurcooL/vfsgen) **star:657** 生成一个vfsdata。静态实现给定虚拟文件系统的go文件。   ![star > 100][Bronze]
* [esc](https://github.com/mjibson/esc) **star:472** 将文件嵌入到Go程序中并提供http文件系统接口。   ![star > 100][Bronze]
* [fileb0x](https://github.com/UnnoTed/fileb0x) **star:424** 一个可定制的工具用来在Go中嵌入文件   ![star > 100][Bronze]
...
* [gonum](https://github.com/gonum/gonum) **star:2960** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [stats](https://github.com/montanaflynn/stats) **star:1342** 包含Golang标准库中缺少的公共函数的统计软件包。   ![star > 1000][Silver]
...
* [lego](https://github.com/xenolf/lego) **star:3485** 纯 Go ACME 客户端库及命令行工具   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [memguard](https://github.com/awnumar/memguard) **star:1512** 一个用于处理内存中敏感值的纯Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [acra](https://github.com/cossacklabs/acra) **star:451** 网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。   ![star > 100][Bronze]
...
* [jsoniter](https://github.com/json-iterator/go) **star:5544** 高性能，100% 兼容的“encoding/json” 替代品   ![star > 5000][Gold]
* [goprotobuf](https://github.com/golang/protobuf) **star:5095** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) **star:2959** Go 语言的 Protocol Buffer 库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [mapstructure](https://github.com/mitchellh/mapstructure) **star:2433** 用于对原生键值对进行解码生成 Go 语言结构体   ![star > 1000][Silver]
...
* [csvutil](https://github.com/jszwec/csvutil) **star:305** 高性能、惯用的CSV记录编码和解码到本机Go结构。   ![star > 100][Bronze]
...
* [etcd](https://github.com/coreos/etcd) **star:26537** 为共享配置和服务发现提供高可用的键值存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Caddy](https://github.com/mholt/caddy) **star:23178** Caddy是另一种HTTP/2 web服务器，易于配置和使用。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [consul](https://www.consul.io/)  Consul 是一个用于服务发现、监控和配置的工具
* [minio](https://github.com/minio/minio) **star:17510** Minio是一个分布式对象存储服务器。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [yakvs](https://git.sci4me.com/sci4me/yakvs)  小型化、网络化、基于内存的键值存储
* [RoadRunner](https://github.com/spiral/roadrunner) **star:3293** 高性能PHP应用服务器，负载平衡器和进程管理器。   ![star > 1000][Silver]
* [devd](https://github.com/cortesi/devd) **star:2804** 为开发人员提供本地web服务器。   ![star > 1000][Silver]
...
* [Flagr](https://github.com/checkr/flagr) **star:827** Flagr是一个开源特性标记和A/B测试服务。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [Fider](https://github.com/getfider/fider) **star:796** Fider是一个收集和组织客户反馈的开放平台。   ![star > 100][Bronze]
* [jackal](https://github.com/ortuman/jackal) **star:718** 用Go编写的XMPP服务器。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [discovery](https://github.com/Bilibili/discovery) **star:676** 用于弹性中间层负载平衡和故障转移的注册表。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gofpdf](https://github.com/jung-kurt/gofpdf) **star:3078** PDF 文档生成器，支持文本，绘图和图片   ![star > 1000][Silver]
* [pongo2](https://github.com/flosch/pongo2) **star:1489** 类似 DjanGo 的模板引擎   ![star > 1000][Silver]
* [quicktemplate](https://github.com/valyala/quicktemplate) **star:1408** 快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译   ![star > 1000][Silver]
* [hero](https://github.com/shiyanhui/hero) **star:1205** Hero是一个方便、快速和强大的go模板引擎。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [Razor](https://github.com/sipin/gorazor) **star:701** Go 语言的 Razor 视图引擎   ![star > 100][Bronze]
...
* [raymond](https://github.com/aymerick/raymond) **star:341** 使用 Go 语言实现的完整的 handlebars   ![star > 100][Bronze]
...
* Testing Frameworks
    ...
    * [Testify](https://github.com/stretchr/testify) **star:8150** 对标准测试包的扩展。   ![star > 5000][Gold]   ![最近一周有更新][Green]
    * [go-cmp](https://github.com/google/go-cmp) **star:1160** 用于比较测试中的Go值的包。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [httpexpect](https://github.com/gavv/httpexpect) **star:1141** 简洁的、声明式的、易用的端到端HTTP 及 REST API 测试   ![star > 1000][Silver]
    * [godog](https://github.com/DATA-DOG/godog) **star:757** 类似 Cucumber 或 Behat 的 BDD 框架   ![star > 100][Bronze]
    ...
    * [gotest.tools](https://github.com/gotestyourself/gotest.tools) **star:120** 一组包，用于增强go测试包并支持公共模式。   ![star > 100][Bronze]   ![最近一周有更新][Green]
    ...
    * [testcase](https://github.com/adamluzsi/testcase) **star:9** 行为驱动开发的惯用测试框架。   ![最近一周有更新][Green]
...
* Mock
    * [gomock](https://github.com/golang/mock) **star:2854** 用于Go编程语言的mock框架。   ![star > 1000][Silver]
    ...
    * [gock](https://github.com/h2non/gock) **star:819** 多功能、易用 HTTP mock   ![star > 100][Bronze]
    * [httpmock](https://github.com/jarcoal/httpmock) **star:582** 轻松模拟来自外部资源的HTTP响应。   ![star > 100][Bronze]
...
* Fuzzing and delta-debugging/reducing/shrinking.
    * [go-fuzz](https://github.com/dvyukov/go-fuzz) **star:2888** 随机测试系统。   ![star > 1000][Silver]
    * [gofuzz](https://github.com/google/gofuzz) **star:532** 用于生成随机值来初始化 Go 语言对象的库   ![star > 100][Bronze]
    * [Tavor](https://github.com/zimmski/tavor) **star:212** 通用模糊测试框架   ![star > 100][Bronze]

* Selenium and browser control tools.
    * [chromedp](https://github.com/knq/chromedp) **star:3588** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品   ![star > 1000][Silver]
    * [selenoid](https://github.com/aerokube/selenoid) **star:1229** Selenium hub 服务器的替代品，在容器中启动浏览器   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* Specific Formats
    * [colly](https://github.com/asciimoo/colly) **star:8421** 快速和优雅的 Scraping 框架。   ![star > 5000][Gold]
    * [GoQuery](https://github.com/PuerkitoBio/goquery) **star:7591** GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能   ![star > 5000][Gold]
    * [blackfriday](https://github.com/russross/blackfriday) **star:3895** Markdown 解析器   ![star > 1000][Silver]
    * [toml](https://github.com/BurntSushi/toml) **star:2790** TOML配置格式(带反射的编码器/解码器)。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [sh](https://github.com/mvdan/sh) **star:1999** Shell解析器和格式化工具。   ![star > 1000][Silver]
    * [go-humanize](https://github.com/dustin/go-humanize) **star:1902** 格式化程序，用于将时间、数字和内存大小转换为可读格式。   ![star > 1000][Silver]
    * [bluemonday](https://github.com/microcosm-cc/bluemonday) **star:1251** HTML 清理工具   ![star > 1000][Silver]
    * [inject](https://github.com/facebookgo/inject) **star:1140** 包注入提供了一个基于反射的注入器。   ![star > 1000][Silver]   ![归档项目][Archived]
    * [gofeed](https://github.com/mmcdole/gofeed) **star:1098** 在Go中解析RSS和Atom feeds。   ![star > 1000][Silver]
    ...
    * [mxj](https://github.com/clbanning/mxj) **star:331** 将XML编码/解码为JSON或map[string]接口{};使用点符号路径和通配符提取值。替换x2j和j2x包。   ![star > 100][Bronze]
    ...
    * [dataflowkit](https://github.com/slotix/dataflowkit) **star:290** Web抓取框架将网站转换为结构化数据。   ![star > 100][Bronze]
    ...
    * [htmlquery](https://github.com/antchfx/htmlquery) **star:130** 用于HTML的XPath查询包，允许您通过XPath表达式从HTML文档中提取数据或求值。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) **star:5030** AWS 提供的官方go语言 SDK   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [github](https://github.com/google/go-github) **star:4766** 访问GitHub REST API v3的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [slack](https://github.com/nlopes/slack) **star:2424** Slack API。   ![star > 1000][Silver]
* [google](https://github.com/google/google-api-go-client) **star:1923** 为Go自动生成谷歌api。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) **star:1786** 谷歌云api Go 客户端库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [anaconda](https://github.com/ChimeraCoder/anaconda) **star:989**  Twitter 1.1 API 的 go 语言客户端   ![star > 100][Bronze]
* [discordgo](https://github.com/bwmarrin/discordgo) **star:967**  Discord Chat API的客户端。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [stripe](https://github.com/stripe/stripe-go) **star:942**  Stripe API 的 Go 语言客户端   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [facebook](https://github.com/huandu/facebook) **star:771** 支持 Facebook Graph API 的库   ![star > 100][Bronze]
* [minio-go](https://github.com/minio/minio-go) **star:722** 用于Amazon S3兼容云存储的Minio Go库。   ![star > 100][Bronze]
* [go-twitter](https://github.com/dghubble/go-twitter) **star:713**  Twitter v1.1 api 的客户端.   ![star > 100][Bronze]
* [go-jira](https://github.com/andygrunwald/go-jira) **star:575**  Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库   ![star > 100][Bronze]
* [githubql](https://github.com/shurcooL/githubql) **star:503** 访问GitHub GraphQL API v4的库。   ![star > 100][Bronze]
* [webhooks](https://github.com/go-playground/webhooks) **star:353** GitHub 和 Bitbucket 的Webhook接收器。   ![star > 100][Bronze]
...
* [fzf](https://github.com/junegunn/fzf) **star:23182** 用Go编写的命令行模糊查找器。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [hub](https://github.com/github/hub) **star:16975** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [delve](https://github.com/derekparker/delve) **star:12045** Go 语言调试器   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [ctop](https://github.com/bcicen/ctop) **star:8826** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。   ![star > 5000][Gold]
* [wuzz](https://github.com/asciimoo/wuzz) **star:8260** 用于HTTP检查的交互式cli工具。   ![star > 5000][Gold]
* [sqlx](https://github.com/jmoiron/sqlx) **star:6809** 为内建的数据库/sql 软件包提供一组扩展。   ![star > 5000][Gold]
* [peco](https://github.com/peco/peco) **star:5471** 简单的交互过滤工具。   ![star > 5000][Gold]
* [usql](https://github.com/knq/usql) **star:4675** usql 是一个通用的命令行接口，用于操作 sql 数据库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [goreleaser](https://github.com/goreleaser/goreleaser) **star:4505** 尽可能快速的发布 Go 语言二进制文件。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [realize](https://github.com/tockins/realize) **star:3165** Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。   ![star > 1000][Silver]
...
* [hystrix-go](https://github.com/afex/hystrix-go) **star:2019** 实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。   ![star > 1000][Silver]
* [resty](https://github.com/go-resty/resty) **star:1976** 简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [Storm](https://github.com/asdine/storm) **star:1354** 一个简单又强大的用于 BoltDB 的工具   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [mole](https://github.com/davrodpin/mole) **star:1301** cli应用程序可以轻松创建ssh隧道。   ![star > 1000][Silver]
* [go-funk](https://github.com/thoas/go-funk) **star:1188** 现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)   ![star > 1000][Silver]
* [mc](https://github.com/minio/mc) **star:1117** Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [mergo](https://github.com/imdario/mergo) **star:850** 用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。   ![star > 100][Bronze]
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) **star:795** 接通断路器。   ![star > 100][Bronze]
* [spinner](https://github.com/briandowns/spinner) **star:785**  一个 Go 语言软件包，提供多种选项，方便在终端中创建加载动画。   ![star > 100][Bronze]
...
* [clockwork](https://github.com/jonboulle/clockwork) **star:220** 一个简单的假 clock 。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gubrak](https://github.com/novalagung/gubrak) **star:140** 带有语法糖的Golang实用工具，就像lodash。   ![star > 100][Bronze]
...
* [chyle](https://github.com/antham/chyle) **star:108** 使用具有多种配置可能性的git存储库生成变更日志。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [ulid](https://github.com/oklog/ulid) **star:1674** 实现了ULID(普遍唯一的词典分类标识符)。   ![star > 1000][Silver]
...
* [govalidator](https://github.com/asaskevich/govalidator) **star:3554** 用于字符串，数字，切片和结构的验证器和sanitizers。   ![star > 1000][Silver]
* [validator](https://github.com/go-playground/validator) **star:3523**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) **star:1050** 支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [govalidator](https://github.com/thedevsaddam/govalidator) **star:716** 用简单的规则验证Golang请求数据。深受Laravel请求验证的启发。   ![star > 100][Bronze]
* [validate](https://github.com/gookit/validate) **star:95**  Go 封装数据验证和过滤。支持验证映射、结构、请求(表单、JSON、url)。值，上载文件)数据和更多特性。   ![包含中文文档][CN]
...
* [go-git](https://github.com/src-d/go-git) **star:4281** 纯Go中高度可扩展的Git实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [git2go](https://github.com/libgit2/git2go) **star:1365**  libgit2 的 Go 语言接口。   ![star > 1000][Silver]
...
* [goav](https://github.com/giorgisio/goav) **star:788** FFmpeg的Comphrensive。   ![star > 100][Bronze]
* [gmf](https://github.com/3d0c/gmf) **star:532**  FFmpeg av\* 库的 Go 语言接口。   ![star > 100][Bronze]
...
* [Gin](https://github.com/gin-gonic/gin) **star:30005** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Beego](https://github.com/astaxie/beego) **star:21476** beego是一种用于 Go 编程语言的开源高性能web框架。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [Buffalo](http://gobuffalo.io)  为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) **star:14688** 高性能、极简的Go web框架。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Revel](https://github.com/revel/revel) **star:11244** 用于Go语言的高效web框架。   ![star > 5000][Gold]
* [Goa](https://github.com/goadesign/goa) **star:3506** Goa为在Go中开发远程api和微服务提供了一种全面的方法。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-json-rest](https://github.com/ant0ine/go-json-rest) **star:3334** 设置RESTful JSON API的快速简便方法。   ![star > 1000][Silver]
...
* [CORS](https://github.com/rs/cors) **star:1223** 轻松地向API添加CORS功能。   ![star > 1000][Silver]
...
* [negroni](https://github.com/urfave/negroni) **star:6333** 符合语言习惯的 HTTP 中间件库。   ![star > 5000][Gold]   ![包含中文文档][CN]
...
* [httprouter](https://github.com/julienschmidt/httprouter) **star:9721** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。   ![star > 5000][Gold]
* [mux](https://github.com/gorilla/mux) **star:9675** 强大的URL路由器和调度器为golang。   ![star > 5000][Gold]
* [chi](https://github.com/go-chi/chi) **star:6041** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [Goji](https://github.com/goji/goji) **star:769** 枸杞是一种简约的和灵活的与支持'net/context` HTTP请求多路复用器。   ![star > 100][Bronze]
...
* [xpath](https://github.com/antchfx/xpath) **star:168** Go的XPath包。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [goast-viewer](https://github.com/yuroyoro/goast-viewer) **star:376** 基于 Web 的 Golang AST 可视化工具。   ![star > 100][Bronze]
...
* [vim-go](https://github.com/fatih/vim-go) **star:10848** Go 开发会用到的 Vim 插件。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) **star:5131** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [go-mode](https://github.com/dominikh/go-mode.el) **star:957** 在 GNU/Emacs 支持 GO。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gotests](https://github.com/cweill/gotests) **star:2201** 从源代码生成测试用例。   ![star > 1000][Silver]
...
* [go-swagger](https://github.com/go-swagger/go-swagger) **star:3992** 基于 Go 的Swagger 2.0实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [OctoLinker](https://github.com/OctoLinker/browser-extension) **star:3798** 借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-callvis](https://github.com/TrueFurby/go-callvis) **star:1988** 使用 dot format 可视化 Go 程序的调用图。   ![star > 1000][Silver]
* [richgo](https://github.com/kyoh86/richgo) **star:389** 用文本装饰丰富 go test 的输出。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [depth](https://github.com/KyleBanks/depth) **star:378** 通过分析导入，将包依赖关系树可视化输出。   ![star > 100][Bronze]
...
* [kubernetes](https://github.com/kubernetes/kubernetes) **star:56329** 来自谷歌的容器集群管理器。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Moby](https://github.com/moby/moby) **star:54446** Collaborative project for the container ecosystem to assemble container-based systems.   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [traefik](https://github.com/containous/traefik) **star:23769** 反向代理和负载均衡器，支持多个后端。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [Gitea](https://github.com/go-gitea/gitea) **star:15316** 从 Gogs fork，完全由社区驱动。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [Vegeta](https://github.com/tsenart/vegeta) **star:12199** HTTP负载测试工具和库。超过9000 !   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Packer](https://github.com/mitchellh/packer) **star:9247** 用于从一个源配置为多个平台创建相同的机器图像。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Hey](https://github.com/rakyll/hey) **star:6323** 压力测试工具，可用来代替 ApacheBench (ab)。   ![star > 5000][Gold]
...
* [webhook](https://github.com/adnanh/webhook) **star:4093** 允许用户创建在服务器上执行命令的 HTTP hooks。   ![star > 1000][Silver]
* [gaia](https://github.com/gaia-pipeline/gaia) **star:3743** 可用于任何编程语言来构建强大的管道。   ![star > 1000][Silver]
* [gox](https://github.com/mitchellh/gox) **star:3364** 非常简单，没有多余的跨平台编译工具。   ![star > 1000][Silver]
* [bosun](https://github.com/bosun-monitor/bosun) **star:2852** 按照时间轴发出告警的框架。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [bombardier](https://github.com/codesenberg/bombardier) **star:1751** 快速跨平台 HTTP 基准测试工具。   ![star > 1000][Silver]
...
* [script](https://github.com/bitfield/script) **star:922** 让DevOps编写类shell和系统管理任务变得更加容易。   ![star > 100][Bronze]
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) **star:671** 允许你的 Go应用程序 进行自我更新。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [Pomerium](https://github.com/pomerium/pomerium) **star:511** Pomerium是一个可识别身份的访问代理。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [aurora](https://github.com/xuri/aurora) **star:403** 基于web的跨平台 Beanstalkd 队列服务器控制台。   ![star > 100][Bronze]
...
* [Gor](https://github.com/buger/gor) **star:11370** Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [rkt](https://github.com/coreos/rkt) **star:8748** 一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) **star:8258** 快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [restic](https://github.com/restic/restic) **star:7487** 消除重复项备份程序。   ![star > 5000][Gold]
* [confd](https://github.com/kelseyhightower/confd) **star:6418** 使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。   ![star > 5000][Gold]
* [Comcast](https://github.com/tylertreat/Comcast) **star:6178** 模拟坏的网络连接。   ![star > 5000][Gold]
* [LiteIDE](https://github.com/visualfc/liteide) **star:5498** 简单的、开源的、跨平台的Go IDE。   ![star > 5000][Gold]   ![包含中文文档][CN]
* [drive](https://github.com/odeke-em/drive) **star:4965** 基于命令行的谷歌驱动器客户端。   ![star > 1000][Silver]
* [nes](https://github.com/fogleman/nes) **star:4126** 任天堂娱乐系统(NES)模拟器。   ![star > 1000][Silver]
* [tsuru](https://tsuru.io/)  Extensible and open source Platform as a Service software.
* [toxiproxy](https://github.com/shopify/toxiproxy) **star:3946** 为自动化测试模拟网络和系统条件的代理。   ![star > 1000][Silver]
* [Pipe](https://github.com/b3log/pipe) **star:2967** 一个小巧漂亮的博客平台。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [Documize](https://github.com/documize/community) **star:829** 集成了SaaS工具数据的现代wiki软件。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [scc](https://github.com/boyter/scc) **star:772** 一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [Leaps](https://github.com/jeffail/leaps) **star:640** 使用操作转换的成对编程服务。   ![star > 100][Bronze]
* [peg](https://github.com/pointlander/peg) **star:611** 解析表达式语法，是Packrat解析器生成器的实现。   ![star > 100][Bronze]
...
* [shell2http](https://github.com/msoap/shell2http) **star:415** 通过http服务器执行shell命令(用于原型或远程控制)。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [GoBooks](https://github.com/dariubs/GoBooks) **star:6803** 一份精选的 Go 书籍清单。   ![star > 5000][Gold]
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) **star:1541** 由 Maria Letta 提供的与 Gopher 有关的图片包，其中包含了插图,表情文字。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [gophers](https://github.com/ashleymcnamara/gophers) **star:1856** 阿什莉·麦克纳马拉的歌斐艺术品。   ![star > 1000][Silver]
...
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) **star:24654** 其他 awesome 系列的列表。   ![star > 5000][Gold]
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) **star:31556** Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。   ![star > 5000][Gold]   ![包含中文文档][CN]
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) **star:4548** 学习使用测试驱动开发。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
...
* [Working with Go](https://github.com/mkaz/working-with-go) **star:1132** 由一个经验丰富的Go程序员群体编写的一系列Go学习范例。   ![star > 1000][Silver]
