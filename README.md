...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-10 09:30:19(每隔1天同步一次)**
...
* [Oto](https://github.com/hajimehoshi/oto) - **star:419** 多平台的 low-level 声音播放库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [authboss](https://github.com/volatiletech/authboss) - **star:1901** web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。![star > 1000][Silver]   
* [branca](https://github.com/hako/branca) - **star:69** 基于 Go 实现Branca令牌。
* [casbin](https://github.com/hsluoyz/casbin) - **star:4743** 支持ACL、RBAC、ABAC等访问控制模型的授权库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [cookiestxt](https://github.com/mengzhuo/cookiestxt) - **star:2** 提供cookie .txt文件格式的解析器。![最近一年没有更新][Yellow]
* [go-jose](https://github.com/square/go-jose) - **star:1098** 相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。![star > 1000][Silver]   
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) - **star:1255** 用 Golang 编写的独立且符合规范的OAuth2服务器。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gologin](https://github.com/dghubble/gologin) - **star:1030** 用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。![star > 1000][Silver]   
* [gorbac](https://github.com/mikespook/gorbac) - **star:896** 轻量级的基于角色的访问控制(RBAC)实现。![star > 100][Bronze]   
...
* [jwt](https://github.com/pascaldekloe/jwt) - **star:78** 轻量级JSON Web令牌库。![最近一个周有更新][Green]
* [jwt-auth](https://github.com/adam-hanna/jwt-auth) - **star:151** JWT中间件，可用于Golang http服务器，提供了许多配置选项。![star > 100][Bronze]   
* [jwt-go](https://github.com/dgrijalva/jwt-go) - **star:5778** JSON Web令牌(JWT)。![star > 5000][Gold]   
* [loginsrv](https://github.com/tarent/loginsrv) - **star:797** JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。![star > 100][Bronze]   
* [oauth2](https://github.com/golang/oauth2) - **star:2336** goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [osin](https://github.com/openshift/osin) - **star:1534** OAuth2服务器库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [paseto](https://github.com/o1egl/paseto) - **star:221** 平台无关的安全令牌(PASETO)。![star > 100][Bronze]   
...
* [Kelp](https://github.com/stellar/kelp) - **star:151** 官方交易和做市机器人为[Stellar](https://www.stellar.org/) DEX。开箱即用的作品，用 Golang 编写，兼容集中交易和定制交易策略。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [slacker](https://github.com/shomali11/slacker) - **star:301** 可简单创建Slack机器人的框架。![star > 100][Bronze]   
...
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - **star:1578** 简单轻量级的Telegram bot客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [cobra](https://github.com/spf13/cobra) - **star:12682** 现代Go CLI命令行交互工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [flaggy](https://github.com/integrii/flaggy) - **star:444** 一个健壮的、易用的标志包，具有出色的子命令支持。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-flags](https://github.com/jessevdk/go-flags) - **star:1492**  Go 命令行选项解析器。![star > 1000][Silver]   
...
* [kingpin](https://github.com/alecthomas/kingpin) - **star:2503** 支持子命令的命令行和标志解析器。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [liner](https://github.com/peterh/liner) - **star:573** 类似readline-like的命令行接口库。![star > 100][Bronze]   
* [mitchellh/cli](https://github.com/mitchellh/cli) - **star:989** 用于实现命令行接口的Go库。![star > 100][Bronze]   
* [mow.cli](https://github.com/jawher/mow.cli) - **star:620** 用于构建具有复杂标志和参数解析和验证的CLI应用程序。![star > 100][Bronze]   
* [ops](https://github.com/nanovms/ops) - **star:241** Unikernel 构建器/协调器。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [pflag](https://github.com/spf13/pflag) - **star:732** 基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。![star > 100][Bronze]   
...
* [urfave/cli](https://github.com/urfave/cli) - **star:11115** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。![star > 5000][Gold]   
...
* [aurora](https://github.com/logrusorgru/aurora) - **star:606** 支持fmt.Printf/Sprintf的ANSI终端颜色。![star > 100][Bronze]   
...
* [color](https://github.com/fatih/color) - **star:2985** 多功能包装，彩色终端输出。![star > 1000][Silver]   
...
* [go-colorable](https://github.com/mattn/go-colorable) - **star:372** 适用于windows的颜色编写器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gocui](https://github.com/jroimartin/gocui) - **star:5087** 旨在创建控制台用户界面的极简Go库。![star > 5000][Gold]   
...
* [progressbar](https://github.com/schollz/progressbar) - **star:554** 基本线程安全的进度条，在每个操作系统工作。![star > 100][Bronze]   
...
* [termbox-go](https://github.com/nsf/termbox-go) - **star:3444** 基于文本的跨平台接口库。![star > 1000][Silver]   
* [termdash](https://github.com/mum4k/termdash) - **star:781** 此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [termui](https://github.com/gizak/termui) - **star:8823** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。![star > 5000][Gold]   
* [uilive](https://github.com/gosuri/uilive) - **star:819** 用于实时更新终端输出的库。![star > 100][Bronze]   
...
* [config](https://github.com/JeremyLoy/config) - **star:187** 云本地应用程序配置。将ENV绑定到结构体仅需两行代码。![star > 100][Bronze]   
...
* [env](https://github.com/caarlos0/env) - **star:837** 解析环境变量并赋值到struct中(默认值)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [godotenv](https://github.com/joho/godotenv) - **star:2063** Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。![star > 1000][Silver]   
...
* [harvester](https://github.com/beatlabs/harvester) - **star:31** 一个易于使用的静态和动态配置包![最近一个周有更新][Green]
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) - **star:2361** 管理来自环境变量的配置数据。![star > 1000][Silver]   
...
* [viper](https://github.com/spf13/viper) - **star:9047** 配置管理。![star > 5000][Gold]   
* [xdg](https://github.com/OpenPeeDeeP/xdg) - **star:31** 遵循[XDG标准](https://standards.freedesktop.org/basedir-spec/basedir-spec-latest.html)的跨平台包。

## 持续集成

*用于帮助进行持续集成的工具。*

* [drone](https://github.com/drone/drone) - **star:18743** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) - **star:499** 布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。![star > 100][Bronze]   
...
* [go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) - **star:85** 自适应基数树。
* [go-datastructures](https://github.com/Workiva/go-datastructures) - **star:5066** 可靠的、高性能的和线程安全的数据结构的集合。![star > 5000][Gold]   
...
* [gods](https://github.com/emirpasic/gods) - **star:6125** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。![star > 5000][Gold]   
...
* [gota](https://github.com/kniren/gota) - **star:855** 实现了数据帧，序列以及数据噪音。![star > 100][Bronze]   
...
* [roaring](https://github.com/RoaringBitmap/roaring) - **star:644** 实现了压缩 bitsets 的Go包。![star > 100][Bronze]   
...
* [trie](https://github.com/derekparker/trie) - **star:410** 在Go中实现Trie。![star > 100][Bronze]   
...
* [willf/bloom](https://github.com/willf/bloom) - **star:649** 实现Bloom过滤器。![star > 100][Bronze]   

## 数据库

*数据库。*

* [badger](https://github.com/dgraph-io/badger) - **star:6143** 快速 K/V 存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [bcache](https://github.com/iwanbk/bcache) - **star:26** 基于内存的最终一致的分布式缓存。
* [BigCache](https://github.com/allegro/bigcache) - **star:2395** 高效的键/值缓存为千兆字节的数据。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [bolt](https://github.com/boltdb/bolt) - **star:9885** K/V 数据库。![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
* [cache2go](https://github.com/muesli/cache2go) - **star:980** 基于内存的 K/V 缓存，支持超时的自动失效。![star > 100][Bronze]   
* [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache) - **star:29** BigCache 支持集群和独立且生命周期存储项。![最近一年没有更新][Yellow]
* [cockroach](https://github.com/cockroachdb/cockroach) - **star:16589** 可伸缩、区域备份、事务性数据存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [couchcache](https://github.com/codingsince1985/couchcache) - **star:40** 由 Couchbase服务 支持的RESTful缓存微服务。
* [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) - **star:1427** 区块链领域的一个SQL数据库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [dgraph](https://github.com/dgraph-io/dgraph) - **star:9960** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [diskv](https://github.com/peterbourgon/diskv) - **star:740** 支持磁盘备份的可持久化 K/V 存储。![star > 100][Bronze]   
* [eliasdb](https://github.com/krotik/eliasdb) - **star:533** 无其他依赖项，支持REST API，短语搜索和sql类似的查询语言的事务图数据库。![star > 100][Bronze]   
* [fastcache](https://github.com/VictoriaMetrics/fastcache) - **star:469** 基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。![star > 100][Bronze]   
...
* [goleveldb](https://github.com/syndtr/goleveldb) - **star:3113** 在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gorocksdb](https://github.com/kapitan-k/gorocksdb) - **star:8** 用 Go 对[RocksDB](https://rocksdb.org)实现了封装。![最近一年没有更新][Yellow]
* [groupcache](https://github.com/golang/groupcache) - **star:7565** Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。![star > 5000][Gold]   
* [influxdb](https://github.com/influxdb/influxdb) - **star:16755** 可伸缩的数据存储，用于指标衡量、事件和实时分析。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [ledisdb](https://github.com/siddontang/ledisdb) - **star:3042** Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。![star > 1000][Silver]   
...
* [prometheus](https://github.com/prometheus/prometheus) - **star:25011** 用于监控系统和时序的数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [pudge](https://github.com/recoilme/pudge) - **star:218** 使用Go的标准库编写的快速和简单的键/值存储。![star > 100][Bronze]   
* [rqlite](https://github.com/rqlite/rqlite) - **star:4646** 基于SQLite的轻量级分布式关系数据库。![star > 1000][Silver]   
...
* [tidb](https://github.com/pingcap/tidb) - **star:19614** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - **star:899** 开源，快速，可伸缩的时间序列数据库。支持PromQL。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gormigrate](https://github.com/go-gormigrate/gormigrate) - **star:320** 面向Gorm ORM的数据库 schema 迁移辅助程序。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [migrate](https://github.com/golang-migrate/migrate) - **star:2468** 基于CLI的数据库迁移库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [migrator](https://github.com/lopezator/migrator) - **star:28** 非常简单的 Go 数据库迁移库。![最近一个周有更新][Green]
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) - **star:1379** 数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。![star > 1000][Silver]   
...
* [go-mysql](https://github.com/siddontang/go-mysql) - **star:1812**  Go 工具集，用于处理MySQL协议和复制。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) - **star:2298** 自动将MySQL数据同步到Elasticsearch中。![star > 1000][Silver]   
* [kingshard](https://github.com/flike/kingshard) - **star:4538** kingshard 是基于 Golang 的MySQL高性能代理。![star > 1000][Silver]   
* [myreplication](https://github.com/2tvenom/myreplication) - **star:142** MySql二进制日志复制监听器。支持基于语句和行的复制。![star > 100][Bronze]   
* [octillery](https://github.com/knocknote/octillery) - **star:49** 用于数据库分表(支持每个ORM或原生SQL)。
* [orchestrator](https://github.com/github/orchestrator) - **star:2967** MySQL复制拓扑管理器和可视化工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [pgweb](https://github.com/sosedoff/pgweb) - **star:5945** 基于web的PostgreSQL数据库浏览器。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [prep](https://github.com/hexdigest/prep) - **star:24** 在不更改代码的情况下使用准备好的SQL语句。![最近一年没有更新][Yellow]
* [pREST](https://github.com/nuveo/prest) - **star:2061** 基于PostgreSQL database的RESTful API服务。![star > 1000][Silver]   
* [rwdb](https://github.com/andizzle/rwdb) - **star:10** rwdb为多个数据库服务器的设置提供读取副本功能。![最近一年没有更新][Yellow]
* [vitess](https://github.com/youtube/vitess) - **star:8306** vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gendry](https://github.com/didi/gendry) - **star:729** 非入侵的SQL构建器和强大的数据绑定器。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [godbal](https://github.com/xujiajun/godbal) - **star:50** 数据库抽象层(dbal)。支持SQL builder，轻松获取结果。
* [goqu](https://github.com/doug-martin/goqu) - **star:521** 常用的SQL生成器和查询库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [Squirrel](https://github.com/Masterminds/squirrel) - **star:2204** 帮助您构建SQL查询的Go库。![star > 1000][Silver]   
* [xo](https://github.com/knq/xo) - **star:2122** 基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。![star > 1000][Silver]   
...
* Relational Databases
    ...
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - **star:7907** MySQL驱动程序。![star > 5000][Gold]   
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - **star:3364** SQLite3驱动程序。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [pgx](https://github.com/jackc/pgx) - **star:1868** PostgreSQL驱动，支持比现有database/sql更多的特性。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* NoSQL Databases
    ...
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - **star:2933** 官方的 MongoDB 驱动。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [redigo](https://github.com/gomodule/redigo) - **star:6160** Redigo 是基于 Go 的Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [redis](https://github.com/go-redis/redis) - **star:6230** 基于 Go 的 Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [xredis](https://github.com/shomali11/xredis) - **star:9** 类型安全，可定制，清晰和易用的Redis客户端。

* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) - **star:5753** 基于 Go 的现代文本索引库。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [elastic](https://github.com/olivere/elastic) - **star:4018** Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [elasticsql](https://github.com/cch123/elasticsql) - **star:374** 将 SQL 转换为 elasticsearch dsl。![star > 100][Bronze]   
    * [elastigo](https://github.com/mattbaird/elastigo) - **star:948** Elasticsearch 客户端。![star > 100][Bronze]   
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - **star:1487** 官方 Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [goes](https://github.com/OwnLocal/goes) - **star:24** 实现了与 Elasticsearch 交互的库。![最近一年没有更新][Yellow]
    * [riot](https://github.com/go-ego/riot) - **star:4635** 基于 Go 的 开源、分布式、简单高效的搜索引擎。![star > 1000][Silver]   
...
* Multiple Backends.
    ...
    * [cayley](https://github.com/google/cayley) - **star:12610** 图形数据库，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dateparse](https://github.com/araddon/dateparse) - **star:876** 可以解析很多格式不固定的日期字符串。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [now](https://github.com/jinzhu/now) - **star:2141** now 是时间有关的工具类。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [dragonboat](https://github.com/lni/dragonboat) - **star:2456** 一个功能齐全，高性能的库集。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [emitter-io](https://github.com/emitter-io/emitter) - **star:1881** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。![star > 1000][Silver]   
* [flowgraph](https://github.com/vectaport/flowgraph) - **star:18** flow-based programming package。
* [gleam](https://github.com/chrislusf/gleam) - **star:2047** 使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。![star > 1000][Silver]   
* [glow](https://github.com/chrislusf/glow) - **star:2496** 全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。![star > 1000][Silver]   
...
* [go-kit](https://github.com/go-kit/kit) - **star:14159** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。![star > 5000][Gold]   
* [gorpc](https://github.com/valyala/gorpc) - **star:548** 简单、快速和可伸缩的RPC库。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [grpc-go](https://github.com/grpc/grpc-go) - **star:8786** gRPC的Go语言实现。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hprose](https://github.com/hprose/hprose-golang) - **star:990** 支持25+种语言RPC库。![star > 100][Bronze]   
* [jaeger](https://github.com/jaegertracing/jaeger) - **star:8434** 分布式跟踪系统。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [KrakenD](https://github.com/devopsfaith/krakend) - **star:1669** 具有中间件的高性能API网关框架。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [micro](https://github.com/micro/micro) - **star:6457** 可插拔的微服务 toolkit 和分布式系统平台。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) - **star:5941** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [raft](https://github.com/hashicorp/raft) - **star:2797** Raft consensus协议的实现。 by HashiCorp。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [ringpop-go](https://github.com/uber/ringpop-go) - **star:567** 可伸缩的，容错、应用分层的的Go应用程序。![star > 100][Bronze]   
* [rpcx](https://github.com/smallnest/rpcx) - **star:3688** 分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [tendermint](https://github.com/tendermint/tendermint) - **star:3066** 一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [torrent](https://github.com/anacrolix/torrent) - **star:2783** BitTorrent 客户端。![star > 1000][Silver]   
...
* [go-imap](https://github.com/emersion/go-imap) - **star:708** 用于客户端和服务器的IMAP库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [MailHog](https://github.com/mailhog/MailHog) - **star:5063** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。![star > 5000][Gold]   
...
* [anko](https://github.com/mattn/anko) - **star:911** 用Go编写的解释器。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [binder](https://github.com/alexeyco/binder) - **star:29** Lua接口，基于[gopher-lua](https://github.com/yuin/gopher-lua)。
* [expr](https://github.com/antonmedv/expr) - **star:658** 一个可以计算表达式的引擎。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-duktape](https://github.com/olebedev/go-duktape) - **star:648** 支持 Duktape JavaScript 引擎。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [go-lua](https://github.com/Shopify/go-lua) - **star:1644** 用 Go 实现的 Lua 5.2 VM接口。![star > 1000][Silver]   
* [go-php](https://github.com/deuill/go-php) - **star:670** PHP 的 Go 接口。![star > 100][Bronze]   
* [go-python](https://github.com/sbinet/go-python) - **star:894** CPython C-API 的 Go 接口。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [golua](https://github.com/aarzilli/golua) - **star:434** Lua C 的 Go 接口。![star > 100][Bronze]   
* [gopher-lua](https://github.com/yuin/gopher-lua) - **star:2914** 用 Go 实现的 Lua 5.1 虚拟机和编译器。![star > 1000][Silver]   
...
* [otto](https://github.com/robertkrimen/otto) - **star:4662** 用 Go 编写的 JavaScript 解释器。![star > 1000][Silver]   
* [purl](https://github.com/ian-kent/purl) - **star:27** 嵌入 Go 的 Perl 5.18.2。![最近一年没有更新][Yellow]
* [tengo](https://github.com/d5/tengo) - **star:1272** 字节码编译的脚本语言。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [errors](https://github.com/pkg/errors) - **star:4747** 可让你很简单的进行错误处理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [afero](https://github.com/spf13/afero) - **star:2181** 文件系统的抽象系统。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [notify](https://github.com/rjeczalik/notify) - **star:486** 文件系统事件通知库，具有类似于os/signal的简单API，。![star > 100][Bronze]   
...
* [decimal](https://github.com/shopspring/decimal) - **star:1557** 任意精度定点的十进制数。![star > 1000][Silver]   
...
* [techan](https://github.com/sdcoffey/techan) - **star:148** 拥有先进的市场分析和交易策略的技术分析库。![star > 100][Bronze]   
...
* [nosurf](https://github.com/justinas/nosurf) - **star:959** CSRF保护中间件。![star > 100][Bronze]   

## 方法

*在Go中支持函数式编程的包。*

* [fpGo](https://github.com/TeaEntityLab/fpGo) - **star:101** 提供函数式编程功能。![star > 100][Bronze]   
* [fuego](https://github.com/seborama/fuego) - **star:33** Functional Experiment in Go。
* [go-underscore](https://github.com/tobyhede/go-underscore) - **star:1061** 常用辅助方法集合。![star > 1000][Silver]   
...
* [g3n](https://github.com/g3n/engine) - **star:730**  3D游戏引擎。![star > 100][Bronze]   
...
* [Leaf](https://github.com/name5566/leaf) - **star:3009** 轻量级游戏服务器框架。![star > 1000][Silver]   
* [nano](https://github.com/lonng/nano) - **star:966** 轻量级、方便、高性能的基于golang的游戏服务器框架。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [Pixel](https://github.com/faiface/pixel) - **star:2378** 手工制作的 2D 游戏库。![star > 1000][Silver]   
...
* [termloop](https://github.com/JoelOtter/termloop) - **star:1021** 基于终端的 Go 游戏引擎，建立在 Termbox 之上。![star > 1000][Silver]   
...
* [gen](https://github.com/clipperhouse/gen) - **star:1023** 用于生成泛型等类似方法的功能代码生成工具。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) - **star:1767** 提供类似 .NET LINQ 的查询方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [goderive](https://github.com/awalterschulze/goderive) - **star:721** 从输入类型来派生函数。![star > 100][Bronze]   
...
* [S2 geometry](https://github.com/golang/geo) - **star:875** S2 geometry 库。![star > 100][Bronze]   
* [Tile38](https://github.com/tidwall/tile38) - **star:6274** 具有空间索引和实时地理定位功能的地理定位数据库。![star > 5000][Gold]   
...
* [gopherjs](https://github.com/gopherjs/gopherjs) - **star:8453** 将 Go 编译成 JavaScript。![star > 5000][Gold]   
* [llgo](https://github.com/go-llvm/llgo) - **star:988** 基于 llvm 的编译器。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [ants](https://github.com/panjf2000/ants) - **star:1774** 一个高性能的协程池。![star > 1000][Silver]   
...
* [breaker](https://github.com/kamilsk/breaker) - **star:24** 灵活的机制，可以使执行流可中断。
...
* [goworker](https://github.com/benmanns/goworker) - **star:2222** 基于 go 的后台 worker。![star > 1000][Silver]   
...
* [workerpool](https://github.com/gammazero/workerpool) - **star:124** 限制任务执行并发数，而不是队列中的任务数量的协程池，。![star > 100][Bronze]   
...
* [app](https://github.com/murlokswarm/app) - **star:2922** 用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。![star > 1000][Silver]   
* [fyne](https://github.com/fyne-io/fyne) - **star:6068** 为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [go-astilectron](https://github.com/asticode/go-astilectron) - **star:2607** 使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。![star > 1000][Silver]   
* [go-gtk](http://mattn.github.io/go-gtk/) - 实现了 GTK 的 Go接口。
* [go-sciter](https://github.com/sciter-sdk/go-sciter) - **star:1423** 实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。![star > 1000][Silver]   
* [gotk3](https://github.com/gotk3/gotk3) - **star:743** 实现了 GTK3 的 Go接口。![star > 100][Bronze]   
* [gowd](https://github.com/dtylman/gowd) - **star:204** 跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。![star > 100][Bronze]   
* [qt](https://github.com/therecipe/qt) - **star:5862** 实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。![star > 5000][Gold]   
* [ui](https://github.com/andlabs/ui) - **star:6837** 跨平台的 Platform-native GUI 库。![star > 5000][Gold]   
* [Wails](https://wails.app) - Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。
* [walk](https://github.com/lxn/walk) - **star:3644** Windows应用程序库。![star > 1000][Silver]   
* [webview](https://github.com/zserge/webview) - **star:4536** 跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [robotgo](https://github.com/go-vgo/robotgo) - **star:4370** 实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [systray](https://github.com/getlantern/systray) - **star:762** 跨平台 Go 库，可在通知区放置图标和菜单。![star > 100][Bronze]   
...
* [bild](https://github.com/anthonynsimon/bild) - **star:2022** 纯Go语言实现的图像处理算法合集。![star > 1000][Silver]   
...
* [gg](https://github.com/fogleman/gg) - **star:1884** 纯Go语言实现的2D渲染。![star > 1000][Silver]   
* [gift](https://github.com/disintegration/gift) - **star:1204** 图像处理包。![star > 1000][Silver]   
...
* [gocv](https://github.com/hybridgroup/gocv) - **star:2378** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [image2ascii](https://github.com/qeesung/image2ascii) - **star:283** 将图像转换为ASCII码。![star > 100][Bronze]   
* [imagick](https://github.com/gographics/imagick) - **star:953**  ImageMagick下MagickWand的C API的Go binding。![star > 100][Bronze]   
* [imaginary](https://github.com/h2non/imaginary) - **star:2548** 用于图像大小调整的快速、简单的HTTP微服务。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [imaging](https://github.com/disintegration/imaging) - **star:2478** 简单的Go图像处理包。![star > 1000][Silver]   
* [img](https://github.com/hawx/img) - **star:128** 图像处理工具的集合。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [ln](https://github.com/fogleman/ln) - **star:2454** Go实现的3D线艺术（3D Line Art）渲染。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
* [pt](https://github.com/fogleman/pt) - **star:1760** Go实现的路径跟踪（path tracing）引擎。![star > 1000][Silver]   
* [resize](https://github.com/nfnt/resize) - **star:2110** Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [rez](https://github.com/bamiaux/rez) - **star:188** 纯Go语言和SIMD实现的图像大小调整。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [smartcrop](https://github.com/muesli/smartcrop) - **star:1243** 为任意图片寻找合适的位置进行图片裁剪。![star > 1000][Silver]   
...
* [flogo](https://github.com/tibcosoftware/flogo) - **star:1095** Flogo是一个面向物联网边缘应用和集成的开源框架。![star > 1000][Silver]   
...
* [mainflux](https://github.com/Mainflux/mainflux) - **star:563** 工业物联网消息和设备管理服务器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gron](https://github.com/roylee0704/gron) - **star:624** 使用简单的Go API定义基于时间的任务。 之后Gron的调度程序将运行它们。![star > 100][Bronze]   
...
* [GJSON](https://github.com/tidwall/gjson) - **star:4756** 使用一行代码获取JSON的值。![star > 1000][Silver]   
...
* [kazaam](https://github.com/Qntfy/kazaam) - **star:124** 用于任意JSON文档转换的API。![star > 100][Bronze]   
...
* [glog](https://github.com/golang/glog) - **star:2276** 为Go提供了多等级日志记录。![star > 1000][Silver]   
...
* [logrus](https://github.com/Sirupsen/logrus) - **star:11576** Go的结构化日志操作 。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [spew](https://github.com/davecgh/go-spew) - **star:3244** 为Go数据结构实现一个漂亮的printer用于帮助调试。![star > 1000][Silver]   
* [stdlog](https://github.com/alexcesaro/log) - **star:43** Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。![最近一年没有更新][Yellow]
* [tail](https://github.com/hpcloud/tail) - **star:1507** 努力模拟实现BSD的tail的特性的Go包。![star > 1000][Silver]   
...
* [zap](https://github.com/uber-go/zap) - **star:7232** 快速、结构化、多等级的日志记录。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [zerolog](https://github.com/rs/zerolog) - **star:2101** Zero-allocation JSON日志记录。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-galib](https://github.com/thoj/go-galib) - **star:170** 用Go编写的遗传算法库。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [GoLearn](https://github.com/sjwhitworth/golearn) - **star:6609** 通用机器学习库。![star > 5000][Gold]   
...
* [gorgonia](https://github.com/chewxy/gorgonia) - **star:2650** 基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。![star > 1000][Silver]   
* [gorse](https://github.com/zhenghaoz/gorse) - **star:513** 基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。![star > 100][Bronze]   
* [goscore](https://github.com/asafschers/goscore) - **star:34**  为预言模型标记语言（PMML）实现的评分API。
* [gosseract](https://github.com/otiai10/gosseract) - **star:849** 使用c++的Tesseract库实现的OCR。![star > 100][Bronze]   
...
* [onnx-go](https://github.com/owulveryck/onnx-go) - **star:144** Go Interface， 用于开放式神经网络交换(Open Neural Network Exchange)。![star > 100][Bronze]   
...
* [Benthos](https://github.com/Jeffail/benthos) - **star:1916** 一系列协议之间的消息流桥。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-socket.io](https://github.com/googollee/go-socket.io) - **star:2837** 套接字。面向golang的io库，一个实时应用程序框架。![star > 1000][Silver]   
* [go-vitotrol](https://github.com/maxatome/go-vitotrol) - **star:11** 客户端库到Viessmann Vitotrol web服务。
* [Gollum](https://github.com/trivago/gollum) - **star:762** n:m多路复用器，它收集来自不同来源的消息并将其广播到一组目的地。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gorush](https://github.com/appleboy/gorush) - **star:3648** 使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [machinery](https://github.com/RichardKnop/machinery) - **star:3318** 基于分布式消息传递的异步任务队列/作业队列。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [mangos](https://github.com/go-mangos/mangos) - **star:1533** 具有传输互操作性的Nanomsg(“可伸缩协议”)的纯go实现。![star > 1000][Silver]   
* [melody](https://github.com/olahol/melody) - **star:1522** 处理websocket会话的极简框架，包括广播和自动乒乓球处理。![star > 1000][Silver]   
* [Mercure](https://github.com/dunglas/mercure) - **star:1442** 使用Mercure协议(构建在服务器发送事件之上)分派服务器发送的更新的服务器和库。![star > 1000][Silver]   
* [messagebus](https://github.com/vardius/message-bus) - **star:62** messagebus是一种Go简单异步消息总线，非常适合在执行事件源、CQRS和DDD时用作事件总线。
* [NATS Go Client](https://github.com/nats-io/nats) - **star:2345** 轻量级和高性能的发布-订阅和分布式队列消息传递系统——这是Go库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [rabtap](https://github.com/jandelgado/rabtap) - **star:69** RabbitMQ瑞士军刀cli应用。![最近一个周有更新][Green]
...
* [sarama](https://github.com/Shopify/sarama) - **star:4503**  Go Apache Kafka的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) - **star:4322** Golang库读写Microsoft Excel™(XLSX)文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [xlsx](https://github.com/tealeg/xlsx) - **star:3288** 库，以简化在Go程序中读取Microsoft Excel最新版本使用的XML格式。![star > 1000][Silver]   
...
* [fx](https://github.com/uber-go/fx) - **star:643** 基于依赖注入的Go应用程序框架(构建在dig之上)。![star > 100][Bronze]   
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - **star:8563** Go生态系统中常见的历史和新兴的项目布局模式。![star > 5000][Gold]   
...
* [xstrings](https://github.com/huandu/xstrings) - **star:611** 从其他语言移植的有用字符串函数的集合。![star > 100][Bronze]   
...
* [captcha](https://github.com/steambap/captcha) - **star:41** 软件包captcha为captcha的生成提供了一个易于使用的、未绑定的API。![最近一个周有更新][Green]
...
* [gopsutil](https://github.com/shirou/gopsutil) - **star:3833** 用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gojieba](https://github.com/yanyiwu/gojieba) - **star:793** 这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。![star > 100][Bronze]   
...
* [gse](https://github.com/go-ego/gse) - **star:1041** 高效的文本分割;支持英语、汉语、日语等。![star > 1000][Silver]   
...
* [prose](https://github.com/jdkato/prose) - **star:2028** 用于支持标记化、词性标记、名称实体提取等文本处理的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [whatlanggo](https://github.com/abadojack/whatlanggo) - **star:343** Go的自然语言检测包。支持84种语言和24种脚本(书写系统，如拉丁语、西里尔语等)。![star > 100][Bronze]   
...
* [dns](https://github.com/miekg/dns) - **star:3731** 使用DNS的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [fasthttp](https://github.com/valyala/fasthttp) - **star:9069** 软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [ftp](https://github.com/jlaffaye/ftp) - **star:507** 包ftp实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户机。![star > 100][Bronze]   
...
* [go-getter](https://github.com/hashicorp/go-getter) - **star:701**  Go 图书馆下载文件或目录从各种来源使用一个URL。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [go-stun](https://github.com/ccding/go-stun) - **star:329** Go实现了STUN客户机(RFC 3489和RFC 5389)。![star > 100][Bronze]   
* [gobgp](https://github.com/osrg/gobgp) - **star:1653** 用 Go 编程语言实现的BGP。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gopacket](https://github.com/google/gopacket) - **star:2794** 使用libpcap绑定访问包处理库。![star > 1000][Silver]   
...
* [grab](https://github.com/cavaliercoder/grab) - **star:542**  Go 软件包管理文件下载。![star > 100][Bronze]   
...
* [kcp-go](https://github.com/xtaci/kcp-go) - **star:2208** 快速可靠的ARQ协议。![star > 1000][Silver]   
* [kcptun](https://github.com/xtaci/kcptun) - **star:10554** 非常简单和快速udp隧道基于KCP协议。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [quic-go](https://github.com/lucas-clemente/quic-go) - **star:2825** 在纯Go中实现了QUIC协议。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [tcp_server](https://github.com/firstrow/tcp_server) - **star:278**  Go 图书馆建设tcp服务器更快。![star > 100][Bronze]   
...
* [water](https://github.com/songgao/water) - **star:829** 简单TUN / TAP图书馆。![star > 100][Bronze]   
* [webrtc](https://github.com/pions/webrtc) - **star:2105** WebRTC API的纯Go实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [heimdall](https://github.com/gojektech/heimdall) - **star:1054** 具有重试和hystrix功能的增强http客户机。![star > 1000][Silver]   
...
* [gl](https://github.com/go-gl/gl) - **star:630** OpenGL的Go绑定(通过glow生成)。![star > 100][Bronze]   
* [glfw](https://github.com/go-gl/glfw) - **star:715** Go绑定用于glfw3。![star > 100][Bronze]   
...
* [go-pg](https://github.com/go-pg/pg) - **star:2896** 关注PostgreSQL的特性和性能。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-queryset](https://github.com/jirfag/go-queryset) - **star:446** 100%类型安全ORM与代码生成和MySQL, PostgreSQL, Sqlite3, SQL Server支持基于GORM。![star > 100][Bronze]   
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) - **star:223** 一个灵活而强大的SQL字符串构建器库加上一个零配置ORM。![star > 100][Bronze]   
* [go-store](https://github.com/gosuri/go-store) - **star:93** 简单而快速的Redis支持的键值存储库。![最近一年没有更新][Yellow]
* [GORM](https://github.com/jinzhu/gorm) - **star:14257** Golang出色的ORM库的目标是对开发人员友好。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [QBS](https://github.com/coocood/qbs) - **star:538** 表示结构查询。一个ORM。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [reform](https://github.com/go-reform/reform) - **star:790** 更好的ORM for Go，基于非空接口和代码生成。![star > 100][Bronze]   
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) - **star:2217** ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [upper.io/db](https://github.com/upper/db) - **star:1820** 通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Xorm](https://github.com/go-xorm/xorm) - **star:5052** 简单而强大的ORM for Go。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dep](https://github.com/golang/dep) - **star:12426**  Go 的依赖管理工具，需要 Go 1.9+![star > 5000][Gold]   
...
* [glide](https://github.com/Masterminds/glide) - **star:7737** 轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [govendor](https://github.com/kardianos/govendor) - **star:4676** 包管理器。使用 vendor 文件的 Go vendor 工具。![star > 1000][Silver]   
...
* [graphql](https://github.com/neelance/graphql-go) - **star:2718** 关注易用性的GraphQL服务器。![star > 1000][Silver]   
* [graphql-go](https://github.com/graphql-go/graphql) - **star:5078** 为Go实现GraphQL。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [packr](https://github.com/gobuffalo/packr) - **star:2036** 将静态文件嵌入到Go二进制文件中的简单方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [statics](https://github.com/go-playground/statics) - **star:53** 将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。![最近一年没有更新][Yellow]
* [statik](https://github.com/rakyll/statik) - **star:2047** 将静态文件嵌入到Go可执行文件中。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [chart](https://github.com/vdobler/chart) - **star:575** 简单的图表绘制库。支持多种图形类型。![star > 100][Bronze]   
...
* [gonum](https://github.com/gonum/gonum) - **star:2872** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gonum/plot](https://github.com/gonum/plot) - **star:1190** gonum/plot提供了一个API，用于在Go中构建和绘制绘图。![star > 1000][Silver]   
...
* [orb](https://github.com/paulmach/orb) - **star:189** 2D几何类型，支持剪切、GeoJSON和Mapbox矢量平铺。![star > 100][Bronze]   
...
* [Cameradar](https://github.com/Ullaakut/cameradar) - **star:1787** 工具和库，以远程入侵RTSP流从监控摄像头。![star > 1000][Silver]   
...
* [lego](https://github.com/xenolf/lego) - **star:3430** 纯 Go ACME 客户端库及命令行工具![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [secure](https://github.com/unrolled/secure) - **star:1188** Go 语言 HTTP 中间件，为 Go 提供了一些安全功能![star > 1000][Silver]   
...
* [go-codec](https://github.com/ugorji/go) - **star:1214** 高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) - **star:2852** Go 语言的 Protocol Buffer 库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [goprotobuf](https://github.com/golang/protobuf) - **star:4906** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.![star > 1000][Silver]   ![最近一个周有更新][Green]
* [jsoniter](https://github.com/json-iterator/go) - **star:5319** 高性能，100% 兼容的“encoding/json” 替代品![star > 5000][Gold]   ![最近一个周有更新][Green]
* [mapstructure](https://github.com/mitchellh/mapstructure) - **star:2338** 用于对原生键值对进行解码生成 Go 语言结构体![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [algernon](https://github.com/xyproto/algernon) - **star:1576** 内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。![star > 1000][Silver]   
* [Caddy](https://github.com/mholt/caddy) - **star:22722** Caddy是另一种HTTP/2 web服务器，易于配置和使用。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [consul](https://www.consul.io/) - Consul 是一个用于服务发现、监控和配置的工具
* [devd](https://github.com/cortesi/devd) - **star:2785** 为开发人员提供本地web服务器。![star > 1000][Silver]   
* [discovery](https://github.com/Bilibili/discovery) - **star:634** 用于弹性中间层负载平衡和故障转移的注册表。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [etcd](https://github.com/coreos/etcd) - **star:25871** 为共享配置和服务发现提供高可用的键值存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Fider](https://github.com/getfider/fider) - **star:780** Fider是一个收集和组织客户反馈的开放平台。![star > 100][Bronze]   
* [Flagr](https://github.com/checkr/flagr) - **star:796** Flagr是一个开源特性标记和A/B测试服务。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [flipt](https://github.com/markphelps/flipt) - **star:979** 一个用Go和Vue.js编写的自包含特性标志解决方案![star > 100][Bronze]   ![最近一个周有更新][Green]
* [jackal](https://github.com/ortuman/jackal) - **star:708** 用Go编写的XMPP服务器。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [minio](https://github.com/minio/minio) - **star:16915** Minio是一个分布式对象存储服务器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gofpdf](https://github.com/jung-kurt/gofpdf) - **star:3020** PDF 文档生成器，支持文本，绘图和图片![star > 1000][Silver]   ![最近一个周有更新][Green]
* [goview](https://github.com/foolin/goview) - **star:40** Goview是一个轻量级、极简的模板库，基于golang html/template构建Go web应用程序。
* [hero](https://github.com/shiyanhui/hero) - **star:1191** Hero是一个方便、快速和强大的go模板引擎。![star > 1000][Silver]   
...
* [mustache](https://github.com/hoisie/mustache) - **star:966** Go 语言实现的 Mustache 模板语言![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [pongo2](https://github.com/flosch/pongo2) - **star:1482** 类似 DjanGo 的模板引擎![star > 1000][Silver]   ![最近一个周有更新][Green]
* [quicktemplate](https://github.com/valyala/quicktemplate) - **star:1369** 快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译![star > 1000][Silver]   ![最近一个周有更新][Green]
* [raymond](https://github.com/aymerick/raymond) - **star:337** 使用 Go 语言实现的完整的 handlebars![star > 100][Bronze]   
* [Razor](https://github.com/sipin/gorazor) - **star:687** Go 语言的 Razor 视图引擎![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* Testing Frameworks
    ...
    * [baloo](https://github.com/h2non/baloo) - **star:636** 表达性强、多功能的、端到端的HTTP API 测试工具![star > 100][Bronze]   
    ...
    * [endly](https://github.com/viant/endly) - **star:85** 声明性端到端功能测试。
    ...
    * [go-cmp](https://github.com/google/go-cmp) - **star:1099** 用于比较测试中的Go值的包。![star > 1000][Silver]   
    ...
    * [godog](https://github.com/DATA-DOG/godog) - **star:727** 类似 Cucumber 或 Behat 的 BDD 框架![star > 100][Bronze]   
    ...
    * [httpexpect](https://github.com/gavv/httpexpect) - **star:1108** 简洁的、声明式的、易用的端到端HTTP 及 REST API 测试![star > 1000][Silver]   
    ...
    * [Testify](https://github.com/stretchr/testify) - **star:7865** 对标准测试包的扩展。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* Mock
    ...
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - **star:1646** Mock SQL ，用于测试数据库交互![star > 1000][Silver]   
    * [go-txdb](https://github.com/DATA-DOG/go-txdb) - **star:154** 基于单事务的数据库驱动，主要用于测试目的![star > 100][Bronze]   ![最近一个周有更新][Green]
    * [gock](https://github.com/h2non/gock) - **star:789** 多功能、易用 HTTP mock![star > 100][Bronze]   ![最近一个周有更新][Green]
    * [gomock](https://github.com/golang/mock) - **star:2691** 用于Go编程语言的mock框架。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [govcr](https://github.com/seborama/govcr) - **star:78** HTTP mock : 离线测试时记录和重放浏览器的动作
    * [hoverfly](https://github.com/SpectoLabs/hoverfly) - **star:1417** 使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* Fuzzing and delta-debugging/reducing/shrinking.
    ...
    * [gofuzz](https://github.com/google/gofuzz) - **star:522** 用于生成随机值来初始化 Go 语言对象的库![star > 100][Bronze]   
    * [Tavor](https://github.com/zimmski/tavor) - **star:208** 通用模糊测试框架![star > 100][Bronze]   

* Selenium and browser control tools.
    * [cdp](https://github.com/mafredri/cdp) - **star:345** 用于Chrome调试协议的类型安全绑定，可与实现该协议的浏览器或其他调试目标一起使用。![star > 100][Bronze]   
    * [chromedp](https://github.com/knq/chromedp) - **star:3416** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [ggr](https://github.com/aerokube/ggr) - **star:208** 一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs![star > 100][Bronze]   
    * [selenoid](https://github.com/aerokube/selenoid) - **star:1185** Selenium hub 服务器的替代品，在容器中启动浏览器![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* Specific Formats
    ...
    * [blackfriday](https://github.com/russross/blackfriday) - **star:3810** Markdown 解析器![star > 1000][Silver]   
    ...
    * [colly](https://github.com/asciimoo/colly) - **star:8116** 快速和优雅的 Scraping 框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
    ...
    * [go-humanize](https://github.com/dustin/go-humanize) - **star:1856** 格式化程序，用于将时间、数字和内存大小转换为可读格式。![star > 1000][Silver]   
    ...
    * [gofeed](https://github.com/mmcdole/gofeed) - **star:1083** 在Go中解析RSS和Atom feeds。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [GoQuery](https://github.com/PuerkitoBio/goquery) - **star:7446** GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能![star > 5000][Gold]   
    * [goregen](https://github.com/zach-klippenstein/goregen) - **star:35** 根据正则表达式生成随机字符串![最近一年没有更新][Yellow]
    * [gotext](https://github.com/leonelquinteros/gotext) - **star:229** GNU gettext 工具![star > 100][Bronze]   
    ...
    * [sh](https://github.com/mvdan/sh) - **star:1927** Shell解析器和格式化工具。![star > 1000][Silver]   
    ...
    * [toml](https://github.com/BurntSushi/toml) - **star:2724** TOML配置格式(带反射的编码器/解码器)。![star > 1000][Silver]   
* Utility
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - **star:4940** AWS 提供的官方go语言 SDK![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [discordgo](https://github.com/bwmarrin/discordgo) - **star:939**  Discord Chat API的客户端。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [github](https://github.com/google/go-github) - **star:4693** 访问GitHub REST API v3的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-jira](https://github.com/andygrunwald/go-jira) - **star:553**  Go [Atlassian JIRA]的客户端库(https://www.atlassian.com/software/jira)![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [google](https://github.com/google/google-api-go-client) - **star:1898** 为Go自动生成谷歌api。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [google-analytics](https://github.com/chonthu/go-google-analytics) - **star:12** 简单的包装，方便的谷歌分析报告。![最近一年没有更新][Yellow]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - **star:1740** 谷歌云api Go 客户端库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [stripe](https://github.com/stripe/stripe-go) - **star:918**  Stripe API 的 Go 语言客户端![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [webhooks](https://github.com/go-playground/webhooks) - **star:338** GitHub 和 Bitbucket 的Webhook接收器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [boilr](https://github.com/tmrts/boilr) - **star:924** 非常快的CLI工具，用于从样板模板创建项目。![star > 100][Bronze]   
* [chyle](https://github.com/antham/chyle) - **star:107** 使用具有多种配置可能性的git存储库生成变更日志。![star > 100][Bronze]   
...
* [clockwork](https://github.com/jonboulle/clockwork) - **star:216** 一个简单的假 clock 。![star > 100][Bronze]   
...
* [ctop](https://github.com/bcicen/ctop) - **star:8670** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。![star > 5000][Gold]   
...
* [Deepcopier](https://github.com/ulule/deepcopier) - **star:203** 结构体拷贝![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [delve](https://github.com/derekparker/delve) - **star:11764** Go 语言调试器![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [filetype](https://github.com/h2non/filetype) - **star:928** 通过数字签名来推测文件类型。![star > 100][Bronze]   
...
* [fzf](https://github.com/junegunn/fzf) - **star:22567** 用Go编写的命令行模糊查找器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-funk](https://github.com/thoas/go-funk) - **star:1109** 现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)![star > 1000][Silver]   
...
* [go-torch](https://github.com/uber/go-torch) - **star:3624** 为 Go 语言程序生成火焰图。![star > 1000][Silver]   
...
* [godropbox](https://github.com/dropbox/godropbox) - **star:3733** 用于编写 Go 语言服务／应用的库，来自 Dropbox.。![star > 1000][Silver]   
...
* [goreleaser](https://github.com/goreleaser/goreleaser) - **star:4404** 尽可能快速的发布 Go 语言二进制文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [hub](https://github.com/github/hub) - **star:16702** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hystrix-go](https://github.com/afex/hystrix-go) - **star:1954** 实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。![star > 1000][Silver]   
...
* [mc](https://github.com/minio/mc) - **star:1076** Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [mergo](https://github.com/imdario/mergo) - **star:827** 用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) - **star:101** 用于基于神奇数字的MIME类型检测的包。![star > 100][Bronze]   
* [minify](https://github.com/tdewolff/minify) - **star:1839** 用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。![star > 1000][Silver]   
...
* [mole](https://github.com/davrodpin/mole) - **star:1296** cli应用程序可以轻松创建ssh隧道。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [panicparse](https://github.com/maruel/panicparse) - **star:2080** 将类似的协程分组并对调用栈进行着色![star > 1000][Silver]   
* [peco](https://github.com/peco/peco) - **star:5410** 简单的交互过滤工具。![star > 5000][Gold]   
...
* [profile](https://github.com/pkg/profile) - **star:985** Go的简单分析支持包。![star > 100][Bronze]   
* [rclient](https://github.com/zpatrick/rclient) - **star:27** 可读、灵活、易于使用的REST api客户端。
* [realize](https://github.com/tockins/realize) - **star:3099** Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。![star > 1000][Silver]   
...
* [resty](https://github.com/go-resty/resty) - **star:1822** 简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。![star > 1000][Silver]   
...
* [sqlx](https://github.com/jmoiron/sqlx) - **star:6614** 为内建的数据库/sql 软件包提供一组扩展。![star > 5000][Gold]   
...
* [Task](https://github.com/go-task/task) - **star:1865** 简单的“Go”的选择。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [toolbox](https://github.com/viant/toolbox) - **star:87** 切片, map, multimap, 结构体, 函数,数据转换工具。服务路由，宏求值和标记器。
* [tracer](https://github.com/kamilsk/tracer) - **star:4** 简单、轻量级的跟踪。
...
* [wuzz](https://github.com/asciimoo/wuzz) - **star:8229** 用于HTTP检查的交互式cli工具。![star > 5000][Gold]   
...
* [uuid](https://github.com/gofrs/uuid) - **star:554** 通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。![star > 100][Bronze]   
...
* [govalidator](https://github.com/asaskevich/govalidator) - **star:3500** 用于字符串，数字，切片和结构的验证器和sanitizers。![star > 1000][Silver]   
...
* [validator](https://github.com/go-playground/validator) - **star:3345**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [git2go](https://github.com/libgit2/git2go) - **star:1345**  libgit2 的 Go 语言接口。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-git](https://github.com/src-d/go-git) - **star:4126** 纯Go中高度可扩展的Git实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gmf](https://github.com/3d0c/gmf) - **star:512**  FFmpeg av\* 库的 Go 语言接口。![star > 100][Bronze]   
...
* [go-astits](https://github.com/asticode/go-astits) - **star:257** 在GO中解析和演示MPEG传输流(.ts)。![star > 100][Bronze]   
...
* [Air](https://github.com/aofei/air) - **star:515** 一个理想的精细化的Go web框架。![star > 100][Bronze]   
* [Banjo](https://github.com/nsheremet/banjo) - **star:7** 非常简单和快速的网络框架 Go 。![最近一年没有更新][Yellow]
* [Beego](https://github.com/astaxie/beego) - **star:21104** beego是一种用于 Go 编程语言的开源高性能web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Buffalo](http://gobuffalo.io) - 为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) - **star:14421** 高性能、极简的Go web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Gin](https://github.com/gin-gonic/gin) - **star:28959** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Gizmo](https://github.com/NYTimes/gizmo) - **star:2817** 《纽约时报》使用的微服务工具包。![star > 1000][Silver]   
* [go-json-rest](https://github.com/ant0ine/go-json-rest) - **star:3316** 设置RESTful JSON API的快速简便方法。![star > 1000][Silver]   
* [go-rest](https://github.com/ungerik/go-rest) - **star:115** 小型的 REST 框架。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [Goa](https://github.com/goadesign/goa) - **star:3464** Goa为在Go中开发远程api和微服务提供了一种全面的方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [hiboot](https://github.com/hidevopsio/hiboot) - **star:83** hiboot是一个高性能的web应用程序框架，支持自动配置和依赖注入。![最近一个周有更新][Green]
* [Macaron](https://github.com/go-macaron/macaron) - **star:2781** Macaron 是一个高效的模块化设计的web框架![star > 1000][Silver]   
...
* [patron](https://github.com/beatlabs/patron) - **star:28** Patron是一个遵循最佳云实践的微服务框架，专注于提升开发效率。![最近一个周有更新][Green]
...
* [Revel](https://github.com/revel/revel) - **star:11190** 用于Go语言的高效web框架。![star > 5000][Gold]   
...
* [CORS](https://github.com/rs/cors) - **star:1181** 轻松地向API添加CORS功能。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Limiter](https://github.com/ulule/limiter) - **star:769** 简单的速度限制中间件。![star > 100][Bronze]   
* [ln-paywall](https://github.com/philippgille/ln-paywall) - **star:86** 使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。
* [Tollbooth](https://github.com/didip/tollbooth) - **star:1220** 限制速率的 HTTP 请求处理程序。![star > 1000][Silver]   
...
* [muxchain](https://github.com/stephens2424/muxchain) - **star:207** 用于net/http的轻量级中间件。![star > 100][Bronze]   
...
* [chi](https://github.com/go-chi/chi) - **star:5895** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。![star > 5000][Gold]   
...
* [gocraft/web](https://github.com/gocraft/web) - **star:1391** Mux和中间件包在Go中。![star > 1000][Silver]   
...
* [httprouter](https://github.com/julienschmidt/httprouter) - **star:9522** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。![star > 5000][Gold]   
...
* [mux](https://github.com/gorilla/mux) - **star:9451** 强大的URL路由器和调度器为golang。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-ole](https://github.com/go-ole/go-ole) - **star:543** 为 Go 语言实现的 Win32 OLE。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [dupl](https://github.com/mibk/dupl) - **star:166** 用于代码克隆检测的工具。![star > 100][Bronze]   
* [errcheck](https://github.com/kisielk/errcheck) - **star:1311** Errcheck是一个用于检查Go程序中未检查错误的程序。![star > 1000][Silver]   
...
* [go-critic](https://github.com/go-critic/go-critic) - **star:555** 源代码检查工具。![star > 100][Bronze]   
...
* [GoLint](https://github.com/golang/lint) - **star:3111** Go 源码的 linter。![star > 1000][Silver]   
...
* [go-mode](https://github.com/dominikh/go-mode.el) - **star:941** 在 GNU/Emacs 支持 GO。![star > 100][Bronze]   
* [go-plus](https://github.com/joefitzgerald/go-plus) - **star:1480** 在 Atom 中添加自动完成，格式化，语法检查，高亮和审查。![star > 1000][Silver]   
* [gocode](https://github.com/nsf/gocode) - **star:4715** Autocompletion daemon for the Go programming language.![star > 1000][Silver]   
* [goprofiling](https://marketplace.visualstudio.com/items?itemName=MaxMedia.go-prof) - 在 VS Code 中支持 Go 的基准分析。
* [GoSublime](https://github.com/DisposaBoy/GoSublime) - **star:3221** 包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [vim-go](https://github.com/fatih/vim-go) - **star:10701** Go 开发会用到的 Vim 插件。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) - **star:5042** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [genny](https://github.com/cheekybits/genny) - **star:926** 优雅的 Go 泛型。![star > 100][Bronze]   
...
* [gotests](https://github.com/cweill/gotests) - **star:2137** 从源代码生成测试用例。![star > 1000][Silver]   
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **star:1940** 使用 dot format 可视化 Go 程序的调用图。![star > 1000][Silver]   
* [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) - **star:37** Bash completion for go and wgo。![最近一年没有更新][Yellow]
* [go-swagger](https://github.com/go-swagger/go-swagger) - **star:3858** 基于 Go 的Swagger 2.0实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [godbg](https://github.com/tylerwince/godbg) - **star:157** 实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。![star > 100][Bronze]   
* [OctoLinker](https://github.com/OctoLinker/browser-extension) - **star:3697** 借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [aurora](https://github.com/xuri/aurora) - **star:391** 基于web的跨平台 Beanstalkd 队列服务器控制台。![star > 100][Bronze]   
...
* [fac](https://github.com/mkchoi212/fac) - **star:1599** 修复 git 合并冲突。![star > 1000][Silver]   
* [gaia](https://github.com/gaia-pipeline/gaia) - **star:3706** 可用于任何编程语言来构建强大的管道。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Gitea](https://github.com/go-gitea/gitea) - **star:14714** 从 Gogs fork，完全由社区驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gox](https://github.com/mitchellh/gox) - **star:3328** 非常简单，没有多余的跨平台编译工具。![star > 1000][Silver]   
* [goxc](https://github.com/laher/goxc) - **star:1628** 专注于跨平台编译和打包的 Go 构建工具。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [grapes](https://github.com/yaronsumel/grapes) - **star:135** 旨在轻松地通过ssh分发命令的轻量级工具。![star > 100][Bronze]   
* [GVM](https://github.com/moovweb/gvm) - **star:4421** GVM 提供了一个接口来管理 Go 版本。![star > 1000][Silver]   
* [Hey](https://github.com/rakyll/hey) - **star:6098** 压力测试工具，可用来代替 ApacheBench (ab)。![star > 5000][Gold]   
* [kala](https://github.com/ajvb/kala) - **star:1347** 简单、现代和高性能的作业调度程序。![star > 1000][Silver]   
* [kcli](https://github.com/cswank/kcli) - **star:73** 用于检查kafka主题/分区/消息的命令行工具。
* [kubernetes](https://github.com/kubernetes/kubernetes) - **star:55080** 来自谷歌的容器集群管理器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Moby](https://github.com/moby/moby) - **star:54050** Collaborative project for the container ecosystem to assemble container-based systems.![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [s3gof3r](https://github.com/rlmcpherson/s3gof3r) - **star:986** 小型实用程序/库，针对大型对象在Amazon S3中的高速传输进行了优化。![star > 100][Bronze]   
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) - **star:534** 从命令行管理 BareMetal 服务器(与使用Docker一样容易)。![star > 100][Bronze]   
* [script](https://github.com/bitfield/script) - **star:708** 让DevOps编写类shell和系统管理任务变得更加容易。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [StatusOK](https://github.com/sanathp/statusok) - **star:1151** 监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。![star > 1000][Silver]   
* [traefik](https://github.com/containous/traefik) - **star:23253** 反向代理和负载均衡器，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Vegeta](https://github.com/tsenart/vegeta) - **star:11928** HTTP负载测试工具和库。超过9000 !![star > 5000][Gold]   
* [webhook](https://github.com/adnanh/webhook) - **star:4001** 允许用户创建在服务器上执行命令的 HTTP hooks。![star > 1000][Silver]   
...
* [Comcast](https://github.com/tylertreat/Comcast) - **star:6143** 模拟坏的网络连接。![star > 5000][Gold]   
* [confd](https://github.com/kelseyhightower/confd) - **star:6337** 使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。![star > 5000][Gold]   
* [DDNS](https://github.com/skibish/ddns) - **star:97** 个人 DDNS 客户端。
* [Docker](http://www.docker.com/) - 面向开发人员和系统管理员的分布式应用程序的开放平台。
* [Documize](https://github.com/documize/community) - **star:800** 集成了SaaS工具数据的现代wiki软件。![star > 100][Bronze]   
* [drive](https://github.com/odeke-em/drive) - **star:4926** 基于命令行的谷歌驱动器客户端。![star > 1000][Silver]   
* [Duplicacy](https://github.com/gilbertchen/duplicacy) - **star:2667** 跨平台网络和云备份工具。![star > 1000][Silver]   
...
* [GoBoy](https://github.com/Humpheh/goboy) - **star:2097** 用 Go 编写的任天堂Game Boy彩色模拟器。![star > 1000][Silver]   
* [gocc](https://github.com/goccmack/gocc) - **star:340** Gocc是一个用Go编写的编译器工具包。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [GoDNS](https://github.com/timothyye/godns) - **star:418** 一个动态DNS客户端工具，支持DNSPod & HE.net。![star > 100][Bronze]   
...
* [Gor](https://github.com/buger/gor) - **star:11223** Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。![star > 5000][Gold]   
...
* [lgo](https://github.com/yunabe/lgo) - **star:1769** 与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [limetext](http://limetext.org/) - 一个强大而优雅的文本编辑器。
* [LiteIDE](https://github.com/visualfc/liteide) - **star:5428** 简单的、开源的、跨平台的Go IDE。![star > 5000][Gold]   
...
* [myLG](https://github.com/mehrdadrad/mylg) - **star:2189** 命令行网络诊断工具。![star > 1000][Silver]   
* [naclpipe](https://github.com/unix4fun/naclpipe) - **star:20** 基于加密管的简单的NaCL EC25519工具。
* [nes](https://github.com/fogleman/nes) - **star:4108** 任天堂娱乐系统(NES)模拟器。![star > 1000][Silver]   
...
* [Pipe](https://github.com/b3log/pipe) - **star:2647** 一个小巧漂亮的博客平台。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [restic](https://github.com/restic/restic) - **star:7267** 消除重复项备份程序。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [rkt](https://github.com/coreos/rkt) - **star:8706** 一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。![star > 5000][Gold]   
* [scc](https://github.com/boyter/scc) - **star:761** 一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - **star:8072** 快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Stack Up](https://github.com/pressly/sup) - **star:1982** Stack Up 是一个超级简单的部署工具 — 只面向Unix。![star > 1000][Silver]   
* [syncthing](https://syncthing.net/) - 开放，分散的文件同步工具和协议。
* [term-quiz](https://github.com/crazcalm/term-quiz) - **star:17** 测试你的终端。
* [toxiproxy](https://github.com/shopify/toxiproxy) - **star:3786** 为自动化测试模拟网络和系统条件的代理。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [tsuru](https://tsuru.io/) - Extensible and open source Platform as a Service software.
* [vFlow](https://github.com/VerizonDigital/vflow) - **star:588** 高性能、可伸缩和可靠的 IPFIX、sFlow和 Netflow 收集器。![star > 100][Bronze]   
...
* [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) - **star:978** web框架基准测试。![star > 100][Bronze]   
* [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) - **star:844** Go序列化方法的基准测试。![star > 100][Bronze]   
...
* [GoBooks](https://github.com/dariubs/GoBooks) - **star:6703** 一份精选的 Go 书籍清单。![star > 5000][Gold]   
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) - **star:1469** 由 Maria Letta 提供的与 Gopher 有关的图片包，其中包含了插图,表情文字。![star > 1000][Silver]   
...
* [gophers](https://github.com/ashleymcnamara/gophers) - **star:1818** 阿什莉·麦克纳马拉的歌斐艺术品。![star > 1000][Silver]   
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - **star:14406** Curated list of awesome remote jobs. A lot of them are looking for Go hackers.![star > 5000][Gold]   ![最近一个周有更新][Green]
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - **star:24518** 其他 awesome 系列的列表。![star > 5000][Gold]   
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - **star:31040** Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Ethereum Development with Go](https://github.com/miguelmota/ethereum-development-with-go-book) - **star:441** 一本讲述如何用 Go 进行以太开发的小册。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Games With Go](http://gameswithgo.org/) - 关于编程和游戏开发系列教学视频。
* [Go By Example](https://gobyexample.com/) - 手把手教你 如何在 Go 应用程序中使用注释。
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - **star:3978**  Go's reference card。![star > 1000][Silver]   
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - **star:4025** 学习使用测试驱动开发。![star > 1000][Silver]   ![最近一个周有更新][Green]
