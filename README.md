...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-09 09:25:27(每隔1天同步一次)**
...
* [Oto](https://github.com/hajimehoshi/oto) - **star:417** 多平台的 low-level 声音播放库。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [PortAudio](https://github.com/gordonklaus/portaudio) - **star:295** 基于 Go 的PortAudio audio I/O库。![star > 100][Bronze]   
* [portmidi](https://github.com/rakyll/portmidi) - **star:202** PortMidi的 Go 语言实现接口。。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [authboss](https://github.com/volatiletech/authboss) - **star:1900** web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。![star > 1000][Silver]   
* [branca](https://github.com/hako/branca) - **star:69** 基于 Go 实现Branca令牌。
* [casbin](https://github.com/hsluoyz/casbin) - **star:4732** 支持ACL、RBAC、ABAC等访问控制模型的授权库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [cookiestxt](https://github.com/mengzhuo/cookiestxt) - **star:2** 提供cookie .txt文件格式的解析器。![最近一年没有更新][Yellow]
* [go-jose](https://github.com/square/go-jose) - **star:1094** 相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。![star > 1000][Silver]   
...
* [gologin](https://github.com/dghubble/gologin) - **star:1032** 用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。![star > 1000][Silver]   
* [gorbac](https://github.com/mikespook/gorbac) - **star:896** 轻量级的基于角色的访问控制(RBAC)实现。![star > 100][Bronze]   
* [goth](https://github.com/markbates/goth) - **star:2225** 提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。![star > 1000][Silver]   
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) - **star:5764** JSON Web令牌(JWT)。![star > 5000][Gold]   
* [loginsrv](https://github.com/tarent/loginsrv) - **star:797** JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。![star > 100][Bronze]   
* [oauth2](https://github.com/golang/oauth2) - **star:2333** goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [osin](https://github.com/openshift/osin) - **star:1536** OAuth2服务器库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [scs](https://github.com/alexedwards/scs) - **star:517** HTTP服务器的会话管理器。![star > 100][Bronze]   
...
* [go-chat-bot](https://github.com/go-chat-bot/bot) - **star:459** 用 Go 编写的IRC, Slack和电报机器人。![star > 100][Bronze]   
...
* [Kelp](https://github.com/stellar/kelp) - **star:150** 官方交易和做市机器人为[Stellar](https://www.stellar.org/) DEX。开箱即用的作品，用 Golang 编写，兼容集中交易和定制交易策略。![star > 100][Bronze]   
...
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - **star:1575** 简单轻量级的Telegram bot客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [cobra](https://github.com/spf13/cobra) - **star:12643** 现代Go CLI命令行交互工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [commandeer](https://github.com/jaffee/commandeer) - **star:80** 开发友好的CLI应用程序。
...
* [kingpin](https://github.com/alecthomas/kingpin) - **star:2500** 支持子命令的命令行和标志解析器。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [liner](https://github.com/peterh/liner) - **star:572** 类似readline-like的命令行接口库。![star > 100][Bronze]   
* [mitchellh/cli](https://github.com/mitchellh/cli) - **star:988** 用于实现命令行接口的Go库。![star > 100][Bronze]   
...
* [urfave/cli](https://github.com/urfave/cli) - **star:11106** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。![star > 5000][Gold]   
...
* [aurora](https://github.com/logrusorgru/aurora) - **star:605** 支持fmt.Printf/Sprintf的ANSI终端颜色。![star > 100][Bronze]   
...
* [color](https://github.com/fatih/color) - **star:2983** 多功能包装，彩色终端输出。![star > 1000][Silver]   
...
* [go-isatty](https://github.com/mattn/go-isatty) - **star:338** Go 实现的 isatty。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [go-prompt](https://github.com/c-bata/go-prompt) - **star:2273** 构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit)![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gocui](https://github.com/jroimartin/gocui) - **star:5015** 旨在创建控制台用户界面的极简Go库。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [progressbar](https://github.com/schollz/progressbar) - **star:551** 基本线程安全的进度条，在每个操作系统工作。![star > 100][Bronze]   
* [simpletable](https://github.com/alexeyco/simpletable) - **star:154** 可在终端显示简易表格。![star > 100][Bronze]   
* [tabby](https://github.com/cheynewallace/tabby) - **star:245** 一个可在终端生成一个极简Golang表格轻量级库![star > 100][Bronze]   
...
* [termdash](https://github.com/mum4k/termdash) - **star:780** 此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。![star > 100][Bronze]   
...
* [termui](https://github.com/gizak/termui) - **star:8819** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。![star > 5000][Gold]   
* [uilive](https://github.com/gosuri/uilive) - **star:818** 用于实时更新终端输出的库。![star > 100][Bronze]   
...
* [env](https://github.com/caarlos0/env) - **star:836** 解析环境变量并赋值到struct中(默认值)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [godotenv](https://github.com/joho/godotenv) - **star:2061** Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。![star > 1000][Silver]   
...
* [harvester](https://github.com/beatlabs/harvester) - **star:29** 一个易于使用的静态和动态配置包![最近一个周有更新][Green]
...
* [ini](https://github.com/go-ini/ini) - **star:1532**  读和写INI文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) - **star:2358** 管理来自环境变量的配置数据。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [viper](https://github.com/spf13/viper) - **star:9025** 配置管理。![star > 5000][Gold]   
...
* [drone](https://github.com/drone/drone) - **star:18731** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [boomfilters](https://github.com/tylertreat/BoomFilters) - **star:1125** 用于处理连续的概率数据结构。![star > 1000][Silver]   
...
* [go-datastructures](https://github.com/Workiva/go-datastructures) - **star:5063** 可靠的、高性能的和线程安全的数据结构的集合。![star > 5000][Gold]   
...
* [gods](https://github.com/emirpasic/gods) - **star:6094** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。![star > 5000][Gold]   
* [golang-set](https://github.com/deckarep/golang-set) - **star:1127** 线程安全和非线程安全的高性能集。![star > 1000][Silver]   
...
* [gota](https://github.com/kniren/gota) - **star:852** 实现了数据帧，序列以及数据噪音。![star > 100][Bronze]   
...
* [willf/bloom](https://github.com/willf/bloom) - **star:648** 实现Bloom过滤器。![star > 100][Bronze]   

## 数据库

*数据库。*

* [badger](https://github.com/dgraph-io/badger) - **star:6133** 快速 K/V 存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [bcache](https://github.com/iwanbk/bcache) - **star:26** 基于内存的最终一致的分布式缓存。
* [BigCache](https://github.com/allegro/bigcache) - **star:2396** 高效的键/值缓存为千兆字节的数据。![star > 1000][Silver]   
...
* [cache](https://github.com/akyoto/cache) - **star:11** 基于内存的 K/V 存储:带生命周期的值存储，0个依赖项，<100 LoC, 100%覆盖率。
* [cache2go](https://github.com/muesli/cache2go) - **star:976** 基于内存的 K/V 缓存，支持超时的自动失效。![star > 100][Bronze]   
* [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache) - **star:29** BigCache 支持集群和独立且生命周期存储项。![最近一年没有更新][Yellow]
* [cockroach](https://github.com/cockroachdb/cockroach) - **star:16586** 可伸缩、区域备份、事务性数据存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dgraph](https://github.com/dgraph-io/dgraph) - **star:9951** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [diskv](https://github.com/peterbourgon/diskv) - **star:739** 支持磁盘备份的可持久化 K/V 存储。![star > 100][Bronze]   
...
* [GCache](https://github.com/bluele/gcache) - **star:866** 支持过期缓存、LFU、LRU和ARC的缓存库。![star > 100][Bronze]   
* [go-cache](https://github.com/pmylund/go-cache) - **star:2804** 基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。![star > 1000][Silver]   
* [goleveldb](https://github.com/syndtr/goleveldb) - **star:3110** 在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gorocksdb](https://github.com/kapitan-k/gorocksdb) - **star:8** 用 Go 对[RocksDB](https://rocksdb.org)实现了封装。![最近一年没有更新][Yellow]
* [groupcache](https://github.com/golang/groupcache) - **star:7561** Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [influxdb](https://github.com/influxdb/influxdb) - **star:16742** 可伸缩的数据存储，用于指标衡量、事件和实时分析。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [prometheus](https://github.com/prometheus/prometheus) - **star:24991** 用于监控系统和时序的数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [pudge](https://github.com/recoilme/pudge) - **star:217** 使用Go的标准库编写的快速和简单的键/值存储。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [rqlite](https://github.com/rqlite/rqlite) - **star:4643** 基于SQLite的轻量级分布式关系数据库。![star > 1000][Silver]   
...
* [tidb](https://github.com/pingcap/tidb) - **star:19594** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [tiedot](https://github.com/HouzuoGuo/tiedot) - **star:2355** 属于你的NoSQL数据库。![star > 1000][Silver]   
* [Vasto](https://github.com/chrislusf/vasto) - **star:143** 分布式高性能键值存储。可做磁盘备份。最终一致。高可用。能够在不中断服务的情况下增长或收缩。![star > 100][Bronze]   
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - **star:891** 开源，快速，可伸缩的时间序列数据库。支持PromQL。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [migrate](https://github.com/golang-migrate/migrate) - **star:2458** 基于CLI的数据库迁移库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [migrator](https://github.com/lopezator/migrator) - **star:28** 非常简单的 Go 数据库迁移库。
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) - **star:1378** 数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。![star > 1000][Silver]   
...
* [go-mysql](https://github.com/siddontang/go-mysql) - **star:1808**  Go 工具集，用于处理MySQL协议和复制。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) - **star:2293** 自动将MySQL数据同步到Elasticsearch中。![star > 1000][Silver]   
* [kingshard](https://github.com/flike/kingshard) - **star:4533** kingshard 是基于 Golang 的MySQL高性能代理。![star > 1000][Silver]   
* [myreplication](https://github.com/2tvenom/myreplication) - **star:142** MySql二进制日志复制监听器。支持基于语句和行的复制。![star > 100][Bronze]   
* [octillery](https://github.com/knocknote/octillery) - **star:47** 用于数据库分表(支持每个ORM或原生SQL)。
* [orchestrator](https://github.com/github/orchestrator) - **star:2964** MySQL复制拓扑管理器和可视化工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [pgweb](https://github.com/sosedoff/pgweb) - **star:5943** 基于web的PostgreSQL数据库浏览器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [vitess](https://github.com/youtube/vitess) - **star:8299** vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gendry](https://github.com/didi/gendry) - **star:724** 非入侵的SQL构建器和强大的数据绑定器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [Squirrel](https://github.com/Masterminds/squirrel) - **star:2200** 帮助您构建SQL查询的Go库。![star > 1000][Silver]   
* [xo](https://github.com/knq/xo) - **star:2121** 基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。![star > 1000][Silver]   
...
* Relational Databases
    ...
    * [go-mssqldb](https://github.com/denisenkom/go-mssqldb) - **star:1000** 微软MSSQL驱动程序。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [go-oci8](https://github.com/mattn/go-oci8) - **star:398** Oracle 驱动程序。![star > 100][Bronze]   
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - **star:7899** MySQL驱动程序。![star > 5000][Gold]   
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - **star:3361** SQLite3驱动程序。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [pgx](https://github.com/jackc/pgx) - **star:1865** PostgreSQL驱动，支持比现有database/sql更多的特性。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [pq](https://github.com/lib/pq) - **star:5091** 纯 Go 的Postgres驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* NoSQL Databases
    ...
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - **star:2924** 官方的 MongoDB 驱动。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [redigo](https://github.com/gomodule/redigo) - **star:6151** Redigo 是基于 Go 的Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [redis](https://github.com/go-redis/redis) - **star:6218** 基于 Go 的 Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* Search and Analytic Databases.
    ...
    * [elastic](https://github.com/olivere/elastic) - **star:4013** Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - **star:1486** 官方 Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [goes](https://github.com/OwnLocal/goes) - **star:24** 实现了与 Elasticsearch 交互的库。![最近一年没有更新][Yellow]
    * [riot](https://github.com/go-ego/riot) - **star:4634** 基于 Go 的 开源、分布式、简单高效的搜索引擎。![star > 1000][Silver]   
...
* Multiple Backends.
    ...
    * [cayley](https://github.com/google/cayley) - **star:12607** 图形数据库，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [now](https://github.com/jinzhu/now) - **star:2140** now 是时间有关的工具类。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [dragonboat](https://github.com/lni/dragonboat) - **star:2451** 一个功能齐全，高性能的库集。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [emitter-io](https://github.com/emitter-io/emitter) - **star:1880** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。![star > 1000][Silver]   
...
* [go-health](https://github.com/InVisionApp/go-health) - **star:474** 用于在服务中启用异步依赖项健康检查的库。![star > 100][Bronze]   
* [go-jump](https://github.com/dgryski/go-jump) - **star:250** 提供了谷歌的 “Jump” 一致哈希函数接口。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [go-kit](https://github.com/go-kit/kit) - **star:14138** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。![star > 5000][Gold]   
* [gorpc](https://github.com/valyala/gorpc) - **star:548** 简单、快速和可伸缩的RPC库。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [grpc-go](https://github.com/grpc/grpc-go) - **star:8770** gRPC的Go语言实现。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hprose](https://github.com/hprose/hprose-golang) - **star:989** 支持25+种语言RPC库。![star > 100][Bronze]   
* [jaeger](https://github.com/jaegertracing/jaeger) - **star:8426** 分布式跟踪系统。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [KrakenD](https://github.com/devopsfaith/krakend) - **star:1661** 具有中间件的高性能API网关框架。![star > 1000][Silver]   
* [micro](https://github.com/micro/micro) - **star:6451** 可插拔的微服务 toolkit 和分布式系统平台。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) - **star:5939** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [raft](https://github.com/hashicorp/raft) - **star:2784** Raft consensus协议的实现。 by HashiCorp。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [ringpop-go](https://github.com/uber/ringpop-go) - **star:566** 可伸缩的，容错、应用分层的的Go应用程序。![star > 100][Bronze]   
* [rpcx](https://github.com/smallnest/rpcx) - **star:3685** 分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [torrent](https://github.com/anacrolix/torrent) - **star:2781** BitTorrent 客户端。![star > 1000][Silver]   
...
* [hermes](https://github.com/matcornic/hermes) - **star:1599** 可生成干净的、响应式的HTML电子邮件。![star > 1000][Silver]   
* [MailHog](https://github.com/mailhog/MailHog) - **star:5052** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。![star > 5000][Gold]   
...
* [anko](https://github.com/mattn/anko) - **star:910** 用Go编写的解释器。![star > 100][Bronze]   
* [binder](https://github.com/alexeyco/binder) - **star:29** Lua接口，基于[gopher-lua](https://github.com/yuin/gopher-lua)。
* [expr](https://github.com/antonmedv/expr) - **star:649** 一个可以计算表达式的引擎。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-lua](https://github.com/Shopify/go-lua) - **star:1643** 用 Go 实现的 Lua 5.2 VM接口。![star > 1000][Silver]   
* [go-php](https://github.com/deuill/go-php) - **star:669** PHP 的 Go 接口。![star > 100][Bronze]   
* [go-python](https://github.com/sbinet/go-python) - **star:893** CPython C-API 的 Go 接口。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [golua](https://github.com/aarzilli/golua) - **star:434** Lua C 的 Go 接口。![star > 100][Bronze]   
* [gopher-lua](https://github.com/yuin/gopher-lua) - **star:2910** 用 Go 实现的 Lua 5.1 虚拟机和编译器。![star > 1000][Silver]   
...
* [otto](https://github.com/robertkrimen/otto) - **star:4660** 用 Go 编写的 JavaScript 解释器。![star > 1000][Silver]   
* [purl](https://github.com/ian-kent/purl) - **star:27** 嵌入 Go 的 Perl 5.18.2。![最近一年没有更新][Yellow]
* [tengo](https://github.com/d5/tengo) - **star:1270** 字节码编译的脚本语言。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [errors](https://github.com/pkg/errors) - **star:4732** 可让你很简单的进行错误处理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [decimal](https://github.com/shopspring/decimal) - **star:1556** 任意精度定点的十进制数。![star > 1000][Silver]   
...
* [go-money](https://github.com/rhymond/go-money) - **star:607** Fowler 货币模式的实现。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [ofxgo](https://github.com/aclindsa/ofxgo) - **star:59** 查询 OFX 服务器和/或解析响应。
* [orderbook](https://github.com/i25959341/orderbook) - **star:65** 限购单匹配引擎。
* [techan](https://github.com/sdcoffey/techan) - **star:145** 拥有先进的市场分析和交易策略的技术分析库。![star > 100][Bronze]   
* [transaction](https://github.com/claygod/transaction) - **star:53** 嵌入式事务数据库，可多线程模式运行。
...
* [gorilla/csrf](https://github.com/gorilla/csrf) - **star:424** 用于Go web应用程序和服务的CSRF保护。![star > 100][Bronze]   
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) - **star:1789** 很简单的 2D 游戏库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [engo](https://github.com/EngoEngine/engo) - **star:1074** 开源 2D 游戏引擎。它遵循 Entity-Component-System 范式。![star > 1000][Silver]   
* [g3n](https://github.com/g3n/engine) - **star:728**  3D游戏引擎。![star > 100][Bronze]   
...
* [go-sdl2](https://github.com/veandco/go-sdl2) - **star:1136** 实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。![star > 1000][Silver]   
...
* [goworld](https://github.com/xiaonanln/goworld) - **star:1138** 可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。![star > 1000][Silver]   
* [Leaf](https://github.com/name5566/leaf) - **star:3007** 轻量级游戏服务器框架。![star > 1000][Silver]   
* [nano](https://github.com/lonng/nano) - **star:965** 轻量级、方便、高性能的基于golang的游戏服务器框架。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Oak](https://github.com/oakmound/oak) - **star:622** 纯 Go 实现的游戏引擎。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Pitaya](https://github.com/topfreegames/pitaya) - **star:288** 可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity。![star > 100][Bronze]   
* [Pixel](https://github.com/faiface/pixel) - **star:2377** 手工制作的 2D 游戏库。![star > 1000][Silver]   
...
* [gen](https://github.com/clipperhouse/gen) - **star:1021** 用于生成泛型等类似方法的功能代码生成工具。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) - **star:1765** 提供类似 .NET LINQ 的查询方法。![star > 1000][Silver]   
...
* [S2 geometry](https://github.com/golang/geo) - **star:873** S2 geometry 库。![star > 100][Bronze]   
* [Tile38](https://github.com/tidwall/tile38) - **star:6273** 具有空间索引和实时地理定位功能的地理定位数据库。![star > 5000][Gold]   
...
* [gopherjs](https://github.com/gopherjs/gopherjs) - **star:8447** 将 Go 编译成 JavaScript。![star > 5000][Gold]   
* [llgo](https://github.com/go-llvm/llgo) - **star:987** 基于 llvm 的编译器。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [ants](https://github.com/panjf2000/ants) - **star:1770** 一个高性能的协程池。![star > 1000][Silver]   
...
* [pool](https://github.com/go-playground/pool) - **star:472** 有限消费者协程或无限协程池，可用于更加简单的处理和取消协程![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [tunny](https://github.com/Jeffail/tunny) - **star:1307** golang 的协程池。![star > 1000][Silver]   
...
* [app](https://github.com/murlokswarm/app) - **star:2921** 用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。![star > 1000][Silver]   
* [fyne](https://github.com/fyne-io/fyne) - **star:6052** 为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [go-astilectron](https://github.com/asticode/go-astilectron) - **star:2602** 使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。![star > 1000][Silver]   
* [go-gtk](http://mattn.github.io/go-gtk/) - 实现了 GTK 的 Go接口。
* [go-sciter](https://github.com/sciter-sdk/go-sciter) - **star:1419** 实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gotk3](https://github.com/gotk3/gotk3) - **star:742** 实现了 GTK3 的 Go接口。![star > 100][Bronze]   
* [gowd](https://github.com/dtylman/gowd) - **star:204** 跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。![star > 100][Bronze]   
* [qt](https://github.com/therecipe/qt) - **star:5849** 实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。![star > 5000][Gold]   
* [ui](https://github.com/andlabs/ui) - **star:6835** 跨平台的 Platform-native GUI 库。![star > 5000][Gold]   
* [Wails](https://wails.app) - Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。
* [walk](https://github.com/lxn/walk) - **star:3641** Windows应用程序库。![star > 1000][Silver]   
* [webview](https://github.com/zserge/webview) - **star:4531** 跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [robotgo](https://github.com/go-vgo/robotgo) - **star:4364** 实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [bimg](https://github.com/h2non/bimg) - **star:775** 使用libvips实现的快速高效的图像处理包。![star > 100][Bronze]   
...
* [gg](https://github.com/fogleman/gg) - **star:1881** 纯Go语言实现的2D渲染。![star > 1000][Silver]   
...
* [gocv](https://github.com/hybridgroup/gocv) - **star:2375** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [goimagehash](https://github.com/corona10/goimagehash) - **star:209**  图像哈希处理的Go语言包。![star > 100][Bronze]   
...
* [imaginary](https://github.com/h2non/imaginary) - **star:2546** 用于图像大小调整的快速、简单的HTTP微服务。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [imaging](https://github.com/disintegration/imaging) - **star:2477** 简单的Go图像处理包。![star > 1000][Silver]   
* [img](https://github.com/hawx/img) - **star:128** 图像处理工具的集合。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [ln](https://github.com/fogleman/ln) - **star:2442** Go实现的3D线艺术（3D Line Art）渲染。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [mergi](https://github.com/noelyahan/mergi) - **star:68** 用于图像处理(合并、裁剪、调整大小、水印、动画)的工具和Go库。
* [mort](https://github.com/aldor007/mort) - **star:363** Go语言实现的图像存储和处理服务器。![star > 100][Bronze]   
* [mpo](https://github.com/donatj/mpo) - **star:6** MPO三维照片的解码和转换工具。
* [picfit](https://github.com/thoas/picfit) - **star:1050** Go实现的图像调整服务器。![star > 1000][Silver]   
* [pt](https://github.com/fogleman/pt) - **star:1760** Go实现的路径跟踪（path tracing）引擎。![star > 1000][Silver]   
* [resize](https://github.com/nfnt/resize) - **star:2111** Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [rez](https://github.com/bamiaux/rez) - **star:187** 纯Go语言和SIMD实现的图像大小调整。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [svgo](https://github.com/ajstarks/svgo) - **star:1310**  Go实现的SVG生成库。![star > 1000][Silver]   
...
* [mainflux](https://github.com/Mainflux/mainflux) - **star:561** 工业物联网消息和设备管理服务器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [GJSON](https://github.com/tidwall/gjson) - **star:4750** 使用一行代码获取JSON的值。![star > 1000][Silver]   
...
* [glog](https://github.com/golang/glog) - **star:2274** 为Go提供了多等级日志记录。![star > 1000][Silver]   
...
* [logrus](https://github.com/Sirupsen/logrus) - **star:11556** Go的结构化日志操作 。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [lumberjack](https://github.com/natefinch/lumberjack) - **star:1390** 简单的滚动日志，io.WriteCloser的实现。![star > 1000][Silver]   
...
* [seelog](https://github.com/cihub/seelog) - **star:1338** 具有灵活调度、过滤和格式化的日志功能。![star > 1000][Silver]   
* [spew](https://github.com/davecgh/go-spew) - **star:3243** 为Go数据结构实现一个漂亮的printer用于帮助调试。![star > 1000][Silver]   
* [stdlog](https://github.com/alexcesaro/log) - **star:43** Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。![最近一年没有更新][Yellow]
* [tail](https://github.com/hpcloud/tail) - **star:1502** 努力模拟实现BSD的tail的特性的Go包。![star > 1000][Silver]   
...
* [zap](https://github.com/uber-go/zap) - **star:7225** 快速、结构化、多等级的日志记录。![star > 5000][Gold]   
* [zerolog](https://github.com/rs/zerolog) - **star:2100** Zero-allocation JSON日志记录。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gobrain](https://github.com/goml/gobrain) - **star:371** 用 Go 编写的神经网络库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gorse](https://github.com/zhenghaoz/gorse) - **star:511** 基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。![star > 100][Bronze]   
...
* [onnx-go](https://github.com/owulveryck/onnx-go) - **star:142** Go Interface， 用于开放式神经网络交换(Open Neural Network Exchange)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [tfgo](https://github.com/galeone/tfgo) - **star:1166** 易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。![star > 1000][Silver]   
...
* [APNs2](https://github.com/sideshow/apns2) - **star:2029** HTTP / 2苹果推送通知供应商——发送推送通知到iOS, tvo, Safari和OSX的应用。![star > 1000][Silver]   
* [Beaver](https://github.com/Clivern/Beaver) - **star:715** 一个实时消息服务器，可构建一个可伸缩的应用程序内通知，多人游戏，聊天应用程序在web和移动应用程序。![star > 100][Bronze]   
* [Benthos](https://github.com/Jeffail/benthos) - **star:1914** 一系列协议之间的消息流桥。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Bus](https://github.com/mustafaturan/bus) - **star:112** 内部通信的最小消息总线实现。![star > 100][Bronze]   
* [Centrifugo](https://github.com/centrifugal/centrifugo) - **star:3618** 实时消息(Websockets或SockJS)服务器。![star > 1000][Silver]   
...
* [go-socket.io](https://github.com/googollee/go-socket.io) - **star:2834** 套接字。面向golang的io库，一个实时应用程序框架。![star > 1000][Silver]   
...
* [gorush](https://github.com/appleboy/gorush) - **star:3647** 使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [machinery](https://github.com/RichardKnop/machinery) - **star:3316** 基于分布式消息传递的异步任务队列/作业队列。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [mangos](https://github.com/go-mangos/mangos) - **star:1533** 具有传输互操作性的Nanomsg(“可伸缩协议”)的纯go实现。![star > 1000][Silver]   
* [melody](https://github.com/olahol/melody) - **star:1521** 处理websocket会话的极简框架，包括广播和自动乒乓球处理。![star > 1000][Silver]   
* [Mercure](https://github.com/dunglas/mercure) - **star:1441** 使用Mercure协议(构建在服务器发送事件之上)分派服务器发送的更新的服务器和库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [sarama](https://github.com/Shopify/sarama) - **star:4495**  Go Apache Kafka的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) - **star:4314** Golang库读写Microsoft Excel™(XLSX)文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [xlsx](https://github.com/tealeg/xlsx) - **star:3287** 库，以简化在Go程序中读取Microsoft Excel最新版本使用的XML格式。![star > 1000][Silver]   
...
* [dig](https://github.com/uber-go/dig) - **star:869** 一个基于反射的Go依赖注入工具包。![star > 100][Bronze]   
* [fx](https://github.com/uber-go/fx) - **star:642** 基于依赖注入的Go应用程序框架(构建在dig之上)。![star > 100][Bronze]   
* [gocontainer](https://github.com/vardius/gocontainer) - **star:6** 简单的依赖注入容器。
* [inject](https://github.com/defval/inject) - **star:17** 一个基于反射的依赖注入容器，具有简单的接口。
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - **star:8539** Go生态系统中常见的历史和新兴的项目布局模式。![star > 5000][Gold]   
...
* [archiver](https://github.com/mholt/archiver) - **star:2450** 用于生成和提取.zip和.tar.gz存档的库和命令。![star > 1000][Silver]   
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) - **star:610** Base64captch支持数字，数字，字母，算术，音频和数字-字母验证码。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) - **star:656** Golang的通用对象池。![star > 100][Bronze]   
* [go-openapi](https://github.com/go-openapi) - 用于解析和利用开放api模式的包的集合。
* [go-resiliency](https://github.com/eapache/go-resiliency) - **star:833**  Go 的弹性模式。![star > 100][Bronze]   
...
* [gopsutil](https://github.com/shirou/gopsutil) - **star:3827** 用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [llvm](https://github.com/llir/llvm) - **star:404** 用于在纯Go中与LLVM IR交互的库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [shortid](https://github.com/teris-io/shortid) - **star:444** 分布式生成超短、唯一、非顺序、URL友好的id。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [gse](https://github.com/go-ego/gse) - **star:1040** 高效的文本分割;支持英语、汉语、日语等。![star > 1000][Silver]   
...
* [prose](https://github.com/jdkato/prose) - **star:2026** 用于支持标记化、词性标记、名称实体提取等文本处理的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [dns](https://github.com/miekg/dns) - **star:3726** 使用DNS的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [fasthttp](https://github.com/valyala/fasthttp) - **star:9063** 软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [fortio](https://github.com/fortio/fortio) - **star:843** 负载测试库和命令行工具，先进的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。Tcp、Http、gRPC。![star > 100][Bronze]   
* [ftp](https://github.com/jlaffaye/ftp) - **star:506** 包ftp实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户机。![star > 100][Bronze]   
...
* [go-getter](https://github.com/hashicorp/go-getter) - **star:699**  Go 图书馆下载文件或目录从各种来源使用一个URL。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [go-stun](https://github.com/ccding/go-stun) - **star:328** Go实现了STUN客户机(RFC 3489和RFC 5389)。![star > 100][Bronze]   
* [gobgp](https://github.com/osrg/gobgp) - **star:1652** 用 Go 编程语言实现的BGP。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gopacket](https://github.com/google/gopacket) - **star:2791** 使用libpcap绑定访问包处理库。![star > 1000][Silver]   
...
* [HTTPLab](https://github.com/gchaincl/httplab) - **star:3386** HTTPLabs允许您检查HTTP请求并伪造响应。![star > 1000][Silver]   
...
* [kcp-go](https://github.com/xtaci/kcp-go) - **star:2205** 快速可靠的ARQ协议。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [kcptun](https://github.com/xtaci/kcptun) - **star:10544** 非常简单和快速udp隧道基于KCP协议。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [NFF-Go](https://github.com/intel-go/nff-go) - **star:645** 快速开发云计算和裸机网络功能的框架(原YANFF)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [quic-go](https://github.com/lucas-clemente/quic-go) - **star:2820** 在纯Go中实现了QUIC协议。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [ssh](https://github.com/gliderlabs/ssh) - **star:1090** 用于构建SSH服务器的高级API(封装密码/ SSH)。![star > 1000][Silver]   
* [sslb](https://github.com/eduardonunesp/sslb) - **star:113** 它是一个超级简单的负载平衡器，只是一个实现某种性能的小项目。![star > 100][Bronze]   
* [stun](https://github.com/go-rtc/stun) - **star:260** Go实现的RFC 5389 STUN协议。![star > 100][Bronze]   
...
* [water](https://github.com/songgao/water) - **star:828** 简单TUN / TAP图书馆。![star > 100][Bronze]   
* [webrtc](https://github.com/pions/webrtc) - **star:2096** WebRTC API的纯Go实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [grequests](https://github.com/levigross/grequests) - **star:1391** 一个 Go “克隆”的伟大和著名的请求库。![star > 1000][Silver]   
* [heimdall](https://github.com/gojektech/heimdall) - **star:1052** 具有重试和hystrix功能的增强http客户机。![star > 1000][Silver]   
* [pester](https://github.com/sethgrid/pester) - **star:320** 使用重试、后退和并发执行HTTP客户机调用。![star > 100][Bronze]   
* [rq](https://github.com/ddo/rq) - **star:25** golang stdlib HTTP客户端更好的接口。
* [sling](https://github.com/dghubble/sling) - **star:849** Sling是一个用于创建和发送API请求的Go HTTP客户端库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-pg](https://github.com/go-pg/pg) - **star:2891** 关注PostgreSQL的特性和性能。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) - **star:222** 一个灵活而强大的SQL字符串构建器库加上一个零配置ORM。![star > 100][Bronze]   
* [go-store](https://github.com/gosuri/go-store) - **star:93** 简单而快速的Redis支持的键值存储库。![最近一年没有更新][Yellow]
* [GORM](https://github.com/jinzhu/gorm) - **star:14230** Golang出色的ORM库的目标是对开发人员友好。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [gorp](https://github.com/go-gorp/gorp) - **star:3062** Go的关系持久性，ORM-ish库。![star > 1000][Silver]   
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) - **star:2215** ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [upper.io/db](https://github.com/upper/db) - **star:1820** 通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Xorm](https://github.com/go-xorm/xorm) - **star:5042** 简单而强大的ORM for Go。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dep](https://github.com/golang/dep) - **star:12411**  Go 的依赖管理工具，需要 Go 1.9+![star > 5000][Gold]   
...
* [glide](https://github.com/Masterminds/glide) - **star:7736** 轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gopm](https://github.com/gpmgo/gopm) - **star:2337** 包管理器。![star > 1000][Silver]   
* [govendor](https://github.com/kardianos/govendor) - **star:4672** 包管理器。使用 vendor 文件的 Go vendor 工具。![star > 1000][Silver]   
...
* [gojsonq](https://github.com/thedevsaddam/gojsonq) - **star:837** 一个用来查询JSON数据的Go包。![star > 100][Bronze]   
* [graphql](https://github.com/tmc/graphql) - **star:51** graphql解析器+工具集![最近一年没有更新][Yellow]
* [graphql](https://github.com/neelance/graphql-go) - **star:2716** 关注易用性的GraphQL服务器。![star > 1000][Silver]   
* [graphql-go](https://github.com/graphql-go/graphql) - **star:5074** 为Go实现GraphQL。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [packr](https://github.com/gobuffalo/packr) - **star:2034** 将静态文件嵌入到Go二进制文件中的简单方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [statics](https://github.com/go-playground/statics) - **star:53** 将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。![最近一年没有更新][Yellow]
* [statik](https://github.com/rakyll/statik) - **star:2044** 将静态文件嵌入到Go可执行文件中。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [templify](https://github.com/wlbr/templify) - **star:19** 将外部模板文件嵌入到Go代码中，以创建单个文件二进制文件。
* [vfsgen](https://github.com/shurcooL/vfsgen) - **star:641** 生成一个vfsdata。静态实现给定虚拟文件系统的go文件。![star > 100][Bronze]   
...
* [gonum](https://github.com/gonum/gonum) - **star:2869** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gonum/plot](https://github.com/gonum/plot) - **star:1189** gonum/plot提供了一个API，用于在Go中构建和绘制绘图。![star > 1000][Silver]   
...
* [Cameradar](https://github.com/Ullaakut/cameradar) - **star:1786** 工具和库，以远程入侵RTSP流从监控摄像头。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [lego](https://github.com/xenolf/lego) - **star:3429** 纯 Go ACME 客户端库及命令行工具![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-codec](https://github.com/ugorji/go) - **star:1210** 高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) - **star:2849** Go 语言的 Protocol Buffer 库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [goprotobuf](https://github.com/golang/protobuf) - **star:4890** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.![star > 1000][Silver]   ![最近一个周有更新][Green]
* [jsoniter](https://github.com/json-iterator/go) - **star:5310** 高性能，100% 兼容的“encoding/json” 替代品![star > 5000][Gold]   
* [mapstructure](https://github.com/mitchellh/mapstructure) - **star:2337** 用于对原生键值对进行解码生成 Go 语言结构体![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Caddy](https://github.com/mholt/caddy) - **star:22702** Caddy是另一种HTTP/2 web服务器，易于配置和使用。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [discovery](https://github.com/Bilibili/discovery) - **star:632** 用于弹性中间层负载平衡和故障转移的注册表。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [etcd](https://github.com/coreos/etcd) - **star:25860** 为共享配置和服务发现提供高可用的键值存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Fider](https://github.com/getfider/fider) - **star:778** Fider是一个收集和组织客户反馈的开放平台。![star > 100][Bronze]   
* [Flagr](https://github.com/checkr/flagr) - **star:793** Flagr是一个开源特性标记和A/B测试服务。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [minio](https://github.com/minio/minio) - **star:16907** Minio是一个分布式对象存储服务器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [amber](https://github.com/eknkc/amber) - **star:821** Amber是一个优雅的Go编程语言模板引擎，它的灵感来自HAML和Jade。![star > 100][Bronze]   
...
* [gofpdf](https://github.com/jung-kurt/gofpdf) - **star:3017** PDF 文档生成器，支持文本，绘图和图片![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [mustache](https://github.com/hoisie/mustache) - **star:965** Go 语言实现的 Mustache 模板语言![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [pongo2](https://github.com/flosch/pongo2) - **star:1481** 类似 DjanGo 的模板引擎![star > 1000][Silver]   ![最近一个周有更新][Green]
* [quicktemplate](https://github.com/valyala/quicktemplate) - **star:1366** 快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译![star > 1000][Silver]   ![最近一个周有更新][Green]
* [raymond](https://github.com/aymerick/raymond) - **star:336** 使用 Go 语言实现的完整的 handlebars![star > 100][Bronze]   
* [Razor](https://github.com/sipin/gorazor) - **star:683** Go 语言的 Razor 视图引擎![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* Testing Frameworks
    ...
    * [go-cmp](https://github.com/google/go-cmp) - **star:1097** 用于比较测试中的Go值的包。![star > 1000][Silver]   
    * [go-mutesting](https://github.com/zimmski/go-mutesting) - **star:245** 变异测试的Go源代码。![star > 100][Bronze]   
    * [go-testdeep](https://github.com/maxatome/go-testdeep) - **star:51** 极具灵活性的golang深度比较，扩展了go测试包。![最近一个周有更新][Green]
    ...
    * [godog](https://github.com/DATA-DOG/godog) - **star:726** 类似 Cucumber 或 Behat 的 BDD 框架![star > 100][Bronze]   
    ...
    * [httpexpect](https://github.com/gavv/httpexpect) - **star:1106** 简洁的、声明式的、易用的端到端HTTP 及 REST API 测试![star > 1000][Silver]   
    ...
    * [testfixtures](https://github.com/go-testfixtures/testfixtures) - **star:316** 类似 Rails 的测试工具，用于测试数据库应用![star > 100][Bronze]   
    * [Testify](https://github.com/stretchr/testify) - **star:7852** 对标准测试包的扩展。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* Mock
    ...
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - **star:1642** Mock SQL ，用于测试数据库交互![star > 1000][Silver]   
    * [go-txdb](https://github.com/DATA-DOG/go-txdb) - **star:154** 基于单事务的数据库驱动，主要用于测试目的![star > 100][Bronze]   ![最近一个周有更新][Green]
    * [gock](https://github.com/h2non/gock) - **star:788** 多功能、易用 HTTP mock![star > 100][Bronze]   ![最近一个周有更新][Green]
    * [gomock](https://github.com/golang/mock) - **star:2689** 用于Go编程语言的mock框架。![star > 1000][Silver]   
    * [govcr](https://github.com/seborama/govcr) - **star:78** HTTP mock : 离线测试时记录和重放浏览器的动作
    * [hoverfly](https://github.com/SpectoLabs/hoverfly) - **star:1416** 使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* Fuzzing and delta-debugging/reducing/shrinking.
    ...
    * [gofuzz](https://github.com/google/gofuzz) - **star:520** 用于生成随机值来初始化 Go 语言对象的库![star > 100][Bronze]   
    * [Tavor](https://github.com/zimmski/tavor) - **star:208** 通用模糊测试框架![star > 100][Bronze]   

* Selenium and browser control tools.
    * [cdp](https://github.com/mafredri/cdp) - **star:344** 用于Chrome调试协议的类型安全绑定，可与实现该协议的浏览器或其他调试目标一起使用。![star > 100][Bronze]   
    * [chromedp](https://github.com/knq/chromedp) - **star:3415** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [ggr](https://github.com/aerokube/ggr) - **star:208** 一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs![star > 100][Bronze]   
    * [selenoid](https://github.com/aerokube/selenoid) - **star:1183** Selenium hub 服务器的替代品，在容器中启动浏览器![star > 1000][Silver]   ![最近一个周有更新][Green]

* Fail injection
    * [failpoint](https://github.com/pingcap/failpoint) - **star:369** 为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* Specific Formats
    ...
    * [blackfriday](https://github.com/russross/blackfriday) - **star:3809** Markdown 解析器![star > 1000][Silver]   
    ...
    * [colly](https://github.com/asciimoo/colly) - **star:8106** 快速和优雅的 Scraping 框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [commonregex](https://github.com/mingrammer/commonregex) - **star:549** 一组用于Go的公共正则表达式。![star > 100][Bronze]   
    ...
    * [go-fixedwidth](https://github.com/ianlopshire/go-fixedwidth) - **star:24** 固定宽度的文本格式(带反射的编码器/解码器)。
    * [go-humanize](https://github.com/dustin/go-humanize) - **star:1850** 格式化程序，用于将时间、数字和内存大小转换为可读格式。![star > 1000][Silver]   
    ...
    * [go-toml](https://github.com/pelletier/go-toml) - **star:598** 使用带有查询支持和方便的cli工具的TOML格式库。![star > 100][Bronze]   ![最近一个周有更新][Green]
    ...
    * [gofeed](https://github.com/mmcdole/gofeed) - **star:1082** 在Go中解析RSS和Atom feeds。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [GoQuery](https://github.com/PuerkitoBio/goquery) - **star:7441** GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能![star > 5000][Gold]   
    ...
    * [sh](https://github.com/mvdan/sh) - **star:1926** Shell解析器和格式化工具。![star > 1000][Silver]   
    ...
    * [toml](https://github.com/BurntSushi/toml) - **star:2723** TOML配置格式(带反射的编码器/解码器)。![star > 1000][Silver]   
* Utility
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - **star:4933** AWS 提供的官方go语言 SDK![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [discordgo](https://github.com/bwmarrin/discordgo) - **star:936**  Discord Chat API的客户端。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [github](https://github.com/google/go-github) - **star:4691** 访问GitHub REST API v3的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-jira](https://github.com/andygrunwald/go-jira) - **star:551**  Go [Atlassian JIRA]的客户端库(https://www.atlassian.com/software/jira)![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-twitter](https://github.com/dghubble/go-twitter) - **star:694**  Twitter v1.1 api 的客户端。。![star > 100][Bronze]   
...
* [google](https://github.com/google/google-api-go-client) - **star:1896** 为Go自动生成谷歌api。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [google-analytics](https://github.com/chonthu/go-google-analytics) - **star:12** 简单的包装，方便的谷歌分析报告。![最近一年没有更新][Yellow]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - **star:1737** 谷歌云api Go 客户端库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [minio-go](https://github.com/minio/minio-go) - **star:705** 用于Amazon S3兼容云存储的Minio Go库。![star > 100][Bronze]   
...
* [slack](https://github.com/nlopes/slack) - **star:2358** Slack API。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [stripe](https://github.com/stripe/stripe-go) - **star:915**  Stripe API 的 Go 语言客户端![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [boilr](https://github.com/tmrts/boilr) - **star:923** 非常快的CLI工具，用于从样板模板创建项目。![star > 100][Bronze]   
...
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) - **star:777** 接通断路器。![star > 100][Bronze]   
...
* [ctop](https://github.com/bcicen/ctop) - **star:8663** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。![star > 5000][Gold]   
...
* [Deepcopier](https://github.com/ulule/deepcopier) - **star:202** 结构体拷贝![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [delve](https://github.com/derekparker/delve) - **star:11756** Go 语言调试器![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [fzf](https://github.com/junegunn/fzf) - **star:22547** 用Go编写的命令行模糊查找器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [git-time-metric](https://github.com/git-time-metric/gtm) - **star:710** git-time-metric - 。![star > 100][Bronze]   
...
* [go-funk](https://github.com/thoas/go-funk) - **star:1105** 现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)![star > 1000][Silver]   
...
* [goreleaser](https://github.com/goreleaser/goreleaser) - **star:4390** 尽可能快速的发布 Go 语言二进制文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gubrak](https://github.com/novalagung/gubrak) - **star:132** 带有语法糖的Golang实用工具，就像lodash。![star > 100][Bronze]   
...
* [hub](https://github.com/github/hub) - **star:16693** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hystrix-go](https://github.com/afex/hystrix-go) - **star:1949** 实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。![star > 1000][Silver]   
...
* [jump](https://github.com/gsamokovarov/jump) - **star:642** 通过学习你的习惯，可以帮助你更快地导航。![star > 100][Bronze]   
* [koazee](https://github.com/wesovilabs/koazee) - **star:280** 库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。![star > 100][Bronze]   
* [lrserver](https://github.com/jaschaephraim/lrserver) - **star:100** LiveReload 服务器。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [mc](https://github.com/minio/mc) - **star:1074** Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [minify](https://github.com/tdewolff/minify) - **star:1838** 用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。![star > 1000][Silver]   
...
* [panicparse](https://github.com/maruel/panicparse) - **star:2079** 将类似的协程分组并对调用栈进行着色![star > 1000][Silver]   
...
* [realize](https://github.com/tockins/realize) - **star:3095** Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。![star > 1000][Silver]   
...
* [resty](https://github.com/go-resty/resty) - **star:1821** 简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。![star > 1000][Silver]   
...
* [sqlx](https://github.com/jmoiron/sqlx) - **star:6602** 为内建的数据库/sql 软件包提供一组扩展。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [sslice](https://github.com/yaa110/sslice) - **star:2** 创建一个总是排序的切片。
* [Storm](https://github.com/asdine/storm) - **star:1333** 一个简单又强大的用于 BoltDB 的工具![star > 1000][Silver]   
* [structs](https://github.com/PumpkinSeed/structs) - **star:12** 简单来讲就是 "Make" 的替代品。![最近一年没有更新][Yellow]
* [Task](https://github.com/go-task/task) - **star:1864** 简单的“Go”的选择。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [toolbox](https://github.com/viant/toolbox) - **star:86** 切片, map, multimap, 结构体, 函数,数据转换工具。服务路由，宏求值和标记器。
...
* [wuzz](https://github.com/asciimoo/wuzz) - **star:8219** 用于HTTP检查的交互式cli工具。![star > 5000][Gold]   
...
* [sno](https://github.com/muyo/sno) - **star:14** 使用嵌入元数据的紧凑、可排序和快速的惟一id。
...
* [uuid](https://github.com/gofrs/uuid) - **star:551** 通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。![star > 100][Bronze]   
...
* [govalidator](https://github.com/asaskevich/govalidator) - **star:3496** 用于字符串，数字，切片和结构的验证器和sanitizers。![star > 1000][Silver]   
* [govalidator](https://github.com/thedevsaddam/govalidator) - **star:697** 用简单的规则验证Golang请求数据。深受Laravel请求验证的启发。![star > 100][Bronze]   
* [jio](https://github.com/faceair/jio) - **star:21** jio是一个json模式验证器，类似于[joi](https://github.com/hapijs/joi)。
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - **star:1017** 支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。![star > 1000][Silver]   
...
* [validator](https://github.com/go-playground/validator) - **star:3343**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [git2go](https://github.com/libgit2/git2go) - **star:1344**  libgit2 的 Go 语言接口。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-git](https://github.com/src-d/go-git) - **star:4123** 纯Go中高度可扩展的Git实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-vcs](https://github.com/sourcegraph/go-vcs) - **star:69** 在Go中操作和检查VCS存储库。
* [hercules](https://github.com/src-d/hercules) - **star:507** 从Git存储库历史中获得高级见解。![star > 100][Bronze]   
...
* [gmf](https://github.com/3d0c/gmf) - **star:509**  FFmpeg av\* 库的 Go 语言接口。![star > 100][Bronze]   
...
* [goav](https://github.com/giorgisio/goav) - **star:760** FFmpeg的Comphrensive。![star > 100][Bronze]   
...
* [Beego](https://github.com/astaxie/beego) - **star:21094** beego是一种用于 Go 编程语言的开源高性能web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Buffalo](http://gobuffalo.io) - 为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) - **star:14403** 高性能、极简的Go web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Gin](https://github.com/gin-gonic/gin) - **star:28895** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Revel](https://github.com/revel/revel) - **star:11187** 用于Go语言的高效web框架。![star > 5000][Gold]   
...
* [tigertonic](https://github.com/rcrowley/go-tigertonic) - **star:996** 用于构建 JSON web 服务的 Go 语言框架，受到 Dropwizard 的启发。![star > 100][Bronze]   
...
* [CORS](https://github.com/rs/cors) - **star:1179** 轻松地向API添加CORS功能。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Limiter](https://github.com/ulule/limiter) - **star:768** 简单的速度限制中间件。![star > 100][Bronze]   
* [ln-paywall](https://github.com/philippgille/ln-paywall) - **star:86** 使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。
* [Tollbooth](https://github.com/didip/tollbooth) - **star:1217** 限制速率的 HTTP 请求处理程序。![star > 1000][Silver]   
...
* [negroni](https://github.com/urfave/negroni) - **star:6286** 符合语言习惯的 HTTP 中间件库。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [chi](https://github.com/go-chi/chi) - **star:5888** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。![star > 5000][Gold]   
* [fasthttprouter](https://github.com/buaazp/fasthttprouter) - **star:737** 高性能路由器分叉从`httprouter`。第一个路由器适合`fasthttp`。![star > 100][Bronze]   
...
* [httprouter](https://github.com/julienschmidt/httprouter) - **star:9516** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。![star > 5000][Gold]   
...
* [mux](https://github.com/gorilla/mux) - **star:9445** 强大的URL路由器和调度器为golang。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [xujiajun/gorouter](https://github.com/xujiajun/gorouter) - **star:445** 一个简单和快速的HTTP路由器 Go 。![star > 100][Bronze]   

## Windows

* [d3d9](https://github.com/gonutz/d3d9) - **star:86**  Direct3D9 的 Go 语言接口。
* [go-ole](https://github.com/go-ole/go-ole) - **star:542** 为 Go 语言实现的 Win32 OLE。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) - **star:278** go-cleanarch 的创建是为了验证 Clean 体系结构规则，比如 Go 项目中的依赖关系。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [GoLint](https://github.com/golang/lint) - **star:3110** Go 源码的 linter。![star > 1000][Silver]   
...
* [vim-go](https://github.com/fatih/vim-go) - **star:10690** Go 开发会用到的 Vim 插件。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) - **star:5039** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **star:1933** 使用 dot format 可视化 Go 程序的调用图。![star > 1000][Silver]   
* [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) - **star:37** Bash completion for go and wgo。![最近一年没有更新][Yellow]
* [go-swagger](https://github.com/go-swagger/go-swagger) - **star:3855** 基于 Go 的Swagger 2.0实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [godbg](https://github.com/tylerwince/godbg) - **star:157** 实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。![star > 100][Bronze]   
* [OctoLinker](https://github.com/OctoLinker/browser-extension) - **star:3695** 借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。![star > 1000][Silver]   
...
* [bombardier](https://github.com/codesenberg/bombardier) - **star:1686** 快速跨平台 HTTP 基准测试工具。![star > 1000][Silver]   
* [bosun](https://github.com/bosun-monitor/bosun) - **star:2845** 按照时间轴发出告警的框架。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gaia](https://github.com/gaia-pipeline/gaia) - **star:3705** 可用于任何编程语言来构建强大的管道。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Gitea](https://github.com/go-gitea/gitea) - **star:14695** 从 Gogs fork，完全由社区驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) - **star:658** 允许你的 Go应用程序 进行自我更新。![star > 100][Bronze]   
...
* [gox](https://github.com/mitchellh/gox) - **star:3327** 非常简单，没有多余的跨平台编译工具。![star > 1000][Silver]   
* [goxc](https://github.com/laher/goxc) - **star:1628** 专注于跨平台编译和打包的 Go 构建工具。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [grapes](https://github.com/yaronsumel/grapes) - **star:134** 旨在轻松地通过ssh分发命令的轻量级工具。![star > 100][Bronze]   
* [GVM](https://github.com/moovweb/gvm) - **star:4414** GVM 提供了一个接口来管理 Go 版本。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Hey](https://github.com/rakyll/hey) - **star:6091** 压力测试工具，可用来代替 ApacheBench (ab)。![star > 5000][Gold]   
* [kala](https://github.com/ajvb/kala) - **star:1348** 简单、现代和高性能的作业调度程序。![star > 1000][Silver]   
* [kcli](https://github.com/cswank/kcli) - **star:71** 用于检查kafka主题/分区/消息的命令行工具。
* [kubernetes](https://github.com/kubernetes/kubernetes) - **star:55037** 来自谷歌的容器集群管理器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Moby](https://github.com/moby/moby) - **star:54031** Collaborative project for the container ecosystem to assemble container-based systems.![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Packer](https://github.com/mitchellh/packer) - **star:9097** 用于从一个源配置为多个平台创建相同的机器图像。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [script](https://github.com/bitfield/script) - **star:706** 让DevOps编写类shell和系统管理任务变得更加容易。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [sg](https://github.com/ChristopherRabotin/sg) - **star:5** 可测试一组HTTP极限(如ab)，可以在每个调用之间使用响应代码和数据，根据之前的响应来确定特定的服务器压力。![最近一年没有更新][Yellow]
* [skm](https://github.com/TimothyYe/skm) - **star:545** SKM是一个简单而强大的SSH密钥管理器，它可以帮助您轻松地管理多个SSH密钥!![star > 100][Bronze]   
* [StatusOK](https://github.com/sanathp/statusok) - **star:1151** 监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。![star > 1000][Silver]   
* [traefik](https://github.com/containous/traefik) - **star:23241** 反向代理和负载均衡器，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Vegeta](https://github.com/tsenart/vegeta) - **star:11925** HTTP负载测试工具和库。超过9000 !![star > 5000][Gold]   
* [webhook](https://github.com/adnanh/webhook) - **star:3996** 允许用户创建在服务器上执行命令的 HTTP hooks。![star > 1000][Silver]   
...
* [Comcast](https://github.com/tylertreat/Comcast) - **star:6141** 模拟坏的网络连接。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [confd](https://github.com/kelseyhightower/confd) - **star:6332** 使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。![star > 5000][Gold]   
...
* [drive](https://github.com/odeke-em/drive) - **star:4924** 基于命令行的谷歌驱动器客户端。![star > 1000][Silver]   
* [Duplicacy](https://github.com/gilbertchen/duplicacy) - **star:2666** 跨平台网络和云备份工具。![star > 1000][Silver]   
* [gfile](https://github.com/Antonito/gfile) - **star:492** 通过WebRTC在两台计算机之间安全地传输文件，不需要任何第三方依赖。![star > 100][Bronze]   
...
* [GoBoy](https://github.com/Humpheh/goboy) - **star:2098** 用 Go 编写的任天堂Game Boy彩色模拟器。![star > 1000][Silver]   
* [gocc](https://github.com/goccmack/gocc) - **star:338** Gocc是一个用Go编写的编译器工具包。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [lgo](https://github.com/yunabe/lgo) - **star:1769** 与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。![star > 1000][Silver]   
* [limetext](http://limetext.org/) - 一个强大而优雅的文本编辑器。
* [LiteIDE](https://github.com/visualfc/liteide) - **star:5424** 简单的、开源的、跨平台的Go IDE。![star > 5000][Gold]   
* [mockingjay](https://github.com/quii/mockingjay-server) - **star:411** 一份配置文件中便可伪造HTTP服务器与用户之间的行为。您还可以使服务器随机宕机，以帮助进行更实际的性能测试。![star > 100][Bronze]   
* [myLG](https://github.com/mehrdadrad/mylg) - **star:2188** 命令行网络诊断工具。![star > 1000][Silver]   
* [naclpipe](https://github.com/unix4fun/naclpipe) - **star:20** 基于加密管的简单的NaCL EC25519工具。
* [nes](https://github.com/fogleman/nes) - **star:4107** 任天堂娱乐系统(NES)模拟器。![star > 1000][Silver]   
...
* [Pipe](https://github.com/b3log/pipe) - **star:2628** 一个小巧漂亮的博客平台。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [restic](https://github.com/restic/restic) - **star:7258** 消除重复项备份程序。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - **star:8067** 快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Stack Up](https://github.com/pressly/sup) - **star:1980** Stack Up 是一个超级简单的部署工具 — 只面向Unix。![star > 1000][Silver]   
* [syncthing](https://syncthing.net/) - 开放，分散的文件同步工具和协议。
* [term-quiz](https://github.com/crazcalm/term-quiz) - **star:17** 测试你的终端。
* [toxiproxy](https://github.com/shopify/toxiproxy) - **star:3783** 为自动化测试模拟网络和系统条件的代理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) - **star:1254** HTTP请求路由器基准测试和比较。![star > 1000][Silver]   
* [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) - **star:977** web框架基准测试。![star > 100][Bronze]   
...
* [GoBooks](https://github.com/dariubs/GoBooks) - **star:6696** 一份精选的 Go 书籍清单。![star > 5000][Gold]   
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) - **star:1468** 由 Maria Letta 提供的与 Gopher 有关的图片包，其中包含了插图,表情文字。![star > 1000][Silver]   
...
* [gophers](https://github.com/ashleymcnamara/gophers) - **star:1814** 阿什莉·麦克纳马拉的歌斐艺术品。![star > 1000][Silver]   
* [gophers](https://github.com/egonelbre/gophers) - **star:1553** Free gophers.![star > 1000][Silver]   
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - **star:14399** Curated list of awesome remote jobs. A lot of them are looking for Go hackers.![star > 5000][Gold]   ![最近一个周有更新][Green]
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - **star:24509** 其他 awesome 系列的列表。![star > 5000][Gold]   
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - **star:31022** Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Ethereum Development with Go](https://github.com/miguelmota/ethereum-development-with-go-book) - **star:440** 一本讲述如何用 Go 进行以太开发的小册。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Games With Go](http://gameswithgo.org/) - 关于编程和游戏开发系列教学视频。
* [Go By Example](https://gobyexample.com/) - 手把手教你 如何在 Go 应用程序中使用注释。
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - **star:3975**  Go's reference card。![star > 1000][Silver]   
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) - **star:672** 引入示例讲述 Golang 与Node.js在学习上的差异。![star > 100][Bronze]   
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - **star:3988** 学习使用测试驱动开发。![star > 1000][Silver]   ![最近一个周有更新][Green]
