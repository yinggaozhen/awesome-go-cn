...
* [Oto](https://github.com/hajimehoshi/oto) - **star:421** 多平台的 low-level 声音播放库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [casbin](https://github.com/hsluoyz/casbin) - **star:4789** 支持ACL、RBAC、ABAC等访问控制模型的授权库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) - **star:1262** 用 Golang 编写的独立且符合规范的OAuth2服务器。![star > 1000][Silver]   
...
* [goth](https://github.com/markbates/goth) - **star:2235** 提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。![star > 1000][Silver]   
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) - **star:5808** JSON Web令牌(JWT)。![star > 5000][Gold]   
...
* [oauth2](https://github.com/golang/oauth2) - **star:2350** goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - **star:1586** 简单轻量级的Telegram bot客户端。![star > 1000][Silver]   
...
* [cobra](https://github.com/spf13/cobra) - **star:12913** 现代Go CLI命令行交互工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-flags](https://github.com/jessevdk/go-flags) - **star:1497**  Go 命令行选项解析器。![star > 1000][Silver]   
...
* [ops](https://github.com/nanovms/ops) - **star:246** Unikernel 构建器/协调器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [urfave/cli](https://github.com/urfave/cli) - **star:11153** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [color](https://github.com/fatih/color) - **star:2990** 多功能包装，彩色终端输出。![star > 1000][Silver]   
...
* [mpb](https://github.com/vbauerster/mpb) - **star:502** 可在终端显示多进度条。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [progressbar](https://github.com/schollz/progressbar) - **star:561** 基本线程安全的进度条，在每个操作系统工作。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [termdash](https://github.com/mum4k/termdash) - **star:791** 此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [termui](https://github.com/gizak/termui) - **star:8839** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。![star > 5000][Gold]   
* [uilive](https://github.com/gosuri/uilive) - **star:821** 用于实时更新终端输出的库。![star > 100][Bronze]   
* [uiprogress](https://github.com/gosuri/uiprogress) - **star:1521** 在终端呈现进度条，可灵活配置的。![star > 1000][Silver]   
...
* [harvester](https://github.com/beatlabs/harvester) - **star:36** 一个易于使用的静态和动态配置包![最近一个周有更新][Green]
...
* [ini](https://github.com/go-ini/ini) - **star:1547**  读和写INI文件。![star > 1000][Silver]   
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) - **star:2369** 管理来自环境变量的配置数据。![star > 1000][Silver]   
* [koanf](https://github.com/knadh/koanf) - **star:74** 轻量级可扩展库，用于读取Go应用程序中的配置。内置支持JSON, TOML, YAML, env，命令行。
...
* [viper](https://github.com/spf13/viper) - **star:9089** 配置管理。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [drone](https://github.com/drone/drone) - **star:18781** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [duci](https://github.com/duck8823/duci) - **star:44** 一个简单的 ci 服务。![最近一个周有更新][Green]
...
* [bit](https://github.com/yourbasic/bit) - **star:52** Go 语言集合数据结构。提供了额外的位操作功能。![最近一年没有更新][Yellow]
...
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) - **star:501** 布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。![star > 100][Bronze]   
...
* [go-datastructures](https://github.com/Workiva/go-datastructures) - **star:5076** 可靠的、高性能的和线程安全的数据结构的集合。![star > 5000][Gold]   
...
* [gods](https://github.com/emirpasic/gods) - **star:6160** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。![star > 5000][Gold]   
* [golang-set](https://github.com/deckarep/golang-set) - **star:1135** 线程安全和非线程安全的高性能集。![star > 1000][Silver]   
...
* [roaring](https://github.com/RoaringBitmap/roaring) - **star:647** 实现了压缩 bitsets 的Go包。![star > 100][Bronze]   
...
* [badger](https://github.com/dgraph-io/badger) - **star:6164** 快速 K/V 存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [bolt](https://github.com/boltdb/bolt) - **star:9901** K/V 数据库。![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
* [cockroach](https://github.com/cockroachdb/cockroach) - **star:16623** 可伸缩、区域备份、事务性数据存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [couchcache](https://github.com/codingsince1985/couchcache) - **star:40** 由 Couchbase服务 支持的RESTful缓存微服务。
* [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) - **star:1438** 区块链领域的一个SQL数据库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [dgraph](https://github.com/dgraph-io/dgraph) - **star:10011** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [fastcache](https://github.com/VictoriaMetrics/fastcache) - **star:471** 基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。![star > 100][Bronze]   
* [GCache](https://github.com/bluele/gcache) - **star:871** 支持过期缓存、LFU、LRU和ARC的缓存库。![star > 100][Bronze]   
* [go-cache](https://github.com/pmylund/go-cache) - **star:2819** 基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。![star > 1000][Silver]   
* [goleveldb](https://github.com/syndtr/goleveldb) - **star:3121** 在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。![star > 1000][Silver]   
* [gorocksdb](https://github.com/kapitan-k/gorocksdb) - **star:8** 用 Go 对[RocksDB](https://rocksdb.org)实现了封装。![最近一年没有更新][Yellow]
* [groupcache](https://github.com/golang/groupcache) - **star:7581** Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。![star > 5000][Gold]   
* [influxdb](https://github.com/influxdb/influxdb) - **star:16796** 可伸缩的数据存储，用于指标衡量、事件和实时分析。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [prometheus](https://github.com/prometheus/prometheus) - **star:25104** 用于监控系统和时序的数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [pudge](https://github.com/recoilme/pudge) - **star:219** 使用Go的标准库编写的快速和简单的键/值存储。![star > 100][Bronze]   
* [rqlite](https://github.com/rqlite/rqlite) - **star:4658** 基于SQLite的轻量级分布式关系数据库。![star > 1000][Silver]   
...
* [tidb](https://github.com/pingcap/tidb) - **star:19686** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - **star:918** 开源，快速，可伸缩的时间序列数据库。支持PromQL。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gormigrate](https://github.com/go-gormigrate/gormigrate) - **star:323** 面向Gorm ORM的数据库 schema 迁移辅助程序。![star > 100][Bronze]   
* [migrate](https://github.com/golang-migrate/migrate) - **star:2495** 基于CLI的数据库迁移库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [octillery](https://github.com/knocknote/octillery) - **star:51** 用于数据库分表(支持每个ORM或原生SQL)。![最近一个周有更新][Green]
* [orchestrator](https://github.com/github/orchestrator) - **star:2982** MySQL复制拓扑管理器和可视化工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [vitess](https://github.com/youtube/vitess) - **star:8322** vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gendry](https://github.com/didi/gendry) - **star:737** 非入侵的SQL构建器和强大的数据绑定器。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [godbal](https://github.com/xujiajun/godbal) - **star:50** 数据库抽象层(dbal)。支持SQL builder，轻松获取结果。
* [goqu](https://github.com/doug-martin/goqu) - **star:595** 常用的SQL生成器和查询库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [Squirrel](https://github.com/Masterminds/squirrel) - **star:2210** 帮助您构建SQL查询的Go库。![star > 1000][Silver]   
* [xo](https://github.com/knq/xo) - **star:2145** 基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。![star > 1000][Silver]   
...
* Relational Databases
    ...
    * [go-mssqldb](https://github.com/denisenkom/go-mssqldb) - **star:1005** 微软MSSQL驱动程序。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [go-oci8](https://github.com/mattn/go-oci8) - **star:398** Oracle 驱动程序。![star > 100][Bronze]   
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - **star:7949** MySQL驱动程序。![star > 5000][Gold]   
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - **star:3382** SQLite3驱动程序。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [pgx](https://github.com/jackc/pgx) - **star:1872** PostgreSQL驱动，支持比现有database/sql更多的特性。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [pq](https://github.com/lib/pq) - **star:5106** 纯 Go 的Postgres驱动。![star > 5000][Gold]   
...
* NoSQL Databases
    ...
    * [go-rejson](https://github.com/nitishm/go-rejson) - **star:86** 实现了基于 Redigo 客户端的redislabs' ReJSON 模块。可简单地将结构体存储为JSON对象并对其进行操作。
    ...
    * [gorethink](https://github.com/dancannon/gorethink) - **star:1455** RethinkDB 驱动。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [goriak](https://github.com/zegl/goriak) - **star:24**  Riak KV 驱动。
    * [mgo](https://github.com/globalsign/mgo) - **star:1616** (已停止维护) MongoDB驱动。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - **star:2955** 官方的 MongoDB 驱动。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [redigo](https://github.com/gomodule/redigo) - **star:6179** Redigo 是基于 Go 的Redis 客户端。![star > 5000][Gold]   
    * [redis](https://github.com/go-redis/redis) - **star:6292** 基于 Go 的 Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [xredis](https://github.com/shomali11/xredis) - **star:9** 类型安全，可定制，清晰和易用的Redis客户端。

* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) - **star:5760** 基于 Go 的现代文本索引库。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [elastic](https://github.com/olivere/elastic) - **star:4040** Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [elasticsql](https://github.com/cch123/elasticsql) - **star:376** 将 SQL 转换为 elasticsearch dsl。![star > 100][Bronze]   
    * [elastigo](https://github.com/mattbaird/elastigo) - **star:948** Elasticsearch 客户端。![star > 100][Bronze]   
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - **star:1498** 官方 Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [dragonboat](https://github.com/lni/dragonboat) - **star:2472** 一个功能齐全，高性能的库集。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [emitter-io](https://github.com/emitter-io/emitter) - **star:1889** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。![star > 1000][Silver]   
...
* [go-kit](https://github.com/go-kit/kit) - **star:14213** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。![star > 5000][Gold]   
* [gorpc](https://github.com/valyala/gorpc) - **star:548** 简单、快速和可伸缩的RPC库。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [grpc-go](https://github.com/grpc/grpc-go) - **star:8855** gRPC的Go语言实现。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hprose](https://github.com/hprose/hprose-golang) - **star:993** 支持25+种语言RPC库。![star > 100][Bronze]   
* [jaeger](https://github.com/jaegertracing/jaeger) - **star:8472** 分布式跟踪系统。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [KrakenD](https://github.com/devopsfaith/krakend) - **star:1692** 具有中间件的高性能API网关框架。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [micro](https://github.com/micro/micro) - **star:6482** 可插拔的微服务 toolkit 和分布式系统平台。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) - **star:6144** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [raft](https://github.com/hashicorp/raft) - **star:2802** Raft consensus协议的实现。 by HashiCorp。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [email](https://github.com/jordan-wright/email) - **star:1082** 一个强大和灵活的电子邮件库。![star > 1000][Silver]   
* [go-dkim](https://github.com/toorop/go-dkim) - **star:46** DKIM库，用于签署 & 验证电子邮件。
* [go-imap](https://github.com/emersion/go-imap) - **star:712** 用于客户端和服务器的IMAP库。![star > 100][Bronze]   
...
* [MailHog](https://github.com/mailhog/MailHog) - **star:5078** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [expr](https://github.com/antonmedv/expr) - **star:671** 一个可以计算表达式的引擎。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-lua](https://github.com/Shopify/go-lua) - **star:1651** 用 Go 实现的 Lua 5.2 VM接口。![star > 1000][Silver]   
...
* [gopher-lua](https://github.com/yuin/gopher-lua) - **star:2922** 用 Go 实现的 Lua 5.1 虚拟机和编译器。![star > 1000][Silver]   
...
* [otto](https://github.com/robertkrimen/otto) - **star:4672** 用 Go 编写的 JavaScript 解释器。![star > 1000][Silver]   
...
* [errors](https://github.com/pkg/errors) - **star:4770** 可让你很简单的进行错误处理。![star > 1000][Silver]   
...
* [tracerr](https://github.com/ztrue/tracerr) - **star:492** 可展示错误的堆栈跟踪信息和源码片段。![star > 100][Bronze]   
...
* [pdfcpu](https://github.com/hhrutter/pdfcpu) - **star:932** PDF处理器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [fpGo](https://github.com/TeaEntityLab/fpGo) - **star:103** 提供函数式编程功能。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [fuego](https://github.com/seborama/fuego) - **star:33** Functional Experiment in Go。
* [go-underscore](https://github.com/tobyhede/go-underscore) - **star:1063** 常用辅助方法集合。![star > 1000][Silver]   
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) - **star:1800** 很简单的 2D 游戏库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [engo](https://github.com/EngoEngine/engo) - **star:1076** 开源 2D 游戏引擎。它遵循 Entity-Component-System 范式。![star > 1000][Silver]   
...
* [go-sdl2](https://github.com/veandco/go-sdl2) - **star:1140** 实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Leaf](https://github.com/name5566/leaf) - **star:3019** 轻量级游戏服务器框架。![star > 1000][Silver]   
* [nano](https://github.com/lonng/nano) - **star:968** 轻量级、方便、高性能的基于golang的游戏服务器框架。![star > 100][Bronze]   
...
* [Pixel](https://github.com/faiface/pixel) - **star:2394** 手工制作的 2D 游戏库。![star > 1000][Silver]   
...
* [gen](https://github.com/clipperhouse/gen) - **star:1027** 用于生成泛型等类似方法的功能代码生成工具。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) - **star:1777** 提供类似 .NET LINQ 的查询方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [goderive](https://github.com/awalterschulze/goderive) - **star:728** 从输入类型来派生函数。![star > 100][Bronze]   
* [gotype](https://github.com/wzshiming/gotype) - **star:20** Golang 源码解析，用法类似reflect(反射)。
* [GoWrap](https://github.com/hexdigest/gowrap) - **star:260** 使用简单模板为 Go 接口生成装饰器。![star > 100][Bronze]   
...
* [Tile38](https://github.com/tidwall/tile38) - **star:6279** 具有空间索引和实时地理定位功能的地理定位数据库。![star > 5000][Gold]   
...
* [gopherjs](https://github.com/gopherjs/gopherjs) - **star:8472** 将 Go 编译成 JavaScript。![star > 5000][Gold]   
...
* [ants](https://github.com/panjf2000/ants) - **star:1782** 一个高性能的协程池。![star > 1000][Silver]   
...
* [Hunch](https://github.com/AaronJan/Hunch) - **star:9** Hunch 提供了诸如 All、First、Retry、Waterfall 等功能，这使得异步流控制更加直观。
...
* [tunny](https://github.com/Jeffail/tunny) - **star:1312** golang 的协程池。![star > 1000][Silver]   
...
* [fyne](https://github.com/fyne-io/fyne) - **star:6106** 为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [go-astilectron](https://github.com/asticode/go-astilectron) - **star:2617** 使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。![star > 1000][Silver]   
...
* [gotk3](https://github.com/gotk3/gotk3) - **star:752** 实现了 GTK3 的 Go接口。![star > 100][Bronze]   
* [gowd](https://github.com/dtylman/gowd) - **star:207** 跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。![star > 100][Bronze]   
* [qt](https://github.com/therecipe/qt) - **star:5895** 实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。![star > 5000][Gold]   
* [ui](https://github.com/andlabs/ui) - **star:6851** 跨平台的 Platform-native GUI 库。![star > 5000][Gold]   
* [Wails](https://wails.app) - Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。
* [walk](https://github.com/lxn/walk) - **star:3649** Windows应用程序库。![star > 1000][Silver]   
* [webview](https://github.com/zserge/webview) - **star:4558** 跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [robotgo](https://github.com/go-vgo/robotgo) - **star:4379** 实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [systray](https://github.com/getlantern/systray) - **star:766** 跨平台 Go 库，可在通知区放置图标和菜单。![star > 100][Bronze]   
...
* [bild](https://github.com/anthonynsimon/bild) - **star:2025** 纯Go语言实现的图像处理算法合集。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [bimg](https://github.com/h2non/bimg) - **star:779** 使用libvips实现的快速高效的图像处理包。![star > 100][Bronze]   
...
* [go-nude](https://github.com/koyachi/go-nude) - **star:287** Go语言实现的裸照检测工具。![star > 100][Bronze]   
...
* [gocv](https://github.com/hybridgroup/gocv) - **star:2392** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [imaginary](https://github.com/h2non/imaginary) - **star:2558** 用于图像大小调整的快速、简单的HTTP微服务。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [resize](https://github.com/nfnt/resize) - **star:2115** Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
* [stegify](https://github.com/DimitarPetrov/stegify) - **star:485**  Go实现的LSB隐写（LSB steganography），能够隐藏任何文件到一个图像中。![star > 100][Bronze]   
...
* [mainflux](https://github.com/Mainflux/mainflux) - **star:570** 工业物联网消息和设备管理服务器。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [periph](https://periph.io/) - 外围设备I/O与低级板(low-level board)设备接口。
* [sensorbee](https://github.com/sensorbee/sensorbee) - **star:178** 轻量级物联网流处理引擎。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [jobs](https://github.com/albrow/jobs) - **star:450** 持久和灵活的后台作业库。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [GJSON](https://github.com/tidwall/gjson) - **star:4783** 使用一行代码获取JSON的值。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [glog](https://github.com/golang/glog) - **star:2282** 为Go提供了多等级日志记录。![star > 1000][Silver]   
...
* [logrus](https://github.com/Sirupsen/logrus) - **star:11650** Go的结构化日志操作 。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [lumberjack](https://github.com/natefinch/lumberjack) - **star:1401** 简单的滚动日志，io.WriteCloser的实现。![star > 1000][Silver]   
...
* [spew](https://github.com/davecgh/go-spew) - **star:3249** 为Go数据结构实现一个漂亮的printer用于帮助调试。![star > 1000][Silver]   
...
* [zap](https://github.com/uber-go/zap) - **star:7266** 快速、结构化、多等级的日志记录。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-deep](https://github.com/patrikeh/go-deep) - **star:215** 一个功能丰富的神经网络库 。![star > 100][Bronze]   
...
* [gorgonia](https://github.com/chewxy/gorgonia) - **star:2658** 基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。![star > 1000][Silver]   
* [gorse](https://github.com/zhenghaoz/gorse) - **star:516** 基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [goscore](https://github.com/asafschers/goscore) - **star:34**  为预言模型标记语言（PMML）实现的评分API。
* [gosseract](https://github.com/otiai10/gosseract) - **star:852** 使用c++的Tesseract库实现的OCR。![star > 100][Bronze]   
...
* [ocrserver](https://github.com/otiai10/ocrserver) - **star:218** 一个简单的OCR API服务器，非常容易地使用Docker和Heroku部署。![star > 100][Bronze]   
...
* [tfgo](https://github.com/galeone/tfgo) - **star:1169** 易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。![star > 1000][Silver]   
...
* [unioffice](https://github.com/unidoc/unioffice) - **star:1642** 用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [archiver](https://github.com/mholt/archiver) - **star:2461** 用于生成和提取.zip和.tar.gz存档的库和命令。![star > 1000][Silver]   
...
* [battery](https://github.com/distatus/battery) - **star:135** 跨平台、标准化的电池信息库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) - **star:659** Golang的通用对象池。![star > 100][Bronze]   
* [go-openapi](https://github.com/go-openapi) - 用于解析和利用开放api模式的包的集合。
* [go-resiliency](https://github.com/eapache/go-resiliency) - **star:838**  Go 的弹性模式。![star > 100][Bronze]   
...
* [lk](https://github.com/hyperboloide/lk) - **star:113** 一个简单的golang授权库。![star > 100][Bronze]   
...
* [persian](https://github.com/mavihq/persian) - **star:34** 一些实用的波斯语在 Go 。
...
* [go-unidecode](https://github.com/mozillazg/go-unidecode) - **star:55** Unicode文本的ASCII音译。
...
* [whatlanggo](https://github.com/abadojack/whatlanggo) - **star:347** Go的自然语言检测包。支持84种语言和24种脚本(书写系统，如拉丁语、西里尔语等)。![star > 100][Bronze]   
...
* [dns](https://github.com/miekg/dns) - **star:3748** 使用DNS的库。![star > 1000][Silver]   
...
* [fasthttp](https://github.com/valyala/fasthttp) - **star:9102** 软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [fortio](https://github.com/fortio/fortio) - **star:849** 负载测试库和命令行工具，先进的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。Tcp、Http、gRPC。![star > 100][Bronze]   
...
* [gopacket](https://github.com/google/gopacket) - **star:2812** 使用libpcap绑定访问包处理库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gotcp](https://github.com/gansidui/gotcp) - **star:410**  Go 包快速编写tcp应用程序。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [kcp-go](https://github.com/xtaci/kcp-go) - **star:2219** 快速可靠的ARQ协议。![star > 1000][Silver]   
* [kcptun](https://github.com/xtaci/kcptun) - **star:10583** 非常简单和快速udp隧道基于KCP协议。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [tcp_server](https://github.com/firstrow/tcp_server) - **star:280**  Go 图书馆建设tcp服务器更快。![star > 100][Bronze]   
...
* [water](https://github.com/songgao/water) - **star:832** 简单TUN / TAP图书馆。![star > 100][Bronze]   
* [webrtc](https://github.com/pions/webrtc) - **star:2130** WebRTC API的纯Go实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [winrm](https://github.com/masterzen/winrm) - **star:210**  Go WinRM客户端远程执行Windows机器上的命令。![star > 100][Bronze]   
* [xtcp](https://github.com/xfxdev/xtcp) - **star:81** TCP服务器框架具有同时全双工通信，优雅关机，自定义协议。
...
* [heimdall](https://github.com/gojektech/heimdall) - **star:1059** 具有重试和hystrix功能的增强http客户机。![star > 1000][Silver]   
...
* [sling](https://github.com/dghubble/sling) - **star:905** Sling是一个用于创建和发送API请求的Go HTTP客户端库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [glfw](https://github.com/go-gl/glfw) - **star:721** Go绑定用于glfw3。![star > 100][Bronze]   
...
* [mathgl](https://github.com/go-gl/mathgl) - **star:287** 纯Go数学软件包专门为三维数学，与灵感来自GLM。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-pg](https://github.com/go-pg/pg) - **star:2911** 关注PostgreSQL的特性和性能。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) - **star:225** 一个灵活而强大的SQL字符串构建器库加上一个零配置ORM。![star > 100][Bronze]   
* [go-store](https://github.com/gosuri/go-store) - **star:93** 简单而快速的Redis支持的键值存储库。![最近一年没有更新][Yellow]
* [GORM](https://github.com/jinzhu/gorm) - **star:14324** Golang出色的ORM库的目标是对开发人员友好。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [gorp](https://github.com/go-gorp/gorp) - **star:3066** Go的关系持久性，ORM-ish库。![star > 1000][Silver]   
* [grimoire](https://github.com/Fs02/grimoire) - **star:114** Grimoire是golang的数据库访问层和验证。(支持:MySQL, PostgreSQL和SQLite3)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [upper.io/db](https://github.com/upper/db) - **star:1832** 通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Xorm](https://github.com/go-xorm/xorm) - **star:5072** 简单而强大的ORM for Go。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dep](https://github.com/golang/dep) - **star:12472**  Go 的依赖管理工具，需要 Go 1.9+![star > 5000][Gold]   
...
* [glide](https://github.com/Masterminds/glide) - **star:7748** 轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [govendor](https://github.com/kardianos/govendor) - **star:4691** 包管理器。使用 vendor 文件的 Go vendor 工具。![star > 1000][Silver]   
...
* [gojsonq](https://github.com/thedevsaddam/gojsonq) - **star:843** 一个用来查询JSON数据的Go包。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [graphql-go](https://github.com/graphql-go/graphql) - **star:5102** 为Go实现GraphQL。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go.rice](https://github.com/GeertJohan/go.rice) - **star:1622** go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。![star > 1000][Silver]   
...
* [statik](https://github.com/rakyll/statik) - **star:2055** 将静态文件嵌入到Go可执行文件中。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [chart](https://github.com/vdobler/chart) - **star:579** 简单的图表绘制库。支持多种图形类型。![star > 100][Bronze]   
...
* [gonum](https://github.com/gonum/gonum) - **star:2881** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gonum/plot](https://github.com/gonum/plot) - **star:1195** gonum/plot提供了一个API，用于在Go中构建和绘制绘图。![star > 1000][Silver]   
* [goraph](https://github.com/gyuho/goraph) - **star:596** 纯Go图论库(数据结构，算法可视化)。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [gosl](https://github.com/cpmech/gosl) - **star:1294** 提供线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程，等等。![star > 1000][Silver]   
...
* [Cameradar](https://github.com/Ullaakut/cameradar) - **star:1794** 工具和库，以远程入侵RTSP流从监控摄像头。![star > 1000][Silver]   
* [certificates](https://github.com/mvmaasakkers/certificates) - **star:6** 用于生成tls证书的自定义工具。
* [go-yara](https://github.com/hillu/go-yara) - **star:131** YARA的 Go 语言接口，号称是 “对于恶意软件研究者（以及其他人）来说是模式匹配的瑞士军刀”![star > 100][Bronze]   
...
* [secure](https://github.com/unrolled/secure) - **star:1190** Go 语言 HTTP 中间件，为 Go 提供了一些安全功能![star > 1000][Silver]   
...
* [csvutil](https://github.com/jszwec/csvutil) - **star:300** 高性能、惯用的CSV记录编码和解码到本机Go结构。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gogoprotobuf](https://github.com/gogo/protobuf) - **star:2872** Go 语言的 Protocol Buffer 库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [goprotobuf](https://github.com/golang/protobuf) - **star:4958** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.![star > 1000][Silver]   ![最近一个周有更新][Green]
* [jsoniter](https://github.com/json-iterator/go) - **star:5365** 高性能，100% 兼容的“encoding/json” 替代品![star > 5000][Gold]   ![最近一个周有更新][Green]
* [mapstructure](https://github.com/mitchellh/mapstructure) - **star:2357** 用于对原生键值对进行解码生成 Go 语言结构体![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Caddy](https://github.com/mholt/caddy) - **star:22854** Caddy是另一种HTTP/2 web服务器，易于配置和使用。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [discovery](https://github.com/Bilibili/discovery) - **star:649** 用于弹性中间层负载平衡和故障转移的注册表。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [etcd](https://github.com/coreos/etcd) - **star:26015** 为共享配置和服务发现提供高可用的键值存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [minio](https://github.com/minio/minio) - **star:16977** Minio是一个分布式对象存储服务器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [RoadRunner](https://github.com/spiral/roadrunner) - **star:3159** 高性能PHP应用服务器，负载平衡器和进程管理器。![star > 1000][Silver]   
...
* [gofpdf](https://github.com/jung-kurt/gofpdf) - **star:3031** PDF 文档生成器，支持文本，绘图和图片![star > 1000][Silver]   
...
* [jet](https://github.com/CloudyKit/jet) - **star:579** Jet模板引擎。![star > 100][Bronze]   
...
* [pongo2](https://github.com/flosch/pongo2) - **star:1482** 类似 DjanGo 的模板引擎![star > 1000][Silver]   
* [quicktemplate](https://github.com/valyala/quicktemplate) - **star:1378** 快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译![star > 1000][Silver]   
...
* Mock
    ...
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - **star:1670** Mock SQL ，用于测试数据库交互![star > 1000][Silver]   
    * [go-txdb](https://github.com/DATA-DOG/go-txdb) - **star:156** 基于单事务的数据库驱动，主要用于测试目的![star > 100][Bronze]   
    * [gock](https://github.com/h2non/gock) - **star:793** 多功能、易用 HTTP mock![star > 100][Bronze]   
    ...
    * [httpmock](https://github.com/jarcoal/httpmock) - **star:567** 轻松模拟来自外部资源的HTTP响应。![star > 100][Bronze]   
...
* Fuzzing and delta-debugging/reducing/shrinking.
    * [go-fuzz](https://github.com/dvyukov/go-fuzz) - **star:2848** 随机测试系统。![star > 1000][Silver]   
...
* Selenium and browser control tools.
    ...
    * [chromedp](https://github.com/knq/chromedp) - **star:3449** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* Specific Formats
    ...
    * [blackfriday](https://github.com/russross/blackfriday) - **star:3824** Markdown 解析器![star > 1000][Silver]   
    * [bluemonday](https://github.com/microcosm-cc/bluemonday) - **star:1219** HTML 清理工具![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [codetree](https://github.com/aerogo/codetree) - **star:7** 解析缩进代码(python、pixy、scarlet等)并返回树结构。
    * [colly](https://github.com/asciimoo/colly) - **star:8152** 快速和优雅的 Scraping 框架。![star > 5000][Gold]   
    ...
    * [editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) - **star:37** Editorconfig文件解析器和Go操作器。![最近一个周有更新][Green]
    ...
    * [go-toml](https://github.com/pelletier/go-toml) - **star:600** 使用带有查询支持和方便的cli工具的TOML格式库。![star > 100][Bronze]   
    ...
    * [GoQuery](https://github.com/PuerkitoBio/goquery) - **star:7460** GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能![star > 5000][Gold]   
    ...
    * [toml](https://github.com/BurntSushi/toml) - **star:2738** TOML配置格式(带反射的编码器/解码器)。![star > 1000][Silver]   
* Utility
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - **star:4966** AWS 提供的官方go语言 SDK![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [github](https://github.com/google/go-github) - **star:4705** 访问GitHub REST API v3的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-jira](https://github.com/andygrunwald/go-jira) - **star:558**  Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-twitter](https://github.com/dghubble/go-twitter) - **star:700**  Twitter v1.1 api 的客户端。。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [google](https://github.com/google/google-api-go-client) - **star:1902** 为Go自动生成谷歌api。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [slack](https://github.com/nlopes/slack) - **star:2371** Slack API。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [circuit](https://github.com/cep21/circuit) - **star:319** 一个高效和功能齐全的 类似 Hystrix Go 实现断路器模式。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) - **star:779** 接通断路器。![star > 100][Bronze]   
...
* [ctop](https://github.com/bcicen/ctop) - **star:8694** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [delve](https://github.com/derekparker/delve) - **star:11798** Go 语言调试器![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [fzf](https://github.com/junegunn/fzf) - **star:22656** 用Go编写的命令行模糊查找器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-funk](https://github.com/thoas/go-funk) - **star:1124** 现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)![star > 1000][Silver]   
...
* [go-torch](https://github.com/uber/go-torch) - **star:3623** 为 Go 语言程序生成火焰图。![star > 1000][Silver]   
...
* [godropbox](https://github.com/dropbox/godropbox) - **star:3731** 用于编写 Go 语言服务／应用的库，来自 Dropbox.。![star > 1000][Silver]   
...
* [goreleaser](https://github.com/goreleaser/goreleaser) - **star:4422** 尽可能快速的发布 Go 语言二进制文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gubrak](https://github.com/novalagung/gubrak) - **star:135** 带有语法糖的Golang实用工具，就像lodash。![star > 100][Bronze]   
...
* [hub](https://github.com/github/hub) - **star:16756** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hystrix-go](https://github.com/afex/hystrix-go) - **star:1966** 实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。![star > 1000][Silver]   
...
* [jump](https://github.com/gsamokovarov/jump) - **star:646** 通过学习你的习惯，可以帮助你更快地导航。![star > 100][Bronze]   
...
* [mc](https://github.com/minio/mc) - **star:1082** Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [minify](https://github.com/tdewolff/minify) - **star:1844** 用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。![star > 1000][Silver]   
...
* [mole](https://github.com/davrodpin/mole) - **star:1297** cli应用程序可以轻松创建ssh隧道。![star > 1000][Silver]   
...
* [resty](https://github.com/go-resty/resty) - **star:1837** 简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。![star > 1000][Silver]   
...
* [sqlx](https://github.com/jmoiron/sqlx) - **star:6652** 为内建的数据库/sql 软件包提供一组扩展。![star > 5000][Gold]   
...
* [Task](https://github.com/go-task/task) - **star:1870** 简单的“Go”的选择。![star > 1000][Silver]   
...
* [uuid](https://github.com/gofrs/uuid) - **star:558** 通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。![star > 100][Bronze]   
...
* [validator](https://github.com/go-playground/validator) - **star:3386**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-git](https://github.com/src-d/go-git) - **star:4139** 纯Go中高度可扩展的Git实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-vcs](https://github.com/sourcegraph/go-vcs) - **star:69** 在Go中操作和检查VCS存储库。![最近一个周有更新][Green]
* [hercules](https://github.com/src-d/hercules) - **star:509** 从Git存储库历史中获得高级见解。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [goav](https://github.com/giorgisio/goav) - **star:765** FFmpeg的Comphrensive。![star > 100][Bronze]   
* [gst](https://github.com/ziutek/gst) - **star:152**  GStreamer的Go工具。![star > 100][Bronze]   
...
* [Goa](https://github.com/goadesign/goa) - **star:3470** Goa为在Go中开发远程api和微服务提供了一种全面的方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Revel](https://github.com/revel/revel) - **star:11197** 用于Go语言的高效web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [vox](https://github.com/aisk/vox) - **star:36** 一个面向人类的golang web框架，深受Koa的启发。
...
* [client-timing](https://github.com/posener/client-timing) - **star:12** 用于服务器定时报头的HTTP客户机。
* [CORS](https://github.com/rs/cors) - **star:1191** 轻松地向API添加CORS功能。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Limiter](https://github.com/ulule/limiter) - **star:774** 简单的速度限制中间件。![star > 100][Bronze]   
* [ln-paywall](https://github.com/philippgille/ln-paywall) - **star:86** 使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。
* [Tollbooth](https://github.com/didip/tollbooth) - **star:1226** 限制速率的 HTTP 请求处理程序。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [XFF](https://github.com/sebest/xff) - **star:72** 处理 X-Forwarded-For 头的中间件。

#### 用于创建HTTP中间件的库

* [alice](https://github.com/justinas/alice) - **star:1812** 用于连接中间件的库，简单无痛苦。![star > 1000][Silver]   
...
* [negroni](https://github.com/urfave/negroni) - **star:6296** 符合语言习惯的 HTTP 中间件库。![star > 5000][Gold]   
...
* [chi](https://github.com/go-chi/chi) - **star:5920** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [httprouter](https://github.com/julienschmidt/httprouter) - **star:9550** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。![star > 5000][Gold]   
...
* [mux](https://github.com/gorilla/mux) - **star:9489** 强大的URL路由器和调度器为golang。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [XML-Comp](https://github.com/xml-comp/xml-comp) - **star:15** 简单的命令行XML比较器，生成文件夹、文件和标记的差异。![最近一年没有更新][Yellow]
...
* [xpath](https://github.com/antchfx/xpath) - **star:156** Go的XPath包。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [xquery](https://github.com/antchfx/xquery) - **star:145** XQuery允许您使用XPath表达式从HTML/XML文档中提取数据。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [zek](https://github.com/miku/zek) - **star:246** 从XML生成Go结构。![star > 100][Bronze]   
...
* [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) - **star:180** 找出项目中过期的依赖项。![star > 100][Bronze]   
...
* [GoLint](https://github.com/golang/lint) - **star:3118** Go 源码的 linter。![star > 1000][Silver]   
...
* [go-mode](https://github.com/dominikh/go-mode.el) - **star:943** 在 GNU/Emacs 支持 GO。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [vscode-go](https://github.com/Microsoft/vscode-go) - **star:5063** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [genny](https://github.com/cheekybits/genny) - **star:932** 优雅的 Go 泛型。![star > 100][Bronze]   
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **star:1952** 使用 dot format 可视化 Go 程序的调用图。![star > 1000][Silver]   
* [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) - **star:37** Bash completion for go and wgo。![最近一年没有更新][Yellow]
* [go-swagger](https://github.com/go-swagger/go-swagger) - **star:3879** 基于 Go 的Swagger 2.0实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [godbg](https://github.com/tylerwince/godbg) - **star:157** 实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。![star > 100][Bronze]   
* [OctoLinker](https://github.com/OctoLinker/browser-extension) - **star:3710** 借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [bombardier](https://github.com/codesenberg/bombardier) - **star:1695** 快速跨平台 HTTP 基准测试工具。![star > 1000][Silver]   
* [bosun](https://github.com/bosun-monitor/bosun) - **star:2849** 按照时间轴发出告警的框架。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Gitea](https://github.com/go-gitea/gitea) - **star:14807** 从 Gogs fork，完全由社区驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-furnace](https://github.com/go-furnace/go-furnace) - **star:63** 用Go编写的托管解决方案，可轻松地在AWS、GCP或DigitalOcean上部署应用程序。
...
* [govvv](https://github.com/ahmetalpbalkan/govvv) - **star:376** 可轻松地添加版本信息到 Go 二进制文件。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [gox](https://github.com/mitchellh/gox) - **star:3333** 非常简单，没有多余的跨平台编译工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [GVM](https://github.com/moovweb/gvm) - **star:4433** GVM 提供了一个接口来管理 Go 版本。![star > 1000][Silver]   
* [Hey](https://github.com/rakyll/hey) - **star:6136** 压力测试工具，可用来代替 ApacheBench (ab)。![star > 5000][Gold]   
...
* [kubernetes](https://github.com/kubernetes/kubernetes) - **star:55262** 来自谷歌的容器集群管理器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Moby](https://github.com/moby/moby) - **star:54113** Collaborative project for the container ecosystem to assemble container-based systems.![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Packer](https://github.com/mitchellh/packer) - **star:9116** 用于从一个源配置为多个平台创建相同的机器图像。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [script](https://github.com/bitfield/script) - **star:869** 让DevOps编写类shell和系统管理任务变得更加容易。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [traefik](https://github.com/containous/traefik) - **star:23335** 反向代理和负载均衡器，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Vegeta](https://github.com/tsenart/vegeta) - **star:11954** HTTP负载测试工具和库。超过9000 !![star > 5000][Gold]   
* [webhook](https://github.com/adnanh/webhook) - **star:4011** 允许用户创建在服务器上执行命令的 HTTP hooks。![star > 1000][Silver]   
...
* [Comcast](https://github.com/tylertreat/Comcast) - **star:6152** 模拟坏的网络连接。![star > 5000][Gold]   
* [confd](https://github.com/kelseyhightower/confd) - **star:6353** 使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。![star > 5000][Gold]   
...
* [drive](https://github.com/odeke-em/drive) - **star:4930** 基于命令行的谷歌驱动器客户端。![star > 1000][Silver]   
* [Duplicacy](https://github.com/gilbertchen/duplicacy) - **star:2668** 跨平台网络和云备份工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gfile](https://github.com/Antonito/gfile) - **star:494** 通过WebRTC在两台计算机之间安全地传输文件，不需要任何第三方依赖。![star > 100][Bronze]   
...
* [gocc](https://github.com/goccmack/gocc) - **star:340** Gocc是一个用Go编写的编译器工具包。![star > 100][Bronze]   
...
* [joincap](https://github.com/assafmo/joincap) - **star:118** 用于合并多个pcap文件的命令行实用程序。![star > 100][Bronze]   
...
* [lgo](https://github.com/yunabe/lgo) - **star:1775** 与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [toxiproxy](https://github.com/shopify/toxiproxy) - **star:3798** 为自动化测试模拟网络和系统条件的代理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [GoBooks](https://github.com/dariubs/GoBooks) - **star:6721** 一份精选的 Go 书籍清单。![star > 5000][Gold]   
...
* [gophers](https://github.com/ashleymcnamara/gophers) - **star:1822** 阿什莉·麦克纳马拉的歌斐艺术品。![star > 1000][Silver]   
...
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - **star:3994**  Go's reference card。![star > 1000][Silver]   
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) - **star:677** 引入示例讲述 Golang 与Node.js在学习上的差异。![star > 100][Bronze]   
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - **star:4153** 学习使用测试驱动开发。![star > 1000][Silver]   ![最近一个周有更新][Green]
