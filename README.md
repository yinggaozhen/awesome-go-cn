...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-08-12 09:57:59(每隔1天同步一次)**
...
* [Oto](https://github.com/hajimehoshi/oto) **star:438** 多平台的 low-level 声音播放库。   ![star > 100][Bronze]
...
* [mp3](https://github.com/tcolgate/mp3) **star:94** 原生 Go MP3解码器。   ![最近一年没有更新][Yellow]
...
* [taglib](https://github.com/wtolson/go-taglib) **star:65** taglib 的 Go 语言实现接口.   ![最近一年没有更新][Yellow]
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) **star:6026** JSON Web令牌(JWT)。   ![star > 5000][Gold]
* [casbin](https://github.com/hsluoyz/casbin) **star:4983** 支持ACL、RBAC、ABAC等访问控制模型的授权库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [oauth2](https://github.com/golang/oauth2) **star:2386** goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。   ![star > 1000][Silver]
* [goth](https://github.com/markbates/goth) **star:2279** 提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [authboss](https://github.com/volatiletech/authboss) **star:1936** web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。   ![star > 1000][Silver]
* [osin](https://github.com/openshift/osin) **star:1546** OAuth2服务器库。   ![star > 1000][Silver]
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) **star:1285** 用 Golang 编写的独立且符合规范的OAuth2服务器。   ![star > 1000][Silver]
* [go-jose](https://github.com/square/go-jose) **star:1126** 相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。   ![star > 1000][Silver]
* [gologin](https://github.com/dghubble/gologin) **star:1042** 用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gorbac](https://github.com/mikespook/gorbac) **star:912** 轻量级的基于角色的访问控制(RBAC)实现。   ![star > 100][Bronze]
* [loginsrv](https://github.com/tarent/loginsrv) **star:820** JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。   ![star > 100][Bronze]
...
* [telebot](https://github.com/tucnak/telebot) **star:953** 用Go编写的Telegram bot框架。   ![star > 100][Bronze]
* [go-chat-bot](https://github.com/go-chat-bot/bot) **star:469** 用 Go 编写的IRC, Slack和电报机器人。   ![star > 100][Bronze]
* [slacker](https://github.com/shomali11/slacker) **star:316** 可简单创建Slack机器人的框架。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [slackscot](https://github.com/alexandre-normand/slackscot) **star:11** 另一个构建Slack机器人的框架。
...
* [cobra](https://github.com/spf13/cobra) **star:13389** 现代Go CLI命令行交互工具。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [urfave/cli](https://github.com/urfave/cli) **star:11466** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [kingpin](https://github.com/alecthomas/kingpin) **star:2536** 支持子命令的命令行和标志解析器。   ![star > 1000][Silver]
* [go-flags](https://github.com/jessevdk/go-flags) **star:1508**  Go 命令行选项解析器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [go-arg](https://github.com/alexflint/go-arg) **star:730** 基于结构的参数解析。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [mow.cli](https://github.com/jawher/mow.cli) **star:623** 用于构建具有复杂标志和参数解析和验证的CLI应用程序。   ![star > 100][Bronze]
* [complete](https://github.com/posener/complete) **star:620** 使用 Go 语言编写的 bash 命令补全工具以及 Go 命令补全工具.   ![star > 100][Bronze]
* [liner](https://github.com/peterh/liner) **star:588** 类似readline-like的命令行接口库。   ![star > 100][Bronze]
* [cli](https://github.com/mkideal/cli) **star:479** 基于golang结构标签，功能丰富易于使用的命令行包。   ![star > 100][Bronze]
* [flaggy](https://github.com/integrii/flaggy) **star:453** 一个健壮的、易用的标志包，具有出色的子命令支持。   ![star > 100][Bronze]
* [ops](https://github.com/nanovms/ops) **star:264** Unikernel 构建器/协调器。   ![star > 100][Bronze]
...
* [sand](https://github.com/Zaba505/sand) **star:6** 用于创建解释器等的简单API。
...
* [termui](https://github.com/gizak/termui) **star:8942** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。   ![star > 5000][Gold]
* [gommon/color](https://github.com/labstack/gommon/tree/master/color)  更换终端文本样式。
* [gocui](https://github.com/jroimartin/gocui) **star:5390** 旨在创建控制台用户界面的极简Go库。   ![star > 5000][Gold]
* [termbox-go](https://github.com/nsf/termbox-go) **star:3492** 基于文本的跨平台接口库。   ![star > 1000][Silver]
* [color](https://github.com/fatih/color) **star:3023** 多功能包装，彩色终端输出。   ![star > 1000][Silver]   ![归档项目][Archived]
* [go-prompt](https://github.com/c-bata/go-prompt) **star:2341** 构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit)   ![star > 1000][Silver]
* [uiprogress](https://github.com/gosuri/uiprogress) **star:1543** 在终端呈现进度条，可灵活配置的。   ![star > 1000][Silver]
* [asciigraph](https://github.com/guptarohit/asciigraph) **star:1146** 在命令行中构建轻量级ASCII线图╭┈╯，应用程序中没有其他依赖项。   ![star > 1000][Silver]
* [uilive](https://github.com/gosuri/uilive) **star:833** 用于实时更新终端输出的库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [mpb](https://github.com/vbauerster/mpb) **star:705** 可在终端显示多进度条。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [aurora](https://github.com/logrusorgru/aurora) **star:637** 支持fmt.Printf/Sprintf的ANSI终端颜色。   ![star > 100][Bronze]
...
* [go-colorable](https://github.com/mattn/go-colorable) **star:377** 适用于windows的颜色编写器。   ![star > 100][Bronze]
...
* [gookit/color](https://github.com/gookit/color) **star:206** 终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。   ![star > 100][Bronze]   ![最近一周有更新][Green]   ![包含中文文档][CN]
...
* [viper](https://github.com/spf13/viper) **star:9379** 配置管理。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) **star:2413** 管理来自环境变量的配置数据。   ![star > 1000][Silver]
* [godotenv](https://github.com/joho/godotenv) **star:2135** Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。   ![star > 1000][Silver]
* [ini](https://github.com/go-ini/ini) **star:1598**  读和写INI文件。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [env](https://github.com/caarlos0/env) **star:874** 解析环境变量并赋值到struct中(默认值)。   ![star > 100][Bronze]
...
* [gookit/config](https://github.com/gookit/config) **star:85** 程序配置管理(load,get,set)。支持JSON, YAML, TOML, INI, HCL。支持多文件加载，数据覆盖合并。   ![包含中文文档][CN]
...
* [drone](https://github.com/drone/drone) **star:19078** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [goveralls](https://github.com/mattn/goveralls) **star:578** Coveralls.io 是一个用 Go 编写，可持续对代码覆盖率进行检测的系统。   ![star > 100][Bronze]
...
* [gods](https://github.com/emirpasic/gods) **star:6417** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。   ![star > 5000][Gold]
* [go-datastructures](https://github.com/Workiva/go-datastructures) **star:5136** 可靠的、高性能的和线程安全的数据结构的集合。   ![star > 5000][Gold]
...
* [gota](https://github.com/kniren/gota) **star:883** 实现了数据帧，序列以及数据噪音。   ![star > 100][Bronze]
* [willf/bloom](https://github.com/willf/bloom) **star:667** 实现Bloom过滤器。   ![star > 100][Bronze]
...
* [mafsa](https://github.com/smartystreets/mafsa) **star:272** 实现了 MA-FSA ，包含最小完美哈希。   ![star > 100][Bronze]   ![归档项目][Archived]
...
* [bloom](https://github.com/zhenjl/bloom) **star:127** 在Go中实现了Bloom过滤器。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [ttlcache](https://github.com/diegobernardes/ttlcache) **star:98** 基于内存的LRU算法实现。
...
* [deque](https://github.com/gammazero/deque) **star:66** 快速环缓冲区deque(双端队列)。
...
* [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) **star:27** 并行FIFO队列。
...
* [prometheus](https://github.com/prometheus/prometheus) **star:25638** 用于监控系统和时序的数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [tidb](https://github.com/pingcap/tidb) **star:20119** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [influxdb](https://github.com/influxdb/influxdb) **star:17138** 可伸缩的数据存储，用于指标衡量、事件和实时分析。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [cockroach](https://github.com/cockroachdb/cockroach) **star:16803** 可伸缩、区域备份、事务性数据存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [dgraph](https://github.com/dgraph-io/dgraph) **star:10480** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [bolt](https://github.com/boltdb/bolt) **star:9993** K/V 数据库。   ![star > 5000][Gold]   ![最近一年没有更新][Yellow]   ![归档项目][Archived]
...
* [buntdb](https://github.com/tidwall/buntdb) **star:2443** 基于内存的K/V，快速，可嵌入的数据库，可自定义索引和空间支持。   ![star > 1000][Silver]
* [tiedot](https://github.com/HouzuoGuo/tiedot) **star:2367** 属于你的NoSQL数据库。   ![star > 1000][Silver]
* [cache2go](https://github.com/muesli/cache2go) **star:1052** 基于内存的 K/V 缓存，支持超时的自动失效。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) **star:1019** 开源，快速，可伸缩的时间序列数据库。支持PromQL。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [GCache](https://github.com/bluele/gcache) **star:900** 支持过期缓存、LFU、LRU和ARC的缓存库。   ![star > 100][Bronze]
...
* [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) **star:877** 区块链领域的一个SQL数据库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [migrate](https://github.com/golang-migrate/migrate) **star:2762** 基于CLI的数据库迁移库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [sql-migrate](https://github.com/rubenv/sql-migrate) **star:1415** 数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。   ![star > 1000][Silver]
...
* [vitess](https://github.com/youtube/vitess) **star:8466** vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [pgweb](https://github.com/sosedoff/pgweb) **star:5996** 基于web的PostgreSQL数据库浏览器。   ![star > 5000][Gold]
* [kingshard](https://github.com/flike/kingshard) **star:4620** kingshard 是基于 Golang 的MySQL高性能代理。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [orchestrator](https://github.com/github/orchestrator) **star:3044** MySQL复制拓扑管理器和可视化工具。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) **star:2402** 自动将MySQL数据同步到Elasticsearch中。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [pREST](https://github.com/nuveo/prest) **star:2090** 基于PostgreSQL database的RESTful API服务。   ![star > 1000][Silver]
* [go-mysql](https://github.com/siddontang/go-mysql) **star:1894**  Go 工具集，用于处理MySQL协议和复制。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [chproxy](https://github.com/Vertamedia/chproxy) **star:308** ClickHouse数据库的HTTP代理。   ![star > 100][Bronze]
...
* Relational Databases
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) **star:8115** MySQL驱动程序。   ![star > 5000][Gold]
    * [pq](https://github.com/lib/pq) **star:5198** 纯 Go 的Postgres驱动。   ![star > 5000][Gold]
...
* Search and Analytic Databases.
    ...
    * [riot](https://github.com/go-ego/riot) **star:4702** 基于 Go 的 开源、分布式、简单高效的搜索引擎。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
    * [elastic](https://github.com/olivere/elastic) **star:4159** Elasticsearch 客户端。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) **star:1588** 官方 Elasticsearch 客户端。   ![star > 1000][Silver]
    * [elastigo](https://github.com/mattbaird/elastigo) **star:950** Elasticsearch 客户端。   ![star > 100][Bronze]
...
* [now](https://github.com/jinzhu/now) **star:2186** now 是时间有关的工具类。   ![star > 1000][Silver]
...
* [go-kit](https://github.com/go-kit/kit) **star:14484** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [grpc-go](https://github.com/grpc/grpc-go) **star:9142** gRPC的Go语言实现。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [micro](https://github.com/micro/micro) **star:6604** 可插拔的微服务 toolkit 和分布式系统平台。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) **star:6358** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [rpcx](https://github.com/smallnest/rpcx) **star:3814** 分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [tendermint](https://github.com/tendermint/tendermint) **star:3156** 一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [torrent](https://github.com/anacrolix/torrent) **star:2854** BitTorrent 客户端。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [raft](https://github.com/coreos/etcd/tree/master/raft)  Raft consensus协议的实现。 by CoreOS。
* [raft](https://github.com/hashicorp/raft) **star:2847** Raft consensus协议的实现。 by HashiCorp。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [dragonboat](https://github.com/lni/dragonboat) **star:2544** 一个功能齐全，高性能的库集。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [glow](https://github.com/chrislusf/glow) **star:2532** 全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。   ![star > 1000][Silver]
* [gleam](https://github.com/chrislusf/gleam) **star:2103** 使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。   ![star > 1000][Silver]
* [emitter-io](https://github.com/emitter-io/emitter) **star:1937** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [KrakenD](https://github.com/devopsfaith/krakend) **star:1762** 具有中间件的高性能API网关框架。   ![star > 1000][Silver]
* [hprose](https://github.com/hprose/hprose-golang) **star:1007** 支持25+种语言RPC库。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [MailHog](https://github.com/mailhog/MailHog) **star:5180** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。   ![star > 5000][Gold]
* [chasquid](https://blitiri.com.ar/p/chasquid)  用Go编写的SMTP服务器。
* [hermes](https://github.com/matcornic/hermes) **star:1619** 可生成干净的、响应式的HTML电子邮件。   ![star > 1000][Silver]
* [email](https://github.com/jordan-wright/email) **star:1094** 一个强大和灵活的电子邮件库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-imap](https://github.com/emersion/go-imap) **star:734** 用于客户端和服务器的IMAP库。   ![star > 100][Bronze]
...
* [go-message](https://github.com/emersion/go-message) **star:113** 用于Internet消息格式化和邮件消息的流媒体库。   ![star > 100][Bronze]
* [smtp](https://github.com/mailhog/smtp) **star:51** SMTP服务器协议状态机。   ![最近一年没有更新][Yellow]
* [go-dkim](https://github.com/toorop/go-dkim) **star:47** DKIM库，用于签署 & 验证电子邮件。
...
* [otto](https://github.com/robertkrimen/otto) **star:4736** 用 Go 编写的 JavaScript 解释器。   ![star > 1000][Silver]
* [gopher-lua](https://github.com/yuin/gopher-lua) **star:2966** 用 Go 实现的 Lua 5.1 虚拟机和编译器。   ![star > 1000][Silver]
* [go-lua](https://github.com/Shopify/go-lua) **star:1671** 用 Go 实现的 Lua 5.2 VM接口。   ![star > 1000][Silver]
* [tengo](https://github.com/d5/tengo) **star:1309** 字节码编译的脚本语言。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [anko](https://github.com/mattn/anko) **star:921** 用Go编写的解释器。   ![star > 100][Bronze]
* [go-python](https://github.com/sbinet/go-python) **star:905** CPython C-API 的 Go 接口。   ![star > 100][Bronze]
* [expr](https://github.com/antonmedv/expr) **star:705** 一个可以计算表达式的引擎。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [go-php](https://github.com/deuill/go-php) **star:684** PHP 的 Go 接口。   ![star > 100][Bronze]
* [go-duktape](https://github.com/olebedev/go-duktape) **star:652** 支持 Duktape JavaScript 引擎。   ![star > 100][Bronze]
* [golua](https://github.com/aarzilli/golua) **star:440** Lua C 的 Go 接口。   ![star > 100][Bronze]
* [gisp](https://github.com/jcla1/gisp) **star:428** LISP 的 Go 接口。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [agora](https://github.com/PuerkitoBio/agora) **star:320** 基于 Go 的动态类型，可嵌入的编程语言。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![归档项目][Archived]
...
* [errors](https://github.com/pkg/errors) **star:4908** 可让你很简单的进行错误处理。   ![star > 1000][Silver]
* [go-multierror](https://github.com/hashicorp/go-multierror) **star:731** 可将一系列的错误作为一个整体来显示。   ![star > 100][Bronze]
...
* [errlog](https://github.com/snwfdhmp/errlog) **star:181** 用于定位抛出错误的源代码(以及一些其他快速调试特性)。可插入到任何 logger 的位置。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [afero](https://github.com/spf13/afero) **star:2242** 文件系统的抽象系统。   ![star > 1000][Silver]
* [pdfcpu](https://github.com/hhrutter/pdfcpu) **star:949** PDF处理器。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [decimal](https://github.com/shopspring/decimal) **star:1603** 任意精度定点的十进制数。   ![star > 1000][Silver]
...
* [Leaf](https://github.com/name5566/leaf) **star:3064** 轻量级游戏服务器框架。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [Pixel](https://github.com/faiface/pixel) **star:2445** 手工制作的 2D 游戏库。   ![star > 1000][Silver]
* [Ebiten](https://github.com/hajimehoshi/ebiten) **star:1857** 很简单的 2D 游戏库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [goworld](https://github.com/xiaonanln/goworld) **star:1198** 可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [gonet](https://github.com/xtaci/gonet) **star:1050** 实现了游戏服务器骨架。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [termloop](https://github.com/JoelOtter/termloop) **star:1025** 基于终端的 Go 游戏引擎，建立在 Termbox 之上。   ![star > 1000][Silver]
* [nano](https://github.com/lonng/nano) **star:1000** 轻量级、方便、高性能的基于golang的游戏服务器框架。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [g3n](https://github.com/g3n/engine) **star:757**  3D游戏引擎。   ![star > 100][Bronze]
...
* [GarageEngine](https://github.com/vova616/GarageEngine) **star:312** 用 OpenGL 编写的 2D 游戏引擎。   ![star > 100][Bronze]
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) **star:1798** 提供类似 .NET LINQ 的查询方法。   ![star > 1000][Silver]
* [jennifer](https://github.com/dave/jennifer) **star:1277** 不使用模板生成任意 Go 代码。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gen](https://github.com/clipperhouse/gen) **star:1037** 用于生成泛型等类似方法的功能代码生成工具。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
* [Tile38](https://github.com/tidwall/tile38) **star:6339** 具有空间索引和实时地理定位功能的地理定位数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [S2 geometry](https://github.com/golang/geo) **star:887** S2 geometry 库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gopherjs](https://github.com/gopherjs/gopherjs) **star:8546** 将 Go 编译成 JavaScript。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [goworker](https://github.com/benmanns/goworker) **star:2253** 基于 go 的后台 worker。   ![star > 1000][Silver]
* [ants](https://github.com/panjf2000/ants) **star:1895** 一个高性能的协程池。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [tunny](https://github.com/Jeffail/tunny) **star:1344** golang 的协程池。   ![star > 1000][Silver]
* [grpool](https://github.com/ivpusic/grpool) **star:499** 轻量级协程池。   ![star > 100][Bronze]
...
* [ui](https://github.com/andlabs/ui) **star:6966** 跨平台的 Platform-native GUI 库。   ![star > 5000][Gold]
...
* [robotgo](https://github.com/go-vgo/robotgo) **star:4435** 实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [imaginary](https://github.com/h2non/imaginary) **star:2593** 用于图像大小调整的快速、简单的HTTP微服务。   ![star > 1000][Silver]
* [bild](https://github.com/anthonynsimon/bild) **star:2548** 纯Go语言实现的图像处理算法合集。   ![star > 1000][Silver]
* [imaging](https://github.com/disintegration/imaging) **star:2534** 简单的Go图像处理包。   ![star > 1000][Silver]
* [ln](https://github.com/fogleman/ln) **star:2462** Go实现的3D线艺术（3D Line Art）渲染。   ![star > 1000][Silver]
* [gocv](https://github.com/hybridgroup/gocv) **star:2461** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [resize](https://github.com/nfnt/resize) **star:2130** Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [gg](https://github.com/fogleman/gg) **star:1918** 纯Go语言实现的2D渲染。   ![star > 1000][Silver]
* [pt](https://github.com/fogleman/pt) **star:1774** Go实现的路径跟踪（path tracing）引擎。   ![star > 1000][Silver]
...
* [gift](https://github.com/disintegration/gift) **star:1210** 图像处理包。   ![star > 1000][Silver]
...
* [bimg](https://github.com/h2non/bimg) **star:797** 使用libvips实现的快速高效的图像处理包。   ![star > 100][Bronze]
...
* [darkroom](https://github.com/gojek/darkroom) **star:57** An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency.   ![最近一周有更新][Green]
...
* [flogo](https://github.com/tibcosoftware/flogo) **star:1130** Flogo是一个面向物联网边缘应用和集成的开源框架。   ![star > 1000][Silver]
...
* [mainflux](https://github.com/Mainflux/mainflux) **star:592** 工业物联网消息和设备管理服务器。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gron](https://github.com/roylee0704/gron) **star:635** 使用简单的Go API定义基于时间的任务。 之后Gron的调度程序将运行它们。   ![star > 100][Bronze]
* [JobRunner](https://github.com/bamzi/jobrunner) **star:569** 智能和功能丰富的cron作业调度程序（包含任务队列和实时监控）。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [go-cron](https://github.com/rk/go-cron) **star:176** 一个Go实现的简单的定时任务库。可以在不同的时间间隔（每秒一次到在每年在特定的日期执行）执行闭包或函数。主要用于web应用和长时间运行的守护进程。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [GJSON](https://github.com/tidwall/gjson) **star:4914** 使用一行代码获取JSON的值。   ![star > 1000][Silver]
...
* [logrus](https://github.com/Sirupsen/logrus) **star:11980** Go的结构化日志操作 。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [zap](https://github.com/uber-go/zap) **star:7469** 快速、结构化、多等级的日志记录。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [spew](https://github.com/davecgh/go-spew) **star:3310** 为Go数据结构实现一个漂亮的printer用于帮助调试。   ![star > 1000][Silver]
* [glog](https://github.com/golang/glog) **star:2301** 为Go提供了多等级日志记录。   ![star > 1000][Silver]
* [zerolog](https://github.com/rs/zerolog) **star:2229** Zero-allocation JSON日志记录。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [tail](https://github.com/hpcloud/tail) **star:1541** 努力模拟实现BSD的tail的特性的Go包。   ![star > 1000][Silver]
* [lumberjack](https://github.com/natefinch/lumberjack) **star:1450** 简单的滚动日志，io.WriteCloser的实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [logger](https://github.com/azer/logger) **star:134** Go的精简日志库。   ![star > 100][Bronze]
* [xlog](https://github.com/rs/xlog) **star:128** 针对'net/context`实现的结构化的记录器，用于HTTP处理程序。   ![star > 100][Bronze]
* [ozzo-log](https://github.com/go-ozzo/ozzo-log) **star:109** 支持日志多等级、分类和过滤的高性能日志记录。可以发送过滤后的日志消息到各种目标(如控制台，网络，邮件)。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
...
* [GoLearn](https://github.com/sjwhitworth/golearn) **star:6650** 通用机器学习库。   ![star > 5000][Gold]   ![包含中文文档][CN]
* [gorgonia](https://github.com/chewxy/gorgonia) **star:2697** 基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。   ![star > 1000][Silver]
* [tfgo](https://github.com/galeone/tfgo) **star:1190** 易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。   ![star > 1000][Silver]
* [goml](https://github.com/cdipaolo/goml) **star:1010** 在线机器学习。   ![star > 1000][Silver]
* [gosseract](https://github.com/otiai10/gosseract) **star:876** 使用c++的Tesseract库实现的OCR。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [eaopt](https://github.com/MaxHalford/eaopt) **star:623** 一个进化优化（evolutionary optimization）库。   ![star > 100][Bronze]
* [gorse](https://github.com/zhenghaoz/gorse) **star:537** 基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。   ![star > 100][Bronze]   ![包含中文文档][CN]
* [gobrain](https://github.com/goml/gobrain) **star:386** 用 Go 编写的神经网络库。   ![star > 100][Bronze]
...
* [go-deep](https://github.com/patrikeh/go-deep) **star:219** 一个功能丰富的神经网络库 。   ![star > 100][Bronze]
...
* [shield](https://github.com/eaigner/shield) **star:123** 贝叶斯文本分类器，具有灵活的tokenizers和存储后端。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [neural-go](https://github.com/schuyler/neural-go) **star:60** 多层感知器网络在Go中的实现，使用反向传播算法进行训练。   ![最近一年没有更新][Yellow]
* [go-pr](https://github.com/daviddengcn/go-pr) **star:56** Go编写的模式识别包。   ![最近一年没有更新][Yellow]
...
* [sarama](https://github.com/Shopify/sarama) **star:4644**  Apache Kafka的Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gorush](https://github.com/appleboy/gorush) **star:3717** 使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。   ![star > 1000][Silver]
* [Centrifugo](https://github.com/centrifugal/centrifugo) **star:3687** 实时消息(Websockets或SockJS)服务器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [machinery](https://github.com/RichardKnop/machinery) **star:3370** 基于分布式消息传递的异步任务/作业队列。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-socket.io](https://github.com/googollee/go-socket.io) **star:2888** go的socket.io库，一个实时应用程序框架。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [NATS Go Client](https://github.com/nats-io/nats) **star:2401** 轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [APNs2](https://github.com/sideshow/apns2) **star:2043** HTTP / 2苹果消息推送provider——发送推送消息到iOS, tvOS, Safari和OSX应用。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [Benthos](https://github.com/Jeffail/benthos) **star:2014** 一系列协议之间的消息流桥接。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [melody](https://github.com/olahol/melody) **star:1565** 处理websocket session的极简框架，包括广播和自动ping/pong处理。   ![star > 1000][Silver]
* [mangos](https://github.com/go-mangos/mangos) **star:1534** Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。   ![star > 1000][Silver]
* [Mercure](https://github.com/dunglas/mercure) **star:1511** 使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-nsq](https://github.com/nsqio/go-nsq) **star:1458** NSQ的官方Go包。   ![star > 1000][Silver]
* [Uniqush-Push](https://github.com/uniqush/uniqush-push) **star:1096** Redis支持的统一推送服务, 用于服务端向移动设备的消息通知。   ![star > 1000][Silver]
...
* [Beaver](https://github.com/Clivern/Beaver) **star:727** 一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。   ![star > 100][Bronze]
* [EventBus](https://github.com/asaskevich/EventBus) **star:561** 具有异步兼容性的轻量级事件总线。   ![star > 100][Bronze]
...
* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) **star:4489** 用于读写Microsoft Excel™(XLSX)文件的Go语言库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [xlsx](https://github.com/tealeg/xlsx) **star:3433** 用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [dig](https://github.com/uber-go/dig) **star:915** 一个基于反射的Go依赖注入工具包。   ![star > 100][Bronze]
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) **star:9192** Go生态系统中历史和新兴的项目布局模式集合。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [gopsutil](https://github.com/shirou/gopsutil) **star:3936** 用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [archiver](https://github.com/mholt/archiver) **star:2491** 用于生成和解压.zip和.tar.gz文档的库和命令。   ![star > 1000][Silver]
* [gosms](https://github.com/haxpax/gosms) **star:1225** Go编写的私人的本地短信网关，可以用来发送短信。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) **star:672** Go语言的通用对象池。   ![star > 100][Bronze]   ![包含中文文档][CN]
...
* [prose](https://github.com/jdkato/prose) **star:2047** 用于支持标记化、词性标记、名称实体提取等文本处理的库。   ![star > 1000][Silver]
* [gse](https://github.com/go-ego/gse) **star:1075** 高效的文本分割;支持英语、汉语、日语等。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [MMSEGO](https://github.com/awsong/MMSEGO) **star:58** 这是一个 Go 实现的[MMSEG](http://technology.chtsai.org/mmseg/)，这是一个中文分词算法。   ![最近一年没有更新][Yellow]
...
* [gopacket](https://github.com/google/gopacket) **star:2883** Go library for packet processing with libpcap bindings.   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [webrtc](https://github.com/pions/webrtc) **star:2280** WebRTC API的纯Go实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [kcp-go](https://github.com/xtaci/kcp-go) **star:2248** 快速可靠的ARQ协议。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gobgp](https://github.com/osrg/gobgp) **star:1693** 基于 Go 的 BGP 实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [ssh](https://github.com/gliderlabs/ssh) **star:1113** 用于构建SSH服务器的高级API(封装密码/ SSH)。   ![star > 1000][Silver]
* [fortio](https://github.com/fortio/fortio) **star:876** 负载测试库和命令行工具，高级的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。支持Tcp、Http、gRPC。   ![star > 100][Bronze]
* [water](https://github.com/songgao/water) **star:842** 简单TUN / TAP图书馆。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [sftp](https://github.com/pkg/sftp) **star:739** Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt.   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [go-getter](https://github.com/hashicorp/go-getter) **star:725**  通过URL来下载文件或目录。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [NFF-Go](https://github.com/intel-go/nff-go) **star:665** 用于快速开发云计算和裸机网络功能的框架(原YANFF)。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [ftp](https://github.com/jlaffaye/ftp) **star:529** 实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户端。   ![star > 100][Bronze]
...
* [stun](https://github.com/go-rtc/stun) **star:286** Go实现的RFC 5389 STUN协议。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [winrm](https://github.com/masterzen/winrm) **star:213**  Go WinRM客户端远程执行Windows机器上的命令。   ![star > 100][Bronze]
...
* [sslb](https://github.com/eduardonunesp/sslb) **star:112** 它是一个超级简单的负载平衡器，只是一个实现某种性能的小项目。   ![star > 100][Bronze]
* [gNxI](https://github.com/google/gnxi) **star:103** 一组基于 gNMI 和 gNOI 协议的网络管理工具。   ![star > 100][Bronze]
* [gmqtt](https://github.com/DrmagicE/gmqtt) **star:90** Gmqtt是一个灵活、高性能的MQTT代理库，它完全实现了MQTT协议V3.1.1。   ![最近一周有更新][Green]   ![包含中文文档][CN]
...
* [packet](https://github.com/aerogo/packet) **star:28** 通过TCP和UDP发送数据包。它可以缓冲消息和热交换连接。
...
* [grequests](https://github.com/levigross/grequests) **star:1416** 一个 Go “克隆”的伟大和著名的请求库。   ![star > 1000][Silver]
* [heimdall](https://github.com/gojektech/heimdall) **star:1082** 具有重试和hystrix功能的增强http客户机。   ![star > 1000][Silver]
* [sling](https://github.com/dghubble/sling) **star:1006** Sling是一个用于创建和发送API请求的Go HTTP客户端库。   ![star > 1000][Silver]
...
* [glfw](https://github.com/go-gl/glfw) **star:735** GLFW 3 的 Go 接口实现。   ![star > 100][Bronze]
...
* [GORM](https://github.com/jinzhu/gorm) **star:14728** 一个出色的 ORM 库。主要目标是对开发人员友好。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Xorm](https://github.com/go-xorm/xorm) **star:5220** 基于 Go 的简单而强大的ORM。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [gorp](https://github.com/go-gorp/gorp) **star:3080** 基于 Go 的关系持久性 ORM-ish 库。   ![star > 1000][Silver]
* [go-pg](https://github.com/go-pg/pg) **star:3012** 用于 PostgreSQL 的ORM。侧重于 PostgreSQL 的特性和性能。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) **star:2277** ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。   ![star > 1000][Silver]
* [upper.io/db](https://github.com/upper/db) **star:1852** 对外提供统一的接口用于访问不同的存储介质，例如PostgreSQL, MySQL, SQLite, MSSQL, QL、MongoDB.。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [reform](https://github.com/go-reform/reform) **star:804** 基于非空接口和代码生成的 ORM。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [pop/soda](https://github.com/gobuffalo/pop) **star:680** 数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [QBS](https://github.com/coocood/qbs) **star:538** Stands for Query By Struct. A Go ORM.   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) **star:236** 一个灵活而强大的SQL字符串构建器库。   ![star > 100][Bronze]
...
* [dep](https://github.com/golang/dep) **star:12586**  Go 的依赖管理工具，需要 Go 1.9+   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [vgo](https://go.googlesource.com/vgo/)  Go 命令版本管理

*用于包和依赖项管理的非官方库。 (翻译出错了? 试试 [英文版](README_EN.md#package-management) 吧~)*

* [glide](https://github.com/Masterminds/glide) **star:7785** 轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。   ![star > 5000][Gold]
...
* [govendor](https://github.com/kardianos/govendor) **star:4746** 包管理器。使用 vendor 文件的 Go vendor 工具。   ![star > 1000][Silver]
...
* [nut](https://github.com/jingweno/nut) **star:244** vendor 依赖。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [VenGO](https://github.com/DamnWidget/VenGO) **star:114** 创建和管理可导出的隔离go虚拟环境。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [jaeger](https://github.com/jaegertracing/jaeger) **star:8694** 分布式跟踪系统。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [graphql-go](https://github.com/graphql-go/graphql) **star:5247** 为Go实现GraphQL。   ![star > 5000][Gold]
* [graphql](https://github.com/neelance/graphql-go) **star:2797** 关注易用性的GraphQL服务器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [packr](https://github.com/gobuffalo/packr) **star:2134** 将静态文件嵌入到Go二进制文件中的简单方法。   ![star > 1000][Silver]
* [statik](https://github.com/rakyll/statik) **star:2115** 将静态文件嵌入到Go可执行文件中。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go.rice](https://github.com/GeertJohan/go.rice) **star:1653** go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。   ![star > 1000][Silver]
* [vfsgen](https://github.com/shurcooL/vfsgen) **star:660** 生成一个vfsdata。静态实现给定虚拟文件系统的go文件。   ![star > 100][Bronze]
...
* [gonum](https://github.com/gonum/gonum) **star:2969** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [stats](https://github.com/montanaflynn/stats) **star:1344** 包含Golang标准库中缺少的公共函数的统计软件包。   ![star > 1000][Silver]
...
* [gonum/plot](https://github.com/gonum/plot) **star:1218** gonum/plot提供了一个API，用于在Go中构建和绘制绘图。   ![star > 1000][Silver]
...
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) **star:78** 用于机器学习和统计的数据模型(类似于 pandas)。   ![最近一周有更新][Green]
...
* [lego](https://github.com/xenolf/lego) **star:3525** 纯 Go ACME 客户端库及命令行工具   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [Cameradar](https://github.com/Ullaakut/cameradar) **star:1824** 工具和库，以远程入侵RTSP流从监控摄像头。   ![star > 1000][Silver]
* [acmetool](https://github.com/hlandau/acme) **star:1694** ACME(让我们用自动更新加密)客户端工具。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [memguard](https://github.com/awnumar/memguard) **star:1522** 一个用于处理内存中敏感值的纯Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [secure](https://github.com/unrolled/secure) **star:1210** Go 语言 HTTP 中间件，为 Go 提供了一些安全功能   ![star > 1000][Silver]
...
* [simple-scrypt](https://github.com/elithrar/simple-scrypt) **star:154** Scrypt 库，具有简单、易懂的 API，同时具有内置的自动校准功能   ![star > 100][Bronze]
...
* [jsoniter](https://github.com/json-iterator/go) **star:5559** 高性能，100% 兼容的“encoding/json” 替代品   ![star > 5000][Gold]
* [goprotobuf](https://github.com/golang/protobuf) **star:5105** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) **star:2965** Go 语言的 Protocol Buffer 库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [mapstructure](https://github.com/mitchellh/mapstructure) **star:2442** 用于对原生键值对进行解码生成 Go 语言结构体   ![star > 1000][Silver]
...
* [bambam](https://github.com/glycerine/bambam) **star:59** 用于 Go 语言生成 Cap'n Proto schemas 的生成器   ![最近一年没有更新][Yellow]
...
* [etcd](https://github.com/coreos/etcd) **star:26583** 为共享配置和服务发现提供高可用的键值存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [discovery](https://github.com/Bilibili/discovery) **star:677** 用于弹性中间层负载平衡和故障转移的注册表。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [go-streams](https://github.com/reugn/go-streams) **star:187** 去流处理库。   ![star > 100][Bronze]

## 模板引擎

*用于模板和词法分析的库和工具。 (翻译出错了? 试试 [英文版](README_EN.md#template-engines) 吧~)*

* [gofpdf](https://github.com/jung-kurt/gofpdf) **star:3081** PDF 文档生成器，支持文本，绘图和图片   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [pongo2](https://github.com/flosch/pongo2) **star:1490** 类似 DjanGo 的模板引擎   ![star > 1000][Silver]
* [quicktemplate](https://github.com/valyala/quicktemplate) **star:1409** 快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译   ![star > 1000][Silver]
* [hero](https://github.com/shiyanhui/hero) **star:1205** Hero是一个方便、快速和强大的go模板引擎。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [mustache](https://github.com/hoisie/mustache) **star:968** Go 语言实现的 Mustache 模板语言   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [ego](https://github.com/benbjohnson/ego) **star:415** 轻量级模板语言，允许您在Go中编写模板。模板被翻译成Go并编译。   ![star > 100][Bronze]
...
* Testing Frameworks
    ...
    * [Testify](https://github.com/stretchr/testify) **star:8168** 对标准测试包的扩展。   ![star > 5000][Gold]
    * [go-cmp](https://github.com/google/go-cmp) **star:1175** 用于比较测试中的Go值的包。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [httpexpect](https://github.com/gavv/httpexpect) **star:1141** 简洁的、声明式的、易用的端到端HTTP 及 REST API 测试   ![star > 1000][Silver]
    * [godog](https://github.com/DATA-DOG/godog) **star:760** 类似 Cucumber 或 Behat 的 BDD 框架   ![star > 100][Bronze]
    ...
    * [testfixtures](https://github.com/go-testfixtures/testfixtures) **star:329** 类似 Rails 的测试工具，用于测试数据库应用   ![star > 100][Bronze]
    * [go-mutesting](https://github.com/zimmski/go-mutesting) **star:293** 变异测试的Go源代码。   ![star > 100][Bronze]
    ...
    * [GoSpec](https://github.com/orfjackal/gospec) **star:110** 用于 Go 编程语言的bdd风格的测试框架。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
    ...
    * [gospecify](https://github.com/stesla/gospecify) **star:50** 支持 BDD 语法 。对于任何使用过 rspec 等库的人来说应该非常熟悉。   ![最近一年没有更新][Yellow]
...
* Mock
    * [gomock](https://github.com/golang/mock) **star:2862** 用于Go编程语言的mock框架。   ![star > 1000][Silver]
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) **star:1750** Mock SQL ，用于测试数据库交互   ![star > 1000][Silver]
    * [hoverfly](https://github.com/SpectoLabs/hoverfly) **star:1441** 使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。   ![star > 1000][Silver]
...
* Fuzzing and delta-debugging/reducing/shrinking.
    * [go-fuzz](https://github.com/dvyukov/go-fuzz) **star:2890** 随机测试系统。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* Selenium and browser control tools.
    * [chromedp](https://github.com/knq/chromedp) **star:3602** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [selenoid](https://github.com/aerokube/selenoid) **star:1234** Selenium hub 服务器的替代品，在容器中启动浏览器   ![star > 1000][Silver]
    * [cdp](https://github.com/mafredri/cdp) **star:354** 用于Chrome调试协议的类型安全绑定，可与实现该协议的浏览器或其他调试目标一起使用。   ![star > 100][Bronze]
    * [ggr](https://github.com/aerokube/ggr) **star:209** 一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs   ![star > 100][Bronze]
...
* Specific Formats
    ...
    * [gofeed](https://github.com/mmcdole/gofeed) **star:1100** 在Go中解析RSS和Atom feeds。   ![star > 1000][Silver]
    ...
    * [gographviz](https://github.com/awalterschulze/gographviz) **star:301** 解析Graphviz DOT语言。   ![star > 100][Bronze]
    ...
    * [go-slugify](https://github.com/mozillazg/go-slugify) **star:50** 生成漂亮的固定链接地址（slug），支持多种语言   ![最近一年没有更新][Yellow]
...
* Utility
    ...
    * [gotabulate](https://github.com/bndr/gotabulate) **star:197** 使用 Go 语言简单、美观的打印表格数据   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) **star:5037** AWS 提供的官方go语言 SDK   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [google](https://github.com/google/google-api-go-client) **star:1926** 为Go自动生成谷歌api。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) **star:1789** 谷歌云api Go 客户端库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [anaconda](https://github.com/ChimeraCoder/anaconda) **star:989**  Twitter 1.1 API 的 go 语言客户端   ![star > 100][Bronze]
* [discordgo](https://github.com/bwmarrin/discordgo) **star:970**  Discord Chat API的客户端。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [stripe](https://github.com/stripe/stripe-go) **star:944**  Stripe API 的 Go 语言客户端   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [facebook](https://github.com/huandu/facebook) **star:771** 支持 Facebook Graph API 的库   ![star > 100][Bronze]
* [minio-go](https://github.com/minio/minio-go) **star:722** 用于Amazon S3兼容云存储的Minio Go库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gostorm](https://github.com/jsgilmore/gostorm) **star:117** GoStorm是一个Go库，它实现了编写Storm spout和bolt所需的通信协议，这些协议用于与Storm shell通信。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [Trello](https://github.com/adlio/trello) **star:102**  Trello API的 Go 语言封装。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [fzf](https://github.com/junegunn/fzf) **star:23254** 用Go编写的命令行模糊查找器。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [hub](https://github.com/github/hub) **star:17052** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [delve](https://github.com/derekparker/delve) **star:12064** Go 语言调试器   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [ctop](https://github.com/bcicen/ctop) **star:8830** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。   ![star > 5000][Gold]
* [wuzz](https://github.com/asciimoo/wuzz) **star:8265** 用于HTTP检查的交互式cli工具。   ![star > 5000][Gold]
* [sqlx](https://github.com/jmoiron/sqlx) **star:6824** 为内建的数据库/sql 软件包提供一组扩展。   ![star > 5000][Gold]
* [peco](https://github.com/peco/peco) **star:5472** 简单的交互过滤工具。   ![star > 5000][Gold]
* [usql](https://github.com/knq/usql) **star:4679** usql 是一个通用的命令行接口，用于操作 sql 数据库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [goreleaser](https://github.com/goreleaser/goreleaser) **star:4512** 尽可能快速的发布 Go 语言二进制文件。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [godropbox](https://github.com/dropbox/godropbox) **star:3744** 用于编写 Go 语言服务／应用的库，来自 Dropbox.。   ![star > 1000][Silver]
...
* [Storm](https://github.com/asdine/storm) **star:1358** 一个简单又强大的用于 BoltDB 的工具   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [mole](https://github.com/davrodpin/mole) **star:1301** cli应用程序可以轻松创建ssh隧道。   ![star > 1000][Silver]
* [go-funk](https://github.com/thoas/go-funk) **star:1196** 现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)   ![star > 1000][Silver]
* [mc](https://github.com/minio/mc) **star:1120** Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [filetype](https://github.com/h2non/filetype) **star:952** 通过数字签名来推测文件类型。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [spinner](https://github.com/briandowns/spinner) **star:798**  一个 Go 语言软件包，提供多种选项，方便在终端中创建加载动画。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gopencils](https://github.com/bndr/gopencils) **star:422** 小而简单的包，可以轻松地使用REST api。   ![star > 100][Bronze]
...
* [ergo](https://github.com/cristianoliveira/ergo) **star:312** 管理运行在不同端口上的多个本地服务变得很容易。   ![star > 100][Bronze]
...
* [gotenv](https://github.com/subosito/gotenv) **star:142** 从 `.env` 或者任何 `io.Reader`。   ![star > 100][Bronze]
...
* [multitick](https://github.com/VividCortex/multitick) **star:57** 用于 aligned tickers 的多路复用   ![最近一年没有更新][Yellow]
...
* [copy-pasta](https://github.com/jutkko/copy-pasta) **star:37** 通用多工作站剪切板，使用类似 S3 的后端作为存储。   ![最近一周有更新][Green]
...
* [ulid](https://github.com/oklog/ulid) **star:1681** 实现了ULID(普遍唯一的词典分类标识符)。   ![star > 1000][Silver]
...
* [govalidator](https://github.com/asaskevich/govalidator) **star:3557** 用于字符串，数字，切片和结构的验证器和sanitizers。   ![star > 1000][Silver]
* [validator](https://github.com/go-playground/validator) **star:3530**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。   ![star > 1000][Silver]
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) **star:1053** 支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [go-git](https://github.com/src-d/go-git) **star:4294** 纯Go中高度可扩展的Git实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [git2go](https://github.com/libgit2/git2go) **star:1362**  libgit2 的 Go 语言接口。   ![star > 1000][Silver]
* [hercules](https://github.com/src-d/hercules) **star:540** 从Git存储库历史中获得高级见解。   ![star > 100][Bronze]
...
* [goav](https://github.com/giorgisio/goav) **star:790** FFmpeg的Comphrensive。   ![star > 100][Bronze]
...
* [gst](https://github.com/ziutek/gst) **star:151**  GStreamer的Go工具。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [Gin](https://github.com/gin-gonic/gin) **star:30109** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Beego](https://github.com/astaxie/beego) **star:21515** beego是一种用于 Go 编程语言的开源高性能web框架。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [Buffalo](http://gobuffalo.io)  为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) **star:14723** 高性能、极简的Go web框架。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Revel](https://github.com/revel/revel) **star:11253** 用于Go语言的高效web框架。   ![star > 5000][Gold]
...
* [traffic](https://github.com/pilu/traffic) **star:517** Sinatra启发了regexp/pattern mux和用于Go的web框架。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [gongular](https://github.com/mustafaakin/gongular) **star:415**  快速 Go web 框架，支持输入映射／验证以及依赖注入。   ![star > 100][Bronze]
* [neo](https://github.com/ivpusic/neo) **star:391** Neo是一个非常简单且快速的Web框架API。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [WebGo](https://github.com/bnkamalesh/webgo) **star:74** 构建web应用程序的微框架;处理程序链接、中间件和上下文注入。与标准库兼容的HTTP处理程序(即http.HandlerFunc)。
...
* [patron](https://github.com/beatlabs/patron) **star:34** Patron是一个遵循最佳云实践的微服务框架，专注于提升开发效率。   ![最近一周有更新][Green]
...
* [CORS](https://github.com/rs/cors) **star:1223** 轻松地向API添加CORS功能。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [Limiter](https://github.com/ulule/limiter) **star:792** 简单的速度限制中间件。   ![star > 100][Bronze]
* [go-server-timing](https://github.com/mitchellh/go-server-timing) **star:746** 添加/解析Server-Timing头。   ![star > 100][Bronze]
...
* [negroni](https://github.com/urfave/negroni) **star:6340** 符合语言习惯的 HTTP 中间件库。   ![star > 5000][Gold]   ![包含中文文档][CN]
* [alice](https://github.com/justinas/alice) **star:1823** 用于连接中间件的库，简单无痛苦。   ![star > 1000][Silver]
* [render](https://github.com/unrolled/render) **star:1267** Go package用于方便地呈现JSON、XML和HTML模板响应。   ![star > 1000][Silver]
* [stats](https://github.com/thoas/stats) **star:536** 使用中间件来存储关于web应用程序的各种信息。   ![star > 100][Bronze]
* [interpose](https://github.com/carbocation/interpose) **star:288** golang的极简网络/http中间件。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [go-wrap](https://github.com/go-on/wrap) **star:58** net/http的小型中间件包。   ![最近一年没有更新][Yellow]
* [catena](https://github.com/codemodus/catena) **star:7** HTTP.Handler wrapper catenation (和chain具有相同的 API ).。

### 路由器

* [httprouter](https://github.com/julienschmidt/httprouter) **star:9736** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。   ![star > 5000][Gold]
* [mux](https://github.com/gorilla/mux) **star:9703** 强大的URL路由器和调度器为golang。   ![star > 5000][Gold]
* [chi](https://github.com/go-chi/chi) **star:6054** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) **star:185** 找出项目中过期的依赖项。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [vim-go](https://github.com/fatih/vim-go) **star:10868** Go 开发会用到的 Vim 插件。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) **star:5136** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [gotests](https://github.com/cweill/gotests) **star:2208** 从源代码生成测试用例。   ![star > 1000][Silver]
* [genny](https://github.com/cheekybits/genny) **star:973** 优雅的 Go 泛型。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [webhook](https://github.com/adnanh/webhook) **star:4097** 允许用户创建在服务器上执行命令的 HTTP hooks。   ![star > 1000][Silver]
* [gaia](https://github.com/gaia-pipeline/gaia) **star:3750** 可用于任何编程语言来构建强大的管道。   ![star > 1000][Silver]
* [gox](https://github.com/mitchellh/gox) **star:3365** 非常简单，没有多余的跨平台编译工具。   ![star > 1000][Silver]
* [bosun](https://github.com/bosun-monitor/bosun) **star:2854** 按照时间轴发出告警的框架。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [bombardier](https://github.com/codesenberg/bombardier) **star:1753** 快速跨平台 HTTP 基准测试工具。   ![star > 1000][Silver]
...
* [script](https://github.com/bitfield/script) **star:924** 让DevOps编写类shell和系统管理任务变得更加容易。   ![star > 100][Bronze]
...
* [godbg](https://github.com/sirnewton01/godbg) **star:218** 基于 web 的 gdb 前端应用程序。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [Leaps](https://github.com/jeffail/leaps) **star:639** 使用操作转换的成对编程服务。   ![star > 100][Bronze]
...
* [GoDNS](https://github.com/timothyye/godns) **star:436** 一个动态DNS客户端工具，支持DNSPod & HE.net。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [shell2http](https://github.com/msoap/shell2http) **star:417** 通过http服务器执行shell命令(用于原型或远程控制)。   ![star > 100][Bronze]
* [mockingjay](https://github.com/quii/mockingjay-server) **star:414** 一份配置文件中便可伪造HTTP服务器与用户之间的行为。您还可以使服务器随机宕机，以帮助进行更实际的性能测试。   ![star > 100][Bronze]
...
* [GoBooks](https://github.com/dariubs/GoBooks) **star:6812** 一份精选的 Go 书籍清单。   ![star > 5000][Gold]
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) **star:1543** 由 Maria Letta 提供的与 Gopher 有关的图片包，其中包含了插图,表情文字。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) **star:24665** 其他 awesome 系列的列表。   ![star > 5000][Gold]
...
* [golang-graphics](https://github.com/mholt/golang-graphics) **star:140** 收藏的 Go 图像，图形和艺术作品。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![归档项目][Archived]
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) **star:31602** Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。   ![star > 5000][Gold]   ![包含中文文档][CN]
...
* [Ethereum Development with Go](https://github.com/miguelmota/ethereum-development-with-go-book) **star:455** 一本讲述如何用 Go 进行以太开发的小册。   ![star > 100][Bronze]   ![包含中文文档][CN]
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) **star:4575** 学习使用测试驱动开发。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) **star:698** 引入示例讲述 Golang 与Node.js在学习上的差异。   ![star > 100][Bronze]
