...
| [Oto](https://github.com/hajimehoshi/oto)  | 426 |  多平台的 low-level 声音播放库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [casbin](https://github.com/hsluoyz/casbin)  | 4846 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]
...
| [gorbac](https://github.com/mikespook/gorbac)  | 901 |  轻量级的基于角色的访问控制(RBAC)实现。 |![star > 100][Bronze]
| [goth](https://github.com/markbates/goth)  | 2242 |  提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。 |![star > 1000][Silver]
...
| [jwt](https://github.com/pascaldekloe/jwt)  | 84 |  轻量级JSON Web令牌库。 |
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-chat-bot](https://github.com/go-chat-bot/bot)  | 465 |  用 Go 编写的IRC, Slack和电报机器人。 |![star > 100][Bronze]
...
| [tbot](https://github.com/yanzay/tbot)  | 215 |  带有类似于net/http API的Telegram bot服务器。 |![star > 100][Bronze]
| [telebot](https://github.com/tucnak/telebot)  | 941 |  用Go编写的Telegram bot框架。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api)  | 1602 |  简单轻量级的Telegram bot客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [cobra](https://github.com/spf13/cobra)  | 13074 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-getoptions](https://github.com/DavidGamba/go-getoptions)  | 6 |   Go 选择解析器，借鉴于Perl灵活性的GetOpt::Long。 |
...
| [kingpin](https://github.com/alecthomas/kingpin)  | 2520 |  支持子命令的命令行和标志解析器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [ops](https://github.com/nanovms/ops)  | 258 |  Unikernel 构建器/协调器。 |![star > 100][Bronze]
| [pflag](https://github.com/spf13/pflag)  | 744 |  基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。 |![star > 100][Bronze]
| [readline](https://github.com/chzyer/readline)  | 1361 |  纯golang实现，在MIT许可下提供了GNU-Readline的大部分特性。 |![star > 1000][Silver]
...
| [urfave/cli](https://github.com/urfave/cli)  | 11251 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-colorable](https://github.com/mattn/go-colorable)  | 371 |  适用于windows的颜色编写器。 |![star > 100][Bronze]
...
| [go-prompt](https://github.com/c-bata/go-prompt)  | 2294 |  构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) |![star > 1000][Silver]
| [gocui](https://github.com/jroimartin/gocui)  | 5256 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [gommon/color](https://github.com/labstack/gommon/tree/master/color)  | - |  更换终端文本样式。 |
| [gookit/color](https://github.com/gookit/color)  | 197 |  终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [mpb](https://github.com/vbauerster/mpb)  | 509 |  可在终端显示多进度条。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [progressbar](https://github.com/schollz/progressbar)  | 559 |  基本线程安全的进度条，在每个操作系统工作。 |![star > 100][Bronze]
...
| [termbox-go](https://github.com/nsf/termbox-go)  | 3457 |  基于文本的跨平台接口库。 |![star > 1000][Silver]
| [termdash](https://github.com/mum4k/termdash)  | 799 |  此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。 |![star > 100][Bronze]
...
| [env](https://github.com/caarlos0/env)  | 851 |  解析环境变量并赋值到struct中(默认值)。 |![star > 100][Bronze]
...
| [godotenv](https://github.com/joho/godotenv)  | 2093 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]
...
| [ini](https://github.com/go-ini/ini)  | 1573 |   读和写INI文件。 |![star > 1000][Silver]
...
| [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig)  | 2386 |  管理来自环境变量的配置数据。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [viper](https://github.com/spf13/viper)  | 9195 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18873 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [goveralls](https://github.com/mattn/goveralls)  | 572 |  Coveralls.io 是一个用 Go 编写，可持续对代码覆盖率进行检测的系统。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algorithms](https://github.com/shady831213/algorithms)  | 236 |  算法和数据结构。来源于CLRS。 |![star > 100][Bronze]
...
| [bitset](https://github.com/willf/bitset)  | 478 |  实现了 bitsets 的 Go 包。 |![star > 100][Bronze]
...
| [gods](https://github.com/emirpasic/gods)  | 6211 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]
| [golang-set](https://github.com/deckarep/golang-set)  | 1148 |  线程安全和非线程安全的高性能集。 |![star > 1000][Silver]
...
| [gota](https://github.com/kniren/gota)  | 864 |  实现了数据帧，序列以及数据噪音。 |![star > 100][Bronze]
...
| [trie](https://github.com/derekparker/trie)  | 416 |  在Go中实现Trie。 |![star > 100][Bronze]
| [ttlcache](https://github.com/diegobernardes/ttlcache)  | 94 |  基于内存的LRU算法实现。 |
| [typ](https://github.com/gurukami/typ)  | 9 |  从复杂结构中获取值，支持空类型、安全的类型转换。 |
| [willf/bloom](https://github.com/willf/bloom)  | 661 |  实现Bloom过滤器。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6214 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [bcache](https://github.com/iwanbk/bcache)  | 27 |  基于内存的最终一致的分布式缓存。 |
| [BigCache](https://github.com/allegro/bigcache)  | 2425 |  高效的键/值缓存为千兆字节的数据。 |![star > 1000][Silver]
| [bolt](https://github.com/boltdb/bolt)  | 9931 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
| [buntdb](https://github.com/tidwall/buntdb)  | 2428 |  基于内存的K/V，快速，可嵌入的数据库，可自定义索引和空间支持。 |![star > 1000][Silver]
| [cache](https://github.com/akyoto/cache)  | 13 |  基于内存的 K/V 存储:带生命周期的值存储，0个依赖项，<100 LoC, 100%覆盖率。 |
| [cache2go](https://github.com/muesli/cache2go)  | 1001 |  基于内存的 K/V 缓存，支持超时的自动失效。 |![star > 1000][Silver]
| [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache)  | 29 |  BigCache 支持集群和独立且生命周期存储项。 |   ![最近一年没有更新][Yellow]
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16701 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [couchcache](https://github.com/codingsince1985/couchcache)  | 40 |  由 Couchbase服务 支持的RESTful缓存微服务。 |
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL)  | 870 |  区块链领域的一个SQL数据库。 |![star > 100][Bronze]
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10076 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [GCache](https://github.com/bluele/gcache)  | 883 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]
| [go-cache](https://github.com/pmylund/go-cache)  | 2857 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3146 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |   ![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7616 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]
| [influxdb](https://github.com/influxdb/influxdb)  | 16904 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [nutsdb](https://github.com/xujiajun/nutsdb)  | 853 |  Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [piladb](https://github.com/fern4lvarez/piladb)  | 171 |  基于堆栈数据结构的轻量级RESTful数据库引擎。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [prometheus](https://github.com/prometheus/prometheus)  | 25312 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 218 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]
| [rqlite](https://github.com/rqlite/rqlite)  | 4671 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tidb](https://github.com/pingcap/tidb)  | 19855 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [tiedot](https://github.com/HouzuoGuo/tiedot)  | 2361 |  属于你的NoSQL数据库。 |![star > 1000][Silver]
| [Vasto](https://github.com/chrislusf/vasto)  | 145 |  分布式高性能键值存储。可做磁盘备份。最终一致。高可用。能够在不中断服务的情况下增长或收缩。 |![star > 100][Bronze]
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 964 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [migrate](https://github.com/golang-migrate/migrate)  | 2550 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sql-migrate](https://github.com/rubenv/sql-migrate)  | 1391 |  数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。 |![star > 1000][Silver]
...
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2361 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]
| [kingshard](https://github.com/flike/kingshard)  | 4569 |  kingshard 是基于 Golang 的MySQL高性能代理。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [orchestrator](https://github.com/github/orchestrator)  | 3006 |  MySQL复制拓扑管理器和可视化工具。 |![star > 1000][Silver]
| [pgweb](https://github.com/sosedoff/pgweb)  | 5959 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]
...
| [vitess](https://github.com/youtube/vitess)  | 8372 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gendry](https://github.com/didi/gendry)  | 745 |  非入侵的SQL构建器和强大的数据绑定器。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2272 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]
...
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 8027 |  MySQL驱动程序。 |![star > 5000][Gold]
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3408 |  SQLite3驱动程序。 |![star > 1000][Silver]
| [gofreetds](https://github.com/minus5/gofreetds)  | 90 |  基于[FreeTDS](http://www.freetds.org)封装的微软MSSQL Go 驱动。 |
| [goracle](https://github.com/go-goracle/goracle)  | 232 |  基于 ODPI-C 的 Oracle 驱动程序 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [pgx](https://github.com/jackc/pgx)  | 1889 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pq](https://github.com/lib/pq)  | 5137 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mgo](https://github.com/globalsign/mgo)  | 1622 |  (已停止维护) MongoDB驱动。 |![star > 1000][Silver]
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 3013 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6220 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [redis](https://github.com/go-redis/redis)  | 6388 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5806 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4075 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [elasticsql](https://github.com/cch123/elasticsql)  | 382 |  将 SQL 转换为 elasticsearch dsl。 |![star > 100][Bronze]
| [elastigo](https://github.com/mattbaird/elastigo)  | 948 |  Elasticsearch 客户端。 |![star > 100][Bronze]
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch)  | 1526 |  官方 Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goes](https://github.com/OwnLocal/goes)  | 24 |  实现了与 Elasticsearch 交互的库。 |   ![最近一年没有更新][Yellow]
| [riot](https://github.com/go-ego/riot)  | 4667 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [cayley](https://github.com/google/cayley)  | 12659 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dateparse](https://github.com/araddon/dateparse)  | 888 |  可以解析很多格式不固定的日期字符串。 |![star > 100][Bronze]
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2496 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [emitter-io](https://github.com/emitter-io/emitter)  | 1904 |  高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。 |![star > 1000][Silver]
| [flowgraph](https://github.com/vectaport/flowgraph)  | 18 |  flow-based programming package。 |
| [gleam](https://github.com/chrislusf/gleam)  | 2068 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]
...
| [go-kit](https://github.com/go-kit/kit)  | 14301 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]
| [gorpc](https://github.com/valyala/gorpc)  | 550 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8970 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 998 |  支持25+种语言RPC库。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8556 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1723 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [micro](https://github.com/micro/micro)  | 6513 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [NATS](https://github.com/nats-io/gnatsd)  | 6244 |  轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [raft](https://github.com/hashicorp/raft)  | 2816 |  Raft consensus协议的实现。 by HashiCorp。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [rpcx](https://github.com/smallnest/rpcx)  | 3736 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tendermint](https://github.com/tendermint/tendermint)  | 3104 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [torrent](https://github.com/anacrolix/torrent)  | 2821 |  BitTorrent 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [hermes](https://github.com/matcornic/hermes)  | 1608 |  可生成干净的、响应式的HTML电子邮件。 |![star > 1000][Silver]
| [MailHog](https://github.com/mailhog/MailHog)  | 5118 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]
...
| [go-lua](https://github.com/Shopify/go-lua)  | 1659 |  用 Go 实现的 Lua 5.2 VM接口。 |![star > 1000][Silver]
...
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2936 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]
...
| [otto](https://github.com/robertkrimen/otto)  | 4704 |  用 Go 编写的 JavaScript 解释器。 |![star > 1000][Silver]
| [purl](https://github.com/ian-kent/purl)  | 27 |  嵌入 Go 的 Perl 5.18.2。 |   ![最近一年没有更新][Yellow]
| [tengo](https://github.com/d5/tengo)  | 1285 |  字节码编译的脚本语言。 |![star > 1000][Silver]
...
| [errors](https://github.com/pkg/errors)  | 4813 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]
| [errorx](https://github.com/joomcode/errorx)  | 549 |  一个功能丰富的错误包，可进行堆栈跟踪、组装异常信息以及其他。 |![star > 100][Bronze]
| [go-multierror](https://github.com/hashicorp/go-multierror)  | 716 |  可将一系列的错误作为一个整体来显示。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2202 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [notify](https://github.com/rjeczalik/notify)  | 490 |  文件系统事件通知库，具有类似于os/signal的简单API，。 |![star > 100][Bronze]
...
| [gorilla/csrf](https://github.com/gorilla/csrf)  | 429 |  用于Go web应用程序和服务的CSRF保护。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [nosurf](https://github.com/justinas/nosurf)  | 964 |  CSRF保护中间件。 |![star > 100][Bronze]
...
| [fuego](https://github.com/seborama/fuego)  | 35 |  Functional Experiment in Go。 |   ![最近一个周有更新][Green]
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1827 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1162 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Leaf](https://github.com/name5566/leaf)  | 3027 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [Tile38](https://github.com/tidwall/tile38)  | 6298 |  具有空间索引和实时地理定位功能的地理定位数据库。 |![star > 5000][Gold]
...
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8494 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1815 |  一个高性能的协程池。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [cyclicbarrier](https://github.com/marusama/cyclicbarrier)  | 33 |  基于 Go 的 CyclicBarrier 实现。 |
...
| [goworker](https://github.com/benmanns/goworker)  | 2238 |  基于 go 的后台 worker。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [semaphore](https://github.com/marusama/semaphore)  | 71 |  基于 CAS 的可快速调整的信号量实现(比基于通道的信号量实现更快)。 |
...
| [tunny](https://github.com/Jeffail/tunny)  | 1326 |  golang 的协程池。 |![star > 1000][Silver]
...
| [ui](https://github.com/andlabs/ui)  | 6902 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]
...
| [webview](https://github.com/zserge/webview)  | 4601 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4402 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bild](https://github.com/anthonynsimon/bild)  | 2027 |  纯Go语言实现的图像处理算法合集。 |![star > 1000][Silver]
...
| [gocv](https://github.com/hybridgroup/gocv)  | 2416 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [imaginary](https://github.com/h2non/imaginary)  | 2578 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]
| [imaging](https://github.com/disintegration/imaging)  | 2493 |  简单的Go图像处理包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [resize](https://github.com/nfnt/resize)  | 2121 |  Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4817 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11774 |  Go的结构化日志操作 。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [lumberjack](https://github.com/natefinch/lumberjack)  | 1423 |  简单的滚动日志，io.WriteCloser的实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [spew](https://github.com/davecgh/go-spew)  | 3275 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [stdlog](https://github.com/alexcesaro/log)  | 43 |  Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。 |   ![最近一年没有更新][Yellow]
| [tail](https://github.com/hpcloud/tail)  | 1526 |  努力模拟实现BSD的tail的特性的Go包。 |![star > 1000][Silver]
...
| [zap](https://github.com/uber-go/zap)  | 7337 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]
| [zerolog](https://github.com/rs/zerolog)  | 2168 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gorgonia](https://github.com/chewxy/gorgonia)  | 2670 |  基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gorse](https://github.com/zhenghaoz/gorse)  | 523 |  基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [goscore](https://github.com/asafschers/goscore)  | 35 |   为预言模型标记语言（PMML）实现的评分API。 |
| [gosseract](https://github.com/otiai10/gosseract)  | 860 |  使用c++的Tesseract库实现的OCR。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Benthos](https://github.com/Jeffail/benthos)  | 1942 |  一系列协议之间的消息流桥接。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Bus](https://github.com/mustafaturan/bus)  | 114 |  内部通信的最小消息总线实现。 |![star > 100][Bronze]
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3650 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [EventBus](https://github.com/asaskevich/EventBus)  | 550 |  具有异步兼容性的轻量级事件总线。 |![star > 100][Bronze]
...
| [go-socket.io](https://github.com/googollee/go-socket.io)  | 2865 |  go的socket.io库，一个实时应用程序框架。 |![star > 1000][Silver]
...
| [gorush](https://github.com/appleboy/gorush)  | 3679 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3341 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mangos](https://github.com/go-mangos/mangos)  | 1532 |  Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。 |![star > 1000][Silver]
| [melody](https://github.com/olahol/melody)  | 1542 |  处理websocket session的极简框架，包括广播和自动ping/pong处理。 |![star > 1000][Silver]
| [Mercure](https://github.com/dunglas/mercure)  | 1476 |  使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sarama](https://github.com/Shopify/sarama)  | 4566 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1672 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4389 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3337 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8845 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]
...
| [archiver](https://github.com/mholt/archiver)  | 2470 |  用于生成和解压.zip和.tar.gz文档的库和命令。 |![star > 1000][Silver]
...
| [go-resiliency](https://github.com/eapache/go-resiliency)  | 840 |   Go语言弹性模式(resiliency pattern)。 |![star > 100][Bronze]
...
| [gopsutil](https://github.com/shirou/gopsutil)  | 3884 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gosh](https://github.com/osamingo/gosh)  | 16 |  提供Go统计处理程序，结构和测量方法。 |   ![最近一个周有更新][Green]
| [gosms](https://github.com/haxpax/gosms)  | 1224 |  Go编写的私人的本地短信网关，可以用来发送短信。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
| [llvm](https://github.com/llir/llvm)  | 408 |  用于在纯Go中与LLVM IR交互的库。 |![star > 100][Bronze]
...
| [gojieba](https://github.com/yanyiwu/gojieba)  | 811 |  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [gse](https://github.com/go-ego/gse)  | 1061 |  高效的文本分割;支持英语、汉语、日语等。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [icu](https://github.com/goodsign/icu)  | 19 |  Cgo绑定用于icu4c C库的检测和转换功能。保证与版本50.1兼容。 |   ![最近一年没有更新][Yellow]
| [kagome](https://github.com/ikawaha/kagome)  | 412 |  JP形态学分析仪编写的纯Go。 |![star > 100][Bronze]
...
| [cidranger](https://github.com/yl2chen/cidranger)  | 386 |  快速得 IP 到 CIDR 查找。 |![star > 100][Bronze]
...
| [fasthttp](https://github.com/valyala/fasthttp)  | 9215 |  一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [fortio](https://github.com/fortio/fortio)  | 857 |  负载测试库和命令行工具，高级的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。支持Tcp、Http、gRPC。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gmqtt](https://github.com/DrmagicE/gmqtt)  | 79 |  Gmqtt是一个灵活、高性能的MQTT代理库，它完全实现了MQTT协议V3.1.1。 |   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [gNxI](https://github.com/google/gnxi)  | 98 |  一组基于 gNMI 和 gNOI 协议的网络管理工具。 |
| [go-getter](https://github.com/hashicorp/go-getter)  | 718 |   通过URL来下载文件或目录。 |![star > 100][Bronze]
| [go-stun](https://github.com/ccding/go-stun)  | 331 |  实现了 STUN 客户端(RFC 3489和RFC 5389)。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gobgp](https://github.com/osrg/gobgp)  | 1662 |  基于 Go 的 BGP 实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [golibwireshark](https://github.com/sunwxg/golibwireshark)  | 14 |  用于解码 pcap 文件和分析解剖数据。 |   ![最近一年没有更新][Yellow]
| [gopacket](https://github.com/google/gopacket)  | 2836 |  Go library for packet processing with libpcap bindings. |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [kcp-go](https://github.com/xtaci/kcp-go)  | 2231 |  快速可靠的ARQ协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [kcptun](https://github.com/xtaci/kcptun)  | 10622 |  基于KCP协议的非常简单和快速udp隧道。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2863 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [ssh](https://github.com/gliderlabs/ssh)  | 1099 |  用于构建SSH服务器的高级API(封装密码/ SSH)。 |![star > 1000][Silver]
...
| [heimdall](https://github.com/gojektech/heimdall)  | 1065 |  具有重试和hystrix功能的增强http客户机。 |![star > 1000][Silver]
...
| [sling](https://github.com/dghubble/sling)  | 983 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]
...
| [glfw](https://github.com/go-gl/glfw)  | 727 |  GLFW 3 的 Go 接口实现。 |![star > 100][Bronze]
...
| [go-pg](https://github.com/go-pg/pg)  | 2936 |  用于 PostgreSQL 的ORM。侧重于 PostgreSQL 的特性和性能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GORM](https://github.com/jinzhu/gorm)  | 14476 |  一个出色的 ORM 库。主要目标是对开发人员友好。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [gorp](https://github.com/go-gorp/gorp)  | 3070 |  基于 Go 的关系持久性 ORM-ish 库。 |![star > 1000][Silver]
...
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2244 |  ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [upper.io/db](https://github.com/upper/db)  | 1838 |  对外提供统一的接口用于访问不同的存储介质，例如PostgreSQL, MySQL, SQLite, MSSQL, QL、MongoDB.。 |![star > 1000][Silver]
| [Xorm](https://github.com/go-xorm/xorm)  | 5138 |  基于 Go 的简单而强大的ORM。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12514 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]
...
| [glide](https://github.com/Masterminds/glide)  | 7763 |  轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。 |![star > 5000][Gold]
...
| [gopm](https://github.com/gpmgo/gopm)  | 2348 |  包管理器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [govendor](https://github.com/kardianos/govendor)  | 4713 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gojsonq](https://github.com/thedevsaddam/gojsonq)  | 852 |  一个用来查询JSON数据的Go包。 |![star > 100][Bronze]
| [graphql](https://github.com/tmc/graphql)  | 51 |  graphql解析器+工具集 |   ![最近一年没有更新][Yellow]
| [graphql](https://github.com/neelance/graphql-go)  | 2743 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [graphql-go](https://github.com/graphql-go/graphql)  | 5161 |  为Go实现GraphQL。 |![star > 5000][Gold]
...
| [go.rice](https://github.com/GeertJohan/go.rice)  | 1634 |  go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [packr](https://github.com/gobuffalo/packr)  | 2075 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [statics](https://github.com/go-playground/statics)  | 53 |  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。 |   ![最近一年没有更新][Yellow]
| [statik](https://github.com/rakyll/statik)  | 2072 |  将静态文件嵌入到Go可执行文件中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go)  | 71 |  用于机器学习和统计的数据模型(类似于 pandas)。 |   ![最近一个周有更新][Green]
...
| [gonum](https://github.com/gonum/gonum)  | 2912 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gonum/plot](https://github.com/gonum/plot)  | 1204 |  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。 |![star > 1000][Silver]
...
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1811 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]
...
| [lego](https://github.com/xenolf/lego)  | 3461 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [memguard](https://github.com/awnumar/memguard)  | 1049 |  一个用于处理内存中敏感值的纯Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2904 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 5015 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5430 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mapstructure](https://github.com/mitchellh/mapstructure)  | 2372 |  用于对原生键值对进行解码生成 Go 语言结构体 |![star > 1000][Silver]
...
| [Caddy](https://github.com/mholt/caddy)  | 22984 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [consul](https://www.consul.io/)  | - |  Consul 是一个用于服务发现、监控和配置的工具 |
| [devd](https://github.com/cortesi/devd)  | 2798 |  为开发人员提供本地web服务器。 |![star > 1000][Silver]
| [discovery](https://github.com/Bilibili/discovery)  | 665 |  用于弹性中间层负载平衡和故障转移的注册表。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [etcd](https://github.com/coreos/etcd)  | 26205 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [minio](https://github.com/minio/minio)  | 17121 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3216 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]
...
| [quicktemplate](https://github.com/valyala/quicktemplate)  | 1390 |  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译 |![star > 1000][Silver]
...
| [cupaloy](https://github.com/bradleyjkemp/cupaloy)  | 83 |  测试框架的简单快照测试插件。 |
...
| [go-mutesting](https://github.com/zimmski/go-mutesting)  | 289 |  变异测试的Go源代码。 |![star > 100][Bronze]
...
| [godog](https://github.com/DATA-DOG/godog)  | 740 |  类似 Cucumber 或 Behat 的 BDD 框架 |![star > 100][Bronze]
...
| [httpexpect](https://github.com/gavv/httpexpect)  | 1134 |  简洁的、声明式的、易用的端到端HTTP 及 REST API 测试 |![star > 1000][Silver]
...
| [Testify](https://github.com/stretchr/testify)  | 8010 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1694 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]
| [go-txdb](https://github.com/DATA-DOG/go-txdb)  | 157 |  基于单事务的数据库驱动，主要用于测试目的 |![star > 100][Bronze]
| [gock](https://github.com/h2non/gock)  | 805 |  多功能、易用 HTTP mock |![star > 100][Bronze]
| [gomock](https://github.com/golang/mock)  | 2787 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [httpmock](https://github.com/jarcoal/httpmock)  | 573 |  轻松模拟来自外部资源的HTTP响应。 |![star > 100][Bronze]
| [minimock](https://github.com/gojuno/minimock)  | 249 |  Go接口的模拟生成器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-fuzz](https://github.com/dvyukov/go-fuzz)  | 2860 |  随机测试系统。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [failpoint](https://github.com/pingcap/failpoint)  | 379 |  为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。 |![star > 100][Bronze]
...
| [bluemonday](https://github.com/microcosm-cc/bluemonday)  | 1224 |  HTML 清理工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [codetree](https://github.com/aerogo/codetree)  | 7 |  解析缩进代码(python、pixy、scarlet等)并返回树结构。 |
| [colly](https://github.com/asciimoo/colly)  | 8247 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]
...
| [gofeed](https://github.com/mmcdole/gofeed)  | 1091 |  在Go中解析RSS和Atom feeds。 |![star > 1000][Silver]
...
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7516 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]
...
| [htmlquery](https://github.com/antchfx/htmlquery)  | 124 |  用于HTML的XPath查询包，允许您通过XPath表达式从HTML文档中提取数据或求值。 |![star > 100][Bronze]
| [inject](https://github.com/facebookgo/inject)  | 1130 |  包注入提供了一个基于反射的注入器。 |![star > 1000][Silver]
...
| [sh](https://github.com/mvdan/sh)  | 1952 |  Shell解析器和格式化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [toml](https://github.com/BurntSushi/toml)  | 2750 |  TOML配置格式(带反射的编码器/解码器)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
* Utility
...
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 4991 |  AWS 提供的官方go语言 SDK |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-jira](https://github.com/andygrunwald/go-jira)  | 565 |   Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [google](https://github.com/google/google-api-go-client)  | 1908 |  为Go自动生成谷歌api。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [slack](https://github.com/nlopes/slack)  | 2391 |  Slack API。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [stripe](https://github.com/stripe/stripe-go)  | 932 |   Stripe API 的 Go 语言客户端 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [circuit](https://github.com/cep21/circuit)  | 328 |  一个高效和功能齐全的 类似 Hystrix Go 实现断路器模式。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [ctop](https://github.com/bcicen/ctop)  | 8755 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]
| [ctxutil](https://github.com/posener/ctxutil)  | 7 |  上下文工具。 |
| [dbt](https://github.com/nikogura/dbt)  | 12 |  用于从中心可信存储库运行自更新签名二进制文件的框架。 |
...
| [delve](https://github.com/derekparker/delve)  | 11887 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [filetype](https://github.com/h2non/filetype)  | 936 |  通过数字签名来推测文件类型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [fzf](https://github.com/junegunn/fzf)  | 22891 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-funk](https://github.com/thoas/go-funk)  | 1153 |  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...) |![star > 1000][Silver]
...
| [goreadability](https://github.com/philipjkim/goreadability)  | 30 |  网页摘要提取器使用Facebook开放图形和arc90的可读性。 |
| [goreleaser](https://github.com/goreleaser/goreleaser)  | 4466 |  尽可能快速的发布 Go 语言二进制文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goreporter](https://github.com/wgliang/goreporter)  | 2478 |  进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具 |![star > 1000][Silver]
...
| [hub](https://github.com/github/hub)  | 16834 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hystrix-go](https://github.com/afex/hystrix-go)  | 1986 |  实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。 |![star > 1000][Silver]
...
| [koazee](https://github.com/wesovilabs/koazee)  | 292 |  库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。 |![star > 100][Bronze]
...
| [mergo](https://github.com/imdario/mergo)  | 840 |  用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [peco](https://github.com/peco/peco)  | 5432 |  简单的交互过滤工具。 |![star > 5000][Gold]
...
| [profile](https://github.com/pkg/profile)  | 993 |  Go的简单分析支持包。 |![star > 100][Bronze]
| [rclient](https://github.com/zpatrick/rclient)  | 27 |  可读、灵活、易于使用的REST api客户端。 |
| [realize](https://github.com/tockins/realize)  | 3132 |  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。 |![star > 1000][Silver]
...
| [resty](https://github.com/go-resty/resty)  | 1922 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]
| [retry](https://github.com/kamilsk/retry)  | 149 |  基于上下文的功能机制，反复执行命令直到成功。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [sqlx](https://github.com/jmoiron/sqlx)  | 6707 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [usql](https://github.com/knq/usql)  | 4660 |  usql 是一个通用的命令行接口，用于操作 sql 数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [ulid](https://github.com/oklog/ulid)  | 1663 |  实现了ULID(普遍唯一的词典分类标识符)。 |![star > 1000][Silver]
...
| [govalidator](https://github.com/asaskevich/govalidator)  | 3517 |  用于字符串，数字，切片和结构的验证器和sanitizers。 |![star > 1000][Silver]
| [govalidator](https://github.com/thedevsaddam/govalidator)  | 708 |  用简单的规则验证Golang请求数据。深受Laravel请求验证的启发。 |![star > 100][Bronze]
...
| [validate](https://github.com/gookit/validate)  | 91 |   Go 封装数据验证和过滤。支持验证映射、结构、请求(表单、JSON、url)。值，上载文件)数据和更多特性。 |   ![包含中文文档][CN]
| [validate](https://github.com/gobuffalo/validate)  | 19 |  这个包提供了一个框架，用于为Go应用程序编写验证。 |
| [validator](https://github.com/go-playground/validator)  | 3440 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-git](https://github.com/src-d/go-git)  | 4165 |  纯Go中高度可扩展的Git实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Beego](https://github.com/astaxie/beego)  | 21311 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14547 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [utron](https://github.com/gernest/utron)  | 2133 |  Go(Golang)的轻量级MVC框架。 |![star > 1000][Silver]
...
| [Limiter](https://github.com/ulule/limiter)  | 782 |  简单的速度限制中间件。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ln-paywall](https://github.com/philippgille/ln-paywall)  | 88 |  使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。 |
| [Tollbooth](https://github.com/didip/tollbooth)  | 1237 |  限制速率的 HTTP 请求处理程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [alice](https://github.com/justinas/alice)  | 1819 |  用于连接中间件的库，简单无痛苦。 |![star > 1000][Silver]
...
| [negroni](https://github.com/urfave/negroni)  | 6307 |  符合语言习惯的 HTTP 中间件库。 |![star > 5000][Gold]   ![包含中文文档][CN]
...
| [chi](https://github.com/go-chi/chi)  | 5972 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9619 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]
...
| [mux](https://github.com/gorilla/mux)  | 9573 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [xpath](https://github.com/antchfx/xpath)  | 159 |  Go的XPath包。 |![star > 100][Bronze]
...
| [GoLint](https://github.com/golang/lint)  | 3133 |  Go 源码的 linter。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [php-parser](https://github.com/z7zmey/php-parser)  | 628 |  用 Go 编写的 PHP 解析器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gocode](https://github.com/nsf/gocode)  | 4728 |  Autocompletion daemon for the Go programming language. |![star > 1000][Silver]
...
| [vim-go](https://github.com/fatih/vim-go)  | 10762 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5083 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [genny](https://github.com/cheekybits/genny)  | 940 |  优雅的 Go 泛型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gotests](https://github.com/cweill/gotests)  | 2164 |  从源代码生成测试用例。 |![star > 1000][Silver]
...
| [go-callvis](https://github.com/TrueFurby/go-callvis)  | 1970 |  使用 dot format 可视化 Go 程序的调用图。 |![star > 1000][Silver]
| [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete)  | 37 |  Bash completion for go and wgo。 |   ![最近一年没有更新][Yellow]
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3916 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [godbg](https://github.com/tylerwince/godbg)  | 156 |  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。 |![star > 100][Bronze]
| [OctoLinker](https://github.com/OctoLinker/browser-extension)  | 3728 |  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [bombardier](https://github.com/codesenberg/bombardier)  | 1719 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]
...
| [Gitea](https://github.com/go-gitea/gitea)  | 14934 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate)  | 662 |  允许你的 Go应用程序 进行自我更新。 |![star > 100][Bronze]
...
| [gox](https://github.com/mitchellh/gox)  | 3339 |  非常简单，没有多余的跨平台编译工具。 |![star > 1000][Silver]
...
| [GVM](https://github.com/moovweb/gvm)  | 4454 |  GVM 提供了一个接口来管理 Go 版本。 |![star > 1000][Silver]
| [Hey](https://github.com/rakyll/hey)  | 6201 |  压力测试工具，可用来代替 ApacheBench (ab)。 |![star > 5000][Gold]
...
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55719 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Moby](https://github.com/moby/moby)  | 54250 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Packer](https://github.com/mitchellh/packer)  | 9142 |  用于从一个源配置为多个平台创建相同的机器图像。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Pewpew](https://github.com/bengadbois/pewpew)  | 201 |  灵活的 HTTP 命令行压测工具。 |![star > 100][Bronze]
| [Pomerium](https://github.com/pomerium/pomerium)  | 486 |  Pomerium是一个可识别身份的访问代理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Rodent](https://github.com/alouche/rodent)  | 30 |  管理Go版本、项目和跟踪依赖项。 |   ![最近一年没有更新][Yellow]
| [s3gof3r](https://github.com/rlmcpherson/s3gof3r)  | 992 |  小型实用程序/库，针对大型对象在Amazon S3中的高速传输进行了优化。 |![star > 100][Bronze]
| [Scaleway-cli](https://github.com/scaleway/scaleway-cli)  | 536 |  从命令行管理 BareMetal 服务器(与使用Docker一样容易)。 |![star > 100][Bronze]
| [script](https://github.com/bitfield/script)  | 901 |  让DevOps编写类shell和系统管理任务变得更加容易。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [traefik](https://github.com/containous/traefik)  | 23520 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 12041 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [webhook](https://github.com/adnanh/webhook)  | 4053 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]
...
| [Circuit](https://github.com/gocircuit/circuit)  | 1785 |  Circuit 是一个可编程平台即服务(PaaS)和/或基础设施即服务(IaaS)，用于管理、发现、同步和编排包含云应用程序的服务和主机。 |![star > 1000][Silver]
| [Comcast](https://github.com/tylertreat/Comcast)  | 6163 |  模拟坏的网络连接。 |![star > 5000][Gold]
| [confd](https://github.com/kelseyhightower/confd)  | 6391 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]
| [DDNS](https://github.com/skibish/ddns)  | 97 |  个人 DDNS 客户端。 |
| [Docker](http://www.docker.com/)  | - |  面向开发人员和系统管理员的分布式应用程序的开放平台。 |
| [Documize](https://github.com/documize/community)  | 811 |  集成了SaaS工具数据的现代wiki软件。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [drive](https://github.com/odeke-em/drive)  | 4941 |  基于命令行的谷歌驱动器客户端。 |![star > 1000][Silver]
...
| [GoDNS](https://github.com/timothyye/godns)  | 423 |  一个动态DNS客户端工具，支持DNSPod & HE.net。 |![star > 100][Bronze]
...
| [Gor](https://github.com/buger/gor)  | 11286 |  Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。 |![star > 5000][Gold]
...
| [lgo](https://github.com/yunabe/lgo)  | 1793 |  与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。 |![star > 1000][Silver]
| [limetext](http://limetext.org/)  | - |  一个强大而优雅的文本编辑器。 |
| [LiteIDE](https://github.com/visualfc/liteide)  | 5449 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [mockingjay](https://github.com/quii/mockingjay-server)  | 414 |  一份配置文件中便可伪造HTTP服务器与用户之间的行为。您还可以使服务器随机宕机，以帮助进行更实际的性能测试。 |![star > 100][Bronze]
| [myLG](https://github.com/mehrdadrad/mylg)  | 2194 |  命令行网络诊断工具。 |![star > 1000][Silver]
...
| [Pipe](https://github.com/b3log/pipe)  | 2820 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [restic](https://github.com/restic/restic)  | 7374 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [rkt](https://github.com/coreos/rkt)  | 8731 |  一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [scc](https://github.com/boyter/scc)  | 765 |  一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Seaweed File System](https://github.com/chrislusf/seaweedfs)  | 8134 |  快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3908 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark)  | 987 |  web框架基准测试。 |![star > 100][Bronze]
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks)  | 858 |  Go序列化方法的基准测试。 |![star > 100][Bronze]
