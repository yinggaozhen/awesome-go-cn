...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-29 10:26:36(每隔1天同步一次)**
...
| [Oto](https://github.com/hajimehoshi/oto)  | 429 |  多平台的 low-level 声音播放库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [authboss](https://github.com/volatiletech/authboss)  | 1920 |  web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。 |![star > 1000][Silver]
| [branca](https://github.com/hako/branca)  | 76 |  基于 Go 实现Branca令牌。 |
| [casbin](https://github.com/hsluoyz/casbin)  | 4877 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]
| [cookiestxt](https://github.com/mengzhuo/cookiestxt)  | 2 |  提供cookie .txt文件格式的解析器。 |   ![最近一年没有更新][Yellow]
| [go-jose](https://github.com/square/go-jose)  | 1117 |  相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server)  | 1272 |  用 Golang 编写的独立且符合规范的OAuth2服务器。 |![star > 1000][Silver]
| [gologin](https://github.com/dghubble/gologin)  | 1037 |  用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。 |![star > 1000][Silver]
| [gorbac](https://github.com/mikespook/gorbac)  | 904 |  轻量级的基于角色的访问控制(RBAC)实现。 |![star > 100][Bronze]
| [goth](https://github.com/markbates/goth)  | 2254 |  提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。 |![star > 1000][Silver]
...
| [jwt](https://github.com/pascaldekloe/jwt)  | 87 |  轻量级JSON Web令牌库。 |
| [jwt-auth](https://github.com/adam-hanna/jwt-auth)  | 151 |  JWT中间件，可用于Golang http服务器，提供了许多配置选项。 |![star > 100][Bronze]
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5908 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [loginsrv](https://github.com/tarent/loginsrv)  | 807 |  JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。 |![star > 100][Bronze]
| [oauth2](https://github.com/golang/oauth2)  | 2368 |  goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。 |![star > 1000][Silver]
| [osin](https://github.com/openshift/osin)  | 1536 |  OAuth2服务器库。 |![star > 1000][Silver]
| [paseto](https://github.com/o1egl/paseto)  | 237 |  平台无关的安全令牌(PASETO)。 |![star > 100][Bronze]
| [permissions2](https://github.com/xyproto/permissions2)  | 352 |  用于跟踪用户、登录状态和权限的库。依赖于cookie安全和bcrypt。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-chat-bot](https://github.com/go-chat-bot/bot)  | 466 |  用 Go 编写的IRC, Slack和电报机器人。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot)  | 217 |  基于控制台的，用于加密货币交易所的的交易机器人。 |![star > 100][Bronze]
...
| [tbot](https://github.com/yanzay/tbot)  | 216 |  带有类似于net/http API的Telegram bot服务器。 |![star > 100][Bronze]
| [telebot](https://github.com/tucnak/telebot)  | 943 |  用Go编写的Telegram bot框架。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api)  | 1614 |  简单轻量级的Telegram bot客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [cobra](https://github.com/spf13/cobra)  | 13125 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [commandeer](https://github.com/jaffee/commandeer)  | 89 |  开发友好的CLI应用程序。 |   ![最近一个周有更新][Green]
...
| [flaggy](https://github.com/integrii/flaggy)  | 446 |  一个健壮的、易用的标志包，具有出色的子命令支持。 |![star > 100][Bronze]
| [flagvar](https://github.com/sgreben/flagvar)  | 31 |  符合 Go 标准的“flag”标志参数类型包。 |
| [go-arg](https://github.com/alexflint/go-arg)  | 654 |  基于结构的参数解析。 |![star > 100][Bronze]
| [go-commander](https://github.com/yitsushi/go-commander)  | 15 |  用于简化CLI工作流的 Go 库。 |
| [go-flags](https://github.com/jessevdk/go-flags)  | 1502 |   Go 命令行选项解析器。 |![star > 1000][Silver]
...
| [mitchellh/cli](https://github.com/mitchellh/cli)  | 994 |  用于实现命令行接口的Go库。 |![star > 100][Bronze]
| [mow.cli](https://github.com/jawher/mow.cli)  | 620 |  用于构建具有复杂标志和参数解析和验证的CLI应用程序。 |![star > 100][Bronze]
| [ops](https://github.com/nanovms/ops)  | 260 |  Unikernel 构建器/协调器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [pflag](https://github.com/spf13/pflag)  | 747 |  基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。 |![star > 100][Bronze]
| [readline](https://github.com/chzyer/readline)  | 1363 |  纯golang实现，在MIT许可下提供了GNU-Readline的大部分特性。 |![star > 1000][Silver]
...
| [urfave/cli](https://github.com/urfave/cli)  | 11297 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [asciigraph](https://github.com/guptarohit/asciigraph)  | 1132 |  在命令行中构建轻量级ASCII线图╭┈╯，应用程序中没有其他依赖项。 |![star > 1000][Silver]
...
| [color](https://github.com/fatih/color)  | 3005 |  多功能包装，彩色终端输出。 |![star > 1000][Silver]
...
| [go-prompt](https://github.com/c-bata/go-prompt)  | 2311 |  构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gocui](https://github.com/jroimartin/gocui)  | 5304 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mpb](https://github.com/vbauerster/mpb)  | 633 |  可在终端显示多进度条。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [progressbar](https://github.com/schollz/progressbar)  | 565 |  基本线程安全的进度条，在每个操作系统工作。 |![star > 100][Bronze]
| [simpletable](https://github.com/alexeyco/simpletable)  | 158 |  可在终端显示简易表格。 |![star > 100][Bronze]
...
| [termbox-go](https://github.com/nsf/termbox-go)  | 3465 |  基于文本的跨平台接口库。 |![star > 1000][Silver]
| [termdash](https://github.com/mum4k/termdash)  | 802 |  此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。 |![star > 100][Bronze]
...
| [termui](https://github.com/gizak/termui)  | 8883 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [uilive](https://github.com/gosuri/uilive)  | 828 |  用于实时更新终端输出的库。 |![star > 100][Bronze]
| [uiprogress](https://github.com/gosuri/uiprogress)  | 1532 |  在终端呈现进度条，可灵活配置的。 |![star > 1000][Silver]
| [uitable](https://github.com/gosuri/uitable)  | 501 |  改善终端应用程序中表格数据的可读性。 |![star > 100][Bronze]
...
| [confita](https://github.com/heetch/confita)  | 235 |  从多个后端级联加载配置到struct中。 |![star > 100][Bronze]
...
| [goConfig](https://github.com/crgimenes/goConfig)  | 107 |  将结构体解析为输入，并用来自命令行、环境变量和配置文件的参数填充该结构体的字段。 |![star > 100][Bronze]
| [godotenv](https://github.com/joho/godotenv)  | 2104 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]
...
| [gookit/config](https://github.com/gookit/config)  | 80 |  程序配置管理(load,get,set)。支持JSON, YAML, TOML, INI, HCL。支持多文件加载，数据覆盖合并。 |   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [ini](https://github.com/go-ini/ini)  | 1581 |   读和写INI文件。 |![star > 1000][Silver]
...
| [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig)  | 2396 |  管理来自环境变量的配置数据。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [koanf](https://github.com/knadh/koanf)  | 81 |  轻量级可扩展库，用于读取Go应用程序中的配置。内置支持JSON, TOML, YAML, env，命令行。 |
| [konfig](https://github.com/lalamove/konfig)  | 512 |  可组合、可观察和高性能的分布式配置管理。 |![star > 100][Bronze]
...
| [viper](https://github.com/spf13/viper)  | 9223 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18915 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [goveralls](https://github.com/mattn/goveralls)  | 577 |  Coveralls.io 是一个用 Go 编写，可持续对代码覆盖率进行检测的系统。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algorithms](https://github.com/shady831213/algorithms)  | 237 |  算法和数据结构。来源于CLRS。 |![star > 100][Bronze]
...
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter)  | 509 |  布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。 |![star > 100][Bronze]
...
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5112 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]
...
| [gods](https://github.com/emirpasic/gods)  | 6255 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]
| [golang-set](https://github.com/deckarep/golang-set)  | 1154 |  线程安全和非线程安全的高性能集。 |![star > 1000][Silver]
...
| [gota](https://github.com/kniren/gota)  | 868 |  实现了数据帧，序列以及数据噪音。 |![star > 100][Bronze]
| [hide](https://github.com/emvi/hide)  | 7 |  ID type with marshalling to/from hash to prevent sending IDs to clients. |
| [hilbert](https://github.com/google/hilbert)  | 180 |  用于映射空间填充曲线（例如 Hilbert 曲线和 Peano 曲线）和数值。 |![star > 100][Bronze]
...
| [roaring](https://github.com/RoaringBitmap/roaring)  | 650 |  实现了压缩 bitsets 的Go包。 |![star > 100][Bronze]
...
| [trie](https://github.com/derekparker/trie)  | 418 |  在Go中实现Trie。 |![star > 100][Bronze]
| [ttlcache](https://github.com/diegobernardes/ttlcache)  | 95 |  基于内存的LRU算法实现。 |
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6229 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [bcache](https://github.com/iwanbk/bcache)  | 27 |  基于内存的最终一致的分布式缓存。 |
| [BigCache](https://github.com/allegro/bigcache)  | 2436 |  高效的键/值缓存为千兆字节的数据。 |![star > 1000][Silver]
| [bolt](https://github.com/boltdb/bolt)  | 9943 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
| [buntdb](https://github.com/tidwall/buntdb)  | 2431 |  基于内存的K/V，快速，可嵌入的数据库，可自定义索引和空间支持。 |![star > 1000][Silver]
| [cache](https://github.com/akyoto/cache)  | 14 |  基于内存的 K/V 存储:带生命周期的值存储，0个依赖项，<100 LoC, 100%覆盖率。 |
| [cache2go](https://github.com/muesli/cache2go)  | 1004 |  基于内存的 K/V 缓存，支持超时的自动失效。 |![star > 1000][Silver]
| [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache)  | 29 |  BigCache 支持集群和独立且生命周期存储项。 |   ![最近一年没有更新][Yellow]
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16729 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [couchcache](https://github.com/codingsince1985/couchcache)  | 40 |  由 Couchbase服务 支持的RESTful缓存微服务。 |
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL)  | 869 |  区块链领域的一个SQL数据库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10107 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache)  | 481 |  基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。 |![star > 100][Bronze]
| [GCache](https://github.com/bluele/gcache)  | 889 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]
| [go-cache](https://github.com/pmylund/go-cache)  | 2867 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3160 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |   ![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7633 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]
| [influxdb](https://github.com/influxdb/influxdb)  | 17010 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [nutsdb](https://github.com/xujiajun/nutsdb)  | 874 |  Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [piladb](https://github.com/fern4lvarez/piladb)  | 171 |  基于堆栈数据结构的轻量级RESTful数据库引擎。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [prometheus](https://github.com/prometheus/prometheus)  | 25379 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 218 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]
| [rqlite](https://github.com/rqlite/rqlite)  | 4680 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tidb](https://github.com/pingcap/tidb)  | 19920 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 979 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [migrate](https://github.com/golang-migrate/migrate)  | 2573 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [migrator](https://github.com/lopezator/migrator)  | 31 |  非常简单的 Go 数据库迁移库。 |
...
| [sql-migrate](https://github.com/rubenv/sql-migrate)  | 1400 |  数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [chproxy](https://github.com/Vertamedia/chproxy)  | 301 |  ClickHouse数据库的HTTP代理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-mysql](https://github.com/siddontang/go-mysql)  | 1862 |   Go 工具集，用于处理MySQL协议和复制。 |![star > 1000][Silver]
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2372 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]
| [kingshard](https://github.com/flike/kingshard)  | 4577 |  kingshard 是基于 Golang 的MySQL高性能代理。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [orchestrator](https://github.com/github/orchestrator)  | 3012 |  MySQL复制拓扑管理器和可视化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pgweb](https://github.com/sosedoff/pgweb)  | 5968 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [vitess](https://github.com/youtube/vitess)  | 8402 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [goqu](https://github.com/doug-martin/goqu)  | 630 |  常用的SQL生成器和查询库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2287 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]
| [xo](https://github.com/knq/xo)  | 2170 |  基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [avatica](https://github.com/apache/calcite-avatica-go)  | 32 |  Apache Avatica/Phoenix SQL驱动程序。 |   ![最近一个周有更新][Green]
...
| [go-adodb](https://github.com/mattn/go-adodb)  | 92 |  Microsoft ActiveX对象数据库驱动程序。 |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb)  | 1018 |  微软MSSQL驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-oci8](https://github.com/mattn/go-oci8)  | 404 |  Oracle 驱动程序。 |![star > 100][Bronze]
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 8057 |  MySQL驱动程序。 |![star > 5000][Gold]
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3417 |  SQLite3驱动程序。 |![star > 1000][Silver]
| [gofreetds](https://github.com/minus5/gofreetds)  | 91 |  基于[FreeTDS](http://www.freetds.org)封装的微软MSSQL Go 驱动。 |
| [goracle](https://github.com/go-goracle/goracle)  | 234 |  基于 ODPI-C 的 Oracle 驱动程序 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [pgx](https://github.com/jackc/pgx)  | 1893 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pq](https://github.com/lib/pq)  | 5148 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-rejson](https://github.com/nitishm/go-rejson)  | 89 |  实现了基于 Redigo 客户端的redislabs' ReJSON 模块。可简单地将结构体存储为JSON对象并对其进行操作。 |   ![最近一个周有更新][Green]
...
| [godis](https://github.com/piaohao/godis)  | 58 |  由GoLang实现的redis客户端，灵感来自jedis。 |
...
| [mgo](https://github.com/globalsign/mgo)  | 1626 |  (已停止维护) MongoDB驱动。 |![star > 1000][Silver]
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 3043 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6230 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [redis](https://github.com/go-redis/redis)  | 6434 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5814 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4105 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [elasticsql](https://github.com/cch123/elasticsql)  | 386 |  将 SQL 转换为 elasticsearch dsl。 |![star > 100][Bronze]
| [elastigo](https://github.com/mattbaird/elastigo)  | 951 |  Elasticsearch 客户端。 |![star > 100][Bronze]
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch)  | 1548 |  官方 Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goes](https://github.com/OwnLocal/goes)  | 24 |  实现了与 Elasticsearch 交互的库。 |   ![最近一年没有更新][Yellow]
| [riot](https://github.com/go-ego/riot)  | 4672 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [cayley](https://github.com/google/cayley)  | 12666 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [durafmt](https://github.com/hako/durafmt)  | 238 |  轻量级、可让time.Duration更加易读的库。 |![star > 100][Bronze]
...
| [now](https://github.com/jinzhu/now)  | 2165 |  now 是时间有关的工具类。 |![star > 1000][Silver]
...
| [dht](https://github.com/anacrolix/dht)  | 126 |  BitTorrent Kademlia DHT的实现。 |![star > 100][Bronze]
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2503 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [emitter-io](https://github.com/emitter-io/emitter)  | 1917 |  高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。 |![star > 1000][Silver]
| [flowgraph](https://github.com/vectaport/flowgraph)  | 18 |  flow-based programming package。 |
| [gleam](https://github.com/chrislusf/gleam)  | 2078 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]
| [glow](https://github.com/chrislusf/glow)  | 2515 |  全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。 |![star > 1000][Silver]
...
| [go-kit](https://github.com/go-kit/kit)  | 14346 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]
| [gorpc](https://github.com/valyala/gorpc)  | 551 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 9000 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 999 |  支持25+种语言RPC库。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8584 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1730 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [micro](https://github.com/micro/micro)  | 6530 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [NATS](https://github.com/nats-io/gnatsd)  | 6259 |  轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [raft](https://github.com/hashicorp/raft)  | 2822 |  Raft consensus协议的实现。 by HashiCorp。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [rpcx](https://github.com/smallnest/rpcx)  | 3747 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]
...
| [tendermint](https://github.com/tendermint/tendermint)  | 3114 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [torrent](https://github.com/anacrolix/torrent)  | 2824 |  BitTorrent 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [email](https://github.com/jordan-wright/email)  | 1090 |  一个强大和灵活的电子邮件库。 |![star > 1000][Silver]
| [go-dkim](https://github.com/toorop/go-dkim)  | 46 |  DKIM库，用于签署 & 验证电子邮件。 |
| [go-imap](https://github.com/emersion/go-imap)  | 726 |  用于客户端和服务器的IMAP库。 |![star > 100][Bronze]
...
| [MailHog](https://github.com/mailhog/MailHog)  | 5129 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]
| [SendGrid](https://github.com/sendgrid/sendgrid-go)  | 517 |  SendGrid 的 Go语言库，用于发送电子邮件。 |![star > 100][Bronze]
| [smtp](https://github.com/mailhog/smtp)  | 50 |  SMTP服务器协议状态机。 |   ![最近一年没有更新][Yellow]
...
| [expr](https://github.com/antonmedv/expr)  | 689 |  一个可以计算表达式的引擎。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-duktape](https://github.com/olebedev/go-duktape)  | 651 |  支持 Duktape JavaScript 引擎。 |![star > 100][Bronze]
| [go-lua](https://github.com/Shopify/go-lua)  | 1662 |  用 Go 实现的 Lua 5.2 VM接口。 |![star > 1000][Silver]
...
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2945 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]
...
| [otto](https://github.com/robertkrimen/otto)  | 4710 |  用 Go 编写的 JavaScript 解释器。 |![star > 1000][Silver]
| [purl](https://github.com/ian-kent/purl)  | 27 |  嵌入 Go 的 Perl 5.18.2。 |   ![最近一年没有更新][Yellow]
| [tengo](https://github.com/d5/tengo)  | 1291 |  字节码编译的脚本语言。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [errlog](https://github.com/snwfdhmp/errlog)  | 145 |  用于定位抛出错误的源代码(以及一些其他快速调试特性)。可插入到任何 logger 的位置。 |![star > 100][Bronze]
| [errors](https://github.com/pkg/errors)  | 4839 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]
| [errorx](https://github.com/joomcode/errorx)  | 549 |  一个功能丰富的错误包，可进行堆栈跟踪、组装异常信息以及其他。 |![star > 100][Bronze]
| [go-multierror](https://github.com/hashicorp/go-multierror)  | 719 |  可将一系列的错误作为一个整体来显示。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2210 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pdfcpu](https://github.com/hhrutter/pdfcpu)  | 940 |  PDF处理器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [decimal](https://github.com/shopspring/decimal)  | 1587 |  任意精度定点的十进制数。 |![star > 1000][Silver]
...
| [conform](https://github.com/leebenson/conform)  | 172 |  控制用户输入。基于struct tags可对数据进行修剪、清理和擦除。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [nosurf](https://github.com/justinas/nosurf)  | 970 |  CSRF保护中间件。 |![star > 100][Bronze]
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1842 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [engo](https://github.com/EngoEngine/engo)  | 1076 |  开源 2D 游戏引擎。它遵循 Entity-Component-System 范式。 |![star > 1000][Silver]
| [g3n](https://github.com/g3n/engine)  | 740 |   3D游戏引擎。 |![star > 100][Bronze]
...
| [go-astar](https://github.com/beefsack/go-astar)  | 325 |  实现了A\*路径查找算法。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [go-collada](https://github.com/GlenKelley/go-collada)  | 12 |  处理Collada文件。 |   ![最近一年没有更新][Yellow]
| [go-sdl2](https://github.com/veandco/go-sdl2)  | 1152 |  实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1172 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Leaf](https://github.com/name5566/leaf)  | 3039 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   ![包含中文文档][CN]
| [nano](https://github.com/lonng/nano)  | 977 |  轻量级、方便、高性能的基于golang的游戏服务器框架。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [Oak](https://github.com/oakmound/oak)  | 623 |  纯 Go 实现的游戏引擎。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Pitaya](https://github.com/topfreegames/pitaya)  | 298 |  可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity。 |![star > 100][Bronze]
...
| [gen](https://github.com/clipperhouse/gen)  | 1031 |  用于生成泛型等类似方法的功能代码生成工具。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
| [go-linq](https://github.com/ahmetalpbalkan/go-linq)  | 1791 |  提供类似 .NET LINQ 的查询方法。 |![star > 1000][Silver]
| [goderive](https://github.com/awalterschulze/goderive)  | 737 |  从输入类型来派生函数。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gotype](https://github.com/wzshiming/gotype)  | 20 |  Golang 源码解析，用法类似reflect(反射)。 |   ![包含中文文档][CN]
| [GoWrap](https://github.com/hexdigest/gowrap)  | 261 |  使用简单模板为 Go 接口生成装饰器。 |![star > 100][Bronze]
| [interfaces](https://github.com/rjeczalik/interfaces)  | 185 |  用于生成接口定义的命令行工具。 |![star > 100][Bronze]
| [jennifer](https://github.com/dave/jennifer)  | 1261 |  不使用模板生成任意 Go 代码。 |![star > 1000][Silver]
...
| [Tile38](https://github.com/tidwall/tile38)  | 6304 |  具有空间索引和实时地理定位功能的地理定位数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [c4go](https://github.com/Konstantin8105/c4go)  | 149 |  将 C 代码转换为 Go 代码。 |![star > 100][Bronze]
| [f4go](https://github.com/Konstantin8105/f4go)  | 11 |  将 FORTRAN 77 转换为 Go代码。 |
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8510 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1843 |  一个高性能的协程池。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [artifex](https://github.com/borderstech/artifex)  | 12 |  简单的内存作业队列。 |
| [async](https://github.com/studiosol/async)  | 21 |  一种异步执行函数的安全方法，在出现 panic 时恢复它们。 |
| [breaker](https://github.com/kamilsk/breaker)  | 34 |  灵活的机制，可以使执行流可中断。 |   ![最近一个周有更新][Green]
...
| [goworker](https://github.com/benmanns/goworker)  | 2242 |  基于 go 的后台 worker。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [grpool](https://github.com/ivpusic/grpool)  | 494 |  轻量级协程池。 |![star > 100][Bronze]
...
| [pool](https://github.com/go-playground/pool)  | 477 |  有限消费者协程或无限协程池，可用于更加简单的处理和取消协程 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [tunny](https://github.com/Jeffail/tunny)  | 1331 |  golang 的协程池。 |![star > 1000][Silver]
...
| [fyne](https://github.com/fyne-io/fyne)  | 6219 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter)  | 1443 |  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。 |![star > 1000][Silver]
| [gotk3](https://github.com/gotk3/gotk3)  | 761 |  实现了 GTK3 的 Go接口。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gowd](https://github.com/dtylman/gowd)  | 207 |  跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。 |![star > 100][Bronze]
| [qt](https://github.com/therecipe/qt)  | 5995 |  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。 |![star > 5000][Gold]
| [ui](https://github.com/andlabs/ui)  | 6917 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3675 |  Windows应用程序库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [webview](https://github.com/zserge/webview)  | 4622 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4414 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]
| [systray](https://github.com/getlantern/systray)  | 777 |  跨平台 Go 库，可在通知区放置图标和菜单。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bild](https://github.com/anthonynsimon/bild)  | 2030 |  纯Go语言实现的图像处理算法合集。 |![star > 1000][Silver]
| [bimg](https://github.com/h2non/bimg)  | 784 |  使用libvips实现的快速高效的图像处理包。 |![star > 100][Bronze]
...
| [gg](https://github.com/fogleman/gg)  | 1899 |  纯Go语言实现的2D渲染。 |![star > 1000][Silver]
| [gift](https://github.com/disintegration/gift)  | 1207 |  图像处理包。 |![star > 1000][Silver]
| [gltf](https://github.com/qmuntal/gltf)  | 37 |  一个高效、健壮的glTF 2.0文件读取、写入和验证器。 |
...
| [go-opencv](https://github.com/lazywei/go-opencv)  | 1089 |  OpenCV库的Go bindings。 |![star > 1000][Silver]
| [go-webcolors](https://github.com/jyotiska/go-webcolors)  | 24 |  Python下webcolors库的Go语言调用。 |   ![最近一年没有更新][Yellow]
| [gocv](https://github.com/hybridgroup/gocv)  | 2426 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goimagehash](https://github.com/corona10/goimagehash)  | 210 |   图像哈希处理的Go语言包。 |![star > 100][Bronze]
...
| [imagick](https://github.com/gographics/imagick)  | 970 |   ImageMagick下MagickWand的C API的Go binding。 |![star > 100][Bronze]
| [imaginary](https://github.com/h2non/imaginary)  | 2580 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]
| [imaging](https://github.com/disintegration/imaging)  | 2502 |  简单的Go图像处理包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [img](https://github.com/hawx/img)  | 129 |  图像处理工具的集合。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [ln](https://github.com/fogleman/ln)  | 2457 |  Go实现的3D线艺术（3D Line Art）渲染。 |![star > 1000][Silver]
...
| [smartcrop](https://github.com/muesli/smartcrop)  | 1250 |  为任意图片寻找合适的位置进行图片裁剪。 |![star > 1000][Silver]
...
| [flogo](https://github.com/tibcosoftware/flogo)  | 1115 |  Flogo是一个面向物联网边缘应用和集成的开源框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [mainflux](https://github.com/Mainflux/mainflux)  | 581 |  工业物联网消息和设备管理服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4840 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]
...
| [gojson](https://github.com/ChimeraCoder/gojson)  | 2023 |  从JSON自动生成Go的结构（struct）定义。 |![star > 1000][Silver]
...
| [glog](https://github.com/golang/glog)  | 2295 |  为Go提供了多等级日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [log](https://github.com/apex/log)  | 728 |  Go的结构化日志包。 |![star > 100][Bronze]
...
| [log15](https://github.com/inconshreveable/log15)  | 882 |  简单、强大的日志操作。 |![star > 100][Bronze]
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11817 |  Go的结构化日志操作 。 |![star > 5000][Gold]
...
| [lumberjack](https://github.com/natefinch/lumberjack)  | 1428 |  简单的滚动日志，io.WriteCloser的实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [seelog](https://github.com/cihub/seelog)  | 1345 |  具有灵活调度、过滤和格式化的日志功能。 |![star > 1000][Silver]
| [spew](https://github.com/davecgh/go-spew)  | 3284 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]
| [stdlog](https://github.com/alexcesaro/log)  | 43 |  Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。 |   ![最近一年没有更新][Yellow]
| [tail](https://github.com/hpcloud/tail)  | 1532 |  努力模拟实现BSD的tail的特性的Go包。 |![star > 1000][Silver]
...
| [zap](https://github.com/uber-go/zap)  | 7359 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]
| [zerolog](https://github.com/rs/zerolog)  | 2187 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bayesian](https://github.com/jbrukh/bayesian)  | 628 |  Go的朴素贝叶斯分类。 |![star > 100][Bronze]
...
| [gobrain](https://github.com/goml/gobrain)  | 382 |  用 Go 编写的神经网络库。 |![star > 100][Bronze]
...
| [GoLearn](https://github.com/sjwhitworth/golearn)  | 6638 |  通用机器学习库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [goml](https://github.com/cdipaolo/goml)  | 1011 |  在线机器学习。 |![star > 1000][Silver]
| [goRecommend](https://github.com/timkaye11/goRecommend)  | 142 |  用Go编写的推荐算法库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gorgonia](https://github.com/chewxy/gorgonia)  | 2677 |  基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gorse](https://github.com/zhenghaoz/gorse)  | 526 |  基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [goscore](https://github.com/asafschers/goscore)  | 35 |   为预言模型标记语言（PMML）实现的评分API。 |
| [gosseract](https://github.com/otiai10/gosseract)  | 862 |  使用c++的Tesseract库实现的OCR。 |![star > 100][Bronze]
...
| [ocrserver](https://github.com/otiai10/ocrserver)  | 220 |  一个简单的OCR API服务器，非常容易地使用Docker和Heroku部署。 |![star > 100][Bronze]
...
| [tfgo](https://github.com/galeone/tfgo)  | 1179 |  易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [APNs2](https://github.com/sideshow/apns2)  | 2038 |  HTTP / 2苹果消息推送provider——发送推送消息到iOS, tvOS, Safari和OSX应用。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Beaver](https://github.com/Clivern/Beaver)  | 717 |  一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。 |![star > 100][Bronze]
| [Benthos](https://github.com/Jeffail/benthos)  | 1993 |  一系列协议之间的消息流桥接。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Bus](https://github.com/mustafaturan/bus)  | 114 |  内部通信的最小消息总线实现。 |![star > 100][Bronze]
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3661 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [EventBus](https://github.com/asaskevich/EventBus)  | 552 |  具有异步兼容性的轻量级事件总线。 |![star > 100][Bronze]
| [gaurun-client](https://github.com/osamingo/gaurun-client)  | 8 |  用Go编写的Gaurun客户端。 |
| [Glue](https://github.com/desertbit/glue)  | 316 |  健壮的Go和Javascript Socket库(替代Socket.io)。 |![star > 100][Bronze]
| [go-notify](https://github.com/TheCreeper/go-notify)  | 47 |  原生的freedesktop通知规范实现。 |
| [go-nsq](https://github.com/nsqio/go-nsq)  | 1452 |  NSQ的官方Go包。 |![star > 1000][Silver]
| [go-socket.io](https://github.com/googollee/go-socket.io)  | 2868 |  go的socket.io库，一个实时应用程序框架。 |![star > 1000][Silver]
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3346 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mangos](https://github.com/go-mangos/mangos)  | 1534 |  Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。 |![star > 1000][Silver]
| [melody](https://github.com/olahol/melody)  | 1550 |  处理websocket session的极简框架，包括广播和自动ping/pong处理。 |![star > 1000][Silver]
| [Mercure](https://github.com/dunglas/mercure)  | 1483 |  使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [NATS Go Client](https://github.com/nats-io/nats)  | 2384 |  轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pubsub](https://github.com/tuxychandru/pubsub)  | 273 |  简单的pubsub的go包。 |![star > 100][Bronze]
...
| [sarama](https://github.com/Shopify/sarama)  | 4583 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1684 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4411 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3345 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [dig](https://github.com/uber-go/dig)  | 895 |  一个基于反射的Go依赖注入工具包。 |![star > 100][Bronze]
| [fx](https://github.com/uber-go/fx)  | 714 |  基于依赖注入的Go应用程序框架(构建在dig之上)。 |![star > 100][Bronze]
| [gocontainer](https://github.com/vardius/gocontainer)  | 9 |  简单的依赖注入容器。 |   ![最近一个周有更新][Green]
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8921 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]
| [scaffold](https://github.com/catchplay/scaffold)  | 23 |  快速生成Go项目布局的脚手架。让您专注于已实现的业务逻辑。 |
...
| [archiver](https://github.com/mholt/archiver)  | 2476 |  用于生成和解压.zip和.tar.gz文档的库和命令。 |![star > 1000][Silver]
...
| [banner](https://github.com/dimiro1/banner)  | 230 |  在Go应用程序中添加漂亮的横幅(banner)。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [base64Captcha](https://github.com/mojocn/base64Captcha)  | 622 |  base64Captcha支持数字，字母，算术，音频和混合模式的验证码。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [go-commons-pool](https://github.com/jolestar/go-commons-pool)  | 665 |  Go语言的通用对象池。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [gommit](https://github.com/antham/gommit)  | 72 |  分析git提交消息，确保它们遵循已定义的格式。 |   ![最近一个周有更新][Green]
| [gopsutil](https://github.com/shirou/gopsutil)  | 3893 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [healthcheck](https://github.com/etherlabsio/healthcheck)  | 81 |  用于RESTful服务的强制的(opinionated)并发健康检查HTTP处理程序。 |
...
| [lk](https://github.com/hyperboloide/lk)  | 120 |  一个简单的版权许可证库。 |![star > 100][Bronze]
| [llvm](https://github.com/llir/llvm)  | 409 |  用于在纯Go中与LLVM IR交互的库。 |![star > 100][Bronze]
...
| [shortid](https://github.com/teris-io/shortid)  | 447 |  分布式地生成超短、唯一、非顺序、URL友好的id。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [gojieba](https://github.com/yanyiwu/gojieba)  | 814 |  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [gse](https://github.com/go-ego/gse)  | 1065 |  高效的文本分割;支持英语、汉语、日语等。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [dns](https://github.com/miekg/dns)  | 3775 |  用于 DNS 的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [fasthttp](https://github.com/valyala/fasthttp)  | 9246 |  一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [fortio](https://github.com/fortio/fortio)  | 862 |  负载测试库和命令行工具，高级的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。支持Tcp、Http、gRPC。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ftp](https://github.com/jlaffaye/ftp)  | 521 |  实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户端。 |![star > 100][Bronze]
| [gmqtt](https://github.com/DrmagicE/gmqtt)  | 82 |  Gmqtt是一个灵活、高性能的MQTT代理库，它完全实现了MQTT协议V3.1.1。 |   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [gobgp](https://github.com/osrg/gobgp)  | 1666 |  基于 Go 的 BGP 实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [golibwireshark](https://github.com/sunwxg/golibwireshark)  | 15 |  用于解码 pcap 文件和分析解剖数据。 |   ![最近一年没有更新][Yellow]
| [gopacket](https://github.com/google/gopacket)  | 2858 |  Go library for packet processing with libpcap bindings. |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gotcp](https://github.com/gansidui/gotcp)  | 411 |  用于快速编写 tcp 应用程序。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [HTTPLab](https://github.com/gchaincl/httplab)  | 3401 |  HTTPLabs 允许你检查 HTTP 请求和伪造响应。 |![star > 1000][Silver]
...
| [kcptun](https://github.com/xtaci/kcptun)  | 10629 |  基于KCP协议的非常简单和快速udp隧道。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [lhttp](https://github.com/fanux/lhttp)  | 512 |  强大的websocket框架，可以让你更容易的构建IM服务器。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
...
| [mdns](https://github.com/hashicorp/mdns)  | 547 |  简单mDNS(Multicast DNS)客户端/服务器库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [mqttPaho](https://eclipse.org/paho/clients/golang/)  | - |  Paho Go客户端提供了一个 MQTT 客户端库，用于通过TCP、TLS或WebSockets连接到MQTT代理。 |
| [NFF-Go](https://github.com/intel-go/nff-go)  | 655 |  用于快速开发云计算和裸机网络功能的框架(原YANFF)。 |![star > 100][Bronze]
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2872 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [ssh](https://github.com/gliderlabs/ssh)  | 1102 |  用于构建SSH服务器的高级API(封装密码/ SSH)。 |![star > 1000][Silver]
| [sslb](https://github.com/eduardonunesp/sslb)  | 113 |  它是一个超级简单的负载平衡器，只是一个实现某种性能的小项目。 |![star > 100][Bronze]
| [stun](https://github.com/go-rtc/stun)  | 270 |  Go实现的RFC 5389 STUN协议。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [tcp_server](https://github.com/firstrow/tcp_server)  | 282 |   Go 图书馆建设tcp服务器更快。 |![star > 100][Bronze]
...
| [webrtc](https://github.com/pions/webrtc)  | 2171 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gentleman](https://github.com/h2non/gentleman)  | 675 |  功能齐全的插件驱动HTTP客户端库。 |![star > 100][Bronze]
...
| [heimdall](https://github.com/gojektech/heimdall)  | 1067 |  具有重试和hystrix功能的增强http客户机。 |![star > 1000][Silver]
| [pester](https://github.com/sethgrid/pester)  | 326 |  使用重试、后退和并发执行HTTP客户机调用。 |![star > 100][Bronze]
| [rq](https://github.com/ddo/rq)  | 26 |  golang stdlib HTTP客户端更好的接口。 |
| [sling](https://github.com/dghubble/sling)  | 991 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gl](https://github.com/go-gl/gl)  | 639 |  OpenGL 的 Go 接口实现(通过glow生成)。 |![star > 100][Bronze]
...
| [go-pg](https://github.com/go-pg/pg)  | 2943 |  用于 PostgreSQL 的ORM。侧重于 PostgreSQL 的特性和性能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-queryset](https://github.com/jirfag/go-queryset)  | 446 |  基于 GORM 100% 类型安全的 ORM。可支持 MySQL, PostgreSQL, Sqlite3, SQL Server。 |![star > 100][Bronze]
...
| [GORM](https://github.com/jinzhu/gorm)  | 14537 |  一个出色的 ORM 库。主要目标是对开发人员友好。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Marlow](https://github.com/dadleyy/marlow)  | 63 |  从项目结构生成ORM。 |   ![最近一个周有更新][Green]
| [pop/soda](https://github.com/gobuffalo/pop)  | 673 |  数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [QBS](https://github.com/coocood/qbs)  | 539 |  Stands for Query By Struct. A Go ORM. |![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
| [reform](https://github.com/go-reform/reform)  | 792 |  基于非空接口和代码生成的 ORM。 |![star > 100][Bronze]
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2252 |  ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]
| [upper.io/db](https://github.com/upper/db)  | 1840 |  对外提供统一的接口用于访问不同的存储介质，例如PostgreSQL, MySQL, SQLite, MSSQL, QL、MongoDB.。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Xorm](https://github.com/go-xorm/xorm)  | 5153 |  基于 Go 的简单而强大的ORM。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12538 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]
...
| [glide](https://github.com/Masterminds/glide)  | 7772 |  轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。 |![star > 5000][Gold]
...
| [gopm](https://github.com/gpmgo/gopm)  | 2350 |  包管理器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [govendor](https://github.com/kardianos/govendor)  | 4725 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gojsonq](https://github.com/thedevsaddam/gojsonq)  | 855 |  一个用来查询JSON数据的Go包。 |![star > 100][Bronze]
| [graphql](https://github.com/tmc/graphql)  | 51 |  graphql解析器+工具集 |   ![最近一年没有更新][Yellow]
| [graphql](https://github.com/neelance/graphql-go)  | 2754 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [graphql-go](https://github.com/graphql-go/graphql)  | 5176 |  为Go实现GraphQL。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [packr](https://github.com/gobuffalo/packr)  | 2089 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [statics](https://github.com/go-playground/statics)  | 53 |  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。 |   ![最近一年没有更新][Yellow]
| [statik](https://github.com/rakyll/statik)  | 2082 |  将静态文件嵌入到Go可执行文件中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go)  | 74 |  用于机器学习和统计的数据模型(类似于 pandas)。 |   ![最近一个周有更新][Green]
...
| [gonum](https://github.com/gonum/gonum)  | 2927 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gonum/plot](https://github.com/gonum/plot)  | 1205 |  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。 |![star > 1000][Silver]
...
| [stats](https://github.com/montanaflynn/stats)  | 1337 |  包含Golang标准库中缺少的公共函数的统计软件包。 |![star > 1000][Silver]
...
| [acra](https://github.com/cossacklabs/acra)  | 449 |  网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。 |![star > 100][Bronze]
...
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1818 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]
...
| [lego](https://github.com/xenolf/lego)  | 3467 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [memguard](https://github.com/awnumar/memguard)  | 1397 |  一个用于处理内存中敏感值的纯Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [secure](https://github.com/unrolled/secure)  | 1198 |  Go 语言 HTTP 中间件，为 Go 提供了一些安全功能 |![star > 1000][Silver]
...
| [csvutil](https://github.com/jszwec/csvutil)  | 300 |  高性能、惯用的CSV记录编码和解码到本机Go结构。 |![star > 100][Bronze]
...
| [go-codec](https://github.com/ugorji/go)  | 1227 |  高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2917 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 5036 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5488 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mapstructure](https://github.com/mitchellh/mapstructure)  | 2385 |  用于对原生键值对进行解码生成 Go 语言结构体 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algernon](https://github.com/xyproto/algernon)  | 1582 |  内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。 |![star > 1000][Silver]
| [Caddy](https://github.com/mholt/caddy)  | 23043 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [consul](https://www.consul.io/)  | - |  Consul 是一个用于服务发现、监控和配置的工具 |
| [devd](https://github.com/cortesi/devd)  | 2800 |  为开发人员提供本地web服务器。 |![star > 1000][Silver]
| [discovery](https://github.com/Bilibili/discovery)  | 668 |  用于弹性中间层负载平衡和故障转移的注册表。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [etcd](https://github.com/coreos/etcd)  | 26282 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Fider](https://github.com/getfider/fider)  | 788 |  Fider是一个收集和组织客户反馈的开放平台。 |![star > 100][Bronze]
| [Flagr](https://github.com/checkr/flagr)  | 815 |  Flagr是一个开源特性标记和A/B测试服务。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [flipt](https://github.com/markphelps/flipt)  | 983 |  一个用Go和Vue.js编写的自包含特性标志解决方案 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [jackal](https://github.com/ortuman/jackal)  | 710 |  用Go编写的XMPP服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [minio](https://github.com/minio/minio)  | 17177 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3231 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gofpdf](https://github.com/jung-kurt/gofpdf)  | 3062 |  PDF 文档生成器，支持文本，绘图和图片 |![star > 1000][Silver]
| [goview](https://github.com/foolin/goview)  | 43 |  Goview是一个轻量级、极简的模板库，基于golang html/template构建Go web应用程序。 |
| [hero](https://github.com/shiyanhui/hero)  | 1199 |  Hero是一个方便、快速和强大的go模板引擎。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [endly](https://github.com/viant/endly)  | 91 |  声明性端到端功能测试。 |
...
| [go-cmp](https://github.com/google/go-cmp)  | 1134 |  用于比较测试中的Go值的包。 |![star > 1000][Silver]
...
| [goblin](https://github.com/franela/goblin)  | 616 |  类似Mocha的测试框架。 |![star > 100][Bronze]
...
| [godog](https://github.com/DATA-DOG/godog)  | 745 |  类似 Cucumber 或 Behat 的 BDD 框架 |![star > 100][Bronze]
| [gofight](https://github.com/appleboy/gofight)  | 253 |  对 Go 语言的路由框架进行 API 测试 |![star > 100][Bronze]
...
| [httpexpect](https://github.com/gavv/httpexpect)  | 1137 |  简洁的、声明式的、易用的端到端HTTP 及 REST API 测试 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Testify](https://github.com/stretchr/testify)  | 8051 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter)  | 357 |  用于生成自包含 mock 对象的工具 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1718 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]
| [go-txdb](https://github.com/DATA-DOG/go-txdb)  | 158 |  基于单事务的数据库驱动，主要用于测试目的 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gock](https://github.com/h2non/gock)  | 807 |  多功能、易用 HTTP mock |![star > 100][Bronze]
| [gomock](https://github.com/golang/mock)  | 2802 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]
| [govcr](https://github.com/seborama/govcr)  | 82 |  HTTP mock : 离线测试时记录和重放浏览器的动作 |   ![最近一个周有更新][Green]
| [hoverfly](https://github.com/SpectoLabs/hoverfly)  | 1433 |  使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [httpmock](https://github.com/jarcoal/httpmock)  | 576 |  轻松模拟来自外部资源的HTTP响应。 |![star > 100][Bronze]
| [minimock](https://github.com/gojuno/minimock)  | 256 |  Go接口的模拟生成器。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-fuzz](https://github.com/dvyukov/go-fuzz)  | 2865 |  随机测试系统。 |![star > 1000][Silver]
...
| [chromedp](https://github.com/knq/chromedp)  | 3514 |  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品 |![star > 1000][Silver]
...
| [selenoid](https://github.com/aerokube/selenoid)  | 1216 |  Selenium hub 服务器的替代品，在容器中启动浏览器 |![star > 1000][Silver]   ![最近一个周有更新][Green]

* Fail injection
        
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [failpoint](https://github.com/pingcap/failpoint)  | 381 |  为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。 |![star > 100][Bronze]
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3871 |  Markdown 解析器 |![star > 1000][Silver]
| [bluemonday](https://github.com/microcosm-cc/bluemonday)  | 1235 |  HTML 清理工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [codetree](https://github.com/aerogo/codetree)  | 7 |  解析缩进代码(python、pixy、scarlet等)并返回树结构。 |
| [colly](https://github.com/asciimoo/colly)  | 8293 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [commonregex](https://github.com/mingrammer/commonregex)  | 551 |  一组用于Go的公共正则表达式。 |![star > 100][Bronze]
| [dataflowkit](https://github.com/slotix/dataflowkit)  | 287 |  Web抓取框架将网站转换为结构化数据。 |![star > 100][Bronze]
...
| [go-humanize](https://github.com/dustin/go-humanize)  | 1888 |  格式化程序，用于将时间、数字和内存大小转换为可读格式。 |![star > 1000][Silver]
...
| [gographviz](https://github.com/awalterschulze/gographviz)  | 293 |  解析Graphviz DOT语言。 |![star > 100][Bronze]
...
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7525 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]
...
| [htmlquery](https://github.com/antchfx/htmlquery)  | 127 |  用于HTML的XPath查询包，允许您通过XPath表达式从HTML文档中提取数据或求值。 |![star > 100][Bronze]
| [inject](https://github.com/facebookgo/inject)  | 1133 |  包注入提供了一个基于反射的注入器。 |![star > 1000][Silver]
| [ltsv](https://github.com/Wing924/ltsv)  | 2 |  用于Go的高性能[LTSV(标签为Tab Separeted Value)](http://ltsv.org/)阅读器。 |
| [mxj](https://github.com/clbanning/mxj)  | 329 |  将XML编码/解码为JSON或map[string]接口{};使用点符号路径和通配符提取值。替换x2j和j2x包。 |![star > 100][Bronze]
| [sdp](https://github.com/gortc/sdp)  | 69 |  SDP:会话描述协议[[RFC 4566](https://tools.ietf.org/html/rfc4566)]。 |   ![最近一个周有更新][Green]
| [sh](https://github.com/mvdan/sh)  | 1975 |  Shell解析器和格式化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [toml](https://github.com/BurntSushi/toml)  | 2762 |  TOML配置格式(带反射的编码器/解码器)。 |![star > 1000][Silver]
* Utility
        
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself)  | 15 |  一个基于 sanitization 的 Go 敏感词过滤器。 |
| [gotabulate](https://github.com/bndr/gotabulate)  | 199 |  使用 Go 语言简单、美观的打印表格数据 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 5000 |  AWS 提供的官方go语言 SDK |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [discordgo](https://github.com/bwmarrin/discordgo)  | 965 |   Discord Chat API的客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ethrpc](https://github.com/onrik/ethrpc)  | 168 |   Ethereum JSON RPC API的客户端。 |![star > 100][Bronze]
| [facebook](https://github.com/huandu/facebook)  | 766 |  支持 Facebook Graph API 的库 |![star > 100][Bronze]
...
| [github](https://github.com/google/go-github)  | 4742 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-jira](https://github.com/andygrunwald/go-jira)  | 569 |   Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-marathon](https://github.com/gambol99/go-marathon)  | 189 |   用于和 Mesosphere's Marathon PAAS 交互的 Go 语言库 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-twitter](https://github.com/dghubble/go-twitter)  | 707 |   Twitter v1.1 api 的客户端。。 |![star > 100][Bronze]
...
| [google](https://github.com/google/google-api-go-client)  | 1910 |  为Go自动生成谷歌api。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [google-analytics](https://github.com/chonthu/go-google-analytics)  | 12 |  简单的包装，方便的谷歌分析报告。 |   ![最近一年没有更新][Yellow]
| [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang)  | 1766 |  谷歌云api Go 客户端库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [minio-go](https://github.com/minio/minio-go)  | 713 |  用于Amazon S3兼容云存储的Minio Go库。 |![star > 100][Bronze]
...
| [slack](https://github.com/nlopes/slack)  | 2396 |  Slack API。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [stripe](https://github.com/stripe/stripe-go)  | 935 |   Stripe API 的 Go 语言客户端 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [boilr](https://github.com/tmrts/boilr)  | 929 |  非常快的CLI工具，用于从样板模板创建项目。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [circuitbreaker](https://github.com/rubyist/circuitbreaker)  | 785 |  接通断路器。 |![star > 100][Bronze]
...
| [ctop](https://github.com/bcicen/ctop)  | 8780 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]
...
| [delve](https://github.com/derekparker/delve)  | 11929 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [filetype](https://github.com/h2non/filetype)  | 939 |  通过数字签名来推测文件类型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [fzf](https://github.com/junegunn/fzf)  | 22972 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [git-time-metric](https://github.com/git-time-metric/gtm)  | 713 |  git-time-metric - 。 |![star > 100][Bronze]
...
| [go-funk](https://github.com/thoas/go-funk)  | 1156 |  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...) |![star > 1000][Silver]
...
| [go-torch](https://github.com/uber/go-torch)  | 3634 |  为 Go 语言程序生成火焰图。 |![star > 1000][Silver]
...
| [goreleaser](https://github.com/goreleaser/goreleaser)  | 4471 |  尽可能快速的发布 Go 语言二进制文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [hub](https://github.com/github/hub)  | 16869 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hystrix-go](https://github.com/afex/hystrix-go)  | 1995 |  实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。 |![star > 1000][Silver]
...
| [koazee](https://github.com/wesovilabs/koazee)  | 293 |  库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。 |![star > 100][Bronze]
| [lrserver](https://github.com/jaschaephraim/lrserver)  | 100 |  LiveReload 服务器。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [mc](https://github.com/minio/mc)  | 1099 |  Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mergo](https://github.com/imdario/mergo)  | 845 |  用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [profile](https://github.com/pkg/profile)  | 998 |  Go的简单分析支持包。 |![star > 100][Bronze]
| [rclient](https://github.com/zpatrick/rclient)  | 27 |  可读、灵活、易于使用的REST api客户端。 |
| [realize](https://github.com/tockins/realize)  | 3142 |  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。 |![star > 1000][Silver]
...
| [resty](https://github.com/go-resty/resty)  | 1940 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]
| [retry](https://github.com/kamilsk/retry)  | 152 |  基于上下文的功能机制，反复执行命令直到成功。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [sqlx](https://github.com/jmoiron/sqlx)  | 6726 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [sslice](https://github.com/yaa110/sslice)  | 4 |  创建一个总是排序的切片。 |
| [Storm](https://github.com/asdine/storm)  | 1343 |  一个简单又强大的用于 BoltDB 的工具 |![star > 1000][Silver]
| [structs](https://github.com/PumpkinSeed/structs)  | 12 |  简单来讲就是 "Make" 的替代品。 |   ![最近一年没有更新][Yellow]
| [Task](https://github.com/go-task/task)  | 1920 |  简单的“Go”的选择。 |![star > 1000][Silver]
| [toolbox](https://github.com/viant/toolbox)  | 92 |  切片, map, multimap, 结构体, 函数,数据转换工具。服务路由，宏求值和标记器。 |   ![最近一个周有更新][Green]
...
| [usql](https://github.com/knq/usql)  | 4662 |  usql 是一个通用的命令行接口，用于操作 sql 数据库。 |![star > 1000][Silver]
| [util](https://github.com/shomali11/util)  | 133 |  有用实用函数的集合。(字符串，并发，操作，…) |![star > 100][Bronze]
| [wuzz](https://github.com/asciimoo/wuzz)  | 8249 |  用于HTTP检查的交互式cli工具。 |![star > 5000][Gold]
...
| [ulid](https://github.com/oklog/ulid)  | 1668 |  实现了ULID(普遍唯一的词典分类标识符)。 |![star > 1000][Silver]
...
| [uuid](https://github.com/gofrs/uuid)  | 563 |  通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。 |![star > 100][Bronze]
| [wuid](https://github.com/edwingeng/wuid)  | 283 |  一个非常快的唯一数字生成器，比UUID快10-135倍。 |![star > 100][Bronze]
...
| [govalidator](https://github.com/asaskevich/govalidator)  | 3530 |  用于字符串，数字，切片和结构的验证器和sanitizers。 |![star > 1000][Silver]
...
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation)  | 1029 |  支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。 |![star > 1000][Silver]
...
| [validator](https://github.com/go-playground/validator)  | 3458 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]
...
| [git2go](https://github.com/libgit2/git2go)  | 1353 |   libgit2 的 Go 语言接口。 |![star > 1000][Silver]
| [go-git](https://github.com/src-d/go-git)  | 4178 |  纯Go中高度可扩展的Git实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gmf](https://github.com/3d0c/gmf)  | 523 |   FFmpeg av\* 库的 Go 语言接口。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [goav](https://github.com/giorgisio/goav)  | 771 |  FFmpeg的Comphrensive。 |![star > 100][Bronze]
...
| [Beego](https://github.com/astaxie/beego)  | 21371 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14588 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Gin](https://github.com/gin-gonic/gin)  | 29673 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2836 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Goa](https://github.com/goadesign/goa)  | 3498 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Macaron](https://github.com/go-macaron/macaron)  | 2808 |  Macaron 是一个高效的模块化设计的web框架 |![star > 1000][Silver]
...
| [Revel](https://github.com/revel/revel)  | 11227 |  用于Go语言的高效web框架。 |![star > 5000][Gold]
...
| [tigertonic](https://github.com/rcrowley/go-tigertonic)  | 994 |  用于构建 JSON web 服务的 Go 语言框架，受到 Dropwizard 的启发。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [traffic](https://github.com/pilu/traffic)  | 519 |  Sinatra启发了regexp/pattern mux和用于Go的web框架。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [uAdmin](https://github.com/uadmin/uadmin)  | 51 |  受到 Sinatra 启发的 Go 语言 web 框架。 |
...
| [CORS](https://github.com/rs/cors)  | 1208 |  轻松地向API添加CORS功能。 |![star > 1000][Silver]
...
| [Limiter](https://github.com/ulule/limiter)  | 785 |  简单的速度限制中间件。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ln-paywall](https://github.com/philippgille/ln-paywall)  | 88 |  使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。 |
| [Tollbooth](https://github.com/didip/tollbooth)  | 1240 |  限制速率的 HTTP 请求处理程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [negroni](https://github.com/urfave/negroni)  | 6312 |  符合语言习惯的 HTTP 中间件库。 |![star > 5000][Gold]   ![包含中文文档][CN]
...
| [chi](https://github.com/go-chi/chi)  | 5992 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]
...
| [Goji](https://github.com/goji/goji)  | 767 |  枸杞是一种简约的和灵活的与支持'net/context` HTTP请求多路复用器。 |![star > 100][Bronze]
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9660 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]
...
| [mux](https://github.com/gorilla/mux)  | 9604 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]
| [ozzo-routing](https://github.com/go-ozzo/ozzo-routing)  | 358 |  一个非常快的Go (golang) HTTP路由器，支持正则表达式路由匹配。完全支持构建RESTful api。 |![star > 100][Bronze]
...
| [xujiajun/gorouter](https://github.com/xujiajun/gorouter)  | 449 |  一个简单和快速的HTTP路由器 Go 。 |![star > 100][Bronze]
...
| [zek](https://github.com/miku/zek)  | 252 |  从XML生成Go结构。 |![star > 100][Bronze]
...
| [gcvis](https://github.com/davecheney/gcvis)  | 917 |  实时可视化跟踪 GC 数据。 |![star > 100][Bronze]
...
| [GoLint](https://github.com/golang/lint)  | 3135 |  Go 源码的 linter。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [php-parser](https://github.com/z7zmey/php-parser)  | 633 |  用 Go 编写的 PHP 解析器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-mode](https://github.com/dominikh/go-mode.el)  | 946 |  在 GNU/Emacs 支持 GO。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-plus](https://github.com/joefitzgerald/go-plus)  | 1480 |  在 Atom 中添加自动完成，格式化，语法检查，高亮和审查。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gocode](https://github.com/nsf/gocode)  | 4732 |  Autocompletion daemon for the Go programming language. |![star > 1000][Silver]
| [goprofiling](https://marketplace.visualstudio.com/items?itemName=MaxMedia.go-prof)  | - |  在 VS Code 中支持 Go 的基准分析。 |
| [GoSublime](https://github.com/DisposaBoy/GoSublime)  | 3233 |  包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [vim-go](https://github.com/fatih/vim-go)  | 10785 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5097 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [genny](https://github.com/cheekybits/genny)  | 952 |  优雅的 Go 泛型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gotests](https://github.com/cweill/gotests)  | 2178 |  从源代码生成测试用例。 |![star > 1000][Silver]
...
| [depth](https://github.com/KyleBanks/depth)  | 373 |  通过分析导入，将包依赖关系树可视化输出。 |![star > 100][Bronze]
...
| [go-callvis](https://github.com/TrueFurby/go-callvis)  | 1981 |  使用 dot format 可视化 Go 程序的调用图。 |![star > 1000][Silver]
| [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete)  | 37 |  Bash completion for go and wgo。 |   ![最近一年没有更新][Yellow]
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3946 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [godbg](https://github.com/tylerwince/godbg)  | 156 |  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。 |![star > 100][Bronze]
| [OctoLinker](https://github.com/OctoLinker/browser-extension)  | 3747 |  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [aurora](https://github.com/xuri/aurora)  | 401 |  基于web的跨平台 Beanstalkd 队列服务器控制台。 |![star > 100][Bronze]
...
| [bosun](https://github.com/bosun-monitor/bosun)  | 2851 |  按照时间轴发出告警的框架。 |![star > 1000][Silver]
...
| [Gitea](https://github.com/go-gitea/gitea)  | 15057 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate)  | 665 |  允许你的 Go应用程序 进行自我更新。 |![star > 100][Bronze]
...
| [gox](https://github.com/mitchellh/gox)  | 3347 |  非常简单，没有多余的跨平台编译工具。 |![star > 1000][Silver]
...
| [Hey](https://github.com/rakyll/hey)  | 6242 |  压力测试工具，可用来代替 ApacheBench (ab)。 |![star > 5000][Gold]
| [kala](https://github.com/ajvb/kala)  | 1355 |  简单、现代和高性能的作业调度程序。 |![star > 1000][Silver]
| [kcli](https://github.com/cswank/kcli)  | 78 |  用于检查kafka主题/分区/消息的命令行工具。 |
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55872 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Moby](https://github.com/moby/moby)  | 54311 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Packer](https://github.com/mitchellh/packer)  | 9212 |  用于从一个源配置为多个平台创建相同的机器图像。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Pewpew](https://github.com/bengadbois/pewpew)  | 201 |  灵活的 HTTP 命令行压测工具。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [script](https://github.com/bitfield/script)  | 906 |  让DevOps编写类shell和系统管理任务变得更加容易。 |![star > 100][Bronze]
| [sg](https://github.com/ChristopherRabotin/sg)  | 5 |  可测试一组HTTP极限(如ab)，可以在每个调用之间使用响应代码和数据，根据之前的响应来确定特定的服务器压力。 |   ![最近一年没有更新][Yellow]
| [skm](https://github.com/TimothyYe/skm)  | 548 |  SKM是一个简单而强大的SSH密钥管理器，它可以帮助您轻松地管理多个SSH密钥! |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [StatusOK](https://github.com/sanathp/statusok)  | 1158 |  监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。 |![star > 1000][Silver]
| [traefik](https://github.com/containous/traefik)  | 23592 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 12087 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [webhook](https://github.com/adnanh/webhook)  | 4064 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]
...
| [Comcast](https://github.com/tylertreat/Comcast)  | 6166 |  模拟坏的网络连接。 |![star > 5000][Gold]
| [confd](https://github.com/kelseyhightower/confd)  | 6398 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]
| [DDNS](https://github.com/skibish/ddns)  | 97 |  个人 DDNS 客户端。 |
| [Docker](http://www.docker.com/)  | - |  面向开发人员和系统管理员的分布式应用程序的开放平台。 |
| [Documize](https://github.com/documize/community)  | 820 |  集成了SaaS工具数据的现代wiki软件。 |![star > 100][Bronze]
| [drive](https://github.com/odeke-em/drive)  | 4950 |  基于命令行的谷歌驱动器客户端。 |![star > 1000][Silver]
| [Duplicacy](https://github.com/gilbertchen/duplicacy)  | 2681 |  跨平台网络和云备份工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GoBoy](https://github.com/Humpheh/goboy)  | 2097 |  用 Go 编写的任天堂Game Boy彩色模拟器。 |![star > 1000][Silver]
| [gocc](https://github.com/goccmack/gocc)  | 342 |  Gocc是一个用Go编写的编译器工具包。 |![star > 100][Bronze]
| [GoDNS](https://github.com/timothyye/godns)  | 425 |  一个动态DNS客户端工具，支持DNSPod & HE.net。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Gor](https://github.com/buger/gor)  | 11309 |  Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。 |![star > 5000][Gold]
...
| [lgo](https://github.com/yunabe/lgo)  | 1799 |  与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。 |![star > 1000][Silver]
| [limetext](http://limetext.org/)  | - |  一个强大而优雅的文本编辑器。 |
| [LiteIDE](https://github.com/visualfc/liteide)  | 5468 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [myLG](https://github.com/mehrdadrad/mylg)  | 2195 |  命令行网络诊断工具。 |![star > 1000][Silver]
...
| [peg](https://github.com/pointlander/peg)  | 605 |  解析表达式语法，是Packrat解析器生成器的实现。 |![star > 100][Bronze]
| [Pipe](https://github.com/b3log/pipe)  | 2874 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]
| [restic](https://github.com/restic/restic)  | 7398 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [rkt](https://github.com/coreos/rkt)  | 8732 |  一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [scc](https://github.com/boyter/scc)  | 768 |  一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Seaweed File System](https://github.com/chrislusf/seaweedfs)  | 8183 |  快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [shell2http](https://github.com/msoap/shell2http)  | 402 |  通过http服务器执行shell命令(用于原型或远程控制)。 |![star > 100][Bronze]
| [snap](https://github.com/intelsdi-x/snap)  | 1803 |  强大的遥测框架。 |![star > 1000][Silver]
...
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3919 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark)  | 992 |  web框架基准测试。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks)  | 859 |  Go序列化方法的基准测试。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
