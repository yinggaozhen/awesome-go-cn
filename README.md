...
* [Oto](https://github.com/hajimehoshi/oto) **star:441** 多平台的 low-level 声音播放库。   ![star > 100][Bronze]
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) **star:6053** JSON Web令牌(JWT)。   ![star > 5000][Gold]
* [casbin](https://github.com/hsluoyz/casbin) **star:5003** 支持ACL、RBAC、ABAC等访问控制模型的授权库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [oauth2](https://github.com/golang/oauth2) **star:2389** goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。   ![star > 1000][Silver]
* [goth](https://github.com/markbates/goth) **star:2285** 提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [authboss](https://github.com/volatiletech/authboss) **star:1940** web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。   ![star > 1000][Silver]
* [osin](https://github.com/openshift/osin) **star:1547** OAuth2服务器库。   ![star > 1000][Silver]
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) **star:1289** 用 Golang 编写的独立且符合规范的OAuth2服务器。   ![star > 1000][Silver]
* [go-jose](https://github.com/square/go-jose) **star:1136** 相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。   ![star > 1000][Silver]
* [gologin](https://github.com/dghubble/gologin) **star:1047** 用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [scs](https://github.com/alexedwards/scs) **star:531** HTTP服务器的会话管理器。   ![star > 100][Bronze]
...
* [telebot](https://github.com/tucnak/telebot) **star:957** 用Go编写的Telegram bot框架。   ![star > 100][Bronze]
...
* [cobra](https://github.com/spf13/cobra) **star:13451** 现代Go CLI命令行交互工具。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [urfave/cli](https://github.com/urfave/cli) **star:11522** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [kingpin](https://github.com/alecthomas/kingpin) **star:2564** 支持子命令的命令行和标志解析器。   ![star > 1000][Silver]
* [go-flags](https://github.com/jessevdk/go-flags) **star:1516**  Go 命令行选项解析器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [pflag](https://github.com/spf13/pflag) **star:756** 基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [go-arg](https://github.com/alexflint/go-arg) **star:745** 基于结构的参数解析。   ![star > 100][Bronze]
...
* [ops](https://github.com/nanovms/ops) **star:268** Unikernel 构建器/协调器。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [termui](https://github.com/gizak/termui) **star:8958** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。   ![star > 5000][Gold]
* [gommon/color](https://github.com/labstack/gommon/tree/master/color)  更换终端文本样式。
* [gocui](https://github.com/jroimartin/gocui) **star:5415** 旨在创建控制台用户界面的极简Go库。   ![star > 5000][Gold]
* [termbox-go](https://github.com/nsf/termbox-go) **star:3496** 基于文本的跨平台接口库。   ![star > 1000][Silver]
* [color](https://github.com/fatih/color) **star:3029** 多功能包装，彩色终端输出。   ![star > 1000][Silver]   ![归档项目][Archived]
* [go-prompt](https://github.com/c-bata/go-prompt) **star:2349** 构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit)   ![star > 1000][Silver]
...
* [uilive](https://github.com/gosuri/uilive) **star:835** 用于实时更新终端输出的库。   ![star > 100][Bronze]
...
* [mpb](https://github.com/vbauerster/mpb) **star:710** 可在终端显示多进度条。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [aurora](https://github.com/logrusorgru/aurora) **star:639** 支持fmt.Printf/Sprintf的ANSI终端颜色。   ![star > 100][Bronze]
* [progressbar](https://github.com/schollz/progressbar) **star:579** 基本线程安全的进度条，在每个操作系统工作。   ![star > 100][Bronze]
...
* [chalk](https://github.com/ttacon/chalk) **star:306** 美化终端/控制台输出。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [tabby](https://github.com/cheynewallace/tabby) **star:248** 一个可在终端生成一个极简Golang表格轻量级库   ![star > 100][Bronze]
* [gookit/color](https://github.com/gookit/color) **star:209** 终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。   ![star > 100][Bronze]   ![最近一周有更新][Green]   ![包含中文文档][CN]
...
* [viper](https://github.com/spf13/viper) **star:9413** 配置管理。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) **star:2418** 管理来自环境变量的配置数据。   ![star > 1000][Silver]
* [godotenv](https://github.com/joho/godotenv) **star:2143** Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。   ![star > 1000][Silver]
* [ini](https://github.com/go-ini/ini) **star:1604**  读和写INI文件。   ![star > 1000][Silver]
* [env](https://github.com/caarlos0/env) **star:877** 解析环境变量并赋值到struct中(默认值)。   ![star > 100][Bronze]
...
* [drone](https://github.com/drone/drone) **star:19100** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [gods](https://github.com/emirpasic/gods) **star:6439** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。   ![star > 5000][Gold]
* [go-datastructures](https://github.com/Workiva/go-datastructures) **star:5144** 可靠的、高性能的和线程安全的数据结构的集合。   ![star > 5000][Gold]
* [golang-set](https://github.com/deckarep/golang-set) **star:1181** 线程安全和非线程安全的高性能集。   ![star > 1000][Silver]
* [boomfilters](https://github.com/tylertreat/BoomFilters) **star:1164** 用于处理连续的概率数据结构。   ![star > 1000][Silver]
* [gota](https://github.com/kniren/gota) **star:890** 实现了数据帧，序列以及数据噪音。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [roaring](https://github.com/RoaringBitmap/roaring) **star:669** 实现了压缩 bitsets 的Go包。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [binpacker](https://github.com/zhuangsirui/binpacker) **star:127** 帮助用户构建自定义二进制流的二进制封装器和解包器   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [prometheus](https://github.com/prometheus/prometheus) **star:25716** 用于监控系统和时序的数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [tidb](https://github.com/pingcap/tidb) **star:20159** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [influxdb](https://github.com/influxdb/influxdb) **star:17162** 可伸缩的数据存储，用于指标衡量、事件和实时分析。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [cockroach](https://github.com/cockroachdb/cockroach) **star:16817** 可伸缩、区域备份、事务性数据存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [dgraph](https://github.com/dgraph-io/dgraph) **star:10520** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [bolt](https://github.com/boltdb/bolt) **star:10010** K/V 数据库。   ![star > 5000][Gold]   ![最近一年没有更新][Yellow]   ![归档项目][Archived]
* [groupcache](https://github.com/golang/groupcache) **star:7679** Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。   ![star > 5000][Gold]
* [badger](https://github.com/dgraph-io/badger) **star:6307** 快速 K/V 存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [rqlite](https://github.com/rqlite/rqlite) **star:4710** 基于SQLite的轻量级分布式关系数据库。   ![star > 1000][Silver]
* [goleveldb](https://github.com/syndtr/goleveldb) **star:3175** 在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [ledisdb](https://github.com/siddontang/ledisdb) **star:3083** Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。   ![star > 1000][Silver]
* [go-cache](https://github.com/pmylund/go-cache) **star:2926** 基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。   ![star > 1000][Silver]
* [BigCache](https://github.com/allegro/bigcache) **star:2469** 高效的键/值缓存为千兆字节的数据。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [cache2go](https://github.com/muesli/cache2go) **star:1053** 基于内存的 K/V 缓存，支持超时的自动失效。   ![star > 1000][Silver]
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) **star:1032** 开源，快速，可伸缩的时间序列数据库。支持PromQL。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [fastcache](https://github.com/VictoriaMetrics/fastcache) **star:492** 基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。   ![star > 100][Bronze]
...
* [migrate](https://github.com/golang-migrate/migrate) **star:2781** 基于CLI的数据库迁移库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [sql-migrate](https://github.com/rubenv/sql-migrate) **star:1416** 数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。   ![star > 1000][Silver]
* [gormigrate](https://github.com/go-gormigrate/gormigrate) **star:336** 面向Gorm ORM的数据库 schema 迁移辅助程序。   ![star > 100][Bronze]
...
* [vitess](https://github.com/youtube/vitess) **star:8482** vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [pgweb](https://github.com/sosedoff/pgweb) **star:6001** 基于web的PostgreSQL数据库浏览器。   ![star > 5000][Gold]
* [kingshard](https://github.com/flike/kingshard) **star:4630** kingshard 是基于 Golang 的MySQL高性能代理。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [orchestrator](https://github.com/github/orchestrator) **star:3050** MySQL复制拓扑管理器和可视化工具。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) **star:2412** 自动将MySQL数据同步到Elasticsearch中。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [Squirrel](https://github.com/Masterminds/squirrel) **star:2337** 帮助您构建SQL查询的Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [xo](https://github.com/knq/xo) **star:2189** 基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gendry](https://github.com/didi/gendry) **star:768** 非入侵的SQL构建器和强大的数据绑定器。   ![star > 100][Bronze]   ![包含中文文档][CN]
...
* Relational Databases
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) **star:8133** MySQL驱动程序。   ![star > 5000][Gold]
    * [pq](https://github.com/lib/pq) **star:5205** 纯 Go 的Postgres驱动。   ![star > 5000][Gold]   ![最近一周有更新][Green]
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) **star:3435** SQLite3驱动程序。   ![star > 1000][Silver]
    * [pgx](https://github.com/jackc/pgx) **star:1969** PostgreSQL驱动，支持比现有database/sql更多的特性。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [go-mssqldb](https://github.com/denisenkom/go-mssqldb) **star:1024** 微软MSSQL驱动程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* NoSQL Databases
    * [redis](https://github.com/go-redis/redis) **star:6572** 基于 Go 的 Redis 客户端。   ![star > 5000][Gold]   ![最近一周有更新][Green]
    * [redigo](https://github.com/gomodule/redigo) **star:6321** Redigo 是基于 Go 的Redis 客户端。   ![star > 5000][Gold]
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) **star:3148** 官方的 MongoDB 驱动。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* Multiple Backends.
    * [cayley](https://github.com/google/cayley) **star:12698** 图形数据库，支持多个后端。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [now](https://github.com/jinzhu/now) **star:2190** now 是时间有关的工具类。   ![star > 1000][Silver]
* [dateparse](https://github.com/araddon/dateparse) **star:900** 可以解析很多格式不固定的日期字符串。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [go-kit](https://github.com/go-kit/kit) **star:14517** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [grpc-go](https://github.com/grpc/grpc-go) **star:9171** gRPC的Go语言实现。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [micro](https://github.com/micro/micro) **star:6617** 可插拔的微服务 toolkit 和分布式系统平台。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) **star:6374** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [rpcx](https://github.com/smallnest/rpcx) **star:3828** 分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [tendermint](https://github.com/tendermint/tendermint) **star:3163** 一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [torrent](https://github.com/anacrolix/torrent) **star:2876** BitTorrent 客户端。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [raft](https://github.com/coreos/etcd/tree/master/raft)  Raft consensus协议的实现。 by CoreOS。
* [raft](https://github.com/hashicorp/raft) **star:2853** Raft consensus协议的实现。 by HashiCorp。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [dragonboat](https://github.com/lni/dragonboat) **star:2553** 一个功能齐全，高性能的库集。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [glow](https://github.com/chrislusf/glow) **star:2538** 全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。   ![star > 1000][Silver]
* [gleam](https://github.com/chrislusf/gleam) **star:2107** 使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。   ![star > 1000][Silver]
* [emitter-io](https://github.com/emitter-io/emitter) **star:1943** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [KrakenD](https://github.com/devopsfaith/krakend) **star:1773** 具有中间件的高性能API网关框架。   ![star > 1000][Silver]
...
* [MailHog](https://github.com/mailhog/MailHog) **star:5190** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。   ![star > 5000][Gold]
...
* [go-message](https://github.com/emersion/go-message) **star:114** 用于Internet消息格式化和邮件消息的流媒体库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [otto](https://github.com/robertkrimen/otto) **star:4747** 用 Go 编写的 JavaScript 解释器。   ![star > 1000][Silver]
...
* [go-python](https://github.com/sbinet/go-python) **star:907** CPython C-API 的 Go 接口。   ![star > 100][Bronze]
...
* [errors](https://github.com/pkg/errors) **star:4916** 可让你很简单的进行错误处理。   ![star > 1000][Silver]
* [go-multierror](https://github.com/hashicorp/go-multierror) **star:733** 可将一系列的错误作为一个整体来显示。   ![star > 100][Bronze]
...
* [errlog](https://github.com/snwfdhmp/errlog) **star:188** 用于定位抛出错误的源代码(以及一些其他快速调试特性)。可插入到任何 logger 的位置。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [afero](https://github.com/spf13/afero) **star:2252** 文件系统的抽象系统。   ![star > 1000][Silver]
...
* [decimal](https://github.com/shopspring/decimal) **star:1614** 任意精度定点的十进制数。   ![star > 1000][Silver]
...
* [fuego](https://github.com/seborama/fuego) **star:40** Functional Experiment in Go。   ![最近一周有更新][Green]

## 游戏开发

*很棒的游戏开发库。 (翻译出错了? 试试 [英文版](README_EN.md#game-development) 吧~)*

* [Leaf](https://github.com/name5566/leaf) **star:3074** 轻量级游戏服务器框架。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [Pixel](https://github.com/faiface/pixel) **star:2453** 手工制作的 2D 游戏库。   ![star > 1000][Silver]
* [Ebiten](https://github.com/hajimehoshi/ebiten) **star:1860** 很简单的 2D 游戏库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [goworld](https://github.com/xiaonanln/goworld) **star:1203** 可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [engo](https://github.com/EngoEngine/engo) **star:1086** 开源 2D 游戏引擎。它遵循 Entity-Component-System 范式。   ![star > 1000][Silver]
...
* [nano](https://github.com/lonng/nano) **star:1003** 轻量级、方便、高性能的基于golang的游戏服务器框架。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [Pitaya](https://github.com/topfreegames/pitaya) **star:301** 可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity。   ![star > 100][Bronze]
...
* [jennifer](https://github.com/dave/jennifer) **star:1280** 不使用模板生成任意 Go 代码。   ![star > 1000][Silver]
...
* [Tile38](https://github.com/tidwall/tile38) **star:6344** 具有空间索引和实时地理定位功能的地理定位数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [S2 geometry](https://github.com/golang/geo) **star:892** S2 geometry 库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gopherjs](https://github.com/gopherjs/gopherjs) **star:8565** 将 Go 编译成 JavaScript。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [goworker](https://github.com/benmanns/goworker) **star:2256** 基于 go 的后台 worker。   ![star > 1000][Silver]
* [ants](https://github.com/panjf2000/ants) **star:1914** 一个高性能的协程池。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [tunny](https://github.com/Jeffail/tunny) **star:1359** golang 的协程池。   ![star > 1000][Silver]
* [grpool](https://github.com/ivpusic/grpool) **star:502** 轻量级协程池。   ![star > 100][Bronze]
...
* [Hunch](https://github.com/AaronJan/Hunch) **star:14** Hunch 提供了诸如 All、First、Retry、Waterfall 等功能，这使得异步流控制更加直观。
...
* [ui](https://github.com/andlabs/ui) **star:6982** 跨平台的 Platform-native GUI 库。   ![star > 5000][Gold]
* [Wails](https://wails.app)  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。
* [fyne](https://github.com/fyne-io/fyne) **star:6330** 为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [qt](https://github.com/therecipe/qt) **star:6090** 实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [webview](https://github.com/zserge/webview) **star:4677** 跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。   ![star > 1000][Silver]
* [walk](https://github.com/lxn/walk) **star:3708** Windows应用程序库。   ![star > 1000][Silver]
* [app](https://github.com/murlokswarm/app) **star:2961** 用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。   ![star > 1000][Silver]
* [go-astilectron](https://github.com/asticode/go-astilectron) **star:2686** 使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-gtk](http://mattn.github.io/go-gtk/)  实现了 GTK 的 Go接口。
* [go-sciter](https://github.com/sciter-sdk/go-sciter) **star:1450** 实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。   ![star > 1000][Silver]
...
* [robotgo](https://github.com/go-vgo/robotgo) **star:4438** 实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。   ![star > 1000][Silver]
* [systray](https://github.com/getlantern/systray) **star:790** 跨平台 Go 库，可在通知区放置图标和菜单。   ![star > 100][Bronze]
* [gosx-notifier](https://github.com/deckarep/gosx-notifier) **star:495** OSX 桌面通知库。   ![star > 100][Bronze]
...
* [bild](https://github.com/anthonynsimon/bild) **star:2556** 纯Go语言实现的图像处理算法合集。   ![star > 1000][Silver]
* [imaging](https://github.com/disintegration/imaging) **star:2538** 简单的Go图像处理包。   ![star > 1000][Silver]
* [gocv](https://github.com/hybridgroup/gocv) **star:2472** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [bimg](https://github.com/h2non/bimg) **star:802** 使用libvips实现的快速高效的图像处理包。   ![star > 100][Bronze]
...
* [darkroom](https://github.com/gojek/darkroom) **star:64** An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency.   ![最近一周有更新][Green]
...
* [flogo](https://github.com/tibcosoftware/flogo) **star:1136** Flogo是一个面向物联网边缘应用和集成的开源框架。   ![star > 1000][Silver]
...
* [mainflux](https://github.com/Mainflux/mainflux) **star:595** 工业物联网消息和设备管理服务器。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [JobRunner](https://github.com/bamzi/jobrunner) **star:574** 智能和功能丰富的cron作业调度程序（包含任务队列和实时监控）。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [GJSON](https://github.com/tidwall/gjson) **star:4934** 使用一行代码获取JSON的值。   ![star > 1000][Silver]
* [gojson](https://github.com/ChimeraCoder/gojson) **star:2033** 从JSON自动生成Go的结构（struct）定义。   ![star > 1000][Silver]
...
* [logrus](https://github.com/Sirupsen/logrus) **star:12021** Go的结构化日志操作 。   ![star > 5000][Gold]
* [zap](https://github.com/uber-go/zap) **star:7491** 快速、结构化、多等级的日志记录。   ![star > 5000][Gold]
* [spew](https://github.com/davecgh/go-spew) **star:3316** 为Go数据结构实现一个漂亮的printer用于帮助调试。   ![star > 1000][Silver]
* [glog](https://github.com/golang/glog) **star:2309** 为Go提供了多等级日志记录。   ![star > 1000][Silver]
* [zerolog](https://github.com/rs/zerolog) **star:2243** Zero-allocation JSON日志记录。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [tail](https://github.com/hpcloud/tail) **star:1544** 努力模拟实现BSD的tail的特性的Go包。   ![star > 1000][Silver]
* [lumberjack](https://github.com/natefinch/lumberjack) **star:1456** 简单的滚动日志，io.WriteCloser的实现。   ![star > 1000][Silver]
...
* [GoLearn](https://github.com/sjwhitworth/golearn) **star:6657** 通用机器学习库。   ![star > 5000][Gold]   ![包含中文文档][CN]
* [gorgonia](https://github.com/chewxy/gorgonia) **star:2701** 基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。   ![star > 1000][Silver]
...
* [gosseract](https://github.com/otiai10/gosseract) **star:881** 使用c++的Tesseract库实现的OCR。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [Goptuna](https://github.com/c-bata/goptuna) **star:81** 黑盒函数的贝叶斯优化框架。一切都会优化。   ![最近一周有更新][Green]
...
* [sarama](https://github.com/Shopify/sarama) **star:4665**  Apache Kafka的Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gorush](https://github.com/appleboy/gorush) **star:3726** 使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。   ![star > 1000][Silver]
* [Centrifugo](https://github.com/centrifugal/centrifugo) **star:3696** 实时消息(Websockets或SockJS)服务器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [machinery](https://github.com/RichardKnop/machinery) **star:3375** 基于分布式消息传递的异步任务/作业队列。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-socket.io](https://github.com/googollee/go-socket.io) **star:2893** go的socket.io库，一个实时应用程序框架。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [NATS Go Client](https://github.com/nats-io/nats) **star:2406** 轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。   ![star > 1000][Silver]
...
* [Benthos](https://github.com/Jeffail/benthos) **star:2016** 一系列协议之间的消息流桥接。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [melody](https://github.com/olahol/melody) **star:1570** 处理websocket session的极简框架，包括广播和自动ping/pong处理。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [mangos](https://github.com/go-mangos/mangos) **star:1534** Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [Mercure](https://github.com/dunglas/mercure) **star:1516** 使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-nsq](https://github.com/nsqio/go-nsq) **star:1462** NSQ的官方Go包。   ![star > 1000][Silver]
...
* [Beaver](https://github.com/Clivern/Beaver) **star:729** 一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。   ![star > 100][Bronze]
...
* [Commander](https://github.com/jeroenrinzema/commander) **star:22** 高级事件驱动的消费者/生产者(consumer/producer)，支持各种“方言”，如Apache Kafka。   ![最近一周有更新][Green]
...
* [unioffice](https://github.com/unidoc/unioffice) **star:1739** 用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。   ![star > 1000][Silver]

### Microsoft Excel

*用于操作Microsoft Excel的库。 (翻译出错了? 试试 [英文版](README_EN.md#microsoft-excel) 吧~)*

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) **star:4504** 用于读写Microsoft Excel™(XLSX)文件的Go语言库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [xlsx](https://github.com/tealeg/xlsx) **star:3444** 用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [xlsx](https://github.com/plandem/xlsx) **star:75** 在Go程序以快速和安全的方式读取/更新现有的Microsoft Excel文件。
...
* [dig](https://github.com/uber-go/dig) **star:920** 一个基于反射的Go依赖注入工具包。   ![star > 100][Bronze]
* [fx](https://github.com/uber-go/fx) **star:758** 基于依赖注入的Go应用程序框架(构建在dig之上)。   ![star > 100][Bronze]
...
* [gopsutil](https://github.com/shirou/gopsutil) **star:3949** 用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [archiver](https://github.com/mholt/archiver) **star:2499** 用于生成和解压.zip和.tar.gz文档的库和命令。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) **star:629** base64Captcha支持数字，字母，算术，音频和混合模式的验证码。   ![star > 100][Bronze]   ![包含中文文档][CN]
* [shortid](https://github.com/teris-io/shortid) **star:452** 分布式地生成超短、唯一、非顺序、URL友好的id。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [gofakeit](https://github.com/brianvoe/gofakeit) **star:429** 用go编写的随机数据生成器。   ![star > 100][Bronze]
* [llvm](https://github.com/llir/llvm) **star:414** 用于在纯Go中与LLVM IR交互的库。   ![star > 100][Bronze]
...
* [prose](https://github.com/jdkato/prose) **star:2054** 用于支持标记化、词性标记、名称实体提取等文本处理的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gse](https://github.com/go-ego/gse) **star:1079** 高效的文本分割;支持英语、汉语、日语等。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [when](https://github.com/olebedev/when) **star:927** 带有可插入规则的自然EN和RU语言日期/时间解析器。   ![star > 100][Bronze]
* [gojieba](https://github.com/yanyiwu/gojieba) **star:825** 这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。   ![star > 100][Bronze]   ![包含中文文档][CN]
* [go-pinyin](https://github.com/mozillazg/go-pinyin) **star:530** 中文汉字到汉语拼音的转换。   ![star > 100][Bronze]
* [kagome](https://github.com/ikawaha/kagome) **star:417** JP形态学分析仪编写的纯Go。   ![star > 100][Bronze]
* [whatlanggo](https://github.com/abadojack/whatlanggo) **star:353** Go的自然语言检测包。支持84种语言和24种脚本(书写系统，如拉丁语、西里尔语等)。   ![star > 100][Bronze]
...
* [kcptun](https://github.com/xtaci/kcptun) **star:10694** 基于KCP协议的非常简单和快速udp隧道。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [fasthttp](https://github.com/valyala/fasthttp) **star:9434** 一个快速HTTP实现，比net/http快10倍。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [fortio](https://github.com/fortio/fortio) **star:890** 负载测试库和命令行工具，高级的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。支持Tcp、Http、gRPC。   ![star > 100][Bronze]
* [water](https://github.com/songgao/water) **star:847** 简单TUN / TAP图书馆。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [sftp](https://github.com/pkg/sftp) **star:744** Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt.   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [heimdall](https://github.com/gojektech/heimdall) **star:1086** 具有重试和hystrix功能的增强http客户机。   ![star > 1000][Silver]
...
* [rq](https://github.com/ddo/rq) **star:27** golang stdlib HTTP客户端更好的接口。
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) **star:2279** ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。   ![star > 1000][Silver]
* [upper.io/db](https://github.com/upper/db) **star:1859** 对外提供统一的接口用于访问不同的存储介质，例如PostgreSQL, MySQL, SQLite, MSSQL, QL、MongoDB.。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [reform](https://github.com/go-reform/reform) **star:806** 基于非空接口和代码生成的 ORM。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [pop/soda](https://github.com/gobuffalo/pop) **star:683** 数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [QBS](https://github.com/coocood/qbs) **star:541** Stands for Query By Struct. A Go ORM.   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
* [go-queryset](https://github.com/jirfag/go-queryset) **star:450** 基于 GORM 100% 类型安全的 ORM。可支持 MySQL, PostgreSQL, Sqlite3, SQL Server。   ![star > 100][Bronze]
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) **star:238** 一个灵活而强大的SQL字符串构建器库。   ![star > 100][Bronze]
...
* [dep](https://github.com/golang/dep) **star:12597**  Go 的依赖管理工具，需要 Go 1.9+   ![star > 5000][Gold]
...
* [govendor](https://github.com/kardianos/govendor) **star:4751** 包管理器。使用 vendor 文件的 Go vendor 工具。   ![star > 1000][Silver]
* [gopm](https://github.com/gpmgo/gopm) **star:2365** 包管理器。   ![star > 1000][Silver]   ![归档项目][Archived]
...
* [jaeger](https://github.com/jaegertracing/jaeger) **star:8723** 分布式跟踪系统。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [packr](https://github.com/gobuffalo/packr) **star:2145** 将静态文件嵌入到Go二进制文件中的简单方法。   ![star > 1000][Silver]
* [statik](https://github.com/rakyll/statik) **star:2125** 将静态文件嵌入到Go可执行文件中。   ![star > 1000][Silver]
...
* [gonum](https://github.com/gonum/gonum) **star:2976** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [stats](https://github.com/montanaflynn/stats) **star:1347** 包含Golang标准库中缺少的公共函数的统计软件包。   ![star > 1000][Silver]
...
* [gonum/plot](https://github.com/gonum/plot) **star:1221** gonum/plot提供了一个API，用于在Go中构建和绘制绘图。   ![star > 1000][Silver]
...
* [Cameradar](https://github.com/Ullaakut/cameradar) **star:1829** 工具和库，以远程入侵RTSP流从监控摄像头。   ![star > 1000][Silver]
...
* [acra](https://github.com/cossacklabs/acra) **star:452** 网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。   ![star > 100][Bronze]
...
* [jsoniter](https://github.com/json-iterator/go) **star:5577** 高性能，100% 兼容的“encoding/json” 替代品   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [goprotobuf](https://github.com/golang/protobuf) **star:5122** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) **star:2982** Go 语言的 Protocol Buffer 库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [mapstructure](https://github.com/mitchellh/mapstructure) **star:2477** 用于对原生键值对进行解码生成 Go 语言结构体   ![star > 1000][Silver]
...
* [etcd](https://github.com/coreos/etcd) **star:26642** 为共享配置和服务发现提供高可用的键值存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Caddy](https://github.com/mholt/caddy) **star:23245** Caddy是另一种HTTP/2 web服务器，易于配置和使用。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [consul](https://www.consul.io/)  Consul 是一个用于服务发现、监控和配置的工具
* [minio](https://github.com/minio/minio) **star:17580** Minio是一个分布式对象存储服务器。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [RoadRunner](https://github.com/spiral/roadrunner) **star:3318** 高性能PHP应用服务器，负载平衡器和进程管理器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [devd](https://github.com/cortesi/devd) **star:2811** 为开发人员提供本地web服务器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [algernon](https://github.com/xyproto/algernon) **star:1592** 内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。   ![star > 1000][Silver]
* [flipt](https://github.com/markphelps/flipt) **star:992** 一个用Go和Vue.js编写的自包含特性标志解决方案   ![star > 100][Bronze]
* [SFTPGo](https://github.com/drakkan/sftpgo) **star:899** 功能齐全，高度可配置的SFTP服务器软件。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [go-streams](https://github.com/reugn/go-streams) **star:190** 去流处理库。   ![star > 100][Bronze]

## 模板引擎

*用于模板和词法分析的库和工具。 (翻译出错了? 试试 [英文版](README_EN.md#template-engines) 吧~)*

* [gofpdf](https://github.com/jung-kurt/gofpdf) **star:3096** PDF 文档生成器，支持文本，绘图和图片   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [pongo2](https://github.com/flosch/pongo2) **star:1493** 类似 DjanGo 的模板引擎   ![star > 1000][Silver]
* [quicktemplate](https://github.com/valyala/quicktemplate) **star:1413** 快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译   ![star > 1000][Silver]
...
* [fasttemplate](https://github.com/valyala/fasttemplate) **star:301** 简单快速的模板引擎。进行模板元素替换时，速度是比[text/template](http://golang.org/pkg/text/template/)快10倍。   ![star > 100][Bronze]
...
* Testing Frameworks
    ...
    * [Testify](https://github.com/stretchr/testify) **star:8199** 对标准测试包的扩展。   ![star > 5000][Gold]
    ...
    * [godog](https://github.com/DATA-DOG/godog) **star:763** 类似 Cucumber 或 Behat 的 BDD 框架   ![star > 100][Bronze]
    ...
    * [go-mutesting](https://github.com/zimmski/go-mutesting) **star:295** 变异测试的Go源代码。   ![star > 100][Bronze]
    ...
    * [endly](https://github.com/viant/endly) **star:95** 声明性端到端功能测试。   ![最近一周有更新][Green]
...
* Mock
    * [gomock](https://github.com/golang/mock) **star:2878** 用于Go编程语言的mock框架。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) **star:1758** Mock SQL ，用于测试数据库交互   ![star > 1000][Silver]
    ...
    * [minimock](https://github.com/gojuno/minimock) **star:266** Go接口的模拟生成器。   ![star > 100][Bronze]
...
* Selenium and browser control tools.
    * [chromedp](https://github.com/knq/chromedp) **star:3612** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [selenoid](https://github.com/aerokube/selenoid) **star:1240** Selenium hub 服务器的替代品，在容器中启动浏览器   ![star > 1000][Silver]
...
* Fail injection
    * [failpoint](https://github.com/pingcap/failpoint) **star:392** 为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。   ![star > 100][Bronze]
...
* Specific Formats
    * [colly](https://github.com/asciimoo/colly) **star:8483** 快速和优雅的 Scraping 框架。   ![star > 5000][Gold]   ![最近一周有更新][Green]
    * [GoQuery](https://github.com/PuerkitoBio/goquery) **star:7622** GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能   ![star > 5000][Gold]
    * [blackfriday](https://github.com/russross/blackfriday) **star:3912** Markdown 解析器   ![star > 1000][Silver]
    * [toml](https://github.com/BurntSushi/toml) **star:2805** TOML配置格式(带反射的编码器/解码器)。   ![star > 1000][Silver]
    * [sh](https://github.com/mvdan/sh) **star:2021** Shell解析器和格式化工具。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) **star:5051** AWS 提供的官方go语言 SDK   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [github](https://github.com/google/go-github) **star:4772** 访问GitHub REST API v3的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [slack](https://github.com/nlopes/slack) **star:2429** Slack API。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [google](https://github.com/google/google-api-go-client) **star:1934** 为Go自动生成谷歌api。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) **star:1799** 谷歌云api Go 客户端库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [anaconda](https://github.com/ChimeraCoder/anaconda) **star:991**  Twitter 1.1 API 的 go 语言客户端   ![star > 100][Bronze]
* [discordgo](https://github.com/bwmarrin/discordgo) **star:972**  Discord Chat API的客户端。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [stripe](https://github.com/stripe/stripe-go) **star:946**  Stripe API 的 Go 语言客户端   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [facebook](https://github.com/huandu/facebook) **star:774** 支持 Facebook Graph API 的库   ![star > 100][Bronze]
* [minio-go](https://github.com/minio/minio-go) **star:724** 用于Amazon S3兼容云存储的Minio Go库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [go-twitter](https://github.com/dghubble/go-twitter) **star:719**  Twitter v1.1 api 的客户端.   ![star > 100][Bronze]
...
* [fzf](https://github.com/junegunn/fzf) **star:23296** 用Go编写的命令行模糊查找器。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [hub](https://github.com/github/hub) **star:17090** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [delve](https://github.com/derekparker/delve) **star:12092** Go 语言调试器   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [ctop](https://github.com/bcicen/ctop) **star:8843** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。   ![star > 5000][Gold]
* [wuzz](https://github.com/asciimoo/wuzz) **star:8274** 用于HTTP检查的交互式cli工具。   ![star > 5000][Gold]
* [sqlx](https://github.com/jmoiron/sqlx) **star:6836** 为内建的数据库/sql 软件包提供一组扩展。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [goreleaser](https://github.com/goreleaser/goreleaser) **star:4530** 尽可能快速的发布 Go 语言二进制文件。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [goreporter](https://github.com/wgliang/goreporter) **star:2486** 进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具   ![star > 1000][Silver]
* [panicparse](https://github.com/maruel/panicparse) **star:2145** 将类似的协程分组并对调用栈进行着色   ![star > 1000][Silver]
* [hystrix-go](https://github.com/afex/hystrix-go) **star:2028** 实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。   ![star > 1000][Silver]
* [resty](https://github.com/go-resty/resty) **star:2000** 简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。   ![star > 1000][Silver]
...
* [boilr](https://github.com/tmrts/boilr) **star:944** 非常快的CLI工具，用于从样板模板创建项目。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [jump](https://github.com/gsamokovarov/jump) **star:663** 通过学习你的习惯，可以帮助你更快地导航。   ![star > 100][Bronze]
* [immortal](https://github.com/immortal/immortal) **star:607** \*nix 跨平台 (与操作系统无关的)监控程序。   ![star > 100][Bronze]
...
* [circuit](https://github.com/cep21/circuit) **star:331** 一个高效和功能齐全的 类似 Hystrix Go 实现断路器模式。   ![star > 100][Bronze]
* [ergo](https://github.com/cristianoliveira/ergo) **star:314** 管理运行在不同端口上的多个本地服务变得很容易。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [clockwork](https://github.com/jonboulle/clockwork) **star:221** 一个简单的假 clock 。   ![star > 100][Bronze]
...
* [retry](https://github.com/kamilsk/retry) **star:162** 基于上下文的功能机制，反复执行命令直到成功。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [wuid](https://github.com/edwingeng/wuid) **star:289** 一个非常快的唯一数字生成器，比UUID快10-135倍。   ![star > 100][Bronze]
...
* [govalidator](https://github.com/asaskevich/govalidator) **star:3562** 用于字符串，数字，切片和结构的验证器和sanitizers。   ![star > 1000][Silver]
* [validator](https://github.com/go-playground/validator) **star:3547**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。   ![star > 1000][Silver]
...
* [go-git](https://github.com/src-d/go-git) **star:4303** 纯Go中高度可扩展的Git实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [git2go](https://github.com/libgit2/git2go) **star:1367**  libgit2 的 Go 语言接口。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [hercules](https://github.com/src-d/hercules) **star:543** 从Git存储库历史中获得高级见解。   ![star > 100][Bronze]
...
* [goav](https://github.com/giorgisio/goav) **star:796** FFmpeg的Comphrensive。   ![star > 100][Bronze]
* [gmf](https://github.com/3d0c/gmf) **star:535**  FFmpeg av\* 库的 Go 语言接口。   ![star > 100][Bronze]
...
* [Gin](https://github.com/gin-gonic/gin) **star:30207** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Beego](https://github.com/astaxie/beego) **star:21549** beego是一种用于 Go 编程语言的开源高性能web框架。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [Buffalo](http://gobuffalo.io)  为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) **star:14752** 高性能、极简的Go web框架。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Revel](https://github.com/revel/revel) **star:11262** 用于Go语言的高效web框架。   ![star > 5000][Gold]
* [Goa](https://github.com/goadesign/goa) **star:3516** Goa为在Go中开发远程api和微服务提供了一种全面的方法。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [negroni](https://github.com/urfave/negroni) **star:6348** 符合语言习惯的 HTTP 中间件库。   ![star > 5000][Gold]   ![包含中文文档][CN]
* [alice](https://github.com/justinas/alice) **star:1825** 用于连接中间件的库，简单无痛苦。   ![star > 1000][Silver]
* [render](https://github.com/unrolled/render) **star:1270** Go package用于方便地呈现JSON、XML和HTML模板响应。   ![star > 1000][Silver]
...
* [httprouter](https://github.com/julienschmidt/httprouter) **star:9755** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。   ![star > 5000][Gold]
* [mux](https://github.com/gorilla/mux) **star:9745** 强大的URL路由器和调度器为golang。   ![star > 5000][Gold]
* [chi](https://github.com/go-chi/chi) **star:6093** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。   ![star > 5000][Gold]
...
* [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) **star:191** 找出项目中过期的依赖项。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [vim-go](https://github.com/fatih/vim-go) **star:10879** Go 开发会用到的 Vim 插件。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [GoSublime](https://github.com/DisposaBoy/GoSublime) **star:3239** 包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。   ![star > 1000][Silver]
* [go-plus](https://github.com/joefitzgerald/go-plus) **star:1485** 在 Atom 中添加自动完成，格式化，语法检查，高亮和审查。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-mode](https://github.com/dominikh/go-mode.el) **star:960** 在 GNU/Emacs 支持 GO。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gotests](https://github.com/cweill/gotests) **star:2214** 从源代码生成测试用例。   ![star > 1000][Silver]
* [genny](https://github.com/cheekybits/genny) **star:976** 优雅的 Go 泛型。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [Gitea](https://github.com/go-gitea/gitea) **star:15422** 从 Gogs fork，完全由社区驱动。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
...
* [webhook](https://github.com/adnanh/webhook) **star:4107** 允许用户创建在服务器上执行命令的 HTTP hooks。   ![star > 1000][Silver]
* [gaia](https://github.com/gaia-pipeline/gaia) **star:3752** 可用于任何编程语言来构建强大的管道。   ![star > 1000][Silver]
* [gox](https://github.com/mitchellh/gox) **star:3367** 非常简单，没有多余的跨平台编译工具。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [bosun](https://github.com/bosun-monitor/bosun) **star:2858** 按照时间轴发出告警的框架。   ![star > 1000][Silver]
* [bombardier](https://github.com/codesenberg/bombardier) **star:1758** 快速跨平台 HTTP 基准测试工具。   ![star > 1000][Silver]
...
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) **star:8289** 快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [vFlow](https://github.com/VerizonDigital/vflow) **star:601** 高性能、可伸缩和可靠的 IPFIX、sFlow和 Netflow 收集器。   ![star > 100][Bronze]
...
* [GoBooks](https://github.com/dariubs/GoBooks) **star:6830** 一份精选的 Go 书籍清单。   ![star > 5000][Gold]
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) **star:1546** 由 Maria Letta 提供的与 Gopher 有关的图片包，其中包含了插图,表情文字。   ![star > 1000][Silver]
...
* [gophers](https://github.com/ashleymcnamara/gophers) **star:1860** 阿什莉·麦克纳马拉的歌斐艺术品。   ![star > 1000][Silver]
...
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) **star:24676** 其他 awesome 系列的列表。   ![star > 5000][Gold]
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) **star:14586** Curated list of awesome remote jobs. A lot of them are looking for Go hackers.   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) **star:31663** Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。   ![star > 5000][Gold]   ![包含中文文档][CN]
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) **star:4599** 学习使用测试驱动开发。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) **star:700** 引入示例讲述 Golang 与Node.js在学习上的差异。   ![star > 100][Bronze]
