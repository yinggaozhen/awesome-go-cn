...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2020-11-22 07:11:01(每隔1天同步一次)**
...
* [gaad](https://github.com/Comcast/gaad)  原生 Go AAC位流解析器。
* [go-sox](https://github.com/krig/go-sox)  libsox 的 Go 语言实现接口。
* [GoAudio](https://github.com/DylanMeeus/GoAudio)  本地Go音频处理库。
* [gosamplerate](https://github.com/dh1tw/gosamplerate)  libsamplerate 的 Go 语言实现接口。
* [id3v2](https://github.com/bogem/id3v2)  ID3解码和编码库为Go。
...
* [mp3](https://github.com/tcolgate/mp3)  原生 Go MP3解码器。
* [music-theory](https://github.com/go-music-theory/music-theory)  基于 Go 的音乐理论模型。
...
* [vorbis](https://github.com/mccoyst/vorbis)  “原生” Go Vorbis解码器(使用CGO，但没有依赖关系)。
* [waveform](https://github.com/mdlayher/waveform)  通过音频流生成波形图像的包。
...
* [session](https://github.com/icza/session)  web服务器会话管理(包括支持谷歌应用程序引擎 - GAE)。
...
* [otpgo](https://github.com/jltorresm/otpgo)  基于时间的一次性密码(TOTP)和基于hmac的一次性密码(HOTP)库用于Go。
...
* [jwt-auth](https://github.com/adam-hanna/jwt-auth)  JWT中间件，可用于Golang http服务器，提供了许多配置选项。
* [branca](https://github.com/hako/branca)  基于 Go 实现Branca令牌。
* [jwt](https://github.com/cristalhq/jwt)  安全、简单、快速的JSON Web令牌。
* [jwt](https://github.com/pascaldekloe/jwt)  轻量级JSON Web令牌库。
* [jwt](https://github.com/robbert229/jwt)  简单易用的JSON Web令牌实现(JWT)。
* [jeff](https://github.com/abraithwaite/jeff)  简单、灵活、安全和惯用的web会话管理，具有可配置化的后端。
* [httpauth](https://github.com/goji/httpauth)  HTTP身份验证中间件。
* [goth](https://github.com/markbates/goth)  提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。
* [gorbac](https://github.com/mikespook/gorbac)  轻量级的基于角色的访问控制(RBAC)实现。
* [gologin](https://github.com/dghubble/gologin)  用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。
...
* [go-guardian](https://github.com/shaj13/go-guardian)  Go-Guardian是一个golang库，它提供了一种简单、干净和习惯的方式来创建强大的现代API和web身份验证，支持LDAP、Basic、承载令牌和基于证书的身份验证。
* [go-email-normalizer](https://github.com/dimuska139/go-email-normalizer)  Golang库，用于提供电子邮件地址的规范表示。
* [cookiestxt](https://github.com/mengzhuo/cookiestxt)  提供cookie .txt文件格式的解析器。
...
* [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles)  用于管理基于语音通道成员存在的临时角色的不和机器人。
...
* [slackscot](https://github.com/alexandre-normand/slackscot)  另一个构建Slack机器人的框架。
* [slacker](https://github.com/shomali11/slacker)  可简单创建Slack机器人的框架。
* [olivia](https://github.com/olivia-ai/olivia)  用人工神经网络建造的聊天机器人。
* [micha](https://github.com/onrik/micha)  基于 GO 实现的Telegram 机器人API库。
* [Kelp](https://github.com/stellar/kelp)  官方交易和做市机器人为[Stellar](https://www.stellar.org/) DEX。开箱即用的作品，用 Golang 编写，兼容集中交易和定制交易策略。
* [go-chat-bot](https://github.com/go-chat-bot/bot)  用 Go 编写的IRC, Slack和电报机器人。
* [hanu](https://github.com/sbstjn/hanu)  用于编写Slack机器人的框架。
* [govkbot](https://github.com/nikepan/govkbot)  简单的Go [VK](https://vk.com) bot库。
* [Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot)  基于控制台的，用于加密货币交易所的的交易机器人。
* [go-twitch-irc](https://github.com/gempir/go-twitch-irc)  Libary为twitch编写机器人程序。电视聊天
...
* [Tenyks](https://github.com/kyleterry/tenyks)  面向服务的IRC bot，使用Redis和JSON进行消息传递。
...
* [1build](https://github.com/gopinath-langote/1build)  命令行工具，以无摩擦地管理项目特定的命令。
...
* [job](https://github.com/liujianping/job)  工作，把你的短期指令当作长期任务。
...
* [sflags](https://github.com/octago/sflags)  基于结构的flag生成器，用于flag、urfave/cli、pflag、cobra、kingpin和其他库。
* [strumt](https://github.com/antham/strumt)  用于创建提示链。
* [ts](https://github.com/liujianping/ts)  时间戳转换和比较工具。
* [ukautz/clif](https://github.com/ukautz/clif)  简小的命令行接口框架。
* [urfave/cli](https://github.com/urfave/cli)  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。
...
* [argparse](https://github.com/akamensky/argparse)  命令行参数分析器，灵感来自Python的argparse模块。
* [cobra](https://github.com/spf13/cobra)  现代Go CLI命令行交互工具。
* [argv](https://github.com/cosiner/argv)  基于Base 语法，用于分隔命令行字符串并将其作为参数的 Go 语言库，
* [cli](https://github.com/mkideal/cli)  基于golang结构标签，功能丰富易于使用的命令行包。
...
* [commandeer](https://github.com/jaffee/commandeer)  开发友好的CLI应用程序。
...
* [wmenu](https://github.com/dixonwille/wmenu)  为cli程序提供了简单上手的菜单，可提示用户作出选择。
...
* [simpletable](https://github.com/alexeyco/simpletable)  可在终端显示简易表格。
* [pterm](https://github.com/pterm/pterm)  一个在每个平台上使用许多可组合组件美化控制台输出的库。
* [mpb](https://github.com/vbauerster/mpb)  可在终端显示多进度条。
* [aurora](https://github.com/logrusorgru/aurora)  支持fmt.Printf/Sprintf的ANSI终端颜色。
* [gookit/color](https://github.com/gookit/color)  终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。
* [gommon/color](https://github.com/labstack/gommon/tree/master/color)  更换终端文本样式。
* [gocui](https://github.com/jroimartin/gocui)  旨在创建控制台用户界面的极简Go库。
...
* [go-colortext](https://github.com/daviddengcn/go-colortext)  在终端中使用彩色文字。
* [go-colorable](https://github.com/mattn/go-colorable)  适用于windows的颜色编写器。
* [go-ataman](https://github.com/workanator/go-ataman)  在终端提供ANSI彩色文本模板。
* [ctc](https://github.com/wzshiming/ctc)  不需要Print方法的非侵入性跨平台终端颜色库。
* [colourize](https://github.com/TreyBastian/colourize)  在终端提供ANSI彩色文本。
...
* [yacspin](https://github.com/theckman/yacspin)  用于与终端旋转器一起工作。

## 配置

*配置解析的库。 (翻译出错了? 试试 [英文版](README_EN.md#configuration) 吧~)*

* [aconfig](https://github.com/cristalhq/aconfig)  简单，有用和固执的配置加载程序。
...
* [hocon](https://github.com/gurkankaymak/hocon)  使用HOCON(一种人类友好的JSON超集)格式的配置库，支持环境变量、引用其他值、注释和多个文件等特性。
...
* [configuration](https://github.com/BoRuDar/configuration)  库，用于从环境变量、文件、标记和“默认”标记初始化配置结构。
* [configure](https://github.com/paked/configure)  通过多个源提供配置，包括JSON、flags和环境变量。
* [configuro](https://github.com/sherifabdlnaby/configuro)  固执己见的配置加载和验证框架从环境和文件集中到12因素兼容的应用程序。
...
* [go-up](https://github.com/ufoscout/go-up)  一个简单的配置库，具有递归占位符解析功能。
...
* [go-aws-ssm](https://github.com/PaddleHQ/go-aws-ssm)  从AWS系统管理器-参数存储中获取参数的Go包。
* [go-ini](https://github.com/subpop/go-ini)  一个对ini文件进行封送和解送的Go包。
...
* [goterator](https://github.com/yaa110/goterator)  迭代器实现，提供映射和减少功能。
...
* [nan](https://github.com/kak-tus/nan)  一个库中的可零分配空结构，具有方便的转换函数、编组器和解组器。
...
* [ttlcache](https://github.com/ReneKroon/ttlcache)  内存中的string-interface{}缓存各种基于时间的过期选项和回调。
...
* [cmap](https://github.com/lrita/cmap)  一个线程安全的go map
...
* [go-edlib](https://github.com/hbollon/go-edlib)  Go字符串比较和编辑距离算法库(Levenshtein, LCS, Hamming, Damerau Levenshtein, Jaro-Winkler等)兼容Unicode。
...
* [pogreb](https://github.com/akrylysov/pogreb)  针对大量读取工作负载的嵌入式键值存储。
...
* [unitdb](https://github.com/unit-io/unitdb)  快速timeseries数据库物联网，实时消息传递应用程序。使用pubsub通过tcp或websocket访问unitdb，使用github.com/unit-io/unitd应用程序。
...
* [goose](https://github.com/pressly/goose)  数据库迁移工具。您可以通过创建增量SQL或Go脚本来管理数据库的升级。
...
* [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable)  高级调度为PostgreSQL。
...
* [buildsqlx](https://github.com/arthurkushman/buildsqlx)  去数据库查询生成器库的PostgreSQL。
...
* [sqlingo](https://github.com/lqs/sqlingo)  在Go中构建SQL的轻量级DSL。
* [sqlf](https://github.com/leporo/sqlf)  快速SQL查询生成器。
* [sq](https://github.com/bokwoon95/go-structured-query)  用于Go的类型安全的SQL生成器和结构映射器。
...
* [gosql](https://github.com/twharmon/gosql)  支持更好的空值的SQL查询生成器。
...
* NoSQL Databases
    ...
    * [qmgo](https://github.com/qiniu/qmgo)  MongoDB司机走了。它是基于官方MongoDB司机但更容易使用像分别。
...
* [Semaphore](https://github.com/jexia/semaphore)  简单的(微)服务协调器。
...
* [consistenthash](https://github.com/mbrostami/consistenthash)  使用可配置副本的一致哈希。
...
* [go-mysql-lock](https://github.com/sanketplus/go-mysql-lock)  基于MySQL分布式锁。
...
* [goja](https://github.com/dop251/goja)  ECMAScript 5.1(+)实现在Go。
...
* [errors](https://github.com/bnkamalesh/errors)  这是一个最小的错误处理包，自定义错误类型，用户友好的消息，Unwrap & is。与非常容易使用和直接的帮助函数。
...
* [qs](https://github.com/sonh/qs)  去模块编码结构到URL查询参数。
...
* [prototype](https://github.com/gonutz/prototype)  跨平台(Windows/Linux/Mac)库，用于使用最少的API创建桌面游戏。
...
* [tile](https://github.com/kelindar/tile)  面向数据和缓存友好的2D网格库(TileMap)，包括寻路、观察者和导入/导出。
...
* [S2 geojson](https://github.com/pantrif/s2-geojson)  将geojson转换为s2单元格&在map上演示一些s2的几何特性。
...
* [neilotoole/errgroup](https://github.com/neilotoole/errgroup)  “sync/errgroup”的替代方案，仅限于N个worker goroutines池。
...
* [pond](https://github.com/alitto/pond)  简约和高性能的goroutine工作池写在Go。
...
* [channelify](https://github.com/ddelizia/channelify)  将函数转换为返回通道，以便进行简单而强大的并行处理。
* [conexec](https://github.com/ITcathyh/conexec)  一个并发工具包，帮助以高效和安全的方式并发执行函数。它支持指定总体超时来避免阻塞，并使用goroutine池来提高效率。
...
* [goccm](https://github.com/zenthangplus/goccm)  Go并发管理器包限制了允许并发运行的goroutines的数量。
...
* [gridder](https://github.com/shomali11/gridder)  一个基于网格的2D图形库。
...
* [draft](https://github.com/lucasepe/draft)  使用简单的YAML语法为GraphViz生成高级微服务架构图。
...
* [go-quartz](https://github.com/reugn/go-quartz)  简单的，无依赖的Go调度库。
...
* [jzon](https://github.com/zerosnake0/jzon)  具有标准兼容API/行为的JSON库。
...
* [dynjson](https://github.com/cocoonspace/dynjson)  用于动态api的可定制的JSON格式。
...
* [epoch](https://github.com/vtopc/epoch)  包含用于封送/解封送Unix时间戳/纪元到内建时间的原语。时间类型为JSON。
...
* [logur](https://github.com/logur/logur)  一个固执的logger接口，集合了著名库的适配器和集成的日志最佳实践([logrus](https://github.com/sirupsen/logrus)， [go-kit log](https://github.com/go-kit/kit/tree/master/log)， [zap](https://github.com/ugo/zap)， [zerolog](https://github.com/rs/zerolog)，等等)。
...
* [onelog](https://github.com/francoispqt/onelog)  Onelog是一个非常简单但非常高效的JSON日志记录器。它是所有场景中最快的JSON记录器。而且，它是配置最低的记录器之一。
* [phuslu/log](https://github.com/phuslu/log)  简化了结构化日志记录。
...
* [sqldb-logger](https://github.com/simukti/sqldb-logger)  一个日志程序，用于不修改现有的* SQL . db stdlib用法的Go SQL数据库驱动程序。
...
* [httpretty](https://github.com/henvic/httpretty)  在终端上美化您的常规HTTP请求以便调试(类似于HTTP . dumprequest)。
* [journald](https://github.com/ssgreg/journald)   Go实现systemd Journal的原生API用于日志记录。
* [kemba](https://github.com/clok/kemba)  一个小的调试日志工具，灵感来自[debug](https://github.com/visionmedia/debug)，非常适合CLI工具和应用程序。
...
* [gosd](https://github.com/alexsniffin/gosd)  一种用于调度何时将消息分派到通道的库。
...
* [Asynq](https://github.com/hibiken/asynq)  一个简单、可靠、高效的基于Redis的分布式任务队列。
...
* [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go)  confluent-kafka-go是Confluent为Apache Kafka和Confluent平台开发的Golang客户端。
...
* [go-mq](https://github.com/cheshir/go-mq)  具有声明式配置的RabbitMQ客户端。
* [go-notify](https://github.com/TheCreeper/go-notify)  原生的freedesktop通知规范实现。
* [go-nsq](https://github.com/nsqio/go-nsq)  NSQ的官方Go包。
* [go-res](https://github.com/jirenius/go-res)  用于构建REST/实时服务的包，其中客户端使用NATS和Resgate进行无缝同步。
...
* [xlsx](https://github.com/tealeg/xlsx)  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。
...
* [di](https://github.com/goava/di)  go编程语言的依赖注入容器。
...
* [goioc/di](https://github.com/goioc/di)  受spring启发的依赖注入容器。
...
* [go-sample](https://github.com/zitryss/go-sample)  带有实际代码的Go应用程序项目的示例布局。
* [go-todo-backend](https://github.com/Fs02/go-todo-backend)  去Todo后端示例使用模块化项目布局的产品微服务。
...
* [scaffold](https://github.com/catchplay/scaffold)  Scaffold生成一个starter Go项目布局。让您关注已实现的业务逻辑。
...
* [gobeam/Stringy](https://github.com/gobeam/Stringy)  字符串操作库，可以将字符串转换为驼色，蛇色，烤肉色等。
...
* [pdfgen](https://github.com/hyperboloide/pdfgen)  通过Json请求生成PDF的HTTP服务。
* [health](https://github.com/dimiro1/health)  易于使用，可扩展的健康检查库。
* [healthcheck](https://github.com/etherlabsio/healthcheck)  用于RESTful服务的强制的(opinionated)并发健康检查HTTP处理程序。
* [hostutils](https://github.com/Wing924/hostutils)  一个用于打包和解包FQDNs列表的go语言库。
...
* [metrics](https://github.com/pascaldekloe/metrics)  用于instrumentation和Prometheus exposition的库。
...
* [sandid](https://github.com/aofei/sandid)  能沟让地球上的每一粒沙子都有自己的ID。
* [shellwords](https://github.com/Wing924/shellwords)  一个Go库，实现了依照UNIX Bourne shell的关键词解析规则进行字符串操纵。
* [shortid](https://github.com/teris-io/shortid)  分布式地生成超短、唯一、非顺序、URL友好的id。
* [shoutrrr](https://github.com/containrrr/shoutrrr)  通知库提供了对各种消息服务(如slack、mattermost、fy和smtp等)的轻松访问。
* [stateless](https://github.com/qmuntal/stateless)  用于创建状态机的流畅库。
* [stats](https://github.com/go-playground/stats)  Monitors Go MemStats + 诸如如内存，Swap和CPU的系统状态统计，并通过UDP发送到任何你想记录的地方
* [turtle](https://github.com/hackebrot/turtle)  Go的Emojis库。
* [url-shortener](https://github.com/pantrif/url-shortener)  一个现代的、强大的、健壮的URL转短链接微服务，带有mysql支持。
* [VarHandler](https://github.com/azr/generators/tree/master/varhandler)  用于生成http输入和输出处理模板。
* [xdg](https://github.com/rkoesters/xdg)  FreeDesktop.org (xdg)规范在Go中的实现。
* [gountries](https://github.com/pariz/gountries)  获取国家和细节数据的包。
* [gosms](https://github.com/haxpax/gosms)  Go编写的私人的本地短信网关，可以用来发送短信。
...
* [browscap_go](https://github.com/digitalcrab/browscap_go)  用于[Browser Capabilities Project](http://browscap.org/)的Go库。
...
* [gatus](https://github.com/TwinProduction/gatus)  自动服务运行状况仪表板。
...
* [go-resiliency](https://github.com/eapache/go-resiliency)   Go语言弹性模式(resiliency pattern)。
* [go-unarr](https://github.com/gen2brain/go-unarr)  用于RAR、TAR、ZIP和7z文件的解压缩库。
...
* [xkg](https://github.com/go-xkg/xkg)  X Keyboard Grabber(键盘事件捕获)
...
* [nlp](https://github.com/james-bowman/nlp)  支持LSA(潜在语义分析)的Go自然语言处理库。
* [paicehusk](https://github.com/rookii/paicehusk)  Golang实现了Paice/外壳阻塞算法。
* [petrovich](https://github.com/striker2000/petrovich)  彼得罗维奇是一个图书馆，它把俄语名字的词形变化成特定的语法格。
* [porter](https://github.com/a2800276/porter)  这是Martin Porter在C语言中实现的Porter词干分析算法的一个相当简单的移植。
* [porter2](https://github.com/zhenjl/porter2)  非常快的波特2史坦默。
* [prose](https://github.com/jdkato/prose)  支持标记化、词性标记、命名实体提取等文本处理的库。只说英语。
...
* [libtextcat](https://github.com/goodsign/libtextcat)  用于libtextcat C库的Cgo绑定。保证与版本2.2兼容。
* [sentences](https://github.com/neurosnap/sentences)  句子标记器:将文本转换为句子列表。
* [shamoji](https://github.com/osamingo/shamoji)  shamoji是用Go编写的word过滤包。
* [snowball](https://github.com/goodsign/snowball)  滚雪球柄端口(cgo包装)为 Go 。提供词干提取功能[Snowball native](http://snowball.tartarus.org/)。
* [stemmer](https://github.com/dchest/stemmer)  用于Go编程语言的Stemmer包。包括英语和德语词根。
...
* [MMSEGO](https://github.com/awsong/MMSEGO)  这是一个 Go 实现的[MMSEG](http://technology.chtsai.org/mmseg/)，这是一个中文分词算法。
* [kagome](https://github.com/ikawaha/kagome)  JP形态学分析仪编写的纯Go。
* [getlang](https://github.com/rylans/getlang)  快速自然语言检测包。
* [go2vec](https://github.com/danieldk/go2vec)  用于word2vec嵌入式的阅读器和实用程序函数。
...
* [go-mystem](https://github.com/dveselov/mystem)  CGo绑定到Yandex。Mystem -俄罗斯形态学分析仪。
* [go-nlp](https://github.com/nuance/go-nlp)  用于处理离散概率分布的实用程序和用于进行NLP工作的其他工具。
* [go-pinyin](https://github.com/mozillazg/go-pinyin)  中文汉字到汉语拼音的转换。
...
* [iuliia-go](https://github.com/mehanizm/iuliia-go)  直译斯拉夫字母→拉丁以所有可能的方式。
* [golibstemmer](https://github.com/rjohnsondev/golibstemmer)   Go 绑定斯诺鲍libstemmer库，包括波特2。
* [gosentiwordnet](https://github.com/dinopuguh/gosentiwordnet)  情绪分析器使用的多愁善感网词汇在Go。
* [gotokenizer](https://github.com/xujiajun/gotokenizer)  一种基于字典和双字母格朗语言模型的记号赋予器。(现在只支持中文分割)
* [gounidecode](https://github.com/fiam/gounidecode)  用于Go的Unicode音译器(也称为unidecode)。
* [govader](https://github.com/jonreiter/govader)  [VADER情绪分析]的Go实现(https://github.com/cjhutto/vaderSentiment)。
* [gse](https://github.com/go-ego/gse)  高效的文本分割;支持英语、汉语、日语等。
* [icu](https://github.com/goodsign/icu)  Cgo绑定用于icu4c C库的检测和转换功能。保证与版本50.1兼容。
* [when](https://github.com/olebedev/when)  带有可插入规则的自然EN和RU语言日期/时间解析器。

## 网络

*用于处理各种网络层的库。 (翻译出错了? 试试 [英文版](README_EN.md#networking) 吧~)*

* [arp](https://github.com/mdlayher/arp)  实现了arp协议，如RFC 826中所述。
...
* [panoptes-stream](https://github.com/yahoo/panoptes-stream)  云本地分布式流媒体网络遥测(gNMI, Juniper JTI和Cisco MDT)。
...
* [iplib](https://github.com/c-robinson/iplib)  用于处理IP地址的库(net)。借鉴于python 的 [ipaddress](https://docy-doc.org/3/library/ipaddress.html)和ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html)
...
* [sslb](https://github.com/eduardonunesp/sslb)  它是一个超级简单的负载平衡器，只是一个实现某种性能的小项目。
...
* [vssh](https://github.com/yahoo/vssh)  Go库建立网络和服务器自动化的SSH协议。
...
* [buffstreams](https://github.com/stabbycutyou/buffstreams)  通过TCP传输协议缓冲区数据。
* [gnet](https://github.com/panjf2000/gnet)  “gnet”是一个用纯Go编写的高性能、轻量级、非阻塞、事件驱动的网络框架。
* [canopus](https://github.com/zubairhamed/canopus)  CoAP客户端/服务器实现(RFC 7252)。
* [cidranger](https://github.com/yl2chen/cidranger)  快速得 IP 到 CIDR 查找。
* [dhcp6](https://github.com/mdlayher/dhcp6)  实现了一个DHCPv6服务器，如RFC 3315所述。
* [dns](https://github.com/miekg/dns)  用于 DNS 的库。
* [ether](https://github.com/songgao/ether)  一个用于发送和接收以太网帧的跨平台 Go 库。
* [ethernet](https://github.com/mdlayher/ethernet)  实现了对IEEE 802.3以太网II帧和IEEE 802.1Q VLAN标签的编组和解组。
* [fasthttp](https://github.com/valyala/fasthttp)  一个快速HTTP实现，比net/http快10倍。
* [fortio](https://github.com/fortio/fortio)  负载测试库和命令行工具，高级的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。支持Tcp、Http、gRPC。
* [ftp](https://github.com/jlaffaye/ftp)  实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户端。
* [gaio](https://github.com/xtaci/gaio)  高性能异步io网络在proactor模式下的Golang。
* [gev](https://github.com/Allenxuxu/gev)  gev是一个基于反应器模式的轻量级、快速的非阻塞TCP网络库。
* [gmqtt](https://github.com/DrmagicE/gmqtt)  Gmqtt是一个灵活、高性能的MQTT代理库，它完全实现了MQTT协议V3.1.1。
* [gNxI](https://github.com/google/gnxi)  一组基于 gNMI 和 gNOI 协议的网络管理工具。
* [HTTPLab](https://github.com/gchaincl/httplab)  HTTPLabs 允许你检查 HTTP 请求和伪造响应。
* [go-getter](https://github.com/hashicorp/go-getter)   通过URL来下载文件或目录。
...
* [gobgp](https://github.com/osrg/gobgp)  基于 Go 的 BGP 实现。
...
* [gopcap](https://github.com/akrennmair/gopcap)   用 Go 实现了对 libpcap 的封装。
...
* [grab](https://github.com/cavaliercoder/grab)   用于管理文件下载。
* [graval](https://github.com/koofr/graval)  FTP服务器框架。
* [xtcp](https://github.com/xfxdev/xtcp)  TCP服务器框架，同时全双工通信，优雅的关机，和自定义协议。
...
* [go-http-client](https://github.com/bozd4g/go-http-client)  简单而容易地进行http调用。
...
* [request](https://github.com/monaco-io/request)  golang的HTTP客户端。如果您有关于axios或请求的经验，您会喜欢它。没有第三依赖性。
...
* [go-glmatrix](https://github.com/technohippy/go-glmatrix)  访问[glMatrix](http://glmatrix.net/)库的端口。
...
* [rel](https://github.com/go-rel/rel)  Golang的现代数据库访问层——可测试、可扩展，并精心设计成一个干净优雅的API。
...
* [go-sql](https://github.com/rushteam/gosql)  一个简单的ORM为mysql。
...
* [modgv](https://github.com/lucasepe/modgv)  将'go mod graph'输出转换为Graphviz的点语言。
...
* [pixie](https://github.com/pixie-labs/pixie)  通过eBPF对Golang应用程序没有检测跟踪。
* [profile](https://github.com/pkg/profile)  Go的简单分析支持包。
* [statsviz](https://github.com/arl/statsviz)  实时可视化您的Go应用程序运行时统计数据。
* [tracer](https://github.com/kamilsk/tracer)  简单、轻量级的跟踪。

## 查询语言

* [api-fu](https://github.com/ccbrown/api-fu)  综合GraphQL实现。
* [dasel](https://github.com/tomwright/dasel)  使用命令行中的选择器查询和更新数据结构。与jq/yq类似，但支持JSON、YAML、TOML和XML，运行时依赖关系为零。
...
* [gws](https://github.com/Zaba505/gws)  Apollos的“GraphQL over Websocket”客户端和服务器实现。
...
* [rqp](https://github.com/timsolov/rest-query-parser)  REST API的查询解析器。查询中直接支持筛选、验证、'和'或'操作。
...
* [mule](https://github.com/wlbr/mule)  嵌入外部资源，如图像，电影…
...
* [decimal](https://github.com/db47h/decimal)  Package decimal实现任意精度的十进制浮点运算。
...
* [calendarheatmap](https://github.com/nikolaydubina/calendarheatmap)  基于Github贡献活动的日历热图。
...
* [secureio](https://github.com/xaionaro-go/secureio)  一个密钥交换+认证+加密的包装和多路复用的' io。读写ecloser '基于XChaCha20-poly1305, ECDH和ED25519。
* [secure](https://github.com/unrolled/secure)  Go 语言 HTTP 中间件，为 Go 提供了一些安全功能
* [passlib](https://github.com/hlandau/passlib)  不过时的密码哈希库。
* [optimus-go](https://github.com/pjebs/optimus-go)  使用Knuth的算法进行ID哈希和混淆。
* [nacl](https://github.com/kevinburke/nacl)   Go 实现NaCL API的集合。
* [memguard](https://github.com/awnumar/memguard)  一个用于处理内存中敏感值的纯Go库。
* [lego](https://github.com/go-acme/lego)  纯 Go ACME 客户端库及命令行工具
...
* [firewalld-rest](https://github.com/prashantgupta24/firewalld-rest)  用于动态更新linux服务器上的firewalld规则的rest应用程序。
...
* [argon2-hashing](https://github.com/andskur/argon2-hashing)  轻包装周围的Go的argon2包，它与Go的标准库Bcrypt和simple-scrypt包密切镜像。
* [themis](https://github.com/cossacklabs/themis)  用于解决典型数据安全任务(安全数据存储、安全消息传递、零知识证明认证)的高级加密库，可用于14种语言，最适合多平台应用程序。
...
* [elastic](https://github.com/epiclabs-io/elastic)  在运行时跨不同类型转换片、映射或任何其他未知值
...
* [SFTPGo](https://github.com/drakkan/sftpgo)  完全功能和高度可配置的SFTP服务器与可选的FTP/S和WebDAV支持。它可以为本地文件系统和云存储后端(如S3和谷歌云存储)提供服务。
...
* [protoxy](https://github.com/camgraff/protoxy)  将JSON请求体转换为协议缓冲区的代理服务器。
...
* [Trickster](https://github.com/tricksterproxy/trickster)  HTTP反向代理缓存和时间序列加速器。
...
* Testing Frameworks
    ...
    * [stop-and-go](https://github.com/elgohr/stop-and-go)  并发性测试助手。
    ...
    * [covergates](https://github.com/covergates/covergates)  自托管的代码覆盖报告审查和管理服务。
    ...
    * [goc](https://github.com/qiniu/goc)  Goc是一个针对Go编程语言的全面覆盖测试系统。
...
* Selenium and browser control tools.
    ...
    * [rod](https://github.com/go-rod/rod)  一个Devtools驱动程序，使web自动化和抓取更加容易。
...
* Specific Formats
    ...
    * [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown)  将HTML转换成Markdown
    * [inject](https://github.com/facebookgo/inject)  包注入提供了一个基于反射的注入器。
    * [gofeed](https://github.com/mmcdole/gofeed)  在Go中解析RSS和Atom feeds。
    * [ltsv](https://github.com/Wing924/ltsv)  高性能[LTSV(Labeled Tab Separated Value)](http://ltsv.org/)。
    * [mxj](https://github.com/clbanning/mxj)  将XML编码/解码为JSON或map[string]接口{};使用点符号路径和通配符提取值。替换x2j和j2x包。
    * [pagser](https://github.com/foolin/pagser)  Pagser是一个简单的，可扩展的，可配置的解析和反序列化的html页面结构，基于goquery和结构标签的golang爬虫。
...
* Utility
    ...
    * [regroup](https://github.com/oriser/regroup)  使用结构标记和自动解析将正则表达式命名组匹配到go结构中。
    * [Tagify](https://github.com/zoomio/tagify)  从给定源生成一组标记。
	* [textwrap](https://github.com/isbm/textwrap)  从Python实现“textwrap”模块。
    * [TySug](https://github.com/Dynom/TySug)  关于键盘布局的其他建议。
...
* [lastpass-go](https://github.com/ansd/lastpass-go)  使用[LastPass](https://www.lastpass.com/) API的客户端库。
...
* [gopaapi5](https://github.com/utekaravinash/gopaapi5)  Go客户端库[亚马逊产品广告API 5.0](https://webservices.amazon.com/paapi5/documentation/)。
* [google-play-scraper](https://github.com/n0madic/google-play-scraper)  从谷歌播放存储获取数据。
...
* [rawg-sdk-go](https://github.com/dimuska139/rawg-sdk-go)  去[RAWG视频游戏数据库](https://rawg.io/) API库
...
* [wit-go](https://github.com/wit-ai/wit-go)  wit.ai HTTP API 客户端。
...
* [simples3](https://github.com/rhnvrm/simples3)  使用REST和用Go编写的V4签名的AWS S3库非常简单。
...
* [amazon-product-advertising-api](https://github.com/ngs/go-amazon-product-advertising-api)  [Amazon Product Advertising API](https://program.amazon.com/gp/advertising/api/detail/main.html)的客户端库。
...
* [go-aws-news](https://github.com/circa10a/go-aws-news)  去应用程序和库获取AWS的新内容。
* [coinpaprika-go](https://github.com/coinpaprika/coinpaprika-api-go-client)  Coinpaprika API的客户端。
* [codeship-go](https://github.com/codeship/codeship-go)   Codeship API v2的客户端。
...
* [golyrics](https://github.com/mamal72/golyrics)  Golyrics是一个从Wikia网站获取音乐歌词数据的Go库。
* [golang-tmdb](https://github.com/cyruzin/golang-tmdb)  电影数据库API v3的Golang包装器。
* [gogtrends](https://github.com/groovili/gogtrends)  非官方的Google Trends API。
...
* [nostromo](https://github.com/pokanop/nostromo)  CLI用于构建强大的别名。
...
* [lets-go](https://github.com/aplescia-chwy/lets-go)  Go模块，为云本地REST API开发提供公共工具。还包含AWS特定的实用程序。
...
* [mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination)  用于官方Mongodb /mongo-go驱动程序包的Mongodb分页，它支持正常的查询和聚合管道。
...
* [statiks](https://github.com/janiltonmaciel/statiks)  快速，零配置，静态HTTP文件服务器。
...
* [taskctl](https://github.com/taskctl/taskctl)  并发任务跑。
...
* [scany](https://github.com/georgysavva/scany)  库扫描数据从数据库到Go structs和更多。
...
* [backscanner](https://github.com/icza/backscanner)  类似 bufio 的扫描器，但它以相反的顺序读取和返回行，从给定的位置开始，然后返回。
...
* [equalizer](https://github.com/reugn/equalizer)  用Go实现的限流工具
* [ergo](https://github.com/cristianoliveira/ergo)  管理运行在不同端口上的多个本地服务变得很容易。
* [evaluator](https://github.com/nullne/evaluator)  基于 s-expression。它很简单，很容易扩展。
...
* [ghokin](https://github.com/antham/ghokin)  没有外部依赖的gherkin (cucumber, behat…)并行格式化程序。
* [git-time-metric](https://github.com/git-time-metric/gtm)  git-time-metric - 。
...
* [dbt](https://github.com/nikogura/dbt)  用于从中心可信存储库运行自更新签名二进制文件的框架。
* [go-bsdiff](https://github.com/gabstv/go-bsdiff)  纯Go bsdiff和bspatch库和CLI工具。
* [clockwork](https://github.com/jonboulle/clockwork)  一个简单的假 clock 。
* [beyond](https://github.com/wesovilabs/beyond)  Go工具将带你进入AOP的世界!
* [blank](https://github.com/Henry-Sarabia/blank)  验证或删除字符串中的空白。
* [boilr](https://github.com/tmrts/boilr)  非常快的CLI工具，用于从样板模板创建项目。
* [chyle](https://github.com/antham/chyle)  使用具有多种配置可能性的git存储库生成变更日志。
* [circuit](https://github.com/cep21/circuit)  一个高效和功能齐全的 类似 Hystrix Go 实现断路器模式。
* [circuitbreaker](https://github.com/rubyist/circuitbreaker)  接通断路器。
...
* [countries](https://github.com/biter777/countries)  完整实现ISO-3166-1、ISO-4217、ITU-T E.164、Unicode CLDR和IANA ccTLD标准。
* [create-go-app](https://github.com/create-go-app/cli)  一个强大的CLI，用于通过运行一个命令创建一个后端服务(Golang)，前端(JavaScript, TypeScript)和部署自动化(Ansible, Docker)的可生产项目。
...
* [go-convert](https://github.com/Eun/go-convert)  Package go-convert允许您将一个值转换成另一种类型。
...
* [gotenv](https://github.com/subosito/gotenv)  从 `.env` 或者任何 `io.Reader`。
* [gubrak](https://github.com/novalagung/gubrak)  带有语法糖的Golang实用工具，就像lodash。
...
* [hostctl](https://github.com/guumaster/hostctl)  一个使用简单命令管理/etc/主机的CLI工具。
...
* [go-countries](https://github.com/mikekonan/go-countries)  对ISO-3166代码的轻量级查找。
* [go-rate](https://github.com/beefsack/go-rate)   Go 限速器。
* [go-dry](https://github.com/ungerik/go-dry)  DRY(don't repeat yourself)库。
...
* [go-lock](https://github.com/viney-shih/go-lock)  go-lock是一个锁库，它实现了读写互斥锁和读写尝试锁，而不需要等待。
...
* [gouid](https://github.com/twharmon/gouid)  生成加密安全的随机字符串id，只有一个分配。
...
* [uuid](https://github.com/google/uuid)  基于RFC 4122和DCE 1.1的uuid包:身份验证和安全服务。
...
* [appy](https://github.com/appist/appy)  一个固执己见的高效web框架，有助于更容易地扩展业务。
...
* [go-fault](https://github.com/github/go-fault)  Go的故障注入中间件。
...
* [mediary](https://github.com/HereMobilityDevelopers/mediary)  在http中添加拦截器。客户端允许转储/成型/跟踪/…的请求/响应。
...
* [go-canvas](https://github.com/markfarnan/go-canvas)  库使用HTML5画布，与所有绘画内的go代码。
* [tinygo](https://github.com/tinygo-org/tinygo)  去编译小地方。微控制器、网络组装和命令行工具。基于LLVM。
...
* [vscode-go](https://github.com/golang/vscode-go)  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。
...
* [xgen](https://github.com/xuri/xgen)  XSD (XML模式定义)解析器和Go/C/Java/Rust/TypeScript代码生成器。
...
* [igo](https://github.com/rocketlaunchr/igo)  一个igo to go transpiler (go语言的新语言功能!)
...
* [typex](https://github.com/dtgorski/typex)  检查Go类型及其传递依赖关系，或者将结果导出为TypeScript值对象(或类型)声明。
...
* [s5cmd](https://github.com/peak/s5cmd)  非常快的S3和本地文件系统执行工具。
...
* [trubka](https://github.com/xitonix/trubka)  一个CLI工具，用于管理和故障排除Apache Kafka集群，具有通用发布/使用协议缓冲区和与Kafka之间的纯文本事件的能力。
...
* [cassowary](https://github.com/rogerwelin/cassowary)  用Go编写的跨平台HTTP负载测试工具。
...
* [vaku](https://github.com/lingrino/vaku)  用于库中基于文件夹的函数(如复制、移动和搜索)的CLI和API。
...
* [Gebug](https://github.com/moshebe/gebug)  一个工具，通过启用调试器和热重新加载特性，使docker化的Go应用程序的调试非常容易，无缝。
...
* [Guora](https://github.com/meloalright/guora)  一个用Go编写的类似Quora的自托管web应用程序。
...
* [woke](https://github.com/get-woke/woke)  检测源代码中不包含的语言。
...
* [go-json-benchmark](https://github.com/zerosnake0/go-json-benchmark)  JSON的基准。
...
* [Design Patterns in Go](https://github.com/shubhamzanwar/design-patterns)  在Go中实现的编程设计模式的集合。
...
* [goapp](https://github.com/bnkamalesh/goapp)  关于构建和开发Go web应用/服务的指南。
