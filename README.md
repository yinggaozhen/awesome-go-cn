...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-06-28 08:42:59(每隔1天同步一次)**
...
* [id3v2](https://github.com/bogem/id3v2) - **Star : 104** **最近提交 : 2019-02-08**  快速稳定的ID3解析和编写Go库。
* [malgo](https://github.com/gen2brain/malgo) - **Star : 67** **最近提交 : 2019-04-16**  迷你音频库。
* [minimp3](https://github.com/tosone/minimp3) - **Star : 25** **最近提交 : 2019-03-19**  轻量级MP3解码器库。
* [mix](https://github.com/go-mix/mix) - **Star : 94** **最近提交 : 2017-06-25**  基于顺序的Go-native音乐应用混音器。
...
* [Oto](https://github.com/hajimehoshi/oto) - **Star : 381** **最近提交 : 2019-06-27**  用于在多个平台上播放声音的低级库。
...
* [go-jose](https://github.com/square/go-jose) - **Star : 1086** **最近提交 : 2019-06-27**  相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) - **Star : 1244** **最近提交 : 2019-06-21**  独立的、符合规范的、用Golang编写的OAuth2服务器。
* [gologin](https://github.com/dghubble/gologin) - **Star : 1026** **最近提交 : 2019-03-05**  用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。
* [gorbac](https://github.com/mikespook/gorbac) - **Star : 895** **最近提交 : 2019-03-21**  在Golang中提供一个轻量级的基于角色的访问控制(RBAC)实现。
* [goth](https://github.com/markbates/goth) - **Star : 2210** **最近提交 : 2019-06-18**  提供使用OAuth和OAuth2的简单、干净和惯用的方法。处理多个提供程序的开箱即用。
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) - **Star : 5687** **最近提交 : 2019-06-25**  JSON Web令牌(JWT)的Golang实现。
* [loginsrv](https://github.com/tarent/loginsrv) - **Star : 792** **最近提交 : 2019-06-03**  JWT登录微服务带有可插入的后端，如OAuth2 (Github)、htpasswd、osiam。
* [oauth2](https://github.com/golang/oauth2) - **Star : 2316** **最近提交 : 2019-06-18**  goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。
...
* [Kelp](https://github.com/stellar/kelp) - **Star : 144** **最近提交 : 2019-06-26**  官方交易和做市机器人为[恒星](https://www.stellar.org/) DEX。开箱即用的作品，用Golang编写，兼容集中交易和定制交易策略。
...
* [telebot](https://github.com/tucnak/telebot) - **Star : 919** **最近提交 : 2019-05-20**  用Go编写的Telegram bot框架。
...
* [cli-init](https://github.com/tcnksm/gcli) - **Star : 866** **最近提交 : 2017-11-20**  开始构建Golang命令行应用程序的简单方法。
...
* [cobra](https://github.com/spf13/cobra) - **Star : 12505** **最近提交 : 2019-06-27**  指挥官为现代Go CLI互动。
...
* [go-getoptions](https://github.com/DavidGamba/go-getoptions) - **Star : 5** **最近提交 : 2019-06-27**   Go 选择解析器启发Perl的灵活性的GetOpt::长。
...
* [kingpin](https://github.com/alecthomas/kingpin) - **Star : 2488** **最近提交 : 2019-06-08**  支持子命令的命令行和标志解析器。
...
* [pflag](https://github.com/spf13/pflag) - **Star : 725** **最近提交 : 2019-06-16**  Drop-in替换Go的标志包，实现POSIX/GNU-style——标志。
...
* [urfave/cli](https://github.com/urfave/cli) - **Star : 11024** **最近提交 : 2019-06-26**  在Go中构建命令行应用程序的简单、快速和有趣的包(以前是codegangsta/cli)。
...
* [go-colorable](https://github.com/mattn/go-colorable) - **Star : 366** **最近提交 : 2019-05-24**  适用于windows的可着色写入器。
* [go-colortext](https://github.com/daviddengcn/go-colortext) - **Star : 198** **最近提交 : 2018-04-10**  在终端中使用颜色输出库。
* [go-isatty](https://github.com/mattn/go-isatty) - **Star : 331** **最近提交 : 2019-05-22**  isatty golang。
* [go-prompt](https://github.com/c-bata/go-prompt) - **Star : 2259** **最近提交 : 2019-06-09**  库，受[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit)的启发，构建一个强大的交互式提示。
* [gocui](https://github.com/jroimartin/gocui) - **Star : 4279** **最近提交 : 2019-06-16**  旨在创建控制台用户界面的极简Go库。
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) - 样式文本终端。
* [gookit/color](https://github.com/gookit/color) - **Star : 177** **最近提交 : 2019-04-30**  终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。
* [mpb](https://github.com/vbauerster/mpb) - **Star : 497** **最近提交 : 2019-06-01**  终端应用程序的多进度条。
* [progressbar](https://github.com/schollz/progressbar) - **Star : 550** **最近提交 : 2019-06-04**  基本线程安全的进度条，在每个操作系统工作。
...
* [termbox-go](https://github.com/nsf/termbox-go) - **Star : 3429** **最近提交 : 2019-06-24**  Termbox是一个用于创建跨平台的基于文本的接口的库。
* [termdash](https://github.com/mum4k/termdash) - **Star : 767** **最近提交 : 2019-06-07**  基于**termbox-go**的Go terminal dashboard，灵感来自[termui](https://github.com/gizak/termui)。
...
* [termui](https://github.com/gizak/termui) - **Star : 8780** **最近提交 : 2019-06-19**  基于**termbox-go**的Go terminal dashboard，灵感来自[blessed-contrib](https://github.com/yaronn/blessed-contrib)。
...
* [uitable](https://github.com/gosuri/uitable) - **Star : 491** **最近提交 : 2019-05-14**  库，用于提高使用表格数据的终端应用程序的可读性。
...
* [confita](https://github.com/heetch/confita) - **Star : 237** **最近提交 : 2019-06-14**  从多个后端级联加载配置到结构中。
...
* [env](https://github.com/caarlos0/env) - **Star : 831** **最近提交 : 2019-05-15**  解析环境变量以获得struct(默认值)。
...
* [envh](https://github.com/antham/envh) - **Star : 93** **最近提交 : 2019-05-20**  帮助管理环境变量。
...
* [godotenv](https://github.com/joho/godotenv) - **Star : 2042** **最近提交 : 2019-06-17**  Ruby的dotenv库的Go端口(从' .env '加载环境变量)。
...
* [gookit/config](https://github.com/gookit/config) - **Star : 69** **最近提交 : 2019-06-10**  应用程序配置管理(负载、获取、设置)。支持JSON, YAML, TOML, INI, HCL。多文件加载，数据覆盖合并。
...
* [ini](https://github.com/go-ini/ini) - **Star : 1511** **最近提交 : 2019-05-23**   Go 软件包读和写INI文件。
* [joshbetz/config](https://github.com/joshbetz/config) - **Star : 194** **最近提交 : 2017-08-11**  用于Go的小型配置库，它解析环境变量、JSON文件，并在SIGHUP时自动重新加载。
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) - **Star : 2334** **最近提交 : 2019-06-17**  使用库管理来自环境变量的配置数据。
...
* [store](https://github.com/tucnak/store) - **Star : 241** **最近提交 : 2017-09-05**  Go的轻量级配置管理器。
* [viper](https://github.com/spf13/viper) - **Star : 8913** **最近提交 : 2019-06-23**   Go 配置尖牙。
* [xdg](https://github.com/OpenPeeDeeP/xdg) - **Star : 31** **最近提交 : 2019-03-12**  遵循[XDG标准]的跨平台包(https://standards.freedesktop.org/basedir-spec/basedir-spec-latest.html)。

## 持续集成

*用于帮助进行持续集成的工具。*

* [drone](https://github.com/drone/drone) - **Star : 18634** **最近提交 : 2019-06-25**  Drone是一个基于Docker的持续集成平台，用Go编写。
...
* [goveralls](https://github.com/mattn/goveralls) - **Star : 567** **最近提交 : 2019-06-05**  把工作服整合起来。io连续代码覆盖跟踪系统。
...
* [conjungo](https://github.com/InVisionApp/conjungo) - **Star : 72** **最近提交 : 2019-05-22**  一个小型、强大和灵活的合并库。
...
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) - **Star : 491** **最近提交 : 2019-03-03**  布谷鸟过滤器:一个很好的替代计数布卢姆过滤器实现在围棋。
...
* [go-datastructures](https://github.com/Workiva/go-datastructures) - **Star : 5030** **最近提交 : 2019-03-06**  有用的、高性能的和线程安全的数据结构的集合。
...
* [gods](https://github.com/emirpasic/gods) - **Star : 6001** **最近提交 : 2019-06-24**  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。
* [golang-set](https://github.com/deckarep/golang-set) - **Star : 1112** **最近提交 : 2018-09-27**  线程安全和非线程安全的高性能集。
...
* [hilbert](https://github.com/google/hilbert) - **Star : 176** **最近提交 : 2018-11-22**  Go软件包用于将值映射到和从空间填充曲线(如Hilbert和Peano曲线)。
* [hyperloglog](https://github.com/axiomhq/hyperloglog) - **Star : 653** **最近提交 : 2019-06-07**  HyperLogLog实现稀疏，LogLog-Beta偏差校正和尾部削减空间。
...
* [merkletree](https://github.com/cbergoon/merkletree) - **Star : 141** **最近提交 : 2019-03-08**  merkle树的实现提供了对数据结构内容的有效和安全的验证。
...
* [roaring](https://github.com/RoaringBitmap/roaring) - **Star : 638** **最近提交 : 2019-06-24**   Go 包实现压缩位集。
...
* [trie](https://github.com/derekparker/trie) - **Star : 404** **最近提交 : 2019-03-23**  在Go中实现Trie。
...
* [willf/bloom](https://github.com/willf/bloom) - **Star : 644** **最近提交 : 2019-03-01**  打包实现Bloom过滤器。

## 数据库

*数据库在Go中实现。*

* [badger](https://github.com/dgraph-io/badger) - **Star : 6049** **最近提交 : 2019-06-27**  快速键值存储在Go中。
* [bcache](https://github.com/iwanbk/bcache) - **Star : 25** **最近提交 : 2019-05-01**  最终一致的分布式内存缓存Go库。
* [BigCache](https://github.com/allegro/bigcache) - **Star : 2364** **最近提交 : 2019-06-26**  有效的键/值缓存为千兆字节的数据。
* [bolt](https://github.com/boltdb/bolt) - **Star : 9852** **最近提交 : 2018-03-03**  Go的低级键/值数据库。
* [buntdb](https://github.com/tidwall/buntdb) - **Star : 2413** **最近提交 : 2019-03-15**  快速，可嵌入，在内存键/值数据库与自定义索引和空间支持 Go 。
* [cache](https://github.com/akyoto/cache) - **Star : 10** **最近提交 : 2019-05-24**  内存键:带过期时间的值存储，0个依赖项，<100 LoC, 100%覆盖率。
* [cache2go](https://github.com/muesli/cache2go) - **Star : 924** **最近提交 : 2019-06-09**  内存内键:值缓存，支持基于超时的自动失效。
* [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache) - **Star : 29** **最近提交 : 2018-01-23**  BigCache支持集群和单独的条目过期。
* [cockroach](https://github.com/cockroachdb/cockroach) - **Star : 16517** **最近提交 : 2019-06-27**  可伸缩、地理复制、事务性数据存储。
* [couchcache](https://github.com/codingsince1985/couchcache) - **Star : 40** **最近提交 : 2019-04-23**  由Couchbase服务器支持的RESTful缓存微服务。
* [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) - **Star : 1415** **最近提交 : 2019-06-27**  CovenantSQL是区块链上的一个SQL数据库。
* [dgraph](https://github.com/dgraph-io/dgraph) - **Star : 9854** **最近提交 : 2019-06-27**  可伸缩、分布式、低延迟、高吞吐量的图形数据库。
* [diskv](https://github.com/peterbourgon/diskv) - **Star : 732** **最近提交 : 2019-04-25**  自定义磁盘支持的键值存储。
* [eliasdb](https://github.com/krotik/eliasdb) - **Star : 531** **最近提交 : 2019-03-13**  不依赖，事务图数据库与REST API，短语搜索和sql类似的查询语言。
* [fastcache](https://github.com/VictoriaMetrics/fastcache) - **Star : 461** **最近提交 : 2019-06-12**  快速线程安全的内存缓存为大量的条目。最大限度地减少GC开销。
* [GCache](https://github.com/bluele/gcache) - **Star : 856** **最近提交 : 2019-06-19**  支持过期缓存、LFU、LRU和ARC的缓存库。
* [go-cache](https://github.com/pmylund/go-cache) - 内存键:Go的值存储/缓存库(类似于Memcached)，适用于单机应用程序。
* [goleveldb](https://github.com/syndtr/goleveldb) - **Star : 3090** **最近提交 : 2019-06-25**  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。
* [gorocksdb](https://github.com/kapitan-k/gorocksdb) - **Star : 7** **最近提交 : 2018-01-11**  Gorocksdb是用Go编写的[RocksDB](https://rocksdb.org)的包装器。
* [groupcache](https://github.com/golang/groupcache) - **Star : 7530** **最近提交 : 2019-02-13**  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。
* [influxdb](https://github.com/influxdb/influxdb) - 可伸缩的数据存储，用于度量、事件和实时分析。
* [ledisdb](https://github.com/siddontang/ledisdb) - **Star : 3034** **最近提交 : 2019-05-24**  Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。
...
* [piladb](https://github.com/fern4lvarez/piladb) - **Star : 169** **最近提交 : 2018-04-08**  基于堆栈数据结构的轻量级RESTful数据库引擎。
* [prometheus](https://github.com/prometheus/prometheus) - **Star : 24784** **最近提交 : 2019-06-27**  监控系统和时序数据库。
* [pudge](https://github.com/recoilme/pudge) - **Star : 212** **最近提交 : 2019-05-13**  快速和简单的键/值存储使用Go的标准库编写。
* [rqlite](https://github.com/rqlite/rqlite) - **Star : 4623** **最近提交 : 2019-06-03**  基于SQLite的轻量级分布式关系数据库。
...
* [tidb](https://github.com/pingcap/tidb) - **Star : 19386** **最近提交 : 2019-06-27**  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。
* [tiedot](https://github.com/HouzuoGuo/tiedot) - **Star : 2353** **最近提交 : 2019-01-26**  您的NoSQL数据库由Golang提供支持。
* [Vasto](https://github.com/chrislusf/vasto) - **Star : 141** **最近提交 : 2019-03-08**  分布式高性能键值存储。在磁盘上。最终一致。哈哈。能够在不中断服务的情况下增长或收缩。
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - **Star : 845** **最近提交 : 2019-06-27**  快速，资源有效和可伸缩的开放源码时间序列数据库。可作为普罗米修斯的长期远程存储。支持PromQL。
...
* [goose](https://github.com/steinbacher/goose) - **Star : 116** **最近提交 : 2016-09-24**  数据库迁移工具。您可以通过创建增量SQL或Go脚本来管理数据库的演进。
* [gormigrate](https://github.com/go-gormigrate/gormigrate) - **Star : 313** **最近提交 : 2019-06-25**  Gorm ORM的数据库模式迁移帮助程序。
* [migrate](https://github.com/golang-migrate/migrate) - **Star : 2396** **最近提交 : 2019-06-27**  数据库迁移。CLI和Golang库。
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) - **Star : 1363** **最近提交 : 2019-06-18**  数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。

*数据库工具。*

* [chproxy](https://github.com/Vertamedia/chproxy) - **Star : 290** **最近提交 : 2019-05-04**  ClickHouse数据库的HTTP代理。
...
* [go-mysql](https://github.com/siddontang/go-mysql) - **Star : 1790** **最近提交 : 2019-06-26**   Go 工具集处理MySQL协议和复制。
...
* [kingshard](https://github.com/flike/kingshard) - **Star : 4512** **最近提交 : 2019-05-15**  kingshard是Golang支持的MySQL高性能代理。
...
* [orchestrator](https://github.com/github/orchestrator) - **Star : 2938** **最近提交 : 2019-06-27**  MySQL复制拓扑管理器和可视化。
* [pgweb](https://github.com/sosedoff/pgweb) - **Star : 5932** **最近提交 : 2019-02-26**  基于web的PostgreSQL数据库浏览器。
...
* [gendry](https://github.com/didi/gendry) - **Star : 693** **最近提交 : 2019-05-15**  非入侵的SQL builder和强大的数据绑定器。
* [godbal](https://github.com/xujiajun/godbal) - **Star : 50** **最近提交 : 2019-01-30**  数据库抽象层(dbal)。支持SQL builder，轻松获取结果。
* [goqu](https://github.com/doug-martin/goqu) - **Star : 519** **最近提交 : 2019-06-20**  惯用SQL生成器和查询库。
...
* [Squirrel](https://github.com/Masterminds/squirrel) - **Star : 2181** **最近提交 : 2019-06-19**  帮助您构建SQL查询的Go库。
...
* Relational Databases
    ...
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - **Star : 7827** **最近提交 : 2019-06-27**  MySQL驱动程序。
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - **Star : 3338** **最近提交 : 2019-06-20**  使用数据库/sql的SQLite3驱动程序。
    ...
    * [pgx](https://github.com/jackc/pgx) - **Star : 1850** **最近提交 : 2019-06-27**  PostgreSQL驱动程序支持数据库/sql公开之外的特性。
    * [pq](https://github.com/lib/pq) - **Star : 5053** **最近提交 : 2019-06-20**  用于数据库/sql的纯Go Postgres驱动程序。
...
* NoSQL Databases
    ...
    * [go-couchbase](https://github.com/couchbase/go-couchbase) - **Star : 290** **最近提交 : 2019-06-26**  Couchbase客户端在Go中。
    ...
    * [mgo](https://github.com/globalsign/mgo) - **Star : 1591** **最近提交 : 2019-06-19**  (未维护的)用于Go语言的MongoDB驱动程序，它在遵循标准Go习惯用法的非常简单的API下实现了丰富且经过良好测试的特性选择。
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - **Star : 2864** **最近提交 : 2019-06-27**  用于Go语言的官方MongoDB驱动程序。
    ...
    * [redigo](https://github.com/gomodule/redigo) - **Star : 6089** **最近提交 : 2019-06-21**  Redigo是Redis数据库的Go客户机。
    * [redis](https://github.com/go-redis/redis) - **Star : 6121** **最近提交 : 2019-06-26**  Redis是Golang的客户。
...
* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) - **Star : 5730** **最近提交 : 2019-06-26**  现代文本索引库。
    * [elastic](https://github.com/olivere/elastic) - **Star : 3977** **最近提交 : 2019-06-27**  弹力搜索客户端 Go 。
    * [elasticsql](https://github.com/cch123/elasticsql) - **Star : 367** **最近提交 : 2019-03-21**  在Go中将sql转换为elasticsearch dsl。
    * [elastigo](https://github.com/mattbaird/elastigo) - **Star : 949** **最近提交 : 2019-02-06**  Elasticsearch客户机库。
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - **Star : 1448** **最近提交 : 2019-06-27**  官方弹力搜索客户端为Go。
    * [goes](https://github.com/OwnLocal/goes) - **Star : 24** **最近提交 : 2017-03-03**  库与Elasticsearch交互。
    * [riot](https://github.com/go-ego/riot) - **Star : 4614** **最近提交 : 2019-06-03**  走开源、分布式、简单高效的搜索引擎之路。
...
* [dateparse](https://github.com/araddon/dateparse) - **Star : 874** **最近提交 : 2019-06-23**  在不知道格式的情况下解析日期。
...
* [go-sunrise](https://github.com/nathan-osman/go-sunrise) - **Star : 12** **最近提交 : 2017-11-22**  计算给定位置的日出和日落时间。
...
* [now](https://github.com/jinzhu/now) - **Star : 2121** **最近提交 : 2019-06-13**  现在是戈朗的时间工具箱。
...
* [dragonboat](https://github.com/lni/dragonboat) - **Star : 2425** **最近提交 : 2019-06-27**  一个功能齐全，高性能的多组筏库在围棋。
...
* [emitter-io](https://github.com/emitter-io/emitter) - **Star : 1861** **最近提交 : 2019-06-16**  高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。
* [flowgraph](https://github.com/vectaport/flowgraph) - **Star : 16** **最近提交 : 2019-06-20**  基于流程的方法编程方案。
* [gleam](https://github.com/chrislusf/gleam) - **Star : 2027** **最近提交 : 2019-06-20**  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。
* [glow](https://github.com/chrislusf/glow) - **Star : 2486** **最近提交 : 2018-11-02**  易于使用的可伸缩分布式大数据处理，Map-Reduce, DAG执行，全部在纯Go。
* [go-health](https://github.com/InVisionApp/go-health) - **Star : 470** **最近提交 : 2019-06-26**  库，用于在服务中启用异步依赖项健康检查。
* [go-jump](https://github.com/dgryski/go-jump) - **Star : 250** **最近提交 : 2018-02-12**  端口谷歌的“跳转”一致哈希函数。
* [go-kit](https://github.com/go-kit/kit) - **Star : 14034** **最近提交 : 2019-06-24**  支持服务发现、负载平衡、可插入传输、请求跟踪等功能的Microservice toolkit。
* [gorpc](https://github.com/valyala/gorpc) - **Star : 546** **最近提交 : 2017-04-07**  简单、快速和可伸缩的RPC库，用于高负载。
* [grpc-go](https://github.com/grpc/grpc-go) - **Star : 8645** **最近提交 : 2019-06-27**  gRPC的Go语言实现。HTTP RPC / 2。
* [hprose](https://github.com/hprose/hprose-golang) - **Star : 987** **最近提交 : 2019-06-27**  非常新颖的RPC库，现在支持25+种语言。
* [jaeger](https://github.com/jaegertracing/jaeger) - **Star : 8338** **最近提交 : 2019-06-27**  分布式跟踪系统。
...
* [micro](https://github.com/micro/micro) - **Star : 6379** **最近提交 : 2019-06-27**  可插入的微服务工具包和分布式系统平台。
...
* [raft](https://github.com/hashicorp/raft) - **Star : 2763** **最近提交 : 2019-06-27**  Golang协议由HashiCorp实现。
...
* [rpcx](https://github.com/smallnest/rpcx) - **Star : 3648** **最近提交 : 2019-06-27**  分布式可插RPC服务框架，如阿里巴巴Dubbo。
...
* [tendermint](https://github.com/tendermint/tendermint) - **Star : 3056** **最近提交 : 2019-06-27**  使用Tendermint consensus和区块链协议将任何编程语言编写的状态机转换成拜占庭式容错复制状态机的高性能中间件。
* [torrent](https://github.com/anacrolix/torrent) - **Star : 2751** **最近提交 : 2019-06-24**  bt客户端包。
...
* [email](https://github.com/jordan-wright/email) - **Star : 1068** **最近提交 : 2019-04-23**  一个强大和灵活的电子邮件库 Go 。
* [go-dkim](https://github.com/toorop/go-dkim) - **Star : 46** **最近提交 : 2019-05-10**  DKIM库，以签署和验证电子邮件。
* [go-imap](https://github.com/emersion/go-imap) - **Star : 700** **最近提交 : 2019-06-19**  用于客户机和服务器的IMAP库。
...
* [hermes](https://github.com/matcornic/hermes) - **Star : 1588** **最近提交 : 2019-06-06**  Golang包生成干净的、响应性强的HTML电子邮件。
* [MailHog](https://github.com/mailhog/MailHog) - **Star : 5003** **最近提交 : 2019-05-28**  电子邮件和SMTP测试与web和API接口。
...
* [anko](https://github.com/mattn/anko) - **Star : 897** **最近提交 : 2019-05-24**  用Go编写的可编写脚本的解释器。
* [binder](https://github.com/alexeyco/binder) - **Star : 28** **最近提交 : 2018-07-30**  转到基于[gopher-lua]的Lua绑定库(https://github.com/yuin/gopher-lua)。
* [expr](https://github.com/antonmedv/expr) - **Star : 552** **最近提交 : 2019-06-27**  一个可以计算表达式的引擎。
* [gentee](https://github.com/gentee/gentee) - **Star : 24** **最近提交 : 2019-06-24**  嵌入式脚本编程语言。
* [gisp](https://github.com/jcla1/gisp) - **Star : 426** **最近提交 : 2017-08-25**  简单的LISP在围棋。
* [go-duktape](https://github.com/olebedev/go-duktape) - **Star : 648** **最近提交 : 2019-03-17**  Duktape JavaScript引擎绑定。
* [go-lua](https://github.com/Shopify/go-lua) - **Star : 1633** **最近提交 : 2019-05-17**  端口的Lua 5.2 VM到纯Go。
* [go-php](https://github.com/deuill/go-php) - **Star : 666** **最近提交 : 2018-10-07**  用于Go的PHP绑定。
...
* [gopher-lua](https://github.com/yuin/gopher-lua) - **Star : 2897** **最近提交 : 2019-06-19**  用Go编写的Lua 5.1虚拟机和编译器。
* [gval](https://github.com/PaesslerAG/gval) - **Star : 129** **最近提交 : 2019-05-30**  一种用Go编写的高度可定制的表达式语言。
* [ngaro](https://github.com/db47h/ngaro) - **Star : 18** **最近提交 : 2018-06-03**  嵌入式Ngaro VM实现，支持在Retro中编写脚本。
* [otto](https://github.com/robertkrimen/otto) - **Star : 4642** **最近提交 : 2019-06-11**  用Go编写的JavaScript解释器。
...
* [errlog](https://github.com/snwfdhmp/errlog) - **Star : 141** **最近提交 : 2019-04-19**  可编程包，用于确定错误的负责源代码(以及一些其他快速调试特性)。可插入到任何记录器的位置。
* [errors](https://github.com/pkg/errors) - **Star : 4672** **最近提交 : 2019-05-30**  提供简单错误处理原语的包。
* [errorx](https://github.com/joomcode/errorx) - **Star : 545** **最近提交 : 2019-03-06**  一个功能丰富的错误包与堆栈跟踪，组成的错误和更多。
...
* [afero](https://github.com/spf13/afero) - **Star : 2164** **最近提交 : 2019-06-19**  文件系统抽象系统。
...
* [go-csv-tag](https://github.com/artonge/go-csv-tag) - **Star : 43** **最近提交 : 2019-03-31**  使用标签加载csv文件。
...
* [pdfcpu](https://github.com/hhrutter/pdfcpu) - **Star : 917** **最近提交 : 2019-06-17**  PDF处理器。
...
* [decimal](https://github.com/shopspring/decimal) - **Star : 1533** **最近提交 : 2019-06-17**  任意精度定点十进制数。
...
* [orderbook](https://github.com/i25959341/orderbook) - **Star : 60** **最近提交 : 2019-05-15**  Golang限购单匹配引擎。
...
* [binding](https://github.com/mholt/binding) - **Star : 752** **最近提交 : 2018-03-29**  将表单和JSON数据从net/http请求绑定到struct。
* [conform](https://github.com/leebenson/conform) - **Star : 171** **最近提交 : 2018-06-16**  控制用户输入。基于struct标签对数据进行修剪、清理和擦除。
* [form](https://github.com/go-playground/form) - **Star : 346** **最近提交 : 2019-04-30**  解码的url。将值转换为Go value(s)并将Go value(s)编码为url.Values。双数组和全地图支持。
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) - **Star : 1766** **最近提交 : 2019-06-27**  死简单的2D游戏库在围棋。
* [engo](https://github.com/EngoEngine/engo) - **Star : 1069** **最近提交 : 2019-04-09**  Engo是一个用Go编写的开源2D游戏引擎。它遵循实体-组件-系统范式。
* [g3n](https://github.com/g3n/engine) - **Star : 717** **最近提交 : 2019-06-13**   Go 3D游戏引擎。
...
* [go-astar](https://github.com/beefsack/go-astar) - **Star : 320** **最近提交 : 2018-03-26**  Go实现了A\*路径查找算法。
* [go-collada](https://github.com/GlenKelley/go-collada) - **Star : 12** **最近提交 : 2013-09-27**   Go 软件包处理Collada文件格式。
* [go-sdl2](https://github.com/veandco/go-sdl2) - **Star : 1130** **最近提交 : 2019-06-13**  用于[Simple DirectMedia层]的Go绑定(https://www.libsdl.org/)。
...
* [goworld](https://github.com/xiaonanln/goworld) - **Star : 1128** **最近提交 : 2019-05-27**  可伸缩的游戏服务器引擎，具有空间实体框架和热交换功能。
* [Leaf](https://github.com/name5566/leaf) - **Star : 2980** **最近提交 : 2018-12-28**  轻量级游戏服务器框架。
* [nano](https://github.com/lonng/nano) - **Star : 955** **最近提交 : 2019-06-16**  轻量级、方便、高性能的基于golang的游戏服务器框架。
* [Oak](https://github.com/oakmound/oak) - **Star : 620** **最近提交 : 2019-06-23**  纯围棋游戏引擎。
* [Pitaya](https://github.com/topfreegames/pitaya) - **Star : 279** **最近提交 : 2019-06-21**  可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity等通过C SDK。
* [Pixel](https://github.com/faiface/pixel) - **Star : 2363** **最近提交 : 2019-06-23**  手工制作的2D游戏库在围棋。
...
* [gen](https://github.com/clipperhouse/gen) - **Star : 1013** **最近提交 : 2018-06-12**  “仿制药”——功能代码生成工具。
...
* [interfaces](https://github.com/rjeczalik/interfaces) - **Star : 183** **最近提交 : 2019-05-02**  用于生成接口定义的命令行工具。
* [jennifer](https://github.com/dave/jennifer) - **Star : 1246** **最近提交 : 2019-05-04**  生成没有模板的任意Go代码。
* [pkgreflect](https://github.com/ungerik/pkgreflect) - **Star : 82** **最近提交 : 2017-09-05**   Go 预处理包范围内的反射。
...
* [S2 geometry](https://github.com/golang/geo) - **Star : 868** **最近提交 : 2019-05-08**  S2几何库在围棋。
* [Tile38](https://github.com/tidwall/tile38) - **Star : 6258** **最近提交 : 2019-06-15**  具有空间索引和实时地理定位功能的地理定位数据库。
...
* [gopherjs](https://github.com/gopherjs/gopherjs) - **Star : 8417** **最近提交 : 2019-05-01**  编译器从到JavaScript。
...
* [ants](https://github.com/panjf2000/ants) - **Star : 1727** **最近提交 : 2019-06-27**  一个高性能的戈朗goroutine池。
...
* [breaker](https://github.com/kamilsk/breaker) - **Star : 23** **最近提交 : 2019-06-26**  🚧灵活的机制,以使代码易碎物品。
...
* [gollback](https://github.com/vardius/gollback) - **Star : 24** **最近提交 : 2019-06-07**  异步简单函数实用程序，用于管理闭包和回调的执行。
* [GoSlaves](https://github.com/themester/GoSlaves) - 简单异步Goroutine池库。
* [goworker](https://github.com/benmanns/goworker) - **Star : 2216** **最近提交 : 2019-02-06**  goworker是一个基于go的后台工作者。
* [gpool](https://github.com/Sherifabdlnaby/gpool) - **Star : 58** **最近提交 : 2019-05-09**  管理可调整大小的上下文感知goroutine池，以绑定并发性。
* [grpool](https://github.com/ivpusic/grpool) - **Star : 486** **最近提交 : 2019-01-28**  轻量级Goroutine池。
...
* [semaphore](https://github.com/marusama/semaphore) - **Star : 68** **最近提交 : 2019-01-10**  基于CAS的快速可调整大小的信号量实现(比基于通道的信号量实现更快)。
...
* [tunny](https://github.com/Jeffail/tunny) - **Star : 1271** **最近提交 : 2018-11-09**  戈朗的戈朗游泳池。
* [worker-pool](https://github.com/vardius/worker-pool) - **Star : 43** **最近提交 : 2019-06-07**  goworker是一个Go simple异步工作池。
* [workerpool](https://github.com/gammazero/workerpool) - **Star : 116** **最近提交 : 2019-06-09**  限制任务执行并发性的Goroutine池，而不是队列中的任务数量。
...
* [fyne](https://github.com/fyne-io/fyne) - **Star : 5980** **最近提交 : 2019-06-26**  跨平台的本地gui是为围棋而设计的，使用EFL呈现。支持:Linux, macOS, Windows。
* [go-astilectron](https://github.com/asticode/go-astilectron) - **Star : 2586** **最近提交 : 2019-06-26**  使用GO和HTML/JS/CSS(电子驱动)构建跨平台GUI应用程序。
...
* [gotk3](https://github.com/gotk3/gotk3) - **Star : 724** **最近提交 : 2019-06-20**  用于GTK3的Go绑定。
* [gowd](https://github.com/dtylman/gowd) - **Star : 200** **最近提交 : 2019-06-19**  快速和简单的桌面UI开发与GO, HTML, CSS和NW.js。交叉平台。
* [qt](https://github.com/therecipe/qt) - **Star : 5782** **最近提交 : 2019-06-27**  Qt绑定for Go(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。
* [ui](https://github.com/andlabs/ui) - **Star : 6813** **最近提交 : 2019-03-28**  用于Go的平台原生GUI库。交叉平台。
* [Wails](https://wails.app) - Mac, Windows, Linux桌面应用程序的HTML用户界面使用内置的OS HTML渲染器。
* [walk](https://github.com/lxn/walk) - **Star : 3603** **最近提交 : 2019-06-22**  Windows应用程序库工具包。
* [webview](https://github.com/zserge/webview) - **Star : 4499** **最近提交 : 2019-06-24**  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。
...
* [robotgo](https://github.com/go-vgo/robotgo) - **Star : 4336** **最近提交 : 2019-06-23**  实现跨平台的GUI系统自动化。控制鼠标、键盘等。
* [systray](https://github.com/getlantern/systray) - **Star : 750** **最近提交 : 2019-06-26**  跨平台Go库在通知区放置图标和菜单。
...
* [bimg](https://github.com/h2non/bimg) - **Star : 766** **最近提交 : 2019-03-21**  使用libvips快速有效地处理图像的小程序包。
...
* [gg](https://github.com/fogleman/gg) - **Star : 1860** **最近提交 : 2019-06-12**  纯粹的围棋2D渲染。
* [gift](https://github.com/disintegration/gift) - **Star : 1201** **最近提交 : 2019-03-23**  图像处理滤波器包。
...
* [gocv](https://github.com/hybridgroup/gocv) - **Star : 2346** **最近提交 : 2019-06-18**  使用OpenCV 3.3+进行计算机视觉打包。
...
* [imaginary](https://github.com/h2non/imaginary) - **Star : 2538** **最近提交 : 2019-05-28**  快速和简单的HTTP微服务，用于图像大小调整。
* [imaging](https://github.com/disintegration/imaging) - **Star : 2453** **最近提交 : 2019-06-11**  简单的 Go 图像处理软件包。
* [img](https://github.com/hawx/img) - **Star : 129** **最近提交 : 2015-05-01**  图像处理工具的选择。
* [ln](https://github.com/fogleman/ln) - **Star : 2436** **最近提交 : 2018-02-24**  3D线艺术渲染在围棋。
...
* [picfit](https://github.com/thoas/picfit) - **Star : 1046** **最近提交 : 2019-05-31**  一个用Go编写的图像调整服务器。
...
* [rez](https://github.com/bamiaux/rez) - **Star : 161** **最近提交 : 2017-08-01**  图像大小调整在纯 Go 和SIMD。
...
* [stegify](https://github.com/DimitarPetrov/stegify) - **Star : 478** **最近提交 : 2019-05-15**   Go 工具为LSB隐写术，能够隐藏任何文件在一个图像。
* [svgo](https://github.com/ajstarks/svgo) - **Star : 1306** **最近提交 : 2018-10-06**   Go 语言库为SVG生成。
...
* [flogo](https://github.com/tibcosoftware/flogo) - **Star : 1087** **最近提交 : 2019-06-19**  Flogo项目是一个面向物联网边缘应用和集成的开源框架。
* [gatt](https://github.com/paypal/gatt) - **Star : 805** **最近提交 : 2019-05-14**  Gatt是一个用于构建蓝牙低能耗外围设备的Go软件包。
...
* [mainflux](https://github.com/Mainflux/mainflux) - **Star : 550** **最近提交 : 2019-06-27**  工业物联网消息和设备管理服务器。
...
* [GJSON](https://github.com/tidwall/gjson) - **Star : 4678** **最近提交 : 2019-06-06**  用一行代码获取JSON值。
...
* [jsonf](https://github.com/miolini/jsonf) - **Star : 54** **最近提交 : 2016-07-08**  控制台工具，用于突出显示格式和结构查询获取JSON。
* [jsongo](https://github.com/ricardolonga/jsongo) - **Star : 91** **最近提交 : 2016-12-15**  使用Fluent API更容易地创建Json对象。
...
* [glog](https://github.com/golang/glog) - **Star : 2255** **最近提交 : 2019-06-01**  为Go提供了水平的执行日志。
...
* [journald](https://github.com/ssgreg/journald) - **Star : 17** **最近提交 : 2018-12-25**   Go 实现systemd Journal的本地日志API。
* [log](https://github.com/aerogo/log) - **Star : 4** **最近提交 : 2019-05-24**  一个O(1)日志系统，允许您将一个日志连接到多个写入器(例如stdout、文件和TCP连接)。
* [log](https://github.com/apex/log) - **Star : 718** **最近提交 : 2019-06-24**  Go的结构化日志包。
...
* [log-voyage](https://github.com/firstrow/logvoyage) - **Star : 82** **最近提交 : 2017-05-25**  用golang编写的功能齐全的日志saas。
* [log15](https://github.com/inconshreveable/log15) - **Star : 876** **最近提交 : 2019-06-13**  简单、强大的Go日志。
...
* [logrus](https://github.com/Sirupsen/logrus) - **Star : 11393** **最近提交 : 2019-06-27**  结构化的日志 Go 。
...
* [lumberjack](https://github.com/natefinch/lumberjack) - **Star : 1373** **最近提交 : 2019-06-06**  简单的滚动日志程序，实现io.WriteCloser。
...
* [rollingwriter](https://github.com/arthurkiller/rollingWriter) - **Star : 93** **最近提交 : 2019-06-01**  RollingWriter是一个自动旋转的io。作者的实现与多个策略，以提供日志文件旋转。
* [seelog](https://github.com/cihub/seelog) - **Star : 1330** **最近提交 : 2019-03-04**  具有灵活调度、过滤和格式化的日志功能。
* [spew](https://github.com/davecgh/go-spew) - **Star : 3220** **最近提交 : 2019-04-21**  为Go数据结构实现一个漂亮的深层打印机，以帮助调试。
* [stdlog](https://github.com/alexcesaro/log) - **Star : 43** **最近提交 : 2015-09-16**  Stdlog是一个面向对象的库，提供水平日志记录。它对cron作业非常有用。
* [tail](https://github.com/hpcloud/tail) - **Star : 1491** **最近提交 : 2019-06-12**  Go软件包努力模拟BSD tail程序的特性。
...
* [zap](https://github.com/uber-go/zap) - **Star : 7145** **最近提交 : 2019-06-26**  快速、结构化、水平登录Go。
* [zerolog](https://github.com/rs/zerolog) - **Star : 2076** **最近提交 : 2019-06-21**  零JSON记录器。
...
* [CloudForest](https://github.com/ryanbressler/CloudForest) - **Star : 639** **最近提交 : 2018-11-20**  快速、灵活、多线程的决策树集成，用于纯Go中的机器学习。
* [eaopt](https://github.com/MaxHalford/eaopt) - **Star : 611** **最近提交 : 2019-03-25**  一个进化优化库。
* [evoli](https://github.com/khezen/evoli) - **Star : 6** **最近提交 : 2019-05-26**  遗传算法和粒子群优化库。
...
* [go-galib](https://github.com/thoj/go-galib) - **Star : 168** **最近提交 : 2015-12-29**  用Go / golang编写的遗传算法库。
...
* [goga](https://github.com/tomcraven/goga) - **Star : 77** **最近提交 : 2017-01-16**  Go的遗传算法库。
* [GoLearn](https://github.com/sjwhitworth/golearn) - **Star : 6582** **最近提交 : 2019-06-20**  通用机器学习库。
...
* [goml](https://github.com/cdipaolo/goml) - **Star : 998** **最近提交 : 2019-04-13**  在线机器学习在围棋。
...
* [gorse](https://github.com/zhenghaoz/gorse) - **Star : 506** **最近提交 : 2019-06-14**  基于协同过滤的Go高性能推荐系统包。
...
* [onnx-go](https://github.com/owulveryck/onnx-go) - **Star : 133** **最近提交 : 2019-06-26**  Go接口打开神经网络交换(ONNX)。
...
* [Benthos](https://github.com/Jeffail/benthos) - **Star : 1870** **最近提交 : 2019-06-27**  一系列协议之间的消息流桥。
* [Bus](https://github.com/mustafaturan/bus) - **Star : 109** **最近提交 : 2019-05-24**  内部通信的最小消息总线实现。
* [Centrifugo](https://github.com/centrifugal/centrifugo) - **Star : 3605** **最近提交 : 2019-06-27**  实时消息(Websockets或SockJS)服务器。
* [Commander](https://github.com/jeroenrinzema/commander) - **Star : 19** **最近提交 : 2019-06-13**  高级事件驱动的消费者/生产者，支持各种“方言”，如Apache Kafka。
* [dbus](https://github.com/godbus/dbus) - **Star : 349** **最近提交 : 2019-06-24**  D-Bus的本地Go绑定。
...
* [EventBus](https://github.com/asaskevich/EventBus) - **Star : 537** **最近提交 : 2019-06-05**  具有异步兼容性的轻量级事件总线。
* [gaurun-client](https://github.com/osamingo/gaurun-client) - **Star : 8** **最近提交 : 2019-05-10**  用Go编写的Gaurun客户端。
* [Glue](https://github.com/desertbit/glue) - **Star : 312** **最近提交 : 2019-06-20**  健壮的Go和Javascript套接字库(替代Socket.io)。
* [go-notify](https://github.com/TheCreeper/go-notify) - **Star : 47** **最近提交 : 2019-02-10**  本地实现的freedesktop通知规范。
* [go-nsq](https://github.com/nsqio/go-nsq) - **Star : 1432** **最近提交 : 2019-03-29**  NSQ的官方Go包。
* [go-socket.io](https://github.com/googollee/go-socket.io) - **Star : 2824** **最近提交 : 2019-05-29**  套接字。面向golang的io库，一个实时应用程序框架。
...
* [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) - **Star : 1819** **最近提交 : 2017-06-07**  gopush-cluster是一个gopush服务器集群。
* [gorush](https://github.com/appleboy/gorush) - **Star : 3615** **最近提交 : 2019-06-27**  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。
...
* [machinery](https://github.com/RichardKnop/machinery) - **Star : 3286** **最近提交 : 2019-06-27**  基于分布式消息传递的异步任务队列/作业队列。
* [mangos](https://github.com/go-mangos/mangos) - 具有传输互操作性的Nanomsg(“可伸缩协议”)的纯go实现。
* [melody](https://github.com/olahol/melody) - **Star : 1503** **最近提交 : 2019-06-26**  处理websocket会话的极简框架，包括广播和自动乒乓球处理。
* [Mercure](https://github.com/dunglas/mercure) - **Star : 1430** **最近提交 : 2019-06-27**  使用Mercure协议(构建在服务器发送事件之上)分派服务器发送的更新的服务器和库。
...
* [rabbus](https://github.com/rafaeljesus/rabbus) - **Star : 60** **最近提交 : 2019-01-31**  amqp交换器和队列上的一个小包装。
* [rabtap](https://github.com/jandelgado/rabtap) - **Star : 65** **最近提交 : 2019-06-14**  RabbitMQ瑞士军刀cli应用。
...
* [sarama](https://github.com/Shopify/sarama) - **Star : 4423** **最近提交 : 2019-06-27**   Go Apache Kafka的库。
* [Uniqush-Push](https://github.com/uniqush/uniqush-push) - **Star : 1088** **最近提交 : 2019-06-14**  Redis支持面向移动设备的服务器端通知的统一推送服务。
* [zmq4](https://github.com/pebbe/zmq4) - **Star : 768** **最近提交 : 2019-06-26**  转接口到ZeroMQ版本4。也可用于[版本3](https://github.com/pebbe/zmq3)和[版本2](https://github.com/pebbe/zmq2)。
...
* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) - **Star : 4186** **最近提交 : 2019-06-20**  Golang库读写Microsoft Excel™(XLSX)文件。
* [go-excel](https://github.com/szyhf/go-excel) - **Star : 45** **最近提交 : 2018-12-22**  一个简单而轻便的阅读器，可以将类似于关系数据库的excel作为表来读取。
...
* [xlsx](https://github.com/tealeg/xlsx) - **Star : 3265** **最近提交 : 2019-06-05**  库，以简化在Go程序中读取Microsoft Excel最新版本使用的XML格式。
...
* [dig](https://github.com/uber-go/dig) - **Star : 853** **最近提交 : 2019-06-17**  一个基于反射的Go依赖注入工具包。
* [fx](https://github.com/uber-go/fx) - **Star : 633** **最近提交 : 2019-06-24**  基于依赖注入的Go应用程序框架(构建在dig之上)。
* [gocontainer](https://github.com/vardius/gocontainer) - **Star : 3** **最近提交 : 2019-06-11**  简单的依赖注入容器。
* [inject](https://github.com/defval/inject) - **Star : 16** **最近提交 : 2019-06-26**  一个基于反射的依赖注入容器，具有简单的接口。
...
* [go-sample](https://github.com/zitryss/go-sample) - **Star : 15** **最近提交 : 2019-01-25**  使用实际代码的Go应用程序项目的示例布局。
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - **Star : 8323** **最近提交 : 2019-06-10**  Go生态系统中常见的历史和新兴的项目布局模式。
* [scaffold](https://github.com/catchplay/scaffold) - **Star : 20** **最近提交 : 2019-01-10**  脚手架生成starter Go项目布局。让您专注于已实现的业务逻辑。

### 字符串
*处理字符串的库。*
* [strutil](https://github.com/ozgio/strutil) - **Star : 61** **最近提交 : 2018-09-06**  字符串工具。
* [xstrings](https://github.com/huandu/xstrings) - **Star : 604** **最近提交 : 2018-09-06**  从其他语言移植的有用字符串函数的集合。
...
* [archiver](https://github.com/mholt/archiver) - **Star : 2350** **最近提交 : 2019-06-26**  用于生成和提取.zip和.tar.gz存档的库和命令。
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) - **Star : 601** **最近提交 : 2019-05-20**  Base64captch支持数字，数字，字母，算术，音频和数字-字母验证码。
...
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) - **Star : 645** **最近提交 : 2019-05-26**  Golang的通用对象池。
* [go-openapi](https://github.com/go-openapi) - 用于解析和利用开放api模式的包的集合。
* [go-resiliency](https://github.com/eapache/go-resiliency) - **Star : 830** **最近提交 : 2019-06-14**  戈朗的弹性模式。
...
* [gopsutil](https://github.com/shirou/gopsutil) - **Star : 3781** **最近提交 : 2019-06-23**  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。
...
* [llvm](https://github.com/llir/llvm) - **Star : 400** **最近提交 : 2019-06-15**  用于在纯Go中与LLVM IR交互的库。
...
* [go-pinyin](https://github.com/mozillazg/go-pinyin) - **Star : 509** **最近提交 : 2019-04-06**  中文汉字到汉语拼音的转换。
* [go-stem](https://github.com/agonopol/go-stem) - **Star : 51** **最近提交 : 2018-06-17**  波特词干算法的实现。
* [go-unidecode](https://github.com/mozillazg/go-unidecode) - **Star : 52** **最近提交 : 2019-04-05**  Unicode文本的ASCII音译。
...
* [gse](https://github.com/go-ego/gse) - **Star : 1034** **最近提交 : 2019-06-09**  高效的文本分割;支持英语、汉语、日语等。
...
* [nlp](https://github.com/james-bowman/nlp) - **Star : 210** **最近提交 : 2019-04-08**  支持LSA(潜在语义分析)的Go自然语言处理库。
...
* [sentences](https://github.com/neurosnap/sentences) - **Star : 260** **最近提交 : 2019-04-17**  句子标记器:将文本转换为句子列表。
...
* [cidranger](https://github.com/yl2chen/cidranger) - **Star : 373** **最近提交 : 2019-01-19**  快速IP到CIDR查找围棋。
* [dhcp6](https://github.com/mdlayher/dhcp6) - **Star : 60** **最近提交 : 2019-03-12**  包dhcp6实现了一个DHCPv6服务器，如RFC 3315所述。
* [dns](https://github.com/miekg/dns) - **Star : 3705** **最近提交 : 2019-06-24**  使用DNS的库。
* [ether](https://github.com/songgao/ether) - **Star : 60** **最近提交 : 2016-04-05**  用于发送和接收以太网帧的跨平台Go包。
* [ethernet](https://github.com/mdlayher/ethernet) - **Star : 182** **最近提交 : 2019-06-06**  包以太网实现了对IEEE 802.3以太网II帧和IEEE 802.1Q VLAN标签的编组和解组。
* [fasthttp](https://github.com/valyala/fasthttp) - **Star : 8994** **最近提交 : 2019-06-23**  软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。
* [fortio](https://github.com/fortio/fortio) - **Star : 812** **最近提交 : 2019-06-18**  负载测试库和命令行工具，先进的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。Tcp、Http、gRPC。
* [ftp](https://github.com/jlaffaye/ftp) - **Star : 487** **最近提交 : 2019-06-24**  包ftp实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户机。
...
* [go-getter](https://github.com/hashicorp/go-getter) - **Star : 684** **最近提交 : 2019-06-17**   Go 图书馆下载文件或目录从各种来源使用一个URL。
* [go-stun](https://github.com/ccding/go-stun) - **Star : 321** **最近提交 : 2018-07-26**  Go实现了STUN客户机(RFC 3489和RFC 5389)。
* [gobgp](https://github.com/osrg/gobgp) - **Star : 1644** **最近提交 : 2019-06-26**  用围棋编程语言实现的BGP。
...
* [gopacket](https://github.com/google/gopacket) - **Star : 2768** **最近提交 : 2019-06-26**  使用libpcap绑定访问包处理库。
...
* [HTTPLab](https://github.com/gchaincl/httplab) - **Star : 3363** **最近提交 : 2019-06-05**  HTTPLabs允许您检查HTTP请求并伪造响应。
...
* [kcp-go](https://github.com/xtaci/kcp-go) - **Star : 2190** **最近提交 : 2019-06-26**  快速可靠的ARQ协议。
* [kcptun](https://github.com/xtaci/kcptun) - **Star : 10503** **最近提交 : 2019-06-27**  非常简单和快速udp隧道基于KCP协议。
* [lhttp](https://github.com/fanux/lhttp) - **Star : 505** **最近提交 : 2018-04-08**  强大的websocket框架，使您的IM服务器更容易构建。
* [linkio](https://github.com/ian-kent/linkio) - **Star : 44** **最近提交 : 2017-08-08**  用于读写器接口的网络链路速度模拟。
* [llb](https://github.com/kirillDanshin/llb) - **Star : 8** **最近提交 : 2016-04-04**  这是一个非常简单但快速的代理服务器后端。可用于快速重定向到预定义域，具有零内存分配和快速响应。
* [mdns](https://github.com/hashicorp/mdns) - **Star : 540** **最近提交 : 2019-04-19**  Golang中的简单mDNS(多播DNS)客户机/服务器库。
...
* [packet](https://github.com/aerogo/packet) - **Star : 25** **最近提交 : 2019-05-27**  通过TCP和UDP发送数据包。如果需要，它可以缓冲消息和热交换连接。
...
* [quic-go](https://github.com/lucas-clemente/quic-go) - **Star : 2788** **最近提交 : 2019-06-27**  在纯Go中实现了QUIC协议。
...
* [ssh](https://github.com/gliderlabs/ssh) - **Star : 1084** **最近提交 : 2019-06-20**  用于构建SSH服务器的高级API(封装密码/ SSH)。
...
* [utp](https://github.com/anacrolix/utp) - **Star : 149** **最近提交 : 2018-02-19**  Go uTP微传输协议的实现。
* [water](https://github.com/songgao/water) - **Star : 822** **最近提交 : 2019-06-23**  简单TUN / TAP图书馆。
...
* [grequests](https://github.com/levigross/grequests) - **Star : 1386** **最近提交 : 2019-02-14**  一个 Go “克隆”的伟大和著名的请求库。
...
* [gl](https://github.com/go-gl/gl) - **Star : 626** **最近提交 : 2019-03-21**  OpenGL的Go绑定(通过glow生成)。
* [glfw](https://github.com/go-gl/glfw) - **Star : 709** **最近提交 : 2019-04-12**  Go绑定用于glfw3。
* [goxjs/gl](https://github.com/goxjs/gl) - **Star : 130** **最近提交 : 2018-11-05**  跨平台的OpenGL绑定(OS X, Linux, Windows，浏览器，iOS, Android)。
...
* [go-pg](https://github.com/go-pg/pg) - **Star : 2856** **最近提交 : 2019-06-27**  关注PostgreSQL的特性和性能。
* [go-queryset](https://github.com/jirfag/go-queryset) - **Star : 442** **最近提交 : 2019-03-17**  100%类型安全ORM与代码生成和MySQL, PostgreSQL, Sqlite3, SQL Server支持基于GORM。
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) - **Star : 218** **最近提交 : 2019-05-23**  一个灵活而强大的SQL字符串构建器库加上一个零配置ORM。
* [go-store](https://github.com/gosuri/go-store) - **Star : 92** **最近提交 : 2017-02-23**  简单而快速的Redis支持的键值存储库。
* [GORM](https://github.com/jinzhu/gorm) - **Star : 14070** **最近提交 : 2019-06-27**  Golang出色的ORM库的目标是对开发人员友好。
* [gorp](https://github.com/go-gorp/gorp) - **Star : 3057** **最近提交 : 2019-06-17**  Go的关系持久性，ORM-ish库。
...
* [pop/soda](https://github.com/gobuffalo/pop) - **Star : 654** **最近提交 : 2019-06-27**  数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。
* [QBS](https://github.com/coocood/qbs) - **Star : 536** **最近提交 : 2017-04-18**  表示结构查询。一个ORM。
* [reform](https://github.com/go-reform/reform) - **Star : 783** **最近提交 : 2019-05-31**  更好的ORM for Go，基于非空接口和代码生成。
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) - **Star : 2196** **最近提交 : 2019-06-25**  ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。
* [upper.io/db](https://github.com/upper/db) - **Star : 1811** **最近提交 : 2019-01-27**  通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。
* [Xorm](https://github.com/go-xorm/xorm) - **Star : 4984** **最近提交 : 2019-06-27**  简单而强大的ORM for Go。
...
* [dep](https://github.com/golang/dep) - **Star : 12359** **最近提交 : 2019-06-24**   Go 依赖的工具。
...
* [glide](https://github.com/Masterminds/glide) - **Star : 7733** **最近提交 : 2019-06-19**  轻松管理您的golang供应商和销售包。受Maven、Bundler和Pip等工具的启发。
...
* [gopm](https://github.com/gpmgo/gopm) - **Star : 2325** **最近提交 : 2019-06-08**  包管理器。
* [govendor](https://github.com/kardianos/govendor) - **Star : 4651** **最近提交 : 2019-06-14**  包管理器。使用标准供应商文件的Go vendor工具。
...
* [mvn-golang](https://github.com/raydac/mvn-golang) - **Star : 86** **最近提交 : 2019-06-24**  插件，为自动加载Golang SDK，依赖关系管理和启动Maven项目基础设施中的构建环境提供了方法。
* [nut](https://github.com/jingweno/nut) - **Star : 245** **最近提交 : 2015-06-26**  供应商的依赖。
* [VenGO](https://github.com/DamnWidget/VenGO) - **Star : 116** **最近提交 : 2016-07-14**  创建和管理可导出的隔离go虚拟环境。

## 查询语言

* [gojsonq](https://github.com/thedevsaddam/gojsonq) - **Star : 830** **最近提交 : 2019-05-28**  一个简单的Go包来查询JSON数据。
...
* [graphql-go](https://github.com/graphql-go/graphql) - **Star : 5037** **最近提交 : 2019-06-20**  为Go实现GraphQL。
...
* [go.rice](https://github.com/GeertJohan/go.rice) - **Star : 1615** **最近提交 : 2019-05-01**  走了。rice是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。
* [packr](https://github.com/gobuffalo/packr) - **Star : 2001** **最近提交 : 2019-06-26**  将静态文件嵌入到Go二进制文件中的简单方法。
...
* [templify](https://github.com/wlbr/templify) - **Star : 18** **最近提交 : 2019-05-26**  将外部模板文件嵌入到Go代码中，以创建单个文件二进制文件。
* [vfsgen](https://github.com/shurcooL/vfsgen) - **Star : 628** **最近提交 : 2019-02-14**  生成一个vfsdata。静态实现给定虚拟文件系统的go文件。
...
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) - **Star : 56** **最近提交 : 2019-06-27**  用于机器学习和统计的数据模型(类似于熊猫)。
* [evaler](https://github.com/soniah/evaler) - **Star : 40** **最近提交 : 2018-07-27**  简单的浮点算术表达式求值器。
* [ewma](https://github.com/VividCortex/ewma) - **Star : 263** **最近提交 : 2019-05-22**  Exponentially-weighted移动平均线。
...
* [gonum](https://github.com/gonum/gonum) - **Star : 2833** **最近提交 : 2019-06-27**  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。
* [gonum/plot](https://github.com/gonum/plot) - **Star : 1173** **最近提交 : 2019-06-15**  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。
* [goraph](https://github.com/gyuho/goraph) - **Star : 597** **最近提交 : 2017-10-01**  纯Go图论库(数据结构，算法可视化)。
* [gosl](https://github.com/cpmech/gosl) - **Star : 1287** **最近提交 : 2019-02-28**   Go 科学图书馆线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程，等等。
...
* [orb](https://github.com/paulmach/orb) - **Star : 180** **最近提交 : 2019-06-26**  2D几何类型，支持剪切、GeoJSON和Mapbox矢量平铺。
...
* [stats](https://github.com/montanaflynn/stats) - **Star : 1326** **最近提交 : 2019-05-03**  包含Golang标准库中缺少的公共函数的统计软件包。
...
* [acra](https://github.com/cossacklabs/acra) - **Star : 437** **最近提交 : 2019-06-25**  网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。
...
* [Cameradar](https://github.com/Ullaakut/cameradar) - **Star : 1767** **最近提交 : 2019-06-27**  工具和库，以远程入侵RTSP流从监控摄像头。
...
* [memguard](https://github.com/awnumar/memguard) - **Star : 992** **最近提交 : 2019-06-27**  一个用于处理内存中敏感值的纯Go库。
...
* [simple-scrypt](https://github.com/elithrar/simple-scrypt) - **Star : 153** **最近提交 : 2018-06-06**  Scrypt包具有简单，明显的API和自动成本校准内置。
...
* [go-codec](https://github.com/ugorji/go) - **Star : 1204** **最近提交 : 2019-06-26**  高性能，功能丰富，惯用的编码，解码和rpc库的msgpack, cbor和json，基于运行时或代码生成的支持。
* [gogoprotobuf](https://github.com/gogo/protobuf) - **Star : 2815** **最近提交 : 2019-06-21**  用于与gadget一起使用的协议缓冲区。
* [goprotobuf](https://github.com/golang/protobuf) - **Star : 4820** **最近提交 : 2019-06-26**  Go以库和协议编译器插件的形式支持谷歌的协议缓冲区。
* [jsoniter](https://github.com/json-iterator/go) - **Star : 5227** **最近提交 : 2019-06-22**  高性能100%兼容的drop-in替换“编码/json”。
* [mapstructure](https://github.com/mitchellh/mapstructure) - **Star : 2308** **最近提交 : 2019-03-26**  用于将通用映射值解码为本机Go结构的Go库。
...
* [algernon](https://github.com/xyproto/algernon) - **Star : 1571** **最近提交 : 2019-06-03**  内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。
* [Caddy](https://github.com/mholt/caddy) - **Star : 22425** **最近提交 : 2019-06-24**  Caddy是另一种HTTP/2 web服务器，易于配置和使用。
...
* [discovery](https://github.com/Bilibili/discovery) - **Star : 618** **最近提交 : 2019-06-25**  用于弹性中间层负载平衡和故障转移的注册表。
* [etcd](https://github.com/coreos/etcd) - 为共享配置和服务发现提供高可用的键值存储。
* [Fider](https://github.com/getfider/fider) - **Star : 765** **最近提交 : 2019-05-29**  Fider是一个收集和组织客户反馈的开放平台。
* [Flagr](https://github.com/checkr/flagr) - **Star : 775** **最近提交 : 2019-06-21**  Flagr是一个开源特性标记和A/B测试服务。
* [flipt](https://github.com/markphelps/flipt) - **Star : 974** **最近提交 : 2019-06-24**  一个用Go和Vue.js编写的自包含特性标志解决方案
* [jackal](https://github.com/ortuman/jackal) - **Star : 704** **最近提交 : 2019-06-17**  用Go编写的XMPP服务器。
* [minio](https://github.com/minio/minio) - **Star : 16767** **最近提交 : 2019-06-27**  Minio是一个分布式对象存储服务器。
...
* [RoadRunner](https://github.com/spiral/roadrunner) - **Star : 3118** **最近提交 : 2019-06-27**  高性能PHP应用服务器，负载平衡器和进程管理器。
...
* [gofpdf](https://github.com/jung-kurt/gofpdf) - **Star : 2991** **最近提交 : 2019-06-24**  PDF文档生成器具有对文本、绘图和图像的高级支持。
* [goview](https://github.com/foolin/goview) - **Star : 36** **最近提交 : 2019-06-08**  Goview是一个轻量级、极简和惯用的模板库，基于golang html/template构建Go web应用程序。
* [hero](https://github.com/shiyanhui/hero) - **Star : 1189** **最近提交 : 2019-06-07**  Hero是一个方便、快速和强大的go模板引擎。
...
* [pongo2](https://github.com/flosch/pongo2) - **Star : 1476** **最近提交 : 2019-06-19**  类似于django的模板引擎。
* [quicktemplate](https://github.com/valyala/quicktemplate) - **Star : 1355** **最近提交 : 2019-04-24**  快速，强大，但易于使用模板引擎。将模板转换为Go代码，然后编译它。
...
* Testing Frameworks
    ...
    * [baloo](https://github.com/h2non/baloo) - **Star : 633** **最近提交 : 2019-01-10**  富有表现力和多用途的端到端HTTP API测试变得很容易。
    ...
    * [dsunit](https://github.com/viant/dsunit) - **Star : 24** **最近提交 : 2019-06-18**  用于SQL、NoSQL、结构化文件的数据存储测试。
    * [endly](https://github.com/viant/endly) - **Star : 83** **最近提交 : 2019-06-22**  声明性端到端功能测试。
    * [frisby](https://github.com/verdverm/frisby) - **Star : 245** **最近提交 : 2019-06-07**  REST API测试框架。
    ...
    * [go-cmp](https://github.com/google/go-cmp) - **Star : 1081** **最近提交 : 2019-06-07**  用于比较测试中的Go值的包。
    ...
    * [godog](https://github.com/DATA-DOG/godog) - **Star : 700** **最近提交 : 2019-05-29**  Cucumber或Behat类似于Go的BDD框架。
    * [gofight](https://github.com/appleboy/gofight) - **Star : 251** **最近提交 : 2019-06-11**  用于Golang路由器框架的API处理程序测试。
    ...
    * [gotest.tools](https://github.com/gotestyourself/gotest.tools) - **Star : 106** **最近提交 : 2019-06-27**  一组包，用于增强go测试包并支持公共模式。
    * [Hamcrest](https://github.com/rdrdr/hamcrest) - **Star : 26** **最近提交 : 2011-02-15**  用于声明性匹配器对象的连贯框架，当将其应用于输入值时，将产生自描述结果。
    * [httpexpect](https://github.com/gavv/httpexpect) - **Star : 1101** **最近提交 : 2019-06-19**  简洁、声明性、易于使用端到端HTTP和REST API测试。
    * [jsonassert](https://github.com/kinbiko/jsonassert) - **Star : 20** **最近提交 : 2019-06-04**  用于验证JSON有效负载已正确序列化的包。
    ...
    * [Testify](https://github.com/stretchr/testify) - **Star : 7757** **最近提交 : 2019-06-13**  对标准go测试包的神圣扩展。
...
* Mock
    ...
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - **Star : 1609** **最近提交 : 2019-06-21**  用于测试数据库交互的模拟SQL驱动程序。
    * [go-txdb](https://github.com/DATA-DOG/go-txdb) - **Star : 153** **最近提交 : 2019-06-01**  基于单事务的数据库驱动程序主要用于测试目的。
    * [gock](https://github.com/h2non/gock) - **Star : 784** **最近提交 : 2019-06-18**  通用HTTP模拟变得容易。
    * [gomock](https://github.com/golang/mock) - **Star : 2662** **最近提交 : 2019-06-21**  用于Go编程语言的mock框架。
    * [govcr](https://github.com/seborama/govcr) - **Star : 78** **最近提交 : 2019-06-06**  Golang的HTTP模拟:记录和回放HTTP交互以进行离线测试。
    * [hoverfly](https://github.com/SpectoLabs/hoverfly) - **Star : 1406** **最近提交 : 2019-06-26**  使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。
...
* Fuzzing and delta-debugging/reducing/shrinking.
    * [go-fuzz](https://github.com/dvyukov/go-fuzz) - **Star : 2835** **最近提交 : 2019-05-16**  随机测试系统。
    * [gofuzz](https://github.com/google/gofuzz) - **Star : 516** **最近提交 : 2019-04-09**  库，用于填充具有随机值的go对象。
...
* Selenium and browser control tools.
    ...
    * [selenoid](https://github.com/aerokube/selenoid) - **Star : 1170** **最近提交 : 2019-06-25**  在容器中启动浏览器的替代Selenium hub服务器。

* Fail injection
    * [failpoint](https://github.com/pingcap/failpoint) - **Star : 363** **最近提交 : 2019-06-25**  为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。
...
* Specific Formats
    ...
    * [bluemonday](https://github.com/microcosm-cc/bluemonday) - **Star : 1210** **最近提交 : 2019-03-15**  HTML洗手液。
    ...
    * [editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) - **Star : 36** **最近提交 : 2019-06-17**  Editorconfig文件解析器和Go操作器。
    ...
    * [go-fixedwidth](https://github.com/ianlopshire/go-fixedwidth) - **Star : 21** **最近提交 : 2019-05-10**  固定宽度的文本格式(带反射的编码器/解码器)。
    * [go-humanize](https://github.com/dustin/go-humanize) - **Star : 1846** **最近提交 : 2019-01-09**  格式化程序，用于将时间、数字和内存大小转换为可读格式。
    ...
    * [GoQuery](https://github.com/PuerkitoBio/goquery) - **Star : 7388** **最近提交 : 2019-04-23**  GoQuery为Go语言带来了类似于jQuery的语法和一组特性。
    ...
    * [htmlquery](https://github.com/antchfx/htmlquery) - **Star : 112** **最近提交 : 2019-02-08**  用于HTML的XPath查询包，允许您通过XPath表达式从HTML文档中提取数据或求值。
    ...
    * [toml](https://github.com/BurntSushi/toml) - **Star : 2698** **最近提交 : 2019-03-27**  TOML配置格式(带反射的编码器/解码器)。
* Utility
    ...
    * [radix](https://github.com/yourbasic/radix) - **Star : 139** **最近提交 : 2018-03-08**  快速字符串排序算法。
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - **Star : 4864** **最近提交 : 2019-06-27**  Go编程语言的官方AWS SDK。
...
* [discordgo](https://github.com/bwmarrin/discordgo) - **Star : 926** **最近提交 : 2019-06-21**   Go 绑定不和谐聊天API。
* [ethrpc](https://github.com/onrik/ethrpc) - **Star : 164** **最近提交 : 2019-03-05**   Go 绑定Ethereum JSON RPC API。
* [facebook](https://github.com/huandu/facebook) - **Star : 764** **最近提交 : 2019-06-13**  支持Facebook图形API的Go库。
...
* [github](https://github.com/google/go-github) - **Star : 4668** **最近提交 : 2019-06-26**  访问GitHub REST API v3的库。
...
* [go-jira](https://github.com/andygrunwald/go-jira) - **Star : 548** **最近提交 : 2019-06-22**   Go [Atlassian JIRA]的客户端库(https://www.atlassian.com/software/jira)
...
* [Medium](https://github.com/Medium/medium-sdk-go) - **Star : 114** **最近提交 : 2018-10-27**  Golang SDK for Medium的OAuth2 API。
...
* [paypal](https://github.com/logpacker/PayPal-Go-SDK) - **Star : 297** **最近提交 : 2019-06-27**  PayPal支付API的包装器。
...
* [slack](https://github.com/nlopes/slack) - **Star : 2328** **最近提交 : 2019-06-26**  Slack API in Go。
...
* [stripe](https://github.com/stripe/stripe-go) - **Star : 912** **最近提交 : 2019-06-27**   Go 客户端获取Stripe API。
...
* [webhooks](https://github.com/go-playground/webhooks) - **Star : 334** **最近提交 : 2019-06-20**  用于GitHub和Bitbucket的Webhook接收器。
...
* [boilr](https://github.com/tmrts/boilr) - **Star : 919** **最近提交 : 2018-07-25**  非常快的CLI工具，用于从样板模板创建项目。
* [chyle](https://github.com/antham/chyle) - **Star : 106** **最近提交 : 2019-06-19**  使用具有多种配置可能性的git存储库生成变更日志。
* [circuit](https://github.com/cep21/circuit) - **Star : 314** **最近提交 : 2019-06-27**  一个高效和功能齐全的Hystrix喜欢 Go 实现断路器模式。
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) - **Star : 775** **最近提交 : 2019-01-30**  接通断路器。
* [clockwork](https://github.com/jonboulle/clockwork) - **Star : 215** **最近提交 : 2019-01-14**  一个简单的假时钟给戈朗。
...
* [ctop](https://github.com/bcicen/ctop) - **Star : 8608** **最近提交 : 2019-06-23**  [Top-like](http://ctop.sh)接口(例如htop)用于容器度量。
...
* [filetype](https://github.com/h2non/filetype) - **Star : 922** **最近提交 : 2019-05-15**  小程序包来推断文件类型，检查神奇数字签名。
* [filler](https://github.com/yaronsumel/filler) - **Star : 14** **最近提交 : 2017-04-10**  使用“fill”标签填充结构的小工具。
* [filter](https://github.com/gookit/filter) - **Star : 10** **最近提交 : 2019-06-16**  提供Go数据的过滤、清理和转换。
* [fzf](https://github.com/junegunn/fzf) - **Star : 22308** **最近提交 : 2019-06-25**  用Go编写的命令行模糊查找器。
...
* [go-funk](https://github.com/thoas/go-funk) - **Star : 958** **最近提交 : 2019-05-03**  现代Go实用程序库，它提供了助手(map, find, contains, filter, chunk, reverse，…)。
...
* [go-rate](https://github.com/beefsack/go-rate) - **Star : 290** **最近提交 : 2018-04-09**  围棋限速器。
...
* [gopencils](https://github.com/bndr/gopencils) - **Star : 422** **最近提交 : 2019-02-18**  小而简单的包，可以轻松地使用REST api。
...
* [goreleaser](https://github.com/goreleaser/goreleaser) - **Star : 4313** **最近提交 : 2019-06-27**  交付Go二进制文件的速度越快越容易越好。
* [goreporter](https://github.com/wgliang/goreporter) - Golang工具，做静态分析，单元测试，代码审查和生成代码质量报告。
* [goseaweedfs](https://github.com/linxGnu/goseaweedfs) - **Star : 24** **最近提交 : 2019-02-07**  具有几乎所有功能的SeaweedFS客户端库。
...
* [gubrak](https://github.com/novalagung/gubrak) - **Star : 125** **最近提交 : 2019-03-16**  带有语法糖的Golang实用程序库。就像lodash，但对golang来说。
...
* [hub](https://github.com/github/hub) - **Star : 16516** **最近提交 : 2019-06-26**  使用附加功能包装git命令，以便从终端与github交互。
* [hystrix-go](https://github.com/afex/hystrix-go) - **Star : 1934** **最近提交 : 2019-06-13**  实现程序定义的回退(即断路器)的Hystrix模式。
...
* [jump](https://github.com/gsamokovarov/jump) - **Star : 638** **最近提交 : 2019-06-20**  通过学习你的习惯，跳跃可以帮助你更快地导航。
* [koazee](https://github.com/wesovilabs/koazee) - **Star : 274** **最近提交 : 2019-03-05**  库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。
* [lrserver](https://github.com/jaschaephraim/lrserver) - **Star : 99** **最近提交 : 2017-11-30**  lieload服务器为Go。
* [mc](https://github.com/minio/mc) - **Star : 1057** **最近提交 : 2019-06-27**  Minio Client提供了与Amazon S3兼容的云存储和文件系统一起工作的最小工具。
* [mergo](https://github.com/imdario/mergo) - **Star : 819** **最近提交 : 2019-06-15**  帮助合并结构和地图在戈朗。对于配置默认值很有用，避免了混乱的if语句。
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) - **Star : 97** **最近提交 : 2019-06-25**  用于基于神奇数字的MIME类型检测的包。
...
* [mmake](https://github.com/tj/mmake) - **Star : 1449** **最近提交 : 2019-06-17**  现代。
* [moldova](https://github.com/StabbyCutyou/moldova) - **Star : 148** **最近提交 : 2017-09-04**  用于基于输入模板生成随机数据的实用程序。
* [mole](https://github.com/davrodpin/mole) - **Star : 1288** **最近提交 : 2019-06-27**  cli应用程序可以轻松创建ssh隧道。
* [mssqlx](https://github.com/linxGnu/mssqlx) - **Star : 56** **最近提交 : 2019-03-27**  数据库客户端库，代理任何主从，主从结构。轻量级和自动平衡的想法。
...
* [peco](https://github.com/peco/peco) - **Star : 5393** **最近提交 : 2019-06-12**  简单的交互过滤工具。
...
* [profile](https://github.com/pkg/profile) - **Star : 965** **最近提交 : 2019-03-24**  Go的简单分析支持包。
...
* [resty](https://github.com/go-resty/resty) - **Star : 1807** **最近提交 : 2019-06-19**  简单的HTTP和REST客户端Go的灵感来自Ruby REST -client。
* [retry](https://github.com/kamilsk/retry) - **Star : 137** **最近提交 : 2019-05-30**  最先进的重复执行动作的功能机制，直至成功。
...
* [robustly](https://github.com/VividCortex/robustly) - **Star : 132** **最近提交 : 2018-03-24**  弹性地运行函数，捕捉并重新启动恐慌。
...
* [sqlx](https://github.com/jmoiron/sqlx) - **Star : 6527** **最近提交 : 2019-06-20**  在优秀的内置数据库/sql包之上提供一组扩展。
* [sslice](https://github.com/yaa110/sslice) - **Star : 2** **最近提交 : 2018-11-17**  创建一个总是排序的切片。
* [Storm](https://github.com/asdine/storm) - **Star : 1330** **最近提交 : 2019-04-18**  简单而强大的BoltDB工具包。
* [structs](https://github.com/PumpkinSeed/structs) - **Star : 12** **最近提交 : 2017-10-23**  实现操作结构的简单函数。
* [Task](https://github.com/go-task/task) - **Star : 1857** **最近提交 : 2019-06-23**  简单的“使”的选择。
* [toolbox](https://github.com/viant/toolbox) - **Star : 86** **最近提交 : 2019-06-10**  切片，地图，多ap，结构，功能，数据转换实用工具。服务路由器，宏评估器，令牌器。
...
* [util](https://github.com/shomali11/util) - **Star : 130** **最近提交 : 2019-06-08**  有用实用函数的集合。(字符串，并发，操作，…)
* [wuzz](https://github.com/asciimoo/wuzz) - **Star : 8183** **最近提交 : 2018-12-07**  用于HTTP检查的交互式cli工具。
...
* [ulid](https://github.com/oklog/ulid) - **Star : 1648** **最近提交 : 2019-06-03**  实现了ULID(普遍唯一的词典分类标识符)。
* [uuid](https://github.com/agext/uuid) - **Star : 10** **最近提交 : 2019-02-23**  使用快速或加密质量的随机节点标识符生成、编码和解码UUIDs v1。
* [uuid](https://github.com/gofrs/uuid) - **Star : 544** **最近提交 : 2019-06-23**  通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。
...
* [govalidator](https://github.com/asaskevich/govalidator) - **Star : 3460** **最近提交 : 2019-05-10**  验证器和消毒剂的字符串，数字，切片和结构。
* [govalidator](https://github.com/thedevsaddam/govalidator) - **Star : 681** **最近提交 : 2019-06-21**  用简单的规则验证Golang请求数据。深受Laravel请求验证的启发。
* [jio](https://github.com/faceair/jio) - **Star : 21** **最近提交 : 2019-05-29**  jio是一个json模式验证器，类似于[joi](https://github.com/hapijs/joi)。
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - **Star : 999** **最近提交 : 2019-05-24**  支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。
* [validate](https://github.com/gookit/validate) - **Star : 81** **最近提交 : 2019-06-03**   Go 封装数据验证和过滤。支持验证映射、结构、请求(表单、JSON、url)。值，上载文件)数据和更多特性。
* [validate](https://github.com/gobuffalo/validate) - **Star : 19** **最近提交 : 2019-04-03**  这个包提供了一个框架，用于为Go应用程序编写验证。
* [validator](https://github.com/go-playground/validator) - **Star : 3268** **最近提交 : 2019-06-14**   Go 结构和字段验证，包括交叉字段，交叉结构，地图，切片和数组潜水。
...
* [git2go](https://github.com/libgit2/git2go) - **Star : 1336** **最近提交 : 2019-06-20**   Go 绑定libgit2。
* [go-git](https://github.com/src-d/go-git) - **Star : 4087** **最近提交 : 2019-06-20**  纯Go中高度可扩展的Git实现。
* [go-vcs](https://github.com/sourcegraph/go-vcs) - **Star : 69** **最近提交 : 2019-06-19**  在Go中操作和检查VCS存储库。
* [hercules](https://github.com/src-d/hercules) - **Star : 491** **最近提交 : 2019-06-21**  从Git存储库历史中获得高级见解。
...
* [goav](https://github.com/giorgisio/goav) - **Star : 744** **最近提交 : 2019-05-28**  FFmpeg的Comphrensive Go绑定。
...
* [libvlc-go](https://github.com/adrg/libvlc-go) - **Star : 58** **最近提交 : 2019-04-14**  Go绑定libvlc 2.X/3.X/4。X(由VLC媒体播放器使用)。
...
* [Beego](https://github.com/astaxie/beego) - **Star : 20965** **最近提交 : 2019-06-25**  beego是一种用于围棋编程语言的开源高性能web框架。
* [Buffalo](http://gobuffalo.io) - 提高Rails的生产力!
* [Echo](https://github.com/labstack/echo) - **Star : 14292** **最近提交 : 2019-06-24**  高性能、极简的Go web框架。
...
* [Gin](https://github.com/gin-gonic/gin) - **Star : 28578** **最近提交 : 2019-06-27**  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。如果您需要性能和良好的生产力。
* [Gizmo](https://github.com/NYTimes/gizmo) - **Star : 2809** **最近提交 : 2019-06-12**  《纽约时报》使用的微服务工具包。
...
* [Goa](https://github.com/goadesign/goa) - **Star : 3451** **最近提交 : 2019-06-27**  Goa为在Go中开发远程api和微服务提供了一种全面的方法。
...
* [Macaron](https://github.com/go-macaron/macaron) - **Star : 2779** **最近提交 : 2019-04-24**  Macaron是一个高生产力和模块化设计的web框架在Go。
...
* [Revel](https://github.com/revel/revel) - **Star : 11156** **最近提交 : 2019-05-19**  用于Go语言的高效web框架。
...
* [tango](https://github.com/lunny/tango) - **Star : 813** **最近提交 : 2019-05-17**  微和可插入的网络框架 Go 。
...
* [utron](https://github.com/gernest/utron) - **Star : 2137** **最近提交 : 2018-10-29**  Go(Golang)的轻量级MVC框架。
...
* [CORS](https://github.com/rs/cors) - **Star : 1172** **最近提交 : 2019-06-15**  轻松地向API添加CORS功能。
...
* [Limiter](https://github.com/ulule/limiter) - **Star : 758** **最近提交 : 2019-06-17**  死简单的速度限制中间件 Go 。
* [ln-paywall](https://github.com/philippgille/ln-paywall) - **Star : 86** **最近提交 : 2019-02-25**  使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。
* [Tollbooth](https://github.com/didip/tollbooth) - **Star : 1203** **最近提交 : 2018-12-04**  速率限制HTTP请求处理程序。
...
* [negroni](https://github.com/urfave/negroni) - **Star : 6268** **最近提交 : 2019-06-02**  Golang的惯用HTTP中间件。
...
* [chi](https://github.com/go-chi/chi) - **Star : 5821** **最近提交 : 2019-06-06**  小型，快速和表达的HTTP路由器建立在网络/上下文。
* [fasthttprouter](https://github.com/buaazp/fasthttprouter) - **Star : 732** **最近提交 : 2019-04-25**  高性能路由器分叉从' httprouter '。第一个路由器适合“fasthttp”。
...
* [Goji](https://github.com/goji/goji) - **Star : 760** **最近提交 : 2019-02-18**  枸杞是一种简约的和灵活的与支持'net/context` HTTP请求多路复用器。
...
* [httprouter](https://github.com/julienschmidt/httprouter) - **Star : 9464** **最近提交 : 2019-05-05**  高性能路由器。使用这个和标准http处理程序来形成一个非常高性能的web框架。
...
* [mux](https://github.com/gorilla/mux) - **Star : 9209** **最近提交 : 2019-06-25**  强大的URL路由器和调度器为golang。
...
* [xujiajun/gorouter](https://github.com/xujiajun/gorouter) - **Star : 442** **最近提交 : 2019-05-18**  一个简单和快速的HTTP路由器 Go 。

## 窗户

* [d3d9](https://github.com/gonutz/d3d9) - **Star : 86** **最近提交 : 2018-12-28**   Go 绑定Direct3D9。
* [go-ole](https://github.com/go-ole/go-ole) - **Star : 539** **最近提交 : 2019-03-05**  用于golang的Win32 OLE实现。
...
* [xpath](https://github.com/antchfx/xpath) - **Star : 145** **最近提交 : 2019-06-18**  Go的XPath包。
...
* [errcheck](https://github.com/kisielk/errcheck) - **Star : 1307** **最近提交 : 2019-01-04**  Errcheck是一个用于检查Go程序中未检查错误的程序。
* [gcvis](https://github.com/davecheney/gcvis) - **Star : 909** **最近提交 : 2019-03-13**  实时可视化Go程序GC跟踪数据。
...
* [go-critic](https://github.com/go-critic/go-critic) - **Star : 548** **最近提交 : 2019-05-26**  源代码linter带来的检查，目前没有实现在其他l。
* [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) - **Star : 171** **最近提交 : 2019-05-06**  找到Go项目过时依赖项的简单方法。
* [go-outdated](https://github.com/firstrow/go-outdated) - **Star : 45** **最近提交 : 2019-01-15**  显示过期包的控制台应用程序。
* [goast-viewer](https://github.com/yuroyoro/goast-viewer) - **Star : 366** **最近提交 : 2019-05-31**  基于Web的Golang AST可视化器。
...
* [GoLint](https://github.com/golang/lint) - **Star : 3093** **最近提交 : 2019-05-24**  Golint是Go源代码的linter。
...
* [gocode](https://github.com/nsf/gocode) - **Star : 4709** **最近提交 : 2019-03-02**  Go编程语言的自动完成守护进程。
* [goprofiling](https://marketplace.visualstudio.com/items?itemName=MaxMedia.go-prof) - 这个扩展将对Go语言的基准分析支持添加到VS代码中。
* [GoSublime](https://github.com/DisposaBoy/GoSublime) - **Star : 3211** **最近提交 : 2019-06-26**  Golang插件集合为文本编辑器SublimeText 3提供代码完成和其他类似idea的功能。
...
* [vim-go](https://github.com/fatih/vim-go) - **Star : 10636** **最近提交 : 2019-06-27**  为Vim开发插件。
* [vscode-go](https://github.com/Microsoft/vscode-go) - **Star : 4990** **最近提交 : 2019-06-26**  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。
...
* [genny](https://github.com/cheekybits/genny) - **Star : 918** **最近提交 : 2019-06-11**  优雅的Go泛型。
...
* [gotests](https://github.com/cweill/gotests) - **Star : 2112** **最近提交 : 2019-05-21**  从源代码生成Go测试。
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **Star : 1911** **最近提交 : 2019-01-15**  使用点格式可视化Go程序的调用图。
* [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) - **Star : 37** **最近提交 : 2017-11-17**  Bash完成go和wgo。
* [go-swagger](https://github.com/go-swagger/go-swagger) - **Star : 3792** **最近提交 : 2019-06-27**  Swagger 2.0实现的go。Swagger是RESTful API的一个简单而强大的表示。
...
* [bombardier](https://github.com/codesenberg/bombardier) - **Star : 1669** **最近提交 : 2019-03-25**  快速跨平台HTTP基准测试工具。
...
* [Gitea](https://github.com/go-gitea/gitea) - **Star : 14528** **最近提交 : 2019-06-27**  叉的Gogs，完全由社区驱动。
...
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) - **Star : 656** **最近提交 : 2019-03-30**  启用Go应用程序进行自我更新。
...
* [gox](https://github.com/mitchellh/gox) - **Star : 3318** **最近提交 : 2019-05-10**  非常简单，没有多余的交叉编译工具。
...
* [GVM](https://github.com/moovweb/gvm) - **Star : 4397** **最近提交 : 2019-01-01**  GVM提供了一个接口来管理Go版本。
* [Hey](https://github.com/rakyll/hey) - **Star : 6025** **最近提交 : 2019-06-24**  Hey是一个向web应用程序发送一些负载的小程序。
...
* [kubernetes](https://github.com/kubernetes/kubernetes) - **Star : 54524** **最近提交 : 2019-06-27**  来自谷歌的容器集群管理器。
* [lstags](https://github.com/ivanilves/lstags) - **Star : 219** **最近提交 : 2019-04-15**  工具和API跨不同注册中心同步Docker图像。
...
* [Moby](https://github.com/moby/moby) - **Star : 53892** **最近提交 : 2019-06-27**  为容器生态系统组装基于容器的系统的协作项目。
...
* [Pewpew](https://github.com/bengadbois/pewpew) - **Star : 198** **最近提交 : 2018-10-27**  灵活的HTTP命令行压力测试器。
* [Pomerium](https://github.com/pomerium/pomerium) - **Star : 462** **最近提交 : 2019-06-27**  Pomerium是一个可识别身份的访问代理。
...
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) - **Star : 531** **最近提交 : 2019-05-15**  从命令行管理裸金属服务器(与使用Docker一样容易)。
* [script](https://github.com/bitfield/script) - **Star : 600** **最近提交 : 2019-06-20**  使编写用于DevOps和系统管理任务的类shell脚本变得容易。
...
* [StatusOK](https://github.com/sanathp/statusok) - **Star : 1136** **最近提交 : 2019-06-10**  监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。
* [traefik](https://github.com/containous/traefik) - **Star : 23078** **最近提交 : 2019-06-27**  反向代理和负载均衡器，支持多个后端。
* [Vegeta](https://github.com/tsenart/vegeta) - **Star : 11838** **最近提交 : 2019-06-25**  HTTP负载测试工具和库。超过9000 !
* [webhook](https://github.com/adnanh/webhook) - **Star : 3968** **最近提交 : 2019-06-22**  允许用户创建在服务器上执行命令的HTTP端点(钩子)的工具。
...
* [Comcast](https://github.com/tylertreat/Comcast) - **Star : 6121** **最近提交 : 2018-10-21**  模拟坏的网络连接。
* [confd](https://github.com/kelseyhightower/confd) - **Star : 6303** **最近提交 : 2019-06-14**  使用etcd或领事中的模板和数据管理本地应用程序配置文件。
...
* [Documize](https://github.com/documize/community) - **Star : 781** **最近提交 : 2019-06-26**  集成SaaS工具数据的现代wiki软件。
* [drive](https://github.com/odeke-em/drive) - **Star : 4906** **最近提交 : 2019-06-20**  命令行的谷歌驱动器客户端。
* [Duplicacy](https://github.com/gilbertchen/duplicacy) - **Star : 2658** **最近提交 : 2019-06-26**  基于无锁重复数据删除思想的跨平台网络和云备份工具。
* [gfile](https://github.com/Antonito/gfile) - **Star : 485** **最近提交 : 2019-04-13**  通过WebRTC在两台计算机之间安全地传输文件，不需要任何第三方。
...
* [GoBoy](https://github.com/Humpheh/goboy) - **Star : 2089** **最近提交 : 2019-06-11**  任天堂Game Boy彩色模拟器编写在围棋。
...
* [lgo](https://github.com/yunabe/lgo) - **Star : 1761** **最近提交 : 2019-03-22**  与木星互动围棋编程。它支持代码完成、代码检查和100% Go兼容性。
* [limetext](http://limetext.org/) - Lime Text是一个强大而优雅的文本编辑器，最初是在Go中开发的，它的目标是成为卓越文本的免费和开源软件的继承者。
* [LiteIDE](https://github.com/visualfc/liteide) - **Star : 5398** **最近提交 : 2019-06-23**  LiteIDE是一个简单的、开源的、跨平台的Go IDE。
...
* [myLG](https://github.com/mehrdadrad/mylg) - **Star : 2176** **最近提交 : 2018-10-29**  用Go编写的命令行网络诊断工具。
* [naclpipe](https://github.com/unix4fun/naclpipe) - **Star : 20** **最近提交 : 2018-11-18**  简单的NaCL EC25519基于加密管工具编写的Go。
* [nes](https://github.com/fogleman/nes) - **Star : 4095** **最近提交 : 2019-06-17**  任天堂娱乐系统(NES)模拟器用围棋编写。
...
* [Pipe](https://github.com/b3log/pipe) - **Star : 2585** **最近提交 : 2019-06-24**  一个小巧漂亮的博客平台。
* [restic](https://github.com/restic/restic) - **Star : 7154** **最近提交 : 2019-06-26**  消除重复项备份程序。
* [rkt](https://github.com/coreos/rkt) - 与init系统集成的应用程序容器运行时，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。
* [scc](https://github.com/boyter/scc) - **Star : 760** **最近提交 : 2019-06-26**  一个非常快速准确的代码计数器与复杂性计算和COCOMO估计。
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - **Star : 7998** **最近提交 : 2019-06-27**  快速、简单、可伸缩的分布式文件系统与O(1)磁盘查找。
...
* [Stack Up](https://github.com/pressly/sup) - **Star : 1962** **最近提交 : 2019-05-22**  Stack Up是一个超级简单的部署工具—Unix—可以把它看作是一个服务器网络的“make”。
...
* [toxiproxy](https://github.com/shopify/toxiproxy) - **Star : 3767** **最近提交 : 2019-06-26**  为自动化测试模拟网络和系统条件的代理。
...
* [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) - **Star : 840** **最近提交 : 2019-04-17**  Go序列化方法的基准测试。
...
* [skynet](https://github.com/atemerev/skynet) - **Star : 906** **最近提交 : 2019-05-12**  天网1M线程微基准测试。
* [speedtest-resize](https://github.com/fawick/speedtest-resize) - **Star : 169** **最近提交 : 2017-03-14**  比较各种图像大小调整算法的围棋语言。
...
* [GoBooks](https://github.com/dariubs/GoBooks) - **Star : 6656** **最近提交 : 2019-05-30**  一份精选的围棋书籍清单。
...
* [gophers](https://github.com/ashleymcnamara/gophers) - **Star : 1807** **最近提交 : 2019-04-13**  阿什莉·麦克纳马拉的歌斐艺术品。
* [gophers](https://github.com/egonelbre/gophers) - **Star : 1543** **最近提交 : 2019-03-18**  免费打地鼠。
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - **Star : 14342** **最近提交 : 2019-06-17**  精心策划的远程工作列表。很多人都在寻找黑客。
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - **Star : 24448** **最近提交 : 2019-06-26**  其他令人惊叹的列表。
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - **Star : 30855** **最近提交 : 2019-06-24**  Golang电子书介绍如何与Golang建立一个web应用程序。
...
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - **Star : 3964** **最近提交 : 2019-02-18**   Go 参考卡片。
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) - **Star : 657** **最近提交 : 2019-06-02**  Golang的例子与Node.js的学习相比较。
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - **Star : 3810** **最近提交 : 2019-06-26**  学习使用测试驱动开发。
