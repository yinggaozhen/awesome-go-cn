...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-26 10:08:38(每隔1天同步一次)**
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [authboss](https://github.com/volatiletech/authboss)  | 1916 |  web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。 |![star > 1000][Silver]
| [branca](https://github.com/hako/branca)  | 76 |  基于 Go 实现Branca令牌。 |
| [casbin](https://github.com/hsluoyz/casbin)  | 4854 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]
| [cookiestxt](https://github.com/mengzhuo/cookiestxt)  | 2 |  提供cookie .txt文件格式的解析器。 |   ![最近一年没有更新][Yellow]
| [go-jose](https://github.com/square/go-jose)  | 1115 |  相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gorbac](https://github.com/mikespook/gorbac)  | 902 |  轻量级的基于角色的访问控制(RBAC)实现。 |![star > 100][Bronze]
| [goth](https://github.com/markbates/goth)  | 2248 |  提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。 |![star > 1000][Silver]
...
| [jwt](https://github.com/pascaldekloe/jwt)  | 85 |  轻量级JSON Web令牌库。 |
| [jwt-auth](https://github.com/adam-hanna/jwt-auth)  | 151 |  JWT中间件，可用于Golang http服务器，提供了许多配置选项。 |![star > 100][Bronze]
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5881 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]
| [loginsrv](https://github.com/tarent/loginsrv)  | 806 |  JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。 |![star > 100][Bronze]
| [oauth2](https://github.com/golang/oauth2)  | 2364 |  goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-chat-bot](https://github.com/go-chat-bot/bot)  | 465 |  用 Go 编写的IRC, Slack和电报机器人。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api)  | 1605 |  简单轻量级的Telegram bot客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [cobra](https://github.com/spf13/cobra)  | 13092 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [docopt.go](https://github.com/docopt/docopt.go)  | 1169 |  会让你满意的命令行参数解析器。 |![star > 1000][Silver]
...
| [flaggy](https://github.com/integrii/flaggy)  | 445 |  一个健壮的、易用的标志包，具有出色的子命令支持。 |![star > 100][Bronze]
...
| [kingpin](https://github.com/alecthomas/kingpin)  | 2522 |  支持子命令的命令行和标志解析器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pflag](https://github.com/spf13/pflag)  | 744 |  基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。 |![star > 100][Bronze]
...
| [urfave/cli](https://github.com/urfave/cli)  | 11263 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [aurora](https://github.com/logrusorgru/aurora)  | 620 |  支持fmt.Printf/Sprintf的ANSI终端颜色。 |![star > 100][Bronze]
...
| [color](https://github.com/fatih/color)  | 3003 |  多功能包装，彩色终端输出。 |![star > 1000][Silver]
...
| [go-prompt](https://github.com/c-bata/go-prompt)  | 2301 |  构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) |![star > 1000][Silver]
| [gocui](https://github.com/jroimartin/gocui)  | 5271 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [gommon/color](https://github.com/labstack/gommon/tree/master/color)  | - |  更换终端文本样式。 |
| [gookit/color](https://github.com/gookit/color)  | 198 |  终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [mpb](https://github.com/vbauerster/mpb)  | 510 |  可在终端显示多进度条。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [progressbar](https://github.com/schollz/progressbar)  | 561 |  基本线程安全的进度条，在每个操作系统工作。 |![star > 100][Bronze]
...
| [termbox-go](https://github.com/nsf/termbox-go)  | 3461 |  基于文本的跨平台接口库。 |![star > 1000][Silver]
...
| [termui](https://github.com/gizak/termui)  | 8872 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]
| [uilive](https://github.com/gosuri/uilive)  | 825 |  用于实时更新终端输出的库。 |![star > 100][Bronze]
| [uiprogress](https://github.com/gosuri/uiprogress)  | 1531 |  在终端呈现进度条，可灵活配置的。 |![star > 1000][Silver]
...
| [env](https://github.com/caarlos0/env)  | 853 |  解析环境变量并赋值到struct中(默认值)。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [godotenv](https://github.com/joho/godotenv)  | 2096 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]
...
| [gookit/config](https://github.com/gookit/config)  | 74 |  程序配置管理(load,get,set)。支持JSON, YAML, TOML, INI, HCL。支持多文件加载，数据覆盖合并。 |   ![包含中文文档][CN]
...
| [ini](https://github.com/go-ini/ini)  | 1575 |   读和写INI文件。 |![star > 1000][Silver]
...
| [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig)  | 2387 |  管理来自环境变量的配置数据。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [koanf](https://github.com/knadh/koanf)  | 81 |  轻量级可扩展库，用于读取Go应用程序中的配置。内置支持JSON, TOML, YAML, env，命令行。 |   ![最近一个周有更新][Green]
| [konfig](https://github.com/lalamove/konfig)  | 511 |  可组合、可观察和高性能的分布式配置管理。 |![star > 100][Bronze]
...
| [viper](https://github.com/spf13/viper)  | 9205 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18887 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [goveralls](https://github.com/mattn/goveralls)  | 573 |  Coveralls.io 是一个用 Go 编写，可持续对代码覆盖率进行检测的系统。 |![star > 100][Bronze]
...
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5103 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]
...
| [gods](https://github.com/emirpasic/gods)  | 6221 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]
...
| [trie](https://github.com/derekparker/trie)  | 417 |  在Go中实现Trie。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6220 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [bcache](https://github.com/iwanbk/bcache)  | 27 |  基于内存的最终一致的分布式缓存。 |
| [BigCache](https://github.com/allegro/bigcache)  | 2429 |  高效的键/值缓存为千兆字节的数据。 |![star > 1000][Silver]
| [bolt](https://github.com/boltdb/bolt)  | 9934 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16713 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [couchcache](https://github.com/codingsince1985/couchcache)  | 40 |  由 Couchbase服务 支持的RESTful缓存微服务。 |
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL)  | 871 |  区块链领域的一个SQL数据库。 |![star > 100][Bronze]
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10082 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [diskv](https://github.com/peterbourgon/diskv)  | 743 |  支持磁盘备份的可持久化 K/V 存储。 |![star > 100][Bronze]
...
| [GCache](https://github.com/bluele/gcache)  | 885 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]
| [go-cache](https://github.com/pmylund/go-cache)  | 2861 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3152 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |   ![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7623 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]
| [influxdb](https://github.com/influxdb/influxdb)  | 16921 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [nutsdb](https://github.com/xujiajun/nutsdb)  | 862 |  Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [piladb](https://github.com/fern4lvarez/piladb)  | 171 |  基于堆栈数据结构的轻量级RESTful数据库引擎。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [prometheus](https://github.com/prometheus/prometheus)  | 25338 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 218 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]
| [rqlite](https://github.com/rqlite/rqlite)  | 4673 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tidb](https://github.com/pingcap/tidb)  | 19878 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [tiedot](https://github.com/HouzuoGuo/tiedot)  | 2362 |  属于你的NoSQL数据库。 |![star > 1000][Silver]
| [Vasto](https://github.com/chrislusf/vasto)  | 145 |  分布式高性能键值存储。可做磁盘备份。最终一致。高可用。能够在不中断服务的情况下增长或收缩。 |![star > 100][Bronze]
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 968 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [migrate](https://github.com/golang-migrate/migrate)  | 2553 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sql-migrate](https://github.com/rubenv/sql-migrate)  | 1392 |  数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [chproxy](https://github.com/Vertamedia/chproxy)  | 299 |  ClickHouse数据库的HTTP代理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-mysql](https://github.com/siddontang/go-mysql)  | 1855 |   Go 工具集，用于处理MySQL协议和复制。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2363 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]
| [kingshard](https://github.com/flike/kingshard)  | 4572 |  kingshard 是基于 Golang 的MySQL高性能代理。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [orchestrator](https://github.com/github/orchestrator)  | 3008 |  MySQL复制拓扑管理器和可视化工具。 |![star > 1000][Silver]
| [pgweb](https://github.com/sosedoff/pgweb)  | 5962 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [vitess](https://github.com/youtube/vitess)  | 8377 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gendry](https://github.com/didi/gendry)  | 748 |  非入侵的SQL构建器和强大的数据绑定器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [godbal](https://github.com/xujiajun/godbal)  | 50 |  数据库抽象层(dbal)。支持SQL builder，轻松获取结果。 |
| [goqu](https://github.com/doug-martin/goqu)  | 625 |  常用的SQL生成器和查询库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2278 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]
...
| [go-oci8](https://github.com/mattn/go-oci8)  | 403 |  Oracle 驱动程序。 |![star > 100][Bronze]
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 8038 |  MySQL驱动程序。 |![star > 5000][Gold]
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3411 |  SQLite3驱动程序。 |![star > 1000][Silver]
| [gofreetds](https://github.com/minus5/gofreetds)  | 90 |  基于[FreeTDS](http://www.freetds.org)封装的微软MSSQL Go 驱动。 |
| [goracle](https://github.com/go-goracle/goracle)  | 233 |  基于 ODPI-C 的 Oracle 驱动程序 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [pgx](https://github.com/jackc/pgx)  | 1891 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pq](https://github.com/lib/pq)  | 5142 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 3022 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6223 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [redis](https://github.com/go-redis/redis)  | 6405 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5807 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4086 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch)  | 1531 |  官方 Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goes](https://github.com/OwnLocal/goes)  | 24 |  实现了与 Elasticsearch 交互的库。 |   ![最近一年没有更新][Yellow]
| [riot](https://github.com/go-ego/riot)  | 4669 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [cayley](https://github.com/google/cayley)  | 12663 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [now](https://github.com/jinzhu/now)  | 2159 |  now 是时间有关的工具类。 |![star > 1000][Silver]
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2499 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [emitter-io](https://github.com/emitter-io/emitter)  | 1905 |  高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。 |![star > 1000][Silver]
| [flowgraph](https://github.com/vectaport/flowgraph)  | 18 |  flow-based programming package。 |
| [gleam](https://github.com/chrislusf/gleam)  | 2070 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]
...
| [go-kit](https://github.com/go-kit/kit)  | 14321 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]
| [gorpc](https://github.com/valyala/gorpc)  | 551 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8980 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 999 |  支持25+种语言RPC库。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8565 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1724 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [micro](https://github.com/micro/micro)  | 6518 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [NATS](https://github.com/nats-io/gnatsd)  | 6248 |  轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [outboxer](https://github.com/italolelis/outboxer)  | 3 |  实现了 outbox pattern Go 库。 |
| [pglock](https://cirello.io/pglock)  | - |  postgresql 的分布式锁定实现。 |
| [raft](https://github.com/hashicorp/raft)  | 2819 |  Raft consensus协议的实现。 by HashiCorp。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [rpcx](https://github.com/smallnest/rpcx)  | 3739 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tendermint](https://github.com/tendermint/tendermint)  | 3106 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [torrent](https://github.com/anacrolix/torrent)  | 2820 |  BitTorrent 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-imap](https://github.com/emersion/go-imap)  | 722 |  用于客户端和服务器的IMAP库。 |![star > 100][Bronze]
...
| [hermes](https://github.com/matcornic/hermes)  | 1609 |  可生成干净的、响应式的HTML电子邮件。 |![star > 1000][Silver]
| [MailHog](https://github.com/mailhog/MailHog)  | 5121 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]
...
| [go-duktape](https://github.com/olebedev/go-duktape)  | 650 |  支持 Duktape JavaScript 引擎。 |![star > 100][Bronze]
...
| [go-python](https://github.com/sbinet/go-python)  | 904 |  CPython C-API 的 Go 接口。 |![star > 100][Bronze]
| [golua](https://github.com/aarzilli/golua)  | 441 |  Lua C 的 Go 接口。 |![star > 100][Bronze]
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2939 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]
...
| [otto](https://github.com/robertkrimen/otto)  | 4706 |  用 Go 编写的 JavaScript 解释器。 |![star > 1000][Silver]
| [purl](https://github.com/ian-kent/purl)  | 27 |  嵌入 Go 的 Perl 5.18.2。 |   ![最近一年没有更新][Yellow]
| [tengo](https://github.com/d5/tengo)  | 1286 |  字节码编译的脚本语言。 |![star > 1000][Silver]
...
| [errors](https://github.com/pkg/errors)  | 4821 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]
| [errorx](https://github.com/joomcode/errorx)  | 549 |  一个功能丰富的错误包，可进行堆栈跟踪、组装异常信息以及其他。 |![star > 100][Bronze]
| [go-multierror](https://github.com/hashicorp/go-multierror)  | 717 |  可将一系列的错误作为一个整体来显示。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2203 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pdfcpu](https://github.com/hhrutter/pdfcpu)  | 936 |  PDF处理器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [decimal](https://github.com/shopspring/decimal)  | 1584 |  任意精度定点的十进制数。 |![star > 1000][Silver]
...
| [nosurf](https://github.com/justinas/nosurf)  | 965 |  CSRF保护中间件。 |![star > 100][Bronze]
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1828 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [engo](https://github.com/EngoEngine/engo)  | 1077 |  开源 2D 游戏引擎。它遵循 Entity-Component-System 范式。 |![star > 1000][Silver]
| [g3n](https://github.com/g3n/engine)  | 737 |   3D游戏引擎。 |![star > 100][Bronze]
...
| [go-sdl2](https://github.com/veandco/go-sdl2)  | 1148 |  实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1165 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Leaf](https://github.com/name5566/leaf)  | 3033 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   ![包含中文文档][CN]
| [nano](https://github.com/lonng/nano)  | 977 |  轻量级、方便、高性能的基于golang的游戏服务器框架。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [Oak](https://github.com/oakmound/oak)  | 623 |  纯 Go 实现的游戏引擎。 |![star > 100][Bronze]
...
| [raylib-go](https://github.com/gen2brain/raylib-go)  | 379 |  实现了 [raylib](http://www.raylib.com/)，一个简单易用的库，用于学习视频游戏编程。 |![star > 100][Bronze]
...
| [go-linq](https://github.com/ahmetalpbalkan/go-linq)  | 1787 |  提供类似 .NET LINQ 的查询方法。 |![star > 1000][Silver]
| [goderive](https://github.com/awalterschulze/goderive)  | 735 |  从输入类型来派生函数。 |![star > 100][Bronze]
| [gotype](https://github.com/wzshiming/gotype)  | 20 |  Golang 源码解析，用法类似reflect(反射)。 |   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [S2 geometry](https://github.com/golang/geo)  | 881 |  S2 geometry 库。 |![star > 100][Bronze]
...
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8498 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1824 |  一个高性能的协程池。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [breaker](https://github.com/kamilsk/breaker)  | 31 |  灵活的机制，可以使执行流可中断。 |   ![最近一个周有更新][Green]
...
| [goworker](https://github.com/benmanns/goworker)  | 2239 |  基于 go 的后台 worker。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tunny](https://github.com/Jeffail/tunny)  | 1329 |  golang 的协程池。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [app](https://github.com/murlokswarm/app)  | 2943 |  用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。 |![star > 1000][Silver]
| [fyne](https://github.com/fyne-io/fyne)  | 6194 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [go-astilectron](https://github.com/asticode/go-astilectron)  | 2639 |  使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。 |![star > 1000][Silver]
| [go-gtk](http://mattn.github.io/go-gtk/)  | - |  实现了 GTK 的 Go接口。 |
| [go-sciter](https://github.com/sciter-sdk/go-sciter)  | 1438 |  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。 |![star > 1000][Silver]
| [gotk3](https://github.com/gotk3/gotk3)  | 761 |  实现了 GTK3 的 Go接口。 |![star > 100][Bronze]
| [gowd](https://github.com/dtylman/gowd)  | 207 |  跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。 |![star > 100][Bronze]
| [qt](https://github.com/therecipe/qt)  | 5986 |  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [ui](https://github.com/andlabs/ui)  | 6908 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3670 |  Windows应用程序库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [webview](https://github.com/zserge/webview)  | 4609 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]
...
| [gosx-notifier](https://github.com/deckarep/gosx-notifier)  | 493 |  OSX 桌面通知库。 |![star > 100][Bronze]
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4406 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [systray](https://github.com/getlantern/systray)  | 773 |  跨平台 Go 库，可在通知区放置图标和菜单。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bild](https://github.com/anthonynsimon/bild)  | 2028 |  纯Go语言实现的图像处理算法合集。 |![star > 1000][Silver]
| [bimg](https://github.com/h2non/bimg)  | 783 |  使用libvips实现的快速高效的图像处理包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gg](https://github.com/fogleman/gg)  | 1895 |  纯Go语言实现的2D渲染。 |![star > 1000][Silver]
...
| [gocv](https://github.com/hybridgroup/gocv)  | 2418 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [imagick](https://github.com/gographics/imagick)  | 968 |   ImageMagick下MagickWand的C API的Go binding。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [imaginary](https://github.com/h2non/imaginary)  | 2579 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]
| [imaging](https://github.com/disintegration/imaging)  | 2494 |  简单的Go图像处理包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [img](https://github.com/hawx/img)  | 129 |  图像处理工具的集合。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [ln](https://github.com/fogleman/ln)  | 2457 |  Go实现的3D线艺术（3D Line Art）渲染。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [smartcrop](https://github.com/muesli/smartcrop)  | 1248 |  为任意图片寻找合适的位置进行图片裁剪。 |![star > 1000][Silver]
...
| [flogo](https://github.com/tibcosoftware/flogo)  | 1113 |  Flogo是一个面向物联网边缘应用和集成的开源框架。 |![star > 1000][Silver]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4827 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11790 |  Go的结构化日志操作 。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [lumberjack](https://github.com/natefinch/lumberjack)  | 1422 |  简单的滚动日志，io.WriteCloser的实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [spew](https://github.com/davecgh/go-spew)  | 3277 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [stdlog](https://github.com/alexcesaro/log)  | 43 |  Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。 |   ![最近一年没有更新][Yellow]
| [tail](https://github.com/hpcloud/tail)  | 1529 |  努力模拟实现BSD的tail的特性的Go包。 |![star > 1000][Silver]
...
| [zap](https://github.com/uber-go/zap)  | 7344 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]
| [zerolog](https://github.com/rs/zerolog)  | 2174 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bayesian](https://github.com/jbrukh/bayesian)  | 627 |  Go的朴素贝叶斯分类。 |![star > 100][Bronze]
...
| [fonet](https://github.com/Fontinalis/fonet)  | 32 |  一个用Go编写的深度神经网络库。 |   ![最近一年没有更新][Yellow]
...
| [GoLearn](https://github.com/sjwhitworth/golearn)  | 6633 |  通用机器学习库。 |![star > 5000][Gold]   ![包含中文文档][CN]
...
| [Beaver](https://github.com/Clivern/Beaver)  | 716 |  一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。 |![star > 100][Bronze]
| [Benthos](https://github.com/Jeffail/benthos)  | 1982 |  一系列协议之间的消息流桥接。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Bus](https://github.com/mustafaturan/bus)  | 114 |  内部通信的最小消息总线实现。 |![star > 100][Bronze]
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3653 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-socket.io](https://github.com/googollee/go-socket.io)  | 2866 |  go的socket.io库，一个实时应用程序框架。 |![star > 1000][Silver]
...
| [gorush](https://github.com/appleboy/gorush)  | 3681 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3342 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mangos](https://github.com/go-mangos/mangos)  | 1533 |  Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。 |![star > 1000][Silver]
| [melody](https://github.com/olahol/melody)  | 1548 |  处理websocket session的极简框架，包括广播和自动ping/pong处理。 |![star > 1000][Silver]
...
| [NATS Go Client](https://github.com/nats-io/nats)  | 2380 |  轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sarama](https://github.com/Shopify/sarama)  | 4571 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1675 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4397 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3341 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]
...
| [dig](https://github.com/uber-go/dig)  | 891 |  一个基于反射的Go依赖注入工具包。 |![star > 100][Bronze]
| [fx](https://github.com/uber-go/fx)  | 662 |  基于依赖注入的Go应用程序框架(构建在dig之上)。 |![star > 100][Bronze]
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8871 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]
...
| [xstrings](https://github.com/huandu/xstrings)  | 615 |  从其他语言移植的有用字符串函数合集。 |![star > 100][Bronze]
...
| [archiver](https://github.com/mholt/archiver)  | 2473 |  用于生成和解压.zip和.tar.gz文档的库和命令。 |![star > 1000][Silver]
...
| [base64Captcha](https://github.com/mojocn/base64Captcha)  | 620 |  base64Captcha支持数字，字母，算术，音频和混合模式的验证码。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [go-commons-pool](https://github.com/jolestar/go-commons-pool)  | 662 |  Go语言的通用对象池。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [go-openapi](https://github.com/go-openapi)  | - |  用于解析和使用开放api模式(open-api schemas)的包的集合。 |
| [go-resiliency](https://github.com/eapache/go-resiliency)  | 844 |   Go语言弹性模式(resiliency pattern)。 |![star > 100][Bronze]
...
| [gopsutil](https://github.com/shirou/gopsutil)  | 3887 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-pinyin](https://github.com/mozillazg/go-pinyin)  | 518 |  中文汉字到汉语拼音的转换。 |![star > 100][Bronze]
...
| [gojieba](https://github.com/yanyiwu/gojieba)  | 812 |  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [gse](https://github.com/go-ego/gse)  | 1063 |  高效的文本分割;支持英语、汉语、日语等。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [prose](https://github.com/jdkato/prose)  | 2037 |  用于支持标记化、词性标记、名称实体提取等文本处理的库。 |![star > 1000][Silver]
...
| [dns](https://github.com/miekg/dns)  | 3767 |  用于 DNS 的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [ether](https://github.com/songgao/ether)  | 62 |  一个用于发送和接收以太网帧的跨平台 Go 库。 |   ![最近一年没有更新][Yellow]
| [ethernet](https://github.com/mdlayher/ethernet)  | 184 |  实现了对IEEE 802.3以太网II帧和IEEE 802.1Q VLAN标签的编组和解组。 |![star > 100][Bronze]
| [fasthttp](https://github.com/valyala/fasthttp)  | 9226 |  一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [fortio](https://github.com/fortio/fortio)  | 860 |  负载测试库和命令行工具，高级的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。支持Tcp、Http、gRPC。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gobgp](https://github.com/osrg/gobgp)  | 1663 |  基于 Go 的 BGP 实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [golibwireshark](https://github.com/sunwxg/golibwireshark)  | 14 |  用于解码 pcap 文件和分析解剖数据。 |   ![最近一年没有更新][Yellow]
| [gopacket](https://github.com/google/gopacket)  | 2842 |  Go library for packet processing with libpcap bindings. |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [HTTPLab](https://github.com/gchaincl/httplab)  | 3397 |  HTTPLabs 允许你检查 HTTP 请求和伪造响应。 |![star > 1000][Silver]
...
| [kcp-go](https://github.com/xtaci/kcp-go)  | 2232 |  快速可靠的ARQ协议。 |![star > 1000][Silver]
| [kcptun](https://github.com/xtaci/kcptun)  | 10626 |  基于KCP协议的非常简单和快速udp隧道。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2865 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [webrtc](https://github.com/pions/webrtc)  | 2164 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sling](https://github.com/dghubble/sling)  | 985 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]
...
| [go-pg](https://github.com/go-pg/pg)  | 2937 |  用于 PostgreSQL 的ORM。侧重于 PostgreSQL 的特性和性能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder)  | 230 |  一个灵活而强大的SQL字符串构建器库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-store](https://github.com/gosuri/go-store)  | 93 |  简单且快速的 Redis 键值存储库。 |   ![最近一年没有更新][Yellow]
| [GORM](https://github.com/jinzhu/gorm)  | 14499 |  一个出色的 ORM 库。主要目标是对开发人员友好。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [gorp](https://github.com/go-gorp/gorp)  | 3071 |  基于 Go 的关系持久性 ORM-ish 库。 |![star > 1000][Silver]
...
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2245 |  ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]
...
| [Xorm](https://github.com/go-xorm/xorm)  | 5144 |  基于 Go 的简单而强大的ORM。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12522 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]
...
| [govendor](https://github.com/kardianos/govendor)  | 4716 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]
...
| [graphql](https://github.com/neelance/graphql-go)  | 2747 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [graphql-go](https://github.com/graphql-go/graphql)  | 5168 |  为Go实现GraphQL。 |![star > 5000][Gold]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [esc](https://github.com/mjibson/esc)  | 465 |  将文件嵌入到Go程序中并提供http文件系统接口。 |![star > 100][Bronze]
...
| [go.rice](https://github.com/GeertJohan/go.rice)  | 1635 |  go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [packr](https://github.com/gobuffalo/packr)  | 2079 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [statics](https://github.com/go-playground/statics)  | 53 |  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。 |   ![最近一年没有更新][Yellow]
| [statik](https://github.com/rakyll/statik)  | 2075 |  将静态文件嵌入到Go可执行文件中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gonum](https://github.com/gonum/gonum)  | 2916 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gonum/plot](https://github.com/gonum/plot)  | 1205 |  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。 |![star > 1000][Silver]
| [goraph](https://github.com/gyuho/goraph)  | 598 |  纯Go图论库(数据结构，算法可视化)。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gosl](https://github.com/cpmech/gosl)  | 1300 |  提供线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程，等等。 |![star > 1000][Silver]
...
| [acra](https://github.com/cossacklabs/acra)  | 446 |  网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。 |![star > 100][Bronze]
...
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1813 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]
...
| [lego](https://github.com/xenolf/lego)  | 3462 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [memguard](https://github.com/awnumar/memguard)  | 1051 |  一个用于处理内存中敏感值的纯Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [colfer](https://github.com/pascaldekloe/colfer)  | 473 |  为Colfer二进制格式生成代码。 |![star > 100][Bronze]
| [csvutil](https://github.com/jszwec/csvutil)  | 299 |  高性能、惯用的CSV记录编码和解码到本机Go结构。 |![star > 100][Bronze]
...
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2905 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 5018 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5455 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mapstructure](https://github.com/mitchellh/mapstructure)  | 2378 |  用于对原生键值对进行解码生成 Go 语言结构体 |![star > 1000][Silver]
...
| [Caddy](https://github.com/mholt/caddy)  | 22992 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [etcd](https://github.com/coreos/etcd)  | 26231 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Fider](https://github.com/getfider/fider)  | 787 |  Fider是一个收集和组织客户反馈的开放平台。 |![star > 100][Bronze]
| [Flagr](https://github.com/checkr/flagr)  | 814 |  Flagr是一个开源特性标记和A/B测试服务。 |![star > 100][Bronze]
...
| [minio](https://github.com/minio/minio)  | 17146 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3222 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]
...
| [gofpdf](https://github.com/jung-kurt/gofpdf)  | 3055 |  PDF 文档生成器，支持文本，绘图和图片 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [jet](https://github.com/CloudyKit/jet)  | 580 |  Jet模板引擎。 |![star > 100][Bronze]
...
| [quicktemplate](https://github.com/valyala/quicktemplate)  | 1392 |  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译 |![star > 1000][Silver]
| [raymond](https://github.com/aymerick/raymond)  | 337 |  使用 Go 语言实现的完整的 handlebars |![star > 100][Bronze]
| [Razor](https://github.com/sipin/gorazor)  | 695 |  Go 语言的 Razor 视图引擎 |![star > 100][Bronze]
...
| [go-cmp](https://github.com/google/go-cmp)  | 1130 |  用于比较测试中的Go值的包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [httpexpect](https://github.com/gavv/httpexpect)  | 1136 |  简洁的、声明式的、易用的端到端HTTP 及 REST API 测试 |![star > 1000][Silver]
...
| [Testify](https://github.com/stretchr/testify)  | 8022 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1704 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]
...
| [gomock](https://github.com/golang/mock)  | 2790 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [minimock](https://github.com/gojuno/minimock)  | 251 |  Go接口的模拟生成器。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-fuzz](https://github.com/dvyukov/go-fuzz)  | 2861 |  随机测试系统。 |![star > 1000][Silver]
...
| [chromedp](https://github.com/knq/chromedp)  | 3502 |  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品 |![star > 1000][Silver]
...
| [selenoid](https://github.com/aerokube/selenoid)  | 1211 |  Selenium hub 服务器的替代品，在容器中启动浏览器 |![star > 1000][Silver]

* Fail injection
        
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [failpoint](https://github.com/pingcap/failpoint)  | 380 |  为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。 |![star > 100][Bronze]
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3860 |  Markdown 解析器 |![star > 1000][Silver]
| [bluemonday](https://github.com/microcosm-cc/bluemonday)  | 1231 |  HTML 清理工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [codetree](https://github.com/aerogo/codetree)  | 7 |  解析缩进代码(python、pixy、scarlet等)并返回树结构。 |
| [colly](https://github.com/asciimoo/colly)  | 8259 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-humanize](https://github.com/dustin/go-humanize)  | 1880 |  格式化程序，用于将时间、数字和内存大小转换为可读格式。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gofeed](https://github.com/mmcdole/gofeed)  | 1091 |  在Go中解析RSS和Atom feeds。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [htmlquery](https://github.com/antchfx/htmlquery)  | 126 |  用于HTML的XPath查询包，允许您通过XPath表达式从HTML文档中提取数据或求值。 |![star > 100][Bronze]
...
| [sh](https://github.com/mvdan/sh)  | 1965 |  Shell解析器和格式化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [toml](https://github.com/BurntSushi/toml)  | 2754 |  TOML配置格式(带反射的编码器/解码器)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
* Utility
...
| [xurls](https://github.com/mvdan/xurls)  | 458 |  从文本中提取url。 |![star > 100][Bronze]
...
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 4995 |  AWS 提供的官方go语言 SDK |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [github](https://github.com/google/go-github)  | 4731 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [githubql](https://github.com/shurcooL/githubql)  | 498 |  访问GitHub GraphQL API v4的库。 |![star > 100][Bronze]
...
| [go-jira](https://github.com/andygrunwald/go-jira)  | 566 |   Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang)  | 1762 |  谷歌云api Go 客户端库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [clockwork](https://github.com/jonboulle/clockwork)  | 220 |  一个简单的假 clock 。 |![star > 100][Bronze]
...
| [ctop](https://github.com/bcicen/ctop)  | 8761 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]
...
| [delve](https://github.com/derekparker/delve)  | 11898 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [fzf](https://github.com/junegunn/fzf)  | 22912 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-torch](https://github.com/uber/go-torch)  | 3630 |  为 Go 语言程序生成火焰图。 |![star > 1000][Silver]
...
| [godropbox](https://github.com/dropbox/godropbox)  | 3739 |  用于编写 Go 语言服务／应用的库，来自 Dropbox.。 |![star > 1000][Silver]
...
| [goreporter](https://github.com/wgliang/goreporter)  | 2479 |  进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具 |![star > 1000][Silver]
...
| [gpath](https://github.com/tenntenn/gpath)  | 28 |   用于简化结构体域访问的库。 |   ![最近一年没有更新][Yellow]
...
| [hub](https://github.com/github/hub)  | 16843 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hystrix-go](https://github.com/afex/hystrix-go)  | 1991 |  实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。 |![star > 1000][Silver]
...
| [mc](https://github.com/minio/mc)  | 1093 |  Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mergo](https://github.com/imdario/mergo)  | 841 |  用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [minify](https://github.com/tdewolff/minify)  | 1851 |  用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [panicparse](https://github.com/maruel/panicparse)  | 2134 |  将类似的协程分组并对调用栈进行着色 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [peco](https://github.com/peco/peco)  | 5434 |  简单的交互过滤工具。 |![star > 5000][Gold]
...
| [resty](https://github.com/go-resty/resty)  | 1926 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]
| [retry](https://github.com/kamilsk/retry)  | 151 |  基于上下文的功能机制，反复执行命令直到成功。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [sqlx](https://github.com/jmoiron/sqlx)  | 6710 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [sslice](https://github.com/yaa110/sslice)  | 4 |  创建一个总是排序的切片。 |
| [Storm](https://github.com/asdine/storm)  | 1344 |  一个简单又强大的用于 BoltDB 的工具 |![star > 1000][Silver]
| [structs](https://github.com/PumpkinSeed/structs)  | 12 |  简单来讲就是 "Make" 的替代品。 |   ![最近一年没有更新][Yellow]
| [Task](https://github.com/go-task/task)  | 1891 |  简单的“Go”的选择。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [toolbox](https://github.com/viant/toolbox)  | 91 |  切片, map, multimap, 结构体, 函数,数据转换工具。服务路由，宏求值和标记器。 |   ![最近一个周有更新][Green]
...
| [ulid](https://github.com/oklog/ulid)  | 1664 |  实现了ULID(普遍唯一的词典分类标识符)。 |![star > 1000][Silver]
...
| [wuid](https://github.com/edwingeng/wuid)  | 282 |  一个非常快的唯一数字生成器，比UUID快10-135倍。 |![star > 100][Bronze]
...
| [govalidator](https://github.com/asaskevich/govalidator)  | 3522 |  用于字符串，数字，切片和结构的验证器和sanitizers。 |![star > 1000][Silver]
| [govalidator](https://github.com/thedevsaddam/govalidator)  | 710 |  用简单的规则验证Golang请求数据。深受Laravel请求验证的启发。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [validate](https://github.com/gookit/validate)  | 92 |   Go 封装数据验证和过滤。支持验证映射、结构、请求(表单、JSON、url)。值，上载文件)数据和更多特性。 |   ![包含中文文档][CN]
| [validate](https://github.com/gobuffalo/validate)  | 19 |  这个包提供了一个框架，用于为Go应用程序编写验证。 |
| [validator](https://github.com/go-playground/validator)  | 3448 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-git](https://github.com/src-d/go-git)  | 4168 |  纯Go中高度可扩展的Git实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Beego](https://github.com/astaxie/beego)  | 21330 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14564 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Gin](https://github.com/gin-gonic/gin)  | 29455 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2833 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]
...
| [Goa](https://github.com/goadesign/goa)  | 3493 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Revel](https://github.com/revel/revel)  | 11220 |  用于Go语言的高效web框架。 |![star > 5000][Gold]
...
| [CORS](https://github.com/rs/cors)  | 1206 |  轻松地向API添加CORS功能。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [alice](https://github.com/justinas/alice)  | 1821 |  用于连接中间件的库，简单无痛苦。 |![star > 1000][Silver]
...
| [chi](https://github.com/go-chi/chi)  | 5981 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9631 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]
...
| [mux](https://github.com/gorilla/mux)  | 9581 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-ole](https://github.com/go-ole/go-ole)  | 549 |  为 Go 语言实现的 Win32 OLE。 |![star > 100][Bronze]
...
| [xpath](https://github.com/antchfx/xpath)  | 160 |  Go的XPath包。 |![star > 100][Bronze]
| [xquery](https://github.com/antchfx/xquery)  | 145 |  XQuery允许您使用XPath表达式从HTML/XML文档中提取数据。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [zek](https://github.com/miku/zek)  | 251 |  从XML生成Go结构。 |![star > 100][Bronze]
...
| [go-critic](https://github.com/go-critic/go-critic)  | 569 |  源代码检查工具。 |![star > 100][Bronze]
...
| [GoLint](https://github.com/golang/lint)  | 3132 |  Go 源码的 linter。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [php-parser](https://github.com/z7zmey/php-parser)  | 630 |  用 Go 编写的 PHP 解析器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gocode](https://github.com/nsf/gocode)  | 4729 |  Autocompletion daemon for the Go programming language. |![star > 1000][Silver]
...
| [vim-go](https://github.com/fatih/vim-go)  | 10769 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5086 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]
...
| [genny](https://github.com/cheekybits/genny)  | 943 |  优雅的 Go 泛型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gotests](https://github.com/cweill/gotests)  | 2168 |  从源代码生成测试用例。 |![star > 1000][Silver]
...
| [go-callvis](https://github.com/TrueFurby/go-callvis)  | 1975 |  使用 dot format 可视化 Go 程序的调用图。 |![star > 1000][Silver]
| [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete)  | 37 |  Bash completion for go and wgo。 |   ![最近一年没有更新][Yellow]
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3920 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [godbg](https://github.com/tylerwince/godbg)  | 156 |  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。 |![star > 100][Bronze]
| [OctoLinker](https://github.com/OctoLinker/browser-extension)  | 3730 |  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [bombardier](https://github.com/codesenberg/bombardier)  | 1721 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]
...
| [fac](https://github.com/mkchoi212/fac)  | 1609 |  修复 git 合并冲突。 |![star > 1000][Silver]
| [gaia](https://github.com/gaia-pipeline/gaia)  | 3731 |  可用于任何编程语言来构建强大的管道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Gitea](https://github.com/go-gitea/gitea)  | 14955 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [govvv](https://github.com/ahmetalpbalkan/govvv)  | 382 |  可轻松地添加版本信息到 Go 二进制文件。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gox](https://github.com/mitchellh/gox)  | 3341 |  非常简单，没有多余的跨平台编译工具。 |![star > 1000][Silver]
...
| [Hey](https://github.com/rakyll/hey)  | 6216 |  压力测试工具，可用来代替 ApacheBench (ab)。 |![star > 5000][Gold]
...
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55771 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Moby](https://github.com/moby/moby)  | 54268 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Packer](https://github.com/mitchellh/packer)  | 9193 |  用于从一个源配置为多个平台创建相同的机器图像。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Pewpew](https://github.com/bengadbois/pewpew)  | 201 |  灵活的 HTTP 命令行压测工具。 |![star > 100][Bronze]
| [Pomerium](https://github.com/pomerium/pomerium)  | 491 |  Pomerium是一个可识别身份的访问代理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [StatusOK](https://github.com/sanathp/statusok)  | 1157 |  监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。 |![star > 1000][Silver]
| [traefik](https://github.com/containous/traefik)  | 23550 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 12056 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [webhook](https://github.com/adnanh/webhook)  | 4057 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]
...
| [Comcast](https://github.com/tylertreat/Comcast)  | 6165 |  模拟坏的网络连接。 |![star > 5000][Gold]
| [confd](https://github.com/kelseyhightower/confd)  | 6394 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]
| [DDNS](https://github.com/skibish/ddns)  | 97 |  个人 DDNS 客户端。 |
| [Docker](http://www.docker.com/)  | - |  面向开发人员和系统管理员的分布式应用程序的开放平台。 |
| [Documize](https://github.com/documize/community)  | 814 |  集成了SaaS工具数据的现代wiki软件。 |![star > 100][Bronze]
| [drive](https://github.com/odeke-em/drive)  | 4942 |  基于命令行的谷歌驱动器客户端。 |![star > 1000][Silver]
...
| [Gor](https://github.com/buger/gor)  | 11298 |  Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。 |![star > 5000][Gold]
...
| [lgo](https://github.com/yunabe/lgo)  | 1794 |  与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。 |![star > 1000][Silver]
| [limetext](http://limetext.org/)  | - |  一个强大而优雅的文本编辑器。 |
| [LiteIDE](https://github.com/visualfc/liteide)  | 5453 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [nes](https://github.com/fogleman/nes)  | 4124 |  任天堂娱乐系统(NES)模拟器。 |![star > 1000][Silver]
...
| [Pipe](https://github.com/b3log/pipe)  | 2840 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [restic](https://github.com/restic/restic)  | 7380 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [rkt](https://github.com/coreos/rkt)  | 8736 |  一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。 |![star > 5000][Gold]
| [scc](https://github.com/boyter/scc)  | 766 |  一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Seaweed File System](https://github.com/chrislusf/seaweedfs)  | 8156 |  快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Stack Up](https://github.com/pressly/sup)  | 1986 |  Stack Up 是一个超级简单的部署工具 — 只面向Unix。 |![star > 1000][Silver]
| [syncthing](https://syncthing.net/)  | - |  开放，分散的文件同步工具和协议。 |
| [term-quiz](https://github.com/crazcalm/term-quiz)  | 17 |  测试你的终端。 |
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3914 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks)  | 858 |  Go序列化方法的基准测试。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
