...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-22 09:40:06(每隔1天同步一次)**
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [authboss](https://github.com/volatiletech/authboss)  | 1914 |  web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [branca](https://github.com/hako/branca)  | 76 |  基于 Go 实现Branca令牌。 |
| [casbin](https://github.com/hsluoyz/casbin)  | 4839 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goth](https://github.com/markbates/goth)  | 2237 |  提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。 |![star > 1000][Silver]   
...
| [jwt](https://github.com/pascaldekloe/jwt)  | 82 |  轻量级JSON Web令牌库。 |
| [jwt-auth](https://github.com/adam-hanna/jwt-auth)  | 151 |  JWT中间件，可用于Golang http服务器，提供了许多配置选项。 |![star > 100][Bronze]   
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5853 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]   
| [loginsrv](https://github.com/tarent/loginsrv)  | 802 |  JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [paseto](https://github.com/o1egl/paseto)  | 235 |  平台无关的安全令牌(PASETO)。 |![star > 100][Bronze]   
...
| [scs](https://github.com/alexedwards/scs)  | 520 |  HTTP服务器的会话管理器。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-chat-bot](https://github.com/go-chat-bot/bot)  | 463 |  用 Go 编写的IRC, Slack和电报机器人。 |![star > 100][Bronze]   
...
| [cobra](https://github.com/spf13/cobra)  | 13038 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [kingpin](https://github.com/alecthomas/kingpin)  | 2511 |  支持子命令的命令行和标志解析器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [urfave/cli](https://github.com/urfave/cli)  | 11222 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [aurora](https://github.com/logrusorgru/aurora)  | 618 |  支持fmt.Printf/Sprintf的ANSI终端颜色。 |![star > 100][Bronze]   
...
| [color](https://github.com/fatih/color)  | 3000 |  多功能包装，彩色终端输出。 |![star > 1000][Silver]   
...
| [go-prompt](https://github.com/c-bata/go-prompt)  | 2291 |  构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) |![star > 1000][Silver]   
| [gocui](https://github.com/jroimartin/gocui)  | 5225 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   
...
| [mpb](https://github.com/vbauerster/mpb)  | 507 |  可在终端显示多进度条。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [termui](https://github.com/gizak/termui)  | 8849 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [goConfig](https://github.com/crgimenes/goConfig)  | 105 |  将结构体解析为输入，并用来自命令行、环境变量和配置文件的参数填充该结构体的字段。 |![star > 100][Bronze]   
...
| [ini](https://github.com/go-ini/ini)  | 1564 |   读和写INI文件。 |![star > 1000][Silver]   
...
| [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig)  | 2380 |  管理来自环境变量的配置数据。 |![star > 1000][Silver]   
...
| [viper](https://github.com/spf13/viper)  | 9170 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18848 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [boomfilters](https://github.com/tylertreat/BoomFilters)  | 1129 |  用于处理连续的概率数据结构。 |![star > 1000][Silver]   
...
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5098 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]   
...
| [gods](https://github.com/emirpasic/gods)  | 6192 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]   
...
| [hyperloglog](https://github.com/axiomhq/hyperloglog)  | 658 |  HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |![star > 100][Bronze]   
...
| [roaring](https://github.com/RoaringBitmap/roaring)  | 648 |  实现了压缩 bitsets 的Go包。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6193 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [bcache](https://github.com/iwanbk/bcache)  | 27 |  基于内存的最终一致的分布式缓存。 |
| [BigCache](https://github.com/allegro/bigcache)  | 2419 |  高效的键/值缓存为千兆字节的数据。 |![star > 1000][Silver]   
| [bolt](https://github.com/boltdb/bolt)  | 9917 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
| [cache2go](https://github.com/muesli/cache2go)  | 995 |  基于内存的 K/V 缓存，支持超时的自动失效。 |![star > 100][Bronze]   
| [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache)  | 29 |  BigCache 支持集群和独立且生命周期存储项。 |![最近一年没有更新][Yellow]
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16689 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10054 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [GCache](https://github.com/bluele/gcache)  | 879 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]   
| [go-cache](https://github.com/pmylund/go-cache)  | 2845 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]   
...
| [influxdb](https://github.com/influxdb/influxdb)  | 16869 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [ledisdb](https://github.com/siddontang/ledisdb)  | 3058 |  Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。 |![star > 1000][Silver]   
...
| [nutsdb](https://github.com/xujiajun/nutsdb)  | 851 |  Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [piladb](https://github.com/fern4lvarez/piladb)  | 171 |  基于堆栈数据结构的轻量级RESTful数据库引擎。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [prometheus](https://github.com/prometheus/prometheus)  | 25242 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 218 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]   
| [rqlite](https://github.com/rqlite/rqlite)  | 4666 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tidb](https://github.com/pingcap/tidb)  | 19795 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 955 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gormigrate](https://github.com/go-gormigrate/gormigrate)  | 326 |  面向Gorm ORM的数据库 schema 迁移辅助程序。 |![star > 100][Bronze]   
| [migrate](https://github.com/golang-migrate/migrate)  | 2533 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-mysql](https://github.com/siddontang/go-mysql)  | 1849 |   Go 工具集，用于处理MySQL协议和复制。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2351 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]   
...
| [orchestrator](https://github.com/github/orchestrator)  | 3000 |  MySQL复制拓扑管理器和可视化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pgweb](https://github.com/sosedoff/pgweb)  | 5957 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]   
...
| [vitess](https://github.com/youtube/vitess)  | 8359 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gendry](https://github.com/didi/gendry)  | 742 |  非入侵的SQL构建器和强大的数据绑定器。 |![star > 100][Bronze]   
| [godbal](https://github.com/xujiajun/godbal)  | 50 |  数据库抽象层(dbal)。支持SQL builder，轻松获取结果。 |
| [goqu](https://github.com/doug-martin/goqu)  | 623 |  常用的SQL生成器和查询库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2239 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]   
| [xo](https://github.com/knq/xo)  | 2161 |  基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。 |![star > 1000][Silver]   
...
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 8006 |  MySQL驱动程序。 |![star > 5000][Gold]   
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3402 |  SQLite3驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pgx](https://github.com/jackc/pgx)  | 1881 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pq](https://github.com/lib/pq)  | 5133 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 3001 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6215 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   
| [redis](https://github.com/go-redis/redis)  | 6366 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5786 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4068 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch)  | 1517 |  官方 Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goes](https://github.com/OwnLocal/goes)  | 24 |  实现了与 Elasticsearch 交互的库。 |![最近一年没有更新][Yellow]
| [riot](https://github.com/go-ego/riot)  | 4661 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   
...
| [cayley](https://github.com/google/cayley)  | 12646 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dateparse](https://github.com/araddon/dateparse)  | 884 |  可以解析很多格式不固定的日期字符串。 |![star > 100][Bronze]   
...
| [now](https://github.com/jinzhu/now)  | 2157 |  now 是时间有关的工具类。 |![star > 1000][Silver]   
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2489 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gleam](https://github.com/chrislusf/gleam)  | 2061 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]   
| [glow](https://github.com/chrislusf/glow)  | 2508 |  全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。 |![star > 1000][Silver]   
...
| [go-kit](https://github.com/go-kit/kit)  | 14273 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]   
| [gorpc](https://github.com/valyala/gorpc)  | 548 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8947 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 997 |  支持25+种语言RPC库。 |![star > 100][Bronze]   
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8527 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1716 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   
| [micro](https://github.com/micro/micro)  | 6501 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   
| [NATS](https://github.com/nats-io/gnatsd)  | 6224 |  轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [raft](https://github.com/hashicorp/raft)  | 2810 |  Raft consensus协议的实现。 by HashiCorp。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [rpcx](https://github.com/smallnest/rpcx)  | 3717 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [torrent](https://github.com/anacrolix/torrent)  | 2817 |  BitTorrent 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-imap](https://github.com/emersion/go-imap)  | 721 |  用于客户端和服务器的IMAP库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [MailHog](https://github.com/mailhog/MailHog)  | 5102 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]   
...
| [anko](https://github.com/mattn/anko)  | 916 |  用Go编写的解释器。 |![star > 100][Bronze]   
...
| [go-python](https://github.com/sbinet/go-python)  | 902 |  CPython C-API 的 Go 接口。 |![star > 100][Bronze]   
| [golua](https://github.com/aarzilli/golua)  | 441 |  Lua C 的 Go 接口。 |![star > 100][Bronze]   
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2928 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]   
...
| [otto](https://github.com/robertkrimen/otto)  | 4701 |  用 Go 编写的 JavaScript 解释器。 |![star > 1000][Silver]   
| [purl](https://github.com/ian-kent/purl)  | 27 |  嵌入 Go 的 Perl 5.18.2。 |![最近一年没有更新][Yellow]
| [tengo](https://github.com/d5/tengo)  | 1280 |  字节码编译的脚本语言。 |![star > 1000][Silver]   
...
| [errors](https://github.com/pkg/errors)  | 4794 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2194 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [decimal](https://github.com/shopspring/decimal)  | 1575 |  任意精度定点的十进制数。 |![star > 1000][Silver]   
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1822 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-sdl2](https://github.com/veandco/go-sdl2)  | 1145 |  实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1157 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   
| [Leaf](https://github.com/name5566/leaf)  | 3029 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   
| [nano](https://github.com/lonng/nano)  | 972 |  轻量级、方便、高性能的基于golang的游戏服务器框架。 |![star > 100][Bronze]   
...
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8491 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1812 |  一个高性能的协程池。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [breaker](https://github.com/kamilsk/breaker)  | 28 |  灵活的机制，可以使执行流可中断。 |![最近一个周有更新][Green]
...
| [goworker](https://github.com/benmanns/goworker)  | 2231 |  基于 go 的后台 worker。 |![star > 1000][Silver]   
...
| [tunny](https://github.com/Jeffail/tunny)  | 1324 |  golang 的协程池。 |![star > 1000][Silver]   
| [worker-pool](https://github.com/vardius/worker-pool)  | 43 |  一个简单的 Go 异步工作池。 |![最近一个周有更新][Green]
| [workerpool](https://github.com/gammazero/workerpool)  | 129 |  限制任务执行并发数，而不是队列中的任务数量的协程池，。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [app](https://github.com/murlokswarm/app)  | 2938 |  用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。 |![star > 1000][Silver]   
| [fyne](https://github.com/fyne-io/fyne)  | 6155 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [go-astilectron](https://github.com/asticode/go-astilectron)  | 2631 |  使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。 |![star > 1000][Silver]   
...
| [qt](https://github.com/therecipe/qt)  | 5947 |  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [ui](https://github.com/andlabs/ui)  | 6892 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]   
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3664 |  Windows应用程序库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [webview](https://github.com/zserge/webview)  | 4582 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]   
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4389 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gocv](https://github.com/hybridgroup/gocv)  | 2406 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [imagick](https://github.com/gographics/imagick)  | 965 |   ImageMagick下MagickWand的C API的Go binding。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [imaginary](https://github.com/h2non/imaginary)  | 2576 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]   
| [imaging](https://github.com/disintegration/imaging)  | 2487 |  简单的Go图像处理包。 |![star > 1000][Silver]   
...
| [picfit](https://github.com/thoas/picfit)  | 1057 |  Go实现的图像调整服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [svgo](https://github.com/ajstarks/svgo)  | 1324 |   Go实现的SVG生成库。 |![star > 1000][Silver]   
...
| [flogo](https://github.com/tibcosoftware/flogo)  | 1110 |  Flogo是一个面向物联网边缘应用和集成的开源框架。 |![star > 1000][Silver]   
...
| [mainflux](https://github.com/Mainflux/mainflux)  | 576 |  工业物联网消息和设备管理服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4807 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [glg](https://github.com/kpango/glg)  | 51 |  glg是一个简单而快速的Go日志库。 |![最近一个周有更新][Green]
| [glo](https://github.com/lajosbencz/glo)  | 8 |  参照PHP的Monolog实现的具有相同日志等级的Go日志库。 |
| [glog](https://github.com/golang/glog)  | 2292 |  为Go提供了多等级日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11742 |  Go的结构化日志操作 。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [lumberjack](https://github.com/natefinch/lumberjack)  | 1417 |  简单的滚动日志，io.WriteCloser的实现。 |![star > 1000][Silver]   
...
| [spew](https://github.com/davecgh/go-spew)  | 3268 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [zap](https://github.com/uber-go/zap)  | 7316 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]   
| [zerolog](https://github.com/rs/zerolog)  | 2151 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GoLearn](https://github.com/sjwhitworth/golearn)  | 6626 |  通用机器学习库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gorgonia](https://github.com/chewxy/gorgonia)  | 2663 |  基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gorse](https://github.com/zhenghaoz/gorse)  | 520 |  基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [APNs2](https://github.com/sideshow/apns2)  | 2035 |  HTTP / 2苹果消息推送provider——发送推送消息到iOS, tvOS, Safari和OSX应用。 |![star > 1000][Silver]   
| [Beaver](https://github.com/Clivern/Beaver)  | 713 |  一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。 |![star > 100][Bronze]   
| [Benthos](https://github.com/Jeffail/benthos)  | 1933 |  一系列协议之间的消息流桥接。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Bus](https://github.com/mustafaturan/bus)  | 114 |  内部通信的最小消息总线实现。 |![star > 100][Bronze]   
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3642 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Gollum](https://github.com/trivago/gollum)  | 766 |  一个n:m多路复用器(n:m multiplexer)，收集不同来源的消息并将其广播到一组目的地。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gorush](https://github.com/appleboy/gorush)  | 3673 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3334 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Mercure](https://github.com/dunglas/mercure)  | 1468 |  使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [NATS Go Client](https://github.com/nats-io/nats)  | 2370 |  轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。 |![star > 1000][Silver]   
...
| [sarama](https://github.com/Shopify/sarama)  | 4552 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1665 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4377 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3327 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]   
...
| [dig](https://github.com/uber-go/dig)  | 884 |  一个基于反射的Go依赖注入工具包。 |![star > 100][Bronze]   
...
| [inject](https://github.com/defval/inject)  | 22 |  一个基于反射的依赖注入容器，具有简单的接口。 |![最近一个周有更新][Green]
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8774 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [archiver](https://github.com/mholt/archiver)  | 2469 |  用于生成和提取.zip和.tar.gz存档的库和命令。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [base64Captcha](https://github.com/mojocn/base64Captcha)  | 616 |  Base64captch支持数字，数字，字母，算术，音频和数字-字母验证码。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gofakeit](https://github.com/brianvoe/gofakeit)  | 410 |  用go编写的随机数据生成器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [fasthttp](https://github.com/valyala/fasthttp)  | 9206 |  一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [fortio](https://github.com/fortio/fortio)  | 854 |  负载测试库和命令行工具，高级的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。支持Tcp、Http、gRPC。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gmqtt](https://github.com/DrmagicE/gmqtt)  | 67 |  Gmqtt是一个灵活、高性能的MQTT代理库，它完全实现了MQTT协议V3.1.1。 |
...
| [gobgp](https://github.com/osrg/gobgp)  | 1660 |  基于 Go 的 BGP 实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [golibwireshark](https://github.com/sunwxg/golibwireshark)  | 14 |  用于解码 pcap 文件和分析解剖数据。 |![最近一年没有更新][Yellow]
| [gopacket](https://github.com/google/gopacket)  | 2832 |  Go library for packet processing with libpcap bindings. |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [grab](https://github.com/cavaliercoder/grab)  | 544 |   用于管理文件下载。 |![star > 100][Bronze]   
...
| [kcptun](https://github.com/xtaci/kcptun)  | 10613 |  基于KCP协议的非常简单和快速udp隧道。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mdns](https://github.com/hashicorp/mdns)  | 545 |  简单mDNS(Multicast DNS)客户端/服务器库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2854 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [raw](https://github.com/mdlayher/raw)  | 302 |  Package raw支持在设备驱动程序级别读取和写入网络接口的数据。 |![star > 100][Bronze]   
| [sftp](https://github.com/pkg/sftp)  | 722 |  Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |![star > 100][Bronze]   
| [ssh](https://github.com/gliderlabs/ssh)  | 1097 |  用于构建SSH服务器的高级API(封装密码/ SSH)。 |![star > 1000][Silver]   
...
| [webrtc](https://github.com/pions/webrtc)  | 2151 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [heimdall](https://github.com/gojektech/heimdall)  | 1063 |  具有重试和hystrix功能的增强http客户机。 |![star > 1000][Silver]   
...
| [sling](https://github.com/dghubble/sling)  | 976 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]   
...
| [mathgl](https://github.com/go-gl/mathgl)  | 290 |  完全基于 Go 实现的数学软件包，专门用于处理三维数学。借鉴于 GLM。 |![star > 100][Bronze]   
...
| [go-pg](https://github.com/go-pg/pg)  | 2927 |  用于 PostgreSQL 的ORM。侧重于 PostgreSQL 的特性和性能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GORM](https://github.com/jinzhu/gorm)  | 14428 |  一个出色的 ORM 库。主要目标是对开发人员友好。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [pop/soda](https://github.com/gobuffalo/pop)  | 671 |  数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2239 |  ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [upper.io/db](https://github.com/upper/db)  | 1836 |  对外提供统一的接口用于访问不同的存储介质，例如PostgreSQL, MySQL, SQLite, MSSQL, QL、MongoDB.。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Xorm](https://github.com/go-xorm/xorm)  | 5111 |  基于 Go 的简单而强大的ORM。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12505 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]   
...
| [gopm](https://github.com/gpmgo/gopm)  | 2344 |  包管理器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [graphql](https://github.com/neelance/graphql-go)  | 2737 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [graphql-go](https://github.com/graphql-go/graphql)  | 5140 |  为Go实现GraphQL。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gonum](https://github.com/gonum/gonum)  | 2899 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gonum/plot](https://github.com/gonum/plot)  | 1199 |  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。 |![star > 1000][Silver]   
...
| [stats](https://github.com/montanaflynn/stats)  | 1333 |  包含Golang标准库中缺少的公共函数的统计软件包。 |![star > 1000][Silver]   
...
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1809 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]   
...
| [lego](https://github.com/xenolf/lego)  | 3454 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [memguard](https://github.com/awnumar/memguard)  | 1033 |  一个用于处理内存中敏感值的纯Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [secure](https://github.com/unrolled/secure)  | 1193 |  Go 语言 HTTP 中间件，为 Go 提供了一些安全功能 |![star > 1000][Silver]   
...
| [go-codec](https://github.com/ugorji/go)  | 1225 |  高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2892 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 4999 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5399 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algernon](https://github.com/xyproto/algernon)  | 1581 |  内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。 |![star > 1000][Silver]   
| [Caddy](https://github.com/mholt/caddy)  | 22940 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [consul](https://www.consul.io/)  | - |  Consul 是一个用于服务发现、监控和配置的工具 |
| [devd](https://github.com/cortesi/devd)  | 2796 |  为开发人员提供本地web服务器。 |![star > 1000][Silver]   
| [discovery](https://github.com/Bilibili/discovery)  | 662 |  用于弹性中间层负载平衡和故障转移的注册表。 |![star > 100][Bronze]   
| [etcd](https://github.com/coreos/etcd)  | 26146 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [minio](https://github.com/minio/minio)  | 17075 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [hero](https://github.com/shiyanhui/hero)  | 1197 |  Hero是一个方便、快速和强大的go模板引擎。 |![star > 1000][Silver]   
...
| [go-cmp](https://github.com/google/go-cmp)  | 1123 |  用于比较测试中的Go值的包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goblin](https://github.com/franela/goblin)  | 613 |  类似Mocha的测试框架。 |![star > 100][Bronze]   
...
| [Testify](https://github.com/stretchr/testify)  | 7985 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1688 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]   
| [go-txdb](https://github.com/DATA-DOG/go-txdb)  | 157 |  基于单事务的数据库驱动，主要用于测试目的 |![star > 100][Bronze]   
| [gock](https://github.com/h2non/gock)  | 799 |  多功能、易用 HTTP mock |![star > 100][Bronze]   
| [gomock](https://github.com/golang/mock)  | 2771 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [govcr](https://github.com/seborama/govcr)  | 81 |  HTTP mock : 离线测试时记录和重放浏览器的动作 |![最近一个周有更新][Green]
| [hoverfly](https://github.com/SpectoLabs/hoverfly)  | 1428 |  使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [httpmock](https://github.com/jarcoal/httpmock)  | 571 |  轻松模拟来自外部资源的HTTP响应。 |![star > 100][Bronze]   
| [minimock](https://github.com/gojuno/minimock)  | 237 |  Go接口的模拟生成器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [chromedp](https://github.com/knq/chromedp)  | 3485 |  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [failpoint](https://github.com/pingcap/failpoint)  | 377 |  为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。 |![star > 100][Bronze]   
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3852 |  Markdown 解析器 |![star > 1000][Silver]   
...
| [colly](https://github.com/asciimoo/colly)  | 8227 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   
...
| [go-humanize](https://github.com/dustin/go-humanize)  | 1873 |  格式化程序，用于将时间、数字和内存大小转换为可读格式。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7498 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]   
...
| [sh](https://github.com/mvdan/sh)  | 1942 |  Shell解析器和格式化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [slug](https://github.com/gosimple/slug)  | 366 |  URL 友好的 slug 化工具，支持多种语言 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 4985 |  AWS 提供的官方go语言 SDK |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [discordgo](https://github.com/bwmarrin/discordgo)  | 958 |   Discord Chat API的客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ethrpc](https://github.com/onrik/ethrpc)  | 163 |   Ethereum JSON RPC API的客户端。 |![star > 100][Bronze]   
| [facebook](https://github.com/huandu/facebook)  | 764 |  支持 Facebook Graph API 的库 |![star > 100][Bronze]   
...
| [github](https://github.com/google/go-github)  | 4724 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-jira](https://github.com/andygrunwald/go-jira)  | 564 |   Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库 |![star > 100][Bronze]   
...
| [slack](https://github.com/nlopes/slack)  | 2386 |  Slack API。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [delve](https://github.com/derekparker/delve)  | 11865 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [fzf](https://github.com/junegunn/fzf)  | 22836 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-funk](https://github.com/thoas/go-funk)  | 1145 |  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...) |![star > 1000][Silver]   
...
| [goreleaser](https://github.com/goreleaser/goreleaser)  | 4459 |  尽可能快速的发布 Go 语言二进制文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [hub](https://github.com/github/hub)  | 16814 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mergo](https://github.com/imdario/mergo)  | 833 |  用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。 |![star > 100][Bronze]   
...
| [panicparse](https://github.com/maruel/panicparse)  | 2121 |  将类似的协程分组并对调用栈进行着色 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [peco](https://github.com/peco/peco)  | 5423 |  简单的交互过滤工具。 |![star > 5000][Gold]   
...
| [realize](https://github.com/tockins/realize)  | 3125 |  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。 |![star > 1000][Silver]   
...
| [resty](https://github.com/go-resty/resty)  | 1901 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [spinner](https://github.com/briandowns/spinner)  | 776 |   一个 Go 语言软件包，提供多种选项，方便在终端中创建加载动画。 |![star > 100][Bronze]   
| [sqlx](https://github.com/jmoiron/sqlx)  | 6689 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Task](https://github.com/go-task/task)  | 1879 |  简单的“Go”的选择。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [usql](https://github.com/knq/usql)  | 4657 |  usql 是一个通用的命令行接口，用于操作 sql 数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [ulid](https://github.com/oklog/ulid)  | 1661 |  实现了ULID(普遍唯一的词典分类标识符)。 |![star > 1000][Silver]   
...
| [wuid](https://github.com/edwingeng/wuid)  | 280 |  一个非常快的唯一数字生成器，比UUID快10-135倍。 |![star > 100][Bronze]   
...
| [validator](https://github.com/go-playground/validator)  | 3424 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-git](https://github.com/src-d/go-git)  | 4161 |  纯Go中高度可扩展的Git实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goav](https://github.com/giorgisio/goav)  | 767 |  FFmpeg的Comphrensive。 |![star > 100][Bronze]   
...
| [Aero](https://github.com/aerogo/aero)  | 154 |  高性能的Go web框架，在Lighthouse中达到最高分。 |![star > 100][Bronze]   
...
| [Beego](https://github.com/astaxie/beego)  | 21260 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14521 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Gin](https://github.com/gin-gonic/gin)  | 29342 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2828 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Goa](https://github.com/goadesign/goa)  | 3484 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Macaron](https://github.com/go-macaron/macaron)  | 2796 |  Macaron 是一个高效的模块化设计的web框架 |![star > 1000][Silver]   
...
| [Revel](https://github.com/revel/revel)  | 11213 |  用于Go语言的高效web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [CORS](https://github.com/rs/cors)  | 1200 |  轻松地向API添加CORS功能。 |![star > 1000][Silver]   
...
| [Tollbooth](https://github.com/didip/tollbooth)  | 1236 |  限制速率的 HTTP 请求处理程序。 |![star > 1000][Silver]   
...
| [chi](https://github.com/go-chi/chi)  | 5956 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9591 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]   
...
| [mux](https://github.com/gorilla/mux)  | 9549 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [GoLint](https://github.com/golang/lint)  | 3128 |  Go 源码的 linter。 |![star > 1000][Silver]   
...
| [vim-go](https://github.com/fatih/vim-go)  | 10747 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5078 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gotests](https://github.com/cweill/gotests)  | 2155 |  从源代码生成测试用例。 |![star > 1000][Silver]   
...
| [go-callvis](https://github.com/TrueFurby/go-callvis)  | 1966 |  使用 dot format 可视化 Go 程序的调用图。 |![star > 1000][Silver]   
| [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete)  | 37 |  Bash completion for go and wgo。 |![最近一年没有更新][Yellow]
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3907 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [godbg](https://github.com/tylerwince/godbg)  | 156 |  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。 |![star > 100][Bronze]   
| [OctoLinker](https://github.com/OctoLinker/browser-extension)  | 3725 |  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [aurora](https://github.com/xuri/aurora)  | 397 |  基于web的跨平台 Beanstalkd 队列服务器控制台。 |![star > 100][Bronze]   
...
| [bombardier](https://github.com/codesenberg/bombardier)  | 1709 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]   
...
| [Gitea](https://github.com/go-gitea/gitea)  | 14893 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Hey](https://github.com/rakyll/hey)  | 6187 |  压力测试工具，可用来代替 ApacheBench (ab)。 |![star > 5000][Gold]   
...
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55577 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Moby](https://github.com/moby/moby)  | 54200 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Pomerium](https://github.com/pomerium/pomerium)  | 475 |  Pomerium是一个可识别身份的访问代理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [script](https://github.com/bitfield/script)  | 896 |  让DevOps编写类shell和系统管理任务变得更加容易。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [sg](https://github.com/ChristopherRabotin/sg)  | 5 |  可测试一组HTTP极限(如ab)，可以在每个调用之间使用响应代码和数据，根据之前的响应来确定特定的服务器压力。 |![最近一年没有更新][Yellow]
| [skm](https://github.com/TimothyYe/skm)  | 545 |  SKM是一个简单而强大的SSH密钥管理器，它可以帮助您轻松地管理多个SSH密钥! |![star > 100][Bronze]   
| [StatusOK](https://github.com/sanathp/statusok)  | 1156 |  监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。 |![star > 1000][Silver]   
| [traefik](https://github.com/containous/traefik)  | 23452 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 12016 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [webhook](https://github.com/adnanh/webhook)  | 4045 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]   
...
| [confd](https://github.com/kelseyhightower/confd)  | 6370 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]   
...
| [Duplicacy](https://github.com/gilbertchen/duplicacy)  | 2675 |  跨平台网络和云备份工具。 |![star > 1000][Silver]   
...
| [LiteIDE](https://github.com/visualfc/liteide)  | 5439 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [nes](https://github.com/fogleman/nes)  | 4121 |  任天堂娱乐系统(NES)模拟器。 |![star > 1000][Silver]   
...
| [peg](https://github.com/pointlander/peg)  | 599 |  解析表达式语法，是Packrat解析器生成器的实现。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Pipe](https://github.com/b3log/pipe)  | 2781 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [restic](https://github.com/restic/restic)  | 7346 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Seaweed File System](https://github.com/chrislusf/seaweedfs)  | 8121 |  快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3893 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks)  | 855 |  Go序列化方法的基准测试。 |![star > 100][Bronze]   
