...
[Gold]: https://cdn.popo1h.com/awesome-go-cn/Gold.svg "star > 5000"
[Silver]: https://cdn.popo1h.com/awesome-go-cn/Silver.svg "star > 1000"
[Bronze]: https://cdn.popo1h.com/awesome-go-cn/Bronze.svg "star > 100"
[Green]: https://cdn.popo1h.com/awesome-go-cn/Green.svg "最近一周有更新"
[Yellow]: https://cdn.popo1h.com/awesome-go-cn/Yellow.svg "最近一年没有更新"

**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-07 09:53:48(每隔1天同步一次)**
...
* [EasyMIDI](https://github.com/algoGuy/EasyMIDI) - **star:21** EasyMidi是一个简单可靠的库，用于处理标准midi文件(SMF)。![最近一年没有更新][Yellow]
...
* [Oto](https://github.com/hajimehoshi/oto) - **star:411** 多平台的 low-level 声音播放库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [authboss](https://github.com/volatiletech/authboss) - **star:1898** web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。![star > 1000][Silver]   
* [branca](https://github.com/hako/branca) - **star:68** 基于 Go 实现Branca令牌。
* [casbin](https://github.com/hsluoyz/casbin) - **star:4712** 支持ACL、RBAC、ABAC等访问控制模型的授权库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) - **star:1254** 用 Golang 编写的独立且符合规范的OAuth2服务器。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gologin](https://github.com/dghubble/gologin) - **star:1031** 用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。![star > 1000][Silver]   
* [gorbac](https://github.com/mikespook/gorbac) - **star:896** 轻量级的基于角色的访问控制(RBAC)实现。![star > 100][Bronze]   
* [goth](https://github.com/markbates/goth) - **star:2218** 提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。![star > 1000][Silver]   
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) - **star:5750** JSON Web令牌(JWT)。![star > 5000][Gold]   
* [loginsrv](https://github.com/tarent/loginsrv) - **star:797** JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。![star > 100][Bronze]   
* [oauth2](https://github.com/golang/oauth2) - **star:2332** goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-chat-bot](https://github.com/go-chat-bot/bot) - **star:458** 用 Go 编写的IRC, Slack和电报机器人。![star > 100][Bronze]   
* [go-sarah](https://github.com/oklahomer/go-sarah) - **star:132** 此框架提供了聊天机器人相关的服务，包括LINE、Slack、Gitter等。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [telebot](https://github.com/tucnak/telebot) - **star:929** 用Go编写的Telegram bot框架。![star > 100][Bronze]   
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - **star:1570** 简单轻量级的Telegram bot客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [cobra](https://github.com/spf13/cobra) - **star:12617** 现代Go CLI命令行交互工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [commandeer](https://github.com/jaffee/commandeer) - **star:79** 开发友好的CLI应用程序。
...
* [flaggy](https://github.com/integrii/flaggy) - **star:442** 一个健壮的、易用的标志包，具有出色的子命令支持。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [kingpin](https://github.com/alecthomas/kingpin) - **star:2499** 支持子命令的命令行和标志解析器。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [liner](https://github.com/peterh/liner) - **star:571** 类似readline-like的命令行接口库。![star > 100][Bronze]   
* [mitchellh/cli](https://github.com/mitchellh/cli) - **star:986** 用于实现命令行接口的Go库。![star > 100][Bronze]   
* [mow.cli](https://github.com/jawher/mow.cli) - **star:619** 用于构建具有复杂标志和参数解析和验证的CLI应用程序。![star > 100][Bronze]   
* [ops](https://github.com/nanovms/ops) - **star:239** Unikernel 构建器/协调器。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [pflag](https://github.com/spf13/pflag) - **star:730** 基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。![star > 100][Bronze]   
...
* [urfave/cli](https://github.com/urfave/cli) - **star:11085** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。![star > 5000][Gold]   
...
* [aurora](https://github.com/logrusorgru/aurora) - **star:602** 支持fmt.Printf/Sprintf的ANSI终端颜色。![star > 100][Bronze]   
...
* [color](https://github.com/fatih/color) - **star:2981** 多功能包装，彩色终端输出。![star > 1000][Silver]   
...
* [go-isatty](https://github.com/mattn/go-isatty) - **star:337** Go 实现的 isatty。![star > 100][Bronze]   
* [go-prompt](https://github.com/c-bata/go-prompt) - **star:2271** 构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit)![star > 1000][Silver]   
* [gocui](https://github.com/jroimartin/gocui) - **star:4949** 旨在创建控制台用户界面的极简Go库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) - 更换终端文本样式。
* [gookit/color](https://github.com/gookit/color) - **star:184** 终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。![star > 100][Bronze]   
* [mpb](https://github.com/vbauerster/mpb) - **star:499** 可在终端显示多进度条。![star > 100][Bronze]   
* [progressbar](https://github.com/schollz/progressbar) - **star:549** 基本线程安全的进度条，在每个操作系统工作。![star > 100][Bronze]   
...
* [termbox-go](https://github.com/nsf/termbox-go) - **star:3440** 基于文本的跨平台接口库。![star > 1000][Silver]   
...
* [termui](https://github.com/gizak/termui) - **star:8809** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [ini](https://github.com/go-ini/ini) - **star:1523**  读和写INI文件。![star > 1000][Silver]   
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) - **star:2354** 管理来自环境变量的配置数据。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [viper](https://github.com/spf13/viper) - **star:9014** 配置管理。![star > 5000][Gold]   
...
* [drone](https://github.com/drone/drone) - **star:18717** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-datastructures](https://github.com/Workiva/go-datastructures) - **star:5058** 可靠的、高性能的和线程安全的数据结构的集合。![star > 5000][Gold]   
...
* [gods](https://github.com/emirpasic/gods) - **star:6058** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。![star > 5000][Gold]   
* [golang-set](https://github.com/deckarep/golang-set) - **star:1123** 线程安全和非线程安全的高性能集。![star > 1000][Silver]   
...
* [trie](https://github.com/derekparker/trie) - **star:407** 在Go中实现Trie。![star > 100][Bronze]   
...
* [badger](https://github.com/dgraph-io/badger) - **star:6120** 快速 K/V 存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [bcache](https://github.com/iwanbk/bcache) - **star:26** 基于内存的最终一致的分布式缓存。
* [BigCache](https://github.com/allegro/bigcache) - **star:2395** 高效的键/值缓存为千兆字节的数据。![star > 1000][Silver]   
* [bolt](https://github.com/boltdb/bolt) - **star:9876** K/V 数据库。![star > 5000][Gold]   ![最近一年没有更新][Yellow]
* [buntdb](https://github.com/tidwall/buntdb) - **star:2421** 基于内存的K/V，快速，可嵌入的数据库，可自定义索引和空间支持。![star > 1000][Silver]   
* [cache](https://github.com/akyoto/cache) - **star:10** 基于内存的 K/V 存储:带生命周期的值存储，0个依赖项，<100 LoC, 100%覆盖率。
* [cache2go](https://github.com/muesli/cache2go) - **star:934** 基于内存的 K/V 缓存，支持超时的自动失效。![star > 100][Bronze]   
* [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache) - **star:29** BigCache 支持集群和独立且生命周期存储项。![最近一年没有更新][Yellow]
* [cockroach](https://github.com/cockroachdb/cockroach) - **star:16578** 可伸缩、区域备份、事务性数据存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dgraph](https://github.com/dgraph-io/dgraph) - **star:9937** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [fastcache](https://github.com/VictoriaMetrics/fastcache) - **star:468** 基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。![star > 100][Bronze]   
* [GCache](https://github.com/bluele/gcache) - **star:865** 支持过期缓存、LFU、LRU和ARC的缓存库。![star > 100][Bronze]   
* [go-cache](https://github.com/pmylund/go-cache) - **star:2797** 基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。![star > 1000][Silver]   
* [goleveldb](https://github.com/syndtr/goleveldb) - **star:3103** 在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gorocksdb](https://github.com/kapitan-k/gorocksdb) - **star:8** 用 Go 对[RocksDB](https://rocksdb.org)实现了封装。![最近一年没有更新][Yellow]
* [groupcache](https://github.com/golang/groupcache) - **star:7559** Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [influxdb](https://github.com/influxdb/influxdb) - **star:16732** 可伸缩的数据存储，用于指标衡量、事件和实时分析。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [prometheus](https://github.com/prometheus/prometheus) - **star:24954** 用于监控系统和时序的数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [pudge](https://github.com/recoilme/pudge) - **star:216** 使用Go的标准库编写的快速和简单的键/值存储。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [rqlite](https://github.com/rqlite/rqlite) - **star:4639** 基于SQLite的轻量级分布式关系数据库。![star > 1000][Silver]   
...
* [tidb](https://github.com/pingcap/tidb) - **star:19559** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [tiedot](https://github.com/HouzuoGuo/tiedot) - **star:2353** 属于你的NoSQL数据库。![star > 1000][Silver]   
...
* [migrate](https://github.com/golang-migrate/migrate) - **star:2441** 基于CLI的数据库迁移库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) - **star:1376** 数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。![star > 1000][Silver]   
...
* [go-mysql](https://github.com/siddontang/go-mysql) - **star:1806**  Go 工具集，用于处理MySQL协议和复制。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) - **star:2287** 自动将MySQL数据同步到Elasticsearch中。![star > 1000][Silver]   
...
* [orchestrator](https://github.com/github/orchestrator) - **star:2963** MySQL复制拓扑管理器和可视化工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [pgweb](https://github.com/sosedoff/pgweb) - **star:5940** 基于web的PostgreSQL数据库浏览器。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [prep](https://github.com/hexdigest/prep) - **star:24** 在不更改代码的情况下使用准备好的SQL语句。![最近一年没有更新][Yellow]
* [pREST](https://github.com/nuveo/prest) - **star:2057** 基于PostgreSQL database的RESTful API服务。![star > 1000][Silver]   
* [rwdb](https://github.com/andizzle/rwdb) - **star:10** rwdb为多个数据库服务器的设置提供读取副本功能。![最近一年没有更新][Yellow]
* [vitess](https://github.com/youtube/vitess) - **star:8289** vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。![star > 5000][Gold]   ![最近一个周有更新][Green]

*SQL查询生成器，用于构建和使用SQL的库。*

* [Dotsql](https://github.com/gchaincl/dotsql) - **star:436** Go library帮助您将sql文件保存在一个地方，并轻松地使用它们。![star > 100][Bronze]   
...
* Relational Databases
    ...
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - **star:7890** MySQL驱动程序。![star > 5000][Gold]   
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - **star:3357** SQLite3驱动程序。![star > 1000][Silver]   
    ...
    * [pgx](https://github.com/jackc/pgx) - **star:1862** PostgreSQL驱动，支持比现有database/sql更多的特性。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [pq](https://github.com/lib/pq) - **star:5084** 纯 Go 的Postgres驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* NoSQL Databases
    ...
    * [mgo](https://github.com/globalsign/mgo) - **star:1609** (已停止维护) MongoDB驱动。![star > 1000][Silver]   
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - **star:2915** 官方的 MongoDB 驱动。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [redigo](https://github.com/gomodule/redigo) - **star:6143** Redigo 是基于 Go 的Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [redis](https://github.com/go-redis/redis) - **star:6206** 基于 Go 的 Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [xredis](https://github.com/shomali11/xredis) - **star:9** 类型安全，可定制，清晰和易用的Redis客户端。

* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) - **star:5750** 基于 Go 的现代文本索引库。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [elastic](https://github.com/olivere/elastic) - **star:4007** Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - **star:1478** 官方 Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [goes](https://github.com/OwnLocal/goes) - **star:24** 实现了与 Elasticsearch 交互的库。![最近一年没有更新][Yellow]
    * [riot](https://github.com/go-ego/riot) - **star:4631** 基于 Go 的 开源、分布式、简单高效的搜索引擎。![star > 1000][Silver]   
...
* Multiple Backends.
    ...
    * [cayley](https://github.com/google/cayley) - **star:12609** 图形数据库，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [now](https://github.com/jinzhu/now) - **star:2138** now 是时间有关的工具类。![star > 1000][Silver]   
...
* [dragonboat](https://github.com/lni/dragonboat) - **star:2448** 一个功能齐全，高性能的库集。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [emitter-io](https://github.com/emitter-io/emitter) - **star:1876** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [flowgraph](https://github.com/vectaport/flowgraph) - **star:18** flow-based programming package。
* [gleam](https://github.com/chrislusf/gleam) - **star:2046** 使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。![star > 1000][Silver]   
...
* [go-kit](https://github.com/go-kit/kit) - **star:14123** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。![star > 5000][Gold]   
* [gorpc](https://github.com/valyala/gorpc) - **star:547** 简单、快速和可伸缩的RPC库。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [grpc-go](https://github.com/grpc/grpc-go) - **star:8760** gRPC的Go语言实现。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hprose](https://github.com/hprose/hprose-golang) - **star:990** 支持25+种语言RPC库。![star > 100][Bronze]   
* [jaeger](https://github.com/jaegertracing/jaeger) - **star:8417** 分布式跟踪系统。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [KrakenD](https://github.com/devopsfaith/krakend) - **star:1648** 具有中间件的高性能API网关框架。![star > 1000][Silver]   
* [micro](https://github.com/micro/micro) - **star:6441** 可插拔的微服务 toolkit 和分布式系统平台。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) - **star:5930** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [raft](https://github.com/hashicorp/raft) - **star:2776** Raft consensus协议的实现。 by HashiCorp。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [rpcx](https://github.com/smallnest/rpcx) - **star:3685** 分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。![star > 1000][Silver]   
...
* [torrent](https://github.com/anacrolix/torrent) - **star:2774** BitTorrent 客户端。![star > 1000][Silver]   
...
* [email](https://github.com/jordan-wright/email) - **star:1075** 一个强大和灵活的电子邮件库。![star > 1000][Silver]   
* [go-dkim](https://github.com/toorop/go-dkim) - **star:46** DKIM库，用于签署 & 验证电子邮件。
* [go-imap](https://github.com/emersion/go-imap) - **star:709** 用于客户端和服务器的IMAP库。![star > 100][Bronze]   
...
* [MailHog](https://github.com/mailhog/MailHog) - **star:5043** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。![star > 5000][Gold]   
...
* [anko](https://github.com/mattn/anko) - **star:902** 用Go编写的解释器。![star > 100][Bronze]   
* [binder](https://github.com/alexeyco/binder) - **star:29** Lua接口，基于[gopher-lua](https://github.com/yuin/gopher-lua)。
* [expr](https://github.com/antonmedv/expr) - **star:638** 一个可以计算表达式的引擎。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [errors](https://github.com/pkg/errors) - **star:4716** 可让你很简单的进行错误处理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [decimal](https://github.com/shopspring/decimal) - **star:1547** 任意精度定点的十进制数。![star > 1000][Silver]   
...
* [techan](https://github.com/sdcoffey/techan) - **star:144** 拥有先进的市场分析和交易策略的技术分析库。![star > 100][Bronze]   
...
* [form](https://github.com/go-playground/form) - **star:346**  将 url 中的数据解析到 Go 变量中，以及将 Go 语言变量编码进 url。支持 Dual Array 及 Full map。![star > 100][Bronze]   
...
* [Ebiten](https://github.com/hajimehoshi/ebiten) - **star:1787** 很简单的 2D 游戏库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gonet](https://github.com/xtaci/gonet) - **star:1043** 实现了游戏服务器骨架。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [goworld](https://github.com/xiaonanln/goworld) - **star:1139** 可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。![star > 1000][Silver]   
* [Leaf](https://github.com/name5566/leaf) - **star:3001** 轻量级游戏服务器框架。![star > 1000][Silver]   
...
* [termloop](https://github.com/JoelOtter/termloop) - **star:1019** 基于终端的 Go 游戏引擎，建立在 Termbox 之上。![star > 1000][Silver]   
...
* [gen](https://github.com/clipperhouse/gen) - **star:1019** 用于生成泛型等类似方法的功能代码生成工具。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
* [jennifer](https://github.com/dave/jennifer) - **star:1249** 不使用模板生成任意 Go 代码。![star > 1000][Silver]   
...
* [osm](https://github.com/paulmach/osm) - **star:60** 用于读取、写入和处理 OpenStreetMap 数据和 APIs。
...
* [gopherjs](https://github.com/gopherjs/gopherjs) - **star:8435** 将 Go 编译成 JavaScript。![star > 5000][Gold]   
* [llgo](https://github.com/go-llvm/llgo) - **star:986** 基于 llvm 的编译器。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [ants](https://github.com/panjf2000/ants) - **star:1763** 一个高性能的协程池。![star > 1000][Silver]   
...
* [workerpool](https://github.com/gammazero/workerpool) - **star:122** 限制任务执行并发数，而不是队列中的任务数量的协程池，。![star > 100][Bronze]   
...
* [app](https://github.com/murlokswarm/app) - **star:2918** 用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。![star > 1000][Silver]   
* [fyne](https://github.com/fyne-io/fyne) - **star:6033** 为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [go-astilectron](https://github.com/asticode/go-astilectron) - **star:2596** 使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。![star > 1000][Silver]   
...
* [gotk3](https://github.com/gotk3/gotk3) - **star:732** 实现了 GTK3 的 Go接口。![star > 100][Bronze]   
* [gowd](https://github.com/dtylman/gowd) - **star:203** 跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。![star > 100][Bronze]   
* [qt](https://github.com/therecipe/qt) - **star:5823** 实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。![star > 5000][Gold]   
...
* [walk](https://github.com/lxn/walk) - **star:3636** Windows应用程序库。![star > 1000][Silver]   
* [webview](https://github.com/zserge/webview) - **star:4523** 跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [systray](https://github.com/getlantern/systray) - **star:761** 跨平台 Go 库，可在通知区放置图标和菜单。![star > 100][Bronze]   
...
* [gg](https://github.com/fogleman/gg) - **star:1876** 纯Go语言实现的2D渲染。![star > 1000][Silver]   
...
* [gocv](https://github.com/hybridgroup/gocv) - **star:2371** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [imaging](https://github.com/disintegration/imaging) - **star:2474** 简单的Go图像处理包。![star > 1000][Silver]   
...
* [GJSON](https://github.com/tidwall/gjson) - **star:4742** 使用一行代码获取JSON的值。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [glog](https://github.com/golang/glog) - **star:2273** 为Go提供了多等级日志记录。![star > 1000][Silver]   
...
* [logger](https://github.com/azer/logger) - **star:135** Go的精简日志库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [logrus](https://github.com/Sirupsen/logrus) - **star:11487** Go的结构化日志操作 。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [lumberjack](https://github.com/natefinch/lumberjack) - **star:1386** 简单的滚动日志，io.WriteCloser的实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [tail](https://github.com/hpcloud/tail) - **star:1498** 努力模拟实现BSD的tail的特性的Go包。![star > 1000][Silver]   
...
* [zap](https://github.com/uber-go/zap) - **star:7208** 快速、结构化、多等级的日志记录。![star > 5000][Gold]   
* [zerolog](https://github.com/rs/zerolog) - **star:2097** Zero-allocation JSON日志记录。![star > 1000][Silver]   ![最近一个周有更新][Green]

## 机器学习

*机器学习库。*

* [bayesian](https://github.com/jbrukh/bayesian) - **star:625** Go的朴素贝叶斯分类。![star > 100][Bronze]   
...
* [GoLearn](https://github.com/sjwhitworth/golearn) - **star:6608** 通用机器学习库。![star > 5000][Gold]   
...
* [gorgonia](https://github.com/chewxy/gorgonia) - **star:2648** 基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gorse](https://github.com/zhenghaoz/gorse) - **star:509** 基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。![star > 100][Bronze]   
...
* [regommend](https://github.com/muesli/regommend) - **star:243** 推荐和协同过滤引擎。![star > 100][Bronze]   
* [shield](https://github.com/eaigner/shield) - **star:124** 贝叶斯文本分类器，具有灵活的tokenizers和存储后端。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [tfgo](https://github.com/galeone/tfgo) - **star:1163** 易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。![star > 1000][Silver]   
...
* [Benthos](https://github.com/Jeffail/benthos) - **star:1912** 一系列协议之间的消息流桥。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Glue](https://github.com/desertbit/glue) - **star:313** 健壮的Go和Javascript套接字库(替代Socket.io)。![star > 100][Bronze]   
...
* [go-socket.io](https://github.com/googollee/go-socket.io) - **star:2832** 套接字。面向golang的io库，一个实时应用程序框架。![star > 1000][Silver]   
...
* [gorush](https://github.com/appleboy/gorush) - **star:3646** 使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [melody](https://github.com/olahol/melody) - **star:1517** 处理websocket会话的极简框架，包括广播和自动乒乓球处理。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Mercure](https://github.com/dunglas/mercure) - **star:1437** 使用Mercure协议(构建在服务器发送事件之上)分派服务器发送的更新的服务器和库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [sarama](https://github.com/Shopify/sarama) - **star:4479**  Go Apache Kafka的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) - **star:4305** Golang库读写Microsoft Excel™(XLSX)文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [xlsx](https://github.com/tealeg/xlsx) - **star:3279** 库，以简化在Go程序中读取Microsoft Excel最新版本使用的XML格式。![star > 1000][Silver]   
...
* [dig](https://github.com/uber-go/dig) - **star:865** 一个基于反射的Go依赖注入工具包。![star > 100][Bronze]   
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - **star:8503** Go生态系统中常见的历史和新兴的项目布局模式。![star > 5000][Gold]   
...
* [archiver](https://github.com/mholt/archiver) - **star:2440** 用于生成和提取.zip和.tar.gz存档的库和命令。![star > 1000][Silver]   
...
* [base64Captcha](https://github.com/mojocn/base64Captcha) - **star:609** Base64captch支持数字，数字，字母，算术，音频和数字-字母验证码。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gopsutil](https://github.com/shirou/gopsutil) - **star:3822** 用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [buffstreams](https://github.com/stabbycutyou/buffstreams) - **star:233** 通过TCP传输协议缓冲区数据变得很容易。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [dhcp6](https://github.com/mdlayher/dhcp6) - **star:62** 包dhcp6实现了一个DHCPv6服务器，如RFC 3315所述。
* [dns](https://github.com/miekg/dns) - **star:3721** 使用DNS的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [fasthttp](https://github.com/valyala/fasthttp) - **star:9044** 软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gNxI](https://github.com/google/gnxi) - **star:99** 一组使用gNMI和gNOI协议的网络管理工具。![最近一个周有更新][Green]
* [go-getter](https://github.com/hashicorp/go-getter) - **star:698**  Go 图书馆下载文件或目录从各种来源使用一个URL。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gopacket](https://github.com/google/gopacket) - **star:2789** 使用libpcap绑定访问包处理库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [kcptun](https://github.com/xtaci/kcptun) - **star:10533** 非常简单和快速udp隧道基于KCP协议。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [quic-go](https://github.com/lucas-clemente/quic-go) - **star:2813** 在纯Go中实现了QUIC协议。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [ssh](https://github.com/gliderlabs/ssh) - **star:1089** 用于构建SSH服务器的高级API(封装密码/ SSH)。![star > 1000][Silver]   
...
* [webrtc](https://github.com/pions/webrtc) - **star:2062** WebRTC API的纯Go实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gentleman](https://github.com/h2non/gentleman) - **star:670** 功能齐全的插件驱动HTTP客户端库。![star > 100][Bronze]   
...
* [glfw](https://github.com/go-gl/glfw) - **star:713** Go绑定用于glfw3。![star > 100][Bronze]   
...
* [go-pg](https://github.com/go-pg/pg) - **star:2884** 关注PostgreSQL的特性和性能。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-queryset](https://github.com/jirfag/go-queryset) - **star:445** 100%类型安全ORM与代码生成和MySQL, PostgreSQL, Sqlite3, SQL Server支持基于GORM。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [GORM](https://github.com/jinzhu/gorm) - **star:14198** Golang出色的ORM库的目标是对开发人员友好。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) - **star:2210** ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [upper.io/db](https://github.com/upper/db) - **star:1817** 通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。![star > 1000][Silver]   
* [Xorm](https://github.com/go-xorm/xorm) - **star:5031** 简单而强大的ORM for Go。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dep](https://github.com/golang/dep) - **star:12402**  Go 的依赖管理工具，需要 Go 1.9+![star > 5000][Gold]   
...
* [glide](https://github.com/Masterminds/glide) - **star:7736** 轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。![star > 5000][Gold]   
...
* [gopm](https://github.com/gpmgo/gopm) - **star:2331** 包管理器。![star > 1000][Silver]   
...
* [graphql](https://github.com/neelance/graphql-go) - **star:2712** 关注易用性的GraphQL服务器。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [graphql-go](https://github.com/graphql-go/graphql) - **star:5067** 为Go实现GraphQL。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go.rice](https://github.com/GeertJohan/go.rice) - **star:1620** go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。![star > 1000][Silver]   
* [packr](https://github.com/gobuffalo/packr) - **star:2024** 将静态文件嵌入到Go二进制文件中的简单方法。![star > 1000][Silver]   
* [statics](https://github.com/go-playground/statics) - **star:53** 将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。![最近一年没有更新][Yellow]
* [statik](https://github.com/rakyll/statik) - **star:2032** 将静态文件嵌入到Go可执行文件中。![star > 1000][Silver]   
* [templify](https://github.com/wlbr/templify) - **star:19** 将外部模板文件嵌入到Go代码中，以创建单个文件二进制文件。
* [vfsgen](https://github.com/shurcooL/vfsgen) - **star:637** 生成一个vfsdata。静态实现给定虚拟文件系统的go文件。![star > 100][Bronze]   
...
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) - **star:64** 用于机器学习和统计的数据模型(类似于 pandas)。![最近一个周有更新][Green]
...
* [gonum](https://github.com/gonum/gonum) - **star:2863** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gonum/plot](https://github.com/gonum/plot) - **star:1186** gonum/plot提供了一个API，用于在Go中构建和绘制绘图。![star > 1000][Silver]   
...
* [orb](https://github.com/paulmach/orb) - **star:188** 2D几何类型，支持剪切、GeoJSON和Mapbox矢量平铺。![star > 100][Bronze]   
...
* [Cameradar](https://github.com/Ullaakut/cameradar) - **star:1784** 工具和库，以远程入侵RTSP流从监控摄像头。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [lego](https://github.com/xenolf/lego) - **star:3428** 纯 Go ACME 客户端库及命令行工具![star > 1000][Silver]   ![最近一个周有更新][Green]
* [memguard](https://github.com/awnumar/memguard) - **star:996** 一个用于处理内存中敏感值的纯Go库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [secure](https://github.com/unrolled/secure) - **star:1187** Go 语言 HTTP 中间件，为 Go 提供了一些安全功能![star > 1000][Silver]   
...
* [go-codec](https://github.com/ugorji/go) - **star:1207** 高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) - **star:2847** Go 语言的 Protocol Buffer 库。![star > 1000][Silver]   
* [goprotobuf](https://github.com/golang/protobuf) - **star:4880** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.![star > 1000][Silver]   ![最近一个周有更新][Green]
* [jsoniter](https://github.com/json-iterator/go) - **star:5291** 高性能，100% 兼容的“encoding/json” 替代品![star > 5000][Gold]   
* [mapstructure](https://github.com/mitchellh/mapstructure) - **star:2335** 用于对原生键值对进行解码生成 Go 语言结构体![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [algernon](https://github.com/xyproto/algernon) - **star:1575** 内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。![star > 1000][Silver]   
* [Caddy](https://github.com/mholt/caddy) - **star:22653** Caddy是另一种HTTP/2 web服务器，易于配置和使用。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [consul](https://www.consul.io/) - Consul 是一个用于服务发现、监控和配置的工具
* [devd](https://github.com/cortesi/devd) - **star:2783** 为开发人员提供本地web服务器。![star > 1000][Silver]   
* [discovery](https://github.com/Bilibili/discovery) - **star:629** 用于弹性中间层负载平衡和故障转移的注册表。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [etcd](https://github.com/coreos/etcd) - **star:25828** 为共享配置和服务发现提供高可用的键值存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Fider](https://github.com/getfider/fider) - **star:775** Fider是一个收集和组织客户反馈的开放平台。![star > 100][Bronze]   
* [Flagr](https://github.com/checkr/flagr) - **star:785** Flagr是一个开源特性标记和A/B测试服务。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [minio](https://github.com/minio/minio) - **star:16880** Minio是一个分布式对象存储服务器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [RoadRunner](https://github.com/spiral/roadrunner) - **star:3143** 高性能PHP应用服务器，负载平衡器和进程管理器。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gofpdf](https://github.com/jung-kurt/gofpdf) - **star:3014** PDF 文档生成器，支持文本，绘图和图片![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [pongo2](https://github.com/flosch/pongo2) - **star:1480** 类似 DjanGo 的模板引擎![star > 1000][Silver]   ![最近一个周有更新][Green]
* [quicktemplate](https://github.com/valyala/quicktemplate) - **star:1359** 快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译![star > 1000][Silver]   ![最近一个周有更新][Green]
* [raymond](https://github.com/aymerick/raymond) - **star:336** 使用 Go 语言实现的完整的 handlebars![star > 100][Bronze]   
* [Razor](https://github.com/sipin/gorazor) - **star:671** Go 语言的 Razor 视图引擎![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* Testing Frameworks
    ...
    * [gotest.tools](https://github.com/gotestyourself/gotest.tools) - **star:113** 一组包，用于增强go测试包并支持公共模式。![star > 100][Bronze]   
    ...
    * [testfixtures](https://github.com/go-testfixtures/testfixtures) - **star:315** 类似 Rails 的测试工具，用于测试数据库应用![star > 100][Bronze]   
    * [Testify](https://github.com/stretchr/testify) - **star:7834** 对标准测试包的扩展。![star > 5000][Gold]   
...
* Mock
    ...
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - **star:1635** Mock SQL ，用于测试数据库交互![star > 1000][Silver]   
    ...
    * [hoverfly](https://github.com/SpectoLabs/hoverfly) - **star:1412** 使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* Selenium and browser control tools.
    ...
    * [chromedp](https://github.com/knq/chromedp) - **star:3409** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* Specific Formats
    ...
    * [blackfriday](https://github.com/russross/blackfriday) - **star:3806** Markdown 解析器![star > 1000][Silver]   
    ...
    * [colly](https://github.com/asciimoo/colly) - **star:8089** 快速和优雅的 Scraping 框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [commonregex](https://github.com/mingrammer/commonregex) - **star:546** 一组用于Go的公共正则表达式。![star > 100][Bronze]   
    * [dataflowkit](https://github.com/slotix/dataflowkit) - **star:281** Web抓取框架将网站转换为结构化数据。![star > 100][Bronze]   
    ...
    * [go-toml](https://github.com/pelletier/go-toml) - **star:596** 使用带有查询支持和方便的cli工具的TOML格式库。![star > 100][Bronze]   
    ...
    * [gofeed](https://github.com/mmcdole/gofeed) - **star:1078** 在Go中解析RSS和Atom feeds。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [GoQuery](https://github.com/PuerkitoBio/goquery) - **star:7439** GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能![star > 5000][Gold]   
    ...
    * [htmlquery](https://github.com/antchfx/htmlquery) - **star:117** 用于HTML的XPath查询包，允许您通过XPath表达式从HTML文档中提取数据或求值。![star > 100][Bronze]   
    ...
    * [sh](https://github.com/mvdan/sh) - **star:1921** Shell解析器和格式化工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [toml](https://github.com/BurntSushi/toml) - **star:2713** TOML配置格式(带反射的编码器/解码器)。![star > 1000][Silver]   
* Utility
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - **star:4928** AWS 提供的官方go语言 SDK![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [discordgo](https://github.com/bwmarrin/discordgo) - **star:934**  Discord Chat API的客户端。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [github](https://github.com/google/go-github) - **star:4686** 访问GitHub REST API v3的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [githubql](https://github.com/shurcooL/githubql) - **star:486** 访问GitHub GraphQL API v4的库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [paypal](https://github.com/logpacker/PayPal-Go-SDK) - **star:297** PayPal支付API的包装器。![star > 100][Bronze]   
...
* [slack](https://github.com/nlopes/slack) - **star:2354** Slack API。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [stripe](https://github.com/stripe/stripe-go) - **star:914**  Stripe API 的 Go 语言客户端![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [boilr](https://github.com/tmrts/boilr) - **star:922** 非常快的CLI工具，用于从样板模板创建项目。![star > 100][Bronze]   
...
* [ctop](https://github.com/bcicen/ctop) - **star:8654** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。![star > 5000][Gold]   
...
* [delve](https://github.com/derekparker/delve) - **star:11739** Go 语言调试器![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [filetype](https://github.com/h2non/filetype) - **star:926** 通过数字签名来推测文件类型。![star > 100][Bronze]   
...
* [fzf](https://github.com/junegunn/fzf) - **star:22501** 用Go编写的命令行模糊查找器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-funk](https://github.com/thoas/go-funk) - **star:1091** 现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)![star > 1000][Silver]   
...
* [goreleaser](https://github.com/goreleaser/goreleaser) - **star:4365** 尽可能快速的发布 Go 语言二进制文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [hub](https://github.com/github/hub) - **star:16595** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [koazee](https://github.com/wesovilabs/koazee) - **star:278** 库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。![star > 100][Bronze]   
* [lrserver](https://github.com/jaschaephraim/lrserver) - **star:99** LiveReload 服务器。![最近一年没有更新][Yellow]
* [mc](https://github.com/minio/mc) - **star:1072** Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [mole](https://github.com/davrodpin/mole) - **star:1292** cli应用程序可以轻松创建ssh隧道。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [panicparse](https://github.com/maruel/panicparse) - **star:2078** 将类似的协程分组并对调用栈进行着色![star > 1000][Silver]   ![最近一个周有更新][Green]
* [peco](https://github.com/peco/peco) - **star:5408** 简单的交互过滤工具。![star > 5000][Gold]   
...
* [realize](https://github.com/tockins/realize) - **star:3090** Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。![star > 1000][Silver]   
...
* [resty](https://github.com/go-resty/resty) - **star:1818** 简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。![star > 1000][Silver]   
...
* [sqlx](https://github.com/jmoiron/sqlx) - **star:6588** 为内建的数据库/sql 软件包提供一组扩展。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Task](https://github.com/go-task/task) - **star:1862** 简单的“Go”的选择。![star > 1000][Silver]   
...
* [wuzz](https://github.com/asciimoo/wuzz) - **star:8216** 用于HTTP检查的交互式cli工具。![star > 5000][Gold]   
...
* [govalidator](https://github.com/asaskevich/govalidator) - **star:3492** 用于字符串，数字，切片和结构的验证器和sanitizers。![star > 1000][Silver]   
...
* [validator](https://github.com/go-playground/validator) - **star:3333**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-git](https://github.com/src-d/go-git) - **star:4114** 纯Go中高度可扩展的Git实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [goav](https://github.com/giorgisio/goav) - **star:755** FFmpeg的Comphrensive。![star > 100][Bronze]   
...
* [Aero](https://github.com/aerogo/aero) - **star:152** 高性能的Go web框架，在Lighthouse中达到最高分。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Air](https://github.com/aofei/air) - **star:514** 一个理想的精细化的Go web框架。![star > 100][Bronze]   
* [Banjo](https://github.com/nsheremet/banjo) - **star:7** 非常简单和快速的网络框架 Go 。![最近一年没有更新][Yellow]
* [Beego](https://github.com/astaxie/beego) - **star:21075** beego是一种用于 Go 编程语言的开源高性能web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Buffalo](http://gobuffalo.io) - 为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) - **star:14382** 高性能、极简的Go web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Gin](https://github.com/gin-gonic/gin) - **star:28828** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Goa](https://github.com/goadesign/goa) - **star:3459** Goa为在Go中开发远程api和微服务提供了一种全面的方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [hiboot](https://github.com/hidevopsio/hiboot) - **star:81** hiboot是一个高性能的web应用程序框架，支持自动配置和依赖注入。
...
* [Revel](https://github.com/revel/revel) - **star:11182** 用于Go语言的高效web框架。![star > 5000][Gold]   
...
* [vox](https://github.com/aisk/vox) - **star:28** 一个面向人类的golang web框架，深受Koa的启发。![最近一个周有更新][Green]
* [WebGo](https://github.com/bnkamalesh/webgo) - **star:71** 构建web应用程序的微框架;处理程序链接、中间件和上下文注入。与标准库兼容的HTTP处理程序(即http.HandlerFunc)。![最近一个周有更新][Green]
...
* [CORS](https://github.com/rs/cors) - **star:1177** 轻松地向API添加CORS功能。![star > 1000][Silver]   
...
* [Tollbooth](https://github.com/didip/tollbooth) - **star:1215** 限制速率的 HTTP 请求处理程序。![star > 1000][Silver]   
...
* [render](https://github.com/unrolled/render) - **star:1263** Go package用于方便地呈现JSON、XML和HTML模板响应。![star > 1000][Silver]   
...
* [chi](https://github.com/go-chi/chi) - **star:5877** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。![star > 5000][Gold]   
...
* [httprouter](https://github.com/julienschmidt/httprouter) - **star:9508** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。![star > 5000][Gold]   
...
* [mux](https://github.com/gorilla/mux) - **star:9428** 强大的URL路由器和调度器为golang。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [zek](https://github.com/miku/zek) - **star:243** 从XML生成Go结构。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-critic](https://github.com/go-critic/go-critic) - **star:553** 源代码检查工具。![star > 100][Bronze]   
...
* [GoLint](https://github.com/golang/lint) - **star:3105** Go 源码的 linter。![star > 1000][Silver]   
...
* [go-mode](https://github.com/dominikh/go-mode.el) - **star:939** 在 GNU/Emacs 支持 GO。![star > 100][Bronze]   
...
* [vim-go](https://github.com/fatih/vim-go) - **star:10682** Go 开发会用到的 Vim 插件。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) - **star:5030** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [genny](https://github.com/cheekybits/genny) - **star:924** 优雅的 Go 泛型。![star > 100][Bronze]   
...
* [gotests](https://github.com/cweill/gotests) - **star:2129** 从源代码生成测试用例。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **star:1930** 使用 dot format 可视化 Go 程序的调用图。![star > 1000][Silver]   
* [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) - **star:37** Bash completion for go and wgo。![最近一年没有更新][Yellow]
* [go-swagger](https://github.com/go-swagger/go-swagger) - **star:3849** 基于 Go 的Swagger 2.0实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [godbg](https://github.com/tylerwince/godbg) - **star:157** 实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。![star > 100][Bronze]   
* [OctoLinker](https://github.com/OctoLinker/browser-extension) - **star:3690** 借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [bombardier](https://github.com/codesenberg/bombardier) - **star:1683** 快速跨平台 HTTP 基准测试工具。![star > 1000][Silver]   
...
* [fac](https://github.com/mkchoi212/fac) - **star:1597** 修复 git 合并冲突。![star > 1000][Silver]   
* [gaia](https://github.com/gaia-pipeline/gaia) - **star:3698** 可用于任何编程语言来构建强大的管道。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Gitea](https://github.com/go-gitea/gitea) - **star:14661** 从 Gogs fork，完全由社区驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [GVM](https://github.com/moovweb/gvm) - **star:4416** GVM 提供了一个接口来管理 Go 版本。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Hey](https://github.com/rakyll/hey) - **star:6073** 压力测试工具，可用来代替 ApacheBench (ab)。![star > 5000][Gold]   
...
* [kubernetes](https://github.com/kubernetes/kubernetes) - **star:54958** 来自谷歌的容器集群管理器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Moby](https://github.com/moby/moby) - **star:54003** Collaborative project for the container ecosystem to assemble container-based systems.![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [script](https://github.com/bitfield/script) - **star:688** 让DevOps编写类shell和系统管理任务变得更加容易。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [StatusOK](https://github.com/sanathp/statusok) - **star:1146** 监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。![star > 1000][Silver]   
* [traefik](https://github.com/containous/traefik) - **star:23213** 反向代理和负载均衡器，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Vegeta](https://github.com/tsenart/vegeta) - **star:11905** HTTP负载测试工具和库。超过9000 !![star > 5000][Gold]   
* [webhook](https://github.com/adnanh/webhook) - **star:3991** 允许用户创建在服务器上执行命令的 HTTP hooks。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Circuit](https://github.com/gocircuit/circuit) - **star:1778** Circuit 是一个可编程平台即服务(PaaS)和/或基础设施即服务(IaaS)，用于管理、发现、同步和编排包含云应用程序的服务和主机。![star > 1000][Silver]   
* [Comcast](https://github.com/tylertreat/Comcast) - **star:6130** 模拟坏的网络连接。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [confd](https://github.com/kelseyhightower/confd) - **star:6328** 使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。![star > 5000][Gold]   
...
* [gfile](https://github.com/Antonito/gfile) - **star:488** 通过WebRTC在两台计算机之间安全地传输文件，不需要任何第三方依赖。![star > 100][Bronze]   
...
* [lgo](https://github.com/yunabe/lgo) - **star:1766** 与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。![star > 1000][Silver]   
* [limetext](http://limetext.org/) - 一个强大而优雅的文本编辑器。
* [LiteIDE](https://github.com/visualfc/liteide) - **star:5421** 简单的、开源的、跨平台的Go IDE。![star > 5000][Gold]   
...
* [myLG](https://github.com/mehrdadrad/mylg) - **star:2187** 命令行网络诊断工具。![star > 1000][Silver]   
...
* [Pipe](https://github.com/b3log/pipe) - **star:2609** 一个小巧漂亮的博客平台。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [restic](https://github.com/restic/restic) - **star:7235** 消除重复项备份程序。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - **star:8057** 快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [toxiproxy](https://github.com/shopify/toxiproxy) - **star:3780** 为自动化测试模拟网络和系统条件的代理。![star > 1000][Silver]   
...
* [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) - **star:976** web框架基准测试。![star > 100][Bronze]   
...
* [GoBooks](https://github.com/dariubs/GoBooks) - **star:6691** 一份精选的 Go 书籍清单。![star > 5000][Gold]   
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) - **star:1466** 由 Maria Letta 提供的与 Gopher 有关的图片包，其中包含了插图,表情文字。![star > 1000][Silver]   
...
* [gophers](https://github.com/egonelbre/gophers) - **star:1552** Free gophers.![star > 1000][Silver]   
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - **star:14391** Curated list of awesome remote jobs. A lot of them are looking for Go hackers.![star > 5000][Gold]   ![最近一个周有更新][Green]
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - **star:24501** 其他 awesome 系列的列表。![star > 5000][Gold]   
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - **star:30985** Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。![star > 5000][Gold]   
...
* [Ethereum Development with Go](https://github.com/miguelmota/ethereum-development-with-go-book) - **star:438** 一本讲述如何用 Go 进行以太开发的小册。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Games With Go](http://gameswithgo.org/) - 关于编程和游戏开发系列教学视频。
* [Go By Example](https://gobyexample.com/) - 手把手教你 如何在 Go 应用程序中使用注释。
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - **star:3974**  Go's reference card。![star > 1000][Silver]   
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) - **star:670** 引入示例讲述 Golang 与Node.js在学习上的差异。![star > 100][Bronze]   
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - **star:3927** 学习使用测试驱动开发。![star > 1000][Silver]   ![最近一个周有更新][Green]
