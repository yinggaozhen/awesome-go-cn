...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-15 22:23:25(每隔1天同步一次)**
...
| [Oto](https://github.com/hajimehoshi/oto)  | 421 |  多平台的 low-level 声音播放库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [PortAudio](https://github.com/gordonklaus/portaudio)  | 300 |  基于 Go 的PortAudio audio I/O库。 |![star > 100][Bronze]   
| [portmidi](https://github.com/rakyll/portmidi)  | 204 |  PortMidi的 Go 语言实现接口。。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [waveform](https://github.com/mdlayher/waveform)  | 246 |  通过音频流生成波形图像的包。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [authboss](https://github.com/volatiletech/authboss)  | 1907 |  web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [branca](https://github.com/hako/branca)  | 70 |  基于 Go 实现Branca令牌。 |
| [casbin](https://github.com/hsluoyz/casbin)  | 4789 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [cookiestxt](https://github.com/mengzhuo/cookiestxt)  | 2 |  提供cookie .txt文件格式的解析器。 |![最近一年没有更新][Yellow]
| [go-jose](https://github.com/square/go-jose)  | 1107 |  相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。 |![star > 1000][Silver]   
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server)  | 1262 |  用 Golang 编写的独立且符合规范的OAuth2服务器。 |![star > 1000][Silver]   
| [gologin](https://github.com/dghubble/gologin)  | 1034 |  用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。 |![star > 1000][Silver]   
| [gorbac](https://github.com/mikespook/gorbac)  | 898 |  轻量级的基于角色的访问控制(RBAC)实现。 |![star > 100][Bronze]   
| [goth](https://github.com/markbates/goth)  | 2235 |  提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。 |![star > 1000][Silver]   
| [httpauth](https://github.com/goji/httpauth)  | 176 |  HTTP身份验证中间件。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [jwt](https://github.com/robbert229/jwt)  | 69 |  简单易用的JSON Web令牌实现(JWT)。 |
| [jwt](https://github.com/pascaldekloe/jwt)  | 77 |  轻量级JSON Web令牌库。 |
| [jwt-auth](https://github.com/adam-hanna/jwt-auth)  | 152 |  JWT中间件，可用于Golang http服务器，提供了许多配置选项。 |![star > 100][Bronze]   
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5808 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]   
| [loginsrv](https://github.com/tarent/loginsrv)  | 799 |  JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [oauth2](https://github.com/golang/oauth2)  | 2350 |  goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [osin](https://github.com/openshift/osin)  | 1535 |  OAuth2服务器库。 |![star > 1000][Silver]   
| [paseto](https://github.com/o1egl/paseto)  | 223 |  平台无关的安全令牌(PASETO)。 |![star > 100][Bronze]   
| [permissions2](https://github.com/xyproto/permissions2)  | 347 |  用于跟踪用户、登录状态和权限的库。依赖于cookie安全和bcrypt。 |![star > 100][Bronze]   
...
| [sjwt](https://github.com/brianvoe/sjwt)  | 28 |  简单的jwt生成器和解析器。 |![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-chat-bot](https://github.com/go-chat-bot/bot)  | 461 |  用 Go 编写的IRC, Slack和电报机器人。 |![star > 100][Bronze]   
...
| [Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot)  | 209 |  基于控制台的，用于加密货币交易所的的交易机器人。 |![star > 100][Bronze]   
...
| [margelet](https://github.com/zhulik/margelet)  | 57 |  构建电报机器人的框架。 |![最近一年没有更新][Yellow]
...
| [telebot](https://github.com/tucnak/telebot)  | 934 |  用Go编写的Telegram bot框架。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api)  | 1586 |  简单轻量级的Telegram bot客户端。 |![star > 1000][Silver]   
...
| [cobra](https://github.com/spf13/cobra)  | 12913 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [commandeer](https://github.com/jaffee/commandeer)  | 83 |  开发友好的CLI应用程序。 |
| [complete](https://github.com/posener/complete)  | 611 |  使用 Go 语言编写的 bash 命令补全工具以及 Go 命令补全工具. |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [docopt.go](https://github.com/docopt/docopt.go)  | 1131 |  会让你满意的命令行参数解析器。 |![star > 1000][Silver]   
| [env](https://github.com/codingconcepts/env)  | 41 |  基于标记的结构化的环境配置。 |
| [flag](https://github.com/cosiner/flag)  | 101 |  简单但功能强大的命令行选项解析库，用于支持Go子命令。 |![star > 100][Bronze]   
...
| [go-arg](https://github.com/alexflint/go-arg)  | 643 |  基于结构的参数解析。 |![star > 100][Bronze]   
...
| [job](https://github.com/liujianping/job)  | 44 |  工作，把你的短期指令当作长期任务。 |
| [kingpin](https://github.com/alecthomas/kingpin)  | 2507 |  支持子命令的命令行和标志解析器。 |![star > 1000][Silver]   
...
| [ops](https://github.com/nanovms/ops)  | 246 |  Unikernel 构建器/协调器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [pflag](https://github.com/spf13/pflag)  | 736 |  基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。 |![star > 100][Bronze]   
| [readline](https://github.com/chzyer/readline)  | 1362 |  纯golang实现，在MIT许可下提供了GNU-Readline的大部分特性。 |![star > 1000][Silver]   
...
| [strumt](https://github.com/antham/strumt)  | 27 |  用于创建提示链。 |![最近一个周有更新][Green]
| [ukautz/clif](https://github.com/ukautz/clif)  | 98 |  简小的命令行接口框架。 |
| [urfave/cli](https://github.com/urfave/cli)  | 11153 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [wlog](https://github.com/dixonwille/wlog)  | 35 |  支持跨平台和并发的简单日志记录接口。 |![最近一年没有更新][Yellow]
| [wmenu](https://github.com/dixonwille/wmenu)  | 81 |  为cli程序提供了简单上手的菜单，可提示用户作出选择。 |
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [asciigraph](https://github.com/guptarohit/asciigraph)  | 1125 |  在命令行中构建轻量级ASCII线图╭┈╯，应用程序中没有其他依赖项。 |![star > 1000][Silver]   
| [aurora](https://github.com/logrusorgru/aurora)  | 612 |  支持fmt.Printf/Sprintf的ANSI终端颜色。 |![star > 100][Bronze]   
...
| [color](https://github.com/fatih/color)  | 2990 |  多功能包装，彩色终端输出。 |![star > 1000][Silver]   
...
| [go-colortext](https://github.com/daviddengcn/go-colortext)  | 198 |  在终端中使用彩色文字。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [go-isatty](https://github.com/mattn/go-isatty)  | 340 |  Go 实现的 isatty。 |![star > 100][Bronze]   
| [go-prompt](https://github.com/c-bata/go-prompt)  | 2278 |  构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) |![star > 1000][Silver]   
| [gocui](https://github.com/jroimartin/gocui)  | 5175 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   
| [gommon/color](https://github.com/labstack/gommon/tree/master/color)  | - |  更换终端文本样式。 |
| [gookit/color](https://github.com/gookit/color)  | 194 |  终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。 |![star > 100][Bronze]   
| [mpb](https://github.com/vbauerster/mpb)  | 502 |  可在终端显示多进度条。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [termbox-go](https://github.com/nsf/termbox-go)  | 3450 |  基于文本的跨平台接口库。 |![star > 1000][Silver]   
| [termdash](https://github.com/mum4k/termdash)  | 791 |  此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [termui](https://github.com/gizak/termui)  | 8839 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]   
| [uilive](https://github.com/gosuri/uilive)  | 821 |  用于实时更新终端输出的库。 |![star > 100][Bronze]   
| [uiprogress](https://github.com/gosuri/uiprogress)  | 1521 |  在终端呈现进度条，可灵活配置的。 |![star > 1000][Silver]   
...
| [configure](https://github.com/paked/configure)  | 49 |  通过多个源提供配置，包括JSON、flags和环境变量。 |
...
| [env](https://github.com/caarlos0/env)  | 841 |  解析环境变量并赋值到struct中(默认值)。 |![star > 100][Bronze]   
| [envcfg](https://github.com/tomazk/envcfg)  | 90 |  对环境变量进行解析，并赋值到struct。 |![最近一年没有更新][Yellow]
| [envconf](https://github.com/ian-kent/envconf)  | 7 |  从环境配置中读取配置。 |![最近一年没有更新][Yellow]
| [envconfig](https://github.com/vrischmann/envconfig)  | 146 |  从环境变量中读取配置。 |![star > 100][Bronze]   
...
| [goConfig](https://github.com/crgimenes/goConfig)  | 103 |  将结构体解析为输入，并用来自命令行、环境变量和配置文件的参数填充该结构体的字段。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [godotenv](https://github.com/joho/godotenv)  | 2070 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]   
...
| [harvester](https://github.com/beatlabs/harvester)  | 36 |  一个易于使用的静态和动态配置包 |![最近一个周有更新][Green]
...
| [ini](https://github.com/go-ini/ini)  | 1547 |   读和写INI文件。 |![star > 1000][Silver]   
...
| [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig)  | 2369 |  管理来自环境变量的配置数据。 |![star > 1000][Silver]   
| [koanf](https://github.com/knadh/koanf)  | 74 |  轻量级可扩展库，用于读取Go应用程序中的配置。内置支持JSON, TOML, YAML, env，命令行。 |
| [konfig](https://github.com/lalamove/konfig)  | 509 |  可组合、可观察和高性能的分布式配置管理。 |![star > 100][Bronze]   
...
| [viper](https://github.com/spf13/viper)  | 9089 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18781 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algorithms](https://github.com/shady831213/algorithms)  | 230 |  算法和数据结构。来源于CLRS。 |![star > 100][Bronze]   
...
| [boomfilters](https://github.com/tylertreat/BoomFilters)  | 1126 |  用于处理连续的概率数据结构。 |![star > 1000][Silver]   
...
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter)  | 501 |  布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。 |![star > 100][Bronze]   
| [deque](https://github.com/edwingeng/deque)  | 5 |  高度优化的双端队列。 |
| [deque](https://github.com/gammazero/deque)  | 61 |  快速环缓冲区deque(双端队列)。 |
...
| [go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree)  | 86 |  自适应基数树。 |
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5076 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]   
...
| [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue)  | 25 |  并行FIFO队列。 |
| [gods](https://github.com/emirpasic/gods)  | 6160 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]   
| [golang-set](https://github.com/deckarep/golang-set)  | 1135 |  线程安全和非线程安全的高性能集。 |![star > 1000][Silver]   
...
| [hilbert](https://github.com/google/hilbert)  | 178 |  用于映射空间填充曲线（例如 Hilbert 曲线和 Peano 曲线）和数值。 |![star > 100][Bronze]   
| [hyperloglog](https://github.com/axiomhq/hyperloglog)  | 661 |  HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |![star > 100][Bronze]   
...
| [levenshtein](https://github.com/agnivade/levenshtein)  | 53 |  实现在Go中计算levenshtein距离。 |
...
| [roaring](https://github.com/RoaringBitmap/roaring)  | 647 |  实现了压缩 bitsets 的Go包。 |![star > 100][Bronze]   
...
| [ttlcache](https://github.com/diegobernardes/ttlcache)  | 92 |  基于内存的LRU算法实现。 |
| [typ](https://github.com/gurukami/typ)  | 9 |  从复杂结构中获取值，支持空类型、安全的类型转换。 |
| [willf/bloom](https://github.com/willf/bloom)  | 652 |  实现Bloom过滤器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6164 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [bcache](https://github.com/iwanbk/bcache)  | 26 |  基于内存的最终一致的分布式缓存。 |
| [BigCache](https://github.com/allegro/bigcache)  | 2408 |  高效的键/值缓存为千兆字节的数据。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [bolt](https://github.com/boltdb/bolt)  | 9901 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
| [cache2go](https://github.com/muesli/cache2go)  | 986 |  基于内存的 K/V 缓存，支持超时的自动失效。 |![star > 100][Bronze]   
| [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache)  | 29 |  BigCache 支持集群和独立且生命周期存储项。 |![最近一年没有更新][Yellow]
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16623 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [couchcache](https://github.com/codingsince1985/couchcache)  | 40 |  由 Couchbase服务 支持的RESTful缓存微服务。 |
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL)  | 1438 |  区块链领域的一个SQL数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10011 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [diskv](https://github.com/peterbourgon/diskv)  | 741 |  支持磁盘备份的可持久化 K/V 存储。 |![star > 100][Bronze]   
| [eliasdb](https://github.com/krotik/eliasdb)  | 532 |  无其他依赖项，支持REST API，短语搜索和sql类似的查询语言的事务图数据库。 |![star > 100][Bronze]   
| [fastcache](https://github.com/VictoriaMetrics/fastcache)  | 471 |  基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。 |![star > 100][Bronze]   
| [GCache](https://github.com/bluele/gcache)  | 871 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]   
| [go-cache](https://github.com/pmylund/go-cache)  | 2819 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]   
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3121 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]   
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7581 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]   
| [influxdb](https://github.com/influxdb/influxdb)  | 16796 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [ledisdb](https://github.com/siddontang/ledisdb)  | 3049 |  Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。 |![star > 1000][Silver]   
| [levigo](https://github.com/jmhodges/levigo)  | 365 |  实现了对LevelDB封装。 |![star > 100][Bronze]   
| [moss](https://github.com/couchbase/moss)  | 715 |  Moss是一个用100% Go编写的简单LSM键值存储引擎。 |![star > 100][Bronze]   
| [nutsdb](https://github.com/xujiajun/nutsdb)  | 848 |  Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。 |![star > 100][Bronze]   
| [piladb](https://github.com/fern4lvarez/piladb)  | 171 |  基于堆栈数据结构的轻量级RESTful数据库引擎。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [prometheus](https://github.com/prometheus/prometheus)  | 25104 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 219 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]   
| [rqlite](https://github.com/rqlite/rqlite)  | 4658 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   
...
| [tidb](https://github.com/pingcap/tidb)  | 19686 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [tiedot](https://github.com/HouzuoGuo/tiedot)  | 2358 |  属于你的NoSQL数据库。 |![star > 1000][Silver]   
| [Vasto](https://github.com/chrislusf/vasto)  | 143 |  分布式高性能键值存储。可做磁盘备份。最终一致。高可用。能够在不中断服务的情况下增长或收缩。 |![star > 100][Bronze]   
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 918 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [darwin](https://github.com/GuiaBolso/darwin)  | 84 |  用于数据库 schema 升级的库。 |
| [go-fixtures](https://github.com/RichardKnop/go-fixtures)  | 19 |  类似 Django fixture，用于 Go 建立内置数据库/sql库。 |
...
| [gormigrate](https://github.com/go-gormigrate/gormigrate)  | 323 |  面向Gorm ORM的数据库 schema 迁移辅助程序。 |![star > 100][Bronze]   
| [migrate](https://github.com/golang-migrate/migrate)  | 2495 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sql-migrate](https://github.com/rubenv/sql-migrate)  | 1383 |  数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [chproxy](https://github.com/Vertamedia/chproxy)  | 296 |  ClickHouse数据库的HTTP代理。 |![star > 100][Bronze]   
| [clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk)  | 127 |  收集小的 insterts 并向 ClickHouse 服务器发送大请求。 |![star > 100][Bronze]   
...
| [go-mysql](https://github.com/siddontang/go-mysql)  | 1831 |   Go 工具集，用于处理MySQL协议和复制。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2309 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]   
| [kingshard](https://github.com/flike/kingshard)  | 4558 |  kingshard 是基于 Golang 的MySQL高性能代理。 |![star > 1000][Silver]   
| [myreplication](https://github.com/2tvenom/myreplication)  | 142 |  MySql二进制日志复制监听器。支持基于语句和行的复制。 |![star > 100][Bronze]   
| [octillery](https://github.com/knocknote/octillery)  | 51 |  用于数据库分表(支持每个ORM或原生SQL)。 |![最近一个周有更新][Green]
| [orchestrator](https://github.com/github/orchestrator)  | 2982 |  MySQL复制拓扑管理器和可视化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pgweb](https://github.com/sosedoff/pgweb)  | 5945 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]   
| [prep](https://github.com/hexdigest/prep)  | 24 |  在不更改代码的情况下使用准备好的SQL语句。 |![最近一年没有更新][Yellow]
| [pREST](https://github.com/nuveo/prest)  | 2071 |  基于PostgreSQL database的RESTful API服务。 |![star > 1000][Silver]   
| [rwdb](https://github.com/andizzle/rwdb)  | 10 |  rwdb为多个数据库服务器的设置提供读取副本功能。 |![最近一年没有更新][Yellow]
| [vitess](https://github.com/youtube/vitess)  | 8322 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [Dotsql](https://github.com/gchaincl/dotsql)  | 438 |  Go library帮助您将sql文件保存在一个地方，并轻松地使用它们。 |![star > 100][Bronze]   
| [gendry](https://github.com/didi/gendry)  | 737 |  非入侵的SQL构建器和强大的数据绑定器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [godbal](https://github.com/xujiajun/godbal)  | 50 |  数据库抽象层(dbal)。支持SQL builder，轻松获取结果。 |
| [goqu](https://github.com/doug-martin/goqu)  | 595 |  常用的SQL生成器和查询库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [sqrl](https://github.com/elgris/sqrl)  | 174 |  SQL查询生成器，从Squirrel fork而来，并再此基础上对性能做了优化。 |![star > 100][Bronze]   
| [Squalus](https://gitlab.com/qosenergy/squalus)  | - |  Go SQL中间层，能使得执行查询更加容易。 |
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2210 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]   
| [xo](https://github.com/knq/xo)  | 2145 |  基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。 |![star > 1000][Silver]   
...
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb)  | 1005 |  微软MSSQL驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-oci8](https://github.com/mattn/go-oci8)  | 398 |  Oracle 驱动程序。 |![star > 100][Bronze]   
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 7949 |  MySQL驱动程序。 |![star > 5000][Gold]   
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3382 |  SQLite3驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gofreetds](https://github.com/minus5/gofreetds)  | 90 |  基于[FreeTDS](http://www.freetds.org)封装的微软MSSQL Go 驱动。 |
| [goracle](https://github.com/go-goracle/goracle)  | 229 |  基于 ODPI-C 的 Oracle 驱动程序 |![star > 100][Bronze]   
| [pgx](https://github.com/jackc/pgx)  | 1872 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pq](https://github.com/lib/pq)  | 5106 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   
...
| [go-couchbase](https://github.com/couchbase/go-couchbase)  | 292 |  Couchbase客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-couchdb](https://github.com/fjl/go-couchdb)  | 51 |  基于 Go 的 Yet another CouchDB 的 Http 接口封装。 |![最近一个周有更新][Green]
| [go-pilosa](https://github.com/pilosa/go-pilosa)  | 32 |   Pilosa客户端。 |![最近一个周有更新][Green]
...
| [gorethink](https://github.com/dancannon/gorethink)  | 1455 |  RethinkDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goriak](https://github.com/zegl/goriak)  | 24 |   Riak KV 驱动。 |
| [mgo](https://github.com/globalsign/mgo)  | 1616 |  (已停止维护) MongoDB驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 2955 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6179 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   
| [redis](https://github.com/go-redis/redis)  | 6292 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5760 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4040 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [elasticsql](https://github.com/cch123/elasticsql)  | 376 |  将 SQL 转换为 elasticsearch dsl。 |![star > 100][Bronze]   
| [elastigo](https://github.com/mattbaird/elastigo)  | 948 |  Elasticsearch 客户端。 |![star > 100][Bronze]   
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch)  | 1498 |  官方 Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goes](https://github.com/OwnLocal/goes)  | 24 |  实现了与 Elasticsearch 交互的库。 |![最近一年没有更新][Yellow]
| [riot](https://github.com/go-ego/riot)  | 4643 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   
...
| [cayley](https://github.com/google/cayley)  | 12624 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dateparse](https://github.com/araddon/dateparse)  | 880 |  可以解析很多格式不固定的日期字符串。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [durafmt](https://github.com/hako/durafmt)  | 237 |  轻量级、可让time.Duration更加易读的库。 |![star > 100][Bronze]   
...
| [now](https://github.com/jinzhu/now)  | 2148 |  now 是时间有关的工具类。 |![star > 1000][Silver]   
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2472 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [emitter-io](https://github.com/emitter-io/emitter)  | 1889 |  高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。 |![star > 1000][Silver]   
| [flowgraph](https://github.com/vectaport/flowgraph)  | 18 |  flow-based programming package。 |
| [gleam](https://github.com/chrislusf/gleam)  | 2051 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]   
| [glow](https://github.com/chrislusf/glow)  | 2500 |  全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。 |![star > 1000][Silver]   
...
| [go-kit](https://github.com/go-kit/kit)  | 14213 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]   
| [gorpc](https://github.com/valyala/gorpc)  | 548 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8855 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 993 |  支持25+种语言RPC库。 |![star > 100][Bronze]   
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8472 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1692 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [micro](https://github.com/micro/micro)  | 6482 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [NATS](https://github.com/nats-io/gnatsd)  | 6144 |  轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [raft](https://github.com/hashicorp/raft)  | 2802 |  Raft consensus协议的实现。 by HashiCorp。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [raft](https://github.com/coreos/etcd/tree/master/raft)  | - |  Raft consensus协议的实现。 by CoreOS。 |
| [redis-lock](https://github.com/bsm/redis-lock)  | 145 |  基于redis的分布式锁简易实现。 |![star > 100][Bronze]   
...
| [rpcx](https://github.com/smallnest/rpcx)  | 3699 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]   
| [sleuth](https://github.com/ursiform/sleuth)  | 298 |  用于HTTP服务之间进行无中心p2p自动发现和RPC通信的库(使用[ZeroMQ](https://github.com/zeromq/libzmq))。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [tendermint](https://github.com/tendermint/tendermint)  | 3085 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [torrent](https://github.com/anacrolix/torrent)  | 2797 |  BitTorrent 客户端。 |![star > 1000][Silver]   
...
| [email](https://github.com/jordan-wright/email)  | 1082 |  一个强大和灵活的电子邮件库。 |![star > 1000][Silver]   
| [go-dkim](https://github.com/toorop/go-dkim)  | 46 |  DKIM库，用于签署 & 验证电子邮件。 |
| [go-imap](https://github.com/emersion/go-imap)  | 712 |  用于客户端和服务器的IMAP库。 |![star > 100][Bronze]   
| [go-message](https://github.com/emersion/go-message)  | 103 |  用于Internet消息格式化和邮件消息的流媒体库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-premailer](https://github.com/vanng822/go-premailer)  | 34 |  在HTML邮件中支持CSS内联。 |
...
| [hermes](https://github.com/matcornic/hermes)  | 1601 |  可生成干净的、响应式的HTML电子邮件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [MailHog](https://github.com/mailhog/MailHog)  | 5078 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [agora](https://github.com/PuerkitoBio/agora)  | 322 |  基于 Go 的动态类型，可嵌入的编程语言。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [anko](https://github.com/mattn/anko)  | 913 |  用Go编写的解释器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [binder](https://github.com/alexeyco/binder)  | 29 |  Lua接口，基于[gopher-lua](https://github.com/yuin/gopher-lua)。 |
| [expr](https://github.com/antonmedv/expr)  | 671 |  一个可以计算表达式的引擎。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gentee](https://github.com/gentee/gentee)  | 26 |  嵌入式脚本编程语言。 |![最近一个周有更新][Green]
| [gisp](https://github.com/jcla1/gisp)  | 429 |  LISP 的 Go 接口。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [go-duktape](https://github.com/olebedev/go-duktape)  | 649 |  支持 Duktape JavaScript 引擎。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-lua](https://github.com/Shopify/go-lua)  | 1651 |  用 Go 实现的 Lua 5.2 VM接口。 |![star > 1000][Silver]   
| [go-php](https://github.com/deuill/go-php)  | 670 |  PHP 的 Go 接口。 |![star > 100][Bronze]   
| [go-python](https://github.com/sbinet/go-python)  | 897 |  CPython C-API 的 Go 接口。 |![star > 100][Bronze]   
| [golua](https://github.com/aarzilli/golua)  | 435 |  Lua C 的 Go 接口。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2922 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]   
| [gval](https://github.com/PaesslerAG/gval)  | 132 |  一种用Go编写的高度可定制的表达式语言。 |![star > 100][Bronze]   
| [ngaro](https://github.com/db47h/ngaro)  | 19 |  嵌入式 Ngaro VM实现，支持在 Retro 中运行脚本。 |![最近一年没有更新][Yellow]
| [otto](https://github.com/robertkrimen/otto)  | 4672 |  用 Go 编写的 JavaScript 解释器。 |![star > 1000][Silver]   
| [purl](https://github.com/ian-kent/purl)  | 27 |  嵌入 Go 的 Perl 5.18.2。 |![最近一年没有更新][Yellow]
| [tengo](https://github.com/d5/tengo)  | 1275 |  字节码编译的脚本语言。 |![star > 1000][Silver]   
...
| [errors](https://github.com/pkg/errors)  | 4770 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]   
| [errorx](https://github.com/joomcode/errorx)  | 549 |  一个功能丰富的错误包，可进行堆栈跟踪、组装异常信息以及其他。 |![star > 100][Bronze]   
| [go-multierror](https://github.com/hashicorp/go-multierror)  | 710 |  可将一系列的错误作为一个整体来显示。 |![star > 100][Bronze]   
| [tracerr](https://github.com/ztrue/tracerr)  | 492 |  可展示错误的堆栈跟踪信息和源码片段。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2189 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pdfcpu](https://github.com/hhrutter/pdfcpu)  | 932 |  PDF处理器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [skywalker](https://github.com/dixonwille/skywalker)  | 47 |  可以轻松地并发地遍历文件系统。 |![最近一年没有更新][Yellow]
...
| [vfs](https://github.com/C2FO/vfs)  | 20 |  一组可插拔的、可扩展的和自定义的文件系统功能，用于跨越许多文件系统类型，如os、S3和GCS。 |![最近一个周有更新][Green]
...
| [decimal](https://github.com/shopspring/decimal)  | 1567 |  任意精度定点的十进制数。 |![star > 1000][Silver]   
| [go-finance](https://github.com/FlashBoys/go-finance)  | 536 |  综合金融市场数据。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [go-finance](https://github.com/alpeb/go-finance)  | 40 |  用于货币时间价值(年金)、现金流、利率转换、债券和折旧计算的金融函数库。 |![最近一年没有更新][Yellow]
| [go-money](https://github.com/rhymond/go-money)  | 609 |  Fowler 货币模式的实现。 |![star > 100][Bronze]   
| [ofxgo](https://github.com/aclindsa/ofxgo)  | 59 |  查询 OFX 服务器和/或解析响应。 |
| [orderbook](https://github.com/i25959341/orderbook)  | 66 |  限购单匹配引擎。 |
| [techan](https://github.com/sdcoffey/techan)  | 150 |  拥有先进的市场分析和交易策略的技术分析库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [transaction](https://github.com/claygod/transaction)  | 54 |  嵌入式事务数据库，可多线程模式运行。 |
...
| [form](https://github.com/go-playground/form)  | 347 |   将 url 中的数据解析到 Go 变量中，以及将 Go 语言变量编码进 url。支持 Dual Array 及 Full map。 |![star > 100][Bronze]   
| [formam](https://github.com/monoculum/formam)  | 123 |  将表单的值解码为 struct。 |![star > 100][Bronze]   
| [forms](https://github.com/albrow/forms)  | 103 |  与框架无关的库，用于解析和验证支持多部分表单和文件的表单/JSON数据。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gorilla/csrf](https://github.com/gorilla/csrf)  | 427 |  用于Go web应用程序和服务的CSRF保护。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [nosurf](https://github.com/justinas/nosurf)  | 961 |  CSRF保护中间件。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [fpGo](https://github.com/TeaEntityLab/fpGo)  | 103 |  提供函数式编程功能。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [fuego](https://github.com/seborama/fuego)  | 33 |  Functional Experiment in Go。 |
| [go-underscore](https://github.com/tobyhede/go-underscore)  | 1063 |  常用辅助方法集合。 |![star > 1000][Silver]   
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1800 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [engo](https://github.com/EngoEngine/engo)  | 1076 |  开源 2D 游戏引擎。它遵循 Entity-Component-System 范式。 |![star > 1000][Silver]   
| [g3n](https://github.com/g3n/engine)  | 733 |   3D游戏引擎。 |![star > 100][Bronze]   
...
| [go-sdl2](https://github.com/veandco/go-sdl2)  | 1140 |  实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1142 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   
| [Leaf](https://github.com/name5566/leaf)  | 3019 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   
...
| [Pitaya](https://github.com/topfreegames/pitaya)  | 291 |  可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity。 |![star > 100][Bronze]   
| [Pixel](https://github.com/faiface/pixel)  | 2394 |  手工制作的 2D 游戏库。 |![star > 1000][Silver]   
| [raylib-go](https://github.com/gen2brain/raylib-go)  | 378 |  实现了 [raylib](http://www.raylib.com/)，一个简单易用的库，用于学习视频游戏编程。 |![star > 100][Bronze]   
...
| [go-linq](https://github.com/ahmetalpbalkan/go-linq)  | 1777 |  提供类似 .NET LINQ 的查询方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goderive](https://github.com/awalterschulze/goderive)  | 728 |  从输入类型来派生函数。 |![star > 100][Bronze]   
...
| [jennifer](https://github.com/dave/jennifer)  | 1258 |  不使用模板生成任意 Go 代码。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [geocache](https://github.com/melihmucuk/geocache)  | 107 |  基于内存缓存的的地理位置的应用程序。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [osm](https://github.com/paulmach/osm)  | 62 |  用于读取、写入和处理 OpenStreetMap 数据和 APIs。 |
...
| [Tile38](https://github.com/tidwall/tile38)  | 6279 |  具有空间索引和实时地理定位功能的地理定位数据库。 |![star > 5000][Gold]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [c4go](https://github.com/Konstantin8105/c4go)  | 143 |  将 C 代码转换为 Go 代码。 |![star > 100][Bronze]   
| [f4go](https://github.com/Konstantin8105/f4go)  | 11 |  将 FORTRAN 77 转换为 Go代码。 |
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8472 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1782 |  一个高性能的协程池。 |![star > 1000][Silver]   
...
| [go-floc](https://github.com/workanator/go-floc)  | 168 |  轻松编排 goroutines。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [goworker](https://github.com/benmanns/goworker)  | 2227 |  基于 go 的后台 worker。 |![star > 1000][Silver]   
| [gpool](https://github.com/Sherifabdlnaby/gpool)  | 58 |  manages a resizeable pool of context-aware goroutines to bound concurrency |
| [grpool](https://github.com/ivpusic/grpool)  | 491 |  轻量级协程池。 |![star > 100][Bronze]   
...
| [pool](https://github.com/go-playground/pool)  | 473 |  有限消费者协程或无限协程池，可用于更加简单的处理和取消协程 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [tunny](https://github.com/Jeffail/tunny)  | 1312 |  golang 的协程池。 |![star > 1000][Silver]   
| [worker-pool](https://github.com/vardius/worker-pool)  | 44 |  一个简单的 Go 异步工作池。 |
| [workerpool](https://github.com/gammazero/workerpool)  | 126 |  限制任务执行并发数，而不是队列中的任务数量的协程池，。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [app](https://github.com/murlokswarm/app)  | 2929 |  用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。 |![star > 1000][Silver]   
| [fyne](https://github.com/fyne-io/fyne)  | 6106 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [go-astilectron](https://github.com/asticode/go-astilectron)  | 2617 |  使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。 |![star > 1000][Silver]   
| [go-gtk](http://mattn.github.io/go-gtk/)  | - |  实现了 GTK 的 Go接口。 |
| [go-sciter](https://github.com/sciter-sdk/go-sciter)  | 1429 |  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。 |![star > 1000][Silver]   
| [gotk3](https://github.com/gotk3/gotk3)  | 752 |  实现了 GTK3 的 Go接口。 |![star > 100][Bronze]   
| [gowd](https://github.com/dtylman/gowd)  | 207 |  跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。 |![star > 100][Bronze]   
| [qt](https://github.com/therecipe/qt)  | 5895 |  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。 |![star > 5000][Gold]   
| [ui](https://github.com/andlabs/ui)  | 6851 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]   
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3649 |  Windows应用程序库。 |![star > 1000][Silver]   
| [webview](https://github.com/zserge/webview)  | 4558 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4379 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [systray](https://github.com/getlantern/systray)  | 766 |  跨平台 Go 库，可在通知区放置图标和菜单。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bild](https://github.com/anthonynsimon/bild)  | 2025 |  纯Go语言实现的图像处理算法合集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [bimg](https://github.com/h2non/bimg)  | 779 |  使用libvips实现的快速高效的图像处理包。 |![star > 100][Bronze]   
...
| [geopattern](https://github.com/pravj/geopattern)  | 1007 |  由字符串创建漂亮图案的图片生成器。 |![star > 1000][Silver]   
| [gg](https://github.com/fogleman/gg)  | 1887 |  纯Go语言实现的2D渲染。 |![star > 1000][Silver]   
| [gift](https://github.com/disintegration/gift)  | 1207 |  图像处理包。 |![star > 1000][Silver]   
| [gltf](https://github.com/qmuntal/gltf)  | 35 |  一个高效、健壮的glTF 2.0文件读取、写入和验证器。 |
...
| [go-nude](https://github.com/koyachi/go-nude)  | 287 |  Go语言实现的裸照检测工具。 |![star > 100][Bronze]   
...
| [gocv](https://github.com/hybridgroup/gocv)  | 2392 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goimagehash](https://github.com/corona10/goimagehash)  | 208 |   图像哈希处理的Go语言包。 |![star > 100][Bronze]   
...
| [image2ascii](https://github.com/qeesung/image2ascii)  | 284 |  将图像转换为ASCII码。 |![star > 100][Bronze]   
| [imagick](https://github.com/gographics/imagick)  | 955 |   ImageMagick下MagickWand的C API的Go binding。 |![star > 100][Bronze]   
| [imaginary](https://github.com/h2non/imaginary)  | 2558 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [imaging](https://github.com/disintegration/imaging)  | 2481 |  简单的Go图像处理包。 |![star > 1000][Silver]   
| [img](https://github.com/hawx/img)  | 129 |  图像处理工具的集合。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [ln](https://github.com/fogleman/ln)  | 2456 |  Go实现的3D线艺术（3D Line Art）渲染。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
| [picfit](https://github.com/thoas/picfit)  | 1052 |  Go实现的图像调整服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [rez](https://github.com/bamiaux/rez)  | 188 |  纯Go语言和SIMD实现的图像大小调整。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [smartcrop](https://github.com/muesli/smartcrop)  | 1245 |  为任意图片寻找合适的位置进行图片裁剪。 |![star > 1000][Silver]   
...
| [svgo](https://github.com/ajstarks/svgo)  | 1314 |   Go实现的SVG生成库。 |![star > 1000][Silver]   
...
| [devices](https://github.com/goiot/devices)  | 226 |  一套用于物联网设备的库，实验性地用于x/exp/io。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [eywa](https://github.com/xcodersun/eywa)  | 36 |  Eywa是一个用于跟踪连接的设备连接管理器。 |![最近一年没有更新][Yellow]
| [flogo](https://github.com/tibcosoftware/flogo)  | 1105 |  Flogo是一个面向物联网边缘应用和集成的开源框架。 |![star > 1000][Silver]   
...
| [mainflux](https://github.com/Mainflux/mainflux)  | 570 |  工业物联网消息和设备管理服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [JobRunner](https://github.com/bamzi/jobrunner)  | 562 |  智能和功能丰富的cron作业调度程序（包含任务队列和实时监控）。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4783 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-respond](https://github.com/nicklaw5/go-respond)  | 21 |  用于处理常见的HTTP JSON响应的Go语言库。 |
| [gojq](https://github.com/elgs/gojq)  | 139 |  Go语言实现的JSON请求。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gojson](https://github.com/ChimeraCoder/gojson)  | 2020 |  从JSON自动生成Go的结构（struct）定义。 |![star > 1000][Silver]   
...
| [kazaam](https://github.com/Qntfy/kazaam)  | 128 |  用于任意JSON文档转换的API。 |![star > 100][Bronze]   
...
| [glo](https://github.com/lajosbencz/glo)  | 7 |  参照PHP的Monolog实现的具有相同日志等级的Go日志库。 |
| [glog](https://github.com/golang/glog)  | 2282 |  为Go提供了多等级日志记录。 |![star > 1000][Silver]   
...
| [go-logger](https://github.com/apsdehal/go-logger)  | 231 |  简单的日志程序的 Go 程序，与级别处理程序。 |![star > 100][Bronze]   
| [gologger](https://github.com/sadlil/gologger)  | 40 |  为Go提供方便简单的日志操作; 在彩色控制台，简单控制台，文件或Elasticsearch上。 |![最近一年没有更新][Yellow]
...
| [log](https://github.com/apex/log)  | 725 |  Go的结构化日志包。 |![star > 100][Bronze]   
...
| [log15](https://github.com/inconshreveable/log15)  | 878 |  简单、强大的日志操作。 |![star > 100][Bronze]   
...
| [logmatic](https://github.com/borderstech/logmatic)  | 7 |  Go的彩色日志记录器，带有可配置的日志级别。 |
| [logo](https://github.com/mbndr/logo)  | 4 |  Go的日志工具，可配置的日志写入器。 |![最近一年没有更新][Yellow]
| [logrus](https://github.com/Sirupsen/logrus)  | 11650 |  Go的结构化日志操作 。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [lumberjack](https://github.com/natefinch/lumberjack)  | 1401 |  简单的滚动日志，io.WriteCloser的实现。 |![star > 1000][Silver]   
...
| [seelog](https://github.com/cihub/seelog)  | 1341 |  具有灵活调度、过滤和格式化的日志功能。 |![star > 1000][Silver]   
| [spew](https://github.com/davecgh/go-spew)  | 3249 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]   
| [stdlog](https://github.com/alexcesaro/log)  | 43 |  Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。 |![最近一年没有更新][Yellow]
| [tail](https://github.com/hpcloud/tail)  | 1512 |  努力模拟实现BSD的tail的特性的Go包。 |![star > 1000][Silver]   
...
| [zap](https://github.com/uber-go/zap)  | 7266 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [zerolog](https://github.com/rs/zerolog)  | 2112 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   
...
| [go-deep](https://github.com/patrikeh/go-deep)  | 215 |  一个功能丰富的神经网络库 。 |![star > 100][Bronze]   
...
| [gobrain](https://github.com/goml/gobrain)  | 373 |  用 Go 编写的神经网络库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [godist](https://github.com/e-dard/godist)  | 24 |  各种概率分布，以及相关的method。 |![最近一年没有更新][Yellow]
| [goga](https://github.com/tomcraven/goga)  | 79 |  Go的遗传算法库。 |![最近一年没有更新][Yellow]
| [GoLearn](https://github.com/sjwhitworth/golearn)  | 6619 |  通用机器学习库。 |![star > 5000][Gold]   
...
| [gorgonia](https://github.com/chewxy/gorgonia)  | 2658 |  基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。 |![star > 1000][Silver]   
| [gorse](https://github.com/zhenghaoz/gorse)  | 516 |  基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [goscore](https://github.com/asafschers/goscore)  | 34 |   为预言模型标记语言（PMML）实现的评分API。 |
| [gosseract](https://github.com/otiai10/gosseract)  | 852 |  使用c++的Tesseract库实现的OCR。 |![star > 100][Bronze]   
...
| [regommend](https://github.com/muesli/regommend)  | 244 |  推荐和协同过滤引擎。 |![star > 100][Bronze]   
| [shield](https://github.com/eaigner/shield)  | 124 |  贝叶斯文本分类器，具有灵活的tokenizers和存储后端。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [tfgo](https://github.com/galeone/tfgo)  | 1169 |  易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [APNs2](https://github.com/sideshow/apns2)  | 2031 |  HTTP / 2苹果消息推送provider——发送推送消息到iOS, tvOS, Safari和OSX应用。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Beaver](https://github.com/Clivern/Beaver)  | 714 |  一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。 |![star > 100][Bronze]   
| [Benthos](https://github.com/Jeffail/benthos)  | 1924 |  一系列协议之间的消息流桥接。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Bus](https://github.com/mustafaturan/bus)  | 112 |  内部通信的最小消息总线实现。 |![star > 100][Bronze]   
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3626 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   
...
| [dbus](https://github.com/godbus/dbus)  | 351 |  D-Bus的Go bindings。 |![star > 100][Bronze]   
| [drone-line](https://github.com/appleboy/drone-line)  | 59 |  使用二进制、docker或Drone CI发送[Line](https://at.line.me/en)通知。 |
...
| [EventBus](https://github.com/asaskevich/EventBus)  | 546 |  具有异步兼容性的轻量级事件总线。 |![star > 100][Bronze]   
...
| [go-nsq](https://github.com/nsqio/go-nsq)  | 1441 |  NSQ的官方Go包。 |![star > 1000][Silver]   
| [go-socket.io](https://github.com/googollee/go-socket.io)  | 2846 |  go的socket.io库，一个实时应用程序框架。 |![star > 1000][Silver]   
...
| [golongpoll](https://github.com/jcuga/golongpoll)  | 421 |  HTTP longpoll服务器库，使web发布-订阅变得简单。 |![star > 100][Bronze]   
...
| [gorush](https://github.com/appleboy/gorush)  | 3658 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3326 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mangos](https://github.com/go-mangos/mangos)  | 1531 |  Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。 |![star > 1000][Silver]   
| [melody](https://github.com/olahol/melody)  | 1527 |  处理websocket session的极简框架，包括广播和自动ping/pong处理。 |![star > 1000][Silver]   
| [Mercure](https://github.com/dunglas/mercure)  | 1451 |  使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。 |![star > 1000][Silver]   
| [messagebus](https://github.com/vardius/message-bus)  | 63 |  messagebus是一个Go的简单异步消息总线，非常适合在执行事件sourcing、CQRS和DDD时用作事件总线。 |
| [NATS Go Client](https://github.com/nats-io/nats)  | 2351 |  轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [nsq-event-bus](https://github.com/rafaeljesus/nsq-event-bus)  | 49 |  一个围绕NSQ topic和channel的小工具。 |![最近一年没有更新][Yellow]
...
| [RapidMQ](https://github.com/sybrexsys/RapidMQ)  | 55 |  RapidMQ是用于管理本地消息队列的轻量且可靠的库。 |![最近一年没有更新][Yellow]
| [rmqconn](https://github.com/sbabiv/rmqconn)  | - |  RabbitMQ重新连接。amqp.Connection和amqp.Dial之上的Wrapper。允许在强制调用Close()方法关闭连接之前重新连接。 |
| [sarama](https://github.com/Shopify/sarama)  | 4527 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Uniqush-Push](https://github.com/uniqush/uniqush-push)  | 1093 |  Redis支持的统一推送服务, 用于服务端向移动设备的消息通知。 |![star > 1000][Silver]   
| [zmq4](https://github.com/pebbe/zmq4)  | 771 |  ZeroMQ的Go interface第4版。也可用于[第3版](https://github.com/pebbe/zmq3)和[第2版](https://github.com/pebbe/zmq2)。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1642 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4349 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3312 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]   
...
| [dig](https://github.com/uber-go/dig)  | 877 |  一个基于反射的Go依赖注入工具包。 |![star > 100][Bronze]   
| [fx](https://github.com/uber-go/fx)  | 646 |  基于依赖注入的Go应用程序框架(构建在dig之上)。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gocontainer](https://github.com/vardius/gocontainer)  | 7 |  简单的依赖注入容器。 |
| [inject](https://github.com/defval/inject)  | 18 |  一个基于反射的依赖注入容器，具有简单的接口。 |![最近一个周有更新][Green]
| [linker](https://github.com/logrange/linker)  | 3 |  A reflection based dependency injection and inversion of control library with components lifecycle support. |
| [wire](https://github.com/Fs02/wire)  | 19 |  适用于Go的严格运行时依赖注入(Strict Runtime Dependency Injection)。 |![最近一个周有更新][Green]
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8645 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [strutil](https://github.com/ozgio/strutil)  | 62 |  字符串工具。 |
...
| [archiver](https://github.com/mholt/archiver)  | 2461 |  用于生成和提取.zip和.tar.gz存档的库和命令。 |![star > 1000][Silver]   
...
| [banner](https://github.com/dimiro1/banner)  | 230 |  在Go应用程序中添加漂亮的横幅。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [base64Captcha](https://github.com/mojocn/base64Captcha)  | 614 |  Base64captch支持数字，数字，字母，算术，音频和数字-字母验证码。 |![star > 100][Bronze]   
| [battery](https://github.com/distatus/battery)  | 135 |  跨平台、标准化的电池信息库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [conv](https://github.com/cstockton/go-conv)  | 341 |  包conv提供了跨Go类型的快速和直观的转换。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [ghorg](https://github.com/gabrie30/ghorg)  | 22 |  将所有repos从GitHub org复制到一个目录中。 |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool)  | 659 |  Golang的通用对象池。 |![star > 100][Bronze]   
| [go-openapi](https://github.com/go-openapi)  | - |  用于解析和利用开放api模式的包的集合。 |
| [go-resiliency](https://github.com/eapache/go-resiliency)  | 838 |   Go 的弹性模式。 |![star > 100][Bronze]   
| [go-unarr](https://github.com/gen2brain/go-unarr)  | 66 |  用于RAR、TAR、ZIP和7z存档的解压缩库。 |
| [gofakeit](https://github.com/brianvoe/gofakeit)  | 404 |  用go编写的随机数据生成器。 |![star > 100][Bronze]   
| [gommit](https://github.com/antham/gommit)  | 65 |  分析git提交消息，确保它们遵循已定义的模式。 |
| [gopsutil](https://github.com/shirou/gopsutil)  | 3845 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [health](https://github.com/dimiro1/health)  | 359 |  易于使用，可扩展的健康检查库。 |![star > 100][Bronze]   
| [healthcheck](https://github.com/etherlabsio/healthcheck)  | 78 |  用于RESTful服务的自以为是的并发健康检查HTTP处理程序。 |
...
| [lk](https://github.com/hyperboloide/lk)  | 113 |  一个简单的golang授权库。 |![star > 100][Bronze]   
...
| [persian](https://github.com/mavihq/persian)  | 34 |  一些实用的波斯语在 Go 。 |
...
| [stats](https://github.com/go-playground/stats)  | 120 |  显示器 Go MemStats +系统统计，如内存，交换和CPU，并通过UDP发送到任何地方，你想记录等… |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [turtle](https://github.com/hackebrot/turtle)  | 73 |  Emojis Go 。 |![最近一年没有更新][Yellow]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [getlang](https://github.com/rylans/getlang)  | 71 |  快速自然语言检测包。 |
...
| [go-pinyin](https://github.com/mozillazg/go-pinyin)  | 515 |  中文汉字到汉语拼音的转换。 |![star > 100][Bronze]   
...
| [gojieba](https://github.com/yanyiwu/gojieba)  | 798 |  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。 |![star > 100][Bronze]   
...
| [nlp](https://github.com/james-bowman/nlp)  | 213 |  支持LSA(潜在语义分析)的Go自然语言处理库。 |![star > 100][Bronze]   
...
| [prose](https://github.com/jdkato/prose)  | 2030 |  用于支持标记化、词性标记、名称实体提取等文本处理的库。 |![star > 1000][Silver]   
| [RAKE.go](https://github.com/Obaied/RAKE.go)  | 45 |  快速自动关键字提取算法(RAKE)的Go端口。 |
| [segment](https://github.com/blevesearch/segment)  | 47 |  Go library for performing Unicode Text Segmentation as described in [Unicode Standard Annex #29](http://www.unicode.org/reports/tr29/) |![最近一年没有更新][Yellow]
...
| [whatlanggo](https://github.com/abadojack/whatlanggo)  | 347 |  Go的自然语言检测包。支持84种语言和24种脚本(书写系统，如拉丁语、西里尔语等)。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [arp](https://github.com/mdlayher/arp)  | 191 |  包arp实现了arp协议，如RFC 826中所述。 |![star > 100][Bronze]   
...
| [cidranger](https://github.com/yl2chen/cidranger)  | 382 |  快速IP到CIDR查找 Go 。 |![star > 100][Bronze]   
| [dhcp6](https://github.com/mdlayher/dhcp6)  | 61 |  包dhcp6实现了一个DHCPv6服务器，如RFC 3315所述。 |
| [dns](https://github.com/miekg/dns)  | 3748 |  使用DNS的库。 |![star > 1000][Silver]   
| [ether](https://github.com/songgao/ether)  | 62 |  用于发送和接收以太网帧的跨平台Go包。 |![最近一年没有更新][Yellow]
| [ethernet](https://github.com/mdlayher/ethernet)  | 182 |  包以太网实现了对IEEE 802.3以太网II帧和IEEE 802.1Q VLAN标签的编组和解组。 |![star > 100][Bronze]   
| [fasthttp](https://github.com/valyala/fasthttp)  | 9102 |  软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [fortio](https://github.com/fortio/fortio)  | 849 |  负载测试库和命令行工具，先进的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。Tcp、Http、gRPC。 |![star > 100][Bronze]   
| [ftp](https://github.com/jlaffaye/ftp)  | 510 |  包ftp实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户机。 |![star > 100][Bronze]   
| [gmqtt](https://github.com/DrmagicE/gmqtt)  | 66 |  Gmqtt是一个灵活、高性能的MQTT代理库，它完全实现了MQTT协议V3.1.1。 |![最近一个周有更新][Green]
| [gNxI](https://github.com/google/gnxi)  | 99 |  一组使用gNMI和gNOI协议的网络管理工具。 |
| [go-getter](https://github.com/hashicorp/go-getter)  | 706 |   Go 图书馆下载文件或目录从各种来源使用一个URL。 |![star > 100][Bronze]   
| [go-stun](https://github.com/ccding/go-stun)  | 329 |  Go实现了STUN客户机(RFC 3489和RFC 5389)。 |![star > 100][Bronze]   
| [gobgp](https://github.com/osrg/gobgp)  | 1654 |  用 Go 编程语言实现的BGP。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [golibwireshark](https://github.com/sunwxg/golibwireshark)  | 14 |  golibwireshark包使用libwireshark库解码pcap文件并分析解剖数据。 |![最近一年没有更新][Yellow]
| [gopacket](https://github.com/google/gopacket)  | 2812 |  使用libpcap绑定访问包处理库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gopcap](https://github.com/akrennmair/gopcap)  | 350 |   Go 包装libpcap。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [grab](https://github.com/cavaliercoder/grab)  | 544 |   Go 软件包管理文件下载。 |![star > 100][Bronze]   
| [graval](https://github.com/koofr/graval)  | 24 |  实验FTP服务器框架。 |![最近一年没有更新][Yellow]
| [HTTPLab](https://github.com/gchaincl/httplab)  | 3389 |  HTTPLabs允许您检查HTTP请求并伪造响应。 |![star > 1000][Silver]   
...
| [kcp-go](https://github.com/xtaci/kcp-go)  | 2219 |  快速可靠的ARQ协议。 |![star > 1000][Silver]   
| [kcptun](https://github.com/xtaci/kcptun)  | 10583 |  非常简单和快速udp隧道基于KCP协议。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [lhttp](https://github.com/fanux/lhttp)  | 509 |  强大的websocket框架，使您的IM服务器更容易构建。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [peerdiscovery](https://github.com/schollz/peerdiscovery)  | 359 |  使用UDP组播进行跨平台本地对等点发现的纯Go库。 |![star > 100][Bronze]   
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2840 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [raw](https://github.com/mdlayher/raw)  | 300 |  Package raw支持在设备驱动程序级别读取和写入网络接口的数据。 |![star > 100][Bronze]   
| [sftp](https://github.com/pkg/sftp)  | 718 |  Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |![star > 100][Bronze]   
| [ssh](https://github.com/gliderlabs/ssh)  | 1094 |  用于构建SSH服务器的高级API(封装密码/ SSH)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [sslb](https://github.com/eduardonunesp/sslb)  | 113 |  它是一个超级简单的负载平衡器，只是一个实现某种性能的小项目。 |![star > 100][Bronze]   
| [stun](https://github.com/go-rtc/stun)  | 263 |  Go实现的RFC 5389 STUN协议。 |![star > 100][Bronze]   
...
| [water](https://github.com/songgao/water)  | 832 |  简单TUN / TAP图书馆。 |![star > 100][Bronze]   
| [webrtc](https://github.com/pions/webrtc)  | 2130 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [grequests](https://github.com/levigross/grequests)  | 1395 |  一个 Go “克隆”的伟大和著名的请求库。 |![star > 1000][Silver]   
...
| [sling](https://github.com/dghubble/sling)  | 905 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gl](https://github.com/go-gl/gl)  | 632 |  OpenGL的Go绑定(通过glow生成)。 |![star > 100][Bronze]   
| [glfw](https://github.com/go-gl/glfw)  | 721 |  Go绑定用于glfw3。 |![star > 100][Bronze]   
...
| [mathgl](https://github.com/go-gl/mathgl)  | 287 |  纯Go数学软件包专门为三维数学，与灵感来自GLM。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-pg](https://github.com/go-pg/pg)  | 2911 |  关注PostgreSQL的特性和性能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-queryset](https://github.com/jirfag/go-queryset)  | 448 |  100%类型安全ORM与代码生成和MySQL, PostgreSQL, Sqlite3, SQL Server支持基于GORM。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder)  | 225 |  一个灵活而强大的SQL字符串构建器库加上一个零配置ORM。 |![star > 100][Bronze]   
| [go-store](https://github.com/gosuri/go-store)  | 93 |  简单而快速的Redis支持的键值存储库。 |![最近一年没有更新][Yellow]
| [GORM](https://github.com/jinzhu/gorm)  | 14324 |  Golang出色的ORM库的目标是对开发人员友好。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [gorp](https://github.com/go-gorp/gorp)  | 3066 |  Go的关系持久性，ORM-ish库。 |![star > 1000][Silver]   
| [grimoire](https://github.com/Fs02/grimoire)  | 114 |  Grimoire是golang的数据库访问层和验证。(支持:MySQL, PostgreSQL和SQLite3)。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [lore](https://github.com/abrahambotros/lore)  | 4 |  用于Go的简单轻量级伪orm /伪结构映射环境。 |![最近一年没有更新][Yellow]
| [Marlow](https://github.com/dadleyy/marlow)  | 62 |  从项目结构生成ORM，用于编译时安全保证。 |
| [pop/soda](https://github.com/gobuffalo/pop)  | 663 |  数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [QBS](https://github.com/coocood/qbs)  | 538 |  表示结构查询。一个ORM。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [reform](https://github.com/go-reform/reform)  | 789 |  更好的ORM for Go，基于非空接口和代码生成。 |![star > 100][Bronze]   
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2223 |  ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [upper.io/db](https://github.com/upper/db)  | 1832 |  通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Xorm](https://github.com/go-xorm/xorm)  | 5072 |  简单而强大的ORM for Go。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12472 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]   
...
| [glide](https://github.com/Masterminds/glide)  | 7748 |  轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [godep](https://github.com/tools/godep)  | 5652 |  godep是go的依赖工具，它通过修复包的依赖关系来帮助构建可重复的包。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
| [gom](https://github.com/mattn/gom)  | 1351 |  Go Manager - bundle for Go。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
| [goop](https://github.com/nitrous-io/goop)  | 778 |  Go 的简单依赖管理器，灵感来自Bundler。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gop](https://github.com/lunny/gop)  | 50 |  在GOPATH之外构建和管理Go应用程序。 |
| [gopm](https://github.com/gpmgo/gopm)  | 2341 |  包管理器。 |![star > 1000][Silver]   
| [govendor](https://github.com/kardianos/govendor)  | 4691 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]   
| [gpm](https://github.com/pote/gpm)  | 1204 |  基本的 Go 依赖管理器。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
| [johnny-deps](https://github.com/VividCortex/johnny-deps)  | 213 |  使用Git的最小依赖版本。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [VenGO](https://github.com/DamnWidget/VenGO)  | 116 |  创建和管理可导出的隔离go虚拟环境。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gojsonq](https://github.com/thedevsaddam/gojsonq)  | 843 |  一个用来查询JSON数据的Go包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [graphql](https://github.com/tmc/graphql)  | 51 |  graphql解析器+工具集 |![最近一年没有更新][Yellow]
| [graphql](https://github.com/neelance/graphql-go)  | 2729 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   
| [graphql-go](https://github.com/graphql-go/graphql)  | 5102 |  为Go实现GraphQL。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [rql](https://github.com/a8m/rql)  | 110 |  用于REST API的资源查询语言。 |![star > 100][Bronze]   
...
| [go-resources](https://github.com/omeid/go-resources)  | 155 |  嵌入到Go中的普通资源。 |![star > 100][Bronze]   
| [go.rice](https://github.com/GeertJohan/go.rice)  | 1622 |  go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。 |![star > 1000][Silver]   
| [packr](https://github.com/gobuffalo/packr)  | 2047 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [statics](https://github.com/go-playground/statics)  | 53 |  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。 |![最近一年没有更新][Yellow]
| [statik](https://github.com/rakyll/statik)  | 2055 |  将静态文件嵌入到Go可执行文件中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go)  | 66 |  用于机器学习和统计的数据模型(类似于 pandas)。 |![最近一个周有更新][Green]
...
| [gonum](https://github.com/gonum/gonum)  | 2881 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gonum/plot](https://github.com/gonum/plot)  | 1195 |  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。 |![star > 1000][Silver]   
| [goraph](https://github.com/gyuho/goraph)  | 596 |  纯Go图论库(数据结构，算法可视化)。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gosl](https://github.com/cpmech/gosl)  | 1294 |  提供线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程，等等。 |![star > 1000][Silver]   
| [GoStats](https://github.com/OGFris/GoStats)  | 9 |  GoStats是一个开放源码的GoLang库，主要用于机器学习领域的数学统计，它涵盖了大多数统计度量函数。 |
| [graph](https://github.com/yourbasic/graph)  | 227 |  基本图形算法库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [ode](https://github.com/ChristopherRabotin/ode)  | 10 |  常微分方程(ODE)求解器，支持扩展状态和基于信道的迭代停止条件。 |![最近一年没有更新][Yellow]
| [orb](https://github.com/paulmach/orb)  | 192 |  2D几何类型，支持剪切、GeoJSON和Mapbox矢量平铺。 |![star > 100][Bronze]   
...
| [sparse](https://github.com/james-bowman/sparse)  | 65 |   Go 稀疏矩阵格式的线性代数支持科学和机器学习应用程序，兼容gonum矩阵库。 |
| [stats](https://github.com/montanaflynn/stats)  | 1333 |  包含Golang标准库中缺少的公共函数的统计软件包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [acra](https://github.com/cossacklabs/acra)  | 443 |  网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。 |![star > 100][Bronze]   
...
| [BadActor](https://github.com/jaredfolkins/badactor)  | 243 |  一个驻留在内存中的，应用驱动的监控程序，受 fail2ban 的启发 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1794 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]   
...
| [lego](https://github.com/xenolf/lego)  | 3437 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [secure](https://github.com/unrolled/secure)  | 1190 |  Go 语言 HTTP 中间件，为 Go 提供了一些安全功能 |![star > 1000][Silver]   
...
| [csvutil](https://github.com/jszwec/csvutil)  | 300 |  高性能、惯用的CSV记录编码和解码到本机Go结构。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-codec](https://github.com/ugorji/go)  | 1217 |  高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2872 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 4958 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5365 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mapstructure](https://github.com/mitchellh/mapstructure)  | 2357 |  用于对原生键值对进行解码生成 Go 语言结构体 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Caddy](https://github.com/mholt/caddy)  | 22854 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [discovery](https://github.com/Bilibili/discovery)  | 649 |  用于弹性中间层负载平衡和故障转移的注册表。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [etcd](https://github.com/coreos/etcd)  | 26015 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Fider](https://github.com/getfider/fider)  | 780 |  Fider是一个收集和组织客户反馈的开放平台。 |![star > 100][Bronze]   
| [Flagr](https://github.com/checkr/flagr)  | 801 |  Flagr是一个开源特性标记和A/B测试服务。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [minio](https://github.com/minio/minio)  | 16977 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3159 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ace](https://github.com/yosssi/ace)  | 760 |  Ace 是一个 Go 语言的 HTML 模板引擎，受到了 Slim 和 Jade 的启发。 Ace 是对Gold的一种改进。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [gofpdf](https://github.com/jung-kurt/gofpdf)  | 3031 |  PDF 文档生成器，支持文本，绘图和图片 |![star > 1000][Silver]   
| [goview](https://github.com/foolin/goview)  | 40 |  Goview是一个轻量级、极简的模板库，基于golang html/template构建Go web应用程序。 |
| [hero](https://github.com/shiyanhui/hero)  | 1192 |  Hero是一个方便、快速和强大的go模板引擎。 |![star > 1000][Silver]   
...
| [liquid](https://github.com/osteele/liquid)  | 80 |  Go 语言实现的 Shopify Liquid 模板. |
| [mustache](https://github.com/hoisie/mustache)  | 967 |  Go 语言实现的 Mustache 模板语言 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [pongo2](https://github.com/flosch/pongo2)  | 1482 |  类似 DjanGo 的模板引擎 |![star > 1000][Silver]   
| [quicktemplate](https://github.com/valyala/quicktemplate)  | 1378 |  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译 |![star > 1000][Silver]   
| [raymond](https://github.com/aymerick/raymond)  | 337 |  使用 Go 语言实现的完整的 handlebars |![star > 100][Bronze]   
| [Razor](https://github.com/sipin/gorazor)  | 688 |  Go 语言的 Razor 视图引擎 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Soy](https://github.com/robfig/soy)  | 143 |  Go 语言实现的谷歌闭包模板(也就是 Soy templates) ,遵循[官方规范](https://developer.google.com/closure/templates/)。 |![star > 100][Bronze]   
| [velvet](https://github.com/gobuffalo/velvet)  | 65 |  使用 Go 语言实现的完整的 handlebars |![最近一年没有更新][Yellow]
...
| [baloo](https://github.com/h2non/baloo)  | 639 |  表达性强、多功能的、端到端的HTTP API 测试工具 |![star > 100][Bronze]   
...
| [cupaloy](https://github.com/bradleyjkemp/cupaloy)  | 80 |  测试框架的简单快照测试插件。 |
| [dbcleaner](https://github.com/khaiql/dbcleaner)  | 83 |  清空数据库用于测试，受到database_cleaner 的启发 |
| [dsunit](https://github.com/viant/dsunit)  | 25 |  用于SQL、NoSQL、结构化文件的数据存储测试。 |![最近一个周有更新][Green]
| [endly](https://github.com/viant/endly)  | 88 |  声明性端到端功能测试。 |![最近一个周有更新][Green]
| [frisby](https://github.com/verdverm/frisby)  | 247 |  REST API测试框架。 |![star > 100][Bronze]   
...
| [go-cmp](https://github.com/google/go-cmp)  | 1115 |  用于比较测试中的Go值的包。 |![star > 1000][Silver]   
| [go-mutesting](https://github.com/zimmski/go-mutesting)  | 244 |  变异测试的Go源代码。 |![star > 100][Bronze]   
| [go-testdeep](https://github.com/maxatome/go-testdeep)  | 55 |  极具灵活性的golang深度比较，扩展了go测试包。 |
| [go-vcr](https://github.com/dnaeon/go-vcr)  | 324 |  记录并回放HTTP交互，以便进行快速、确定和准确的测试。 |![star > 100][Bronze]   
...
| [godog](https://github.com/DATA-DOG/godog)  | 732 |  类似 Cucumber 或 Behat 的 BDD 框架 |![star > 100][Bronze]   
...
| [gotest.tools](https://github.com/gotestyourself/gotest.tools)  | 117 |  一组包，用于增强go测试包并支持公共模式。 |![star > 100][Bronze]   
| [Hamcrest](https://github.com/rdrdr/hamcrest)  | 26 |  用于声明性 Matcher 对象的连贯框架，当将其应用于输入值时，将产生自描述结果。 |![最近一年没有更新][Yellow]
| [httpexpect](https://github.com/gavv/httpexpect)  | 1114 |  简洁的、声明式的、易用的端到端HTTP 及 REST API 测试 |![star > 1000][Silver]   
...
| [testcase](https://github.com/adamluzsi/testcase)  | 9 |  行为驱动开发的惯用测试框架。 |
| [testfixtures](https://github.com/go-testfixtures/testfixtures)  | 322 |  类似 Rails 的测试工具，用于测试数据库应用 |![star > 100][Bronze]   
| [Testify](https://github.com/stretchr/testify)  | 7908 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1670 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]   
| [go-txdb](https://github.com/DATA-DOG/go-txdb)  | 156 |  基于单事务的数据库驱动，主要用于测试目的 |![star > 100][Bronze]   
| [gock](https://github.com/h2non/gock)  | 793 |  多功能、易用 HTTP mock |![star > 100][Bronze]   
| [gomock](https://github.com/golang/mock)  | 2707 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [govcr](https://github.com/seborama/govcr)  | 80 |  HTTP mock : 离线测试时记录和重放浏览器的动作 |![最近一个周有更新][Green]
| [hoverfly](https://github.com/SpectoLabs/hoverfly)  | 1422 |  使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [httpmock](https://github.com/jarcoal/httpmock)  | 567 |  轻松模拟来自外部资源的HTTP响应。 |![star > 100][Bronze]   
| [minimock](https://github.com/gojuno/minimock)  | 193 |  Go接口的模拟生成器。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-fuzz](https://github.com/dvyukov/go-fuzz)  | 2848 |  随机测试系统。 |![star > 1000][Silver]   
| [gofuzz](https://github.com/google/gofuzz)  | 524 |  用于生成随机值来初始化 Go 语言对象的库 |![star > 100][Bronze]   
| [Tavor](https://github.com/zimmski/tavor)  | 208 |  通用模糊测试框架 |![star > 100][Bronze]   

* Selenium and browser control tools.
        
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [cdp](https://github.com/mafredri/cdp)  | 346 |  用于Chrome调试协议的类型安全绑定，可与实现该协议的浏览器或其他调试目标一起使用。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [chromedp](https://github.com/knq/chromedp)  | 3449 |  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [ggr](https://github.com/aerokube/ggr)  | 208 |  一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs |![star > 100][Bronze]   
| [selenoid](https://github.com/aerokube/selenoid)  | 1194 |  Selenium hub 服务器的替代品，在容器中启动浏览器 |![star > 1000][Silver]   ![最近一个周有更新][Green]

* Fail injection
        
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [failpoint](https://github.com/pingcap/failpoint)  | 372 |  为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。 |![star > 100][Bronze]   
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3824 |  Markdown 解析器 |![star > 1000][Silver]   
| [bluemonday](https://github.com/microcosm-cc/bluemonday)  | 1219 |  HTML 清理工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [codetree](https://github.com/aerogo/codetree)  | 7 |  解析缩进代码(python、pixy、scarlet等)并返回树结构。 |
| [colly](https://github.com/asciimoo/colly)  | 8152 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   
| [commonregex](https://github.com/mingrammer/commonregex)  | 551 |  一组用于Go的公共正则表达式。 |![star > 100][Bronze]   
| [dataflowkit](https://github.com/slotix/dataflowkit)  | 283 |  Web抓取框架将网站转换为结构化数据。 |![star > 100][Bronze]   
...
| [go-humanize](https://github.com/dustin/go-humanize)  | 1863 |  格式化程序，用于将时间、数字和内存大小转换为可读格式。 |![star > 1000][Silver]   
| [go-nmea](https://github.com/adrianmo/go-nmea)  | 92 |  用于Go语言的NMEA解析器库。 |
...
| [go-toml](https://github.com/pelletier/go-toml)  | 600 |  使用带有查询支持和方便的cli工具的TOML格式库。 |![star > 100][Bronze]   
...
| [goq](https://github.com/andrewstuart/goq)  | 142 |   声明式 HTML 编组，使用结构标签和 jQuery 语法 (使用 GoQuery). |![star > 100][Bronze]   
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7460 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]   
| [goregen](https://github.com/zach-klippenstein/goregen)  | 35 |  根据正则表达式生成随机字符串 |![最近一年没有更新][Yellow]
| [gotext](https://github.com/leonelquinteros/gotext)  | 230 |  GNU gettext 工具 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [inject](https://github.com/facebookgo/inject)  | 1132 |  包注入提供了一个基于反射的注入器。 |![star > 1000][Silver]   
...
| [sdp](https://github.com/gortc/sdp)  | 67 |  SDP:会话描述协议[[RFC 4566](https://tools.ietf.org/html/rfc4566)]。 |
| [sh](https://github.com/mvdan/sh)  | 1932 |  Shell解析器和格式化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [slug](https://github.com/gosimple/slug)  | 365 |  URL 友好的 slug 化工具，支持多种语言 |![star > 100][Bronze]   
...
| [toml](https://github.com/BurntSushi/toml)  | 2738 |  TOML配置格式(带反射的编码器/解码器)。 |![star > 1000][Silver]   
* Utility
...
| [xurls](https://github.com/mvdan/xurls)  | 455 |  从文本中提取url。 |![star > 100][Bronze]   
...
| [anaconda](https://github.com/ChimeraCoder/anaconda)  | 986 |   Twitter 1.1 API 的 go 语言客户端 |![star > 100][Bronze]   
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 4966 |  AWS 提供的官方go语言 SDK |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [brewerydb](https://github.com/naegelejd/brewerydb)  | 16 |  用于访问 BreweryDB API的 Go 语言库 |![最近一年没有更新][Yellow]
| [cachet](https://github.com/andygrunwald/cachet)  | 65 |  使用客户端库[Cachet(开源状态页系统)](https://cachethq.io/)。 |![最近一年没有更新][Yellow]
...
| [coinpaprika-go](https://github.com/coinpaprika/coinpaprika-api-go-client)  | 11 |  Coinpaprika API的客户端。 |
| [discordgo](https://github.com/bwmarrin/discordgo)  | 944 |   Discord Chat API的客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ethrpc](https://github.com/onrik/ethrpc)  | 164 |   Ethereum JSON RPC API的客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gads](https://github.com/emiddleton/gads)  | 44 |   Google Adwords 非官方 API |
...
| [github](https://github.com/google/go-github)  | 4705 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [githubql](https://github.com/shurcooL/githubql)  | 489 |  访问GitHub GraphQL API v4的库。 |![star > 100][Bronze]   
...
| [go-jira](https://github.com/andygrunwald/go-jira)  | 558 |   Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-twitter](https://github.com/dghubble/go-twitter)  | 700 |   Twitter v1.1 api 的客户端。。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [google](https://github.com/google/google-api-go-client)  | 1902 |  为Go自动生成谷歌api。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [google-analytics](https://github.com/chonthu/go-google-analytics)  | 12 |  简单的包装，方便的谷歌分析报告。 |![最近一年没有更新][Yellow]
| [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang)  | 1750 |  谷歌云api Go 客户端库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [hipchat (xmpp)](https://github.com/daneharrigan/hipchat)  | 114 |  一个用于通过XMPP与HipChat通信的golang包。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [igdb](https://github.com/Henry-Sarabia/igdb)  | 52 |  [Internet Game Database API](https://api.igdb.com/) 客户端。 |
| [Medium](https://github.com/Medium/medium-sdk-go)  | 116 |  Medium的OAuth2 API 客户端。 |![star > 100][Bronze]   
| [megos](https://github.com/andygrunwald/megos)  | 57 |  用于访问[Apache Mesos](http://mesos.apache.org/)集群的客户端库。 |![最近一年没有更新][Yellow]
| [minio-go](https://github.com/minio/minio-go)  | 708 |  用于Amazon S3兼容云存储的Minio Go库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [mixpanel](https://github.com/dukex/mixpanel)  | 28 |  Mixpanel是一个库，用于跟踪事件并将Mixpanel概要文件更新从go应用程序发送到Mixpanel。 |
...
| [slack](https://github.com/nlopes/slack)  | 2371 |  Slack API。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [stripe](https://github.com/stripe/stripe-go)  | 926 |   Stripe API 的 Go 语言客户端 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [webhooks](https://github.com/go-playground/webhooks)  | 340 |  GitHub 和 Bitbucket 的Webhook接收器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [boilr](https://github.com/tmrts/boilr)  | 926 |  非常快的CLI工具，用于从样板模板创建项目。 |![star > 100][Bronze]   
| [chyle](https://github.com/antham/chyle)  | 107 |  使用具有多种配置可能性的git存储库生成变更日志。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [circuit](https://github.com/cep21/circuit)  | 319 |  一个高效和功能齐全的 类似 Hystrix Go 实现断路器模式。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [circuitbreaker](https://github.com/rubyist/circuitbreaker)  | 779 |  接通断路器。 |![star > 100][Bronze]   
| [clockwork](https://github.com/jonboulle/clockwork)  | 217 |  一个简单的假 clock 。 |![star > 100][Bronze]   
...
| [ctop](https://github.com/bcicen/ctop)  | 8694 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Deepcopier](https://github.com/ulule/deepcopier)  | 205 |  结构体拷贝 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [delve](https://github.com/derekparker/delve)  | 11798 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [fzf](https://github.com/junegunn/fzf)  | 22656 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [gaper](https://github.com/maxcnunes/gaper)  | 37 |  当Go项目崩溃或一些人看到文件更改时，构建并重新启动该项目。 |
...
| [go-bind-plugin](https://github.com/wendigo/go-bind-plugin)  | 160 |  Go:generate 工具，用于构建 Go 语言插件(1.8 only)，并对导出的符号进行包装。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [go-bsdiff](https://github.com/gabstv/go-bsdiff)  | 80 |  纯Go bsdiff和bspatch库和CLI工具。 |
| [go-dry](https://github.com/ungerik/go-dry)  | 433 |  DRY(don't repeat yourself)库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [go-funk](https://github.com/thoas/go-funk)  | 1124 |  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...) |![star > 1000][Silver]   
...
| [go-torch](https://github.com/uber/go-torch)  | 3623 |  为 Go 语言程序生成火焰图。 |![star > 1000][Silver]   
...
| [godropbox](https://github.com/dropbox/godropbox)  | 3731 |  用于编写 Go 语言服务／应用的库，来自 Dropbox.。 |![star > 1000][Silver]   
...
| [gopencils](https://github.com/bndr/gopencils)  | 424 |  小而简单的包，可以轻松地使用REST api。 |![star > 100][Bronze]   
...
| [goreleaser](https://github.com/goreleaser/goreleaser)  | 4422 |  尽可能快速的发布 Go 语言二进制文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goreporter](https://github.com/wgliang/goreporter)  | 2464 |  进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具 |![star > 1000][Silver]   
...
| [hub](https://github.com/github/hub)  | 16756 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hystrix-go](https://github.com/afex/hystrix-go)  | 1966 |  实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。 |![star > 1000][Silver]   
| [immortal](https://github.com/immortal/immortal)  | 600 |  \*nix 跨平台 (与操作系统无关的)监控程序。 |![star > 100][Bronze]   
| [intrinsic](https://github.com/mengzhuo/intrinsic)  | 39 |  不需要编写任何汇编代码就能使用 x86 SIMD。 |![最近一年没有更新][Yellow]
| [jump](https://github.com/gsamokovarov/jump)  | 646 |  通过学习你的习惯，可以帮助你更快地导航。 |![star > 100][Bronze]   
| [koazee](https://github.com/wesovilabs/koazee)  | 282 |  库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。 |![star > 100][Bronze]   
| [lrserver](https://github.com/jaschaephraim/lrserver)  | 100 |  LiveReload 服务器。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [mc](https://github.com/minio/mc)  | 1082 |  Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mergo](https://github.com/imdario/mergo)  | 829 |  用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。 |![star > 100][Bronze]   
...
| [mimetype](https://github.com/gabriel-vasile/mimetype)  | 103 |  用于基于神奇数字的MIME类型检测的包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [minify](https://github.com/tdewolff/minify)  | 1844 |  用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。 |![star > 1000][Silver]   
| [minquery](https://github.com/icza/minquery)  | 50 |  MongoDB / mgo.v2, 支持高效分页查询(用于继续列出我们停止的文档的游标)。 |
| [mmake](https://github.com/tj/mmake)  | 1450 |  现代 Make 工具 |![star > 1000][Silver]   
| [moldova](https://github.com/StabbyCutyou/moldova)  | 148 |  基于输入目标生成随机数据的工具 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [mole](https://github.com/davrodpin/mole)  | 1297 |  cli应用程序可以轻松创建ssh隧道。 |![star > 1000][Silver]   
...
| [onecache](https://github.com/adelowo/onecache)  | 98 |  支持多个后端存储(Redis、Memcached、文件系统等)的缓存库。 |
| [panicparse](https://github.com/maruel/panicparse)  | 2093 |  将类似的协程分组并对调用栈进行着色 |![star > 1000][Silver]   
| [peco](https://github.com/peco/peco)  | 5415 |  简单的交互过滤工具。 |![star > 5000][Gold]   
...
| [profile](https://github.com/pkg/profile)  | 986 |  Go的简单分析支持包。 |![star > 100][Bronze]   
| [rclient](https://github.com/zpatrick/rclient)  | 27 |  可读、灵活、易于使用的REST api客户端。 |
| [realize](https://github.com/tockins/realize)  | 3106 |  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。 |![star > 1000][Silver]   
...
| [resty](https://github.com/go-resty/resty)  | 1837 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]   
| [retry](https://github.com/kamilsk/retry)  | 141 |  基于上下文的功能机制，反复执行命令直到成功。 |![star > 100][Bronze]   
...
| [scan](https://github.com/blockloop/scan)  | 11 |  扫描golang的sql。行直接指向结构、片或基本类型。 |
| [serve](https://github.com/syntaqx/serve)  | 191 |  任何您需要的静态http服务器。 |![star > 100][Bronze]   
...
| [spinner](https://github.com/briandowns/spinner)  | 773 |   一个 Go 语言软件包，提供多种选项，方便在终端中创建加载动画。 |![star > 100][Bronze]   
| [sqlx](https://github.com/jmoiron/sqlx)  | 6652 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   
| [sslice](https://github.com/yaa110/sslice)  | 4 |  创建一个总是排序的切片。 |![最近一个周有更新][Green]
| [Storm](https://github.com/asdine/storm)  | 1336 |  一个简单又强大的用于 BoltDB 的工具 |![star > 1000][Silver]   
| [structs](https://github.com/PumpkinSeed/structs)  | 12 |  简单来讲就是 "Make" 的替代品。 |![最近一年没有更新][Yellow]
| [Task](https://github.com/go-task/task)  | 1870 |  简单的“Go”的选择。 |![star > 1000][Silver]   
| [toolbox](https://github.com/viant/toolbox)  | 87 |  切片, map, multimap, 结构体, 函数,数据转换工具。服务路由，宏求值和标记器。 |
| [tracer](https://github.com/kamilsk/tracer)  | 4 |  简单、轻量级的跟踪。 |![最近一个周有更新][Green]
...
| [usql](https://github.com/knq/usql)  | 4657 |  usql 是一个通用的命令行接口，用于操作 sql 数据库。 |![star > 1000][Silver]   
| [util](https://github.com/shomali11/util)  | 132 |  有用实用函数的集合。(字符串，并发，操作，…) |![star > 100][Bronze]   
| [wuzz](https://github.com/asciimoo/wuzz)  | 8236 |  用于HTTP检查的交互式cli工具。 |![star > 5000][Gold]   
...
| [sno](https://github.com/muyo/sno)  | 14 |  使用嵌入元数据的紧凑、可排序和快速的惟一id。 |![最近一个周有更新][Green]
| [ulid](https://github.com/oklog/ulid)  | 1657 |  实现了ULID(普遍唯一的词典分类标识符)。 |![star > 1000][Silver]   
...
| [uuid](https://github.com/gofrs/uuid)  | 558 |  通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。 |![star > 100][Bronze]   
...
| [govalidator](https://github.com/asaskevich/govalidator)  | 3507 |  用于字符串，数字，切片和结构的验证器和sanitizers。 |![star > 1000][Silver]   
| [govalidator](https://github.com/thedevsaddam/govalidator)  | 703 |  用简单的规则验证Golang请求数据。深受Laravel请求验证的启发。 |![star > 100][Bronze]   
| [jio](https://github.com/faceair/jio)  | 21 |  jio是一个json模式验证器，类似于[joi](https://github.com/hapijs/joi)。 |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation)  | 1021 |  支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。 |![star > 1000][Silver]   
| [validate](https://github.com/gookit/validate)  | 87 |   Go 封装数据验证和过滤。支持验证映射、结构、请求(表单、JSON、url)。值，上载文件)数据和更多特性。 |
| [validate](https://github.com/gobuffalo/validate)  | 19 |  这个包提供了一个框架，用于为Go应用程序编写验证。 |
| [validator](https://github.com/go-playground/validator)  | 3386 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [git2go](https://github.com/libgit2/git2go)  | 1346 |   libgit2 的 Go 语言接口。 |![star > 1000][Silver]   
| [go-git](https://github.com/src-d/go-git)  | 4139 |  纯Go中高度可扩展的Git实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-vcs](https://github.com/sourcegraph/go-vcs)  | 69 |  在Go中操作和检查VCS存储库。 |![最近一个周有更新][Green]
| [hercules](https://github.com/src-d/hercules)  | 509 |  从Git存储库历史中获得高级见解。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gmf](https://github.com/3d0c/gmf)  | 515 |   FFmpeg av\* 库的 Go 语言接口。 |![star > 100][Bronze]   
...
| [go-astits](https://github.com/asticode/go-astits)  | 258 |  在GO中解析和演示MPEG传输流(.ts)。 |![star > 100][Bronze]   
...
| [libvlc-go](https://github.com/adrg/libvlc-go)  | 60 |  Go绑定libvlc 2.X/3.X/4。X(由VLC媒体播放器使用)。 |
...
| [Aero](https://github.com/aerogo/aero)  | 153 |  高性能的Go web框架，在Lighthouse中达到最高分。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Air](https://github.com/aofei/air)  | 515 |  一个理想的精细化的Go web框架。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Banjo](https://github.com/nsheremet/banjo)  | 7 |  非常简单和快速的网络框架 Go 。 |![最近一年没有更新][Yellow]
| [Beego](https://github.com/astaxie/beego)  | 21153 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14465 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   
...
| [Gin](https://github.com/gin-gonic/gin)  | 29140 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2820 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]   
| [go-json-rest](https://github.com/ant0ine/go-json-rest)  | 3318 |  设置RESTful JSON API的快速简便方法。 |![star > 1000][Silver]   
| [go-rest](https://github.com/ungerik/go-rest)  | 115 |  小型的 REST 框架。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [Goa](https://github.com/goadesign/goa)  | 3470 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Golax](https://github.com/fulldump/golax)  | 71 |  一个非Sinatra快速HTTP框架，支持谷歌自定义方法、深度拦截器、递归等。 |![最近一年没有更新][Yellow]
| [Golf](https://github.com/dinever/golf)  | 236 |  Golf 是一个快速、简单、轻量级的 Go 语言微型 web 框架。具有强大的功能且没有标准库以外的依赖。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [Gondola](https://github.com/rainycape/gondola)  | 313 |  web框架写的网站越快越好。 |![star > 100][Bronze]   
...
| [Macaron](https://github.com/go-macaron/macaron)  | 2788 |  Macaron 是一个高效的模块化设计的web框架 |![star > 1000][Silver]   
...
| [patron](https://github.com/beatlabs/patron)  | 31 |  Patron是一个遵循最佳云实践的微服务框架，专注于提升开发效率。 |![最近一个周有更新][Green]
...
| [Revel](https://github.com/revel/revel)  | 11197 |  用于Go语言的高效web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [tango](https://github.com/lunny/tango)  | 814 |  微型的、支持插件的 web 框架。 |![star > 100][Bronze]   
...
| [utron](https://github.com/gernest/utron)  | 2136 |  Go(Golang)的轻量级MVC框架。 |![star > 1000][Silver]   
| [vox](https://github.com/aisk/vox)  | 36 |  一个面向人类的golang web框架，深受Koa的启发。 |
| [WebGo](https://github.com/bnkamalesh/webgo)  | 72 |  构建web应用程序的微框架;处理程序链接、中间件和上下文注入。与标准库兼容的HTTP处理程序(即http.HandlerFunc)。 |![最近一个周有更新][Green]
| [YARF](https://github.com/yarf-framework/yarf)  | 49 |  快速微框架，旨在以快速和简单的方式构建REST api和web服务。 |
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [client-timing](https://github.com/posener/client-timing)  | 12 |  用于服务器定时报头的HTTP客户机。 |
| [CORS](https://github.com/rs/cors)  | 1191 |  轻松地向API添加CORS功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Limiter](https://github.com/ulule/limiter)  | 774 |  简单的速度限制中间件。 |![star > 100][Bronze]   
| [ln-paywall](https://github.com/philippgille/ln-paywall)  | 86 |  使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。 |
| [Tollbooth](https://github.com/didip/tollbooth)  | 1226 |  限制速率的 HTTP 请求处理程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [alice](https://github.com/justinas/alice)  | 1812 |  用于连接中间件的库，简单无痛苦。 |![star > 1000][Silver]   
...
| [negroni](https://github.com/urfave/negroni)  | 6296 |  符合语言习惯的 HTTP 中间件库。 |![star > 5000][Gold]   
...
| [bellt](https://github.com/GuilhermeCaruso/bellt)  | 37 |  一个简单的Go HTTP路由器。 |
...
| [chi](https://github.com/go-chi/chi)  | 5920 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [fasthttprouter](https://github.com/buaazp/fasthttprouter)  | 742 |  高性能路由器分叉从`httprouter`。第一个路由器适合`fasthttp`。 |![star > 100][Bronze]   
| [FastRouter](https://github.com/razonyang/fastrouter)  | 18 |  一个快速，灵活的HTTP路由器写在Go。 |![最近一年没有更新][Yellow]
| [gocraft/web](https://github.com/gocraft/web)  | 1392 |  Mux和中间件包在Go中。 |![star > 1000][Silver]   
| [Goji](https://github.com/goji/goji)  | 763 |  枸杞是一种简约的和灵活的与支持'net/context` HTTP请求多路复用器。 |![star > 100][Bronze]   
| [GoRouter](https://github.com/vardius/gorouter)  | 49 |  GoRouter 是一个服务器/API 微型框架、HTTP 请求路由 router, 数据分选器，提供了支持net/context的中间件。 |
| [gowww/router](https://github.com/gowww/router)  | 158 |  超快的HTTP 路由，完全兼容 net/HTTP.Handler 接口.。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9550 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]   
...
| [mux](https://github.com/gorilla/mux)  | 9489 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-ole](https://github.com/go-ole/go-ole)  | 544 |  为 Go 语言实现的 Win32 OLE。 |![star > 100][Bronze]   
...
| [xpath](https://github.com/antchfx/xpath)  | 156 |  Go的XPath包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [xquery](https://github.com/antchfx/xquery)  | 145 |  XQuery允许您使用XPath表达式从HTML/XML文档中提取数据。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [zek](https://github.com/miku/zek)  | 246 |  从XML生成Go结构。 |![star > 100][Bronze]   
...
| [errcheck](https://github.com/kisielk/errcheck)  | 1315 |  Errcheck是一个用于检查Go程序中未检查错误的程序。 |![star > 1000][Silver]   
...
| [go-critic](https://github.com/go-critic/go-critic)  | 558 |  源代码检查工具。 |![star > 100][Bronze]   
...
| [GoLint](https://github.com/golang/lint)  | 3118 |  Go 源码的 linter。 |![star > 1000][Silver]   
...
| [php-parser](https://github.com/z7zmey/php-parser)  | 615 |  用 Go 编写的 PHP 解析器。 |![star > 100][Bronze]   
| [staticcheck](https://github.com/dominikh/go-tools/tree/master/cmd/staticcheck)  | - |  用于大量静态分析检查，您可能已经从 c# 的 ReSharper 等工具中习惯了这些检查。 |
| [tarp](https://github.com/verygoodsoftwarenotvirus/tarp)  | 14 |  在源码中寻找没有直接单元测试的函数和方法。 |
...
| [go-mode](https://github.com/dominikh/go-mode.el)  | 943 |  在 GNU/Emacs 支持 GO。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-plus](https://github.com/joefitzgerald/go-plus)  | 1481 |  在 Atom 中添加自动完成，格式化，语法检查，高亮和审查。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gocode](https://github.com/nsf/gocode)  | 4718 |  Autocompletion daemon for the Go programming language. |![star > 1000][Silver]   
| [goprofiling](https://marketplace.visualstudio.com/items?itemName=MaxMedia.go-prof)  | - |  在 VS Code 中支持 Go 的基准分析。 |
| [GoSublime](https://github.com/DisposaBoy/GoSublime)  | 3224 |  包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [vim-go](https://github.com/fatih/vim-go)  | 10712 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5063 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [genny](https://github.com/cheekybits/genny)  | 932 |  优雅的 Go 泛型。 |![star > 100][Bronze]   
...
| [gotests](https://github.com/cweill/gotests)  | 2148 |  从源代码生成测试用例。 |![star > 1000][Silver]   
...
| [depth](https://github.com/KyleBanks/depth)  | 370 |  通过分析导入，将包依赖关系树可视化输出。 |![star > 100][Bronze]   
...
| [go-callvis](https://github.com/TrueFurby/go-callvis)  | 1952 |  使用 dot format 可视化 Go 程序的调用图。 |![star > 1000][Silver]   
| [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete)  | 37 |  Bash completion for go and wgo。 |![最近一年没有更新][Yellow]
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3879 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [godbg](https://github.com/tylerwince/godbg)  | 157 |  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。 |![star > 100][Bronze]   
| [OctoLinker](https://github.com/OctoLinker/browser-extension)  | 3710 |  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [richgo](https://github.com/kyoh86/richgo)  | 379 |  用文本装饰丰富 go test 的输出。 |![star > 100][Bronze]   
...
| [aurora](https://github.com/xuri/aurora)  | 393 |  基于web的跨平台 Beanstalkd 队列服务器控制台。 |![star > 100][Bronze]   
| [awsenv](https://github.com/soniah/awsenv)  | 21 |  可以为 profile 加载Amazon (AWS)环境变量的轻量二进制文件。 |![最近一年没有更新][Yellow]
| [Blast](https://github.com/dave/blast)  | 169 |  一个用于API负载测试和批处理作业的简单工具。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [bombardier](https://github.com/codesenberg/bombardier)  | 1695 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]   
| [bosun](https://github.com/bosun-monitor/bosun)  | 2849 |  按照时间轴发出告警的框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gaia](https://github.com/gaia-pipeline/gaia)  | 3715 |  可用于任何编程语言来构建强大的管道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Gitea](https://github.com/go-gitea/gitea)  | 14807 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [govvv](https://github.com/ahmetalpbalkan/govvv)  | 376 |  可轻松地添加版本信息到 Go 二进制文件。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gox](https://github.com/mitchellh/gox)  | 3333 |  非常简单，没有多余的跨平台编译工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GVM](https://github.com/moovweb/gvm)  | 4433 |  GVM 提供了一个接口来管理 Go 版本。 |![star > 1000][Silver]   
| [Hey](https://github.com/rakyll/hey)  | 6136 |  压力测试工具，可用来代替 ApacheBench (ab)。 |![star > 5000][Gold]   
| [kala](https://github.com/ajvb/kala)  | 1349 |  简单、现代和高性能的作业调度程序。 |![star > 1000][Silver]   
| [kcli](https://github.com/cswank/kcli)  | 74 |  用于检查kafka主题/分区/消息的命令行工具。 |
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55262 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [lstags](https://github.com/ivanilves/lstags)  | 220 |  提供了工具和API，可用来同步不同注册中心的Docker图像。 |![star > 100][Bronze]   
...
| [Moby](https://github.com/moby/moby)  | 54113 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Packer](https://github.com/mitchellh/packer)  | 9116 |  用于从一个源配置为多个平台创建相同的机器图像。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Pewpew](https://github.com/bengadbois/pewpew)  | 198 |  灵活的 HTTP 命令行压测工具。 |![star > 100][Bronze]   
| [Pomerium](https://github.com/pomerium/pomerium)  | 468 |  Pomerium是一个可识别身份的访问代理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Rodent](https://github.com/alouche/rodent)  | 30 |  管理Go版本、项目和跟踪依赖项。 |![最近一年没有更新][Yellow]
| [s3gof3r](https://github.com/rlmcpherson/s3gof3r)  | 987 |  小型实用程序/库，针对大型对象在Amazon S3中的高速传输进行了优化。 |![star > 100][Bronze]   
...
| [script](https://github.com/bitfield/script)  | 869 |  让DevOps编写类shell和系统管理任务变得更加容易。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [sg](https://github.com/ChristopherRabotin/sg)  | 5 |  可测试一组HTTP极限(如ab)，可以在每个调用之间使用响应代码和数据，根据之前的响应来确定特定的服务器压力。 |![最近一年没有更新][Yellow]
| [skm](https://github.com/TimothyYe/skm)  | 547 |  SKM是一个简单而强大的SSH密钥管理器，它可以帮助您轻松地管理多个SSH密钥! |![star > 100][Bronze]   
| [StatusOK](https://github.com/sanathp/statusok)  | 1152 |  监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。 |![star > 1000][Silver]   
| [traefik](https://github.com/containous/traefik)  | 23335 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 11954 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   
| [webhook](https://github.com/adnanh/webhook)  | 4011 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]   
...
| [Comcast](https://github.com/tylertreat/Comcast)  | 6152 |  模拟坏的网络连接。 |![star > 5000][Gold]   
| [confd](https://github.com/kelseyhightower/confd)  | 6353 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]   
| [DDNS](https://github.com/skibish/ddns)  | 97 |  个人 DDNS 客户端。 |
| [Docker](http://www.docker.com/)  | - |  面向开发人员和系统管理员的分布式应用程序的开放平台。 |
| [Documize](https://github.com/documize/community)  | 802 |  集成了SaaS工具数据的现代wiki软件。 |![star > 100][Bronze]   
| [drive](https://github.com/odeke-em/drive)  | 4930 |  基于命令行的谷歌驱动器客户端。 |![star > 1000][Silver]   
| [Duplicacy](https://github.com/gilbertchen/duplicacy)  | 2668 |  跨平台网络和云备份工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-peerflix](https://github.com/Sioro-Neoku/go-peerflix)  | 371 |  视频流 torrent 客户端。 |![star > 100][Bronze]   
| [GoBoy](https://github.com/Humpheh/goboy)  | 2100 |  用 Go 编写的任天堂Game Boy彩色模拟器。 |![star > 1000][Silver]   
...
| [Gor](https://github.com/buger/gor)  | 11247 |  Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。 |![star > 5000][Gold]   
| [hugo](http://gohugo.io/)  | - |  快速、现代的静态网站引擎。 |
| [ide](https://github.com/thestrukture/ide)  | 251 |  基于浏览器的IDE |![star > 100][Bronze]   
...
| [joincap](https://github.com/assafmo/joincap)  | 118 |  用于合并多个pcap文件的命令行实用程序。 |![star > 100][Bronze]   
...
| [lgo](https://github.com/yunabe/lgo)  | 1775 |  与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [limetext](http://limetext.org/)  | - |  一个强大而优雅的文本编辑器。 |
| [LiteIDE](https://github.com/visualfc/liteide)  | 5432 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mockingjay](https://github.com/quii/mockingjay-server)  | 412 |  一份配置文件中便可伪造HTTP服务器与用户之间的行为。您还可以使服务器随机宕机，以帮助进行更实际的性能测试。 |![star > 100][Bronze]   
...
| [nes](https://github.com/fogleman/nes)  | 4112 |  任天堂娱乐系统(NES)模拟器。 |![star > 1000][Silver]   
...
| [peg](https://github.com/pointlander/peg)  | 586 |  解析表达式语法，是Packrat解析器生成器的实现。 |![star > 100][Bronze]   
| [Pipe](https://github.com/b3log/pipe)  | 2685 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [restic](https://github.com/restic/restic)  | 7290 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [rkt](https://github.com/coreos/rkt)  | 8715 |  一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [scc](https://github.com/boyter/scc)  | 761 |  一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。 |![star > 100][Bronze]   
| [Seaweed File System](https://github.com/chrislusf/seaweedfs)  | 8091 |  快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [shell2http](https://github.com/msoap/shell2http)  | 397 |  通过http服务器执行shell命令(用于原型或远程控制)。 |![star > 100][Bronze]   
| [snap](https://github.com/intelsdi-x/snap)  | 1805 |  强大的遥测框架。 |![star > 1000][Silver]   
...
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3798 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-benchmarks](https://github.com/tylertreat/go-benchmarks)  | 120 |  Few miscellaneous Go microbenchmarks. Compare some language features to alternative approaches |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark)  | 980 |  web框架基准测试。 |![star > 100][Bronze]   
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks)  | 851 |  Go序列化方法的基准测试。 |![star > 100][Bronze]   
...
| [GoBooks](https://github.com/dariubs/GoBooks)  | 6721 |  一份精选的 Go 书籍清单。 |![star > 5000][Gold]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gopherize.me](https://github.com/matryer/gopherize.me)  | 314 |  Gopherize自己。 |![star > 100][Bronze]   
| [gophers](https://github.com/ashleymcnamara/gophers)  | 1822 |  阿什莉·麦克纳马拉的歌斐艺术品。 |![star > 1000][Silver]   
| [gophers](https://github.com/egonelbre/gophers)  | 1558 |  Free gophers. |![star > 1000][Silver]   
...
| [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job)  | 14440 |  Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness)  | 24534 |  其他 awesome 系列的列表。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang)  | 31127 |  Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。 |![star > 5000][Gold]   
...
| [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet)  | 3994 |   Go's reference card。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers)  | 677 |  引入示例讲述 Golang 与Node.js在学习上的差异。 |![star > 100][Bronze]   
...
| [Learn Go with TDD](https://github.com/quii/learn-go-with-tests)  | 4153 |  学习使用测试驱动开发。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [package main](https://www.youtube.com/packagemain)  | - |  关于 Go 编程的YouTube频道。 |
* [The world’s easiest introduction to WebAssembly with Golang](https://medium.com/@martinolsansky/webassembly-with-golang-is-fun-b243c0e34f02)
        
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [Working with Go](https://github.com/mkaz/working-with-go)  | 1128 |  由一个经验丰富的Go程序员群体编写的一系列Go学习范例。 |![star > 1000][Silver]   
