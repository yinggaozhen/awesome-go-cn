...
* [configuration](https://github.com/BoRuDar/configuration) **star:19** 库，用于从环境变量、文件、标记和“默认”标记初始化配置结构。   [![godoc][GoDoc]](https://godoc.org/github.com/BoRuDar/configuration)
...
* [willf/bloom](https://github.com/willf/bloom) **star:812** 实现Bloom过滤器。   [![godoc][GoDoc]](https://godoc.org/github.com/willf/bloom)
...
* [dep](https://github.com/golang/dep) **star:13208**  Go 的依赖管理工具，需要 Go 1.9+   [![star > 2000][Awesome]](https://github.com/golang/dep)   [![godoc][GoDoc]](https://godoc.org/github.com/golang/dep)
...
* [go-git](https://github.com/src-d/go-git) **star:5053** 纯Go中高度可扩展的Git实现。   [![star > 2000][Awesome]](https://github.com/src-d/go-git)   [![godoc][GoDoc]](https://godoc.org/github.com/src-d/go-git)   [![归档项目][Archived]](https://github.com/src-d/go-git)
...
* [Goyave](https://github.com/System-Glitch/goyave) **star:421** 功能齐全的web框架旨在干净的代码和快速的开发，具有强大的内置功能。   [![godoc][GoDoc]](https://godoc.org/github.com/System-Glitch/goyave)
...
* [zek](https://github.com/miku/zek) **star:351** 从XML生成Go结构。   [![godoc][GoDoc]](https://godoc.org/github.com/miku/zek)
