...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-08-10 14:56:10(每隔1天同步一次)**
...
* [Oto](https://github.com/hajimehoshi/oto) **star:437** 多平台的 low-level 声音播放库。   ![star > 100][Bronze]
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) **star:6009** JSON Web令牌(JWT)。   ![star > 5000][Gold]
* [casbin](https://github.com/hsluoyz/casbin) **star:4972** 支持ACL、RBAC、ABAC等访问控制模型的授权库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [oauth2](https://github.com/golang/oauth2) **star:2385** goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。   ![star > 1000][Silver]
* [goth](https://github.com/markbates/goth) **star:2271** 提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。   ![star > 1000][Silver]
...
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) **star:1283** 用 Golang 编写的独立且符合规范的OAuth2服务器。   ![star > 1000][Silver]
* [go-jose](https://github.com/square/go-jose) **star:1127** 相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。   ![star > 1000][Silver]
...
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) **star:1632** 简单轻量级的Telegram bot客户端。   ![star > 1000][Silver]
* [telebot](https://github.com/tucnak/telebot) **star:950** 用Go编写的Telegram bot框架。   ![star > 100][Bronze]
* [go-chat-bot](https://github.com/go-chat-bot/bot) **star:469** 用 Go 编写的IRC, Slack和电报机器人。   ![star > 100][Bronze]
* [slacker](https://github.com/shomali11/slacker) **star:311** 可简单创建Slack机器人的框架。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [Kelp](https://github.com/stellar/kelp) **star:163** 官方交易和做市机器人为[Stellar](https://www.stellar.org/) DEX。开箱即用的作品，用 Golang 编写，兼容集中交易和定制交易策略。   ![star > 100][Bronze]
...
* [cobra](https://github.com/spf13/cobra) **star:13358** 现代Go CLI命令行交互工具。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [urfave/cli](https://github.com/urfave/cli) **star:11414** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [kingpin](https://github.com/alecthomas/kingpin) **star:2535** 支持子命令的命令行和标志解析器。   ![star > 1000][Silver]
...
* [pflag](https://github.com/spf13/pflag) **star:753** 基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。   ![star > 100][Bronze]
* [go-arg](https://github.com/alexflint/go-arg) **star:693** 基于结构的参数解析。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [mow.cli](https://github.com/jawher/mow.cli) **star:624** 用于构建具有复杂标志和参数解析和验证的CLI应用程序。   ![star > 100][Bronze]
* [complete](https://github.com/posener/complete) **star:619** 使用 Go 语言编写的 bash 命令补全工具以及 Go 命令补全工具.   ![star > 100][Bronze]
* [liner](https://github.com/peterh/liner) **star:588** 类似readline-like的命令行接口库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [argparse](https://github.com/akamensky/argparse) **star:108** 命令行参数分析器，灵感来自Python的argparse模块。   ![star > 100][Bronze]
...
* [termui](https://github.com/gizak/termui) **star:8934** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。   ![star > 5000][Gold]
* [gommon/color](https://github.com/labstack/gommon/tree/master/color)  更换终端文本样式。
* [gocui](https://github.com/jroimartin/gocui) **star:5387** 旨在创建控制台用户界面的极简Go库。   ![star > 5000][Gold]
* [termbox-go](https://github.com/nsf/termbox-go) **star:3488** 基于文本的跨平台接口库。   ![star > 1000][Silver]
* [color](https://github.com/fatih/color) **star:3021** 多功能包装，彩色终端输出。   ![star > 1000][Silver]   ![归档项目][Archived]
* [go-prompt](https://github.com/c-bata/go-prompt) **star:2338** 构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit)   ![star > 1000][Silver]
...
* [termdash](https://github.com/mum4k/termdash) **star:810** 此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。   ![star > 100][Bronze]
* [mpb](https://github.com/vbauerster/mpb) **star:702** 可在终端显示多进度条。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [aurora](https://github.com/logrusorgru/aurora) **star:635** 支持fmt.Printf/Sprintf的ANSI终端颜色。   ![star > 100][Bronze]
...
* [go-colorable](https://github.com/mattn/go-colorable) **star:376** 适用于windows的颜色编写器。   ![star > 100][Bronze]
...
* [gookit/color](https://github.com/gookit/color) **star:203** 终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。   ![star > 100][Bronze]   ![包含中文文档][CN]
* [go-colortext](https://github.com/daviddengcn/go-colortext) **star:196** 在终端中使用彩色文字。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [simpletable](https://github.com/alexeyco/simpletable) **star:168** 可在终端显示简易表格。   ![star > 100][Bronze]
...
* [viper](https://github.com/spf13/viper) **star:9360** 配置管理。   ![star > 5000][Gold]
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) **star:2411** 管理来自环境变量的配置数据。   ![star > 1000][Silver]
* [godotenv](https://github.com/joho/godotenv) **star:2128** Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。   ![star > 1000][Silver]
* [ini](https://github.com/go-ini/ini) **star:1598**  读和写INI文件。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [env](https://github.com/caarlos0/env) **star:875** 解析环境变量并赋值到struct中(默认值)。   ![star > 100][Bronze]
...
* [koanf](https://github.com/knadh/koanf) **star:86** 轻量级可扩展库，用于读取Go应用程序中的配置。内置支持JSON, TOML, YAML, env，命令行。
* [gookit/config](https://github.com/gookit/config) **star:85** 程序配置管理(load,get,set)。支持JSON, YAML, TOML, INI, HCL。支持多文件加载，数据覆盖合并。   ![最近一周有更新][Green]   ![包含中文文档][CN]
...
* [drone](https://github.com/drone/drone) **star:19064** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [gods](https://github.com/emirpasic/gods) **star:6410** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。   ![star > 5000][Gold]
* [go-datastructures](https://github.com/Workiva/go-datastructures) **star:5133** 可靠的、高性能的和线程安全的数据结构的集合。   ![star > 5000][Gold]
* [golang-set](https://github.com/deckarep/golang-set) **star:1172** 线程安全和非线程安全的高性能集。   ![star > 1000][Silver]
...
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) **star:516** 布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。   ![star > 100][Bronze]
...
* [binpacker](https://github.com/zhuangsirui/binpacker) **star:125** 帮助用户构建自定义二进制流的二进制封装器和解包器   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [ring](https://github.com/TheTannerRyan/ring) **star:89** 高性能、线程安全的bloom过滤器。
* [conjungo](https://github.com/InVisionApp/conjungo) **star:79** 一个小型、强大和灵活的合并库。
...
* [prometheus](https://github.com/prometheus/prometheus) **star:25610** 用于监控系统和时序的数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [tidb](https://github.com/pingcap/tidb) **star:20103** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [influxdb](https://github.com/influxdb/influxdb) **star:17128** 可伸缩的数据存储，用于指标衡量、事件和实时分析。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [cockroach](https://github.com/cockroachdb/cockroach) **star:16790** 可伸缩、区域备份、事务性数据存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [dgraph](https://github.com/dgraph-io/dgraph) **star:10463** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [bolt](https://github.com/boltdb/bolt) **star:9988** K/V 数据库。   ![star > 5000][Gold]   ![最近一年没有更新][Yellow]   ![归档项目][Archived]
* [groupcache](https://github.com/golang/groupcache) **star:7665** Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。   ![star > 5000][Gold]
* [badger](https://github.com/dgraph-io/badger) **star:6286** 快速 K/V 存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [rqlite](https://github.com/rqlite/rqlite) **star:4702** 基于SQLite的轻量级分布式关系数据库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [goleveldb](https://github.com/syndtr/goleveldb) **star:3173** 在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [ledisdb](https://github.com/siddontang/ledisdb) **star:3079** Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。   ![star > 1000][Silver]
* [go-cache](https://github.com/pmylund/go-cache) **star:2912** 基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。   ![star > 1000][Silver]
* [BigCache](https://github.com/allegro/bigcache) **star:2459** 高效的键/值缓存为千兆字节的数据。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [buntdb](https://github.com/tidwall/buntdb) **star:2440** 基于内存的K/V，快速，可嵌入的数据库，可自定义索引和空间支持。   ![star > 1000][Silver]
* [tiedot](https://github.com/HouzuoGuo/tiedot) **star:2366** 属于你的NoSQL数据库。   ![star > 1000][Silver]
* [cache2go](https://github.com/muesli/cache2go) **star:1051** 基于内存的 K/V 缓存，支持超时的自动失效。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) **star:1016** 开源，快速，可伸缩的时间序列数据库。支持PromQL。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [fastcache](https://github.com/VictoriaMetrics/fastcache) **star:489** 基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。   ![star > 100][Bronze]
...
* [Vasto](https://github.com/chrislusf/vasto) **star:149** 分布式高性能键值存储。可做磁盘备份。最终一致。高可用。能够在不中断服务的情况下增长或收缩。   ![star > 100][Bronze]
...
* [migrate](https://github.com/golang-migrate/migrate) **star:2749** 基于CLI的数据库迁移库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [sql-migrate](https://github.com/rubenv/sql-migrate) **star:1414** 数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。   ![star > 1000][Silver]
* [gormigrate](https://github.com/go-gormigrate/gormigrate) **star:334** 面向Gorm ORM的数据库 schema 迁移辅助程序。   ![star > 100][Bronze]
...
* [pgweb](https://github.com/sosedoff/pgweb) **star:5991** 基于web的PostgreSQL数据库浏览器。   ![star > 5000][Gold]
* [kingshard](https://github.com/flike/kingshard) **star:4613** kingshard 是基于 Golang 的MySQL高性能代理。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [orchestrator](https://github.com/github/orchestrator) **star:3039** MySQL复制拓扑管理器和可视化工具。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [go-mysql](https://github.com/siddontang/go-mysql) **star:1895**  Go 工具集，用于处理MySQL协议和复制。   ![star > 1000][Silver]
...
* [Squirrel](https://github.com/Masterminds/squirrel) **star:2324** 帮助您构建SQL查询的Go库。   ![star > 1000][Silver]
* [xo](https://github.com/knq/xo) **star:2188** 基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。   ![star > 1000][Silver]
...
* [sqrl](https://github.com/elgris/sqrl) **star:178** SQL查询生成器，从Squirrel fork而来，并再此基础上对性能做了优化。   ![star > 100][Bronze]
...
* Relational Databases
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) **star:8116** MySQL驱动程序。   ![star > 5000][Gold]
    * [pq](https://github.com/lib/pq) **star:5197** 纯 Go 的Postgres驱动。   ![star > 5000][Gold]
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) **star:3430** SQLite3驱动程序。   ![star > 1000][Silver]
    * [pgx](https://github.com/jackc/pgx) **star:1965** PostgreSQL驱动，支持比现有database/sql更多的特性。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* NoSQL Databases
    * [redis](https://github.com/go-redis/redis) **star:6516** 基于 Go 的 Redis 客户端。   ![star > 5000][Gold]   ![最近一周有更新][Green]
    * [redigo](https://github.com/gomodule/redigo) **star:6295** Redigo 是基于 Go 的Redis 客户端。   ![star > 5000][Gold]
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) **star:3121** 官方的 MongoDB 驱动。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [mgo](https://github.com/globalsign/mgo) **star:1647** (已停止维护) MongoDB驱动。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    ...
    * [go-couchbase](https://github.com/couchbase/go-couchbase) **star:294** Couchbase客户端。   ![star > 100][Bronze]   ![最近一周有更新][Green]
    * [gocb](https://github.com/couchbase/gocb) **star:292** 官方Couchbase Go SDK。   ![star > 100][Bronze]   ![最近一周有更新][Green]
    * [gocql](http://gocql.github.io)  Apache Cassandra 的 Go 驱动。
    * [redeo](https://github.com/bsm/redeo) **star:260** 与 redis 协议兼容的 TCP 服务器/服务。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) **star:5848** 基于 Go 的现代文本索引库。   ![star > 5000][Gold]   ![最近一周有更新][Green]
    * [riot](https://github.com/go-ego/riot) **star:4700** 基于 Go 的 开源、分布式、简单高效的搜索引擎。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
    * [elastic](https://github.com/olivere/elastic) **star:4153** Elasticsearch 客户端。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) **star:1587** 官方 Elasticsearch 客户端。   ![star > 1000][Silver]
...
* [go-kit](https://github.com/go-kit/kit) **star:14469** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [grpc-go](https://github.com/grpc/grpc-go) **star:9119** gRPC的Go语言实现。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [micro](https://github.com/micro/micro) **star:6599** 可插拔的微服务 toolkit 和分布式系统平台。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) **star:6350** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [rpcx](https://github.com/smallnest/rpcx) **star:3812** 分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [tendermint](https://github.com/tendermint/tendermint) **star:3152** 一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [raft](https://github.com/coreos/etcd/tree/master/raft)  Raft consensus协议的实现。 by CoreOS。
* [raft](https://github.com/hashicorp/raft) **star:2845** Raft consensus协议的实现。 by HashiCorp。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [torrent](https://github.com/anacrolix/torrent) **star:2845** BitTorrent 客户端。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [dragonboat](https://github.com/lni/dragonboat) **star:2543** 一个功能齐全，高性能的库集。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [glow](https://github.com/chrislusf/glow) **star:2529** 全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。   ![star > 1000][Silver]
* [gleam](https://github.com/chrislusf/gleam) **star:2101** 使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。   ![star > 1000][Silver]
* [emitter-io](https://github.com/emitter-io/emitter) **star:1936** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [KrakenD](https://github.com/devopsfaith/krakend) **star:1759** 具有中间件的高性能API网关框架。   ![star > 1000][Silver]
* [hprose](https://github.com/hprose/hprose-golang) **star:1006** 支持25+种语言RPC库。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [go-health](https://github.com/InVisionApp/go-health) **star:479** 用于在服务中启用异步依赖项健康检查的库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [digota](https://github.com/digota/digota) **star:300** 基于 grpc 的电子商务微服务。   ![star > 100][Bronze]
...
* [MailHog](https://github.com/mailhog/MailHog) **star:5172** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。   ![star > 5000][Gold]
...
* [email](https://github.com/jordan-wright/email) **star:1094** 一个强大和灵活的电子邮件库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [otto](https://github.com/robertkrimen/otto) **star:4731** 用 Go 编写的 JavaScript 解释器。   ![star > 1000][Silver]
* [gopher-lua](https://github.com/yuin/gopher-lua) **star:2964** 用 Go 实现的 Lua 5.1 虚拟机和编译器。   ![star > 1000][Silver]
* [go-lua](https://github.com/Shopify/go-lua) **star:1672** 用 Go 实现的 Lua 5.2 VM接口。   ![star > 1000][Silver]
* [tengo](https://github.com/d5/tengo) **star:1305** 字节码编译的脚本语言。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [expr](https://github.com/antonmedv/expr) **star:705** 一个可以计算表达式的引擎。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [go-php](https://github.com/deuill/go-php) **star:683** PHP 的 Go 接口。   ![star > 100][Bronze]
...
* [gval](https://github.com/PaesslerAG/gval) **star:136** 一种用Go编写的高度可定制的表达式语言。   ![star > 100][Bronze]
...
* [errors](https://github.com/pkg/errors) **star:4902** 可让你很简单的进行错误处理。   ![star > 1000][Silver]
...
* [errlog](https://github.com/snwfdhmp/errlog) **star:167** 用于定位抛出错误的源代码(以及一些其他快速调试特性)。可插入到任何 logger 的位置。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [afero](https://github.com/spf13/afero) **star:2236** 文件系统的抽象系统。   ![star > 1000][Silver]
* [pdfcpu](https://github.com/hhrutter/pdfcpu) **star:947** PDF处理器。   ![star > 100][Bronze]
* [notify](https://github.com/rjeczalik/notify) **star:496** 文件系统事件通知库，具有类似于os/signal的简单API，。   ![star > 100][Bronze]
...
* [decimal](https://github.com/shopspring/decimal) **star:1601** 任意精度定点的十进制数。   ![star > 1000][Silver]
...
* [techan](https://github.com/sdcoffey/techan) **star:159** 拥有先进的市场分析和交易策略的技术分析库。   ![star > 100][Bronze]
...
* [gorilla/csrf](https://github.com/gorilla/csrf) **star:436** 用于Go web应用程序和服务的CSRF保护。   ![star > 100][Bronze]
...
* [Leaf](https://github.com/name5566/leaf) **star:3065** 轻量级游戏服务器框架。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [Pixel](https://github.com/faiface/pixel) **star:2440** 手工制作的 2D 游戏库。   ![star > 1000][Silver]
...
* [termloop](https://github.com/JoelOtter/termloop) **star:1025** 基于终端的 Go 游戏引擎，建立在 Termbox 之上。   ![star > 1000][Silver]
* [nano](https://github.com/lonng/nano) **star:998** 轻量级、方便、高性能的基于golang的游戏服务器框架。   ![star > 100][Bronze]   ![包含中文文档][CN]
* [g3n](https://github.com/g3n/engine) **star:755**  3D游戏引擎。   ![star > 100][Bronze]
...
* [Pitaya](https://github.com/topfreegames/pitaya) **star:300** 可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [GoWrap](https://github.com/hexdigest/gowrap) **star:263** 使用简单模板为 Go 接口生成装饰器。   ![star > 100][Bronze]
...
* [gopherjs](https://github.com/gopherjs/gopherjs) **star:8546** 将 Go 编译成 JavaScript。   ![star > 5000][Gold]
...
* [goworker](https://github.com/benmanns/goworker) **star:2252** 基于 go 的后台 worker。   ![star > 1000][Silver]
* [ants](https://github.com/panjf2000/ants) **star:1892** 一个高性能的协程池。   ![star > 1000][Silver]   ![包含中文文档][CN]
...
* [ui](https://github.com/andlabs/ui) **star:6957** 跨平台的 Platform-native GUI 库。   ![star > 5000][Gold]
* [Wails](https://wails.app)  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。
* [fyne](https://github.com/fyne-io/fyne) **star:6293** 为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [qt](https://github.com/therecipe/qt) **star:6063** 实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [webview](https://github.com/zserge/webview) **star:4666** 跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。   ![star > 1000][Silver]
* [walk](https://github.com/lxn/walk) **star:3696** Windows应用程序库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [app](https://github.com/murlokswarm/app) **star:2955** 用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。   ![star > 1000][Silver]
* [go-astilectron](https://github.com/asticode/go-astilectron) **star:2667** 使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [robotgo](https://github.com/go-vgo/robotgo) **star:4431** 实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [systray](https://github.com/getlantern/systray) **star:787** 跨平台 Go 库，可在通知区放置图标和菜单。   ![star > 100][Bronze]
...
* [bild](https://github.com/anthonynsimon/bild) **star:2546** 纯Go语言实现的图像处理算法合集。   ![star > 1000][Silver]
* [imaging](https://github.com/disintegration/imaging) **star:2529** 简单的Go图像处理包。   ![star > 1000][Silver]
* [ln](https://github.com/fogleman/ln) **star:2462** Go实现的3D线艺术（3D Line Art）渲染。   ![star > 1000][Silver]
* [gocv](https://github.com/hybridgroup/gocv) **star:2460** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。   ![star > 1000][Silver]
* [resize](https://github.com/nfnt/resize) **star:2127** Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [gg](https://github.com/fogleman/gg) **star:1914** 纯Go语言实现的2D渲染。   ![star > 1000][Silver]
* [pt](https://github.com/fogleman/pt) **star:1772** Go实现的路径跟踪（path tracing）引擎。   ![star > 1000][Silver]
* [svgo](https://github.com/ajstarks/svgo) **star:1333**  Go实现的SVG生成库。   ![star > 1000][Silver]
* [smartcrop](https://github.com/muesli/smartcrop) **star:1261** 为任意图片寻找合适的位置进行图片裁剪。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [picfit](https://github.com/thoas/picfit) **star:1069** Go实现的图像调整服务器。   ![star > 1000][Silver]
...
* [bimg](https://github.com/h2non/bimg) **star:796** 使用libvips实现的快速高效的图像处理包。   ![star > 100][Bronze]
* [stegify](https://github.com/DimitarPetrov/stegify) **star:506**  Go实现的LSB隐写（LSB steganography），能够隐藏任何文件到一个图像中。   ![star > 100][Bronze]
...
* [darkroom](https://github.com/gojek/darkroom) **star:47** An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency.   ![最近一周有更新][Green]
...
* [flogo](https://github.com/tibcosoftware/flogo) **star:1128** Flogo是一个面向物联网边缘应用和集成的开源框架。   ![star > 1000][Silver]
...
* [GJSON](https://github.com/tidwall/gjson) **star:4908** 使用一行代码获取JSON的值。   ![star > 1000][Silver]
...
* [logrus](https://github.com/Sirupsen/logrus) **star:11962** Go的结构化日志操作 。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [zap](https://github.com/uber-go/zap) **star:7461** 快速、结构化、多等级的日志记录。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [spew](https://github.com/davecgh/go-spew) **star:3311** 为Go数据结构实现一个漂亮的printer用于帮助调试。   ![star > 1000][Silver]
* [glog](https://github.com/golang/glog) **star:2305** 为Go提供了多等级日志记录。   ![star > 1000][Silver]
* [zerolog](https://github.com/rs/zerolog) **star:2225** Zero-allocation JSON日志记录。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [tail](https://github.com/hpcloud/tail) **star:1542** 努力模拟实现BSD的tail的特性的Go包。   ![star > 1000][Silver]
* [lumberjack](https://github.com/natefinch/lumberjack) **star:1448** 简单的滚动日志，io.WriteCloser的实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [seelog](https://github.com/cihub/seelog) **star:1361** 具有灵活调度、过滤和格式化的日志功能。   ![star > 1000][Silver]
* [log15](https://github.com/inconshreveable/log15) **star:913** 简单、强大的日志操作。   ![star > 100][Bronze]
...
* [GoLearn](https://github.com/sjwhitworth/golearn) **star:6653** 通用机器学习库。   ![star > 5000][Gold]   ![包含中文文档][CN]
...
* [gosseract](https://github.com/otiai10/gosseract) **star:875** 使用c++的Tesseract库实现的OCR。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [eaopt](https://github.com/MaxHalford/eaopt) **star:622** 一个进化优化（evolutionary optimization）库。   ![star > 100][Bronze]
...
* [Goptuna](https://github.com/c-bata/goptuna) **star:78** 黑盒函数的贝叶斯优化框架。一切都会优化。   ![最近一周有更新][Green]
...
* [sarama](https://github.com/Shopify/sarama) **star:4640**  Apache Kafka的Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gorush](https://github.com/appleboy/gorush) **star:3714** 使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。   ![star > 1000][Silver]
* [Centrifugo](https://github.com/centrifugal/centrifugo) **star:3689** 实时消息(Websockets或SockJS)服务器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [machinery](https://github.com/RichardKnop/machinery) **star:3371** 基于分布式消息传递的异步任务/作业队列。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-socket.io](https://github.com/googollee/go-socket.io) **star:2888** go的socket.io库，一个实时应用程序框架。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [melody](https://github.com/olahol/melody) **star:1564** 处理websocket session的极简框架，包括广播和自动ping/pong处理。   ![star > 1000][Silver]
* [mangos](https://github.com/go-mangos/mangos) **star:1534** Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。   ![star > 1000][Silver]
* [Mercure](https://github.com/dunglas/mercure) **star:1509** 使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [Beaver](https://github.com/Clivern/Beaver) **star:726** 一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。   ![star > 100][Bronze]
...
* [unioffice](https://github.com/unidoc/unioffice) **star:1722** 用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]

### Microsoft Excel

*用于操作Microsoft Excel的库。 (翻译出错了? 试试 [英文版](README_EN.md#microsoft-excel) 吧~)*

* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) **star:4478** 用于读写Microsoft Excel™(XLSX)文件的Go语言库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [xlsx](https://github.com/tealeg/xlsx) **star:3427** 用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [xlsx](https://github.com/plandem/xlsx) **star:73** 在Go程序以快速和安全的方式读取/更新现有的Microsoft Excel文件。
...
* [dig](https://github.com/uber-go/dig) **star:913** 一个基于反射的Go依赖注入工具包。   ![star > 100][Bronze]
* [fx](https://github.com/uber-go/fx) **star:753** 基于依赖注入的Go应用程序框架(构建在dig之上)。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) **star:9171** Go生态系统中历史和新兴的项目布局模式集合。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [scaffold](https://github.com/catchplay/scaffold) **star:25** 快速生成Go项目布局的脚手架。让您专注于已实现的业务逻辑。
* [go-sample](https://github.com/zitryss/go-sample) **star:24** 带有实际代码的Go应用程序项目的示例布局。

### 字符串

*处理字符串的库。 (翻译出错了? 试试 [英文版](README_EN.md#strings) 吧~)*

* [xstrings](https://github.com/huandu/xstrings) **star:620** 从其他语言移植的有用字符串函数合集。   ![star > 100][Bronze]
* [strutil](https://github.com/ozgio/strutil) **star:63** 字符串处理工具。

*这些库之所以放在这里，是因为不适合放在其他分类。 (翻译出错了? 试试 [英文版](README_EN.md#strings) 吧~)*

* [gopsutil](https://github.com/shirou/gopsutil) **star:3934** 用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [archiver](https://github.com/mholt/archiver) **star:2490** 用于生成和解压.zip和.tar.gz文档的库和命令。   ![star > 1000][Silver]
* [gosms](https://github.com/haxpax/gosms) **star:1226** Go编写的私人的本地短信网关，可以用来发送短信。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [go-resiliency](https://github.com/eapache/go-resiliency) **star:858**  Go语言弹性模式(resiliency pattern)。   ![star > 100][Bronze]
...
* [gofakeit](https://github.com/brianvoe/gofakeit) **star:423** 用go编写的随机数据生成器。   ![star > 100][Bronze]
...
* [banner](https://github.com/dimiro1/banner) **star:233** 在Go应用程序中添加漂亮的横幅(banner)。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [gountries](https://github.com/pariz/gountries) **star:210** 获取国家和细节数据的包。   ![star > 100][Bronze]
* [antch](https://github.com/antchfx/antch) **star:141** 一个快速、强大和可扩展的web爬虫框架。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
...
* [gse](https://github.com/go-ego/gse) **star:1073** 高效的文本分割;支持英语、汉语、日语等。   ![star > 1000][Silver]   ![包含中文文档][CN]
* [when](https://github.com/olebedev/when) **star:927** 带有可插入规则的自然EN和RU语言日期/时间解析器。   ![star > 100][Bronze]
* [gojieba](https://github.com/yanyiwu/gojieba) **star:820** 这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。   ![star > 100][Bronze]   ![包含中文文档][CN]
...
* [whatlanggo](https://github.com/abadojack/whatlanggo) **star:351** Go的自然语言检测包。支持84种语言和24种脚本(书写系统，如拉丁语、西里尔语等)。   ![star > 100][Bronze]
...
* [kcptun](https://github.com/xtaci/kcptun) **star:10680** 基于KCP协议的非常简单和快速udp隧道。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [fasthttp](https://github.com/valyala/fasthttp) **star:9396** 一个快速HTTP实现，比net/http快10倍。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [dns](https://github.com/miekg/dns) **star:3806** 用于 DNS 的库。   ![star > 1000][Silver]
* [HTTPLab](https://github.com/gchaincl/httplab) **star:3408** HTTPLabs 允许你检查 HTTP 请求和伪造响应。   ![star > 1000][Silver]
* [quic-go](https://github.com/lucas-clemente/quic-go) **star:2918** 在纯Go中实现了QUIC协议。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [webrtc](https://github.com/pions/webrtc) **star:2267** WebRTC API的纯Go实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [kcp-go](https://github.com/xtaci/kcp-go) **star:2248** 快速可靠的ARQ协议。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [gobgp](https://github.com/osrg/gobgp) **star:1692** 基于 Go 的 BGP 实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [water](https://github.com/songgao/water) **star:842** 简单TUN / TAP图书馆。   ![star > 100][Bronze]
...
* [go-getter](https://github.com/hashicorp/go-getter) **star:725**  通过URL来下载文件或目录。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [mdns](https://github.com/hashicorp/mdns) **star:552** 简单mDNS(Multicast DNS)客户端/服务器库。   ![star > 100][Bronze]
* [grab](https://github.com/cavaliercoder/grab) **star:546**  用于管理文件下载。   ![star > 100][Bronze]
* [ftp](https://github.com/jlaffaye/ftp) **star:526** 实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户端。   ![star > 100][Bronze]
* [lhttp](https://github.com/fanux/lhttp) **star:513** 强大的websocket框架，可以让你更容易的构建IM服务器。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
* [gosnmp](https://github.com/soniah/gosnmp) **star:438** 用于执行 SNMP 操作的原生 Go 库。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [stun](https://github.com/go-rtc/stun) **star:280** Go实现的RFC 5389 STUN协议。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [gNxI](https://github.com/google/gnxi) **star:100** 一组基于 gNMI 和 gNOI 协议的网络管理工具。   ![star > 100][Bronze]
* [gmqtt](https://github.com/DrmagicE/gmqtt) **star:90** Gmqtt是一个灵活、高性能的MQTT代理库，它完全实现了MQTT协议V3.1.1。   ![包含中文文档][CN]
...
* [grequests](https://github.com/levigross/grequests) **star:1417** 一个 Go “克隆”的伟大和著名的请求库。   ![star > 1000][Silver]
* [heimdall](https://github.com/gojektech/heimdall) **star:1081** 具有重试和hystrix功能的增强http客户机。   ![star > 1000][Silver]
* [sling](https://github.com/dghubble/sling) **star:1005** Sling是一个用于创建和发送API请求的Go HTTP客户端库。   ![star > 1000][Silver]
...
* [GORM](https://github.com/jinzhu/gorm) **star:14689** 一个出色的 ORM 库。主要目标是对开发人员友好。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Xorm](https://github.com/go-xorm/xorm) **star:5216** 基于 Go 的简单而强大的ORM。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [gorp](https://github.com/go-gorp/gorp) **star:3080** 基于 Go 的关系持久性 ORM-ish 库。   ![star > 1000][Silver]
* [go-pg](https://github.com/go-pg/pg) **star:3003** 用于 PostgreSQL 的ORM。侧重于 PostgreSQL 的特性和性能。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) **star:2274** ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。   ![star > 1000][Silver]
* [upper.io/db](https://github.com/upper/db) **star:1850** 对外提供统一的接口用于访问不同的存储介质，例如PostgreSQL, MySQL, SQLite, MSSQL, QL、MongoDB.。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [reform](https://github.com/go-reform/reform) **star:802** 基于非空接口和代码生成的 ORM。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [pop/soda](https://github.com/gobuffalo/pop) **star:679** 数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。   ![star > 100][Bronze]
...
* [dep](https://github.com/golang/dep) **star:12573**  Go 的依赖管理工具，需要 Go 1.9+   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [godep](https://github.com/tools/godep) **star:5652** godep是go的依赖工具，它通过修复包的依赖关系来帮助构建可重复的包。   ![star > 5000][Gold]   ![最近一年没有更新][Yellow]   ![归档项目][Archived]
* [govendor](https://github.com/kardianos/govendor) **star:4745** 包管理器。使用 vendor 文件的 Go vendor 工具。   ![star > 1000][Silver]
...
* [jaeger](https://github.com/jaegertracing/jaeger) **star:8682** 分布式跟踪系统。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [profile](https://github.com/pkg/profile) **star:1010** Go的简单分析支持包。   ![star > 1000][Silver]
* [tracer](https://github.com/kamilsk/tracer) **star:8** 简单、轻量级的跟踪。   ![最近一周有更新][Green]

## 查询语言

* [graphql-go](https://github.com/graphql-go/graphql) **star:5236** 为Go实现GraphQL。   ![star > 5000][Gold]
* [graphql](https://github.com/neelance/graphql-go) **star:2790** 关注易用性的GraphQL服务器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [packr](https://github.com/gobuffalo/packr) **star:2126** 将静态文件嵌入到Go二进制文件中的简单方法。   ![star > 1000][Silver]
* [statik](https://github.com/rakyll/statik) **star:2113** 将静态文件嵌入到Go可执行文件中。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go.rice](https://github.com/GeertJohan/go.rice) **star:1652** go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。   ![star > 1000][Silver]
* [vfsgen](https://github.com/shurcooL/vfsgen) **star:659** 生成一个vfsdata。静态实现给定虚拟文件系统的go文件。   ![star > 100][Bronze]
...
* [gonum](https://github.com/gonum/gonum) **star:2964** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [gonum/plot](https://github.com/gonum/plot) **star:1216** gonum/plot提供了一个API，用于在Go中构建和绘制绘图。   ![star > 1000][Silver]
...
* [graph](https://github.com/yourbasic/graph) **star:234** 基本图形算法库。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [lego](https://github.com/xenolf/lego) **star:3506** 纯 Go ACME 客户端库及命令行工具   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [Cameradar](https://github.com/Ullaakut/cameradar) **star:1825** 工具和库，以远程入侵RTSP流从监控摄像头。   ![star > 1000][Silver]
* [acmetool](https://github.com/hlandau/acme) **star:1693** ACME(让我们用自动更新加密)客户端工具。   ![star > 1000][Silver]   ![最近一年没有更新][Yellow]
* [memguard](https://github.com/awnumar/memguard) **star:1514** 一个用于处理内存中敏感值的纯Go库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [secure](https://github.com/unrolled/secure) **star:1209** Go 语言 HTTP 中间件，为 Go 提供了一些安全功能   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [certificates](https://github.com/mvmaasakkers/certificates) **star:8** 用于生成tls证书的自定义工具。
...
* [jsoniter](https://github.com/json-iterator/go) **star:5550** 高性能，100% 兼容的“encoding/json” 替代品   ![star > 5000][Gold]
* [goprotobuf](https://github.com/golang/protobuf) **star:5098** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) **star:2961** Go 语言的 Protocol Buffer 库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [mapstructure](https://github.com/mitchellh/mapstructure) **star:2439** 用于对原生键值对进行解码生成 Go 语言结构体   ![star > 1000][Silver]
* [go-codec](https://github.com/ugorji/go) **star:1236** 高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成   ![star > 1000][Silver]
...
* [etcd](https://github.com/coreos/etcd) **star:26555** 为共享配置和服务发现提供高可用的键值存储。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Caddy](https://github.com/mholt/caddy) **star:23189** Caddy是另一种HTTP/2 web服务器，易于配置和使用。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [consul](https://www.consul.io/)  Consul 是一个用于服务发现、监控和配置的工具
* [minio](https://github.com/minio/minio) **star:17531** Minio是一个分布式对象存储服务器。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [yakvs](https://git.sci4me.com/sci4me/yakvs)  小型化、网络化、基于内存的键值存储
* [RoadRunner](https://github.com/spiral/roadrunner) **star:3298** 高性能PHP应用服务器，负载平衡器和进程管理器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [devd](https://github.com/cortesi/devd) **star:2805** 为开发人员提供本地web服务器。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [Fider](https://github.com/getfider/fider) **star:797** Fider是一个收集和组织客户反馈的开放平台。   ![star > 100][Bronze]
...
* [go-streams](https://github.com/reugn/go-streams) **star:187** 去流处理库。   ![star > 100][Bronze]   ![最近一周有更新][Green]

## 模板引擎

*用于模板和词法分析的库和工具。 (翻译出错了? 试试 [英文版](README_EN.md#template-engines) 吧~)*

* [gofpdf](https://github.com/jung-kurt/gofpdf) **star:3079** PDF 文档生成器，支持文本，绘图和图片   ![star > 1000][Silver]
...
* [jet](https://github.com/CloudyKit/jet) **star:582** Jet模板引擎。   ![star > 100][Bronze]
...
* Testing Frameworks
    ...
    * [Testify](https://github.com/stretchr/testify) **star:8156** 对标准测试包的扩展。   ![star > 5000][Gold]
    * [go-cmp](https://github.com/google/go-cmp) **star:1169** 用于比较测试中的Go值的包。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    ...
    * [testfixtures](https://github.com/go-testfixtures/testfixtures) **star:328** 类似 Rails 的测试工具，用于测试数据库应用   ![star > 100][Bronze]
    * [go-mutesting](https://github.com/zimmski/go-mutesting) **star:292** 变异测试的Go源代码。   ![star > 100][Bronze]
    ...
    * [gotest.tools](https://github.com/gotestyourself/gotest.tools) **star:121** 一组包，用于增强go测试包并支持公共模式。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* Mock
    * [gomock](https://github.com/golang/mock) **star:2861** 用于Go编程语言的mock框架。   ![star > 1000][Silver]
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) **star:1745** Mock SQL ，用于测试数据库交互   ![star > 1000][Silver]
    * [hoverfly](https://github.com/SpectoLabs/hoverfly) **star:1438** 使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。   ![star > 1000][Silver]
    * [gock](https://github.com/h2non/gock) **star:821** 多功能、易用 HTTP mock   ![star > 100][Bronze]
...
* Fuzzing and delta-debugging/reducing/shrinking.
    * [go-fuzz](https://github.com/dvyukov/go-fuzz) **star:2889** 随机测试系统。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* Selenium and browser control tools.
    * [chromedp](https://github.com/knq/chromedp) **star:3594** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [selenoid](https://github.com/aerokube/selenoid) **star:1232** Selenium hub 服务器的替代品，在容器中启动浏览器   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [cdp](https://github.com/mafredri/cdp) **star:353** 用于Chrome调试协议的类型安全绑定，可与实现该协议的浏览器或其他调试目标一起使用。   ![star > 100][Bronze]
    * [ggr](https://github.com/aerokube/ggr) **star:208** 一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs   ![star > 100][Bronze]

* Fail injection
    * [failpoint](https://github.com/pingcap/failpoint) **star:389** 为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。   ![star > 100][Bronze]
...
* Specific Formats
    * [colly](https://github.com/asciimoo/colly) **star:8432** 快速和优雅的 Scraping 框架。   ![star > 5000][Gold]
    * [GoQuery](https://github.com/PuerkitoBio/goquery) **star:7594** GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能   ![star > 5000][Gold]
    * [blackfriday](https://github.com/russross/blackfriday) **star:3896** Markdown 解析器   ![star > 1000][Silver]
    * [toml](https://github.com/BurntSushi/toml) **star:2789** TOML配置格式(带反射的编码器/解码器)。   ![star > 1000][Silver]   ![最近一周有更新][Green]
    * [sh](https://github.com/mvdan/sh) **star:2002** Shell解析器和格式化工具。   ![star > 1000][Silver]
    ...
    * [inject](https://github.com/facebookgo/inject) **star:1141** 包注入提供了一个基于反射的注入器。   ![star > 1000][Silver]   ![归档项目][Archived]
    ...
    * [dataflowkit](https://github.com/slotix/dataflowkit) **star:291** Web抓取框架将网站转换为结构化数据。   ![star > 100][Bronze]
    ...
    * [go-slugify](https://github.com/mozillazg/go-slugify) **star:42** 生成漂亮的固定链接地址（slug），支持多种语言   ![最近一年没有更新][Yellow]
    ...
    * [go-fixedwidth](https://github.com/ianlopshire/go-fixedwidth) **star:27** 固定宽度的文本格式(带反射的编码器/解码器)。
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) **star:5035** AWS 提供的官方go语言 SDK   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [github](https://github.com/google/go-github) **star:4767** 访问GitHub REST API v3的库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [slack](https://github.com/nlopes/slack) **star:2424** Slack API。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [google](https://github.com/google/google-api-go-client) **star:1924** 为Go自动生成谷歌api。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) **star:1786** 谷歌云api Go 客户端库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [anaconda](https://github.com/ChimeraCoder/anaconda) **star:990**  Twitter 1.1 API 的 go 语言客户端   ![star > 100][Bronze]
...
* [go-jira](https://github.com/andygrunwald/go-jira) **star:576**  Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库   ![star > 100][Bronze]
* [githubql](https://github.com/shurcooL/githubql) **star:503** 访问GitHub GraphQL API v4的库。   ![star > 100][Bronze]
* [webhooks](https://github.com/go-playground/webhooks) **star:356** GitHub 和 Bitbucket 的Webhook接收器。   ![star > 100][Bronze]
...
* [uptimerobot](https://github.com/bitfield/uptimerobot) **star:35** 运行时Robot v2 API 的 Go 语言封装和命令行客户端。
...
* [fzf](https://github.com/junegunn/fzf) **star:23215** 用Go编写的命令行模糊查找器。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [hub](https://github.com/github/hub) **star:17019** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [delve](https://github.com/derekparker/delve) **star:12052** Go 语言调试器   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [ctop](https://github.com/bcicen/ctop) **star:8829** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。   ![star > 5000][Gold]
* [wuzz](https://github.com/asciimoo/wuzz) **star:8262** 用于HTTP检查的交互式cli工具。   ![star > 5000][Gold]
* [sqlx](https://github.com/jmoiron/sqlx) **star:6819** 为内建的数据库/sql 软件包提供一组扩展。   ![star > 5000][Gold]
* [peco](https://github.com/peco/peco) **star:5474** 简单的交互过滤工具。   ![star > 5000][Gold]
* [usql](https://github.com/knq/usql) **star:4676** usql 是一个通用的命令行接口，用于操作 sql 数据库。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [goreleaser](https://github.com/goreleaser/goreleaser) **star:4507** 尽可能快速的发布 Go 语言二进制文件。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [godropbox](https://github.com/dropbox/godropbox) **star:3746** 用于编写 Go 语言服务／应用的库，来自 Dropbox.。   ![star > 1000][Silver]
* [realize](https://github.com/tockins/realize) **star:3167** Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。   ![star > 1000][Silver]
...
* [hystrix-go](https://github.com/afex/hystrix-go) **star:2020** 实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。   ![star > 1000][Silver]
* [resty](https://github.com/go-resty/resty) **star:1985** 简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [Task](https://github.com/go-task/task) **star:1937** 简单的“Go”的选择。   ![star > 1000][Silver]
...
* [Storm](https://github.com/asdine/storm) **star:1357** 一个简单又强大的用于 BoltDB 的工具   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [mole](https://github.com/davrodpin/mole) **star:1301** cli应用程序可以轻松创建ssh隧道。   ![star > 1000][Silver]
* [go-funk](https://github.com/thoas/go-funk) **star:1191** 现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)   ![star > 1000][Silver]
* [mc](https://github.com/minio/mc) **star:1120** Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [filetype](https://github.com/h2non/filetype) **star:951** 通过数字签名来推测文件类型。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [boilr](https://github.com/tmrts/boilr) **star:943** 非常快的CLI工具，用于从样板模板创建项目。   ![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [mergo](https://github.com/imdario/mergo) **star:852** 用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。   ![star > 100][Bronze]
* [spinner](https://github.com/briandowns/spinner) **star:797**  一个 Go 语言软件包，提供多种选项，方便在终端中创建加载动画。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) **star:796** 接通断路器。   ![star > 100][Bronze]
* [git-time-metric](https://github.com/git-time-metric/gtm) **star:718** git-time-metric - 。   ![star > 100][Bronze]
...
* [ergo](https://github.com/cristianoliveira/ergo) **star:311** 管理运行在不同端口上的多个本地服务变得很容易。   ![star > 100][Bronze]
...
* [gubrak](https://github.com/novalagung/gubrak) **star:141** 带有语法糖的Golang实用工具，就像lodash。   ![star > 100][Bronze]
...
* [ulid](https://github.com/oklog/ulid) **star:1678** 实现了ULID(普遍唯一的词典分类标识符)。   ![star > 1000][Silver]
...
* [govalidator](https://github.com/asaskevich/govalidator) **star:3556** 用于字符串，数字，切片和结构的验证器和sanitizers。   ![star > 1000][Silver]
* [validator](https://github.com/go-playground/validator) **star:3526**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。   ![star > 1000][Silver]
...
* [validate](https://github.com/gookit/validate) **star:97**  Go 封装数据验证和过滤。支持验证映射、结构、请求(表单、JSON、url)。值，上载文件)数据和更多特性。   ![包含中文文档][CN]
...
* [go-git](https://github.com/src-d/go-git) **star:4288** 纯Go中高度可扩展的Git实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [git2go](https://github.com/libgit2/git2go) **star:1364**  libgit2 的 Go 语言接口。   ![star > 1000][Silver]
* [hercules](https://github.com/src-d/hercules) **star:539** 从Git存储库历史中获得高级见解。   ![star > 100][Bronze]
...
* [go-astits](https://github.com/asticode/go-astits) **star:259** 在GO中解析和演示MPEG传输流(.ts)。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [Gin](https://github.com/gin-gonic/gin) **star:30038** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Beego](https://github.com/astaxie/beego) **star:21493** beego是一种用于 Go 编程语言的开源高性能web框架。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [Buffalo](http://gobuffalo.io)  为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) **star:14703** 高性能、极简的Go web框架。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Revel](https://github.com/revel/revel) **star:11248** 用于Go语言的高效web框架。   ![star > 5000][Gold]
* [Goa](https://github.com/goadesign/goa) **star:3508** Goa为在Go中开发远程api和微服务提供了一种全面的方法。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-json-rest](https://github.com/ant0ine/go-json-rest) **star:3335** 设置RESTful JSON API的快速简便方法。   ![star > 1000][Silver]
* [Gizmo](https://github.com/NYTimes/gizmo) **star:2851** 《纽约时报》使用的微服务工具包。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [rux](https://github.com/gookit/rux) **star:7** 用于构建golang HTTP应用程序的简单而快速的web框架。   ![最近一周有更新][Green]   ![包含中文文档][CN]
...
* [Tollbooth](https://github.com/didip/tollbooth) **star:1251** 限制速率的 HTTP 请求处理程序。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [negroni](https://github.com/urfave/negroni) **star:6338** 符合语言习惯的 HTTP 中间件库。   ![star > 5000][Gold]   ![包含中文文档][CN]
...
* [httprouter](https://github.com/julienschmidt/httprouter) **star:9729** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。   ![star > 5000][Gold]
* [mux](https://github.com/gorilla/mux) **star:9686** 强大的URL路由器和调度器为golang。   ![star > 5000][Gold]
* [chi](https://github.com/go-chi/chi) **star:6050** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [fasthttprouter](https://github.com/buaazp/fasthttprouter) **star:750** 高性能路由器分叉从`httprouter`。第一个路由器适合`fasthttp`。   ![star > 100][Bronze]
* [xujiajun/gorouter](https://github.com/xujiajun/gorouter) **star:450** 一个简单和快速的HTTP路由器 Go 。   ![star > 100][Bronze]
...
* [xpath](https://github.com/antchfx/xpath) **star:169** Go的XPath包。   ![star > 100][Bronze]
...
* [GoLint](https://github.com/golang/lint) **star:3157** Go 源码的 linter。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [php-parser](https://github.com/z7zmey/php-parser) **star:637** 用 Go 编写的 PHP 解析器。   ![star > 100][Bronze]
* [go-critic](https://github.com/go-critic/go-critic) **star:578** 源代码检查工具。   ![star > 100][Bronze]
...
* [vim-go](https://github.com/fatih/vim-go) **star:10854** Go 开发会用到的 Vim 插件。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) **star:5133** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [GoSublime](https://github.com/DisposaBoy/GoSublime) **star:3241** 包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。   ![star > 1000][Silver]
...
* [gotests](https://github.com/cweill/gotests) **star:2207** 从源代码生成测试用例。   ![star > 1000][Silver]
* [genny](https://github.com/cheekybits/genny) **star:969** 优雅的 Go 泛型。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [go-swagger](https://github.com/go-swagger/go-swagger) **star:3998** 基于 Go 的Swagger 2.0实现。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [OctoLinker](https://github.com/OctoLinker/browser-extension) **star:3801** 借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。   ![star > 1000][Silver]   ![最近一周有更新][Green]
* [go-callvis](https://github.com/TrueFurby/go-callvis) **star:1992** 使用 dot format 可视化 Go 程序的调用图。   ![star > 1000][Silver]
...
* [kubernetes](https://github.com/kubernetes/kubernetes) **star:56422** 来自谷歌的容器集群管理器。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Moby](https://github.com/moby/moby) **star:54457** Collaborative project for the container ecosystem to assemble container-based systems.   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [traefik](https://github.com/containous/traefik) **star:23796** 反向代理和负载均衡器，支持多个后端。   ![star > 5000][Gold]   ![最近一周有更新][Green]
...
* [Gitea](https://github.com/go-gitea/gitea) **star:15335** 从 Gogs fork，完全由社区驱动。   ![star > 5000][Gold]   ![最近一周有更新][Green]   ![包含中文文档][CN]
* [Vegeta](https://github.com/tsenart/vegeta) **star:12208** HTTP负载测试工具和库。超过9000 !   ![star > 5000][Gold]
* [Packer](https://github.com/mitchellh/packer) **star:9247** 用于从一个源配置为多个平台创建相同的机器图像。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Hey](https://github.com/rakyll/hey) **star:6334** 压力测试工具，可用来代替 ApacheBench (ab)。   ![star > 5000][Gold]
* [GVM](https://github.com/moovweb/gvm) **star:4479** GVM 提供了一个接口来管理 Go 版本。   ![star > 1000][Silver]
...
* [gaia](https://github.com/gaia-pipeline/gaia) **star:3747** 可用于任何编程语言来构建强大的管道。   ![star > 1000][Silver]
...
* [bombardier](https://github.com/codesenberg/bombardier) **star:1752** 快速跨平台 HTTP 基准测试工具。   ![star > 1000][Silver]
...
* [kala](https://github.com/ajvb/kala) **star:1359** 简单、现代和高性能的作业调度程序。   ![star > 1000][Silver]
* [StatusOK](https://github.com/sanathp/statusok) **star:1164** 监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。   ![star > 1000][Silver]
* [s3gof3r](https://github.com/rlmcpherson/s3gof3r) **star:999** 小型实用程序/库，针对大型对象在Amazon S3中的高速传输进行了优化。   ![star > 100][Bronze]
* [script](https://github.com/bitfield/script) **star:922** 让DevOps编写类shell和系统管理任务变得更加容易。   ![star > 100][Bronze]
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) **star:673** 允许你的 Go应用程序 进行自我更新。   ![star > 100][Bronze]   ![最近一周有更新][Green]
* [skm](https://github.com/TimothyYe/skm) **star:550** SKM是一个简单而强大的SSH密钥管理器，它可以帮助您轻松地管理多个SSH密钥!   ![star > 100][Bronze]
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) **star:539** 从命令行管理 BareMetal 服务器(与使用Docker一样容易)。   ![star > 100][Bronze]
* [Pomerium](https://github.com/pomerium/pomerium) **star:515** Pomerium是一个可识别身份的访问代理。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [Gor](https://github.com/buger/gor) **star:11373** Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [rkt](https://github.com/coreos/rkt) **star:8749** 一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) **star:8268** 快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。   ![star > 5000][Gold]   ![最近一周有更新][Green]
* [restic](https://github.com/restic/restic) **star:7499** 消除重复项备份程序。   ![star > 5000][Gold]
* [confd](https://github.com/kelseyhightower/confd) **star:6424** 使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。   ![star > 5000][Gold]
* [Comcast](https://github.com/tylertreat/Comcast) **star:6178** 模拟坏的网络连接。   ![star > 5000][Gold]
* [LiteIDE](https://github.com/visualfc/liteide) **star:5500** 简单的、开源的、跨平台的Go IDE。   ![star > 5000][Gold]   ![包含中文文档][CN]
* [drive](https://github.com/odeke-em/drive) **star:4967** 基于命令行的谷歌驱动器客户端。   ![star > 1000][Silver]
* [nes](https://github.com/fogleman/nes) **star:4127** 任天堂娱乐系统(NES)模拟器。   ![star > 1000][Silver]
* [tsuru](https://tsuru.io/)  Extensible and open source Platform as a Service software.
* [toxiproxy](https://github.com/shopify/toxiproxy) **star:3948** 为自动化测试模拟网络和系统条件的代理。   ![star > 1000][Silver]
* [Pipe](https://github.com/b3log/pipe) **star:2978** 一个小巧漂亮的博客平台。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [GoBoy](https://github.com/Humpheh/goboy) **star:2106** 用 Go 编写的任天堂Game Boy彩色模拟器。   ![star > 1000][Silver]
* [Stack Up](https://github.com/pressly/sup) **star:1992** Stack Up 是一个超级简单的部署工具 — 只面向Unix。   ![star > 1000][Silver]
...
* [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) **star:867** Go序列化方法的基准测试。   ![star > 100][Bronze]   ![最近一周有更新][Green]
...
* [GoBooks](https://github.com/dariubs/GoBooks) **star:6806** 一份精选的 Go 书籍清单。   ![star > 5000][Gold]
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) **star:1544** 由 Maria Letta 提供的与 Gopher 有关的图片包，其中包含了插图,表情文字。   ![star > 1000][Silver]   ![最近一周有更新][Green]
...
* [gophers](https://github.com/ashleymcnamara/gophers) **star:1857** 阿什莉·麦克纳马拉的歌斐艺术品。   ![star > 1000][Silver]
...
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) **star:24659** 其他 awesome 系列的列表。   ![star > 5000][Gold]
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) **star:31571** Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。   ![star > 5000][Gold]   ![包含中文文档][CN]
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) **star:4554** 学习使用测试驱动开发。   ![star > 1000][Silver]   ![最近一周有更新][Green]   ![包含中文文档][CN]
