...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-20 20:56:15(每隔1天同步一次)**
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [authboss](https://github.com/volatiletech/authboss)  | 1913 |  web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [branca](https://github.com/hako/branca)  | 72 |  基于 Go 实现Branca令牌。 |
| [casbin](https://github.com/hsluoyz/casbin)  | 4836 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [cookiestxt](https://github.com/mengzhuo/cookiestxt)  | 2 |  提供cookie .txt文件格式的解析器。 |![最近一年没有更新][Yellow]
| [go-jose](https://github.com/square/go-jose)  | 1113 |  相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。 |![star > 1000][Silver]   
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server)  | 1266 |  用 Golang 编写的独立且符合规范的OAuth2服务器。 |![star > 1000][Silver]   
| [gologin](https://github.com/dghubble/gologin)  | 1035 |  用于使用OAuth1和OAuth2身份验证提供者登录的可链处理程序。 |![star > 1000][Silver]   
| [gorbac](https://github.com/mikespook/gorbac)  | 900 |  轻量级的基于角色的访问控制(RBAC)实现。 |![star > 100][Bronze]   
| [goth](https://github.com/markbates/goth)  | 2236 |  提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。 |![star > 1000][Silver]   
...
| [jwt](https://github.com/pascaldekloe/jwt)  | 79 |  轻量级JSON Web令牌库。 |
| [jwt-auth](https://github.com/adam-hanna/jwt-auth)  | 151 |  JWT中间件，可用于Golang http服务器，提供了许多配置选项。 |![star > 100][Bronze]   
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5846 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]   
| [loginsrv](https://github.com/tarent/loginsrv)  | 801 |  JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [paseto](https://github.com/o1egl/paseto)  | 227 |  平台无关的安全令牌(PASETO)。 |![star > 100][Bronze]   
...
| [Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot)  | 211 |  基于控制台的，用于加密货币交易所的的交易机器人。 |![star > 100][Bronze]   
...
| [Kelp](https://github.com/stellar/kelp)  | 153 |  官方交易和做市机器人为[Stellar](https://www.stellar.org/) DEX。开箱即用的作品，用 Golang 编写，兼容集中交易和定制交易策略。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [telebot](https://github.com/tucnak/telebot)  | 939 |  用Go编写的Telegram bot框架。 |![star > 100][Bronze]   
...
| [cli-init](https://github.com/tcnksm/gcli)  | 867 |  一个简单就可开启构建Golang命令行的应用程序。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [climax](http://github.com/tucnak/climax)  | - |  Alternative CLI with "human face", in spirit of Go command. |
| [cmdr](https://github.com/hedzr/cmdr)  | 8 |  一个POSIX/GNU风格的、类似getopt的命令行UI Go库。 |![最近一个周有更新][Green]
| [cobra](https://github.com/spf13/cobra)  | 13018 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [commandeer](https://github.com/jaffee/commandeer)  | 85 |  开发友好的CLI应用程序。 |
| [complete](https://github.com/posener/complete)  | 610 |  使用 Go 语言编写的 bash 命令补全工具以及 Go 命令补全工具. |![star > 100][Bronze]   
| [docopt.go](https://github.com/docopt/docopt.go)  | 1164 |  会让你满意的命令行参数解析器。 |![star > 1000][Silver]   
...
| [go-arg](https://github.com/alexflint/go-arg)  | 652 |  基于结构的参数解析。 |![star > 100][Bronze]   
| [go-commander](https://github.com/yitsushi/go-commander)  | 14 |  用于简化CLI工作流的 Go 库。 |
| [go-flags](https://github.com/jessevdk/go-flags)  | 1498 |   Go 命令行选项解析器。 |![star > 1000][Silver]   
...
| [job](https://github.com/liujianping/job)  | 48 |  工作，把你的短期指令当作长期任务。 |
| [kingpin](https://github.com/alecthomas/kingpin)  | 2512 |  支持子命令的命令行和标志解析器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [liner](https://github.com/peterh/liner)  | 575 |  类似readline-like的命令行接口库。 |![star > 100][Bronze]   
...
| [pflag](https://github.com/spf13/pflag)  | 742 |  基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。 |![star > 100][Bronze]   
| [readline](https://github.com/chzyer/readline)  | 1362 |  纯golang实现，在MIT许可下提供了GNU-Readline的大部分特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [urfave/cli](https://github.com/urfave/cli)  | 11212 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [aurora](https://github.com/logrusorgru/aurora)  | 616 |  支持fmt.Printf/Sprintf的ANSI终端颜色。 |![star > 100][Bronze]   
...
| [color](https://github.com/fatih/color)  | 2997 |  多功能包装，彩色终端输出。 |![star > 1000][Silver]   
...
| [gocui](https://github.com/jroimartin/gocui)  | 5217 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   
...
| [termbox-go](https://github.com/nsf/termbox-go)  | 3453 |  基于文本的跨平台接口库。 |![star > 1000][Silver]   
| [termdash](https://github.com/mum4k/termdash)  | 797 |  此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。 |![star > 100][Bronze]   
...
| [termui](https://github.com/gizak/termui)  | 8848 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [env](https://github.com/caarlos0/env)  | 845 |  解析环境变量并赋值到struct中(默认值)。 |![star > 100][Bronze]   
...
| [godotenv](https://github.com/joho/godotenv)  | 2087 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]   
...
| [ini](https://github.com/go-ini/ini)  | 1561 |   读和写INI文件。 |![star > 1000][Silver]   
...
| [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig)  | 2377 |  管理来自环境变量的配置数据。 |![star > 1000][Silver]   
| [koanf](https://github.com/knadh/koanf)  | 79 |  轻量级可扩展库，用于读取Go应用程序中的配置。内置支持JSON, TOML, YAML, env，命令行。 |![最近一个周有更新][Green]
| [konfig](https://github.com/lalamove/konfig)  | 509 |  可组合、可观察和高性能的分布式配置管理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [viper](https://github.com/spf13/viper)  | 9162 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18836 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5095 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]   
...
| [gods](https://github.com/emirpasic/gods)  | 6186 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]   
| [golang-set](https://github.com/deckarep/golang-set)  | 1146 |  线程安全和非线程安全的高性能集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gota](https://github.com/kniren/gota)  | 862 |  实现了数据帧，序列以及数据噪音。 |![star > 100][Bronze]   
...
| [trie](https://github.com/derekparker/trie)  | 413 |  在Go中实现Trie。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6194 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [bolt](https://github.com/boltdb/bolt)  | 9915 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
| [cache2go](https://github.com/muesli/cache2go)  | 994 |  基于内存的 K/V 缓存，支持超时的自动失效。 |![star > 100][Bronze]   
| [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache)  | 29 |  BigCache 支持集群和独立且生命周期存储项。 |![最近一年没有更新][Yellow]
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16686 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [couchcache](https://github.com/codingsince1985/couchcache)  | 40 |  由 Couchbase服务 支持的RESTful缓存微服务。 |
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL)  | 1444 |  区块链领域的一个SQL数据库。 |![star > 1000][Silver]   
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10049 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache)  | 476 |  基于内存的快速线程安全的缓存，可缓存大量的条目。最大限度地减少GC开销。 |![star > 100][Bronze]   
| [GCache](https://github.com/bluele/gcache)  | 878 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]   
| [go-cache](https://github.com/pmylund/go-cache)  | 2837 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]   
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3136 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]   
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7607 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [influxdb](https://github.com/influxdb/influxdb)  | 16860 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [ledisdb](https://github.com/siddontang/ledisdb)  | 3057 |  Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。 |![star > 1000][Silver]   
| [levigo](https://github.com/jmhodges/levigo)  | 364 |  实现了对LevelDB封装。 |![star > 100][Bronze]   
| [moss](https://github.com/couchbase/moss)  | 717 |  Moss是一个用100% Go编写的简单LSM键值存储引擎。 |![star > 100][Bronze]   
| [nutsdb](https://github.com/xujiajun/nutsdb)  | 850 |  Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。 |![star > 100][Bronze]   
| [piladb](https://github.com/fern4lvarez/piladb)  | 171 |  基于堆栈数据结构的轻量级RESTful数据库引擎。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [prometheus](https://github.com/prometheus/prometheus)  | 25228 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 218 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]   
| [rqlite](https://github.com/rqlite/rqlite)  | 4665 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tidb](https://github.com/pingcap/tidb)  | 19784 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 954 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gormigrate](https://github.com/go-gormigrate/gormigrate)  | 325 |  面向Gorm ORM的数据库 schema 迁移辅助程序。 |![star > 100][Bronze]   
| [migrate](https://github.com/golang-migrate/migrate)  | 2530 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   
...
| [sql-migrate](https://github.com/rubenv/sql-migrate)  | 1386 |  数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk)  | 132 |  收集小的 insterts 并向 ClickHouse 服务器发送大请求。 |![star > 100][Bronze]   
...
| [go-mysql](https://github.com/siddontang/go-mysql)  | 1848 |   Go 工具集，用于处理MySQL协议和复制。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2345 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]   
| [kingshard](https://github.com/flike/kingshard)  | 4565 |  kingshard 是基于 Golang 的MySQL高性能代理。 |![star > 1000][Silver]   
...
| [orchestrator](https://github.com/github/orchestrator)  | 2997 |  MySQL复制拓扑管理器和可视化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pgweb](https://github.com/sosedoff/pgweb)  | 5955 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]   
...
| [vitess](https://github.com/youtube/vitess)  | 8358 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [goqu](https://github.com/doug-martin/goqu)  | 622 |  常用的SQL生成器和查询库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2228 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]   
| [xo](https://github.com/knq/xo)  | 2156 |  基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。 |![star > 1000][Silver]   
...
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb)  | 1013 |  微软MSSQL驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-oci8](https://github.com/mattn/go-oci8)  | 402 |  Oracle 驱动程序。 |![star > 100][Bronze]   
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 7997 |  MySQL驱动程序。 |![star > 5000][Gold]   
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3397 |  SQLite3驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pgx](https://github.com/jackc/pgx)  | 1880 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pq](https://github.com/lib/pq)  | 5130 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 2998 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6212 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   
| [redis](https://github.com/go-redis/redis)  | 6359 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5782 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4067 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch)  | 1516 |  官方 Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goes](https://github.com/OwnLocal/goes)  | 24 |  实现了与 Elasticsearch 交互的库。 |![最近一年没有更新][Yellow]
| [riot](https://github.com/go-ego/riot)  | 4660 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   
...
| [cayley](https://github.com/google/cayley)  | 12643 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dateparse](https://github.com/araddon/dateparse)  | 882 |  可以解析很多格式不固定的日期字符串。 |![star > 100][Bronze]   
...
| [now](https://github.com/jinzhu/now)  | 2156 |  now 是时间有关的工具类。 |![star > 1000][Silver]   
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2488 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [emitter-io](https://github.com/emitter-io/emitter)  | 1898 |  高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。 |![star > 1000][Silver]   
| [flowgraph](https://github.com/vectaport/flowgraph)  | 18 |  flow-based programming package。 |
| [gleam](https://github.com/chrislusf/gleam)  | 2057 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]   
| [glow](https://github.com/chrislusf/glow)  | 2507 |  全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。 |![star > 1000][Silver]   
...
| [go-kit](https://github.com/go-kit/kit)  | 14274 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]   
| [gorpc](https://github.com/valyala/gorpc)  | 547 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8934 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 997 |  支持25+种语言RPC库。 |![star > 100][Bronze]   
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8520 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1715 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   
| [micro](https://github.com/micro/micro)  | 6500 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   
| [NATS](https://github.com/nats-io/gnatsd)  | 6217 |  轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [ringpop-go](https://github.com/uber/ringpop-go)  | 569 |  可伸缩的，容错、应用分层的的Go应用程序。 |![star > 100][Bronze]   
| [rpcx](https://github.com/smallnest/rpcx)  | 3712 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]   
...
| [tendermint](https://github.com/tendermint/tendermint)  | 3096 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [torrent](https://github.com/anacrolix/torrent)  | 2813 |  BitTorrent 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-imap](https://github.com/emersion/go-imap)  | 719 |  用于客户端和服务器的IMAP库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [hermes](https://github.com/matcornic/hermes)  | 1606 |  可生成干净的、响应式的HTML电子邮件。 |![star > 1000][Silver]   
| [MailHog](https://github.com/mailhog/MailHog)  | 5100 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]   
...
| [expr](https://github.com/antonmedv/expr)  | 680 |  一个可以计算表达式的引擎。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-lua](https://github.com/Shopify/go-lua)  | 1656 |  用 Go 实现的 Lua 5.2 VM接口。 |![star > 1000][Silver]   
| [go-php](https://github.com/deuill/go-php)  | 673 |  PHP 的 Go 接口。 |![star > 100][Bronze]   
| [go-python](https://github.com/sbinet/go-python)  | 900 |  CPython C-API 的 Go 接口。 |![star > 100][Bronze]   
| [golua](https://github.com/aarzilli/golua)  | 440 |  Lua C 的 Go 接口。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2925 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]   
...
| [otto](https://github.com/robertkrimen/otto)  | 4700 |  用 Go 编写的 JavaScript 解释器。 |![star > 1000][Silver]   
| [purl](https://github.com/ian-kent/purl)  | 27 |  嵌入 Go 的 Perl 5.18.2。 |![最近一年没有更新][Yellow]
| [tengo](https://github.com/d5/tengo)  | 1281 |  字节码编译的脚本语言。 |![star > 1000][Silver]   
...
| [errors](https://github.com/pkg/errors)  | 4792 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2195 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-csv-tag](https://github.com/artonge/go-csv-tag)  | 45 |  使用 tag 加载 csv 文件。 |![最近一个周有更新][Green]
...
| [decimal](https://github.com/shopspring/decimal)  | 1576 |  任意精度定点的十进制数。 |![star > 1000][Silver]   
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1820 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [engo](https://github.com/EngoEngine/engo)  | 1075 |  开源 2D 游戏引擎。它遵循 Entity-Component-System 范式。 |![star > 1000][Silver]   
| [g3n](https://github.com/g3n/engine)  | 734 |   3D游戏引擎。 |![star > 100][Bronze]   
...
| [go-sdl2](https://github.com/veandco/go-sdl2)  | 1144 |  实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。 |![star > 1000][Silver]   
| [go3d](https://github.com/ungerik/go3d)  | 165 |  以性能为主的2D/3D数学相关包。 |![star > 100][Bronze]   
| [gonet](https://github.com/xtaci/gonet)  | 1047 |  实现了游戏服务器骨架。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
| [goworld](https://github.com/xiaonanln/goworld)  | 1154 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   
| [Leaf](https://github.com/name5566/leaf)  | 3028 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   
| [nano](https://github.com/lonng/nano)  | 969 |  轻量级、方便、高性能的基于golang的游戏服务器框架。 |![star > 100][Bronze]   
| [Oak](https://github.com/oakmound/oak)  | 622 |  纯 Go 实现的游戏引擎。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Pitaya](https://github.com/topfreegames/pitaya)  | 294 |  可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Pixel](https://github.com/faiface/pixel)  | 2417 |  手工制作的 2D 游戏库。 |![star > 1000][Silver]   
...
| [go-linq](https://github.com/ahmetalpbalkan/go-linq)  | 1785 |  提供类似 .NET LINQ 的查询方法。 |![star > 1000][Silver]   
| [goderive](https://github.com/awalterschulze/goderive)  | 733 |  从输入类型来派生函数。 |![star > 100][Bronze]   
...
| [osm](https://github.com/paulmach/osm)  | 65 |  用于读取、写入和处理 OpenStreetMap 数据和 APIs。 |
| [pbf](https://github.com/maguro/pbf)  | 15 |  基于Golang 的 OpenStreetMap PBF 编码器/解码器。 |
| [S2 geometry](https://github.com/golang/geo)  | 879 |  S2 geometry 库。 |![star > 100][Bronze]   
| [Tile38](https://github.com/tidwall/tile38)  | 6291 |  具有空间索引和实时地理定位功能的地理定位数据库。 |![star > 5000][Gold]   
...
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8489 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1807 |  一个高性能的协程池。 |![star > 1000][Silver]   
...
| [breaker](https://github.com/kamilsk/breaker)  | 28 |  灵活的机制，可以使执行流可中断。 |
...
| [goworker](https://github.com/benmanns/goworker)  | 2230 |  基于 go 的后台 worker。 |![star > 1000][Silver]   
...
| [tunny](https://github.com/Jeffail/tunny)  | 1322 |  golang 的协程池。 |![star > 1000][Silver]   
| [worker-pool](https://github.com/vardius/worker-pool)  | 43 |  一个简单的 Go 异步工作池。 |![最近一个周有更新][Green]
| [workerpool](https://github.com/gammazero/workerpool)  | 128 |  限制任务执行并发数，而不是队列中的任务数量的协程池，。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [app](https://github.com/murlokswarm/app)  | 2939 |  用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。 |![star > 1000][Silver]   
| [fyne](https://github.com/fyne-io/fyne)  | 6137 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [go-astilectron](https://github.com/asticode/go-astilectron)  | 2626 |  使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。 |![star > 1000][Silver]   
| [go-gtk](http://mattn.github.io/go-gtk/)  | - |  实现了 GTK 的 Go接口。 |
| [go-sciter](https://github.com/sciter-sdk/go-sciter)  | 1435 |  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gotk3](https://github.com/gotk3/gotk3)  | 755 |  实现了 GTK3 的 Go接口。 |![star > 100][Bronze]   
| [gowd](https://github.com/dtylman/gowd)  | 206 |  跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。 |![star > 100][Bronze]   
| [qt](https://github.com/therecipe/qt)  | 5942 |  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。 |![star > 5000][Gold]   
| [ui](https://github.com/andlabs/ui)  | 6884 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]   
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3663 |  Windows应用程序库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [webview](https://github.com/zserge/webview)  | 4578 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]   
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4386 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [bimg](https://github.com/h2non/bimg)  | 781 |  使用libvips实现的快速高效的图像处理包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [geopattern](https://github.com/pravj/geopattern)  | 1009 |  由字符串创建漂亮图案的图片生成器。 |![star > 1000][Silver]   
| [gg](https://github.com/fogleman/gg)  | 1894 |  纯Go语言实现的2D渲染。 |![star > 1000][Silver]   
...
| [gocv](https://github.com/hybridgroup/gocv)  | 2401 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [imagick](https://github.com/gographics/imagick)  | 964 |   ImageMagick下MagickWand的C API的Go binding。 |![star > 100][Bronze]   
| [imaginary](https://github.com/h2non/imaginary)  | 2574 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]   
| [imaging](https://github.com/disintegration/imaging)  | 2486 |  简单的Go图像处理包。 |![star > 1000][Silver]   
| [img](https://github.com/hawx/img)  | 129 |  图像处理工具的集合。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [ln](https://github.com/fogleman/ln)  | 2455 |  Go实现的3D线艺术（3D Line Art）渲染。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [picfit](https://github.com/thoas/picfit)  | 1056 |  Go实现的图像调整服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pt](https://github.com/fogleman/pt)  | 1763 |  Go实现的路径跟踪（path tracing）引擎。 |![star > 1000][Silver]   
| [resize](https://github.com/nfnt/resize)  | 2118 |  Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
| [flogo](https://github.com/tibcosoftware/flogo)  | 1108 |  Flogo是一个面向物联网边缘应用和集成的开源框架。 |![star > 1000][Silver]   
...
| [mainflux](https://github.com/Mainflux/mainflux)  | 575 |  工业物联网消息和设备管理服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4805 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [glog](https://github.com/golang/glog)  | 2290 |  为Go提供了多等级日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11736 |  Go的结构化日志操作 。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [lumberjack](https://github.com/natefinch/lumberjack)  | 1416 |  简单的滚动日志，io.WriteCloser的实现。 |![star > 1000][Silver]   
| [mlog](https://github.com/jbrodriguez/mlog)  | 18 |  简单的go日志模块，有5个级别，可选循环(rotation)日志文件记录功能和stdout/stderr输出。 |
| [onelog](https://github.com/francoispqt/onelog)  | 328 |  Onelog是一个非常简单但非常高效的JSON日志程序。它是所有场景中速度最快的JSON日志程序。而且，它是配置要求最低的日志记录器之一。 |![star > 100][Bronze]   
...
| [spew](https://github.com/davecgh/go-spew)  | 3262 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [stdlog](https://github.com/alexcesaro/log)  | 43 |  Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。 |![最近一年没有更新][Yellow]
| [tail](https://github.com/hpcloud/tail)  | 1519 |  努力模拟实现BSD的tail的特性的Go包。 |![star > 1000][Silver]   
...
| [zap](https://github.com/uber-go/zap)  | 7312 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]   
| [zerolog](https://github.com/rs/zerolog)  | 2145 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gobrain](https://github.com/goml/gobrain)  | 377 |  用 Go 编写的神经网络库。 |![star > 100][Bronze]   
...
| [gorgonia](https://github.com/chewxy/gorgonia)  | 2663 |  基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。 |![star > 1000][Silver]   
| [gorse](https://github.com/zhenghaoz/gorse)  | 519 |  基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。 |![star > 100][Bronze]   
| [goscore](https://github.com/asafschers/goscore)  | 35 |   为预言模型标记语言（PMML）实现的评分API。 |
| [gosseract](https://github.com/otiai10/gosseract)  | 857 |  使用c++的Tesseract库实现的OCR。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [tfgo](https://github.com/galeone/tfgo)  | 1173 |  易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [APNs2](https://github.com/sideshow/apns2)  | 2034 |  HTTP / 2苹果消息推送provider——发送推送消息到iOS, tvOS, Safari和OSX应用。 |![star > 1000][Silver]   
| [Beaver](https://github.com/Clivern/Beaver)  | 715 |  一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。 |![star > 100][Bronze]   
| [Benthos](https://github.com/Jeffail/benthos)  | 1934 |  一系列协议之间的消息流桥接。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Bus](https://github.com/mustafaturan/bus)  | 114 |  内部通信的最小消息总线实现。 |![star > 100][Bronze]   
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3641 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   
...
| [EventBus](https://github.com/asaskevich/EventBus)  | 548 |  具有异步兼容性的轻量级事件总线。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-nsq](https://github.com/nsqio/go-nsq)  | 1448 |  NSQ的官方Go包。 |![star > 1000][Silver]   
| [go-socket.io](https://github.com/googollee/go-socket.io)  | 2855 |  go的socket.io库，一个实时应用程序框架。 |![star > 1000][Silver]   
| [go-vitotrol](https://github.com/maxatome/go-vitotrol)  | 11 |  用于Viessmann Vitotrol web服务的客户端库。 |
| [Gollum](https://github.com/trivago/gollum)  | 764 |  一个n:m多路复用器(n:m multiplexer)，收集不同来源的消息并将其广播到一组目的地。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster)  | 1827 |  gopush-cluster是一个gopush服务器集群。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
| [gorush](https://github.com/appleboy/gorush)  | 3672 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3332 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mangos](https://github.com/go-mangos/mangos)  | 1532 |  Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。 |![star > 1000][Silver]   
| [melody](https://github.com/olahol/melody)  | 1538 |  处理websocket session的极简框架，包括广播和自动ping/pong处理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Mercure](https://github.com/dunglas/mercure)  | 1467 |  使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [messagebus](https://github.com/vardius/message-bus)  | 63 |  messagebus是一个Go的简单异步消息总线，非常适合在执行事件sourcing、CQRS和DDD时用作事件总线。 |![最近一个周有更新][Green]
| [NATS Go Client](https://github.com/nats-io/nats)  | 2366 |  轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。 |![star > 1000][Silver]   
...
| [sarama](https://github.com/Shopify/sarama)  | 4553 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1660 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4370 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3325 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]   
...
| [dig](https://github.com/uber-go/dig)  | 885 |  一个基于反射的Go依赖注入工具包。 |![star > 100][Bronze]   
| [fx](https://github.com/uber-go/fx)  | 655 |  基于依赖注入的Go应用程序框架(构建在dig之上)。 |![star > 100][Bronze]   
| [gocontainer](https://github.com/vardius/gocontainer)  | 8 |  简单的依赖注入容器。 |
| [inject](https://github.com/defval/inject)  | 21 |  一个基于反射的依赖注入容器，具有简单的接口。 |![最近一个周有更新][Green]
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8755 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [antch](https://github.com/antchfx/antch)  | 139 |  一个快速、强大和可扩展的web爬行和抓取框架。 |![star > 100][Bronze]   
| [archiver](https://github.com/mholt/archiver)  | 2471 |  用于生成和提取.zip和.tar.gz存档的库和命令。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gommit](https://github.com/antham/gommit)  | 69 |  分析git提交消息，确保它们遵循已定义的模式。 |
| [gopsutil](https://github.com/shirou/gopsutil)  | 3875 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [lk](https://github.com/hyperboloide/lk)  | 115 |  一个简单的golang授权库。 |![star > 100][Bronze]   
...
| [gojieba](https://github.com/yanyiwu/gojieba)  | 808 |  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。 |![star > 100][Bronze]   
...
| [gse](https://github.com/go-ego/gse)  | 1060 |  高效的文本分割;支持英语、汉语、日语等。 |![star > 1000][Silver]   
...
| [dns](https://github.com/miekg/dns)  | 3761 |  用于 DNS 的库。 |![star > 1000][Silver]   
...
| [fasthttp](https://github.com/valyala/fasthttp)  | 9197 |  一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gobgp](https://github.com/osrg/gobgp)  | 1658 |  基于 Go 的 BGP 实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [golibwireshark](https://github.com/sunwxg/golibwireshark)  | 14 |  用于解码 pcap 文件和分析解剖数据。 |![最近一年没有更新][Yellow]
| [gopacket](https://github.com/google/gopacket)  | 2829 |  Go library for packet processing with libpcap bindings. |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gosnmp](https://github.com/soniah/gosnmp)  | 429 |  用于执行 SNMP 操作的原生 Go 库。 |![star > 100][Bronze]   
...
| [kcp-go](https://github.com/xtaci/kcp-go)  | 2227 |  快速可靠的ARQ协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [kcptun](https://github.com/xtaci/kcptun)  | 10612 |  基于KCP协议的非常简单和快速udp隧道。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mdns](https://github.com/hashicorp/mdns)  | 545 |  简单mDNS(Multicast DNS)客户端/服务器库。 |![star > 100][Bronze]   
| [mqttPaho](https://eclipse.org/paho/clients/golang/)  | - |  Paho Go客户端提供了一个 MQTT 客户端库，用于通过TCP、TLS或WebSockets连接到MQTT代理。 |
| [NFF-Go](https://github.com/intel-go/nff-go)  | 650 |  用于快速开发云计算和裸机网络功能的框架(原YANFF)。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [packet](https://github.com/aerogo/packet)  | 26 |  通过TCP和UDP发送数据包。它可以缓冲消息和热交换连接。 |
| [peerdiscovery](https://github.com/schollz/peerdiscovery)  | 357 |  基于UDP组播的跨平台本地对等点发现库。 |![star > 100][Bronze]   
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2853 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [raw](https://github.com/mdlayher/raw)  | 303 |  Package raw支持在设备驱动程序级别读取和写入网络接口的数据。 |![star > 100][Bronze]   
| [sftp](https://github.com/pkg/sftp)  | 721 |  Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |![star > 100][Bronze]   
...
| [stun](https://github.com/go-rtc/stun)  | 266 |  Go实现的RFC 5389 STUN协议。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [webrtc](https://github.com/pions/webrtc)  | 2150 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gentleman](https://github.com/h2non/gentleman)  | 674 |  功能齐全的插件驱动HTTP客户端库。 |![star > 100][Bronze]   
| [goreq](https://github.com/smallnest/goreq)  | 98 |  基于gorequest的增强简化HTTP客户机。 |
| [grequests](https://github.com/levigross/grequests)  | 1402 |  一个 Go “克隆”的伟大和著名的请求库。 |![star > 1000][Silver]   
| [heimdall](https://github.com/gojektech/heimdall)  | 1062 |  具有重试和hystrix功能的增强http客户机。 |![star > 1000][Silver]   
...
| [sling](https://github.com/dghubble/sling)  | 971 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [mathgl](https://github.com/go-gl/mathgl)  | 290 |  完全基于 Go 实现的数学软件包，专门用于处理三维数学。借鉴于 GLM。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-pg](https://github.com/go-pg/pg)  | 2924 |  用于 PostgreSQL 的ORM。侧重于 PostgreSQL 的特性和性能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GORM](https://github.com/jinzhu/gorm)  | 14420 |  一个出色的 ORM 库。主要目标是对开发人员友好。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [gorp](https://github.com/go-gorp/gorp)  | 3069 |  基于 Go 的关系持久性 ORM-ish 库。 |![star > 1000][Silver]   
...
| [pop/soda](https://github.com/gobuffalo/pop)  | 669 |  数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2237 |  ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Xorm](https://github.com/go-xorm/xorm)  | 5105 |  基于 Go 的简单而强大的ORM。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12501 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]   
...
| [glide](https://github.com/Masterminds/glide)  | 7761 |  轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。 |![star > 5000][Gold]   
...
| [govendor](https://github.com/kardianos/govendor)  | 4704 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gojsonq](https://github.com/thedevsaddam/gojsonq)  | 850 |  一个用来查询JSON数据的Go包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [graphql](https://github.com/tmc/graphql)  | 51 |  graphql解析器+工具集 |![最近一年没有更新][Yellow]
| [graphql](https://github.com/neelance/graphql-go)  | 2736 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [graphql-go](https://github.com/graphql-go/graphql)  | 5134 |  为Go实现GraphQL。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go.rice](https://github.com/GeertJohan/go.rice)  | 1630 |  go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [packr](https://github.com/gobuffalo/packr)  | 2065 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   
| [statics](https://github.com/go-playground/statics)  | 53 |  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。 |![最近一年没有更新][Yellow]
| [statik](https://github.com/rakyll/statik)  | 2063 |  将静态文件嵌入到Go可执行文件中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [templify](https://github.com/wlbr/templify)  | 19 |  将外部模板文件嵌入到Go代码中，以创建单个文件二进制文件。 |
| [vfsgen](https://github.com/shurcooL/vfsgen)  | 646 |  生成一个vfsdata。静态实现给定虚拟文件系统的go文件。 |![star > 100][Bronze]   
...
| [gonum](https://github.com/gonum/gonum)  | 2896 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gosl](https://github.com/cpmech/gosl)  | 1298 |  提供线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程，等等。 |![star > 1000][Silver]   
...
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1805 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]   
...
| [lego](https://github.com/xenolf/lego)  | 3451 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [memguard](https://github.com/awnumar/memguard)  | 1026 |  一个用于处理内存中敏感值的纯Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [secure](https://github.com/unrolled/secure)  | 1192 |  Go 语言 HTTP 中间件，为 Go 提供了一些安全功能 |![star > 1000][Silver]   
| [simple-scrypt](https://github.com/elithrar/simple-scrypt)  | 155 |  Scrypt 库，具有简单、易懂的 API，同时具有内置的自动校准功能 |![star > 100][Bronze]   
...
| [go-codec](https://github.com/ugorji/go)  | 1223 |  高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2890 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 4994 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5399 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mapstructure](https://github.com/mitchellh/mapstructure)  | 2366 |  用于对原生键值对进行解码生成 Go 语言结构体 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algernon](https://github.com/xyproto/algernon)  | 1580 |  内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。 |![star > 1000][Silver]   
| [Caddy](https://github.com/mholt/caddy)  | 22923 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [consul](https://www.consul.io/)  | - |  Consul 是一个用于服务发现、监控和配置的工具 |
| [devd](https://github.com/cortesi/devd)  | 2794 |  为开发人员提供本地web服务器。 |![star > 1000][Silver]   
| [discovery](https://github.com/Bilibili/discovery)  | 661 |  用于弹性中间层负载平衡和故障转移的注册表。 |![star > 100][Bronze]   
| [etcd](https://github.com/coreos/etcd)  | 26126 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Fider](https://github.com/getfider/fider)  | 784 |  Fider是一个收集和组织客户反馈的开放平台。 |![star > 100][Bronze]   
| [Flagr](https://github.com/checkr/flagr)  | 809 |  Flagr是一个开源特性标记和A/B测试服务。 |![star > 100][Bronze]   
...
| [minio](https://github.com/minio/minio)  | 17063 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3204 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [fasttemplate](https://github.com/valyala/fasttemplate)  | 290 |  简单快速的模板引擎。进行模板元素替换时，速度是比[text/template](http://golang.org/pkg/text/template/)快10倍。 |![star > 100][Bronze]   
| [gofpdf](https://github.com/jung-kurt/gofpdf)  | 3043 |  PDF 文档生成器，支持文本，绘图和图片 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [quicktemplate](https://github.com/valyala/quicktemplate)  | 1385 |  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译 |![star > 1000][Silver]   
| [raymond](https://github.com/aymerick/raymond)  | 336 |  使用 Go 语言实现的完整的 handlebars |![star > 100][Bronze]   
| [Razor](https://github.com/sipin/gorazor)  | 693 |  Go 语言的 Razor 视图引擎 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [baloo](https://github.com/h2non/baloo)  | 642 |  表达性强、多功能的、端到端的HTTP API 测试工具 |![star > 100][Bronze]   
...
| [go-cmp](https://github.com/google/go-cmp)  | 1120 |  用于比较测试中的Go值的包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-mutesting](https://github.com/zimmski/go-mutesting)  | 287 |  变异测试的Go源代码。 |![star > 100][Bronze]   
...
| [Testify](https://github.com/stretchr/testify)  | 7975 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1687 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]   
| [go-txdb](https://github.com/DATA-DOG/go-txdb)  | 157 |  基于单事务的数据库驱动，主要用于测试目的 |![star > 100][Bronze]   
| [gock](https://github.com/h2non/gock)  | 798 |  多功能、易用 HTTP mock |![star > 100][Bronze]   
| [gomock](https://github.com/golang/mock)  | 2764 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [govcr](https://github.com/seborama/govcr)  | 81 |  HTTP mock : 离线测试时记录和重放浏览器的动作 |![最近一个周有更新][Green]
| [hoverfly](https://github.com/SpectoLabs/hoverfly)  | 1427 |  使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [httpmock](https://github.com/jarcoal/httpmock)  | 572 |  轻松模拟来自外部资源的HTTP响应。 |![star > 100][Bronze]   
| [minimock](https://github.com/gojuno/minimock)  | 233 |  Go接口的模拟生成器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-fuzz](https://github.com/dvyukov/go-fuzz)  | 2857 |  随机测试系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [chromedp](https://github.com/knq/chromedp)  | 3482 |  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [ggr](https://github.com/aerokube/ggr)  | 208 |  一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs |![star > 100][Bronze]   
| [selenoid](https://github.com/aerokube/selenoid)  | 1201 |  Selenium hub 服务器的替代品，在容器中启动浏览器 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3851 |  Markdown 解析器 |![star > 1000][Silver]   
...
| [colly](https://github.com/asciimoo/colly)  | 8213 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   
...
| [go-humanize](https://github.com/dustin/go-humanize)  | 1870 |  格式化程序，用于将时间、数字和内存大小转换为可读格式。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gofeed](https://github.com/mmcdole/gofeed)  | 1088 |  在Go中解析RSS和Atom feeds。 |![star > 1000][Silver]   
...
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7490 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]   
...
| [htmlquery](https://github.com/antchfx/htmlquery)  | 121 |  用于HTML的XPath查询包，允许您通过XPath表达式从HTML文档中提取数据或求值。 |![star > 100][Bronze]   
...
| [sh](https://github.com/mvdan/sh)  | 1941 |  Shell解析器和格式化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [toml](https://github.com/BurntSushi/toml)  | 2746 |  TOML配置格式(带反射的编码器/解码器)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
* Utility
...
| [xurls](https://github.com/mvdan/xurls)  | 457 |  从文本中提取url。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 4984 |  AWS 提供的官方go语言 SDK |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [discordgo](https://github.com/bwmarrin/discordgo)  | 955 |   Discord Chat API的客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [github](https://github.com/google/go-github)  | 4720 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [githubql](https://github.com/shurcooL/githubql)  | 495 |  访问GitHub GraphQL API v4的库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-jira](https://github.com/andygrunwald/go-jira)  | 563 |   Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库 |![star > 100][Bronze]   
...
| [go-twitter](https://github.com/dghubble/go-twitter)  | 701 |   Twitter v1.1 api 的客户端。。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang)  | 1757 |  谷歌云api Go 客户端库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [slack](https://github.com/nlopes/slack)  | 2384 |  Slack API。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Trello](https://github.com/adlio/trello)  | 101 |   Trello API的 Go 语言封装。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [apm](https://github.com/topfreegames/apm)  | 128 |  Go 语言进程管理工具具有HTTP API.。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [ctop](https://github.com/bcicen/ctop)  | 8743 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]   
...
| [Deepcopier](https://github.com/ulule/deepcopier)  | 208 |  结构体拷贝 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [delve](https://github.com/derekparker/delve)  | 11860 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [dlog](https://github.com/kirillDanshin/dlog)  | 15 |  编译时控制的日志，让你的 release 包变得更小而不需移除 debug 调用。 |![最近一年没有更新][Yellow]
| [ergo](https://github.com/cristianoliveira/ergo)  | 310 |  管理运行在不同端口上的多个本地服务变得很容易。 |![star > 100][Bronze]   
...
| [filetype](https://github.com/h2non/filetype)  | 934 |  通过数字签名来推测文件类型。 |![star > 100][Bronze]   
...
| [fzf](https://github.com/junegunn/fzf)  | 22810 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-funk](https://github.com/thoas/go-funk)  | 1141 |  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...) |![star > 1000][Silver]   
...
| [goreleaser](https://github.com/goreleaser/goreleaser)  | 4454 |  尽可能快速的发布 Go 语言二进制文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goreporter](https://github.com/wgliang/goreporter)  | 2476 |  进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具 |![star > 1000][Silver]   
...
| [hub](https://github.com/github/hub)  | 16804 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hystrix-go](https://github.com/afex/hystrix-go)  | 1978 |  实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。 |![star > 1000][Silver]   
...
| [koazee](https://github.com/wesovilabs/koazee)  | 290 |  库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。 |![star > 100][Bronze]   
| [lrserver](https://github.com/jaschaephraim/lrserver)  | 100 |  LiveReload 服务器。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [mc](https://github.com/minio/mc)  | 1092 |  Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mergo](https://github.com/imdario/mergo)  | 832 |  用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。 |![star > 100][Bronze]   
...
| [panicparse](https://github.com/maruel/panicparse)  | 2109 |  将类似的协程分组并对调用栈进行着色 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [peco](https://github.com/peco/peco)  | 5420 |  简单的交互过滤工具。 |![star > 5000][Gold]   
...
| [realize](https://github.com/tockins/realize)  | 3121 |  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。 |![star > 1000][Silver]   
...
| [resty](https://github.com/go-resty/resty)  | 1891 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [retry](https://github.com/kamilsk/retry)  | 145 |  基于上下文的功能机制，反复执行命令直到成功。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [spinner](https://github.com/briandowns/spinner)  | 775 |   一个 Go 语言软件包，提供多种选项，方便在终端中创建加载动画。 |![star > 100][Bronze]   
| [sqlx](https://github.com/jmoiron/sqlx)  | 6685 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [sslice](https://github.com/yaa110/sslice)  | 4 |  创建一个总是排序的切片。 |
| [Storm](https://github.com/asdine/storm)  | 1341 |  一个简单又强大的用于 BoltDB 的工具 |![star > 1000][Silver]   
| [structs](https://github.com/PumpkinSeed/structs)  | 12 |  简单来讲就是 "Make" 的替代品。 |![最近一年没有更新][Yellow]
| [Task](https://github.com/go-task/task)  | 1878 |  简单的“Go”的选择。 |![star > 1000][Silver]   
| [toolbox](https://github.com/viant/toolbox)  | 89 |  切片, map, multimap, 结构体, 函数,数据转换工具。服务路由，宏求值和标记器。 |![最近一个周有更新][Green]
...
| [ulid](https://github.com/oklog/ulid)  | 1659 |  实现了ULID(普遍唯一的词典分类标识符)。 |![star > 1000][Silver]   
...
| [uuid](https://github.com/gofrs/uuid)  | 562 |  通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation)  | 1022 |  支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [validator](https://github.com/go-playground/validator)  | 3417 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]   
...
| [git2go](https://github.com/libgit2/git2go)  | 1349 |   libgit2 的 Go 语言接口。 |![star > 1000][Silver]   
| [go-git](https://github.com/src-d/go-git)  | 4160 |  纯Go中高度可扩展的Git实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-vcs](https://github.com/sourcegraph/go-vcs)  | 69 |  在Go中操作和检查VCS存储库。 |![最近一个周有更新][Green]
| [hercules](https://github.com/src-d/hercules)  | 517 |  从Git存储库历史中获得高级见解。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gmf](https://github.com/3d0c/gmf)  | 523 |   FFmpeg av\* 库的 Go 语言接口。 |![star > 100][Bronze]   
...
| [Beego](https://github.com/astaxie/beego)  | 21246 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14509 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Gin](https://github.com/gin-gonic/gin)  | 29316 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2826 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Goa](https://github.com/goadesign/goa)  | 3483 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Macaron](https://github.com/go-macaron/macaron)  | 2793 |  Macaron 是一个高效的模块化设计的web框架 |![star > 1000][Silver]   
...
| [Revel](https://github.com/revel/revel)  | 11208 |  用于Go语言的高效web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [CORS](https://github.com/rs/cors)  | 1199 |  轻松地向API添加CORS功能。 |![star > 1000][Silver]   
...
| [Tollbooth](https://github.com/didip/tollbooth)  | 1235 |  限制速率的 HTTP 请求处理程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [alice](https://github.com/justinas/alice)  | 1815 |  用于连接中间件的库，简单无痛苦。 |![star > 1000][Silver]   
...
| [negroni](https://github.com/urfave/negroni)  | 6303 |  符合语言习惯的 HTTP 中间件库。 |![star > 5000][Gold]   
...
| [chi](https://github.com/go-chi/chi)  | 5949 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [fasthttprouter](https://github.com/buaazp/fasthttprouter)  | 743 |  高性能路由器分叉从`httprouter`。第一个路由器适合`fasthttp`。 |![star > 100][Bronze]   
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9582 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]   
...
| [mux](https://github.com/gorilla/mux)  | 9537 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-critic](https://github.com/go-critic/go-critic)  | 565 |  源代码检查工具。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [GoLint](https://github.com/golang/lint)  | 3127 |  Go 源码的 linter。 |![star > 1000][Silver]   
...
| [GoSublime](https://github.com/DisposaBoy/GoSublime)  | 3226 |  包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。 |![star > 1000][Silver]   
...
| [vim-go](https://github.com/fatih/vim-go)  | 10740 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5075 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gotests](https://github.com/cweill/gotests)  | 2154 |  从源代码生成测试用例。 |![star > 1000][Silver]   
...
| [go-callvis](https://github.com/TrueFurby/go-callvis)  | 1964 |  使用 dot format 可视化 Go 程序的调用图。 |![star > 1000][Silver]   
| [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete)  | 37 |  Bash completion for go and wgo。 |![最近一年没有更新][Yellow]
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3906 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [godbg](https://github.com/tylerwince/godbg)  | 157 |  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。 |![star > 100][Bronze]   
| [OctoLinker](https://github.com/OctoLinker/browser-extension)  | 3723 |  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [richgo](https://github.com/kyoh86/richgo)  | 384 |  用文本装饰丰富 go test 的输出。 |![star > 100][Bronze]   
...
| [bombardier](https://github.com/codesenberg/bombardier)  | 1704 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]   
...
| [fac](https://github.com/mkchoi212/fac)  | 1603 |  修复 git 合并冲突。 |![star > 1000][Silver]   
| [gaia](https://github.com/gaia-pipeline/gaia)  | 3728 |  可用于任何编程语言来构建强大的管道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Gitea](https://github.com/go-gitea/gitea)  | 14886 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [GVM](https://github.com/moovweb/gvm)  | 4448 |  GVM 提供了一个接口来管理 Go 版本。 |![star > 1000][Silver]   
| [Hey](https://github.com/rakyll/hey)  | 6183 |  压力测试工具，可用来代替 ApacheBench (ab)。 |![star > 5000][Gold]   
| [kala](https://github.com/ajvb/kala)  | 1352 |  简单、现代和高性能的作业调度程序。 |![star > 1000][Silver]   
| [kcli](https://github.com/cswank/kcli)  | 77 |  用于检查kafka主题/分区/消息的命令行工具。 |
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55537 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Moby](https://github.com/moby/moby)  | 54188 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Packer](https://github.com/mitchellh/packer)  | 9132 |  用于从一个源配置为多个平台创建相同的机器图像。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [script](https://github.com/bitfield/script)  | 894 |  让DevOps编写类shell和系统管理任务变得更加容易。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [StatusOK](https://github.com/sanathp/statusok)  | 1155 |  监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。 |![star > 1000][Silver]   
| [traefik](https://github.com/containous/traefik)  | 23436 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 12002 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [webhook](https://github.com/adnanh/webhook)  | 4044 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]   
...
| [confd](https://github.com/kelseyhightower/confd)  | 6366 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]   
| [DDNS](https://github.com/skibish/ddns)  | 97 |  个人 DDNS 客户端。 |
| [Docker](http://www.docker.com/)  | - |  面向开发人员和系统管理员的分布式应用程序的开放平台。 |
| [Documize](https://github.com/documize/community)  | 809 |  集成了SaaS工具数据的现代wiki软件。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [drive](https://github.com/odeke-em/drive)  | 4938 |  基于命令行的谷歌驱动器客户端。 |![star > 1000][Silver]   
| [Duplicacy](https://github.com/gilbertchen/duplicacy)  | 2672 |  跨平台网络和云备份工具。 |![star > 1000][Silver]   
...
| [go-peerflix](https://github.com/Sioro-Neoku/go-peerflix)  | 373 |  视频流 torrent 客户端。 |![star > 100][Bronze]   
...
| [LiteIDE](https://github.com/visualfc/liteide)  | 5437 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [nes](https://github.com/fogleman/nes)  | 4120 |  任天堂娱乐系统(NES)模拟器。 |![star > 1000][Silver]   
...
| [peg](https://github.com/pointlander/peg)  | 593 |  解析表达式语法，是Packrat解析器生成器的实现。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [Pipe](https://github.com/b3log/pipe)  | 2770 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [restic](https://github.com/restic/restic)  | 7340 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [rkt](https://github.com/coreos/rkt)  | 8728 |  一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [scc](https://github.com/boyter/scc)  | 764 |  一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。 |![star > 100][Bronze]   
...
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3880 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [tsuru](https://tsuru.io/)  | - |  Extensible and open source Platform as a Service software. |
| [vFlow](https://github.com/VerizonDigital/vflow)  | 593 |  高性能、可伸缩和可靠的 IPFIX、sFlow和 Netflow 收集器。 |![star > 100][Bronze]   
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark)  | 983 |  web框架基准测试。 |![star > 100][Bronze]   
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks)  | 854 |  Go序列化方法的基准测试。 |![star > 100][Bronze]   
