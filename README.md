...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-05 16:58:46(每隔1天同步一次)**
...
* [Oto](https://github.com/hajimehoshi/oto) - **star:387** 多平台的 low-level 声音播放库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [authboss](https://github.com/volatiletech/authboss) - **star:1895** web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [branca](https://github.com/hako/branca) - **star:67** 基于 Go 实现Branca令牌。
* [casbin](https://github.com/hsluoyz/casbin) - **star:4699** 支持ACL、RBAC、ABAC等访问控制模型的授权库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [cookiestxt](https://github.com/mengzhuo/cookiestxt) - **star:2** 提供cookie .txt文件格式的解析器。![最近一年没有更新][Yellow]
* [go-jose](https://github.com/square/go-jose) - **star:1090** 相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。![star > 1000][Silver]   
* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) - **star:1250** 用 Golang 编写的独立且符合规范的OAuth2服务器。![star > 1000][Silver]   
...
* [goth](https://github.com/markbates/goth) - **star:2217** 提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。![star > 1000][Silver]   
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) - **star:5722** JSON Web令牌(JWT)。![star > 5000][Gold]   
* [loginsrv](https://github.com/tarent/loginsrv) - **star:795** JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。![star > 100][Bronze]   
* [oauth2](https://github.com/golang/oauth2) - **star:2332** goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。![star > 1000][Silver]   
...
* [go-chat-bot](https://github.com/go-chat-bot/bot) - **star:456** 用 Go 编写的IRC, Slack和电报机器人。![star > 100][Bronze]   
* [go-sarah](https://github.com/oklahomer/go-sarah) - **star:130** 此框架提供了聊天机器人相关的服务，包括LINE、Slack、Gitter等。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [Kelp](https://github.com/stellar/kelp) - **star:148** 官方交易和做市机器人为[Stellar](https://www.stellar.org/) DEX。开箱即用的作品，用 Golang 编写，兼容集中交易和定制交易策略。![star > 100][Bronze]   
...
* [telebot](https://github.com/tucnak/telebot) - **star:927** 用Go编写的Telegram bot框架。![star > 100][Bronze]   
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - **star:1568** 简单轻量级的Telegram bot客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [cobra](https://github.com/spf13/cobra) - **star:12596** 现代Go CLI命令行交互工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [liner](https://github.com/peterh/liner) - **star:570** 类似readline-like的命令行接口库。![star > 100][Bronze]   
...
* [ops](https://github.com/nanovms/ops) - **star:222** Unikernel 构建器/协调器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [urfave/cli](https://github.com/urfave/cli) - **star:11076** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。![star > 5000][Gold]   
...
* [color](https://github.com/fatih/color) - **star:2978** 多功能包装，彩色终端输出。![star > 1000][Silver]   
...
* [go-colorable](https://github.com/mattn/go-colorable) - **star:371** 适用于windows的颜色编写器。![star > 100][Bronze]   
...
* [go-prompt](https://github.com/c-bata/go-prompt) - **star:2270** 构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit)![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gocui](https://github.com/jroimartin/gocui) - **star:4892** 旨在创建控制台用户界面的极简Go库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [termbox-go](https://github.com/nsf/termbox-go) - **star:3438** 基于文本的跨平台接口库。![star > 1000][Silver]   
* [termdash](https://github.com/mum4k/termdash) - **star:782** 此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。![star > 100][Bronze]   
...
* [termui](https://github.com/gizak/termui) - **star:8806** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [env](https://github.com/caarlos0/env) - **star:835** 解析环境变量并赋值到struct中(默认值)。![star > 100][Bronze]   
...
* [godotenv](https://github.com/joho/godotenv) - **star:2058** Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。![star > 1000][Silver]   
...
* [ini](https://github.com/go-ini/ini) - **star:1521**  读和写INI文件。![star > 1000][Silver]   
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) - **star:2351** 管理来自环境变量的配置数据。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [koanf](https://github.com/knadh/koanf) - **star:71** 轻量级可扩展库，用于读取Go应用程序中的配置。内置支持JSON, TOML, YAML, env，命令行。
...
* [viper](https://github.com/spf13/viper) - **star:9003** 配置管理。![star > 5000][Gold]   
...
* [drone](https://github.com/drone/drone) - **star:18713** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gods](https://github.com/emirpasic/gods) - **star:6048** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。![star > 5000][Gold]   
* [golang-set](https://github.com/deckarep/golang-set) - **star:1122** 线程安全和非线程安全的高性能集。![star > 1000][Silver]   
...
* [badger](https://github.com/dgraph-io/badger) - **star:6113** 快速 K/V 存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [bcache](https://github.com/iwanbk/bcache) - **star:26** 基于内存的最终一致的分布式缓存。
* [BigCache](https://github.com/allegro/bigcache) - **star:2393** 高效的键/值缓存为千兆字节的数据。![star > 1000][Silver]   
* [bolt](https://github.com/boltdb/bolt) - **star:9872** K/V 数据库。![star > 5000][Gold]   ![最近一年没有更新][Yellow]
* [buntdb](https://github.com/tidwall/buntdb) - **star:2420** 基于内存的K/V，快速，可嵌入的数据库，可自定义索引和空间支持。![star > 1000][Silver]   
* [cache](https://github.com/akyoto/cache) - **star:10** 基于内存的 K/V 存储:带生命周期的值存储，0个依赖项，<100 LoC, 100%覆盖率。
* [cache2go](https://github.com/muesli/cache2go) - **star:931** 基于内存的 K/V 缓存，支持超时的自动失效。![star > 100][Bronze]   
* [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache) - **star:29** BigCache 支持集群和独立且生命周期存储项。![最近一年没有更新][Yellow]
* [cockroach](https://github.com/cockroachdb/cockroach) - **star:16576** 可伸缩、区域备份、事务性数据存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dgraph](https://github.com/dgraph-io/dgraph) - **star:9933** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [diskv](https://github.com/peterbourgon/diskv) - **star:738** 支持磁盘备份的可持久化 K/V 存储。![star > 100][Bronze]   
...
* [GCache](https://github.com/bluele/gcache) - **star:864** 支持过期缓存、LFU、LRU和ARC的缓存库。![star > 100][Bronze]   
* [go-cache](https://github.com/pmylund/go-cache) - **star:2793** 基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。![star > 1000][Silver]   
...
* [groupcache](https://github.com/golang/groupcache) - **star:7556** Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [influxdb](https://github.com/influxdb/influxdb) - **star:16724** 可伸缩的数据存储，用于指标衡量、事件和实时分析。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [piladb](https://github.com/fern4lvarez/piladb) - **star:172** 基于堆栈数据结构的轻量级RESTful数据库引擎。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [prometheus](https://github.com/prometheus/prometheus) - **star:24947** 用于监控系统和时序的数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [pudge](https://github.com/recoilme/pudge) - **star:216** 使用Go的标准库编写的快速和简单的键/值存储。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [rqlite](https://github.com/rqlite/rqlite) - **star:4638** 基于SQLite的轻量级分布式关系数据库。![star > 1000][Silver]   
...
* [tidb](https://github.com/pingcap/tidb) - **star:19551** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - **star:885** 开源，快速，可伸缩的时间序列数据库。支持PromQL。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [migrate](https://github.com/golang-migrate/migrate) - **star:2437** 基于CLI的数据库迁移库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [orchestrator](https://github.com/github/orchestrator) - **star:2962** MySQL复制拓扑管理器和可视化工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [vitess](https://github.com/youtube/vitess) - **star:8288** vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Squirrel](https://github.com/Masterminds/squirrel) - **star:2196** 帮助您构建SQL查询的Go库。![star > 1000][Silver]   
...
* Relational Databases
    ...
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - **star:7883** MySQL驱动程序。![star > 5000][Gold]   
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - **star:3354** SQLite3驱动程序。![star > 1000][Silver]   
    ...
    * [pgx](https://github.com/jackc/pgx) - **star:1859** PostgreSQL驱动，支持比现有database/sql更多的特性。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [pq](https://github.com/lib/pq) - **star:5081** 纯 Go 的Postgres驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* NoSQL Databases
    ...
    * [mgo](https://github.com/globalsign/mgo) - **star:1607** (已停止维护) MongoDB驱动。![star > 1000][Silver]   
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - **star:2903** 官方的 MongoDB 驱动。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [redigo](https://github.com/gomodule/redigo) - **star:6139** Redigo 是基于 Go 的Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [redis](https://github.com/go-redis/redis) - **star:6199** 基于 Go 的 Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [xredis](https://github.com/shomali11/xredis) - **star:9** 类型安全，可定制，清晰和易用的Redis客户端。

* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) - **star:5748** 基于 Go 的现代文本索引库。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [elastic](https://github.com/olivere/elastic) - **star:4006** Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - **star:1471** 官方 Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* Multiple Backends.
    ...
    * [cayley](https://github.com/google/cayley) - **star:12606** 图形数据库，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [now](https://github.com/jinzhu/now) - **star:2135** now 是时间有关的工具类。![star > 1000][Silver]   
...
* [dragonboat](https://github.com/lni/dragonboat) - **star:2446** 一个功能齐全，高性能的库集。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [emitter-io](https://github.com/emitter-io/emitter) - **star:1875** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [flowgraph](https://github.com/vectaport/flowgraph) - **star:17** flow-based programming package。
* [gleam](https://github.com/chrislusf/gleam) - **star:2045** 使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-kit](https://github.com/go-kit/kit) - **star:14118** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。![star > 5000][Gold]   
* [gorpc](https://github.com/valyala/gorpc) - **star:547** 简单、快速和可伸缩的RPC库。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [grpc-go](https://github.com/grpc/grpc-go) - **star:8749** gRPC的Go语言实现。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hprose](https://github.com/hprose/hprose-golang) - **star:990** 支持25+种语言RPC库。![star > 100][Bronze]   
* [jaeger](https://github.com/jaegertracing/jaeger) - **star:8410** 分布式跟踪系统。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [KrakenD](https://github.com/devopsfaith/krakend) - **star:1644** 具有中间件的高性能API网关框架。![star > 1000][Silver]   
* [micro](https://github.com/micro/micro) - **star:6435** 可插拔的微服务 toolkit 和分布式系统平台。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) - **star:5928** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [raft](https://github.com/hashicorp/raft) - **star:2775** Raft consensus协议的实现。 by HashiCorp。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [rpcx](https://github.com/smallnest/rpcx) - **star:3681** 分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。![star > 1000][Silver]   
...
* [torrent](https://github.com/anacrolix/torrent) - **star:2771** BitTorrent 客户端。![star > 1000][Silver]   
...
* [hermes](https://github.com/matcornic/hermes) - **star:1595** 可生成干净的、响应式的HTML电子邮件。![star > 1000][Silver]   
* [MailHog](https://github.com/mailhog/MailHog) - **star:5040** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。![star > 5000][Gold]   
...
* [expr](https://github.com/antonmedv/expr) - **star:626** 一个可以计算表达式的引擎。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [gentee](https://github.com/gentee/gentee) - **star:25** 嵌入式脚本编程语言。![最近一个周有更新][Green]
* [gisp](https://github.com/jcla1/gisp) - **star:430** LISP 的 Go 接口。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [go-duktape](https://github.com/olebedev/go-duktape) - **star:648** 支持 Duktape JavaScript 引擎。![star > 100][Bronze]   
* [go-lua](https://github.com/Shopify/go-lua) - **star:1641** 用 Go 实现的 Lua 5.2 VM接口。![star > 1000][Silver]   
* [go-php](https://github.com/deuill/go-php) - **star:669** PHP 的 Go 接口。![star > 100][Bronze]   
* [go-python](https://github.com/sbinet/go-python) - **star:891** CPython C-API 的 Go 接口。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [golua](https://github.com/aarzilli/golua) - **star:434** Lua C 的 Go 接口。![star > 100][Bronze]   
* [gopher-lua](https://github.com/yuin/gopher-lua) - **star:2907** 用 Go 实现的 Lua 5.1 虚拟机和编译器。![star > 1000][Silver]   
...
* [otto](https://github.com/robertkrimen/otto) - **star:4655** 用 Go 编写的 JavaScript 解释器。![star > 1000][Silver]   
...
* [errors](https://github.com/pkg/errors) - **star:4709** 可让你很简单的进行错误处理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [afero](https://github.com/spf13/afero) - **star:2180** 文件系统的抽象系统。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [notify](https://github.com/rjeczalik/notify) - **star:485** 文件系统事件通知库，具有类似于os/signal的简单API，。![star > 100][Bronze]   
...
* [orderbook](https://github.com/i25959341/orderbook) - **star:64** 限购单匹配引擎。
...
* [g3n](https://github.com/g3n/engine) - **star:723**  3D游戏引擎。![star > 100][Bronze]   
...
* [Leaf](https://github.com/name5566/leaf) - **star:2997** 轻量级游戏服务器框架。![star > 1000][Silver]   
* [nano](https://github.com/lonng/nano) - **star:963** 轻量级、方便、高性能的基于golang的游戏服务器框架。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [Pixel](https://github.com/faiface/pixel) - **star:2374** 手工制作的 2D 游戏库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) - **star:1761** 提供类似 .NET LINQ 的查询方法。![star > 1000][Silver]   
...
* [jennifer](https://github.com/dave/jennifer) - **star:1250** 不使用模板生成任意 Go 代码。![star > 1000][Silver]   
...
* [S2 geometry](https://github.com/golang/geo) - **star:872** S2 geometry 库。![star > 100][Bronze]   
* [Tile38](https://github.com/tidwall/tile38) - **star:6270** 具有空间索引和实时地理定位功能的地理定位数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gopherjs](https://github.com/gopherjs/gopherjs) - **star:8429** 将 Go 编译成 JavaScript。![star > 5000][Gold]   
...
* [ants](https://github.com/panjf2000/ants) - **star:1760** 一个高性能的协程池。![star > 1000][Silver]   
...
* [tunny](https://github.com/Jeffail/tunny) - **star:1303** golang 的协程池。![star > 1000][Silver]   
...
* [fyne](https://github.com/fyne-io/fyne) - **star:6031** 为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [go-astilectron](https://github.com/asticode/go-astilectron) - **star:2594** 使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。![star > 1000][Silver]   
...
* [qt](https://github.com/therecipe/qt) - **star:5817** 实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。![star > 5000][Gold]   
* [ui](https://github.com/andlabs/ui) - **star:6832** 跨平台的 Platform-native GUI 库。![star > 5000][Gold]   
* [Wails](https://wails.app) - Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。
* [walk](https://github.com/lxn/walk) - **star:3633** Windows应用程序库。![star > 1000][Silver]   
* [webview](https://github.com/zserge/webview) - **star:4519** 跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [robotgo](https://github.com/go-vgo/robotgo) - **star:4360** 实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [systray](https://github.com/getlantern/systray) - **star:759** 跨平台 Go 库，可在通知区放置图标和菜单。![star > 100][Bronze]   
...
* [bimg](https://github.com/h2non/bimg) - **star:773** 使用libvips实现的快速高效的图像处理包。![star > 100][Bronze]   
...
* [go-opencv](https://github.com/lazywei/go-opencv) - **star:1082** OpenCV库的Go bindings。![star > 1000][Silver]   
* [go-webcolors](https://github.com/jyotiska/go-webcolors) - **star:24** Python下webcolors库的Go语言调用。![最近一年没有更新][Yellow]
* [gocv](https://github.com/hybridgroup/gocv) - **star:2367** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [imaging](https://github.com/disintegration/imaging) - **star:2472** 简单的Go图像处理包。![star > 1000][Silver]   
...
* [pt](https://github.com/fogleman/pt) - **star:1757** Go实现的路径跟踪（path tracing）引擎。![star > 1000][Silver]   
...
* [svgo](https://github.com/ajstarks/svgo) - **star:1309**  Go实现的SVG生成库。![star > 1000][Silver]   
...
* [mainflux](https://github.com/Mainflux/mainflux) - **star:559** 工业物联网消息和设备管理服务器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [GJSON](https://github.com/tidwall/gjson) - **star:4741** 使用一行代码获取JSON的值。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [glog](https://github.com/golang/glog) - **star:2271** 为Go提供了水平的执行日志。![star > 1000][Silver]   
...
* [logrus](https://github.com/Sirupsen/logrus) - **star:11474** 结构化的日志 Go 。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [lumberjack](https://github.com/natefinch/lumberjack) - **star:1384** 简单的滚动日志程序，实现io.WriteCloser。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [spew](https://github.com/davecgh/go-spew) - **star:3242** 为Go数据结构实现一个漂亮的深层打印机，以帮助调试。![star > 1000][Silver]   
...
* [zap](https://github.com/uber-go/zap) - **star:7202** 快速、结构化、水平登录Go。![star > 5000][Gold]   
...
* [GoLearn](https://github.com/sjwhitworth/golearn) - **star:6605** 通用机器学习库。![star > 5000][Gold]   
...
* [gorgonia](https://github.com/chewxy/gorgonia) - **star:2647** 基于图形的计算库，如Theano for Go，它为构建各种机器学习和神经网络算法提供了基本框架。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [tfgo](https://github.com/galeone/tfgo) - **star:1161** 易于使用的Tensorflow绑定:简化了官方Tensorflow Go绑定的使用。在Go中定义计算图形，加载和执行Python中训练的模型。![star > 1000][Silver]   
...
* [APNs2](https://github.com/sideshow/apns2) - **star:2026** HTTP / 2苹果推送通知供应商——发送推送通知到iOS, tvo, Safari和OSX的应用。![star > 1000][Silver]   
* [Beaver](https://github.com/Clivern/Beaver) - **star:714** 一个实时消息服务器，可构建一个可伸缩的应用程序内通知，多人游戏，聊天应用程序在web和移动应用程序。![star > 100][Bronze]   
* [Benthos](https://github.com/Jeffail/benthos) - **star:1910** 一系列协议之间的消息流桥。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Bus](https://github.com/mustafaturan/bus) - **star:111** 内部通信的最小消息总线实现。![star > 100][Bronze]   
* [Centrifugo](https://github.com/centrifugal/centrifugo) - **star:3616** 实时消息(Websockets或SockJS)服务器。![star > 1000][Silver]   
...
* [EventBus](https://github.com/asaskevich/EventBus) - **star:540** 具有异步兼容性的轻量级事件总线。![star > 100][Bronze]   
...
* [go-socket.io](https://github.com/googollee/go-socket.io) - **star:2831** 套接字。面向golang的io库，一个实时应用程序框架。![star > 1000][Silver]   
...
* [golongpoll](https://github.com/jcuga/golongpoll) - **star:420** HTTP longpoll服务器库，使web发布-订阅变得简单。![star > 100][Bronze]   
...
* [gorush](https://github.com/appleboy/gorush) - **star:3643** 使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [machinery](https://github.com/RichardKnop/machinery) - **star:3309** 基于分布式消息传递的异步任务队列/作业队列。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [mangos](https://github.com/go-mangos/mangos) - **star:1532** 具有传输互操作性的Nanomsg(“可伸缩协议”)的纯go实现。![star > 1000][Silver]   
* [melody](https://github.com/olahol/melody) - **star:1515** 处理websocket会话的极简框架，包括广播和自动乒乓球处理。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Mercure](https://github.com/dunglas/mercure) - **star:1433** 使用Mercure协议(构建在服务器发送事件之上)分派服务器发送的更新的服务器和库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [sarama](https://github.com/Shopify/sarama) - **star:4475**  Go Apache Kafka的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) - **star:4297** Golang库读写Microsoft Excel™(XLSX)文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [xlsx](https://github.com/tealeg/xlsx) - **star:3276** 库，以简化在Go程序中读取Microsoft Excel最新版本使用的XML格式。![star > 1000][Silver]   
...
* [dig](https://github.com/uber-go/dig) - **star:864** 一个基于反射的Go依赖注入工具包。![star > 100][Bronze]   
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - **star:8488** Go生态系统中常见的历史和新兴的项目布局模式。![star > 5000][Gold]   
...
* [archiver](https://github.com/mholt/archiver) - **star:2441** 用于生成和提取.zip和.tar.gz存档的库和命令。![star > 1000][Silver]   
...
* [gopsutil](https://github.com/shirou/gopsutil) - **star:3815** 用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [sandid](https://github.com/aofei/sandid) - **star:13** 地球上的每一粒沙子都有自己的身份。
...
* [prose](https://github.com/jdkato/prose) - **star:2021** 用于支持标记化、词性标记、名称实体提取等文本处理的库。![star > 1000][Silver]   
...
* [dns](https://github.com/miekg/dns) - **star:3720** 使用DNS的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [fasthttp](https://github.com/valyala/fasthttp) - **star:9035** 软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [fortio](https://github.com/fortio/fortio) - **star:839** 负载测试库和命令行工具，先进的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。Tcp、Http、gRPC。![star > 100][Bronze]   
...
* [go-getter](https://github.com/hashicorp/go-getter) - **star:695**  Go 图书馆下载文件或目录从各种来源使用一个URL。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [gopacket](https://github.com/google/gopacket) - **star:2788** 使用libpcap绑定访问包处理库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [HTTPLab](https://github.com/gchaincl/httplab) - **star:3383** HTTPLabs允许您检查HTTP请求并伪造响应。![star > 1000][Silver]   
...
* [kcp-go](https://github.com/xtaci/kcp-go) - **star:2204** 快速可靠的ARQ协议。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [kcptun](https://github.com/xtaci/kcptun) - **star:10529** 非常简单和快速udp隧道基于KCP协议。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [quic-go](https://github.com/lucas-clemente/quic-go) - **star:2812** 在纯Go中实现了QUIC协议。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [raw](https://github.com/mdlayher/raw) - **star:300** Package raw支持在设备驱动程序级别读取和写入网络接口的数据。![star > 100][Bronze]   
* [sftp](https://github.com/pkg/sftp) - **star:714** 包sftp实现了SSH文件传输协议，如https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt所述。![star > 100][Bronze]   
...
* [webrtc](https://github.com/pions/webrtc) - **star:2056** WebRTC API的纯Go实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [sling](https://github.com/dghubble/sling) - **star:846** Sling是一个用于创建和发送API请求的Go HTTP客户端库。![star > 100][Bronze]   
...
* [glfw](https://github.com/go-gl/glfw) - **star:712** Go绑定用于glfw3。![star > 100][Bronze]   
...
* [go-pg](https://github.com/go-pg/pg) - **star:2885** 关注PostgreSQL的特性和性能。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [GORM](https://github.com/jinzhu/gorm) - **star:14189** Golang出色的ORM库的目标是对开发人员友好。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [reform](https://github.com/go-reform/reform) - **star:788** 更好的ORM for Go，基于非空接口和代码生成。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) - **star:2209** ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [upper.io/db](https://github.com/upper/db) - **star:1816** 通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。![star > 1000][Silver]   
* [Xorm](https://github.com/go-xorm/xorm) - **star:5027** 简单而强大的ORM for Go。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dep](https://github.com/golang/dep) - **star:12396**  Go 的依赖管理工具，需要 Go 1.9+![star > 5000][Gold]   
...
* [govendor](https://github.com/kardianos/govendor) - **star:4666** 包管理器。使用 vendor 文件的 Go vendor 工具。![star > 1000][Silver]   
...
* [graphql](https://github.com/neelance/graphql-go) - **star:2708** 关注易用性的GraphQL服务器。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [graphql-go](https://github.com/graphql-go/graphql) - **star:5064** 为Go实现GraphQL。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [esc](https://github.com/mjibson/esc) - **star:459** 将文件嵌入到Go程序中并提供http文件系统接口。![star > 100][Bronze]   
...
* [go.rice](https://github.com/GeertJohan/go.rice) - **star:1619** go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。![star > 1000][Silver]   
* [packr](https://github.com/gobuffalo/packr) - **star:2022** 将静态文件嵌入到Go二进制文件中的简单方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [statics](https://github.com/go-playground/statics) - **star:53** 将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。![最近一年没有更新][Yellow]
* [statik](https://github.com/rakyll/statik) - **star:2030** 将静态文件嵌入到Go可执行文件中。![star > 1000][Silver]   
* [templify](https://github.com/wlbr/templify) - **star:19** 将外部模板文件嵌入到Go代码中，以创建单个文件二进制文件。
* [vfsgen](https://github.com/shurcooL/vfsgen) - **star:636** 生成一个vfsdata。静态实现给定虚拟文件系统的go文件。![star > 100][Bronze]   
...
* [gonum](https://github.com/gonum/gonum) - **star:2861** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gonum/plot](https://github.com/gonum/plot) - **star:1185** gonum/plot提供了一个API，用于在Go中构建和绘制绘图。![star > 1000][Silver]   
* [goraph](https://github.com/gyuho/goraph) - **star:597** 纯Go图论库(数据结构，算法可视化)。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [gosl](https://github.com/cpmech/gosl) - **star:1290** 提供线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程，等等。![star > 1000][Silver]   
...
* [lego](https://github.com/xenolf/lego) - **star:3426** 纯 Go ACME 客户端库及命令行工具![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gogoprotobuf](https://github.com/gogo/protobuf) - **star:2842** Go 语言的 Protocol Buffer 库。![star > 1000][Silver]   
* [goprotobuf](https://github.com/golang/protobuf) - **star:4876** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.![star > 1000][Silver]   ![最近一个周有更新][Green]
* [jsoniter](https://github.com/json-iterator/go) - **star:5283** 高性能，100% 兼容的“encoding/json” 替代品![star > 5000][Gold]   
* [mapstructure](https://github.com/mitchellh/mapstructure) - **star:2332** 用于对原生键值对进行解码生成 Go 语言结构体![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Caddy](https://github.com/mholt/caddy) - **star:22611** Caddy是另一种HTTP/2 web服务器，易于配置和使用。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [etcd](https://github.com/coreos/etcd) - **star:25814** 为共享配置和服务发现提供高可用的键值存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Fider](https://github.com/getfider/fider) - **star:775** Fider是一个收集和组织客户反馈的开放平台。![star > 100][Bronze]   
* [Flagr](https://github.com/checkr/flagr) - **star:782** Flagr是一个开源特性标记和A/B测试服务。![star > 100][Bronze]   
...
* [minio](https://github.com/minio/minio) - **star:16870** Minio是一个分布式对象存储服务器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [RoadRunner](https://github.com/spiral/roadrunner) - **star:3142** 高性能PHP应用服务器，负载平衡器和进程管理器。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gofpdf](https://github.com/jung-kurt/gofpdf) - **star:3013** PDF 文档生成器，支持文本，绘图和图片![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [pongo2](https://github.com/flosch/pongo2) - **star:1480** 类似 DjanGo 的模板引擎![star > 1000][Silver]   
...
* Testing Frameworks
    ...
    * [go-cmp](https://github.com/google/go-cmp) - **star:1092** 用于比较测试中的Go值的包。![star > 1000][Silver]   
    ...
    * [Testify](https://github.com/stretchr/testify) - **star:7819** 对标准测试包的扩展。![star > 5000][Gold]   
...
* Mock
    ...
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - **star:1633** Mock SQL ，用于测试数据库交互![star > 1000][Silver]   
    ...
    * [gomock](https://github.com/golang/mock) - **star:2682** 用于Go编程语言的mock框架。![star > 1000][Silver]   
    ...
    * [httpmock](https://github.com/jarcoal/httpmock) - **star:558** 轻松模拟来自外部资源的HTTP响应。![star > 100][Bronze]   
...
* Selenium and browser control tools.
    ...
    * [chromedp](https://github.com/knq/chromedp) - **star:3405** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* Specific Formats
    ...
    * [colly](https://github.com/asciimoo/colly) - **star:8087** 快速和优雅的 Scraping 框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
    ...
    * [go-humanize](https://github.com/dustin/go-humanize) - **star:1849** 格式化程序，用于将时间、数字和内存大小转换为可读格式。![star > 1000][Silver]   
    ...
    * [go-toml](https://github.com/pelletier/go-toml) - **star:595** 使用带有查询支持和方便的cli工具的TOML格式库。![star > 100][Bronze]   
    ...
    * [GoQuery](https://github.com/PuerkitoBio/goquery) - **star:7434** GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能![star > 5000][Gold]   
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - **star:4924** AWS 提供的官方go语言 SDK![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [github](https://github.com/google/go-github) - **star:4685** 访问GitHub REST API v3的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-jira](https://github.com/andygrunwald/go-jira) - **star:550**  Go [Atlassian JIRA]的客户端库(https://www.atlassian.com/software/jira)![star > 100][Bronze]   
...
* [google](https://github.com/google/google-api-go-client) - **star:1893** 为Go自动生成谷歌api。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [google-analytics](https://github.com/chonthu/go-google-analytics) - **star:12** 简单的包装，方便的谷歌分析报告。![最近一年没有更新][Yellow]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - **star:1734** 谷歌云api Go 客户端库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [slack](https://github.com/nlopes/slack) - **star:2351** Slack API。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [stripe](https://github.com/stripe/stripe-go) - **star:913**  Stripe API 的 Go 语言客户端![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [ynab](https://github.com/brunomvsouza/ynab.go) - **star:11**  YNAB API 的 Go 语言封装。
...
* [ctop](https://github.com/bcicen/ctop) - **star:8650** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [delve](https://github.com/derekparker/delve) - **star:11733** Go 语言调试器![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [fzf](https://github.com/junegunn/fzf) - **star:22443** 用Go编写的命令行模糊查找器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-funk](https://github.com/thoas/go-funk) - **star:1084** 现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)![star > 1000][Silver]   
...
* [goreleaser](https://github.com/goreleaser/goreleaser) - **star:4347** 尽可能快速的发布 Go 语言二进制文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gubrak](https://github.com/novalagung/gubrak) - **star:129** 带有语法糖的Golang实用工具，就像lodash。![star > 100][Bronze]   
...
* [hub](https://github.com/github/hub) - **star:16586** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hystrix-go](https://github.com/afex/hystrix-go) - **star:1948** 实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。![star > 1000][Silver]   
...
* [mergo](https://github.com/imdario/mergo) - **star:826** 用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。![star > 100][Bronze]   
...
* [mole](https://github.com/davrodpin/mole) - **star:1291** cli应用程序可以轻松创建ssh隧道。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [peco](https://github.com/peco/peco) - **star:5405** 简单的交互过滤工具。![star > 5000][Gold]   
...
* [resty](https://github.com/go-resty/resty) - **star:1817** 简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。![star > 1000][Silver]   
...
* [sqlx](https://github.com/jmoiron/sqlx) - **star:6583** 为内建的数据库/sql 软件包提供一组扩展。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Task](https://github.com/go-task/task) - **star:1861** 简单的“Go”的选择。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [usql](https://github.com/knq/usql) - **star:4652** usql 是一个通用的命令行接口，用于操作 sql 数据库。![star > 1000][Silver]   
* [util](https://github.com/shomali11/util) - **star:131** 有用实用函数的集合。(字符串，并发，操作，…)![star > 100][Bronze]   
* [wuzz](https://github.com/asciimoo/wuzz) - **star:8209** 用于HTTP检查的交互式cli工具。![star > 5000][Gold]   
...
* [validator](https://github.com/go-playground/validator) - **star:3322**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-git](https://github.com/src-d/go-git) - **star:4112** 纯Go中高度可扩展的Git实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-vcs](https://github.com/sourcegraph/go-vcs) - **star:69** 在Go中操作和检查VCS存储库。
* [hercules](https://github.com/src-d/hercules) - **star:505** 从Git存储库历史中获得高级见解。![star > 100][Bronze]   
...
* [goav](https://github.com/giorgisio/goav) - **star:752** FFmpeg的Comphrensive。![star > 100][Bronze]   
...
* [Air](https://github.com/aofei/air) - **star:513** 一个理想的精细化的Go web框架。![star > 100][Bronze]   
* [Banjo](https://github.com/nsheremet/banjo) - **star:7** 非常简单和快速的网络框架 Go 。![最近一年没有更新][Yellow]
* [Beego](https://github.com/astaxie/beego) - **star:21069** beego是一种用于 Go 编程语言的开源高性能web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Buffalo](http://gobuffalo.io) - 为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) - **star:14378** 高性能、极简的Go web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Gin](https://github.com/gin-gonic/gin) - **star:28795** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Gizmo](https://github.com/NYTimes/gizmo) - **star:2813** 《纽约时报》使用的微服务工具包。![star > 1000][Silver]   
...
* [Macaron](https://github.com/go-macaron/macaron) - **star:2785** Macaron 是一个高效的模块化设计的web框架![star > 1000][Silver]   
...
* [patron](https://github.com/beatlabs/patron) - **star:22** Patron是一个遵循最佳云实践的微服务框架，专注于提升开发效率。![最近一个周有更新][Green]
...
* [Revel](https://github.com/revel/revel) - **star:11180** 用于Go语言的高效web框架。![star > 5000][Gold]   
...
* [chi](https://github.com/go-chi/chi) - **star:5870** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。![star > 5000][Gold]   
...
* [httprouter](https://github.com/julienschmidt/httprouter) - **star:9505** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。![star > 5000][Gold]   
...
* [mux](https://github.com/gorilla/mux) - **star:9415** 强大的URL路由器和调度器为golang。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [GoLint](https://github.com/golang/lint) - **star:3106** Go 源码的 linter。![star > 1000][Silver]   
...
* [gocode](https://github.com/nsf/gocode) - **star:4714** Autocompletion daemon for the Go programming language.![star > 1000][Silver]   
...
* [vim-go](https://github.com/fatih/vim-go) - **star:10680** Go 开发会用到的 Vim 插件。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) - **star:5026** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [genny](https://github.com/cheekybits/genny) - **star:923** 优雅的 Go 泛型。![star > 100][Bronze]   
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **star:1927** 使用 dot format 可视化 Go 程序的调用图。![star > 1000][Silver]   
* [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) - **star:37** Bash completion for go and wgo。![最近一年没有更新][Yellow]
* [go-swagger](https://github.com/go-swagger/go-swagger) - **star:3839** 基于 Go 的Swagger 2.0实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [godbg](https://github.com/tylerwince/godbg) - **star:157** 实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。![star > 100][Bronze]   
* [OctoLinker](https://github.com/OctoLinker/browser-extension) - **star:3689** 借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [bombardier](https://github.com/codesenberg/bombardier) - **star:1680** 快速跨平台 HTTP 基准测试工具。![star > 1000][Silver]   
...
* [fac](https://github.com/mkchoi212/fac) - **star:1595** 修复 git 合并冲突。![star > 1000][Silver]   
* [gaia](https://github.com/gaia-pipeline/gaia) - **star:3697** 可用于任何编程语言来构建强大的管道。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Gitea](https://github.com/go-gitea/gitea) - **star:14649** 从 Gogs fork，完全由社区驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [govvv](https://github.com/ahmetalpbalkan/govvv) - **star:374** 可轻松地添加版本信息到 Go 二进制文件。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [gox](https://github.com/mitchellh/gox) - **star:3325** 非常简单，没有多余的跨平台编译工具。![star > 1000][Silver]   
...
* [Hey](https://github.com/rakyll/hey) - **star:6070** 压力测试工具，可用来代替 ApacheBench (ab)。![star > 5000][Gold]   
...
* [kubernetes](https://github.com/kubernetes/kubernetes) - **star:54913** 来自谷歌的容器集群管理器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Moby](https://github.com/moby/moby) - **star:53997** Collaborative project for the container ecosystem to assemble container-based systems.![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Packer](https://github.com/mitchellh/packer) - **star:9071** 用于从一个源配置为多个平台创建相同的机器图像。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Pewpew](https://github.com/bengadbois/pewpew) - **star:199** 灵活的 HTTP 命令行压测工具。![star > 100][Bronze]   
* [Pomerium](https://github.com/pomerium/pomerium) - **star:465** Pomerium是一个可识别身份的访问代理。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [script](https://github.com/bitfield/script) - **star:679** 让DevOps编写类shell和系统管理任务变得更加容易。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [StatusOK](https://github.com/sanathp/statusok) - **star:1145** 监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。![star > 1000][Silver]   
* [traefik](https://github.com/containous/traefik) - **star:23193** 反向代理和负载均衡器，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Vegeta](https://github.com/tsenart/vegeta) - **star:11898** HTTP负载测试工具和库。超过9000 !![star > 5000][Gold]   ![最近一个周有更新][Green]
* [webhook](https://github.com/adnanh/webhook) - **star:3990** 允许用户创建在服务器上执行命令的 HTTP hooks。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Comcast](https://github.com/tylertreat/Comcast) - **star:6129** 模拟坏的网络连接。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [confd](https://github.com/kelseyhightower/confd) - **star:6326** 使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。![star > 5000][Gold]   
* [DDNS](https://github.com/skibish/ddns) - **star:97** 个人 DDNS 客户端。
* [Docker](http://www.docker.com/) - 面向开发人员和系统管理员的分布式应用程序的开放平台。
* [Documize](https://github.com/documize/community) - **star:797** 集成了SaaS工具数据的现代wiki软件。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [drive](https://github.com/odeke-em/drive) - **star:4921** 基于命令行的谷歌驱动器客户端。![star > 1000][Silver]   
* [Duplicacy](https://github.com/gilbertchen/duplicacy) - **star:2662** 跨平台网络和云备份工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gfile](https://github.com/Antonito/gfile) - **star:487** 通过WebRTC在两台计算机之间安全地传输文件，不需要任何第三方依赖。![star > 100][Bronze]   
...
* [Gor](https://github.com/buger/gor) - **star:11207** Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [LiteIDE](https://github.com/visualfc/liteide) - **star:5418** 简单的、开源的、跨平台的Go IDE。![star > 5000][Gold]   
...
* [myLG](https://github.com/mehrdadrad/mylg) - **star:2185** 命令行网络诊断工具。![star > 1000][Silver]   
...
* [Pipe](https://github.com/b3log/pipe) - **star:2606** 一个小巧漂亮的博客平台。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [restic](https://github.com/restic/restic) - **star:7227** 消除重复项备份程序。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [rkt](https://github.com/coreos/rkt) - **star:8702** 一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [scc](https://github.com/boyter/scc) - **star:761** 一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - **star:8050** 快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [shell2http](https://github.com/msoap/shell2http) - **star:395** 通过http服务器执行shell命令(用于原型或远程控制)。![star > 100][Bronze]   
...
* [toxiproxy](https://github.com/shopify/toxiproxy) - **star:3779** 为自动化测试模拟网络和系统条件的代理。![star > 1000][Silver]   
...
* [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) - **star:842** Go序列化方法的基准测试。![star > 100][Bronze]   
...
* [GoBooks](https://github.com/dariubs/GoBooks) - **star:6688** 一份精选的 Go 书籍清单。![star > 5000][Gold]   
...
* [gophers](https://github.com/egonelbre/gophers) - **star:1551** Free gophers.![star > 1000][Silver]   
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - **star:14384** Curated list of awesome remote jobs. A lot of them are looking for Go hackers.![star > 5000][Gold]   ![最近一个周有更新][Green]
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - **star:24494** 其他 awesome 系列的列表。![star > 5000][Gold]   
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - **star:30974** Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。![star > 5000][Gold]   
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) - **star:669** 引入示例讲述 Golang 与Node.js在学习上的差异。![star > 100][Bronze]   
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - **star:3918** 学习使用测试驱动开发。![star > 1000][Silver]   ![最近一个周有更新][Green]
