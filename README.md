...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-08 09:48:11(每隔1天同步一次)**
...
* [flac](https://github.com/mewkiz/flac) - **star:99** 原生 Go FLAC编码器/解码器，支持FLAC流。
...
* [mix](https://github.com/go-mix/mix) - **star:97** 基于序列的 Go 原生音乐混音器。![最近一年没有更新][Yellow]
* [mp3](https://github.com/tcolgate/mp3) - **star:89** 原生 Go MP3解码器。![最近一年没有更新][Yellow]
* [music-theory](https://github.com/go-music-theory/music-theory) - **star:252** 基于 Go 的音乐理论模型。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [Oto](https://github.com/hajimehoshi/oto) - **star:415** 多平台的 low-level 声音播放库。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [PortAudio](https://github.com/gordonklaus/portaudio) - **star:294** 基于 Go 的PortAudio audio I/O库。![star > 100][Bronze]   
...
* [authboss](https://github.com/volatiletech/authboss) - **star:1899** web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。![star > 1000][Silver]   
* [branca](https://github.com/hako/branca) - **star:68** 基于 Go 实现Branca令牌。
* [casbin](https://github.com/hsluoyz/casbin) - **star:4717** 支持ACL、RBAC、ABAC等访问控制模型的授权库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [cookiestxt](https://github.com/mengzhuo/cookiestxt) - **star:2** 提供cookie .txt文件格式的解析器。![最近一年没有更新][Yellow]
* [go-jose](https://github.com/square/go-jose) - **star:1091** 相当完整地实现了JOSE工作组的JSON Web令牌、JSON Web签名和JSON Web加密规范。![star > 1000][Silver]   
...
* [gorbac](https://github.com/mikespook/gorbac) - **star:895** 轻量级的基于角色的访问控制(RBAC)实现。![star > 100][Bronze]   
* [goth](https://github.com/markbates/goth) - **star:2221** 提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。![star > 1000][Silver]   
...
* [jwt](https://github.com/pascaldekloe/jwt) - **star:77** 轻量级JSON Web令牌库。![最近一个周有更新][Green]
* [jwt-auth](https://github.com/adam-hanna/jwt-auth) - **star:151** JWT中间件，可用于Golang http服务器，提供了许多配置选项。![star > 100][Bronze]   
* [jwt-go](https://github.com/dgrijalva/jwt-go) - **star:5756** JSON Web令牌(JWT)。![star > 5000][Gold]   
...
* [go-sarah](https://github.com/oklahomer/go-sarah) - **star:133** 此框架提供了聊天机器人相关的服务，包括LINE、Slack、Gitter等。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) - **star:208** 基于控制台的，用于加密货币交易所的的交易机器人。![star > 100][Bronze]   
...
* [Kelp](https://github.com/stellar/kelp) - **star:149** 官方交易和做市机器人为[Stellar](https://www.stellar.org/) DEX。开箱即用的作品，用 Golang 编写，兼容集中交易和定制交易策略。![star > 100][Bronze]   
...
* [slacker](https://github.com/shomali11/slacker) - **star:300** 可简单创建Slack机器人的框架。![star > 100][Bronze]   
...
* [telebot](https://github.com/tucnak/telebot) - **star:931** 用Go编写的Telegram bot框架。![star > 100][Bronze]   
* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - **star:1571** 简单轻量级的Telegram bot客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [argparse](https://github.com/akamensky/argparse) - **star:100** 命令行参数分析器，灵感来自Python的argparse模块。![star > 100][Bronze]   
...
* [cobra](https://github.com/spf13/cobra) - **star:12627** 现代Go CLI命令行交互工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [flaggy](https://github.com/integrii/flaggy) - **star:443** 一个健壮的、易用的标志包，具有出色的子命令支持。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [kingpin](https://github.com/alecthomas/kingpin) - **star:2498** 支持子命令的命令行和标志解析器。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [liner](https://github.com/peterh/liner) - **star:571** 类似readline-like的命令行接口库。![star > 100][Bronze]   
...
* [pflag](https://github.com/spf13/pflag) - **star:731** 基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。![star > 100][Bronze]   
...
* [urfave/cli](https://github.com/urfave/cli) - **star:11091** 可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。![star > 5000][Gold]   
...
* [asciigraph](https://github.com/guptarohit/asciigraph) - **star:1122** 在命令行中构建轻量级ASCII线图╭┈╯，应用程序中没有其他依赖项。![star > 1000][Silver]   
...
* [go-colorable](https://github.com/mattn/go-colorable) - **star:372** 适用于windows的颜色编写器。![star > 100][Bronze]   
* [go-colortext](https://github.com/daviddengcn/go-colortext) - **star:198** 在终端中使用彩色文字。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [go-isatty](https://github.com/mattn/go-isatty) - **star:338** Go 实现的 isatty。![star > 100][Bronze]   
* [go-prompt](https://github.com/c-bata/go-prompt) - **star:2272** 构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit)![star > 1000][Silver]   
* [gocui](https://github.com/jroimartin/gocui) - **star:4978** 旨在创建控制台用户界面的极简Go库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) - 更换终端文本样式。
* [gookit/color](https://github.com/gookit/color) - **star:185** 终端显色工具库，支持16种颜色，256种颜色，RGB显色输出，兼容Windows。![star > 100][Bronze]   
* [mpb](https://github.com/vbauerster/mpb) - **star:499** 可在终端显示多进度条。![star > 100][Bronze]   
* [progressbar](https://github.com/schollz/progressbar) - **star:550** 基本线程安全的进度条，在每个操作系统工作。![star > 100][Bronze]   
...
* [termbox-go](https://github.com/nsf/termbox-go) - **star:3443** 基于文本的跨平台接口库。![star > 1000][Silver]   
...
* [termui](https://github.com/gizak/termui) - **star:8813** 此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。![star > 5000][Gold]   
...
* [uitable](https://github.com/gosuri/uitable) - **star:495** 改善终端应用程序中表格数据的可读性。![star > 100][Bronze]   

## 配置

*配置解析的库。*

* [config](https://github.com/JeremyLoy/config) - **star:186** 云本地应用程序配置。将ENV绑定到结构体仅需两行代码。![star > 100][Bronze]   
...
* [env](https://github.com/caarlos0/env) - **star:835** 解析环境变量并赋值到struct中(默认值)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [godotenv](https://github.com/joho/godotenv) - **star:2059** Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。![star > 1000][Silver]   
...
* [harvester](https://github.com/beatlabs/harvester) - **star:28** 一个易于使用的静态和动态配置包
...
* [ini](https://github.com/go-ini/ini) - **star:1527**  读和写INI文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) - **star:2357** 管理来自环境变量的配置数据。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [viper](https://github.com/spf13/viper) - **star:9020** 配置管理。![star > 5000][Gold]   
...
* [drone](https://github.com/drone/drone) - **star:18724** Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [boomfilters](https://github.com/tylertreat/BoomFilters) - **star:1123** 用于处理连续的概率数据结构。![star > 1000][Silver]   
...
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) - **star:498** 布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。![star > 100][Bronze]   
...
* [go-datastructures](https://github.com/Workiva/go-datastructures) - **star:5061** 可靠的、高性能的和线程安全的数据结构的集合。![star > 5000][Gold]   
...
* [gods](https://github.com/emirpasic/gods) - **star:6065** 数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。![star > 5000][Gold]   
* [golang-set](https://github.com/deckarep/golang-set) - **star:1124** 线程安全和非线程安全的高性能集。![star > 1000][Silver]   
...
* [hyperloglog](https://github.com/axiomhq/hyperloglog) - **star:658** HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction.![star > 100][Bronze]   
...
* [badger](https://github.com/dgraph-io/badger) - **star:6127** 快速 K/V 存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [bolt](https://github.com/boltdb/bolt) - **star:9880** K/V 数据库。![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
* [cache2go](https://github.com/muesli/cache2go) - **star:952** 基于内存的 K/V 缓存，支持超时的自动失效。![star > 100][Bronze]   
* [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache) - **star:29** BigCache 支持集群和独立且生命周期存储项。![最近一年没有更新][Yellow]
* [cockroach](https://github.com/cockroachdb/cockroach) - **star:16582** 可伸缩、区域备份、事务性数据存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dgraph](https://github.com/dgraph-io/dgraph) - **star:9942** 可伸缩、分布式、低延迟、高吞吐量的图形数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [GCache](https://github.com/bluele/gcache) - **star:865** 支持过期缓存、LFU、LRU和ARC的缓存库。![star > 100][Bronze]   
* [go-cache](https://github.com/pmylund/go-cache) - **star:2801** 基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。![star > 1000][Silver]   
* [goleveldb](https://github.com/syndtr/goleveldb) - **star:3104** 在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [influxdb](https://github.com/influxdb/influxdb) - **star:16738** 可伸缩的数据存储，用于指标衡量、事件和实时分析。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [ledisdb](https://github.com/siddontang/ledisdb) - **star:3043** Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。![star > 1000][Silver]   
...
* [nutsdb](https://github.com/xujiajun/nutsdb) - **star:847** Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。![star > 100][Bronze]   
* [piladb](https://github.com/fern4lvarez/piladb) - **star:171** 基于堆栈数据结构的轻量级RESTful数据库引擎。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [prometheus](https://github.com/prometheus/prometheus) - **star:24970** 用于监控系统和时序的数据库。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [pudge](https://github.com/recoilme/pudge) - **star:217** 使用Go的标准库编写的快速和简单的键/值存储。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [rqlite](https://github.com/rqlite/rqlite) - **star:4642** 基于SQLite的轻量级分布式关系数据库。![star > 1000][Silver]   
...
* [tidb](https://github.com/pingcap/tidb) - **star:19575** TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - **star:888** 开源，快速，可伸缩的时间序列数据库。支持PromQL。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [goose](https://github.com/steinbacher/goose) - **star:116** 数据库迁移工具。您可以通过创建增量SQL或Go脚本来管理数据库的升级。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
* [migrate](https://github.com/golang-migrate/migrate) - **star:2446** 基于CLI的数据库迁移库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [migrator](https://github.com/lopezator/migrator) - **star:27** 非常简单的 Go 数据库迁移库。
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) - **star:1377** 数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。![star > 1000][Silver]   

*数据库工具。*

* [chproxy](https://github.com/Vertamedia/chproxy) - **star:294** ClickHouse数据库的HTTP代理。![star > 100][Bronze]   
...
* [go-mysql](https://github.com/siddontang/go-mysql) - **star:1807**  Go 工具集，用于处理MySQL协议和复制。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) - **star:2288** 自动将MySQL数据同步到Elasticsearch中。![star > 1000][Silver]   
* [kingshard](https://github.com/flike/kingshard) - **star:4532** kingshard 是基于 Golang 的MySQL高性能代理。![star > 1000][Silver]   
...
* [orchestrator](https://github.com/github/orchestrator) - **star:2965** MySQL复制拓扑管理器和可视化工具。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [pgweb](https://github.com/sosedoff/pgweb) - **star:5941** 基于web的PostgreSQL数据库浏览器。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [prep](https://github.com/hexdigest/prep) - **star:24** 在不更改代码的情况下使用准备好的SQL语句。![最近一年没有更新][Yellow]
* [pREST](https://github.com/nuveo/prest) - **star:2060** 基于PostgreSQL database的RESTful API服务。![star > 1000][Silver]   
* [rwdb](https://github.com/andizzle/rwdb) - **star:10** rwdb为多个数据库服务器的设置提供读取副本功能。![最近一年没有更新][Yellow]
* [vitess](https://github.com/youtube/vitess) - **star:8290** vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [gendry](https://github.com/didi/gendry) - **star:702** 非入侵的SQL构建器和强大的数据绑定器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [Squirrel](https://github.com/Masterminds/squirrel) - **star:2197** 帮助您构建SQL查询的Go库。![star > 1000][Silver]   
* [xo](https://github.com/knq/xo) - **star:2119** 基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* Relational Databases
    ...
    * [go-mssqldb](https://github.com/denisenkom/go-mssqldb) - **star:999** 微软MSSQL驱动程序。![star > 100][Bronze]   ![最近一个周有更新][Green]
    * [go-oci8](https://github.com/mattn/go-oci8) - **star:398** Oracle 驱动程序。![star > 100][Bronze]   
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - **star:7894** MySQL驱动程序。![star > 5000][Gold]   
    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - **star:3358** SQLite3驱动程序。![star > 1000][Silver]   
    ...
    * [pgx](https://github.com/jackc/pgx) - **star:1864** PostgreSQL驱动，支持比现有database/sql更多的特性。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [pq](https://github.com/lib/pq) - **star:5086** 纯 Go 的Postgres驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* NoSQL Databases
    ...
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - **star:2920** 官方的 MongoDB 驱动。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [redigo](https://github.com/gomodule/redigo) - **star:6145** Redigo 是基于 Go 的Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [redis](https://github.com/go-redis/redis) - **star:6213** 基于 Go 的 Redis 客户端。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* Search and Analytic Databases.
    ...
    * [elastic](https://github.com/olivere/elastic) - **star:4010** Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [elasticsql](https://github.com/cch123/elasticsql) - **star:372** 将 SQL 转换为 elasticsearch dsl。![star > 100][Bronze]   
    * [elastigo](https://github.com/mattbaird/elastigo) - **star:948** Elasticsearch 客户端。![star > 100][Bronze]   
    * [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - **star:1484** 官方 Elasticsearch 客户端。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [carbon](https://github.com/uniplaces/carbon) - **star:332** 简单的时间扩展，包含了许多使用方法，从 PHP Carbon 库移植的。![star > 100][Bronze]   
...
* [now](https://github.com/jinzhu/now) - **star:2139** now 是时间有关的工具类。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [emitter-io](https://github.com/emitter-io/emitter) - **star:1878** 高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。![star > 1000][Silver]   
* [flowgraph](https://github.com/vectaport/flowgraph) - **star:18** flow-based programming package。
* [gleam](https://github.com/chrislusf/gleam) - **star:2048** 使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。![star > 1000][Silver]   
* [glow](https://github.com/chrislusf/glow) - **star:2497** 全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。![star > 1000][Silver]   
...
* [go-kit](https://github.com/go-kit/kit) - **star:14126** 支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。![star > 5000][Gold]   
* [gorpc](https://github.com/valyala/gorpc) - **star:548** 简单、快速和可伸缩的RPC库。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [grpc-go](https://github.com/grpc/grpc-go) - **star:8763** gRPC的Go语言实现。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [hprose](https://github.com/hprose/hprose-golang) - **star:990** 支持25+种语言RPC库。![star > 100][Bronze]   
* [jaeger](https://github.com/jaegertracing/jaeger) - **star:8421** 分布式跟踪系统。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [KrakenD](https://github.com/devopsfaith/krakend) - **star:1654** 具有中间件的高性能API网关框架。![star > 1000][Silver]   
* [micro](https://github.com/micro/micro) - **star:6444** 可插拔的微服务 toolkit 和分布式系统平台。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [NATS](https://github.com/nats-io/gnatsd) - **star:5931** 轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [raft](https://github.com/hashicorp/raft) - **star:2777** Raft consensus协议的实现。 by HashiCorp。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [rpcx](https://github.com/smallnest/rpcx) - **star:3686** 分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。![star > 1000][Silver]   
...
* [tendermint](https://github.com/tendermint/tendermint) - **star:3065** 一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [torrent](https://github.com/anacrolix/torrent) - **star:2777** BitTorrent 客户端。![star > 1000][Silver]   
...
* [go-imap](https://github.com/emersion/go-imap) - **star:709** 用于客户端和服务器的IMAP库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [hermes](https://github.com/matcornic/hermes) - **star:1596** 可生成干净的、响应式的HTML电子邮件。![star > 1000][Silver]   
* [MailHog](https://github.com/mailhog/MailHog) - **star:5048** 电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。![star > 5000][Gold]   
...
* [anko](https://github.com/mattn/anko) - **star:904** 用Go编写的解释器。![star > 100][Bronze]   
* [binder](https://github.com/alexeyco/binder) - **star:29** Lua接口，基于[gopher-lua](https://github.com/yuin/gopher-lua)。
* [expr](https://github.com/antonmedv/expr) - **star:640** 一个可以计算表达式的引擎。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-python](https://github.com/sbinet/go-python) - **star:892** CPython C-API 的 Go 接口。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [golua](https://github.com/aarzilli/golua) - **star:434** Lua C 的 Go 接口。![star > 100][Bronze]   
* [gopher-lua](https://github.com/yuin/gopher-lua) - **star:2908** 用 Go 实现的 Lua 5.1 虚拟机和编译器。![star > 1000][Silver]   
...
* [otto](https://github.com/robertkrimen/otto) - **star:4656** 用 Go 编写的 JavaScript 解释器。![star > 1000][Silver]   
...
* [errors](https://github.com/pkg/errors) - **star:4727** 可让你很简单的进行错误处理。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [errorx](https://github.com/joomcode/errorx) - **star:547** 一个功能丰富的错误包，可进行堆栈跟踪、组装异常信息以及其他。![star > 100][Bronze]   
* [go-multierror](https://github.com/hashicorp/go-multierror) - **star:705** 可将一系列的错误作为一个整体来显示。![star > 100][Bronze]   
...
* [pdfcpu](https://github.com/hhrutter/pdfcpu) - **star:927** PDF处理器。![star > 100][Bronze]   
...
* [decimal](https://github.com/shopspring/decimal) - **star:1551** 任意精度定点的十进制数。![star > 1000][Silver]   
...
* [gorilla/csrf](https://github.com/gorilla/csrf) - **star:425** 用于Go web应用程序和服务的CSRF保护。![star > 100][Bronze]   
* [nosurf](https://github.com/justinas/nosurf) - **star:958** CSRF保护中间件。![star > 100][Bronze]   
...
* [Azul3D](https://github.com/azul3d/engine) - **star:423** 用Go编写的 3D 游戏引擎。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [Ebiten](https://github.com/hajimehoshi/ebiten) - **star:1788** 很简单的 2D 游戏库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [engo](https://github.com/EngoEngine/engo) - **star:1073** 开源 2D 游戏引擎。它遵循 Entity-Component-System 范式。![star > 1000][Silver]   
* [g3n](https://github.com/g3n/engine) - **star:725**  3D游戏引擎。![star > 100][Bronze]   
...
* [go-sdl2](https://github.com/veandco/go-sdl2) - **star:1135** 实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。![star > 1000][Silver]   
...
* [Leaf](https://github.com/name5566/leaf) - **star:3002** 轻量级游戏服务器框架。![star > 1000][Silver]   
* [nano](https://github.com/lonng/nano) - **star:965** 轻量级、方便、高性能的基于golang的游戏服务器框架。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Oak](https://github.com/oakmound/oak) - **star:621** 纯 Go 实现的游戏引擎。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) - **star:1763** 提供类似 .NET LINQ 的查询方法。![star > 1000][Silver]   
...
* [Tile38](https://github.com/tidwall/tile38) - **star:6271** 具有空间索引和实时地理定位功能的地理定位数据库。![star > 5000][Gold]   
...
* [gopherjs](https://github.com/gopherjs/gopherjs) - **star:8442** 将 Go 编译成 JavaScript。![star > 5000][Gold]   
...
* [ants](https://github.com/panjf2000/ants) - **star:1766** 一个高性能的协程池。![star > 1000][Silver]   
...
* [goworker](https://github.com/benmanns/goworker) - **star:2221** 基于 go 的后台 worker。![star > 1000][Silver]   
...
* [grpool](https://github.com/ivpusic/grpool) - **star:492** 轻量级协程池。![star > 100][Bronze]   
...
* [tunny](https://github.com/Jeffail/tunny) - **star:1304** golang 的协程池。![star > 1000][Silver]   
* [worker-pool](https://github.com/vardius/worker-pool) - **star:43** 一个简单的 Go 异步工作池。
* [workerpool](https://github.com/gammazero/workerpool) - **star:123** 限制任务执行并发数，而不是队列中的任务数量的协程池，。![star > 100][Bronze]   
...
* [app](https://github.com/murlokswarm/app) - **star:2919** 用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。![star > 1000][Silver]   
* [fyne](https://github.com/fyne-io/fyne) - **star:6041** 为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [go-astilectron](https://github.com/asticode/go-astilectron) - **star:2600** 使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。![star > 1000][Silver]   
* [go-gtk](http://mattn.github.io/go-gtk/) - 实现了 GTK 的 Go接口。
* [go-sciter](https://github.com/sciter-sdk/go-sciter) - **star:1418** 实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gotk3](https://github.com/gotk3/gotk3) - **star:736** 实现了 GTK3 的 Go接口。![star > 100][Bronze]   
* [gowd](https://github.com/dtylman/gowd) - **star:204** 跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。![star > 100][Bronze]   
* [qt](https://github.com/therecipe/qt) - **star:5833** 实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。![star > 5000][Gold]   
...
* [walk](https://github.com/lxn/walk) - **star:3638** Windows应用程序库。![star > 1000][Silver]   
* [webview](https://github.com/zserge/webview) - **star:4527** 跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [robotgo](https://github.com/go-vgo/robotgo) - **star:4361** 实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [bild](https://github.com/anthonynsimon/bild) - **star:2021** 纯Go语言实现的图像处理算法合集。![star > 1000][Silver]   
* [bimg](https://github.com/h2non/bimg) - **star:774** 使用libvips实现的快速高效的图像处理包。![star > 100][Bronze]   
...
* [gg](https://github.com/fogleman/gg) - **star:1882** 纯Go语言实现的2D渲染。![star > 1000][Silver]   
...
* [gocv](https://github.com/hybridgroup/gocv) - **star:2373** 使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [imagick](https://github.com/gographics/imagick) - **star:952**  ImageMagick下MagickWand的C API的Go binding。![star > 100][Bronze]   
* [imaginary](https://github.com/h2non/imaginary) - **star:2547** 用于图像大小调整的快速、简单的HTTP微服务。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [imaging](https://github.com/disintegration/imaging) - **star:2475** 简单的Go图像处理包。![star > 1000][Silver]   
* [img](https://github.com/hawx/img) - **star:128** 图像处理工具的集合。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [ln](https://github.com/fogleman/ln) - **star:2441** Go实现的3D线艺术（3D Line Art）渲染。![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
* [pt](https://github.com/fogleman/pt) - **star:1759** Go实现的路径跟踪（path tracing）引擎。![star > 1000][Silver]   
...
* [flogo](https://github.com/tibcosoftware/flogo) - **star:1091** Flogo是一个面向物联网边缘应用和集成的开源框架。![star > 1000][Silver]   
...
* [mainflux](https://github.com/Mainflux/mainflux) - **star:560** 工业物联网消息和设备管理服务器。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [GJSON](https://github.com/tidwall/gjson) - **star:4743** 使用一行代码获取JSON的值。![star > 1000][Silver]   
...
* [glg](https://github.com/kpango/glg) - **star:50** glg是一个简单而快速的Go日志库。
...
* [logrus](https://github.com/Sirupsen/logrus) - **star:11543** Go的结构化日志操作 。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [lumberjack](https://github.com/natefinch/lumberjack) - **star:1387** 简单的滚动日志，io.WriteCloser的实现。![star > 1000][Silver]   
* [mlog](https://github.com/jbrodriguez/mlog) - **star:17** 简单的go日志模块，有5个级别，可选循环(rotation)日志文件记录功能和stdout/stderr输出。
* [onelog](https://github.com/francoispqt/onelog) - **star:326** Onelog是一个非常简单但非常高效的JSON日志程序。它是所有场景中速度最快的JSON日志程序。而且，它是配置要求最低的日志记录器之一。![star > 100][Bronze]   
...
* [seelog](https://github.com/cihub/seelog) - **star:1336** 具有灵活调度、过滤和格式化的日志功能。![star > 1000][Silver]   
...
* [xlog](https://github.com/rs/xlog) - **star:130** 针对'net/context`实现的结构化的记录器，用于HTTP处理程序。![star > 100][Bronze]   
* [zap](https://github.com/uber-go/zap) - **star:7217** 快速、结构化、多等级的日志记录。![star > 5000][Gold]   
* [zerolog](https://github.com/rs/zerolog) - **star:2098** Zero-allocation JSON日志记录。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [eaopt](https://github.com/MaxHalford/eaopt) - **star:615** 一个进化优化（evolutionary optimization）库。![star > 100][Bronze]   
...
* [go-deep](https://github.com/patrikeh/go-deep) - **star:213** 一个功能丰富的神经网络库 。![star > 100][Bronze]   
...
* [gobrain](https://github.com/goml/gobrain) - **star:370** 用 Go 编写的神经网络库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [GoLearn](https://github.com/sjwhitworth/golearn) - **star:6610** 通用机器学习库。![star > 5000][Gold]   
...
* [gorgonia](https://github.com/chewxy/gorgonia) - **star:2650** 基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gorse](https://github.com/zhenghaoz/gorse) - **star:510** 基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。![star > 100][Bronze]   
* [goscore](https://github.com/asafschers/goscore) - **star:34**  为预言模型标记语言（PMML）实现的评分API。
* [gosseract](https://github.com/otiai10/gosseract) - **star:848** 使用c++的Tesseract库实现的OCR。![star > 100][Bronze]   
...
* [onnx-go](https://github.com/owulveryck/onnx-go) - **star:141** Go Interface， 用于开放式神经网络交换(Open Neural Network Exchange)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [tfgo](https://github.com/galeone/tfgo) - **star:1164** 易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。![star > 1000][Silver]   
...
* [APNs2](https://github.com/sideshow/apns2) - **star:2028** HTTP / 2苹果推送通知供应商——发送推送通知到iOS, tvo, Safari和OSX的应用。![star > 1000][Silver]   
...
* [Centrifugo](https://github.com/centrifugal/centrifugo) - **star:3617** 实时消息(Websockets或SockJS)服务器。![star > 1000][Silver]   
...
* [EventBus](https://github.com/asaskevich/EventBus) - **star:543** 具有异步兼容性的轻量级事件总线。![star > 100][Bronze]   
...
* [go-socket.io](https://github.com/googollee/go-socket.io) - **star:2833** 套接字。面向golang的io库，一个实时应用程序框架。![star > 1000][Silver]   
...
* [machinery](https://github.com/RichardKnop/machinery) - **star:3315** 基于分布式消息传递的异步任务队列/作业队列。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [mangos](https://github.com/go-mangos/mangos) - **star:1533** 具有传输互操作性的Nanomsg(“可伸缩协议”)的纯go实现。![star > 1000][Silver]   
* [melody](https://github.com/olahol/melody) - **star:1518** 处理websocket会话的极简框架，包括广播和自动乒乓球处理。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Mercure](https://github.com/dunglas/mercure) - **star:1440** 使用Mercure协议(构建在服务器发送事件之上)分派服务器发送的更新的服务器和库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [messagebus](https://github.com/vardius/message-bus) - **star:62** messagebus是一种Go简单异步消息总线，非常适合在执行事件源、CQRS和DDD时用作事件总线。
* [NATS Go Client](https://github.com/nats-io/nats) - **star:2346** 轻量级和高性能的发布-订阅和分布式队列消息传递系统——这是Go库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [sarama](https://github.com/Shopify/sarama) - **star:4489**  Go Apache Kafka的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Uniqush-Push](https://github.com/uniqush/uniqush-push) - **star:1094** Redis支持面向移动设备的服务器端通知的统一推送服务。![star > 1000][Silver]   
...
* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) - **star:4309** Golang库读写Microsoft Excel™(XLSX)文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [xlsx](https://github.com/tealeg/xlsx) - **star:3283** 库，以简化在Go程序中读取Microsoft Excel最新版本使用的XML格式。![star > 1000][Silver]   
...
* [dig](https://github.com/uber-go/dig) - **star:866** 一个基于反射的Go依赖注入工具包。![star > 100][Bronze]   
* [fx](https://github.com/uber-go/fx) - **star:640** 基于依赖注入的Go应用程序框架(构建在dig之上)。![star > 100][Bronze]   
* [gocontainer](https://github.com/vardius/gocontainer) - **star:5** 简单的依赖注入容器。
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - **star:8515** Go生态系统中常见的历史和新兴的项目布局模式。![star > 5000][Gold]   
...
* [archiver](https://github.com/mholt/archiver) - **star:2445** 用于生成和提取.zip和.tar.gz存档的库和命令。![star > 1000][Silver]   
...
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) - **star:655** Golang的通用对象池。![star > 100][Bronze]   
...
* [gopsutil](https://github.com/shirou/gopsutil) - **star:3823** 用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gojieba](https://github.com/yanyiwu/gojieba) - **star:792** 这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。![star > 100][Bronze]   
...
* [prose](https://github.com/jdkato/prose) - **star:2022** 用于支持标记化、词性标记、名称实体提取等文本处理的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [dns](https://github.com/miekg/dns) - **star:3724** 使用DNS的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [fasthttp](https://github.com/valyala/fasthttp) - **star:9052** 软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [fortio](https://github.com/fortio/fortio) - **star:840** 负载测试库和命令行工具，先进的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。Tcp、Http、gRPC。![star > 100][Bronze]   
* [ftp](https://github.com/jlaffaye/ftp) - **star:505** 包ftp实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户机。![star > 100][Bronze]   
* [gmqtt](https://github.com/DrmagicE/gmqtt) - **star:65** Gmqtt是一个灵活、高性能的MQTT代理库，它完全实现了MQTT协议V3.1.1。![最近一个周有更新][Green]
* [gNxI](https://github.com/google/gnxi) - **star:100** 一组使用gNMI和gNOI协议的网络管理工具。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [go-getter](https://github.com/hashicorp/go-getter) - **star:699**  Go 图书馆下载文件或目录从各种来源使用一个URL。![star > 100][Bronze]   
...
* [gopacket](https://github.com/google/gopacket) - **star:2790** 使用libpcap绑定访问包处理库。![star > 1000][Silver]   
...
* [gosnmp](https://github.com/soniah/gosnmp) - **star:427** 用于执行SNMP操作的本机Go库。![star > 100][Bronze]   
...
* [HTTPLab](https://github.com/gchaincl/httplab) - **star:3385** HTTPLabs允许您检查HTTP请求并伪造响应。![star > 1000][Silver]   
...
* [kcptun](https://github.com/xtaci/kcptun) - **star:10535** 非常简单和快速udp隧道基于KCP协议。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [quic-go](https://github.com/lucas-clemente/quic-go) - **star:2814** 在纯Go中实现了QUIC协议。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [tcp_server](https://github.com/firstrow/tcp_server) - **star:277**  Go 图书馆建设tcp服务器更快。![star > 100][Bronze]   
...
* [webrtc](https://github.com/pions/webrtc) - **star:2071** WebRTC API的纯Go实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gentleman](https://github.com/h2non/gentleman) - **star:671** 功能齐全的插件驱动HTTP客户端库。![star > 100][Bronze]   
* [goreq](https://github.com/smallnest/goreq) - **star:98** 基于gorequest的增强简化HTTP客户机。
* [grequests](https://github.com/levigross/grequests) - **star:1393** 一个 Go “克隆”的伟大和著名的请求库。![star > 1000][Silver]   
...
* [sling](https://github.com/dghubble/sling) - **star:847** Sling是一个用于创建和发送API请求的Go HTTP客户端库。![star > 100][Bronze]   
...
* [glfw](https://github.com/go-gl/glfw) - **star:714** Go绑定用于glfw3。![star > 100][Bronze]   
...
* [go-pg](https://github.com/go-pg/pg) - **star:2890** 关注PostgreSQL的特性和性能。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) - **star:221** 一个灵活而强大的SQL字符串构建器库加上一个零配置ORM。![star > 100][Bronze]   
* [go-store](https://github.com/gosuri/go-store) - **star:92** 简单而快速的Redis支持的键值存储库。![最近一年没有更新][Yellow]
* [GORM](https://github.com/jinzhu/gorm) - **star:14213** Golang出色的ORM库的目标是对开发人员友好。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [gorp](https://github.com/go-gorp/gorp) - **star:3062** Go的关系持久性，ORM-ish库。![star > 1000][Silver]   
* [grimoire](https://github.com/Fs02/grimoire) - **star:111** Grimoire是golang的数据库访问层和验证。(支持:MySQL, PostgreSQL和SQLite3)。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [lore](https://github.com/abrahambotros/lore) - **star:4** 用于Go的简单轻量级伪orm /伪结构映射环境。![最近一年没有更新][Yellow]
* [Marlow](https://github.com/dadleyy/marlow) - **star:61** 从项目结构生成ORM，用于编译时安全保证。
* [pop/soda](https://github.com/gobuffalo/pop) - **star:656** 数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [QBS](https://github.com/coocood/qbs) - **star:537** 表示结构查询。一个ORM。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [reform](https://github.com/go-reform/reform) - **star:790** 更好的ORM for Go，基于非空接口和代码生成。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) - **star:2212** ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [upper.io/db](https://github.com/upper/db) - **star:1818** 通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Xorm](https://github.com/go-xorm/xorm) - **star:5039** 简单而强大的ORM for Go。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [dep](https://github.com/golang/dep) - **star:12404**  Go 的依赖管理工具，需要 Go 1.9+![star > 5000][Gold]   
...
* [gopm](https://github.com/gpmgo/gopm) - **star:2334** 包管理器。![star > 1000][Silver]   
* [govendor](https://github.com/kardianos/govendor) - **star:4669** 包管理器。使用 vendor 文件的 Go vendor 工具。![star > 1000][Silver]   
...
* [gojsonq](https://github.com/thedevsaddam/gojsonq) - **star:836** 一个用来查询JSON数据的Go包。![star > 100][Bronze]   
* [graphql](https://github.com/tmc/graphql) - **star:51** graphql解析器+工具集![最近一年没有更新][Yellow]
* [graphql](https://github.com/neelance/graphql-go) - **star:2715** 关注易用性的GraphQL服务器。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [graphql-go](https://github.com/graphql-go/graphql) - **star:5072** 为Go实现GraphQL。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [packr](https://github.com/gobuffalo/packr) - **star:2028** 将静态文件嵌入到Go二进制文件中的简单方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [statics](https://github.com/go-playground/statics) - **star:53** 将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。![最近一年没有更新][Yellow]
* [statik](https://github.com/rakyll/statik) - **star:2033** 将静态文件嵌入到Go可执行文件中。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [templify](https://github.com/wlbr/templify) - **star:19** 将外部模板文件嵌入到Go代码中，以创建单个文件二进制文件。
* [vfsgen](https://github.com/shurcooL/vfsgen) - **star:638** 生成一个vfsdata。静态实现给定虚拟文件系统的go文件。![star > 100][Bronze]   
...
* [chart](https://github.com/vdobler/chart) - **star:574** 简单的图表绘制库。支持多种图形类型。![star > 100][Bronze]   
...
* [gonum](https://github.com/gonum/gonum) - **star:2867** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gonum/plot](https://github.com/gonum/plot) - **star:1187** gonum/plot提供了一个API，用于在Go中构建和绘制绘图。![star > 1000][Silver]   
...
* [Cameradar](https://github.com/Ullaakut/cameradar) - **star:1785** 工具和库，以远程入侵RTSP流从监控摄像头。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [go-codec](https://github.com/ugorji/go) - **star:1208** 高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成![star > 1000][Silver]   ![最近一个周有更新][Green]
* [gogoprotobuf](https://github.com/gogo/protobuf) - **star:2847** Go 语言的 Protocol Buffer 库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [goprotobuf](https://github.com/golang/protobuf) - **star:4884** 通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.![star > 1000][Silver]   ![最近一个周有更新][Green]
* [jsoniter](https://github.com/json-iterator/go) - **star:5298** 高性能，100% 兼容的“encoding/json” 替代品![star > 5000][Gold]   
* [mapstructure](https://github.com/mitchellh/mapstructure) - **star:2336** 用于对原生键值对进行解码生成 Go 语言结构体![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Caddy](https://github.com/mholt/caddy) - **star:22683** Caddy是另一种HTTP/2 web服务器，易于配置和使用。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [consul](https://www.consul.io/) - Consul 是一个用于服务发现、监控和配置的工具
* [devd](https://github.com/cortesi/devd) - **star:2784** 为开发人员提供本地web服务器。![star > 1000][Silver]   
* [discovery](https://github.com/Bilibili/discovery) - **star:629** 用于弹性中间层负载平衡和故障转移的注册表。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [etcd](https://github.com/coreos/etcd) - **star:25840** 为共享配置和服务发现提供高可用的键值存储。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Fider](https://github.com/getfider/fider) - **star:775** Fider是一个收集和组织客户反馈的开放平台。![star > 100][Bronze]   
* [Flagr](https://github.com/checkr/flagr) - **star:788** Flagr是一个开源特性标记和A/B测试服务。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [flipt](https://github.com/markphelps/flipt) - **star:977** 一个用Go和Vue.js编写的自包含特性标志解决方案![star > 100][Bronze]   ![最近一个周有更新][Green]
* [jackal](https://github.com/ortuman/jackal) - **star:708** 用Go编写的XMPP服务器。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [minio](https://github.com/minio/minio) - **star:16890** Minio是一个分布式对象存储服务器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [RoadRunner](https://github.com/spiral/roadrunner) - **star:3146** 高性能PHP应用服务器，负载平衡器和进程管理器。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [gofpdf](https://github.com/jung-kurt/gofpdf) - **star:3016** PDF 文档生成器，支持文本，绘图和图片![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [pongo2](https://github.com/flosch/pongo2) - **star:1479** 类似 DjanGo 的模板引擎![star > 1000][Silver]   ![最近一个周有更新][Green]
* [quicktemplate](https://github.com/valyala/quicktemplate) - **star:1364** 快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译![star > 1000][Silver]   ![最近一个周有更新][Green]
* [raymond](https://github.com/aymerick/raymond) - **star:336** 使用 Go 语言实现的完整的 handlebars![star > 100][Bronze]   
* [Razor](https://github.com/sipin/gorazor) - **star:675** Go 语言的 Razor 视图引擎![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* Testing Frameworks
    ...
    * [go-cmp](https://github.com/google/go-cmp) - **star:1095** 用于比较测试中的Go值的包。![star > 1000][Silver]   
    * [go-mutesting](https://github.com/zimmski/go-mutesting) - **star:245** 变异测试的Go源代码。![star > 100][Bronze]   
    * [go-testdeep](https://github.com/maxatome/go-testdeep) - **star:49** 极具灵活性的golang深度比较，扩展了go测试包。![最近一个周有更新][Green]
    ...
    * [godog](https://github.com/DATA-DOG/godog) - **star:725** 类似 Cucumber 或 Behat 的 BDD 框架![star > 100][Bronze]   
    ...
    * [httpexpect](https://github.com/gavv/httpexpect) - **star:1105** 简洁的、声明式的、易用的端到端HTTP 及 REST API 测试![star > 1000][Silver]   
    ...
    * [Testify](https://github.com/stretchr/testify) - **star:7842** 对标准测试包的扩展。![star > 5000][Gold]   
...
* Mock
    ...
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - **star:1637** Mock SQL ，用于测试数据库交互![star > 1000][Silver]   
    * [go-txdb](https://github.com/DATA-DOG/go-txdb) - **star:154** 基于单事务的数据库驱动，主要用于测试目的![star > 100][Bronze]   ![最近一个周有更新][Green]
    * [gock](https://github.com/h2non/gock) - **star:787** 多功能、易用 HTTP mock![star > 100][Bronze]   ![最近一个周有更新][Green]
    * [gomock](https://github.com/golang/mock) - **star:2681** 用于Go编程语言的mock框架。![star > 1000][Silver]   
    * [govcr](https://github.com/seborama/govcr) - **star:78** HTTP mock : 离线测试时记录和重放浏览器的动作
    * [hoverfly](https://github.com/SpectoLabs/hoverfly) - **star:1415** 使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [httpmock](https://github.com/jarcoal/httpmock) - **star:559** 轻松模拟来自外部资源的HTTP响应。![star > 100][Bronze]   
...
* Fuzzing and delta-debugging/reducing/shrinking.
    ...
    * [gofuzz](https://github.com/google/gofuzz) - **star:519** 用于生成随机值来初始化 Go 语言对象的库![star > 100][Bronze]   
...
* Selenium and browser control tools.
    ...
    * [chromedp](https://github.com/knq/chromedp) - **star:3411** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品![star > 1000][Silver]   ![最近一个周有更新][Green]
    * [ggr](https://github.com/aerokube/ggr) - **star:208** 一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs![star > 100][Bronze]   
    * [selenoid](https://github.com/aerokube/selenoid) - **star:1180** Selenium hub 服务器的替代品，在容器中启动浏览器![star > 1000][Silver]   ![最近一个周有更新][Green]

* Fail injection
    * [failpoint](https://github.com/pingcap/failpoint) - **star:368** 为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* Specific Formats
    ...
    * [blackfriday](https://github.com/russross/blackfriday) - **star:3808** Markdown 解析器![star > 1000][Silver]   
    * [bluemonday](https://github.com/microcosm-cc/bluemonday) - **star:1214** HTML 清理工具![star > 1000][Silver]   
    * [codetree](https://github.com/aerogo/codetree) - **star:6** 解析缩进代码(python、pixy、scarlet等)并返回树结构。
    * [colly](https://github.com/asciimoo/colly) - **star:8095** 快速和优雅的 Scraping 框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
    * [commonregex](https://github.com/mingrammer/commonregex) - **star:547** 一组用于Go的公共正则表达式。![star > 100][Bronze]   
    * [dataflowkit](https://github.com/slotix/dataflowkit) - **star:282** Web抓取框架将网站转换为结构化数据。![star > 100][Bronze]   
    ...
    * [go-fixedwidth](https://github.com/ianlopshire/go-fixedwidth) - **star:22** 固定宽度的文本格式(带反射的编码器/解码器)。
    ...
    * [go-toml](https://github.com/pelletier/go-toml) - **star:596** 使用带有查询支持和方便的cli工具的TOML格式库。![star > 100][Bronze]   ![最近一个周有更新][Green]
    ...
    * [gofeed](https://github.com/mmcdole/gofeed) - **star:1081** 在Go中解析RSS和Atom feeds。![star > 1000][Silver]   ![最近一个周有更新][Green]
    ...
    * [sh](https://github.com/mvdan/sh) - **star:1923** Shell解析器和格式化工具。![star > 1000][Silver]   
    ...
    * [toml](https://github.com/BurntSushi/toml) - **star:2715** TOML配置格式(带反射的编码器/解码器)。![star > 1000][Silver]   
* Utility
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - **star:4930** AWS 提供的官方go语言 SDK![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [github](https://github.com/google/go-github) - **star:4689** 访问GitHub REST API v3的库。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [githubql](https://github.com/shurcooL/githubql) - **star:487** 访问GitHub GraphQL API v4的库。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [go-jira](https://github.com/andygrunwald/go-jira) - **star:550**  Go [Atlassian JIRA]的客户端库(https://www.atlassian.com/software/jira)![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [google](https://github.com/google/google-api-go-client) - **star:1895** 为Go自动生成谷歌api。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [google-analytics](https://github.com/chonthu/go-google-analytics) - **star:12** 简单的包装，方便的谷歌分析报告。![最近一年没有更新][Yellow]
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - **star:1735** 谷歌云api Go 客户端库。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [slack](https://github.com/nlopes/slack) - **star:2356** Slack API。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [ctop](https://github.com/bcicen/ctop) - **star:8657** [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。![star > 5000][Gold]   
...
* [delve](https://github.com/derekparker/delve) - **star:11744** Go 语言调试器![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [fzf](https://github.com/junegunn/fzf) - **star:22525** 用Go编写的命令行模糊查找器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [go-funk](https://github.com/thoas/go-funk) - **star:1097** 现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)![star > 1000][Silver]   
...
* [goreleaser](https://github.com/goreleaser/goreleaser) - **star:4377** 尽可能快速的发布 Go 语言二进制文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [goreporter](https://github.com/wgliang/goreporter) - **star:2457** 进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具![star > 1000][Silver]   
...
* [gubrak](https://github.com/novalagung/gubrak) - **star:131** 带有语法糖的Golang实用工具，就像lodash。![star > 100][Bronze]   
...
* [hub](https://github.com/github/hub) - **star:16665** 封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [koazee](https://github.com/wesovilabs/koazee) - **star:279** 库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。![star > 100][Bronze]   
* [lrserver](https://github.com/jaschaephraim/lrserver) - **star:100** LiveReload 服务器。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [mc](https://github.com/minio/mc) - **star:1073** Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [mergo](https://github.com/imdario/mergo) - **star:826** 用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [mimetype](https://github.com/gabriel-vasile/mimetype) - **star:100** 用于基于神奇数字的MIME类型检测的包。![star > 100][Bronze]   
* [minify](https://github.com/tdewolff/minify) - **star:1837** 用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。![star > 1000][Silver]   
...
* [mole](https://github.com/davrodpin/mole) - **star:1293** cli应用程序可以轻松创建ssh隧道。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [panicparse](https://github.com/maruel/panicparse) - **star:2078** 将类似的协程分组并对调用栈进行着色![star > 1000][Silver]   
* [peco](https://github.com/peco/peco) - **star:5411** 简单的交互过滤工具。![star > 5000][Gold]   
...
* [realize](https://github.com/tockins/realize) - **star:3092** Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。![star > 1000][Silver]   
...
* [resty](https://github.com/go-resty/resty) - **star:1819** 简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。![star > 1000][Silver]   
...
* [sqlx](https://github.com/jmoiron/sqlx) - **star:6590** 为内建的数据库/sql 软件包提供一组扩展。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Task](https://github.com/go-task/task) - **star:1863** 简单的“Go”的选择。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [wuzz](https://github.com/asciimoo/wuzz) - **star:8218** 用于HTTP检查的交互式cli工具。![star > 5000][Gold]   
...
* [sno](https://github.com/muyo/sno) - **star:13** 使用嵌入元数据的紧凑、可排序和快速的惟一id。
...
* [govalidator](https://github.com/asaskevich/govalidator) - **star:3494** 用于字符串，数字，切片和结构的验证器和sanitizers。![star > 1000][Silver]   
* [govalidator](https://github.com/thedevsaddam/govalidator) - **star:696** 用简单的规则验证Golang请求数据。深受Laravel请求验证的启发。![star > 100][Bronze]   
* [jio](https://github.com/faceair/jio) - **star:21** jio是一个json模式验证器，类似于[joi](https://github.com/hapijs/joi)。
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - **star:1011** 支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。![star > 1000][Silver]   
...
* [git2go](https://github.com/libgit2/git2go) - **star:1342**  libgit2 的 Go 语言接口。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [go-git](https://github.com/src-d/go-git) - **star:4118** 纯Go中高度可扩展的Git实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [goav](https://github.com/giorgisio/goav) - **star:756** FFmpeg的Comphrensive。![star > 100][Bronze]   
...
* [Beego](https://github.com/astaxie/beego) - **star:21085** beego是一种用于 Go 编程语言的开源高性能web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Buffalo](http://gobuffalo.io) - 为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) - **star:14390** 高性能、极简的Go web框架。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Gin](https://github.com/gin-gonic/gin) - **star:28853** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Gizmo](https://github.com/NYTimes/gizmo) - **star:2815** 《纽约时报》使用的微服务工具包。![star > 1000][Silver]   
...
* [Goa](https://github.com/goadesign/goa) - **star:3462** Goa为在Go中开发远程api和微服务提供了一种全面的方法。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [hiboot](https://github.com/hidevopsio/hiboot) - **star:82** hiboot是一个高性能的web应用程序框架，支持自动配置和依赖注入。
...
* [patron](https://github.com/beatlabs/patron) - **star:27** Patron是一个遵循最佳云实践的微服务框架，专注于提升开发效率。![最近一个周有更新][Green]
...
* [Revel](https://github.com/revel/revel) - **star:11184** 用于Go语言的高效web框架。![star > 5000][Gold]   
...
* [tango](https://github.com/lunny/tango) - **star:815** 微型的、支持插件的 web 框架。![star > 100][Bronze]   
...
* [vox](https://github.com/aisk/vox) - **star:28** 一个面向人类的golang web框架，深受Koa的启发。
...
* [CORS](https://github.com/rs/cors) - **star:1178** 轻松地向API添加CORS功能。![star > 1000][Silver]   
...
* [Limiter](https://github.com/ulule/limiter) - **star:766** 简单的速度限制中间件。![star > 100][Bronze]   
* [ln-paywall](https://github.com/philippgille/ln-paywall) - **star:86** 使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。
* [Tollbooth](https://github.com/didip/tollbooth) - **star:1216** 限制速率的 HTTP 请求处理程序。![star > 1000][Silver]   
* [XFF](https://github.com/sebest/xff) - **star:71** 处理 X-Forwarded-For 头的中间件。

#### 用于创建HTTP中间件的库

* [alice](https://github.com/justinas/alice) - **star:1806** 用于连接中间件的库，简单无痛苦。![star > 1000][Silver]   
...
* [negroni](https://github.com/urfave/negroni) - **star:6284** 符合语言习惯的 HTTP 中间件库。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [chi](https://github.com/go-chi/chi) - **star:5883** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。![star > 5000][Gold]   
...
* [httprouter](https://github.com/julienschmidt/httprouter) - **star:9512** 高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。![star > 5000][Gold]   
...
* [mux](https://github.com/gorilla/mux) - **star:9434** 强大的URL路由器和调度器为golang。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [errcheck](https://github.com/kisielk/errcheck) - **star:1310** Errcheck是一个用于检查Go程序中未检查错误的程序。![star > 1000][Silver]   
...
* [GoLint](https://github.com/golang/lint) - **star:3108** Go 源码的 linter。![star > 1000][Silver]   
...
* [GoSublime](https://github.com/DisposaBoy/GoSublime) - **star:3221** 包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。![star > 1000][Silver]   
...
* [vim-go](https://github.com/fatih/vim-go) - **star:10686** Go 开发会用到的 Vim 插件。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [vscode-go](https://github.com/Microsoft/vscode-go) - **star:5036** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [genny](https://github.com/cheekybits/genny) - **star:925** 优雅的 Go 泛型。![star > 100][Bronze]   
...
* [gotests](https://github.com/cweill/gotests) - **star:2131** 从源代码生成测试用例。![star > 1000][Silver]   
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **star:1931** 使用 dot format 可视化 Go 程序的调用图。![star > 1000][Silver]   
* [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) - **star:37** Bash completion for go and wgo。![最近一年没有更新][Yellow]
* [go-swagger](https://github.com/go-swagger/go-swagger) - **star:3853** 基于 Go 的Swagger 2.0实现。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [godbg](https://github.com/tylerwince/godbg) - **star:157** 实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。![star > 100][Bronze]   
* [OctoLinker](https://github.com/OctoLinker/browser-extension) - **star:3694** 借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [bombardier](https://github.com/codesenberg/bombardier) - **star:1685** 快速跨平台 HTTP 基准测试工具。![star > 1000][Silver]   
* [bosun](https://github.com/bosun-monitor/bosun) - **star:2844** 按照时间轴发出告警的框架。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [easyssh-proxy](https://github.com/appleboy/easyssh-proxy) - **star:97** Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`.![最近一个周有更新][Green]
* [fac](https://github.com/mkchoi212/fac) - **star:1598** 修复 git 合并冲突。![star > 1000][Silver]   
* [gaia](https://github.com/gaia-pipeline/gaia) - **star:3705** 可用于任何编程语言来构建强大的管道。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [Gitea](https://github.com/go-gitea/gitea) - **star:14674** 从 Gogs fork，完全由社区驱动。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Hey](https://github.com/rakyll/hey) - **star:6085** 压力测试工具，可用来代替 ApacheBench (ab)。![star > 5000][Gold]   
* [kala](https://github.com/ajvb/kala) - **star:1348** 简单、现代和高性能的作业调度程序。![star > 1000][Silver]   
* [kcli](https://github.com/cswank/kcli) - **star:69** 用于检查kafka主题/分区/消息的命令行工具。
* [kubernetes](https://github.com/kubernetes/kubernetes) - **star:54988** 来自谷歌的容器集群管理器。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [Moby](https://github.com/moby/moby) - **star:54013** Collaborative project for the container ecosystem to assemble container-based systems.![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Mora](https://github.com/emicklei/mora) - **star:264** 用于访问 MongoDB 文档和元数据的 REST 服务器。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [ostent](https://github.com/ostrost/ostent) - **star:165** 收集和显示系统指标，并可选 Graphite and/or fluxdb作为依赖。![star > 100][Bronze]   ![最近一年没有更新][Yellow]
* [Packer](https://github.com/mitchellh/packer) - **star:9087** 用于从一个源配置为多个平台创建相同的机器图像。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Pewpew](https://github.com/bengadbois/pewpew) - **star:198** 灵活的 HTTP 命令行压测工具。![star > 100][Bronze]   
* [Pomerium](https://github.com/pomerium/pomerium) - **star:466** Pomerium是一个可识别身份的访问代理。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [script](https://github.com/bitfield/script) - **star:694** 让DevOps编写类shell和系统管理任务变得更加容易。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [StatusOK](https://github.com/sanathp/statusok) - **star:1149** 监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。![star > 1000][Silver]   
* [traefik](https://github.com/containous/traefik) - **star:23226** 反向代理和负载均衡器，支持多个后端。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [Vegeta](https://github.com/tsenart/vegeta) - **star:11916** HTTP负载测试工具和库。超过9000 !![star > 5000][Gold]   
* [webhook](https://github.com/adnanh/webhook) - **star:3992** 允许用户创建在服务器上执行命令的 HTTP hooks。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [Circuit](https://github.com/gocircuit/circuit) - **star:1780** Circuit 是一个可编程平台即服务(PaaS)和/或基础设施即服务(IaaS)，用于管理、发现、同步和编排包含云应用程序的服务和主机。![star > 1000][Silver]   
* [Comcast](https://github.com/tylertreat/Comcast) - **star:6132** 模拟坏的网络连接。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [confd](https://github.com/kelseyhightower/confd) - **star:6330** 使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。![star > 5000][Gold]   
* [DDNS](https://github.com/skibish/ddns) - **star:97** 个人 DDNS 客户端。
* [Docker](http://www.docker.com/) - 面向开发人员和系统管理员的分布式应用程序的开放平台。
* [Documize](https://github.com/documize/community) - **star:798** 集成了SaaS工具数据的现代wiki软件。![star > 100][Bronze]   
* [drive](https://github.com/odeke-em/drive) - **star:4923** 基于命令行的谷歌驱动器客户端。![star > 1000][Silver]   
* [Duplicacy](https://github.com/gilbertchen/duplicacy) - **star:2665** 跨平台网络和云备份工具。![star > 1000][Silver]   
* [gfile](https://github.com/Antonito/gfile) - **star:491** 通过WebRTC在两台计算机之间安全地传输文件，不需要任何第三方依赖。![star > 100][Bronze]   
...
* [Gor](https://github.com/buger/gor) - **star:11215** Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [LiteIDE](https://github.com/visualfc/liteide) - **star:5422** 简单的、开源的、跨平台的Go IDE。![star > 5000][Gold]   
...
* [Pipe](https://github.com/b3log/pipe) - **star:2615** 一个小巧漂亮的博客平台。![star > 1000][Silver]   ![最近一个周有更新][Green]
* [restic](https://github.com/restic/restic) - **star:7240** 消除重复项备份程序。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [rkt](https://github.com/coreos/rkt) - **star:8704** 一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。![star > 5000][Gold]   ![最近一个周有更新][Green]
* [scc](https://github.com/boyter/scc) - **star:761** 一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。![star > 100][Bronze]   ![最近一个周有更新][Green]
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - **star:8060** 快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。![star > 5000][Gold]   ![最近一个周有更新][Green]
...
* [toxiproxy](https://github.com/shopify/toxiproxy) - **star:3784** 为自动化测试模拟网络和系统条件的代理。![star > 1000][Silver]   ![最近一个周有更新][Green]
...
* [GoBooks](https://github.com/dariubs/GoBooks) - **star:6694** 一份精选的 Go 书籍清单。![star > 5000][Gold]   
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) - **star:1467** 由 Maria Letta 提供的与 Gopher 有关的图片包，其中包含了插图,表情文字。![star > 1000][Silver]   
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - **star:14396** Curated list of awesome remote jobs. A lot of them are looking for Go hackers.![star > 5000][Gold]   ![最近一个周有更新][Green]
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - **star:24504** 其他 awesome 系列的列表。![star > 5000][Gold]   
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - **star:31001** Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。![star > 5000][Gold]   
...
* [Ethereum Development with Go](https://github.com/miguelmota/ethereum-development-with-go-book) - **star:439** 一本讲述如何用 Go 进行以太开发的小册。![star > 100][Bronze]   ![最近一个周有更新][Green]
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) - **star:671** 引入示例讲述 Golang 与Node.js在学习上的差异。![star > 100][Bronze]   
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - **star:3955** 学习使用测试驱动开发。![star > 1000][Silver]   ![最近一个周有更新][Green]
