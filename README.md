...
| [Oto](https://github.com/hajimehoshi/oto)  | 423 |  多平台的 low-level 声音播放库。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [authboss](https://github.com/volatiletech/authboss)  | 1910 |  web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [branca](https://github.com/hako/branca)  | 71 |  基于 Go 实现Branca令牌。 |
| [casbin](https://github.com/hsluoyz/casbin)  | 4832 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [jwt](https://github.com/pascaldekloe/jwt)  | 78 |  轻量级JSON Web令牌库。 |
| [jwt-auth](https://github.com/adam-hanna/jwt-auth)  | 151 |  JWT中间件，可用于Golang http服务器，提供了许多配置选项。 |![star > 100][Bronze]   
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5841 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]   
...
| [paseto](https://github.com/o1egl/paseto)  | 226 |  平台无关的安全令牌(PASETO)。 |![star > 100][Bronze]   
...
| [cobra](https://github.com/spf13/cobra)  | 13000 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [commandeer](https://github.com/jaffee/commandeer)  | 84 |  开发友好的CLI应用程序。 |
| [complete](https://github.com/posener/complete)  | 610 |  使用 Go 语言编写的 bash 命令补全工具以及 Go 命令补全工具. |![star > 100][Bronze]   
| [docopt.go](https://github.com/docopt/docopt.go)  | 1163 |  会让你满意的命令行参数解析器。 |![star > 1000][Silver]   
...
| [mitchellh/cli](https://github.com/mitchellh/cli)  | 991 |  用于实现命令行接口的Go库。 |![star > 100][Bronze]   
...
| [pflag](https://github.com/spf13/pflag)  | 741 |  基于POSIX/GNU-style --flags实现的包，主要用于替换Go的falg包。 |![star > 100][Bronze]   
...
| [urfave/cli](https://github.com/urfave/cli)  | 11194 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [aurora](https://github.com/logrusorgru/aurora)  | 615 |  支持fmt.Printf/Sprintf的ANSI终端颜色。 |![star > 100][Bronze]   
...
| [color](https://github.com/fatih/color)  | 2996 |  多功能包装，彩色终端输出。 |![star > 1000][Silver]   
...
| [go-prompt](https://github.com/c-bata/go-prompt)  | 2290 |  构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) |![star > 1000][Silver]   
| [gocui](https://github.com/jroimartin/gocui)  | 5207 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   
...
| [termdash](https://github.com/mum4k/termdash)  | 795 |  此库是基于**termbox-go**实现的，借鉴于[termui](https://github.com/gizak/termui)。 |![star > 100][Bronze]   
...
| [termui](https://github.com/gizak/termui)  | 8847 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [uilive](https://github.com/gosuri/uilive)  | 821 |  用于实时更新终端输出的库。 |![star > 100][Bronze]   
| [uiprogress](https://github.com/gosuri/uiprogress)  | 1525 |  在终端呈现进度条，可灵活配置的。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [env](https://github.com/caarlos0/env)  | 843 |  解析环境变量并赋值到struct中(默认值)。 |![star > 100][Bronze]   
...
| [godotenv](https://github.com/joho/godotenv)  | 2082 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]   
...
| [ini](https://github.com/go-ini/ini)  | 1559 |   读和写INI文件。 |![star > 1000][Silver]   
...
| [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig)  | 2373 |  管理来自环境变量的配置数据。 |![star > 1000][Silver]   
| [koanf](https://github.com/knadh/koanf)  | 78 |  轻量级可扩展库，用于读取Go应用程序中的配置。内置支持JSON, TOML, YAML, env，命令行。 |![最近一个周有更新][Green]
...
| [viper](https://github.com/spf13/viper)  | 9146 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18813 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [bit](https://github.com/yourbasic/bit)  | 53 |  Go 语言集合数据结构。提供了额外的位操作功能。 |![最近一年没有更新][Yellow]
...
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter)  | 506 |  布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。 |![star > 100][Bronze]   
...
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5093 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]   
...
| [gods](https://github.com/emirpasic/gods)  | 6180 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]   
| [golang-set](https://github.com/deckarep/golang-set)  | 1144 |  线程安全和非线程安全的高性能集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gota](https://github.com/kniren/gota)  | 861 |  实现了数据帧，序列以及数据噪音。 |![star > 100][Bronze]   
...
| [willf/bloom](https://github.com/willf/bloom)  | 655 |  实现Bloom过滤器。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6188 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [bcache](https://github.com/iwanbk/bcache)  | 26 |  基于内存的最终一致的分布式缓存。 |
| [BigCache](https://github.com/allegro/bigcache)  | 2421 |  高效的键/值缓存为千兆字节的数据。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [bolt](https://github.com/boltdb/bolt)  | 9912 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
...
| [cache2go](https://github.com/muesli/cache2go)  | 993 |  基于内存的 K/V 缓存，支持超时的自动失效。 |![star > 100][Bronze]   
| [clusteredBigCache](https://github.com/oaStuff/clusteredBigCache)  | 29 |  BigCache 支持集群和独立且生命周期存储项。 |![最近一年没有更新][Yellow]
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16677 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10042 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [GCache](https://github.com/bluele/gcache)  | 877 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]   
| [go-cache](https://github.com/pmylund/go-cache)  | 2835 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]   
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3133 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]   
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7601 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [influxdb](https://github.com/influxdb/influxdb)  | 16848 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [ledisdb](https://github.com/siddontang/ledisdb)  | 3055 |  Ledisdb是一种高性能的NoSQL，类似于基于LevelDB的Redis。 |![star > 1000][Silver]   
...
| [prometheus](https://github.com/prometheus/prometheus)  | 25200 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 218 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]   
| [rqlite](https://github.com/rqlite/rqlite)  | 4662 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [tidb](https://github.com/pingcap/tidb)  | 19765 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 952 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [migrate](https://github.com/golang-migrate/migrate)  | 2526 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sql-migrate](https://github.com/rubenv/sql-migrate)  | 1385 |  数据库迁移工具。允许使用go-bindata将迁移嵌入到应用程序中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-mysql](https://github.com/siddontang/go-mysql)  | 1844 |   Go 工具集，用于处理MySQL协议和复制。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2341 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]   
...
| [orchestrator](https://github.com/github/orchestrator)  | 2989 |  MySQL复制拓扑管理器和可视化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pgweb](https://github.com/sosedoff/pgweb)  | 5951 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]   
| [prep](https://github.com/hexdigest/prep)  | 24 |  在不更改代码的情况下使用准备好的SQL语句。 |![最近一年没有更新][Yellow]
| [pREST](https://github.com/nuveo/prest)  | 2075 |  基于PostgreSQL database的RESTful API服务。 |![star > 1000][Silver]   
| [rwdb](https://github.com/andizzle/rwdb)  | 10 |  rwdb为多个数据库服务器的设置提供读取副本功能。 |![最近一年没有更新][Yellow]
| [vitess](https://github.com/youtube/vitess)  | 8354 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Squirrel](https://github.com/Masterminds/squirrel)  | 2219 |  帮助您构建SQL查询的Go库。 |![star > 1000][Silver]   
| [xo](https://github.com/knq/xo)  | 2152 |  基于现有的schema定义和自定义查询生成 Go 代码，基于支持PostgreSQL、MySQL、SQLite、Oracle和Microsoft SQL Server。 |![star > 1000][Silver]   
...
| [go-adodb](https://github.com/mattn/go-adodb)  | 89 |  Microsoft ActiveX对象数据库驱动程序。 |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb)  | 1011 |  微软MSSQL驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-oci8](https://github.com/mattn/go-oci8)  | 401 |  Oracle 驱动程序。 |![star > 100][Bronze]   
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 7986 |  MySQL驱动程序。 |![star > 5000][Gold]   
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3394 |  SQLite3驱动程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [pgx](https://github.com/jackc/pgx)  | 1879 |  PostgreSQL驱动，支持比现有database/sql更多的特性。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pq](https://github.com/lib/pq)  | 5124 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mgo](https://github.com/globalsign/mgo)  | 1621 |  (已停止维护) MongoDB驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 2987 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6206 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   
| [redis](https://github.com/go-redis/redis)  | 6340 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [cayley](https://github.com/google/cayley)  | 12636 |  图形数据库，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [dsc](https://github.com/viant/dsc)  | 13 |  面向 SQL、NoSQL、结构化文件的数据存储连接。 |
| [gokv](https://github.com/philippgille/gokv)  | 78 |  可扩展的简单的 K/V 存储(Redis、Consul、etcd、bbolt、BadgerDB、LevelDB、Memcached、DynamoDB、S3、PostgreSQL、MongoDB、CockroachDB等等)。 |
...
| [now](https://github.com/jinzhu/now)  | 2152 |  now 是时间有关的工具类。 |![star > 1000][Silver]   
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2487 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gleam](https://github.com/chrislusf/gleam)  | 2054 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]   
| [glow](https://github.com/chrislusf/glow)  | 2505 |  全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。 |![star > 1000][Silver]   
...
| [go-kit](https://github.com/go-kit/kit)  | 14259 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]   
| [gorpc](https://github.com/valyala/gorpc)  | 547 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8901 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 996 |  支持25+种语言RPC库。 |![star > 100][Bronze]   
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8513 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [tendermint](https://github.com/tendermint/tendermint)  | 3092 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [torrent](https://github.com/anacrolix/torrent)  | 2806 |  BitTorrent 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [email](https://github.com/jordan-wright/email)  | 1086 |  一个强大和灵活的电子邮件库。 |![star > 1000][Silver]   
...
| [hermes](https://github.com/matcornic/hermes)  | 1604 |  可生成干净的、响应式的HTML电子邮件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [MailHog](https://github.com/mailhog/MailHog)  | 5092 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]   
...
| [go-lua](https://github.com/Shopify/go-lua)  | 1654 |  用 Go 实现的 Lua 5.2 VM接口。 |![star > 1000][Silver]   
...
| [otto](https://github.com/robertkrimen/otto)  | 4696 |  用 Go 编写的 JavaScript 解释器。 |![star > 1000][Silver]   
...
| [errors](https://github.com/pkg/errors)  | 4789 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]   
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1818 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-sdl2](https://github.com/veandco/go-sdl2)  | 1143 |  实现了[Simple DirectMedia Layer](https://www.libsdl.org/)。 |![star > 1000][Silver]   
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1153 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   
...
| [Pixel](https://github.com/faiface/pixel)  | 2413 |  手工制作的 2D 游戏库。 |![star > 1000][Silver]   
...
| [go-linq](https://github.com/ahmetalpbalkan/go-linq)  | 1784 |  提供类似 .NET LINQ 的查询方法。 |![star > 1000][Silver]   
| [goderive](https://github.com/awalterschulze/goderive)  | 732 |  从输入类型来派生函数。 |![star > 100][Bronze]   
...
| [S2 geometry](https://github.com/golang/geo)  | 878 |  S2 geometry 库。 |![star > 100][Bronze]   
...
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8485 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1798 |  一个高性能的协程池。 |![star > 1000][Silver]   
...
| [fyne](https://github.com/fyne-io/fyne)  | 6128 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [go-astilectron](https://github.com/asticode/go-astilectron)  | 2623 |  使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。 |![star > 1000][Silver]   
| [go-gtk](http://mattn.github.io/go-gtk/)  | - |  实现了 GTK 的 Go接口。 |
| [go-sciter](https://github.com/sciter-sdk/go-sciter)  | 1434 |  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [qt](https://github.com/therecipe/qt)  | 5927 |  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。 |![star > 5000][Gold]   
| [ui](https://github.com/andlabs/ui)  | 6878 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]   
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3661 |  Windows应用程序库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [webview](https://github.com/zserge/webview)  | 4575 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]   
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4385 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [systray](https://github.com/getlantern/systray)  | 771 |  跨平台 Go 库，可在通知区放置图标和菜单。 |![star > 100][Bronze]   
...
| [imagick](https://github.com/gographics/imagick)  | 961 |   ImageMagick下MagickWand的C API的Go binding。 |![star > 100][Bronze]   
| [imaginary](https://github.com/h2non/imaginary)  | 2571 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]   
...
| [picfit](https://github.com/thoas/picfit)  | 1055 |  Go实现的图像调整服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [pt](https://github.com/fogleman/pt)  | 1763 |  Go实现的路径跟踪（path tracing）引擎。 |![star > 1000][Silver]   
| [resize](https://github.com/nfnt/resize)  | 2117 |  Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4798 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [glog](https://github.com/golang/glog)  | 2288 |  为Go提供了多等级日志记录。 |![star > 1000][Silver]   
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11713 |  Go的结构化日志操作 。 |![star > 5000][Gold]   
...
| [spew](https://github.com/davecgh/go-spew)  | 3257 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [stdlog](https://github.com/alexcesaro/log)  | 43 |  Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。 |![最近一年没有更新][Yellow]
| [tail](https://github.com/hpcloud/tail)  | 1516 |  努力模拟实现BSD的tail的特性的Go包。 |![star > 1000][Silver]   
...
| [zap](https://github.com/uber-go/zap)  | 7295 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]   
| [zerolog](https://github.com/rs/zerolog)  | 2134 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [eaopt](https://github.com/MaxHalford/eaopt)  | 617 |  一个进化优化（evolutionary optimization）库。 |![star > 100][Bronze]   
...
| [gobrain](https://github.com/goml/gobrain)  | 375 |  用 Go 编写的神经网络库。 |![star > 100][Bronze]   
...
| [gosseract](https://github.com/otiai10/gosseract)  | 856 |  使用c++的Tesseract库实现的OCR。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [APNs2](https://github.com/sideshow/apns2)  | 2033 |  HTTP / 2苹果消息推送provider——发送推送消息到iOS, tvOS, Safari和OSX应用。 |![star > 1000][Silver]   
...
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3639 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   
...
| [go-nsq](https://github.com/nsqio/go-nsq)  | 1446 |  NSQ的官方Go包。 |![star > 1000][Silver]   
| [go-socket.io](https://github.com/googollee/go-socket.io)  | 2852 |  go的socket.io库，一个实时应用程序框架。 |![star > 1000][Silver]   
| [go-vitotrol](https://github.com/maxatome/go-vitotrol)  | 11 |  用于Viessmann Vitotrol web服务的客户端库。 |
| [Gollum](https://github.com/trivago/gollum)  | 763 |  一个n:m多路复用器(n:m multiplexer)，收集不同来源的消息并将其广播到一组目的地。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster)  | 1826 |  gopush-cluster是一个gopush服务器集群。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
| [gorush](https://github.com/appleboy/gorush)  | 3669 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3333 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mangos](https://github.com/go-mangos/mangos)  | 1531 |  Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。 |![star > 1000][Silver]   
| [melody](https://github.com/olahol/melody)  | 1535 |  处理websocket session的极简框架，包括广播和自动ping/pong处理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Mercure](https://github.com/dunglas/mercure)  | 1461 |  使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [messagebus](https://github.com/vardius/message-bus)  | 63 |  messagebus是一个Go的简单异步消息总线，非常适合在执行事件sourcing、CQRS和DDD时用作事件总线。 |
| [NATS Go Client](https://github.com/nats-io/nats)  | 2359 |  轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sarama](https://github.com/Shopify/sarama)  | 4547 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1655 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4366 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3324 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]   
| [xlsx](https://github.com/plandem/xlsx)  | 65 |  在Go程序以快速和安全的方式读取/更新现有的Microsoft Excel文件。 |![最近一个周有更新][Green]
...
| [fx](https://github.com/uber-go/fx)  | 654 |  基于依赖注入的Go应用程序框架(构建在dig之上)。 |![star > 100][Bronze]   
| [gocontainer](https://github.com/vardius/gocontainer)  | 8 |  简单的依赖注入容器。 |
| [inject](https://github.com/defval/inject)  | 19 |  一个基于反射的依赖注入容器，具有简单的接口。 |![最近一个周有更新][Green]
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8734 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gommit](https://github.com/antham/gommit)  | 68 |  分析git提交消息，确保它们遵循已定义的模式。 |
| [gopsutil](https://github.com/shirou/gopsutil)  | 3867 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gojieba](https://github.com/yanyiwu/gojieba)  | 807 |  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。 |![star > 100][Bronze]   
...
| [prose](https://github.com/jdkato/prose)  | 2034 |  用于支持标记化、词性标记、名称实体提取等文本处理的库。 |![star > 1000][Silver]   
...
| [ssh](https://github.com/gliderlabs/ssh)  | 1094 |  用于构建SSH服务器的高级API(封装密码/ SSH)。 |![star > 1000][Silver]   
...
| [webrtc](https://github.com/pions/webrtc)  | 2145 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [grequests](https://github.com/levigross/grequests)  | 1399 |  一个 Go “克隆”的伟大和著名的请求库。 |![star > 1000][Silver]   
| [heimdall](https://github.com/gojektech/heimdall)  | 1060 |  具有重试和hystrix功能的增强http客户机。 |![star > 1000][Silver]   
...
| [sling](https://github.com/dghubble/sling)  | 966 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12495 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]   
...
| [govendor](https://github.com/kardianos/govendor)  | 4700 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gojsonq](https://github.com/thedevsaddam/gojsonq)  | 847 |  一个用来查询JSON数据的Go包。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [graphql-go](https://github.com/graphql-go/graphql)  | 5127 |  为Go实现GraphQL。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [packr](https://github.com/gobuffalo/packr)  | 2059 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   
| [statics](https://github.com/go-playground/statics)  | 53 |  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。 |![最近一年没有更新][Yellow]
| [statik](https://github.com/rakyll/statik)  | 2061 |  将静态文件嵌入到Go可执行文件中。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go)  | 69 |  用于机器学习和统计的数据模型(类似于 pandas)。 |![最近一个周有更新][Green]
...
| [graph](https://github.com/yourbasic/graph)  | 229 |  基本图形算法库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [ode](https://github.com/ChristopherRabotin/ode)  | 10 |  常微分方程(ODE)求解器，支持扩展状态和基于信道的迭代停止条件。 |![最近一年没有更新][Yellow]
| [orb](https://github.com/paulmach/orb)  | 194 |  2D几何类型，支持剪切、GeoJSON和Mapbox矢量平铺。 |![star > 100][Bronze]   
...
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1804 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]   
...
| [lego](https://github.com/xenolf/lego)  | 3442 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [memguard](https://github.com/awnumar/memguard)  | 998 |  一个用于处理内存中敏感值的纯Go库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2886 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 4985 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5391 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mapstructure](https://github.com/mitchellh/mapstructure)  | 2362 |  用于对原生键值对进行解码生成 Go 语言结构体 |![star > 1000][Silver]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [algernon](https://github.com/xyproto/algernon)  | 1578 |  内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。 |![star > 1000][Silver]   
| [Caddy](https://github.com/mholt/caddy)  | 22910 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [etcd](https://github.com/coreos/etcd)  | 26102 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [minio](https://github.com/minio/minio)  | 17044 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3195 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [fasttemplate](https://github.com/valyala/fasttemplate)  | 289 |  简单快速的模板引擎。进行模板元素替换时，速度是比[text/template](http://golang.org/pkg/text/template/)快10倍。 |![star > 100][Bronze]   
| [gofpdf](https://github.com/jung-kurt/gofpdf)  | 3041 |  PDF 文档生成器，支持文本，绘图和图片 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [quicktemplate](https://github.com/valyala/quicktemplate)  | 1384 |  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译 |![star > 1000][Silver]   
...
| [go-cmp](https://github.com/google/go-cmp)  | 1117 |  用于比较测试中的Go值的包。 |![star > 1000][Silver]   
...
| [httpexpect](https://github.com/gavv/httpexpect)  | 1131 |  简洁的、声明式的、易用的端到端HTTP 及 REST API 测试 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Testify](https://github.com/stretchr/testify)  | 7961 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1685 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]   
...
| [gomock](https://github.com/golang/mock)  | 2746 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [minimock](https://github.com/gojuno/minimock)  | 205 |  Go接口的模拟生成器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Tavor](https://github.com/zimmski/tavor)  | 210 |  通用模糊测试框架 |![star > 100][Bronze]   
...
| [chromedp](https://github.com/knq/chromedp)  | 3477 |  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [ggr](https://github.com/aerokube/ggr)  | 208 |  一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs |![star > 100][Bronze]   
| [selenoid](https://github.com/aerokube/selenoid)  | 1199 |  Selenium hub 服务器的替代品，在容器中启动浏览器 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3849 |  Markdown 解析器 |![star > 1000][Silver]   
...
| [colly](https://github.com/asciimoo/colly)  | 8199 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   
...
| [gofeed](https://github.com/mmcdole/gofeed)  | 1087 |  在Go中解析RSS和Atom feeds。 |![star > 1000][Silver]   
...
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7481 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]   
...
| [toml](https://github.com/BurntSushi/toml)  | 2744 |  TOML配置格式(带反射的编码器/解码器)。 |![star > 1000][Silver]   
* Utility
...
| [radix](https://github.com/yourbasic/radix)  | 142 |  快速字符串排序算法。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 4978 |  AWS 提供的官方go语言 SDK |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [github](https://github.com/google/go-github)  | 4719 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-jira](https://github.com/andygrunwald/go-jira)  | 561 |   Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [google](https://github.com/google/google-api-go-client)  | 1907 |  为Go自动生成谷歌api。 |![star > 1000][Silver]   
| [google-analytics](https://github.com/chonthu/go-google-analytics)  | 12 |  简单的包装，方便的谷歌分析报告。 |![最近一年没有更新][Yellow]
| [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang)  | 1755 |  谷歌云api Go 客户端库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [apm](https://github.com/topfreegames/apm)  | 127 |  Go 语言进程管理工具具有HTTP API.。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [circuit](https://github.com/cep21/circuit)  | 324 |  一个高效和功能齐全的 类似 Hystrix Go 实现断路器模式。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [ctop](https://github.com/bcicen/ctop)  | 8741 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [delve](https://github.com/derekparker/delve)  | 11845 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [filetype](https://github.com/h2non/filetype)  | 930 |  通过数字签名来推测文件类型。 |![star > 100][Bronze]   
...
| [fzf](https://github.com/junegunn/fzf)  | 22780 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-funk](https://github.com/thoas/go-funk)  | 1135 |  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...) |![star > 1000][Silver]   
...
| [goreleaser](https://github.com/goreleaser/goreleaser)  | 4449 |  尽可能快速的发布 Go 语言二进制文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goreporter](https://github.com/wgliang/goreporter)  | 2471 |  进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具 |![star > 1000][Silver]   
...
| [hub](https://github.com/github/hub)  | 16792 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   
| [hystrix-go](https://github.com/afex/hystrix-go)  | 1975 |  实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。 |![star > 1000][Silver]   
...
| [koazee](https://github.com/wesovilabs/koazee)  | 288 |  库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。 |![star > 100][Bronze]   
| [lrserver](https://github.com/jaschaephraim/lrserver)  | 100 |  LiveReload 服务器。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [mc](https://github.com/minio/mc)  | 1090 |  Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mergo](https://github.com/imdario/mergo)  | 831 |  用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。 |![star > 100][Bronze]   
...
| [mole](https://github.com/davrodpin/mole)  | 1298 |  cli应用程序可以轻松创建ssh隧道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [realize](https://github.com/tockins/realize)  | 3116 |  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。 |![star > 1000][Silver]   
...
| [resty](https://github.com/go-resty/resty)  | 1863 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [retry](https://github.com/kamilsk/retry)  | 144 |  基于上下文的功能机制，反复执行命令直到成功。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [retry](https://github.com/shafreeck/retry)  | 9 |  一个相当简单的库，以确保您的工作可以完成。 |![最近一个周有更新][Green]
...
| [sqlx](https://github.com/jmoiron/sqlx)  | 6679 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   
...
| [Task](https://github.com/go-task/task)  | 1876 |  简单的“Go”的选择。 |![star > 1000][Silver]   
| [toolbox](https://github.com/viant/toolbox)  | 88 |  切片, map, multimap, 结构体, 函数,数据转换工具。服务路由，宏求值和标记器。 |![最近一个周有更新][Green]
...
| [validator](https://github.com/go-playground/validator)  | 3407 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [git2go](https://github.com/libgit2/git2go)  | 1348 |   libgit2 的 Go 语言接口。 |![star > 1000][Silver]   
| [go-git](https://github.com/src-d/go-git)  | 4152 |  纯Go中高度可扩展的Git实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-vcs](https://github.com/sourcegraph/go-vcs)  | 69 |  在Go中操作和检查VCS存储库。 |![最近一个周有更新][Green]
| [hercules](https://github.com/src-d/hercules)  | 511 |  从Git存储库历史中获得高级见解。 |![star > 100][Bronze]   
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [gmf](https://github.com/3d0c/gmf)  | 520 |   FFmpeg av\* 库的 Go 语言接口。 |![star > 100][Bronze]   
...
| [Beego](https://github.com/astaxie/beego)  | 21223 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14498 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Gin](https://github.com/gin-gonic/gin)  | 29279 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2825 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Goa](https://github.com/goadesign/goa)  | 3481 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [hiboot](https://github.com/hidevopsio/hiboot)  | 85 |  hiboot是一个高性能的web应用程序框架，支持自动配置和依赖注入。 |
| [Macaron](https://github.com/go-macaron/macaron)  | 2791 |  Macaron 是一个高效的模块化设计的web框架 |![star > 1000][Silver]   
...
| [CORS](https://github.com/rs/cors)  | 1198 |  轻松地向API添加CORS功能。 |![star > 1000][Silver]   
...
| [Limiter](https://github.com/ulule/limiter)  | 777 |  简单的速度限制中间件。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ln-paywall](https://github.com/philippgille/ln-paywall)  | 86 |  使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。 |
| [Tollbooth](https://github.com/didip/tollbooth)  | 1234 |  限制速率的 HTTP 请求处理程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [chi](https://github.com/go-chi/chi)  | 5939 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9574 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]   
...
| [mux](https://github.com/gorilla/mux)  | 9528 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]   
...
| [go-critic](https://github.com/go-critic/go-critic)  | 564 |  源代码检查工具。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [GoLint](https://github.com/golang/lint)  | 3126 |  Go 源码的 linter。 |![star > 1000][Silver]   
...
| [gocode](https://github.com/nsf/gocode)  | 4723 |  Autocompletion daemon for the Go programming language. |![star > 1000][Silver]   
...
| [vim-go](https://github.com/fatih/vim-go)  | 10733 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5071 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [genny](https://github.com/cheekybits/genny)  | 936 |  优雅的 Go 泛型。 |![star > 100][Bronze]   
...
| [gotests](https://github.com/cweill/gotests)  | 2151 |  从源代码生成测试用例。 |![star > 1000][Silver]   
...
| [go-callvis](https://github.com/TrueFurby/go-callvis)  | 1963 |  使用 dot format 可视化 Go 程序的调用图。 |![star > 1000][Silver]   
| [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete)  | 37 |  Bash completion for go and wgo。 |![最近一年没有更新][Yellow]
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3901 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [godbg](https://github.com/tylerwince/godbg)  | 157 |  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。 |![star > 100][Bronze]   
| [OctoLinker](https://github.com/OctoLinker/browser-extension)  | 3719 |  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [bombardier](https://github.com/codesenberg/bombardier)  | 1703 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]   
...
| [gaia](https://github.com/gaia-pipeline/gaia)  | 3725 |  可用于任何编程语言来构建强大的管道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Gitea](https://github.com/go-gitea/gitea)  | 14870 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [GVM](https://github.com/moovweb/gvm)  | 4443 |  GVM 提供了一个接口来管理 Go 版本。 |![star > 1000][Silver]   
| [Hey](https://github.com/rakyll/hey)  | 6170 |  压力测试工具，可用来代替 ApacheBench (ab)。 |![star > 5000][Gold]   
...
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55479 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [traefik](https://github.com/containous/traefik)  | 23419 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 11989 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   
| [webhook](https://github.com/adnanh/webhook)  | 4035 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]   
...
| [Comcast](https://github.com/tylertreat/Comcast)  | 6158 |  模拟坏的网络连接。 |![star > 5000][Gold]   
| [confd](https://github.com/kelseyhightower/confd)  | 6364 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]   
| [DDNS](https://github.com/skibish/ddns)  | 97 |  个人 DDNS 客户端。 |
| [Docker](http://www.docker.com/)  | - |  面向开发人员和系统管理员的分布式应用程序的开放平台。 |
| [Documize](https://github.com/documize/community)  | 806 |  集成了SaaS工具数据的现代wiki软件。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [drive](https://github.com/odeke-em/drive)  | 4938 |  基于命令行的谷歌驱动器客户端。 |![star > 1000][Silver]   
| [Duplicacy](https://github.com/gilbertchen/duplicacy)  | 2671 |  跨平台网络和云备份工具。 |![star > 1000][Silver]   
...
| [lgo](https://github.com/yunabe/lgo)  | 1780 |  与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。 |![star > 1000][Silver]   
...
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3859 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark)  | 982 |  web框架基准测试。 |![star > 100][Bronze]   
