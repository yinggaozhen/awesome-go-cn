...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-28 20:39:36(每隔1天同步一次)**
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [authboss](https://github.com/volatiletech/authboss)  | 1918 |  web模块化认证系统。它试图删除尽可能多的模板文件和硬编码，以便每次新建一个新的web项目时，您都可以插入、配置并开始构建您的应用程序，而不必每次都构建一个身份验证系统。 |![star > 1000][Silver]
| [branca](https://github.com/hako/branca)  | 76 |  基于 Go 实现Branca令牌。 |
| [casbin](https://github.com/hsluoyz/casbin)  | 4869 |  支持ACL、RBAC、ABAC等访问控制模型的授权库。 |![star > 1000][Silver]
...
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server)  | 1271 |  用 Golang 编写的独立且符合规范的OAuth2服务器。 |![star > 1000][Silver]
...
| [goth](https://github.com/markbates/goth)  | 2251 |  提供了 OAuth 和 OAuth2 的简单清晰易用的方法。可开箱即用处理多个提供程序。 |![star > 1000][Silver]
...
| [jwt](https://github.com/pascaldekloe/jwt)  | 86 |  轻量级JSON Web令牌库。 |
| [jwt-auth](https://github.com/adam-hanna/jwt-auth)  | 151 |  JWT中间件，可用于Golang http服务器，提供了许多配置选项。 |![star > 100][Bronze]
| [jwt-go](https://github.com/dgrijalva/jwt-go)  | 5892 |  JSON Web令牌(JWT)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [loginsrv](https://github.com/tarent/loginsrv)  | 807 |  JWT登录微服务带有可插拔的后端服务，如OAuth2 (Github)、htpasswd、osiam。 |![star > 100][Bronze]
| [oauth2](https://github.com/golang/oauth2)  | 2367 |  goauth2的继任者。通用OAuth 2.0包，附带JWT、谷歌api、计算引擎和应用程序引擎支持。 |![star > 1000][Silver]
...
| [scs](https://github.com/alexedwards/scs)  | 522 |  HTTP服务器的会话管理器。 |![star > 100][Bronze]
...
| [Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot)  | 216 |  基于控制台的，用于加密货币交易所的的交易机器人。 |![star > 100][Bronze]
...
| [telebot](https://github.com/tucnak/telebot)  | 941 |  用Go编写的Telegram bot框架。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api)  | 1612 |  简单轻量级的Telegram bot客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [cmdr](https://github.com/hedzr/cmdr)  | 11 |  一个POSIX/GNU风格的、类似getopt的命令行UI Go库。 |   ![最近一个周有更新][Green]
| [cobra](https://github.com/spf13/cobra)  | 13115 |  现代Go CLI命令行交互工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [docopt.go](https://github.com/docopt/docopt.go)  | 1171 |  会让你满意的命令行参数解析器。 |![star > 1000][Silver]
...
| [go-flags](https://github.com/jessevdk/go-flags)  | 1501 |   Go 命令行选项解析器。 |![star > 1000][Silver]
...
| [kingpin](https://github.com/alecthomas/kingpin)  | 2522 |  支持子命令的命令行和标志解析器。 |![star > 1000][Silver]
...
| [urfave/cli](https://github.com/urfave/cli)  | 11277 |  可让你简单、快速和愉快的构建命令行应用(之前是codegangsta/cli)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [aurora](https://github.com/logrusorgru/aurora)  | 623 |  支持fmt.Printf/Sprintf的ANSI终端颜色。 |![star > 100][Bronze]
...
| [go-prompt](https://github.com/c-bata/go-prompt)  | 2311 |  构建一个强大的交互式提示，借鉴于[python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) |![star > 1000][Silver]
| [gocui](https://github.com/jroimartin/gocui)  | 5291 |  旨在创建控制台用户界面的极简Go库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [mpb](https://github.com/vbauerster/mpb)  | 622 |  可在终端显示多进度条。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [progressbar](https://github.com/schollz/progressbar)  | 564 |  基本线程安全的进度条，在每个操作系统工作。 |![star > 100][Bronze]
| [simpletable](https://github.com/alexeyco/simpletable)  | 157 |  可在终端显示简易表格。 |![star > 100][Bronze]
...
| [termbox-go](https://github.com/nsf/termbox-go)  | 3463 |  基于文本的跨平台接口库。 |![star > 1000][Silver]
...
| [termui](https://github.com/gizak/termui)  | 8881 |  此库是基于**termbox-go**实现的，借鉴于[blessed-contrib](https://github.com/yaronn/blessed-contrib)。 |![star > 5000][Gold]
...
| [uitable](https://github.com/gosuri/uitable)  | 500 |  改善终端应用程序中表格数据的可读性。 |![star > 100][Bronze]
...
| [env](https://github.com/caarlos0/env)  | 856 |  解析环境变量并赋值到struct中(默认值)。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [godotenv](https://github.com/joho/godotenv)  | 2101 |  Ruby 的 dotenv 库的 Go移植版(从.env文件加载环境变量)。 |![star > 1000][Silver]
...
| [gookit/config](https://github.com/gookit/config)  | 79 |  程序配置管理(load,get,set)。支持JSON, YAML, TOML, INI, HCL。支持多文件加载，数据覆盖合并。 |   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig)  | 2393 |  管理来自环境变量的配置数据。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [viper](https://github.com/spf13/viper)  | 9216 |  配置管理。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [drone](https://github.com/drone/drone)  | 18905 |  Drone 是一个基于 Docker 的持续集成平台，用 Go 编写。 |![star > 5000][Gold]
...
| [goveralls](https://github.com/mattn/goveralls)  | 576 |  Coveralls.io 是一个用 Go 编写，可持续对代码覆盖率进行检测的系统。 |![star > 100][Bronze]
...
| [go-datastructures](https://github.com/Workiva/go-datastructures)  | 5109 |  可靠的、高性能的和线程安全的数据结构的集合。 |![star > 5000][Gold]
...
| [gods](https://github.com/emirpasic/gods)  | 6234 |  数据结构。容器、集合、列表、堆栈、地图、BidiMaps、树、HashSet等。 |![star > 5000][Gold]
| [golang-set](https://github.com/deckarep/golang-set)  | 1150 |  线程安全和非线程安全的高性能集。 |![star > 1000][Silver]
| [goset](https://github.com/zoumo/goset)  | 16 |  一个有用的Go集合实现。 |   ![最近一年没有更新][Yellow]
| [goskiplist](https://github.com/ryszard/goskiplist)  | 192 |  基于 Go 的跳表实现。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gota](https://github.com/kniren/gota)  | 867 |  实现了数据帧，序列以及数据噪音。 |![star > 100][Bronze]
...
| [merkletree](https://github.com/cbergoon/merkletree)  | 145 |  实现了merkle树，提供了对数据结构内容的有效和安全的验证。 |![star > 100][Bronze]
...
| [willf/bloom](https://github.com/willf/bloom)  | 662 |  实现Bloom过滤器。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [badger](https://github.com/dgraph-io/badger)  | 6226 |  快速 K/V 存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [bcache](https://github.com/iwanbk/bcache)  | 27 |  基于内存的最终一致的分布式缓存。 |
| [BigCache](https://github.com/allegro/bigcache)  | 2432 |  高效的键/值缓存为千兆字节的数据。 |![star > 1000][Silver]
| [bolt](https://github.com/boltdb/bolt)  | 9939 |  K/V 数据库。 |![star > 5000][Gold]   ![最近一年没有更新][Yellow]
| [buntdb](https://github.com/tidwall/buntdb)  | 2430 |  基于内存的K/V，快速，可嵌入的数据库，可自定义索引和空间支持。 |![star > 1000][Silver]
...
| [cockroach](https://github.com/cockroachdb/cockroach)  | 16723 |  可伸缩、区域备份、事务性数据存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [dgraph](https://github.com/dgraph-io/dgraph)  | 10100 |  可伸缩、分布式、低延迟、高吞吐量的图形数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [GCache](https://github.com/bluele/gcache)  | 888 |  支持过期缓存、LFU、LRU和ARC的缓存库。 |![star > 100][Bronze]
| [go-cache](https://github.com/pmylund/go-cache)  | 2865 |  基于内存的 K/V 存储/缓存 : (类似于Memcached)，适用于单机应用程序。 |![star > 1000][Silver]
| [goleveldb](https://github.com/syndtr/goleveldb)  | 3156 |  在Go中实现[LevelDB](https://github.com/google/leveldb) key/value数据库。 |![star > 1000][Silver]
| [gorocksdb](https://github.com/kapitan-k/gorocksdb)  | 8 |  用 Go 对[RocksDB](https://rocksdb.org)实现了封装。 |   ![最近一年没有更新][Yellow]
| [groupcache](https://github.com/golang/groupcache)  | 7631 |  Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。 |![star > 5000][Gold]
| [influxdb](https://github.com/influxdb/influxdb)  | 16998 |  可伸缩的数据存储，用于指标衡量、事件和实时分析。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [nutsdb](https://github.com/xujiajun/nutsdb)  | 868 |  Nutsdb是一个用纯Go编写的简单、快速、可嵌入、持久的键/值存储。它支持完全序列化的事务和许多数据结构，如列表、集合、排序集。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [piladb](https://github.com/fern4lvarez/piladb)  | 171 |  基于堆栈数据结构的轻量级RESTful数据库引擎。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [prometheus](https://github.com/prometheus/prometheus)  | 25370 |  用于监控系统和时序的数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [pudge](https://github.com/recoilme/pudge)  | 218 |  使用Go的标准库编写的快速和简单的键/值存储。 |![star > 100][Bronze]
| [rqlite](https://github.com/rqlite/rqlite)  | 4676 |  基于SQLite的轻量级分布式关系数据库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Scribble](https://github.com/nanobox-io/golang-scribble)  | 58 |  小型平面文件JSON存储。 |
| [slowpoke](https://github.com/recoilme/slowpoke)  | 87 |  具有持久性的键值存储。 |
| [tempdb](https://github.com/rafaeljesus/tempdb)  | 13 |  用于临时数据存放的 K/V 存储。 |   ![最近一年没有更新][Yellow]
| [tidb](https://github.com/pingcap/tidb)  | 19912 |  TiDB是一个分布式SQL数据库。灵感来自谷歌F1的设计。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics)  | 978 |  开源，快速，可伸缩的时间序列数据库。支持PromQL。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [migrate](https://github.com/golang-migrate/migrate)  | 2565 |  基于CLI的数据库迁移库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-mysql](https://github.com/siddontang/go-mysql)  | 1858 |   Go 工具集，用于处理MySQL协议和复制。 |![star > 1000][Silver]
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch)  | 2369 |  自动将MySQL数据同步到Elasticsearch中。 |![star > 1000][Silver]
...
| [pgweb](https://github.com/sosedoff/pgweb)  | 5965 |  基于web的PostgreSQL数据库浏览器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [vitess](https://github.com/youtube/vitess)  | 8389 |  vitess提供了可以为大规模web服务扩展MySQL数据库提供便利的服务和工具。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gendry](https://github.com/didi/gendry)  | 752 |  非入侵的SQL构建器和强大的数据绑定器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [godbal](https://github.com/xujiajun/godbal)  | 50 |  数据库抽象层(dbal)。支持SQL builder，轻松获取结果。 |
| [goqu](https://github.com/doug-martin/goqu)  | 627 |  常用的SQL生成器和查询库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql)  | 8050 |  MySQL驱动程序。 |![star > 5000][Gold]
| [go-sqlite3](https://github.com/mattn/go-sqlite3)  | 3415 |  SQLite3驱动程序。 |![star > 1000][Silver]
...
| [pq](https://github.com/lib/pq)  | 5145 |  纯 Go 的Postgres驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]

* NoSQL Databases
        
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [aerospike-client-go](https://github.com/aerospike/aerospike-client-go)  | 303 |  Aerospike 客户端。 |![star > 100][Bronze]
...
| [go-rejson](https://github.com/nitishm/go-rejson)  | 89 |  实现了基于 Redigo 客户端的redislabs' ReJSON 模块。可简单地将结构体存储为JSON对象并对其进行操作。 |
...
| [mgo](https://github.com/globalsign/mgo)  | 1625 |  (已停止维护) MongoDB驱动。 |![star > 1000][Silver]
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver)  | 3035 |  官方的 MongoDB 驱动。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [redigo](https://github.com/gomodule/redigo)  | 6229 |  Redigo 是基于 Go 的Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [redis](https://github.com/go-redis/redis)  | 6422 |  基于 Go 的 Redis 客户端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [bleve](https://github.com/blevesearch/bleve)  | 5812 |  基于 Go 的现代文本索引库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [elastic](https://github.com/olivere/elastic)  | 4093 |  Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [elasticsql](https://github.com/cch123/elasticsql)  | 385 |  将 SQL 转换为 elasticsearch dsl。 |![star > 100][Bronze]
| [elastigo](https://github.com/mattbaird/elastigo)  | 951 |  Elasticsearch 客户端。 |![star > 100][Bronze]
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch)  | 1537 |  官方 Elasticsearch 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goes](https://github.com/OwnLocal/goes)  | 24 |  实现了与 Elasticsearch 交互的库。 |   ![最近一年没有更新][Yellow]
| [riot](https://github.com/go-ego/riot)  | 4672 |  基于 Go 的 开源、分布式、简单高效的搜索引擎。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [cayley](https://github.com/google/cayley)  | 12662 |  图形数据库，支持多个后端。 |![star > 5000][Gold]
...
| [dateparse](https://github.com/araddon/dateparse)  | 889 |  可以解析很多格式不固定的日期字符串。 |![star > 100][Bronze]
...
| [now](https://github.com/jinzhu/now)  | 2162 |  now 是时间有关的工具类。 |![star > 1000][Silver]
...
| [consistent](https://github.com/buraksezer/consistent)  | 186 |  Consistent hashing with bounded loads。 |![star > 100][Bronze]
...
| [dragonboat](https://github.com/lni/dragonboat)  | 2502 |  一个功能齐全，高性能的库集。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [emitter-io](https://github.com/emitter-io/emitter)  | 1914 |  高性能、分布式、安全和低延迟的发布-订阅平台，使用MQTT、Websockets和love构建。 |![star > 1000][Silver]
| [flowgraph](https://github.com/vectaport/flowgraph)  | 18 |  flow-based programming package。 |
| [gleam](https://github.com/chrislusf/gleam)  | 2076 |  使用纯Go和Luajit编写的快速、可伸缩的分布式map/reduce系统，结合了Go的高并发性和Luajit的高性能，可以独立运行或分布式运行。 |![star > 1000][Silver]
| [glow](https://github.com/chrislusf/glow)  | 2515 |  全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。 |![star > 1000][Silver]
| [go-health](https://github.com/InVisionApp/go-health)  | 476 |  用于在服务中启用异步依赖项健康检查的库。 |![star > 100][Bronze]
| [go-jump](https://github.com/dgryski/go-jump)  | 253 |  提供了谷歌的 “Jump” 一致哈希函数接口。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [go-kit](https://github.com/go-kit/kit)  | 14337 |  支持服务发现、负载平衡、插件式传输、请求跟踪等功能的Microservice toolkit。 |![star > 5000][Gold]
| [gorpc](https://github.com/valyala/gorpc)  | 551 |  简单、快速和可伸缩的RPC库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [grpc-go](https://github.com/grpc/grpc-go)  | 8991 |  gRPC的Go语言实现。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hprose](https://github.com/hprose/hprose-golang)  | 999 |  支持25+种语言RPC库。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [jaeger](https://github.com/jaegertracing/jaeger)  | 8580 |  分布式跟踪系统。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [KrakenD](https://github.com/devopsfaith/krakend)  | 1727 |  具有中间件的高性能API网关框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [micro](https://github.com/micro/micro)  | 6527 |  可插拔的微服务 toolkit 和分布式系统平台。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [NATS](https://github.com/nats-io/gnatsd)  | 6255 |  轻量级、高性能消息传递系统，可用于微服务、物联网(IoT)和云。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [rpcx](https://github.com/smallnest/rpcx)  | 3745 |  分布式可插拔的RPC服务框架，如阿里巴巴Dubbo。 |![star > 1000][Silver]
...
| [tendermint](https://github.com/tendermint/tendermint)  | 3111 |  一个高性能中间件，可将任何语言的状态机转换为 Byzantine Fault 状态机。使用 Tendermint 一致性及区块链协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [torrent](https://github.com/anacrolix/torrent)  | 2825 |  BitTorrent 客户端。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-imap](https://github.com/emersion/go-imap)  | 724 |  用于客户端和服务器的IMAP库。 |![star > 100][Bronze]
...
| [hermes](https://github.com/matcornic/hermes)  | 1611 |  可生成干净的、响应式的HTML电子邮件。 |![star > 1000][Silver]
| [MailHog](https://github.com/mailhog/MailHog)  | 5127 |  电子邮件和SMTP测试工具，对外提供了 web 和 API 接口。 |![star > 5000][Gold]
...
| [go-lua](https://github.com/Shopify/go-lua)  | 1661 |  用 Go 实现的 Lua 5.2 VM接口。 |![star > 1000][Silver]
...
| [gopher-lua](https://github.com/yuin/gopher-lua)  | 2944 |  用 Go 实现的 Lua 5.1 虚拟机和编译器。 |![star > 1000][Silver]
...
| [tengo](https://github.com/d5/tengo)  | 1289 |  字节码编译的脚本语言。 |![star > 1000][Silver]
...
| [errors](https://github.com/pkg/errors)  | 4836 |  可让你很简单的进行错误处理。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [afero](https://github.com/spf13/afero)  | 2207 |  文件系统的抽象系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [notify](https://github.com/rjeczalik/notify)  | 491 |  文件系统事件通知库，具有类似于os/signal的简单API，。 |![star > 100][Bronze]
| [opc](https://github.com/qmuntal/opc)  | 57 |  加载Open Packaging Conventions (OPC)文件。 |
| [pdfcpu](https://github.com/hhrutter/pdfcpu)  | 939 |  PDF处理器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [decimal](https://github.com/shopspring/decimal)  | 1586 |  任意精度定点的十进制数。 |![star > 1000][Silver]
...
| [techan](https://github.com/sdcoffey/techan)  | 155 |  拥有先进的市场分析和交易策略的技术分析库。 |![star > 100][Bronze]
...
| [forms](https://github.com/albrow/forms)  | 104 |  与框架无关的库，用于解析和验证支持多部分表单和文件的表单/JSON数据。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gorilla/csrf](https://github.com/gorilla/csrf)  | 430 |  用于Go web应用程序和服务的CSRF保护。 |![star > 100][Bronze]
| [nosurf](https://github.com/justinas/nosurf)  | 968 |  CSRF保护中间件。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [fpGo](https://github.com/TeaEntityLab/fpGo)  | 106 |  提供函数式编程功能。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [fuego](https://github.com/seborama/fuego)  | 38 |  Functional Experiment in Go。 |   ![最近一个周有更新][Green]
| [go-underscore](https://github.com/tobyhede/go-underscore)  | 1066 |  常用辅助方法集合。 |![star > 1000][Silver]
...
| [Ebiten](https://github.com/hajimehoshi/ebiten)  | 1839 |  很简单的 2D 游戏库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [goworld](https://github.com/xiaonanln/goworld)  | 1170 |  可伸缩的游戏服务器引擎，具有 space-entity 框架和 hot-swapping 功能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Leaf](https://github.com/name5566/leaf)  | 3038 |  轻量级游戏服务器框架。 |![star > 1000][Silver]   ![包含中文文档][CN]
...
| [Pitaya](https://github.com/topfreegames/pitaya)  | 297 |  可伸缩的游戏服务器框架，支持集群和客户端库的iOS, Android, Unity。 |![star > 100][Bronze]
| [Pixel](https://github.com/faiface/pixel)  | 2423 |  手工制作的 2D 游戏库。 |![star > 1000][Silver]
...
| [gen](https://github.com/clipperhouse/gen)  | 1030 |  用于生成泛型等类似方法的功能代码生成工具。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]
| [generis](https://github.com/senselogic/GENERIS)  | 18 |  提供泛型、free-form 宏、条件编译和HTML模板的代码生成工具。 |
| [go-enum](https://github.com/abice/go-enum)  | 83 |  从代码注释中生成枚举。 |
| [go-linq](https://github.com/ahmetalpbalkan/go-linq)  | 1790 |  提供类似 .NET LINQ 的查询方法。 |![star > 1000][Silver]
...
| [S2 geometry](https://github.com/golang/geo)  | 882 |  S2 geometry 库。 |![star > 100][Bronze]
| [Tile38](https://github.com/tidwall/tile38)  | 6301 |  具有空间索引和实时地理定位功能的地理定位数据库。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gopherjs](https://github.com/gopherjs/gopherjs)  | 8506 |  将 Go 编译成 JavaScript。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [ants](https://github.com/panjf2000/ants)  | 1839 |  一个高性能的协程池。 |![star > 1000][Silver]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [artifex](https://github.com/borderstech/artifex)  | 11 |  简单的内存作业队列。 |
| [async](https://github.com/studiosol/async)  | 20 |  一种异步执行函数的安全方法，在出现 panic 时恢复它们。 |
| [breaker](https://github.com/kamilsk/breaker)  | 33 |  灵活的机制，可以使执行流可中断。 |   ![最近一个周有更新][Green]
...
| [goworker](https://github.com/benmanns/goworker)  | 2241 |  基于 go 的后台 worker。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [grpool](https://github.com/ivpusic/grpool)  | 493 |  轻量级协程池。 |![star > 100][Bronze]
...
| [pool](https://github.com/go-playground/pool)  | 475 |  有限消费者协程或无限协程池，可用于更加简单的处理和取消协程 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [tunny](https://github.com/Jeffail/tunny)  | 1330 |  golang 的协程池。 |![star > 1000][Silver]
| [worker-pool](https://github.com/vardius/worker-pool)  | 43 |  一个简单的 Go 异步工作池。 |   ![最近一个周有更新][Green]
| [workerpool](https://github.com/gammazero/workerpool)  | 131 |  限制任务执行并发数，而不是队列中的任务数量的协程池，。 |![star > 100][Bronze]
...
| [fyne](https://github.com/fyne-io/fyne)  | 6205 |  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter)  | 1440 |  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。 |![star > 1000][Silver]
| [gotk3](https://github.com/gotk3/gotk3)  | 760 |  实现了 GTK3 的 Go接口。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [gowd](https://github.com/dtylman/gowd)  | 207 |  跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。 |![star > 100][Bronze]
| [qt](https://github.com/therecipe/qt)  | 5988 |  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [ui](https://github.com/andlabs/ui)  | 6915 |  跨平台的 Platform-native GUI 库。 |![star > 5000][Gold]
| [Wails](https://wails.app)  | - |  Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。 |
| [walk](https://github.com/lxn/walk)  | 3673 |  Windows应用程序库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [webview](https://github.com/zserge/webview)  | 4616 |  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [robotgo](https://github.com/go-vgo/robotgo)  | 4409 |  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。 |![star > 1000][Silver]
| [systray](https://github.com/getlantern/systray)  | 776 |  跨平台 Go 库，可在通知区放置图标和菜单。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gg](https://github.com/fogleman/gg)  | 1898 |  纯Go语言实现的2D渲染。 |![star > 1000][Silver]
| [gift](https://github.com/disintegration/gift)  | 1206 |  图像处理包。 |![star > 1000][Silver]
...
| [go-opencv](https://github.com/lazywei/go-opencv)  | 1087 |  OpenCV库的Go bindings。 |![star > 1000][Silver]
| [go-webcolors](https://github.com/jyotiska/go-webcolors)  | 24 |  Python下webcolors库的Go语言调用。 |   ![最近一年没有更新][Yellow]
| [gocv](https://github.com/hybridgroup/gocv)  | 2425 |  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [imagick](https://github.com/gographics/imagick)  | 970 |   ImageMagick下MagickWand的C API的Go binding。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [imaginary](https://github.com/h2non/imaginary)  | 2580 |  用于图像大小调整的快速、简单的HTTP微服务。 |![star > 1000][Silver]
| [imaging](https://github.com/disintegration/imaging)  | 2498 |  简单的Go图像处理包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [picfit](https://github.com/thoas/picfit)  | 1061 |  Go实现的图像调整服务器。 |![star > 1000][Silver]
| [pt](https://github.com/fogleman/pt)  | 1765 |  Go实现的路径跟踪（path tracing）引擎。 |![star > 1000][Silver]
...
| [huego](https://github.com/amimof/huego)  | 110 |  一个包含广泛的Philips Hue客户端的Go语言库。 |![star > 100][Bronze]
| [iot](https://github.com/vaelen/iot/)  | - |  IoT是一个实现谷歌物联网核心设备的简单框架。 |
| [mainflux](https://github.com/Mainflux/mainflux)  | 580 |  工业物联网消息和设备管理服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [GJSON](https://github.com/tidwall/gjson)  | 4835 |  使用一行代码获取JSON的值。 |![star > 1000][Silver]
...
| [logrus](https://github.com/Sirupsen/logrus)  | 11812 |  Go的结构化日志操作 。 |![star > 5000][Gold]
...
| [spew](https://github.com/davecgh/go-spew)  | 3281 |  为Go数据结构实现一个漂亮的printer用于帮助调试。 |![star > 1000][Silver]
| [stdlog](https://github.com/alexcesaro/log)  | 43 |  Stdlog是一个面向对象的库，提供了多等级日志记录。它对cron任务非常有用。 |   ![最近一年没有更新][Yellow]
| [tail](https://github.com/hpcloud/tail)  | 1531 |  努力模拟实现BSD的tail的特性的Go包。 |![star > 1000][Silver]
...
| [zap](https://github.com/uber-go/zap)  | 7353 |  快速、结构化、多等级的日志记录。 |![star > 5000][Gold]
| [zerolog](https://github.com/rs/zerolog)  | 2182 |  Zero-allocation JSON日志记录。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gobrain](https://github.com/goml/gobrain)  | 379 |  用 Go 编写的神经网络库。 |![star > 100][Bronze]
...
| [goml](https://github.com/cdipaolo/goml)  | 1009 |  在线机器学习。 |![star > 1000][Silver]
| [goRecommend](https://github.com/timkaye11/goRecommend)  | 142 |  用Go编写的推荐算法库。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [gorgonia](https://github.com/chewxy/gorgonia)  | 2675 |  基于图形（graph-based）的计算库，如Theano：它为构建各种机器学习和神经网络算法提供了基本框架。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gorse](https://github.com/zhenghaoz/gorse)  | 525 |  基于协同过滤（Collaborative Filtering ）的高性能推荐系统包。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [tfgo](https://github.com/galeone/tfgo)  | 1175 |  易于使用的Tensorflow bindings:简化了官方Tensorflow Go bindings的使用。在Go中定义计算图形，在Python中加载和执行训练的模型。 |![star > 1000][Silver]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [APNs2](https://github.com/sideshow/apns2)  | 2037 |  HTTP / 2苹果消息推送provider——发送推送消息到iOS, tvOS, Safari和OSX应用。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Beaver](https://github.com/Clivern/Beaver)  | 717 |  一个实时消息服务器，可用于在web和手机app端构建一个可伸缩的应用内通知，多人游戏，聊天应用。 |![star > 100][Bronze]
| [Benthos](https://github.com/Jeffail/benthos)  | 1989 |  一系列协议之间的消息流桥接。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Bus](https://github.com/mustafaturan/bus)  | 114 |  内部通信的最小消息总线实现。 |![star > 100][Bronze]
| [Centrifugo](https://github.com/centrifugal/centrifugo)  | 3660 |  实时消息(Websockets或SockJS)服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Commander](https://github.com/jeroenrinzema/commander)  | 21 |  高级事件驱动的消费者/生产者(consumer/producer)，支持各种“方言”，如Apache Kafka。 |
...
| [EventBus](https://github.com/asaskevich/EventBus)  | 553 |  具有异步兼容性的轻量级事件总线。 |![star > 100][Bronze]
...
| [go-socket.io](https://github.com/googollee/go-socket.io)  | 2867 |  go的socket.io库，一个实时应用程序框架。 |![star > 1000][Silver]
...
| [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster)  | 1833 |  gopush-cluster是一个gopush服务器集群。 |![star > 1000][Silver]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
| [gorush](https://github.com/appleboy/gorush)  | 3685 |  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [machinery](https://github.com/RichardKnop/machinery)  | 3345 |  基于分布式消息传递的异步任务/作业队列。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [mangos](https://github.com/go-mangos/mangos)  | 1534 |  Nanomsg(“可伸缩协议”)的纯go实现,具有传输互操作性。 |![star > 1000][Silver]
| [melody](https://github.com/olahol/melody)  | 1549 |  处理websocket session的极简框架，包括广播和自动ping/pong处理。 |![star > 1000][Silver]
| [Mercure](https://github.com/dunglas/mercure)  | 1478 |  使用Mercure协议分派服务器发送(server-sent)更新的服务器和库(构建在服务器发送事件之上)。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [NATS Go Client](https://github.com/nats-io/nats)  | 2382 |  轻量级和高性能的发布-订阅(publish-subscribe)和分布式队列消息传递系统——这是一个Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sarama](https://github.com/Shopify/sarama)  | 4580 |   Apache Kafka的Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [unioffice](https://github.com/unidoc/unioffice)  | 1683 |  用于创建和处理Office Word (.docx)、Excel (.xlsx)和Powerpoint (.pptx)文档的纯go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize)  | 4406 |  用于读写Microsoft Excel™(XLSX)文件的Go语言库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [xlsx](https://github.com/tealeg/xlsx)  | 3346 |  用以简化在Go程序中读取使用最新版本Microsoft Excel的XML格式文件的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [dig](https://github.com/uber-go/dig)  | 894 |  一个基于反射的Go依赖注入工具包。 |![star > 100][Bronze]
| [fx](https://github.com/uber-go/fx)  | 693 |  基于依赖注入的Go应用程序框架(构建在dig之上)。 |![star > 100][Bronze]
...
| [golang-standards/project-layout](https://github.com/golang-standards/project-layout)  | 8897 |  Go生态系统中历史和新兴的项目布局模式集合。 |![star > 5000][Gold]
| [scaffold](https://github.com/catchplay/scaffold)  | 22 |  快速生成Go项目布局的脚手架。让您专注于已实现的业务逻辑。 |
...
| [antch](https://github.com/antchfx/antch)  | 139 |  一个快速、强大和可扩展的web爬虫框架。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]   ![包含中文文档][CN]
| [archiver](https://github.com/mholt/archiver)  | 2475 |  用于生成和解压.zip和.tar.gz文档的库和命令。 |![star > 1000][Silver]
...
| [base64Captcha](https://github.com/mojocn/base64Captcha)  | 621 |  base64Captcha支持数字，字母，算术，音频和混合模式的验证码。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [go-commons-pool](https://github.com/jolestar/go-commons-pool)  | 663 |  Go语言的通用对象池。 |![star > 100][Bronze]   ![包含中文文档][CN]
| [go-openapi](https://github.com/go-openapi)  | - |  用于解析和使用开放api模式(open-api schemas)的包的集合。 |
| [go-resiliency](https://github.com/eapache/go-resiliency)  | 848 |   Go语言弹性模式(resiliency pattern)。 |![star > 100][Bronze]
| [go-unarr](https://github.com/gen2brain/go-unarr)  | 67 |  用于RAR、TAR、ZIP和7z文件的解压缩库。 |
| [gofakeit](https://github.com/brianvoe/gofakeit)  | 412 |  用go编写的随机数据生成器。 |![star > 100][Bronze]
| [gommit](https://github.com/antham/gommit)  | 70 |  分析git提交消息，确保它们遵循已定义的格式。 |   ![最近一个周有更新][Green]
| [gopsutil](https://github.com/shirou/gopsutil)  | 3891 |  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gosh](https://github.com/osamingo/gosh)  | 16 |  提供Go统计处理程序，结构和测量方法。 |   ![最近一个周有更新][Green]
...
| [lk](https://github.com/hyperboloide/lk)  | 118 |  一个简单的版权许可证库。 |![star > 100][Bronze]
...
| [go-pinyin](https://github.com/mozillazg/go-pinyin)  | 519 |  中文汉字到汉语拼音的转换。 |![star > 100][Bronze]
...
| [gojieba](https://github.com/yanyiwu/gojieba)  | 813 |  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [when](https://github.com/olebedev/when)  | 925 |  带有可插入规则的自然EN和RU语言日期/时间解析器。 |![star > 100][Bronze]
...
| [dns](https://github.com/miekg/dns)  | 3770 |  用于 DNS 的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [fasthttp](https://github.com/valyala/fasthttp)  | 9238 |  一个快速HTTP实现，比net/http快10倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [gmqtt](https://github.com/DrmagicE/gmqtt)  | 80 |  Gmqtt是一个灵活、高性能的MQTT代理库，它完全实现了MQTT协议V3.1.1。 |   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [gobgp](https://github.com/osrg/gobgp)  | 1664 |  基于 Go 的 BGP 实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [golibwireshark](https://github.com/sunwxg/golibwireshark)  | 14 |  用于解码 pcap 文件和分析解剖数据。 |   ![最近一年没有更新][Yellow]
| [gopacket](https://github.com/google/gopacket)  | 2854 |  Go library for packet processing with libpcap bindings. |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [HTTPLab](https://github.com/gchaincl/httplab)  | 3399 |  HTTPLabs 允许你检查 HTTP 请求和伪造响应。 |![star > 1000][Silver]
...
| [kcp-go](https://github.com/xtaci/kcp-go)  | 2236 |  快速可靠的ARQ协议。 |![star > 1000][Silver]
| [kcptun](https://github.com/xtaci/kcptun)  | 10627 |  基于KCP协议的非常简单和快速udp隧道。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [NFF-Go](https://github.com/intel-go/nff-go)  | 654 |  用于快速开发云计算和裸机网络功能的框架(原YANFF)。 |![star > 100][Bronze]
...
| [quic-go](https://github.com/lucas-clemente/quic-go)  | 2870 |  在纯Go中实现了QUIC协议。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [raw](https://github.com/mdlayher/raw)  | 303 |  Package raw支持在设备驱动程序级别读取和写入网络接口的数据。 |![star > 100][Bronze]
| [sftp](https://github.com/pkg/sftp)  | 730 |  Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |![star > 100][Bronze]
| [ssh](https://github.com/gliderlabs/ssh)  | 1101 |  用于构建SSH服务器的高级API(封装密码/ SSH)。 |![star > 1000][Silver]
...
| [webrtc](https://github.com/pions/webrtc)  | 2169 |  WebRTC API的纯Go实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [sling](https://github.com/dghubble/sling)  | 989 |  Sling是一个用于创建和发送API请求的Go HTTP客户端库。 |![star > 100][Bronze]
...
| [go-pg](https://github.com/go-pg/pg)  | 2938 |  用于 PostgreSQL 的ORM。侧重于 PostgreSQL 的特性和性能。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder)  | 231 |  一个灵活而强大的SQL字符串构建器库。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [go-store](https://github.com/gosuri/go-store)  | 93 |  简单且快速的 Redis 键值存储库。 |   ![最近一年没有更新][Yellow]
| [GORM](https://github.com/jinzhu/gorm)  | 14523 |  一个出色的 ORM 库。主要目标是对开发人员友好。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [reform](https://github.com/go-reform/reform)  | 791 |  基于非空接口和代码生成的 ORM。 |![star > 100][Bronze]
| [SQLBoiler](https://github.com/volatiletech/sqlboiler)  | 2251 |  ORM 生成器。根据数据库 schema 生成一个功能强大且运行速度快的ORM。 |![star > 1000][Silver]
| [upper.io/db](https://github.com/upper/db)  | 1840 |  对外提供统一的接口用于访问不同的存储介质，例如PostgreSQL, MySQL, SQLite, MSSQL, QL、MongoDB.。 |![star > 1000][Silver]
| [Xorm](https://github.com/go-xorm/xorm)  | 5147 |  基于 Go 的简单而强大的ORM。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [dep](https://github.com/golang/dep)  | 12531 |   Go 的依赖管理工具，需要 Go 1.9+ |![star > 5000][Gold]
...
| [glide](https://github.com/Masterminds/glide)  | 7768 |  轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。 |![star > 5000][Gold]
...
| [gopm](https://github.com/gpmgo/gopm)  | 2352 |  包管理器。 |![star > 1000][Silver]
| [govendor](https://github.com/kardianos/govendor)  | 4722 |  包管理器。使用 vendor 文件的 Go vendor 工具。 |![star > 1000][Silver]
...
| [graphql](https://github.com/neelance/graphql-go)  | 2752 |  关注易用性的GraphQL服务器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [graphql-go](https://github.com/graphql-go/graphql)  | 5175 |  为Go实现GraphQL。 |![star > 5000][Gold]
...
| [go.rice](https://github.com/GeertJohan/go.rice)  | 1640 |  go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。 |![star > 1000][Silver]
| [packr](https://github.com/gobuffalo/packr)  | 2084 |  将静态文件嵌入到Go二进制文件中的简单方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gonum](https://github.com/gonum/gonum)  | 2922 |  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gosl](https://github.com/cpmech/gosl)  | 1301 |  提供线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程，等等。 |![star > 1000][Silver]
...
| [Cameradar](https://github.com/Ullaakut/cameradar)  | 1817 |  工具和库，以远程入侵RTSP流从监控摄像头。 |![star > 1000][Silver]
...
| [lego](https://github.com/xenolf/lego)  | 3465 |  纯 Go ACME 客户端库及命令行工具 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [memguard](https://github.com/awnumar/memguard)  | 1356 |  一个用于处理内存中敏感值的纯Go库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [gogoprotobuf](https://github.com/gogo/protobuf)  | 2912 |  Go 语言的 Protocol Buffer 库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [goprotobuf](https://github.com/golang/protobuf)  | 5031 |  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers. |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [jsoniter](https://github.com/json-iterator/go)  | 5479 |  高性能，100% 兼容的“encoding/json” 替代品 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [mapstructure](https://github.com/mitchellh/mapstructure)  | 2383 |  用于对原生键值对进行解码生成 Go 语言结构体 |![star > 1000][Silver]
...
| [Caddy](https://github.com/mholt/caddy)  | 23025 |  Caddy是另一种HTTP/2 web服务器，易于配置和使用。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [etcd](https://github.com/coreos/etcd)  | 26268 |  为共享配置和服务发现提供高可用的键值存储。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Fider](https://github.com/getfider/fider)  | 787 |  Fider是一个收集和组织客户反馈的开放平台。 |![star > 100][Bronze]
| [Flagr](https://github.com/checkr/flagr)  | 815 |  Flagr是一个开源特性标记和A/B测试服务。 |![star > 100][Bronze]
| [flipt](https://github.com/markphelps/flipt)  | 984 |  一个用Go和Vue.js编写的自包含特性标志解决方案 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [jackal](https://github.com/ortuman/jackal)  | 709 |  用Go编写的XMPP服务器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [minio](https://github.com/minio/minio)  | 17169 |  Minio是一个分布式对象存储服务器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [RoadRunner](https://github.com/spiral/roadrunner)  | 3226 |  高性能PHP应用服务器，负载平衡器和进程管理器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [fasttemplate](https://github.com/valyala/fasttemplate)  | 292 |  简单快速的模板引擎。进行模板元素替换时，速度是比[text/template](http://golang.org/pkg/text/template/)快10倍。 |![star > 100][Bronze]
| [gofpdf](https://github.com/jung-kurt/gofpdf)  | 3059 |  PDF 文档生成器，支持文本，绘图和图片 |![star > 1000][Silver]
...
| [quicktemplate](https://github.com/valyala/quicktemplate)  | 1393 |  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译 |![star > 1000][Silver]
...
| [frisby](https://github.com/verdverm/frisby)  | 249 |  REST API测试框架。 |![star > 100][Bronze]
...
| [go-cmp](https://github.com/google/go-cmp)  | 1132 |  用于比较测试中的Go值的包。 |![star > 1000][Silver]
| [go-mutesting](https://github.com/zimmski/go-mutesting)  | 289 |  变异测试的Go源代码。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [godog](https://github.com/DATA-DOG/godog)  | 744 |  类似 Cucumber 或 Behat 的 BDD 框架 |![star > 100][Bronze]
...
| [Testify](https://github.com/stretchr/testify)  | 8042 |  对标准测试包的扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock)  | 1717 |  Mock SQL ，用于测试数据库交互 |![star > 1000][Silver]
...
| [gomock](https://github.com/golang/mock)  | 2798 |  用于Go编程语言的mock框架。 |![star > 1000][Silver]
...
| [httpmock](https://github.com/jarcoal/httpmock)  | 574 |  轻松模拟来自外部资源的HTTP响应。 |![star > 100][Bronze]
| [minimock](https://github.com/gojuno/minimock)  | 255 |  Go接口的模拟生成器。 |![star > 100][Bronze]
...
| name  | star  | desc  | tag&nbsp;&nbsp;&nbsp; |
|---|---|---|---|
| [go-fuzz](https://github.com/dvyukov/go-fuzz)  | 2864 |  随机测试系统。 |![star > 1000][Silver]
...
| [chromedp](https://github.com/knq/chromedp)  | 3513 |  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品 |![star > 1000][Silver]
...
| [selenoid](https://github.com/aerokube/selenoid)  | 1216 |  Selenium hub 服务器的替代品，在容器中启动浏览器 |![star > 1000][Silver]
...
| [blackfriday](https://github.com/russross/blackfriday)  | 3869 |  Markdown 解析器 |![star > 1000][Silver]
...
| [colly](https://github.com/asciimoo/colly)  | 8282 |  快速和优雅的 Scraping 框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-humanize](https://github.com/dustin/go-humanize)  | 1885 |  格式化程序，用于将时间、数字和内存大小转换为可读格式。 |![star > 1000][Silver]
...
| [gofeed](https://github.com/mmcdole/gofeed)  | 1093 |  在Go中解析RSS和Atom feeds。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [GoQuery](https://github.com/PuerkitoBio/goquery)  | 7524 |  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能 |![star > 5000][Gold]
...
| [inject](https://github.com/facebookgo/inject)  | 1134 |  包注入提供了一个基于反射的注入器。 |![star > 1000][Silver]
...
| [sh](https://github.com/mvdan/sh)  | 1973 |  Shell解析器和格式化工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [toml](https://github.com/BurntSushi/toml)  | 2760 |  TOML配置格式(带反射的编码器/解码器)。 |![star > 1000][Silver]
* Utility
...
| [aws-sdk-go](https://github.com/aws/aws-sdk-go)  | 4997 |  AWS 提供的官方go语言 SDK |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [discordgo](https://github.com/bwmarrin/discordgo)  | 963 |   Discord Chat API的客户端。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
| [ethrpc](https://github.com/onrik/ethrpc)  | 167 |   Ethereum JSON RPC API的客户端。 |![star > 100][Bronze]
...
| [github](https://github.com/google/go-github)  | 4737 |  访问GitHub REST API v3的库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [go-jira](https://github.com/andygrunwald/go-jira)  | 568 |   Go [Atlassian JIRA](https://www.atlassian.com/software/jira)的客户端库 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-twitter](https://github.com/dghubble/go-twitter)  | 706 |   Twitter v1.1 api 的客户端。。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang)  | 1765 |  谷歌云api Go 客户端库。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [slack](https://github.com/nlopes/slack)  | 2395 |  Slack API。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [stripe](https://github.com/stripe/stripe-go)  | 934 |   Stripe API 的 Go 语言客户端 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [Trello](https://github.com/adlio/trello)  | 100 |   Trello API的 Go 语言封装。 |![star > 100][Bronze]
...
| [boilr](https://github.com/tmrts/boilr)  | 928 |  非常快的CLI工具，用于从样板模板创建项目。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
...
| [ctop](https://github.com/bcicen/ctop)  | 8770 |  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。 |![star > 5000][Gold]
...
| [delve](https://github.com/derekparker/delve)  | 11912 |  Go 语言调试器 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [filetype](https://github.com/h2non/filetype)  | 938 |  通过数字签名来推测文件类型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [fzf](https://github.com/junegunn/fzf)  | 22957 |  用Go编写的命令行模糊查找器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [go-torch](https://github.com/uber/go-torch)  | 3633 |  为 Go 语言程序生成火焰图。 |![star > 1000][Silver]
...
| [godropbox](https://github.com/dropbox/godropbox)  | 3740 |  用于编写 Go 语言服务／应用的库，来自 Dropbox.。 |![star > 1000][Silver]
...
| [hub](https://github.com/github/hub)  | 16860 |  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [hystrix-go](https://github.com/afex/hystrix-go)  | 1994 |  实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。 |![star > 1000][Silver]
...
| [jump](https://github.com/gsamokovarov/jump)  | 651 |  通过学习你的习惯，可以帮助你更快地导航。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [mc](https://github.com/minio/mc)  | 1095 |  Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [minify](https://github.com/tdewolff/minify)  | 1852 |  用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [minquery](https://github.com/icza/minquery)  | 50 |  MongoDB / mgo.v2, 支持高效分页查询(用于继续列出我们停止的文档的游标)。 |
| [mmake](https://github.com/tj/mmake)  | 1447 |  现代 Make 工具 |![star > 1000][Silver]
...
| [panicparse](https://github.com/maruel/panicparse)  | 2137 |  将类似的协程分组并对调用栈进行着色 |![star > 1000][Silver]
| [peco](https://github.com/peco/peco)  | 5437 |  简单的交互过滤工具。 |![star > 5000][Gold]
...
| [profile](https://github.com/pkg/profile)  | 996 |  Go的简单分析支持包。 |![star > 100][Bronze]
| [rclient](https://github.com/zpatrick/rclient)  | 27 |  可读、灵活、易于使用的REST api客户端。 |
| [realize](https://github.com/tockins/realize)  | 3139 |  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。 |![star > 1000][Silver]
...
| [resty](https://github.com/go-resty/resty)  | 1938 |  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。 |![star > 1000][Silver]
...
| [sqlx](https://github.com/jmoiron/sqlx)  | 6721 |  为内建的数据库/sql 软件包提供一组扩展。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Task](https://github.com/go-task/task)  | 1914 |  简单的“Go”的选择。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [wuzz](https://github.com/asciimoo/wuzz)  | 8250 |  用于HTTP检查的交互式cli工具。 |![star > 5000][Gold]
...
| [ulid](https://github.com/oklog/ulid)  | 1666 |  实现了ULID(普遍唯一的词典分类标识符)。 |![star > 1000][Silver]
...
| [uuid](https://github.com/gofrs/uuid)  | 562 |  通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。 |![star > 100][Bronze]
...
| [govalidator](https://github.com/asaskevich/govalidator)  | 3528 |  用于字符串，数字，切片和结构的验证器和sanitizers。 |![star > 1000][Silver]
...
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation)  | 1028 |  支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。 |![star > 1000][Silver]
...
| [validator](https://github.com/go-playground/validator)  | 3456 |   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。 |![star > 1000][Silver]
...
| [go-git](https://github.com/src-d/go-git)  | 4174 |  纯Go中高度可扩展的Git实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Air](https://github.com/aofei/air)  | 328 |  一个理想的精细化的Go web框架。 |![star > 100][Bronze]
| [Banjo](https://github.com/nsheremet/banjo)  | 7 |  非常简单和快速的网络框架 Go 。 |   ![最近一年没有更新][Yellow]
| [Beego](https://github.com/astaxie/beego)  | 21356 |  beego是一种用于 Go 编程语言的开源高性能web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
| [Buffalo](http://gobuffalo.io)  | - |  为 Go 语言带来堪比 Rails 的高生产效率! |
| [Echo](https://github.com/labstack/echo)  | 14578 |  高性能、极简的Go web框架。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Gin](https://github.com/gin-gonic/gin)  | 29605 |  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Gizmo](https://github.com/NYTimes/gizmo)  | 2834 |  《纽约时报》使用的微服务工具包。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [go-json-rest](https://github.com/ant0ine/go-json-rest)  | 3329 |  设置RESTful JSON API的快速简便方法。 |![star > 1000][Silver]
| [go-rest](https://github.com/ungerik/go-rest)  | 116 |  小型的 REST 框架。 |![star > 100][Bronze]   ![最近一年没有更新][Yellow]
| [Goa](https://github.com/goadesign/goa)  | 3496 |  Goa为在Go中开发远程api和微服务提供了一种全面的方法。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [Macaron](https://github.com/go-macaron/macaron)  | 2806 |  Macaron 是一个高效的模块化设计的web框架 |![star > 1000][Silver]
...
| [Revel](https://github.com/revel/revel)  | 11223 |  用于Go语言的高效web框架。 |![star > 5000][Gold]
...
| [CORS](https://github.com/rs/cors)  | 1207 |  轻松地向API添加CORS功能。 |![star > 1000][Silver]
...
| [Tollbooth](https://github.com/didip/tollbooth)  | 1239 |  限制速率的 HTTP 请求处理程序。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [negroni](https://github.com/urfave/negroni)  | 6311 |  符合语言习惯的 HTTP 中间件库。 |![star > 5000][Gold]   ![包含中文文档][CN]
...
| [chi](https://github.com/go-chi/chi)  | 5987 |  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。 |![star > 5000][Gold]
...
| [Goji](https://github.com/goji/goji)  | 766 |  枸杞是一种简约的和灵活的与支持'net/context` HTTP请求多路复用器。 |![star > 100][Bronze]
...
| [httprouter](https://github.com/julienschmidt/httprouter)  | 9645 |  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。 |![star > 5000][Gold]
...
| [mux](https://github.com/gorilla/mux)  | 9592 |  强大的URL路由器和调度器为golang。 |![star > 5000][Gold]
...
| [errcheck](https://github.com/kisielk/errcheck)  | 1320 |  Errcheck是一个用于检查Go程序中未检查错误的程序。 |![star > 1000][Silver]
| [gcvis](https://github.com/davecheney/gcvis)  | 916 |  实时可视化跟踪 GC 数据。 |![star > 100][Bronze]
...
| [go-critic](https://github.com/go-critic/go-critic)  | 570 |  源代码检查工具。 |![star > 100][Bronze]
...
| [goast-viewer](https://github.com/yuroyoro/goast-viewer)  | 370 |  基于 Web 的 Golang AST 可视化工具。 |![star > 100][Bronze]
...
| [php-parser](https://github.com/z7zmey/php-parser)  | 631 |  用 Go 编写的 PHP 解析器。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [go-mode](https://github.com/dominikh/go-mode.el)  | 945 |  在 GNU/Emacs 支持 GO。 |![star > 100][Bronze]
| [go-plus](https://github.com/joefitzgerald/go-plus)  | 1480 |  在 Atom 中添加自动完成，格式化，语法检查，高亮和审查。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [gocode](https://github.com/nsf/gocode)  | 4731 |  Autocompletion daemon for the Go programming language. |![star > 1000][Silver]
| [goprofiling](https://marketplace.visualstudio.com/items?itemName=MaxMedia.go-prof)  | - |  在 VS Code 中支持 Go 的基准分析。 |
| [GoSublime](https://github.com/DisposaBoy/GoSublime)  | 3232 |  包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [vim-go](https://github.com/fatih/vim-go)  | 10775 |  Go 开发会用到的 Vim 插件。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [vscode-go](https://github.com/Microsoft/vscode-go)  | 5092 |  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [genny](https://github.com/cheekybits/genny)  | 949 |  优雅的 Go 泛型。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [gotests](https://github.com/cweill/gotests)  | 2177 |  从源代码生成测试用例。 |![star > 1000][Silver]
...
| [go-swagger](https://github.com/go-swagger/go-swagger)  | 3939 |  基于 Go 的Swagger 2.0实现。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [richgo](https://github.com/kyoh86/richgo)  | 386 |  用文本装饰丰富 go test 的输出。 |![star > 100][Bronze]
...
| [bombardier](https://github.com/codesenberg/bombardier)  | 1725 |  快速跨平台 HTTP 基准测试工具。 |![star > 1000][Silver]
...
| [dogo](https://github.com/liudng/dogo)  | 217 |  监视源文件中的更改并自动编译和运行(restart)。 |![star > 100][Bronze]   ![包含中文文档][CN]
...
| [fac](https://github.com/mkchoi212/fac)  | 1613 |  修复 git 合并冲突。 |![star > 1000][Silver]
| [gaia](https://github.com/gaia-pipeline/gaia)  | 3732 |  可用于任何编程语言来构建强大的管道。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
| [Gitea](https://github.com/go-gitea/gitea)  | 15009 |  从 Gogs fork，完全由社区驱动。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate)  | 664 |  允许你的 Go应用程序 进行自我更新。 |![star > 100][Bronze]
...
| [gox](https://github.com/mitchellh/gox)  | 3346 |  非常简单，没有多余的跨平台编译工具。 |![star > 1000][Silver]
...
| [GVM](https://github.com/moovweb/gvm)  | 4456 |  GVM 提供了一个接口来管理 Go 版本。 |![star > 1000][Silver]
...
| [kubernetes](https://github.com/kubernetes/kubernetes)  | 55836 |  来自谷歌的容器集群管理器。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Moby](https://github.com/moby/moby)  | 54286 |  Collaborative project for the container ecosystem to assemble container-based systems. |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Pewpew](https://github.com/bengadbois/pewpew)  | 201 |  灵活的 HTTP 命令行压测工具。 |![star > 100][Bronze]
| [Pomerium](https://github.com/pomerium/pomerium)  | 492 |  Pomerium是一个可识别身份的访问代理。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
...
| [script](https://github.com/bitfield/script)  | 904 |  让DevOps编写类shell和系统管理任务变得更加容易。 |![star > 100][Bronze]
...
| [traefik](https://github.com/containous/traefik)  | 23574 |  反向代理和负载均衡器，支持多个后端。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [Vegeta](https://github.com/tsenart/vegeta)  | 12081 |  HTTP负载测试工具和库。超过9000 ! |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [webhook](https://github.com/adnanh/webhook)  | 4061 |  允许用户创建在服务器上执行命令的 HTTP hooks。 |![star > 1000][Silver]
...
| [Comcast](https://github.com/tylertreat/Comcast)  | 6167 |  模拟坏的网络连接。 |![star > 5000][Gold]
| [confd](https://github.com/kelseyhightower/confd)  | 6395 |  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。 |![star > 5000][Gold]
| [DDNS](https://github.com/skibish/ddns)  | 97 |  个人 DDNS 客户端。 |
| [Docker](http://www.docker.com/)  | - |  面向开发人员和系统管理员的分布式应用程序的开放平台。 |
| [Documize](https://github.com/documize/community)  | 818 |  集成了SaaS工具数据的现代wiki软件。 |![star > 100][Bronze]
| [drive](https://github.com/odeke-em/drive)  | 4947 |  基于命令行的谷歌驱动器客户端。 |![star > 1000][Silver]
| [Duplicacy](https://github.com/gilbertchen/duplicacy)  | 2680 |  跨平台网络和云备份工具。 |![star > 1000][Silver]   ![最近一个周有更新][Green]
...
| [lgo](https://github.com/yunabe/lgo)  | 1797 |  与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。 |![star > 1000][Silver]
| [limetext](http://limetext.org/)  | - |  一个强大而优雅的文本编辑器。 |
| [LiteIDE](https://github.com/visualfc/liteide)  | 5459 |  简单的、开源的、跨平台的Go IDE。 |![star > 5000][Gold]   ![最近一个周有更新][Green]   ![包含中文文档][CN]
...
| [nes](https://github.com/fogleman/nes)  | 4128 |  任天堂娱乐系统(NES)模拟器。 |![star > 1000][Silver]
...
| [peg](https://github.com/pointlander/peg)  | 603 |  解析表达式语法，是Packrat解析器生成器的实现。 |![star > 100][Bronze]
| [Pipe](https://github.com/b3log/pipe)  | 2865 |  一个小巧漂亮的博客平台。 |![star > 1000][Silver]
| [restic](https://github.com/restic/restic)  | 7391 |  消除重复项备份程序。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
...
| [Seaweed File System](https://github.com/chrislusf/seaweedfs)  | 8170 |  快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。 |![star > 5000][Gold]   ![最近一个周有更新][Green]
| [shell2http](https://github.com/msoap/shell2http)  | 401 |  通过http服务器执行shell命令(用于原型或远程控制)。 |![star > 100][Bronze]
...
| [toxiproxy](https://github.com/shopify/toxiproxy)  | 3918 |  为自动化测试模拟网络和系统条件的代理。 |![star > 1000][Silver]
...
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark)  | 1257 |  HTTP请求路由器基准测试和比较。 |![star > 1000][Silver]
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark)  | 989 |  web框架基准测试。 |![star > 100][Bronze]   ![最近一个周有更新][Green]
